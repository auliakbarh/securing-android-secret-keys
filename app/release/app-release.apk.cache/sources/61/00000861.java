...
public final class KeyEventHelpers_androidKt {
    ...
    public static final boolean m757cancelsTextSelectionZmokQxo(KeyEvent cancelsTextSelection) {
        Intrinsics.checkNotNullParameter(cancelsTextSelection, "$this$cancelsTextSelection");
        return cancelsTextSelection.getKeyCode() == 4 && KeyEventType.m3607equalsimpl0(KeyEvent_androidKt.m3615getTypeZmokQxo(cancelsTextSelection), KeyEventType.Companion.m3612getKeyUpCS__XNY());
    }
}