...
public final class RepeatableSpec<T> implements FiniteAnimationSpec<T> {
    ...
    public final long m105getInitialStartOffsetRmkjzm4() {
    ...
    public /* synthetic */ RepeatableSpec(int i, DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode, long j, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(i, durationBasedAnimationSpec, (i2 & 4) != 0 ? RepeatMode.Restart : repeatMode, (i2 & 8) != 0 ? StartOffset.m110constructorimpl$default(0, 0, 2, null) : j, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ RepeatableSpec(int i, DurationBasedAnimationSpec animation, RepeatMode repeatMode) {
        this(i, animation, repeatMode, StartOffset.m110constructorimpl$default(0, 0, 2, null), (DefaultConstructorMarker) null);
        Intrinsics.checkNotNullParameter(animation, "animation");
        Intrinsics.checkNotNullParameter(repeatMode, "repeatMode");
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof RepeatableSpec) {
            ...
            return repeatableSpec.iterations == this.iterations && Intrinsics.areEqual(repeatableSpec.animation, this.animation) && repeatableSpec.repeatMode == this.repeatMode && StartOffset.m112equalsimpl0(repeatableSpec.initialStartOffset, this.initialStartOffset);
        }
        return false;
    }

    public int hashCode() {
        return (((((this.iterations * 31) + this.animation.hashCode()) * 31) + this.repeatMode.hashCode()) * 31) + StartOffset.m115hashCodeimpl(this.initialStartOffset);
    }
}