...
final class ScrollableTabData {
    ...
    private final int calculateTabOffset(TabPosition tabPosition, Density density, int i, List<TabPosition> list) {
        int mo318roundToPx0680j_4 = density.mo318roundToPx0680j_4(((TabPosition) CollectionsKt.last((List<? extends Object>) list)).m1504getRightD9Ej5fM()) + i;
        int maxValue = mo318roundToPx0680j_4 - this.scrollState.getMaxValue();
        return RangesKt.coerceIn(density.mo318roundToPx0680j_4(tabPosition.m1503getLeftD9Ej5fM()) - ((maxValue / 2) - (density.mo318roundToPx0680j_4(tabPosition.m1505getWidthD9Ej5fM()) / 2)), 0, RangesKt.coerceAtLeast(mo318roundToPx0680j_4 - maxValue, 0));
    }
}