...
public final class CalendarModelKt {
    ...
    public static final DateInputFormat datePatternAsInputFormat(String localeFormat) {
        ...
        String removeSuffix = StringsKt.removeSuffix(StringsKt.replace$default(new Regex("y{1,4}").replace(regex3.replace(regex2.replace(regex.replace(localeFormat, ""), "dd"), "MM"), "yyyy"), "My", "M/y", false, 4, (Object) null), (CharSequence) ".");
