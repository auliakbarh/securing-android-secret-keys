...
public final class BroadcastFrameClock implements MonotonicFrameClock {
    ...
    public static final class FrameAwaiter<R> {
        ...
        public final void resume(long j) {
            ...
            try {
                ...
                m5158constructorimpl = Result.m5158constructorimpl(this.onFrame.invoke(Long.valueOf(j)));
            } catch (Throwable th) {
                Result.Companion companion2 = Result.Companion;
                m5158constructorimpl = Result.m5158constructorimpl(ResultKt.createFailure(th));
            }
            continuation.resumeWith(m5158constructorimpl);
        }
    }
    ...
    public <R> Object withFrameNanos(Function1<? super Long, ? extends R> function1, Continuation<? super R> continuation) {
        ...
        synchronized (this.lock) {
            ...
            if (th != null) {
                Result.Companion companion = Result.Companion;
                cancellableContinuationImpl2.resumeWith(Result.m5158constructorimpl(ResultKt.createFailure(th)));
            } else {
                ...
                cancellableContinuationImpl2.invokeOnCancellation(new Function1<Throwable, Unit>() { // from class: androidx.compose.runtime.BroadcastFrameClock$withFrameNanos$2$1
                    ...
                    public final void invoke2(Throwable th2) {
                        ...
                        Object access$getLock$p = BroadcastFrameClock.access$getLock$p(BroadcastFrameClock.this);
                        ...
                        synchronized (access$getLock$p) {
                            ...
                            access$getAwaiters$p.remove(frameAwaiter2);
                            Unit unit = Unit.INSTANCE;
                        }
                    }
                });
    ...
    public final void fail(Throwable th) {
        synchronized (this.lock) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                Result.Companion companion = Result.Companion;
                continuation.resumeWith(Result.m5158constructorimpl(ResultKt.createFailure(th)));
            }
            this.awaiters.clear();
            Unit unit = Unit.INSTANCE;
        }
