...
public final class SnackbarHostState {
    ...
    /* JADX WARN: Removed duplicated region for block: B:26:0x009e A[Catch: all -> 0x00af, TRY_LEAVE, TryCatch #1 {all -> 0x00af, blocks: (B:24:0x0071, B:26:0x009e), top: B:41:0x0071 }] */
    ...
    public static final class SnackbarDataImpl implements SnackbarData {
        ...
        public void performAction() {
            if (this.continuation.isActive()) {
                ...
                this.continuation.resumeWith(Result.m5154constructorimpl(SnackbarResult.ActionPerformed));
            }
        }
        ...
        public void dismiss() {
            if (this.continuation.isActive()) {
                Result.Companion companion = Result.Companion;
                this.continuation.resumeWith(Result.m5154constructorimpl(SnackbarResult.Dismissed));
            }
        }
