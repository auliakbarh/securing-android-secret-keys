...
public final class CombinedClickableElement extends ModifierNodeElement<CombinedClickableNode> {
    ...
    public void update(CombinedClickableNode node) {
        ...
        node.m208updatecJG_KMw(this.interactionSource, this.enabled, this.onClickLabel, this.role, this.onClick, this.onLongClickLabel, this.onLongClick, this.onDoubleClick);
    }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        int m4242hashCodeimpl = (((hashCode2 + (role != null ? Role.m4242hashCodeimpl(role.m4244unboximpl()) : 0)) * 31) + this.onClick.hashCode()) * 31;
        String str2 = this.onLongClickLabel;
        int hashCode3 = (m4242hashCodeimpl + (str2 != null ? str2.hashCode() : 0)) * 31;
