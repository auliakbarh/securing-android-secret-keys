...
public abstract class ShaderBrush extends Brush {
    ...
    public abstract Shader mo2597createShaderuvyYCjk(long j);

    public ShaderBrush() {
        super(null);
        this.createdSize = Size.Companion.m2466getUnspecifiedNHjbRc();
    }

    @Override // androidx.compose.ui.graphics.Brush
    /* renamed from: applyTo-Pq9zytI */
    public final void mo2575applyToPq9zytI(long j, Paint p, float f) {
        Intrinsics.checkNotNullParameter(p, "p");
        Shader shader = this.internalShader;
        if (shader == null || !Size.m2454equalsimpl0(this.createdSize, j)) {
            if (Size.m2460isEmptyimpl(j)) {
                shader = null;
                this.internalShader = null;
                this.createdSize = Size.Companion.m2466getUnspecifiedNHjbRc();
            } else {
                shader = mo2597createShaderuvyYCjk(j);
                this.internalShader = shader;
                this.createdSize = j;
            }
        }
        if (!Color.m2629equalsimpl0(p.mo2503getColor0d7_KjU(), Color.Companion.m2654getBlack0d7_KjU())) {
            p.mo2509setColor8_81llA(Color.Companion.m2654getBlack0d7_KjU());
        }
