...
public final class Stroke extends DrawStyle {
    ...
    private static final int DefaultCap = StrokeCap.Companion.m2974getButtKaPHkGw();
    private static final int DefaultJoin = StrokeJoin.Companion.m2985getMiterLxFBmk8();
    ...
    public final int m3234getCapKaPHkGw() {
        return this.cap;
    }

    /* renamed from: getJoin-LxFBmk8  reason: not valid java name */
    public final int m3235getJoinLxFBmk8() {
        return this.join;
    }
    ...
    public static final class Companion {
        ...
        public final int m3236getDefaultCapKaPHkGw() {
            return Stroke.DefaultCap;
        }

        /* renamed from: getDefaultJoin-LxFBmk8  reason: not valid java name */
        public final int m3237getDefaultJoinLxFBmk8() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Stroke) {
            ...
            return this.width == stroke.width && this.miter == stroke.miter && StrokeCap.m2970equalsimpl0(this.cap, stroke.cap) && StrokeJoin.m2980equalsimpl0(this.join, stroke.join) && Intrinsics.areEqual(this.pathEffect, stroke.pathEffect);
        }
        return false;
    }

    public int hashCode() {
        int hashCode = ((((((Float.hashCode(this.width) * 31) + Float.hashCode(this.miter)) * 31) + StrokeCap.m2971hashCodeimpl(this.cap)) * 31) + StrokeJoin.m2981hashCodeimpl(this.join)) * 31;
        PathEffect pathEffect = this.pathEffect;
        return hashCode + (pathEffect != null ? pathEffect.hashCode() : 0);
    }

    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + ((Object) StrokeCap.m2972toStringimpl(this.cap)) + ", join=" + ((Object) StrokeJoin.m2982toStringimpl(this.join)) + ", pathEffect=" + this.pathEffect + ')';
    }
}