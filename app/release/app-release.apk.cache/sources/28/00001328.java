...
public final class CornerRadiusKt {
    ...
    public static final long m2375lerp3Ry4LBc(long j, long j2, float f) {
        return CornerRadius(MathHelpersKt.lerp(CornerRadius.m2364getXimpl(j), CornerRadius.m2364getXimpl(j2), f), MathHelpersKt.lerp(CornerRadius.m2365getYimpl(j), CornerRadius.m2365getYimpl(j2), f));
    }

    public static final long CornerRadius(float f, float f2) {
        return CornerRadius.m2358constructorimpl((Float.floatToIntBits(f2) & 4294967295L) | (Float.floatToIntBits(f) << 32));
    }
}