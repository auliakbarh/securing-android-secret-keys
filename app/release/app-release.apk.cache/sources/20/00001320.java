...
public final class OneDimensionalFocusSearchKt {
    ...
    /* renamed from: access$searchChildren-4C6V_qg */
    public static final /* synthetic */ boolean m2343access$searchChildren4C6V_qg(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2, int i, Function1 function1) {
        return m2346searchChildren4C6V_qg(focusTargetNode, focusTargetNode2, i, function1);
    }
    ...
    public static final boolean m2345oneDimensionalFocusSearchOMvw8(FocusTargetNode oneDimensionalFocusSearch, int i, Function1<? super FocusTargetNode, Boolean> onFound) {
    ...
    private static final boolean forwardFocusSearch(FocusTargetNode focusTargetNode, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (i == 1) {
            ...
            if (activeChild != null) {
                return forwardFocusSearch(activeChild, function1) || m2344generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, FocusDirection.Companion.m2321getNextdhqQ8s(), function1);
            }
    ...
    private static final boolean backwardFocusSearch(FocusTargetNode focusTargetNode, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (i == 1) {
            ...
            if (i2 != 1) {
                if (i2 == 2 || i2 == 3) {
                    return m2344generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, FocusDirection.Companion.m2323getPreviousdhqQ8s(), function1);
                }
                if (i2 == 4) {
                    throw new IllegalStateException(NoActiveChild.toString());
                }
                throw new NoWhenBranchMatchedException();
            } else if (!backwardFocusSearch(activeChild, function1) && !m2344generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, FocusDirection.Companion.m2323getPreviousdhqQ8s(), function1) && (!activeChild.fetchFocusProperties$ui_release().getCanFocus() || !function1.invoke(activeChild).booleanValue())) {
                return false;
            }
        } else if (i == 2 || i == 3) {
    ...
    private static final boolean m2344generateAndSearchChildren4C6V_qg(final FocusTargetNode focusTargetNode, final FocusTargetNode focusTargetNode2, final int i, final Function1<? super FocusTargetNode, Boolean> function1) {
        if (m2346searchChildren4C6V_qg(focusTargetNode, focusTargetNode2, i, function1)) {
            return true;
        }
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m2304searchBeyondBoundsOMvw8(focusTargetNode, i, new Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean>() { // from class: androidx.compose.ui.focus.OneDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope searchBeyondBounds) {
                ...
                Boolean valueOf = Boolean.valueOf(OneDimensionalFocusSearchKt.m2343access$searchChildren4C6V_qg(FocusTargetNode.this, focusTargetNode2, i, function1));
    ...
    public static final boolean m2346searchChildren4C6V_qg(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2, int i, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (FocusDirection.m2308equalsimpl0(i, FocusDirection.Companion.m2321getNextdhqQ8s()) || !focusTargetNode.fetchFocusProperties$ui_release().getCanFocus() || isRoot(focusTargetNode)) {
            return false;
        }
        return function1.invoke(focusTargetNode).booleanValue();
    }
