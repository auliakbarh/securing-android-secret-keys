...
public final class DefaultIoScheduler extends ExecutorCoroutineDispatcher implements Executor {
    ...
    private static final CoroutineDispatcher f51default;
    ...
    static {
        ...
        f51default = unlimitedIoScheduler.limitedParallelism(systemProp$default);
    }
    ...
    public void execute(Runnable runnable) {
        mo6712dispatch(EmptyCoroutineContext.INSTANCE, runnable);
    }
    ...
    public void mo6712dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        f51default.mo6712dispatch(coroutineContext, runnable);
    }

    @Override // kotlinx.coroutines.CoroutineDispatcher
    public void dispatchYield(CoroutineContext coroutineContext, Runnable runnable) {
        f51default.dispatchYield(coroutineContext, runnable);
    }
