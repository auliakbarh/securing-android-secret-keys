...
public final class DefaultIoScheduler extends ExecutorCoroutineDispatcher implements Executor {
    ...
    private static final CoroutineDispatcher f48default;
    ...
    static {
        ...
        f48default = unlimitedIoScheduler.limitedParallelism(systemProp$default);
    }
    ...
    public void execute(Runnable runnable) {
        mo6709dispatch(EmptyCoroutineContext.INSTANCE, runnable);
    }
    ...
    public void mo6709dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        f48default.mo6709dispatch(coroutineContext, runnable);
    }

    @Override // kotlinx.coroutines.CoroutineDispatcher
    public void dispatchYield(CoroutineContext coroutineContext, Runnable runnable) {
        f48default.dispatchYield(coroutineContext, runnable);
    }
