...
public final class DefaultIoScheduler extends ExecutorCoroutineDispatcher implements Executor {
    ...
    private static final CoroutineDispatcher f47default;
    ...
    static {
        ...
        f47default = unlimitedIoScheduler.limitedParallelism(systemProp$default);
    }
    ...
    public void execute(Runnable runnable) {
        mo6708dispatch(EmptyCoroutineContext.INSTANCE, runnable);
    }
    ...
    public void mo6708dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        f47default.mo6708dispatch(coroutineContext, runnable);
    }

    @Override // kotlinx.coroutines.CoroutineDispatcher
    public void dispatchYield(CoroutineContext coroutineContext, Runnable runnable) {
        f47default.dispatchYield(coroutineContext, runnable);
    }
