...
public final class SwitchKt {
    ...
    /* renamed from: access$SwitchImpl-0DmnUew */
    public static final /* synthetic */ void m1496access$SwitchImpl0DmnUew(BoxScope boxScope, boolean z, boolean z2, SwitchColors switchColors, State state, Function2 function2, InteractionSource interactionSource, Shape shape, float f, float f2, float f3, Composer composer, int i, int i2) {
        m1495SwitchImpl0DmnUew(boxScope, z, z2, switchColors, state, function2, interactionSource, shape, f, f2, f3, composer, i, i2);
    }

    public static final /* synthetic */ TweenSpec access$getAnimationSpec$p() {
    ...
    /* JADX WARN: Removed duplicated region for block: B:253:0x012b  */
    ...
    /* JADX WARN: Removed duplicated region for block: B:270:0x01a6  */
    /* JADX WARN: Removed duplicated region for block: B:272:0x01b1  */
    /* JADX WARN: Removed duplicated region for block: B:273:0x01b4  */
    /* JADX WARN: Removed duplicated region for block: B:276:0x021c  */
    /* JADX WARN: Removed duplicated region for block: B:281:0x0254  */
    ...
    /* JADX WARN: Removed duplicated region for block: B:291:0x02eb  */
    /* JADX WARN: Removed duplicated region for block: B:292:0x02f4  */
    /* JADX WARN: Removed duplicated region for block: B:295:0x0380  */
    /* JADX WARN: Removed duplicated region for block: B:298:0x038c  */
    /* JADX WARN: Removed duplicated region for block: B:299:0x0390  */
    /* JADX WARN: Removed duplicated region for block: B:302:0x0444  */
    ...
    */
    ...
    /* renamed from: SwitchImpl-0DmnUew */
    public static final void m1495SwitchImpl0DmnUew(final BoxScope boxScope, final boolean z, final boolean z2, final SwitchColors switchColors, final State<Float> state, final Function2<? super Composer, ? super Integer, Unit> function2, final InteractionSource interactionSource, final Shape shape, final float f, final float f2, final float f3, Composer composer, final int i, final int i2) {
        int i3;
        int i4;
        float m4872constructorimpl;
        final float floatValue;
        float m2145getTrackOutlineWidthD9Ej5fM;
        ...
        if ((i3 & 1533916891) != 306783378 || (i4 & 11) != 2 || !startRestartGroup.getSkipping()) {
            ...
            float mo320toDpu2uoSUM = ((Density) consume).mo320toDpu2uoSUM(state.getValue().floatValue());
            if (SwitchImpl_0DmnUew$lambda$7(collectIsPressedAsState)) {
                m4872constructorimpl = SwitchTokens.INSTANCE.m2139getPressedHandleWidthD9Ej5fM();
            } else {
                m4872constructorimpl = Dp.m4872constructorimpl(Dp.m4872constructorimpl(Dp.m4872constructorimpl(ThumbDiameter - f) * (Dp.m4872constructorimpl(mo320toDpu2uoSUM - f2) / Dp.m4872constructorimpl(f3 - f2))) + f);
            }
            ...
            if (!SwitchImpl_0DmnUew$lambda$7(collectIsPressedAsState)) {
                ...
                if (!z) {
                    m2145getTrackOutlineWidthD9Ej5fM = SwitchTokens.INSTANCE.m2145getTrackOutlineWidthD9Ej5fM();
                } else {
                    m2145getTrackOutlineWidthD9Ej5fM = Dp.m4872constructorimpl(ThumbPathLength - SwitchTokens.INSTANCE.m2145getTrackOutlineWidthD9Ej5fM());
                }
                floatValue = density.mo324toPx0680j_4(m2145getTrackOutlineWidthD9Ej5fM);
            }
            startRestartGroup.endReplaceableGroup();
            Shape shape2 = ShapesKt.toShape(SwitchTokens.INSTANCE.getTrackShape(), startRestartGroup, 6);
            Modifier m157backgroundbw27NRU = BackgroundKt.m157backgroundbw27NRU(BorderKt.m169borderxT4_qwU(SizeKt.m512height3ABfNKs(SizeKt.m531width3ABfNKs(boxScope.align(Modifier.Companion, Alignment.Companion.getCenter()), SwitchWidth), SwitchHeight), SwitchTokens.INSTANCE.m2145getTrackOutlineWidthD9Ej5fM(), switchColors.borderColor$material3_release(z2, z, startRestartGroup, i5).getValue().m2638unboximpl(), shape2), SwitchImpl_0DmnUew$lambda$6(trackColor$material3_release), shape2);
            ...
            Updater.m2269setimpl(m2262constructorimpl, density2, ComposeUiNode.Companion.getSetDensity());
            ...
            if (changed || rememberedValue == Composer.Companion.getEmpty()) {
                rememberedValue = (Function1) new Function1<Density, IntOffset>() { // from class: androidx.compose.material3.SwitchKt$SwitchImpl$1$1$1
                    ...
                    public /* bridge */ /* synthetic */ IntOffset invoke(Density density3) {
                        return IntOffset.m4981boximpl(m1497invokeBjo55l4(density3));
                    }

                    /* renamed from: invoke-Bjo55l4  reason: not valid java name */
                    public final long m1497invokeBjo55l4(Density offset) {
            ...
            startRestartGroup.endReplaceableGroup();
            Modifier m157backgroundbw27NRU2 = BackgroundKt.m157backgroundbw27NRU(SizeKt.m518requiredSize3ABfNKs(IndicationKt.indication(OffsetKt.offset(align, (Function1) rememberedValue), interactionSource, RippleKt.m965rememberRipple9IZ8Weo(false, Dp.m4872constructorimpl(SwitchTokens.INSTANCE.m2143getStateLayerSizeD9Ej5fM() / 2), 0L, startRestartGroup, 54, 4)), m4872constructorimpl), SwitchImpl_0DmnUew$lambda$13$lambda$10, shape);
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf2 = LayoutKt.materializerOf(m157backgroundbw27NRU2);
            if (!(startRestartGroup.getApplier() instanceof Applier)) {
                ComposablesKt.invalidApplier();
            }
            startRestartGroup.startReusableNode();
            ...
            Updater.m2269setimpl(m2262constructorimpl2, rememberBoxMeasurePolicy2, ComposeUiNode.Companion.getSetMeasurePolicy());
            Updater.m2269setimpl(m2262constructorimpl2, density3, ComposeUiNode.Companion.getSetDensity());
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SwitchKt$SwitchImpl$2
            ...
            public final void invoke(Composer composer2, int i7) {
                SwitchKt.m1496access$SwitchImpl0DmnUew(BoxScope.this, z, z2, switchColors, state, function2, interactionSource, shape, f, f2, f3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), RecomposeScopeImplKt.updateChangedFlags(i2));
            }
        });
    }

    static {
        float m2141getSelectedHandleWidthD9Ej5fM = SwitchTokens.INSTANCE.m2141getSelectedHandleWidthD9Ej5fM();
        ThumbDiameter = m2141getSelectedHandleWidthD9Ej5fM;
        UncheckedThumbDiameter = SwitchTokens.INSTANCE.m2148getUnselectedHandleWidthD9Ej5fM();
        float m2146getTrackWidthD9Ej5fM = SwitchTokens.INSTANCE.m2146getTrackWidthD9Ej5fM();
        SwitchWidth = m2146getTrackWidthD9Ej5fM;
        float m2144getTrackHeightD9Ej5fM = SwitchTokens.INSTANCE.m2144getTrackHeightD9Ej5fM();
        SwitchHeight = m2144getTrackHeightD9Ej5fM;
        float m4872constructorimpl = Dp.m4872constructorimpl(Dp.m4872constructorimpl(m2144getTrackHeightD9Ej5fM - m2141getSelectedHandleWidthD9Ej5fM) / 2);
        ThumbPadding = m4872constructorimpl;
        ThumbPathLength = Dp.m4872constructorimpl(Dp.m4872constructorimpl(m2146getTrackWidthD9Ej5fM - m2141getSelectedHandleWidthD9Ej5fM) - m4872constructorimpl);
