...
public final class Latch {
    ...
    public static final /* synthetic */ List access$getAwaiters$p(Latch latch) {
        return latch.awaiters;
    }

    public static final /* synthetic */ Object access$getLock$p(Latch latch) {
        return latch.lock;
    }
    ...
    public final Object await(Continuation<? super Unit> continuation) {
        ...
        cancellableContinuationImpl2.invokeOnCancellation(new Function1<Throwable, Unit>() { // from class: androidx.compose.runtime.Latch$await$2$2
            ...
            public final void invoke2(Throwable th) {
                Object access$getLock$p = Latch.access$getLock$p(Latch.this);
                Latch latch = Latch.this;
                CancellableContinuation<Unit> cancellableContinuation = cancellableContinuationImpl2;
                synchronized (access$getLock$p) {
                    Latch.access$getAwaiters$p(latch).remove(cancellableContinuation);
    ...
    public final void openLatch() {
        synchronized (this.lock) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                list.get(i).resumeWith(Result.m5155constructorimpl(Unit.INSTANCE));
            }
            list.clear();
            Unit unit = Unit.INSTANCE;
        }
