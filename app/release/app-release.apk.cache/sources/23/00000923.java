        ...
        if (i == 0) {
            ...
            Flow snapshotFlow = SnapshotStateKt.snapshotFlow(new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$rememberAnimatedMagnifierPosition$1.1
                ...
                public /* bridge */ /* synthetic */ Offset invoke() {
                    return Offset.m2378boximpl(m897invokeF1C5BW0());
                }
            ...
            if (snapshotFlow.collect(new FlowCollector<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$rememberAnimatedMagnifierPosition$1.2
                ...
                public /* bridge */ /* synthetic */ Object emit(Offset offset, Continuation continuation) {
                    return m898emit3MmeM6k(offset.m2399unboximpl(), continuation);
                }

                /* renamed from: emit-3MmeM6k  reason: not valid java name */
                public final Object m898emit3MmeM6k(long j, Continuation<? super Unit> continuation) {
                    if (OffsetKt.m2408isSpecifiedk4lQ0M(animatable.getValue().m2399unboximpl()) && OffsetKt.m2408isSpecifiedk4lQ0M(j) && Offset.m2390getYimpl(animatable.getValue().m2399unboximpl()) != Offset.m2390getYimpl(j)) {
                    ...
                    Object snapTo = animatable.snapTo(Offset.m2378boximpl(j), continuation);
