...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    public static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo6474elapsedNowUwyO8pc() {
            return Duration.m6519minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public ComparableTimeMark mo6477plusLRDsOJo(long j) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m6520plusLRDsOJo(this.offset, j), null);
        }
        ...
        public long mo6476minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (other instanceof DoubleTimeMark) {
                ...
                if (Intrinsics.areEqual(this.timeSource, doubleTimeMark.timeSource)) {
                    if (Duration.m6489equalsimpl0(this.offset, doubleTimeMark.offset) && Duration.m6516isInfiniteimpl(this.offset)) {
                        return Duration.Companion.m6587getZEROUwyO8pc();
                    }
                    long m6519minusLRDsOJo = Duration.m6519minusLRDsOJo(this.offset, doubleTimeMark.offset);
                    long duration = DurationKt.toDuration(this.startedAt - doubleTimeMark.startedAt, this.timeSource.getUnit());
                    return Duration.m6489equalsimpl0(duration, Duration.m6537unaryMinusUwyO8pc(m6519minusLRDsOJo)) ? Duration.Companion.m6587getZEROUwyO8pc() : Duration.m6520plusLRDsOJo(duration, m6519minusLRDsOJo);
                }
            }
        ...
        public boolean equals(Object obj) {
            return (obj instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) obj).timeSource) && Duration.m6489equalsimpl0(mo6476minusUwyO8pc((ComparableTimeMark) obj), Duration.Companion.m6587getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m6512hashCodeimpl(Duration.m6520plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m6533toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.m6587getZEROUwyO8pc(), null);
    }
}