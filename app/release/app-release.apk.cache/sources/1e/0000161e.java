...
public final class LayoutNodeLayoutDelegate {
    ...
    public final Constraints m4021getLastConstraintsDWUhwKw() {
        return this.measurePassDelegate.m4027getLastConstraintsDWUhwKw();
    }

    /* renamed from: getLastLookaheadConstraints-DWUhwKw  reason: not valid java name */
    public final Constraints m4022getLastLookaheadConstraintsDWUhwKw() {
        LookaheadPassDelegate lookaheadPassDelegate = this.lookaheadPassDelegate;
        if (lookaheadPassDelegate != null) {
            return lookaheadPassDelegate.m4023getLastConstraintsDWUhwKw();
        }
        return null;
    }
    ...
    public final class MeasurePassDelegate extends Placeable implements Measurable, AlignmentLinesOwner {
        ...
        private long lastPosition = IntOffset.Companion.m5000getZeronOccac();
        ...
        /* renamed from: getLastConstraints-DWUhwKw  reason: not valid java name */
        public final Constraints m4027getLastConstraintsDWUhwKw() {
            if (this.measuredOnce) {
                return Constraints.m4816boximpl(m3919getMeasurementConstraintsmsEJaDk());
            }
            return null;
        }
        ...
        public Placeable mo3865measureBRTryo0(long j) {
            ...
            if (layoutNodeLayoutDelegate.isOutMostLookaheadRoot(layoutNodeLayoutDelegate.layoutNode)) {
                ...
                lookaheadPassDelegate$ui_release.mo3865measureBRTryo0(j);
            }
            trackMeasurementByParent(LayoutNodeLayoutDelegate.this.layoutNode);
            m4028remeasureBRTryo0(j);
            return this;
        }

        /* renamed from: remeasure-BRTryo0  reason: not valid java name */
        public final boolean m4028remeasureBRTryo0(long j) {
            ...
            if (!LayoutNodeLayoutDelegate.this.layoutNode.getMeasurePending$ui_release() && Constraints.m4821equalsimpl0(m3919getMeasurementConstraintsmsEJaDk(), j)) {
            ...
            this.measuredOnce = true;
            long mo3872getSizeYbymL2g = LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo3872getSizeYbymL2g();
            m3921setMeasurementConstraintsBRTryo0(j);
            LayoutNodeLayoutDelegate.this.m4020performMeasureBRTryo0(j);
            if (IntSize.m5030equalsimpl0(LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo3872getSizeYbymL2g(), mo3872getSizeYbymL2g) && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth() == getWidth() && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight() == getHeight()) {
                z = false;
            }
            m3920setMeasuredSizeozmzZPI(IntSizeKt.IntSize(LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth(), LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight()));
            return z;
        }
        ...
        protected void mo3866placeAtf8xVGno(long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
            if (!IntOffset.m4989equalsimpl0(j, this.lastPosition)) {
            ...
            if (layoutNodeLayoutDelegate.isOutMostLookaheadRoot(layoutNodeLayoutDelegate.layoutNode)) {
                ...
                Placeable.PlacementScope.place$default(companion, lookaheadPassDelegate$ui_release, IntOffset.m4990getXimpl(j), IntOffset.m4991getYimpl(j), 0.0f, 4, null);
            }
            m4026placeOuterCoordinatorf8xVGno(j, f, function1);
        }

        /* renamed from: placeOuterCoordinator-f8xVGno  reason: not valid java name */
        private final void m4026placeOuterCoordinatorf8xVGno(final long j, final float f, final Function1<? super GraphicsLayerScope, Unit> function1) {
            LayoutNodeLayoutDelegate.this.layoutState = LayoutNode.LayoutState.LayingOut;
            this.lastPosition = j;
            this.lastZIndex = f;
            ...
            if (!LayoutNodeLayoutDelegate.this.getLayoutPending$ui_release() && isPlaced()) {
                LayoutNodeLayoutDelegate.this.getOuterCoordinator().m4070placeSelfApparentToRealOffsetf8xVGno(j, f, function1);
                ...
                snapshotObserver.observeLayoutModifierSnapshotReads$ui_release(layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$MeasurePassDelegate$placeOuterCoordinator$1
                    ...
                    public final void invoke2() {
                        ...
                        float f2 = f;
                        if (function12 == null) {
                            companion.m3926place70tqf50(layoutNodeLayoutDelegate2.getOuterCoordinator(), j2, f2);
                        } else {
                            companion.m3931placeWithLayeraW9wM(layoutNodeLayoutDelegate2.getOuterCoordinator(), j2, f2, function12);
                        }
                    }
                });
            }
        ...
        public final void replace() {
            try {
                ...
                m4026placeOuterCoordinatorf8xVGno(this.lastPosition, this.lastZIndex, this.lastLayerBlock);
            } finally {
        ...
        private final void onBeforeLayoutChildren() {
            ...
            if (size > 0) {
                ...
                do {
                    LayoutNode layoutNode2 = content[i];
                    if (layoutNode2.getMeasurePending$ui_release() && layoutNode2.getMeasuredByParent$ui_release() == LayoutNode.UsageByParent.InMeasureBlock && LayoutNode.m4004remeasure_Sx5XlM$ui_release$default(layoutNode2, null, 1, null)) {
        ...
        public final void measureBasedOnLookahead() {
            ...
            if (lookaheadPassDelegate$ui_release.getMeasuredByParent$ui_release() == LayoutNode.UsageByParent.InMeasureBlock && parent$ui_release.getLayoutState$ui_release() == LayoutNode.LayoutState.Measuring) {
                Constraints m4023getLastConstraintsDWUhwKw = lookaheadPassDelegate$ui_release.m4023getLastConstraintsDWUhwKw();
                Intrinsics.checkNotNull(m4023getLastConstraintsDWUhwKw);
                mo3865measureBRTryo0(m4023getLastConstraintsDWUhwKw.m4834unboximpl());
                ...
                Constraints m4023getLastConstraintsDWUhwKw2 = lookaheadPassDelegate$ui_release.m4023getLastConstraintsDWUhwKw();
                Intrinsics.checkNotNull(m4023getLastConstraintsDWUhwKw2);
                mo3865measureBRTryo0(m4023getLastConstraintsDWUhwKw2.m4834unboximpl());
            }
        }
        ...
        public final void placeBasedOnLookahead() {
            ...
            mo3866placeAtf8xVGno(lookaheadPassDelegate$ui_release.m4024getLastPositionnOccac$ui_release(), lookaheadPassDelegate$ui_release.getLastZIndex$ui_release(), lookaheadPassDelegate$ui_release.getLastLayerBlock$ui_release());
        }
    }
    ...
    public final class LookaheadPassDelegate extends Placeable implements Measurable, AlignmentLinesOwner {
        ...
        /* renamed from: getLastConstraints-DWUhwKw  reason: not valid java name */
        public final Constraints m4023getLastConstraintsDWUhwKw() {
        ...
        public final long m4024getLastPositionnOccac$ui_release() {
        ...
        /* renamed from: remeasure-BRTryo0  reason: not valid java name */
        public final boolean m4025remeasureBRTryo0(long j) {
            Constraints constraints;
            LayoutNode parent$ui_release = LayoutNodeLayoutDelegate.this.layoutNode.getParent$ui_release();
            LayoutNodeLayoutDelegate.this.layoutNode.setCanMultiMeasure$ui_release(LayoutNodeLayoutDelegate.this.layoutNode.getCanMultiMeasure$ui_release() || (parent$ui_release != null && parent$ui_release.getCanMultiMeasure$ui_release()));
            if (!LayoutNodeLayoutDelegate.this.layoutNode.getLookaheadMeasurePending$ui_release() && (constraints = this.lookaheadConstraints) != null && Constraints.m4821equalsimpl0(constraints.m4834unboximpl(), j)) {
            ...
            this.lookaheadConstraints = Constraints.m4816boximpl(j);
            getAlignmentLines().setUsedByModifierMeasurement$ui_release(false);
            ...
            LayoutNodeLayoutDelegate.this.m4019performLookaheadMeasureBRTryo0(j);
            m3920setMeasuredSizeozmzZPI(IntSizeKt.IntSize(lookaheadDelegate.getWidth(), lookaheadDelegate.getHeight()));
            return (IntSize.m5032getWidthimpl(IntSize) == lookaheadDelegate.getWidth() && IntSize.m5031getHeightimpl(IntSize) == lookaheadDelegate.getHeight()) ? false : true;
        }

        @Override // androidx.compose.ui.layout.Placeable
        /* renamed from: placeAt-f8xVGno */
        protected void mo3866placeAtf8xVGno(final long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
            LayoutNodeLayoutDelegate.this.layoutState = LayoutNode.LayoutState.LookaheadLayingOut;
            this.placedOnce = true;
            if (!IntOffset.m4989equalsimpl0(j, this.lastPosition)) {
                if (LayoutNodeLayoutDelegate.this.getCoordinatesAccessedDuringModifierPlacement() || LayoutNodeLayoutDelegate.this.getCoordinatesAccessedDuringPlacement()) {
            ...
            if (!LayoutNodeLayoutDelegate.this.getLookaheadLayoutPending$ui_release() && isPlaced()) {
                ...
                OwnerSnapshotObserver.observeLayoutModifierSnapshotReads$ui_release$default(snapshotObserver, layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate$placeAt$1
                    ...
                    public final void invoke2() {
                        ...
                        Intrinsics.checkNotNull(lookaheadDelegate);
                        Placeable.PlacementScope.m3922place70tqf50$default(companion2, lookaheadDelegate, j2, 0.0f, 2, null);
                    }
                }, 2, null);
            }
            this.lastPosition = j;
            ...
            if (size > 0) {
                ...
                do {
                    ...
                    if (layoutNode2.getLookaheadMeasurePending$ui_release() && layoutNode2.getMeasuredByParentInLookahead$ui_release() == LayoutNode.UsageByParent.InMeasureBlock) {
                        LookaheadPassDelegate lookaheadPassDelegate$ui_release = layoutNode2.getLayoutDelegate$ui_release().getLookaheadPassDelegate$ui_release();
                        Intrinsics.checkNotNull(lookaheadPassDelegate$ui_release);
                        Constraints m4023getLastConstraintsDWUhwKw = m4023getLastConstraintsDWUhwKw();
                        Intrinsics.checkNotNull(m4023getLastConstraintsDWUhwKw);
                        if (lookaheadPassDelegate$ui_release.m4025remeasureBRTryo0(m4023getLastConstraintsDWUhwKw.m4834unboximpl())) {
        ...
        public final void replace() {
            try {
                ...
                mo3866placeAtf8xVGno(this.lastPosition, 0.0f, null);
            } finally {
                this.relayoutWithoutParentInProgress = false;
            }
        }
    ...
    public final void m4020performMeasureBRTryo0(final long j) {
        ...
        LayoutNodeKt.requireOwner(this.layoutNode).getSnapshotObserver().observeMeasureSnapshotReads$ui_release(this.layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$performMeasure$2
            ...
            /* renamed from: invoke  reason: avoid collision after fix types in other method */
            public final void invoke2() {
                LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo3865measureBRTryo0(j);
            }
        });
    ...
    public final void m4019performLookaheadMeasureBRTryo0(final long j) {
        ...
        OwnerSnapshotObserver.observeMeasureSnapshotReads$ui_release$default(LayoutNodeKt.requireOwner(this.layoutNode).getSnapshotObserver(), this.layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$performLookaheadMeasure$1
            ...
            public final void invoke2() {
                LookaheadDelegate lookaheadDelegate = LayoutNodeLayoutDelegate.this.getOuterCoordinator().getLookaheadDelegate();
                Intrinsics.checkNotNull(lookaheadDelegate);
                lookaheadDelegate.mo3865measureBRTryo0(j);
            }
        }, 2, null);
