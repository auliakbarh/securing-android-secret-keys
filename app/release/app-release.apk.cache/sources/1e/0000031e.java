...
public final class MagnifierKt$magnifier$4 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public static final /* synthetic */ Function1 access$invoke$lambda$3(State state) {
        return invoke$lambda$3(state);
    }

    public static final /* synthetic */ long access$invoke$lambda$8(State state) {
        return invoke$lambda$8(state);
    }
    ...
    public final Modifier invoke(Modifier composed, Composer composer, int i) {
        ...
        if (rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m2378boximpl(Offset.Companion.m2404getUnspecifiedF1C5BW0()), null, 2, null);
        ...
        if (rememberedValue2 == Composer.Companion.getEmpty()) {
            rememberedValue2 = SnapshotStateKt.derivedStateOf(new Function0<Offset>() { // from class: androidx.compose.foundation.MagnifierKt$magnifier$4$sourceCenterInRoot$2$1
                ...
                public /* bridge */ /* synthetic */ Offset invoke() {
                    return Offset.m2378boximpl(m216invokeF1C5BW0());
                }

                /* renamed from: invoke-F1C5BW0  reason: not valid java name */
                public final long m216invokeF1C5BW0() {
                    long m2399unboximpl = ((Offset) MagnifierKt$magnifier$4.access$invoke$lambda$3(rememberUpdatedState).invoke(Density.this)).m2399unboximpl();
                    if (OffsetKt.m2408isSpecifiedk4lQ0M(MagnifierKt$magnifier$4.access$invoke$lambda$1(mutableState)) && OffsetKt.m2408isSpecifiedk4lQ0M(m2399unboximpl)) {
                        return Offset.m2394plusMKHz9U(MagnifierKt$magnifier$4.access$invoke$lambda$1(mutableState), m2399unboximpl);
                    }
                    return Offset.Companion.m2404getUnspecifiedF1C5BW0();
                }
            });
        ...
        if (rememberedValue3 == Composer.Companion.getEmpty()) {
            rememberedValue3 = SnapshotStateKt.derivedStateOf(new Function0<Boolean>() { // from class: androidx.compose.foundation.MagnifierKt$magnifier$4$isMagnifierShown$2$1
                ...
                public final Boolean invoke() {
                    return Boolean.valueOf(OffsetKt.m2408isSpecifiedk4lQ0M(MagnifierKt$magnifier$4.access$invoke$lambda$8(state)));
                }
            });
        ...
        if (changed || rememberedValue5 == Composer.Companion.getEmpty()) {
            rememberedValue5 = (Function1) new Function1<LayoutCoordinates, Unit>() { // from class: androidx.compose.foundation.MagnifierKt$magnifier$4$2$1
                ...
                public final void invoke2(LayoutCoordinates it) {
                    ...
                    MagnifierKt$magnifier$4.access$invoke$lambda$2(mutableState, LayoutCoordinatesKt.positionInRoot(it));
                }
            };
            ...
            rememberedValue6 = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.foundation.MagnifierKt$magnifier$4$4$1
                ...
                public final void invoke2(SemanticsPropertyReceiver semantics) {
                    ...
                    semantics.set(magnifierPositionInRoot, new Function0<Offset>() { // from class: androidx.compose.foundation.MagnifierKt$magnifier$4$4$1.1
                        ...
                        @Override // kotlin.jvm.functions.Function0
                        public /* bridge */ /* synthetic */ Offset invoke() {
                            return Offset.m2378boximpl(m215invokeF1C5BW0());
                        }
    ...
    public static final long invoke$lambda$8(State<Offset> state) {
        return state.getValue().m2399unboximpl();
    }
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                long mo240getSizeYbymL2g = create.mo240getSizeYbymL2g();
                ...
                if (invoke$lambda$6 != null) {
                    invoke$lambda$6.invoke(DpSize.m4958boximpl(density.mo322toDpSizekrfVVM(IntSizeKt.m5042toSizeozmzZPI(mo240getSizeYbymL2g))));
                }
                longRef.element = mo240getSizeYbymL2g;
                ...
                try {
                    ...
                    if (FlowKt.collect(SnapshotStateKt.snapshotFlow(new Function0<Unit>() { // from class: androidx.compose.foundation.MagnifierKt.magnifier.4.1.2
                        ...
                        public final void invoke2() {
                            long m2404getUnspecifiedF1C5BW0;
                            if (MagnifierKt$magnifier$4.invoke$lambda$10(state)) {
                                ...
                                long m2399unboximpl = ((Offset) invoke).m2399unboximpl();
                                if (OffsetKt.m2408isSpecifiedk4lQ0M(m2399unboximpl)) {
                                    m2404getUnspecifiedF1C5BW0 = Offset.m2394plusMKHz9U(MagnifierKt$magnifier$4.invoke$lambda$1(mutableState2), m2399unboximpl);
                                } else {
                                    m2404getUnspecifiedF1C5BW0 = Offset.Companion.m2404getUnspecifiedF1C5BW0();
                                }
                                platformMagnifier2.mo241updateWko1d7g(invoke$lambda$8, m2404getUnspecifiedF1C5BW0, MagnifierKt$magnifier$4.invoke$lambda$5(state4));
                                long mo240getSizeYbymL2g2 = create.mo240getSizeYbymL2g();
                                Ref.LongRef longRef2 = longRef;
                                Density density3 = density2;
                                State<Function1<DpSize, Unit>> state6 = state5;
                                if (IntSize.m5030equalsimpl0(mo240getSizeYbymL2g2, longRef2.element)) {
                                    return;
                                }
                                longRef2.element = mo240getSizeYbymL2g2;
                                Function1 invoke$lambda$62 = MagnifierKt$magnifier$4.invoke$lambda$6(state6);
                                if (invoke$lambda$62 != null) {
                                    invoke$lambda$62.invoke(DpSize.m4958boximpl(density3.mo322toDpSizekrfVVM(IntSizeKt.m5042toSizeozmzZPI(mo240getSizeYbymL2g2))));
                                    return;
                                }
                                return;
                            }
