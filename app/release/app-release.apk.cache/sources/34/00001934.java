...
public final class KeyboardCapitalization {
    ...
    private static final int None = m4578constructorimpl(0);
    private static final int Characters = m4578constructorimpl(1);
    private static final int Words = m4578constructorimpl(2);
    private static final int Sentences = m4578constructorimpl(3);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ KeyboardCapitalization m4577boximpl(int i) {
        return new KeyboardCapitalization(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m4578constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4579equalsimpl(int i, Object obj) {
        return (obj instanceof KeyboardCapitalization) && i == ((KeyboardCapitalization) obj).m4583unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m4579equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m4581hashCodeimpl(this.value);
    }
    ...
    public String toString() {
        return m4582toStringimpl(this.value);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m4582toStringimpl(int i) {
        return m4580equalsimpl0(i, None) ? "None" : m4580equalsimpl0(i, Characters) ? "Characters" : m4580equalsimpl0(i, Words) ? "Words" : m4580equalsimpl0(i, Sentences) ? "Sentences" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m4584getCharactersIUNYP9k$annotations() {
        }

        /* renamed from: getNone-IUNYP9k$annotations  reason: not valid java name */
        public static /* synthetic */ void m4585getNoneIUNYP9k$annotations() {
        }

        /* renamed from: getSentences-IUNYP9k$annotations  reason: not valid java name */
        public static /* synthetic */ void m4586getSentencesIUNYP9k$annotations() {
        }

        /* renamed from: getWords-IUNYP9k$annotations  reason: not valid java name */
        public static /* synthetic */ void m4587getWordsIUNYP9k$annotations() {
        }
        ...
        public final int m4589getNoneIUNYP9k() {
            return KeyboardCapitalization.None;
        }

        /* renamed from: getCharacters-IUNYP9k  reason: not valid java name */
        public final int m4588getCharactersIUNYP9k() {
            return KeyboardCapitalization.Characters;
        }

        /* renamed from: getWords-IUNYP9k  reason: not valid java name */
        public final int m4591getWordsIUNYP9k() {
            return KeyboardCapitalization.Words;
        }

        /* renamed from: getSentences-IUNYP9k  reason: not valid java name */
        public final int m4590getSentencesIUNYP9k() {
