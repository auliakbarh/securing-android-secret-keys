...
public final class MeasureAndLayoutDelegate {
    ...
    public final void m4037updateRootConstraintsBRTryo0(long j) {
        Constraints constraints = this.rootConstraints;
        if (constraints != null && Constraints.m4821equalsimpl0(constraints.m4834unboximpl(), j)) {
            return;
        }
        if (!(!this.duringMeasureLayout)) {
            throw new IllegalArgumentException("Failed requirement.".toString());
        }
        this.rootConstraints = Constraints.m4816boximpl(j);
    ...
    private final boolean m4034doLookaheadRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean m4003lookaheadRemeasure_Sx5XlM$ui_release$default;
        if (layoutNode.getLookaheadRoot$ui_release() == null) {
            return false;
        }
        if (constraints != null) {
            m4003lookaheadRemeasure_Sx5XlM$ui_release$default = layoutNode.m4007lookaheadRemeasure_Sx5XlM$ui_release(constraints);
        } else {
            m4003lookaheadRemeasure_Sx5XlM$ui_release$default = LayoutNode.m4003lookaheadRemeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (m4003lookaheadRemeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
        ...
        return m4003lookaheadRemeasure_Sx5XlM$ui_release$default;
    }

    /* renamed from: doRemeasure-sdFAvZA */
    private final boolean m4035doRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean m4004remeasure_Sx5XlM$ui_release$default;
        if (constraints != null) {
            m4004remeasure_Sx5XlM$ui_release$default = layoutNode.m4008remeasure_Sx5XlM$ui_release(constraints);
        } else {
            m4004remeasure_Sx5XlM$ui_release$default = LayoutNode.m4004remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (m4004remeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
        ...
        return m4004remeasure_Sx5XlM$ui_release$default;
    }
    ...
    public final void m4036measureAndLayout0kLqBqw(LayoutNode layoutNode, long j) {
        Intrinsics.checkNotNullParameter(layoutNode, "layoutNode");
        ...
        if (!this.duringMeasureLayout) {
            if (this.rootConstraints != null) {
                ...
                try {
                    ...
                    boolean m4034doLookaheadRemeasuresdFAvZA = m4034doLookaheadRemeasuresdFAvZA(layoutNode, Constraints.m4816boximpl(j));
                    m4035doRemeasuresdFAvZA(layoutNode, Constraints.m4816boximpl(j));
                    if ((m4034doLookaheadRemeasuresdFAvZA || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true)) {
    ...
    public final boolean remeasureAndRelayoutIfNeeded(LayoutNode layoutNode, boolean z) {
        ...
        boolean m4034doLookaheadRemeasuresdFAvZA;
        boolean m4035doRemeasuresdFAvZA;
        int i = 0;
        if (layoutNode.isPlaced() || getCanAffectParent(layoutNode) || Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true) || getCanAffectParentInLookahead(layoutNode) || layoutNode.getAlignmentLinesRequired$ui_release()) {
            if (layoutNode.getLookaheadMeasurePending$ui_release() || layoutNode.getMeasurePending$ui_release()) {
                ...
                m4034doLookaheadRemeasuresdFAvZA = (layoutNode.getLookaheadMeasurePending$ui_release() && z) ? m4034doLookaheadRemeasuresdFAvZA(layoutNode, constraints) : false;
                m4035doRemeasuresdFAvZA = m4035doRemeasuresdFAvZA(layoutNode, constraints);
            } else {
                m4035doRemeasuresdFAvZA = false;
                m4034doLookaheadRemeasuresdFAvZA = false;
            }
            if ((m4034doLookaheadRemeasuresdFAvZA || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true) && z) {
                layoutNode.lookaheadReplace$ui_release();
            }
            if (layoutNode.getLayoutPending$ui_release() && layoutNode.isPlaced()) {
                if (layoutNode == this.root) {
            ...
            return m4035doRemeasuresdFAvZA;
        }
        return false;
    }
    ...
    private final void remeasureOnly(LayoutNode layoutNode) {
        ...
        if (layoutNode.getMeasurePending$ui_release() || layoutNode.getLookaheadMeasurePending$ui_release()) {
            ...
            if (layoutNode.getLookaheadMeasurePending$ui_release()) {
                m4034doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
            }
            m4035doRemeasuresdFAvZA(layoutNode, constraints);
        }
    }
    ...
    public final void forceMeasureTheSubtree(LayoutNode layoutNode, final boolean z) {
        ...
        do {
            LayoutNode layoutNode2 = content[i];
            if (function1.invoke(layoutNode2).booleanValue() && this.relayoutNodes.remove(layoutNode2, z)) {
        ...
        if (function1.invoke(layoutNode).booleanValue() || !this.relayoutNodes.remove(layoutNode, z)) {
            return;
        }
