...
public final class SemanticsModifierNodeKt {
    ...
    public static final Rect touchBoundsInRoot(Modifier.Node node, boolean z) {
        ...
        if (node.getNode().isAttached()) {
            if (!z) {
                return LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m3978requireCoordinator64DMado(node, NodeKind.m4080constructorimpl(8)));
            }
            return DelegatableNodeKt.m3978requireCoordinator64DMado(node, NodeKind.m4080constructorimpl(8)).touchBoundsInRoot();
        }
