...
public abstract class LazyGridMeasuredItemProvider {
    ...
    public static /* synthetic */ LazyGridMeasuredItem m617getAndMeasure3p2s80s$default(LazyGridMeasuredItemProvider lazyGridMeasuredItemProvider, int i, int i2, long j, int i3, Object obj) {
        if (obj == null) {
            if ((i3 & 2) != 0) {
                i2 = lazyGridMeasuredItemProvider.defaultMainAxisSpacing;
            }
            return lazyGridMeasuredItemProvider.m618getAndMeasure3p2s80s(i, i2, j);
        }
        throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: getAndMeasure-3p2s80s");
    }

    /* renamed from: getAndMeasure-3p2s80s  reason: not valid java name */
    public final LazyGridMeasuredItem m618getAndMeasure3p2s80s(int i, int i2, long j) {
        int m4829getMinHeightimpl;
        Object key = this.itemProvider.getKey(i);
        Object contentType = this.itemProvider.getContentType(i);
        List<Placeable> mo637measure0kLqBqw = this.measureScope.mo637measure0kLqBqw(i, j);
        if (Constraints.m4826getHasFixedWidthimpl(j)) {
            m4829getMinHeightimpl = Constraints.m4830getMinWidthimpl(j);
        } else if (!Constraints.m4825getHasFixedHeightimpl(j)) {
            throw new IllegalArgumentException("Failed requirement.".toString());
        } else {
            m4829getMinHeightimpl = Constraints.m4829getMinHeightimpl(j);
        }
        return createItem(i, key, contentType, m4829getMinHeightimpl, i2, mo637measure0kLqBqw);
    }
