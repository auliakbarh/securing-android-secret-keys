...
public final class DateRangePickerDefaults {
    ...
    public static final /* synthetic */ void access$DateRangePickerHeadline(DateRangePickerDefaults dateRangePickerDefaults, DateRangePickerState dateRangePickerState, DatePickerFormatter datePickerFormatter, Modifier modifier, String str, String str2, Function2 function2, Function2 function22, Function2 function23, Composer composer, int i) {
        dateRangePickerDefaults.DateRangePickerHeadline(dateRangePickerState, datePickerFormatter, modifier, str, str2, function2, function22, function23, composer, i);
    }
    ...
    public final void DateRangePickerHeadline(final DateRangePickerState dateRangePickerState, final DatePickerFormatter datePickerFormatter, final Modifier modifier, final String str, final String str2, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, Composer composer, final int i) {
        ...
        if ((23967451 & i3) != 4793490 || !startRestartGroup.getSkipping()) {
            ...
            if (formatDate$material3_release == null) {
                int m1171unboximpl = stateData$material3_release.getDisplayMode().getValue().m1171unboximpl();
                if (DisplayMode.m1168equalsimpl0(m1171unboximpl, DisplayMode.Companion.m1173getPickerjFl4v0())) {
                    startRestartGroup.startReplaceableGroup(1922096411);
                    ComposerKt.sourceInformation(startRestartGroup, "398@17129L51");
                    formatDate$material3_release = Strings_androidKt.m1464getStringNWtq28(Strings.Companion.m1419getDatePickerNoSelectionDescriptionadMyvUU(), startRestartGroup, 6);
                    startRestartGroup.endReplaceableGroup();
                } else if (DisplayMode.m1168equalsimpl0(m1171unboximpl, DisplayMode.Companion.m1172getInputjFl4v0())) {
                    startRestartGroup.startReplaceableGroup(1922096500);
                    ComposerKt.sourceInformation(startRestartGroup, "399@17218L46");
                    formatDate$material3_release = Strings_androidKt.m1464getStringNWtq28(Strings.Companion.m1414getDateInputNoInputDescriptionadMyvUU(), startRestartGroup, 6);
                    startRestartGroup.endReplaceableGroup();
                } else {
            ...
            if (formatDate$material3_release2 == null) {
                int m1171unboximpl2 = stateData$material3_release.getDisplayMode().getValue().m1171unboximpl();
                if (DisplayMode.m1168equalsimpl0(m1171unboximpl2, DisplayMode.Companion.m1173getPickerjFl4v0())) {
                    startRestartGroup.startReplaceableGroup(1922096919);
                    ComposerKt.sourceInformation(startRestartGroup, "409@17637L51");
                    str3 = Strings_androidKt.m1464getStringNWtq28(Strings.Companion.m1419getDatePickerNoSelectionDescriptionadMyvUU(), startRestartGroup, 6);
                    startRestartGroup.endReplaceableGroup();
                } else if (DisplayMode.m1168equalsimpl0(m1171unboximpl2, DisplayMode.Companion.m1172getInputjFl4v0())) {
                    startRestartGroup.startReplaceableGroup(1922097008);
                    ComposerKt.sourceInformation(startRestartGroup, "410@17726L46");
                    str3 = Strings_androidKt.m1464getStringNWtq28(Strings.Companion.m1414getDateInputNoInputDescriptionadMyvUU(), startRestartGroup, 6);
                    startRestartGroup.endReplaceableGroup();
                } else {
            ...
            if (changed || rememberedValue == Composer.Companion.getEmpty()) {
                rememberedValue = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DateRangePickerDefaults$DateRangePickerHeadline$4$1$1
                    ...
                    public final void invoke2(SemanticsPropertyReceiver clearAndSetSemantics) {
                        ...
                        SemanticsPropertiesKt.m4258setLiveRegionhR3wRGc(clearAndSetSemantics, LiveRegionMode.Companion.m4237getPolite0phEisY());
            ...
            Arrangement.HorizontalOrVertical m390spacedBy0680j_4 = Arrangement.INSTANCE.m390spacedBy0680j_4(Dp.m4872constructorimpl(4));
            startRestartGroup.startReplaceableGroup(693286680);
            ComposerKt.sourceInformation(startRestartGroup, "CC(Row)P(2,1,3)78@3913L58,79@3976L130:Row.kt#2w3rfo");
            MeasurePolicy rowMeasurePolicy = RowKt.rowMeasurePolicy(m390spacedBy0680j_4, centerVertically, startRestartGroup, 54);
            ...
            if (formatDate$material3_release$default != null) {
                ...
                TextKt.m1551Text4IGK_g(formatDate$material3_release$default, (Modifier) null, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 0, 0, 131070);
            ...
            if (formatDate$material3_release$default2 != null) {
                ...
                TextKt.m1551Text4IGK_g(formatDate$material3_release$default2, (Modifier) null, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 0, 0, 131070);
                composer2.endReplaceableGroup();
            } else {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerDefaults$DateRangePickerHeadline$5
            ...
            public final void invoke(Composer composer3, int i4) {
                DateRangePickerDefaults.access$DateRangePickerHeadline(DateRangePickerDefaults.this, dateRangePickerState, datePickerFormatter, modifier, str, str2, function2, function22, function23, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
}