...
public final class TextUnitType {
    ...
    private static final long Unspecified = m5079constructorimpl(0);
    private static final long Sp = m5079constructorimpl(4294967296L);
    private static final long Em = m5079constructorimpl(8589934592L);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ TextUnitType m5078boximpl(long j) {
        return new TextUnitType(j);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m5079constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m5080equalsimpl(long j, Object obj) {
        return (obj instanceof TextUnitType) && j == ((TextUnitType) obj).m5084unboximpl();
    }
    ...
    public static int m5082hashCodeimpl(long j) {
        return Long.hashCode(j);
    }

    public boolean equals(Object obj) {
        return m5080equalsimpl(this.type, obj);
    }

    public int hashCode() {
        return m5082hashCodeimpl(this.type);
    }
    ...
    public String toString() {
        return m5083toStringimpl(this.type);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m5083toStringimpl(long j) {
        return m5081equalsimpl0(j, Unspecified) ? "Unspecified" : m5081equalsimpl0(j, Sp) ? "Sp" : m5081equalsimpl0(j, Em) ? "Em" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public final long m5087getUnspecifiedUIouoOA() {
            return TextUnitType.Unspecified;
        }

        /* renamed from: getSp-UIouoOA  reason: not valid java name */
        public final long m5086getSpUIouoOA() {
            return TextUnitType.Sp;
        }

        /* renamed from: getEm-UIouoOA  reason: not valid java name */
        public final long m5085getEmUIouoOA() {
