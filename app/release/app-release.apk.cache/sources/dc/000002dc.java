...
public final class Clickable_androidKt {
    ...
    public static final boolean m206isPressZmokQxo(KeyEvent isPress) {
        Intrinsics.checkNotNullParameter(isPress, "$this$isPress");
        return KeyEventType.m3607equalsimpl0(KeyEvent_androidKt.m3615getTypeZmokQxo(isPress), KeyEventType.Companion.m3611getKeyDownCS__XNY()) && m205isEnterZmokQxo(isPress);
    }

    /* renamed from: isClick-ZmokQxo  reason: not valid java name */
    public static final boolean m204isClickZmokQxo(KeyEvent isClick) {
        Intrinsics.checkNotNullParameter(isClick, "$this$isClick");
        return KeyEventType.m3607equalsimpl0(KeyEvent_androidKt.m3615getTypeZmokQxo(isClick), KeyEventType.Companion.m3612getKeyUpCS__XNY()) && m205isEnterZmokQxo(isClick);
    }

    /* renamed from: isEnter-ZmokQxo  reason: not valid java name */
    private static final boolean m205isEnterZmokQxo(KeyEvent keyEvent) {
        int m3621getNativeKeyCodeYVgTNJs = Key_androidKt.m3621getNativeKeyCodeYVgTNJs(KeyEvent_androidKt.m3614getKeyZmokQxo(keyEvent));
        return m3621getNativeKeyCodeYVgTNJs == 23 || m3621getNativeKeyCodeYVgTNJs == 66 || m3621getNativeKeyCodeYVgTNJs == 160;
    }
}