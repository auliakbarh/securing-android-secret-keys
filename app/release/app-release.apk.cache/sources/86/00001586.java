...
public abstract class Placeable implements Measured {
    ...
    private long apparentToRealOffset = IntOffset.Companion.m5000getZeronOccac();
    ...
    public abstract void mo3866placeAtf8xVGno(long j, float f, Function1<? super GraphicsLayerScope, Unit> function1);

    @Override // androidx.compose.ui.layout.Measured
    public int getMeasuredWidth() {
        return IntSize.m5032getWidthimpl(this.measuredSize);
    }

    @Override // androidx.compose.ui.layout.Measured
    public int getMeasuredHeight() {
        return IntSize.m5031getHeightimpl(this.measuredSize);
    }

    /* renamed from: setMeasuredSize-ozmzZPI */
    public final void m3920setMeasuredSizeozmzZPI(long j) {
        if (IntSize.m5030equalsimpl0(this.measuredSize, j)) {
            return;
        }
        this.measuredSize = j;
    ...
    private final void onMeasuredSizeChanged() {
        this.width = RangesKt.coerceIn(IntSize.m5032getWidthimpl(this.measuredSize), Constraints.m4830getMinWidthimpl(this.measurementConstraints), Constraints.m4828getMaxWidthimpl(this.measurementConstraints));
        this.height = RangesKt.coerceIn(IntSize.m5031getHeightimpl(this.measuredSize), Constraints.m4829getMinHeightimpl(this.measurementConstraints), Constraints.m4827getMaxHeightimpl(this.measurementConstraints));
        this.apparentToRealOffset = IntOffsetKt.IntOffset((this.width - IntSize.m5032getWidthimpl(this.measuredSize)) / 2, (this.height - IntSize.m5031getHeightimpl(this.measuredSize)) / 2);
    }

    /* renamed from: setMeasurementConstraints-BRTryo0 */
    public final void m3921setMeasurementConstraintsBRTryo0(long j) {
        if (Constraints.m4821equalsimpl0(this.measurementConstraints, j)) {
            return;
        }
    ...
    public static abstract class PlacementScope {
        ...
        public static /* synthetic */ void m3923placeRelative70tqf50$default(PlacementScope placementScope, Placeable placeable, long j, float f, int i, Object obj) {
            if (obj != null) {
            ...
            placementScope.m3929placeRelative70tqf50(placeable, j, f);
        }
        ...
        public final void placeRelative(Placeable placeable, int i, int i2, float f) {
            ...
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                ...
                placeable.mo3866placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4990getXimpl(IntOffset) + IntOffset.m4990getXimpl(j), IntOffset.m4991getYimpl(IntOffset) + IntOffset.m4991getYimpl(j)), f, null);
                return;
            }
            long IntOffset2 = IntOffsetKt.IntOffset((getParentWidth() - placeable.getWidth()) - IntOffset.m4990getXimpl(IntOffset), IntOffset.m4991getYimpl(IntOffset));
            long j2 = placeable.apparentToRealOffset;
            placeable.mo3866placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4990getXimpl(IntOffset2) + IntOffset.m4990getXimpl(j2), IntOffset.m4991getYimpl(IntOffset2) + IntOffset.m4991getYimpl(j2)), f, null);
        }
        ...
        public static /* synthetic */ void m3922place70tqf50$default(PlacementScope placementScope, Placeable placeable, long j, float f, int i, Object obj) {
            if (obj != null) {
            ...
            placementScope.m3926place70tqf50(placeable, j, f);
        }

        /* renamed from: placeRelativeWithLayer-aW-9-wM$default */
        public static /* synthetic */ void m3924placeRelativeWithLayeraW9wM$default(PlacementScope placementScope, Placeable placeable, long j, float f, Function1 function1, int i, Object obj) {
            ...
            placementScope.m3930placeRelativeWithLayeraW9wM(placeable, j, f2, function13);
        }
        ...
        public final void placeRelativeWithLayer(Placeable placeable, int i, int i2, float f, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            ...
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                long j = placeable.apparentToRealOffset;
                placeable.mo3866placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4990getXimpl(IntOffset) + IntOffset.m4990getXimpl(j), IntOffset.m4991getYimpl(IntOffset) + IntOffset.m4991getYimpl(j)), f, layerBlock);
                return;
            }
            long IntOffset2 = IntOffsetKt.IntOffset((getParentWidth() - placeable.getWidth()) - IntOffset.m4990getXimpl(IntOffset), IntOffset.m4991getYimpl(IntOffset));
            long j2 = placeable.apparentToRealOffset;
            placeable.mo3866placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4990getXimpl(IntOffset2) + IntOffset.m4990getXimpl(j2), IntOffset.m4991getYimpl(IntOffset2) + IntOffset.m4991getYimpl(j2)), f, layerBlock);
        }
        ...
        public static /* synthetic */ void m3925placeWithLayeraW9wM$default(PlacementScope placementScope, Placeable placeable, long j, float f, Function1 function1, int i, Object obj) {
            Function1 function12;
            if (obj != null) {
            ...
            placementScope.m3931placeWithLayeraW9wM(placeable, j, f2, function13);
        }

        /* renamed from: placeAutoMirrored-aW-9-wM$ui_release */
        public final void m3928placeAutoMirroredaW9wM$ui_release(Placeable placeAutoMirrored, long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
            Intrinsics.checkNotNullParameter(placeAutoMirrored, "$this$placeAutoMirrored");
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                long j2 = placeAutoMirrored.apparentToRealOffset;
                placeAutoMirrored.mo3866placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4990getXimpl(j) + IntOffset.m4990getXimpl(j2), IntOffset.m4991getYimpl(j) + IntOffset.m4991getYimpl(j2)), f, function1);
                return;
            }
            long IntOffset = IntOffsetKt.IntOffset((getParentWidth() - placeAutoMirrored.getWidth()) - IntOffset.m4990getXimpl(j), IntOffset.m4991getYimpl(j));
            long j3 = placeAutoMirrored.apparentToRealOffset;
            placeAutoMirrored.mo3866placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4990getXimpl(IntOffset) + IntOffset.m4990getXimpl(j3), IntOffset.m4991getYimpl(IntOffset) + IntOffset.m4991getYimpl(j3)), f, function1);
        }

        /* renamed from: placeApparentToRealOffset-aW-9-wM$ui_release */
        public final void m3927placeApparentToRealOffsetaW9wM$ui_release(Placeable placeApparentToRealOffset, long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
            ...
            placeApparentToRealOffset.mo3866placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4990getXimpl(j) + IntOffset.m4990getXimpl(j2), IntOffset.m4991getYimpl(j) + IntOffset.m4991getYimpl(j2)), f, function1);
        }
        ...
        public final void m3929placeRelative70tqf50(Placeable placeRelative, long j, float f) {
            Intrinsics.checkNotNullParameter(placeRelative, "$this$placeRelative");
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                long j2 = placeRelative.apparentToRealOffset;
                placeRelative.mo3866placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4990getXimpl(j) + IntOffset.m4990getXimpl(j2), IntOffset.m4991getYimpl(j) + IntOffset.m4991getYimpl(j2)), f, null);
                return;
            }
            long IntOffset = IntOffsetKt.IntOffset((getParentWidth() - placeRelative.getWidth()) - IntOffset.m4990getXimpl(j), IntOffset.m4991getYimpl(j));
            long j3 = placeRelative.apparentToRealOffset;
            placeRelative.mo3866placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4990getXimpl(IntOffset) + IntOffset.m4990getXimpl(j3), IntOffset.m4991getYimpl(IntOffset) + IntOffset.m4991getYimpl(j3)), f, null);
        }

        /* renamed from: place-70tqf50 */
        public final void m3926place70tqf50(Placeable place, long j, float f) {
            Intrinsics.checkNotNullParameter(place, "$this$place");
            long j2 = place.apparentToRealOffset;
            place.mo3866placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4990getXimpl(j) + IntOffset.m4990getXimpl(j2), IntOffset.m4991getYimpl(j) + IntOffset.m4991getYimpl(j2)), f, null);
        }

        /* renamed from: placeRelativeWithLayer-aW-9-wM */
        public final void m3930placeRelativeWithLayeraW9wM(Placeable placeRelativeWithLayer, long j, float f, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            Intrinsics.checkNotNullParameter(placeRelativeWithLayer, "$this$placeRelativeWithLayer");
            Intrinsics.checkNotNullParameter(layerBlock, "layerBlock");
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                long j2 = placeRelativeWithLayer.apparentToRealOffset;
                placeRelativeWithLayer.mo3866placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4990getXimpl(j) + IntOffset.m4990getXimpl(j2), IntOffset.m4991getYimpl(j) + IntOffset.m4991getYimpl(j2)), f, layerBlock);
                return;
            }
            long IntOffset = IntOffsetKt.IntOffset((getParentWidth() - placeRelativeWithLayer.getWidth()) - IntOffset.m4990getXimpl(j), IntOffset.m4991getYimpl(j));
            long j3 = placeRelativeWithLayer.apparentToRealOffset;
            placeRelativeWithLayer.mo3866placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4990getXimpl(IntOffset) + IntOffset.m4990getXimpl(j3), IntOffset.m4991getYimpl(IntOffset) + IntOffset.m4991getYimpl(j3)), f, layerBlock);
        }

        /* renamed from: placeWithLayer-aW-9-wM */
        public final void m3931placeWithLayeraW9wM(Placeable placeWithLayer, long j, float f, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            Intrinsics.checkNotNullParameter(placeWithLayer, "$this$placeWithLayer");
            Intrinsics.checkNotNullParameter(layerBlock, "layerBlock");
            long j2 = placeWithLayer.apparentToRealOffset;
            placeWithLayer.mo3866placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4990getXimpl(j) + IntOffset.m4990getXimpl(j2), IntOffset.m4991getYimpl(j) + IntOffset.m4991getYimpl(j2)), f, layerBlock);
        }
    }
}