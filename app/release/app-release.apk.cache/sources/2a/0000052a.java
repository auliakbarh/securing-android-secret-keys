...
final class MinIntrinsicHeightModifier implements IntrinsicSizeModifier {
    ...
    public long mo433calculateContentConstraintsl58MMJ0(MeasureScope calculateContentConstraints, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(calculateContentConstraints, "$this$calculateContentConstraints");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return Constraints.Companion.m4837fixedHeightOenEA2s(measurable.minIntrinsicHeight(Constraints.m4828getMaxWidthimpl(j)));
    }
