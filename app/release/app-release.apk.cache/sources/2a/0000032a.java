...
public final class MarqueeAnimationMode {
    ...
    private static final int Immediately = m221constructorimpl(0);
    private static final int WhileFocused = m221constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ MarqueeAnimationMode m220boximpl(int i) {
        return new MarqueeAnimationMode(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m221constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m222equalsimpl(int i, Object obj) {
        return (obj instanceof MarqueeAnimationMode) && i == ((MarqueeAnimationMode) obj).m226unboximpl();
    }
    ...
    public static int m224hashCodeimpl(int i) {
    ...
    public int hashCode() {
        return m224hashCodeimpl(this.value);
    }
    ...
    public String toString() {
        return m225toStringimpl(this.value);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m225toStringimpl(int i) {
        if (m223equalsimpl0(i, Immediately)) {
            return "Immediately";
        }
        if (m223equalsimpl0(i, WhileFocused)) {
            return "WhileFocused";
        }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m227getImmediatelyZbEOnfQ$annotations() {
        }

        /* renamed from: getWhileFocused-ZbEOnfQ$annotations  reason: not valid java name */
        public static /* synthetic */ void m228getWhileFocusedZbEOnfQ$annotations() {
        }
