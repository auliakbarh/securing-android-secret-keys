...
public final class AndroidPath implements Path {
    ...
    public int mo2521getFillTypeRgk1Os() {
        if (this.internalPath.getFillType() == Path.FillType.EVEN_ODD) {
            return PathFillType.Companion.m2904getEvenOddRgk1Os();
        }
        return PathFillType.Companion.m2905getNonZeroRgk1Os();
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: setFillType-oQ8Xj4U  reason: not valid java name */
    public void mo2523setFillTypeoQ8Xj4U(int i) {
        Path.FillType fillType;
        android.graphics.Path path = this.internalPath;
        if (PathFillType.m2900equalsimpl0(i, PathFillType.Companion.m2904getEvenOddRgk1Os())) {
    ...
    public void addRoundRect(RoundRect roundRect) {
        ...
        this.radii[0] = CornerRadius.m2364getXimpl(roundRect.m2439getTopLeftCornerRadiuskKHJgLs());
        this.radii[1] = CornerRadius.m2365getYimpl(roundRect.m2439getTopLeftCornerRadiuskKHJgLs());
        this.radii[2] = CornerRadius.m2364getXimpl(roundRect.m2440getTopRightCornerRadiuskKHJgLs());
        this.radii[3] = CornerRadius.m2365getYimpl(roundRect.m2440getTopRightCornerRadiuskKHJgLs());
        this.radii[4] = CornerRadius.m2364getXimpl(roundRect.m2438getBottomRightCornerRadiuskKHJgLs());
        this.radii[5] = CornerRadius.m2365getYimpl(roundRect.m2438getBottomRightCornerRadiuskKHJgLs());
        this.radii[6] = CornerRadius.m2364getXimpl(roundRect.m2437getBottomLeftCornerRadiuskKHJgLs());
        this.radii[7] = CornerRadius.m2365getYimpl(roundRect.m2437getBottomLeftCornerRadiuskKHJgLs());
    ...
    public void mo2525translatek4lQ0M(long j) {
        this.mMatrix.reset();
        this.mMatrix.setTranslate(Offset.m2389getXimpl(j), Offset.m2390getYimpl(j));
        this.internalPath.transform(this.mMatrix);
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: transform-58bKbWc  reason: not valid java name */
    public void mo2524transform58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        AndroidMatrixConversions_androidKt.m2500setFromEL8BTi8(this.mMatrix, matrix);
        this.internalPath.transform(this.mMatrix);
    }
    ...
    public boolean mo2522opN5in7k0(Path path1, Path path2, int i) {
        Path.Op op;
        Intrinsics.checkNotNullParameter(path1, "path1");
        Intrinsics.checkNotNullParameter(path2, "path2");
        if (PathOperation.m2909equalsimpl0(i, PathOperation.Companion.m2913getDifferenceb3I0S0c())) {
            op = Path.Op.DIFFERENCE;
        } else if (PathOperation.m2909equalsimpl0(i, PathOperation.Companion.m2914getIntersectb3I0S0c())) {
            op = Path.Op.INTERSECT;
        } else if (PathOperation.m2909equalsimpl0(i, PathOperation.Companion.m2915getReverseDifferenceb3I0S0c())) {
            op = Path.Op.REVERSE_DIFFERENCE;
        } else {
            op = PathOperation.m2909equalsimpl0(i, PathOperation.Companion.m2916getUnionb3I0S0c()) ? Path.Op.UNION : Path.Op.XOR;
        }
        android.graphics.Path path = this.internalPath;
    ...
    public void mo2520addPathUv8p0NA(Path path, long j) {
        Intrinsics.checkNotNullParameter(path, "path");
        android.graphics.Path path2 = this.internalPath;
        if (path instanceof AndroidPath) {
            path2.addPath(((AndroidPath) path).getInternalPath(), Offset.m2389getXimpl(j), Offset.m2390getYimpl(j));
            return;
        }
        throw new UnsupportedOperationException("Unable to obtain android.graphics.Path");
    }
