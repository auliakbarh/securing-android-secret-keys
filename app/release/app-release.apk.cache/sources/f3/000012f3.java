...
public final class FocusOwnerImpl implements FocusOwner {
    ...
    public void clearFocus(boolean z, boolean z2) {
        ...
        if (!z) {
            int i = WhenMappings.$EnumSwitchMapping$0[FocusTransactionsKt.m2337performCustomClearFocusMxy_nc0(this.rootFocusNode, FocusDirection.Companion.m2318getExitdhqQ8s()).ordinal()];
            if (i == 1 || i == 2 || i == 3) {
                return;
            }
        }
    ...
    public boolean mo2326moveFocus3ESFkO8(final int i) {
        final FocusTargetNode findActiveFocusNode = FocusTraversalKt.findActiveFocusNode(this.rootFocusNode);
        if (findActiveFocusNode == null) {
            return false;
        }
        FocusRequester m2341customFocusSearchOMvw8 = FocusTraversalKt.m2341customFocusSearchOMvw8(findActiveFocusNode, i, getLayoutDirection());
        if (m2341customFocusSearchOMvw8 != FocusRequester.Companion.getDefault()) {
            return m2341customFocusSearchOMvw8 != FocusRequester.Companion.getCancel() && m2341customFocusSearchOMvw8.focus$ui_release();
        }
        final Ref.BooleanRef booleanRef = new Ref.BooleanRef();
        boolean m2342focusSearchsMXa3k8 = FocusTraversalKt.m2342focusSearchsMXa3k8(this.rootFocusNode, i, getLayoutDirection(), new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.focus.FocusOwnerImpl$moveFocus$foundNextItem$1
            ...
            public final Boolean invoke(FocusTargetNode destination) {
                        ...
                        while (parent$ui_release != null) {
                            if ((parent$ui_release.getKindSet$ui_release() & m4080constructorimpl) != 0) {
                                ...
                                while (node2 != null) {
                                    ...
                                    if ((node2.getKindSet$ui_release() & m4080constructorimpl) != 0 && (node2 instanceof DelegatingNode)) {
                                        int i2 = 0;
                ...
                int i3 = WhenMappings.$EnumSwitchMapping$0[FocusTransactionsKt.m2340performCustomRequestFocusMxy_nc0(destination, i).ordinal()];
                if (i3 != 1) {
                    if (i3 == 2 || i3 == 3) {
        ...
        return m2342focusSearchsMXa3k8 || m2330wrapAroundFocus3ESFkO8(i);
    }

    @Override // androidx.compose.ui.focus.FocusOwner
    /* renamed from: dispatchKeyEvent-ZmokQxo */
    public boolean mo2328dispatchKeyEventZmokQxo(KeyEvent keyEvent) {
        int i;
        NodeChain nodes$ui_release;
        Modifier.Node node;
        ...
        if (findActiveFocusNode != null) {
            ...
            if (lastLocalKeyInputNode == null) {
                int m4080constructorimpl = NodeKind.m4080constructorimpl(8192);
                if (!focusTargetNode.getNode().isAttached()) {
                    throw new IllegalStateException("visitAncestors called on an unattached node".toString());
                }
                Modifier.Node parent$ui_release = focusTargetNode.getNode().getParent$ui_release();
                        ...
                        while (parent$ui_release != null) {
                            if ((parent$ui_release.getKindSet$ui_release() & m4080constructorimpl) != 0) {
                                ...
                                while (node != null) {
                                    ...
                                    if ((node.getKindSet$ui_release() & m4080constructorimpl) != 0 && (node instanceof DelegatingNode)) {
                                        int i2 = 0;
            ...
            if (lastLocalKeyInputNode != null) {
                ...
                int m4080constructorimpl2 = NodeKind.m4080constructorimpl(8192);
                ...
                while (requireLayoutNode2 != null) {
                    if ((requireLayoutNode2.getNodes$ui_release().getHead$ui_release().getAggregateChildKindSet$ui_release() & m4080constructorimpl2) != 0) {
                        while (parent$ui_release2 != null) {
                            if ((parent$ui_release2.getKindSet$ui_release() & m4080constructorimpl2) != 0) {
                                ...
                                while (node3 != null) {
                                    if (node3 instanceof KeyInputModifierNode) {
                                        ...
                                        for (Modifier.Node delegate$ui_release2 = ((DelegatingNode) node3).getDelegate$ui_release(); delegate$ui_release2 != null; delegate$ui_release2 = delegate$ui_release2.getChild$ui_release()) {
                                            if ((delegate$ui_release2.getKindSet$ui_release() & m4080constructorimpl2) != 0) {
                                                i3++;
                                                if (i3 == 1) {
                ...
                if (arrayList != null && arrayList.size() - 1 >= 0) {
                    while (true) {
                        int i4 = i - 1;
                        if (((KeyInputModifierNode) arrayList.get(i)).mo142onPreKeyEventZmokQxo(keyEvent)) {
                            return true;
                        }
                        if (i4 < 0) {
                            break;
                ...
                while (node4 != null) {
                    if (node4 instanceof KeyInputModifierNode) {
                        if (((KeyInputModifierNode) node4).mo142onPreKeyEventZmokQxo(keyEvent)) {
                            return true;
                        }
                ...
                while (node5 != null) {
                    if (node5 instanceof KeyInputModifierNode) {
                        if (((KeyInputModifierNode) node5).mo140onKeyEventZmokQxo(keyEvent)) {
                            return true;
                        }
                    } else if ((node5.getKindSet$ui_release() & m4080constructorimpl2) != 0 && (node5 instanceof DelegatingNode)) {
                        int i6 = 0;
                    ...
                    node5 = DelegatableNodeKt.access$pop(mutableVector4);
                }
                if (arrayList != null) {
                    int size = arrayList.size();
                    for (int i7 = 0; i7 < size; i7++) {
                        if (((KeyInputModifierNode) arrayList.get(i7)).mo140onKeyEventZmokQxo(keyEvent)) {
                            return true;
                        }
                    }
                }
    ...
    public boolean mo2327dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent keyEvent) {
        ...
        if (findActiveFocusNode != null) {
            FocusTargetNode focusTargetNode = findActiveFocusNode;
            int m4080constructorimpl = NodeKind.m4080constructorimpl(131072);
            if (!focusTargetNode.getNode().isAttached()) {
                throw new IllegalStateException("visitAncestors called on an unattached node".toString());
            }
            Modifier.Node parent$ui_release = focusTargetNode.getNode().getParent$ui_release();
        ...
        if (softKeyboardInterceptionModifierNode != null) {
            ...
            int m4080constructorimpl2 = NodeKind.m4080constructorimpl(131072);
                        ...
                        if ((parent$ui_release2.getKindSet$ui_release() & m4080constructorimpl2) != 0) {
                            ...
                            while (node2 != null) {
                                if (node2 instanceof SoftKeyboardInterceptionModifierNode) {
                                    ...
                                    arrayList.add(node2);
                                } else if ((node2.getKindSet$ui_release() & m4080constructorimpl2) != 0 && (node2 instanceof DelegatingNode)) {
                                    int i3 = 0;
            ...
            if (arrayList != null && arrayList.size() - 1 >= 0) {
                while (true) {
                    int i4 = i - 1;
                    if (((SoftKeyboardInterceptionModifierNode) arrayList.get(i)).mo3302onPreInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                        return true;
                    }
                    if (i4 < 0) {
                        break;
            ...
            while (node3 != null) {
                if (node3 instanceof SoftKeyboardInterceptionModifierNode) {
                    if (((SoftKeyboardInterceptionModifierNode) node3).mo3302onPreInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                        return true;
                    }
                } else if ((node3.getKindSet$ui_release() & m4080constructorimpl2) != 0 && (node3 instanceof DelegatingNode)) {
                    int i5 = 0;
            ...
            while (node4 != null) {
                if (node4 instanceof SoftKeyboardInterceptionModifierNode) {
                    if (((SoftKeyboardInterceptionModifierNode) node4).mo3301onInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                        return true;
                    }
                } else if ((node4.getKindSet$ui_release() & m4080constructorimpl2) != 0 && (node4 instanceof DelegatingNode)) {
                    int i6 = 0;
            ...
            if (arrayList != null) {
                int size = arrayList.size();
                for (int i7 = 0; i7 < size; i7++) {
                    if (((SoftKeyboardInterceptionModifierNode) arrayList.get(i7)).mo3301onInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                        return true;
                    }
                }
            }
    ...
    public boolean dispatchRotaryEvent(RotaryScrollEvent event) {
        ...
        if (findActiveFocusNode != null) {
            FocusTargetNode focusTargetNode = findActiveFocusNode;
            int m4080constructorimpl = NodeKind.m4080constructorimpl(16384);
            if (!focusTargetNode.getNode().isAttached()) {
                throw new IllegalStateException("visitAncestors called on an unattached node".toString());
            }
            Modifier.Node parent$ui_release = focusTargetNode.getNode().getParent$ui_release();
        ...
        if (rotaryInputModifierNode != null) {
            ...
            int m4080constructorimpl2 = NodeKind.m4080constructorimpl(16384);
    ...
    private final boolean m2330wrapAroundFocus3ESFkO8(int i) {
        if (this.rootFocusNode.getFocusState().getHasFocus() && !this.rootFocusNode.getFocusState().isFocused() && (FocusDirection.m2308equalsimpl0(i, FocusDirection.Companion.m2321getNextdhqQ8s()) || FocusDirection.m2308equalsimpl0(i, FocusDirection.Companion.m2323getPreviousdhqQ8s()))) {
            clearFocus(false);
            if (this.rootFocusNode.getFocusState().isFocused()) {
                return mo2326moveFocus3ESFkO8(i);
            }
            return false;
        }
        return false;
    ...
    private final /* synthetic */ <T extends DelegatableNode> void m2329traverseAncestorsYYKmho(DelegatableNode delegatableNode, int i, Function1<? super T, Unit> function1, Function1<? super T, Unit> function12) {
        int i2;
        int i3;
        NodeChain nodes$ui_release;
    ...
    private final Modifier.Node lastLocalKeyInputNode(DelegatableNode delegatableNode) {
        int m4080constructorimpl = NodeKind.m4080constructorimpl(1024) | NodeKind.m4080constructorimpl(8192);
        if (!delegatableNode.getNode().isAttached()) {
        ...
        if ((node.getAggregateChildKindSet$ui_release() & m4080constructorimpl) != 0) {
            for (Modifier.Node child$ui_release = node.getChild$ui_release(); child$ui_release != null; child$ui_release = child$ui_release.getChild$ui_release()) {
                if ((child$ui_release.getKindSet$ui_release() & m4080constructorimpl) != 0) {
                    if ((NodeKind.m4080constructorimpl(1024) & child$ui_release.getKindSet$ui_release()) != 0) {
                        return node2;
                    }
