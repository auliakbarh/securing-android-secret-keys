...
public final class SuggestionChipDefaults {
    ...
    private static final float Height = SuggestionChipTokens.INSTANCE.m2126getContainerHeightD9Ej5fM();
    private static final float IconSize = SuggestionChipTokens.INSTANCE.m2135getLeadingIconSizeD9Ej5fM();

    /* renamed from: getHeight-D9Ej5fM  reason: not valid java name */
    public final float m1468getHeightD9Ej5fM() {
        return Height;
    }
    ...
    public final ChipColors m1471suggestionChipColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        ...
        long m2627copywmQWz5c$default = (i2 & 16) != 0 ? Color.m2627copywmQWz5c$default(ColorSchemeKt.toColor(SuggestionChipTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j5;
        long m2627copywmQWz5c$default2 = (i2 & 32) != 0 ? Color.m2627copywmQWz5c$default(ColorSchemeKt.toColor(SuggestionChipTokens.INSTANCE.getDisabledLeadingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j6;
        ...
        ChipColors chipColors = new ChipColors(m2663getTransparent0d7_KjU, color, color2, Color.Companion.m2664getUnspecified0d7_KjU(), m2663getTransparent0d7_KjU2, m2627copywmQWz5c$default, m2627copywmQWz5c$default2, Color.Companion.m2664getUnspecified0d7_KjU(), null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ChipElevation m1472suggestionChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float m2133getFlatContainerElevationD9Ej5fM = (i2 & 1) != 0 ? SuggestionChipTokens.INSTANCE.m2133getFlatContainerElevationD9Ej5fM() : f;
        float f7 = (i2 & 2) != 0 ? m2133getFlatContainerElevationD9Ej5fM : f2;
        float f8 = (i2 & 4) != 0 ? m2133getFlatContainerElevationD9Ej5fM : f3;
        float f9 = (i2 & 8) != 0 ? m2133getFlatContainerElevationD9Ej5fM : f4;
        float m2127getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? SuggestionChipTokens.INSTANCE.m2127getDraggedContainerElevationD9Ej5fM() : f5;
        float f10 = (i2 & 32) != 0 ? m2133getFlatContainerElevationD9Ej5fM : f6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ChipElevation chipElevation = new ChipElevation(m2133getFlatContainerElevationD9Ej5fM, f7, f8, f9, m2127getDraggedContainerElevationD9Ej5fM, f10, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ChipBorder m1470suggestionChipBorderd_3_b6Q(long j, long j2, float f, Composer composer, int i, int i2) {
        ...
        long m2627copywmQWz5c$default = (i2 & 2) != 0 ? Color.m2627copywmQWz5c$default(ColorSchemeKt.toColor(SuggestionChipTokens.INSTANCE.getFlatDisabledOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j2;
        float m2134getFlatOutlineWidthD9Ej5fM = (i2 & 4) != 0 ? SuggestionChipTokens.INSTANCE.m2134getFlatOutlineWidthD9Ej5fM() : f;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ChipBorder chipBorder = new ChipBorder(color, m2627copywmQWz5c$default, m2134getFlatOutlineWidthD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ChipColors m1466elevatedSuggestionChipColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        ...
        long m1047getOnSurfaceVariant0d7_KjU = (i2 & 4) != 0 ? MaterialTheme.INSTANCE.getColorScheme(composer, 6).m1047getOnSurfaceVariant0d7_KjU() : j3;
        long m2627copywmQWz5c$default = (i2 & 8) != 0 ? Color.m2627copywmQWz5c$default(ColorSchemeKt.toColor(SuggestionChipTokens.INSTANCE.getElevatedDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        long m2627copywmQWz5c$default2 = (i2 & 16) != 0 ? Color.m2627copywmQWz5c$default(ColorSchemeKt.toColor(SuggestionChipTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j5;
        long m2627copywmQWz5c$default3 = (i2 & 32) != 0 ? Color.m2627copywmQWz5c$default(MaterialTheme.INSTANCE.getColorScheme(composer, 6).m1046getOnSurface0d7_KjU(), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ChipColors chipColors = new ChipColors(color, color2, m1047getOnSurfaceVariant0d7_KjU, Color.Companion.m2664getUnspecified0d7_KjU(), m2627copywmQWz5c$default, m2627copywmQWz5c$default2, m2627copywmQWz5c$default3, Color.Companion.m2664getUnspecified0d7_KjU(), null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ChipElevation m1467elevatedSuggestionChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float m2128getElevatedContainerElevationD9Ej5fM = (i2 & 1) != 0 ? SuggestionChipTokens.INSTANCE.m2128getElevatedContainerElevationD9Ej5fM() : f;
        float m2132getElevatedPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? SuggestionChipTokens.INSTANCE.m2132getElevatedPressedContainerElevationD9Ej5fM() : f2;
        float m2130getElevatedFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? SuggestionChipTokens.INSTANCE.m2130getElevatedFocusContainerElevationD9Ej5fM() : f3;
        float m2131getElevatedHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? SuggestionChipTokens.INSTANCE.m2131getElevatedHoverContainerElevationD9Ej5fM() : f4;
        float m2127getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? SuggestionChipTokens.INSTANCE.m2127getDraggedContainerElevationD9Ej5fM() : f5;
        float m2129getElevatedDisabledContainerElevationD9Ej5fM = (i2 & 32) != 0 ? SuggestionChipTokens.INSTANCE.m2129getElevatedDisabledContainerElevationD9Ej5fM() : f6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ChipElevation chipElevation = new ChipElevation(m2128getElevatedContainerElevationD9Ej5fM, m2132getElevatedPressedContainerElevationD9Ej5fM, m2130getElevatedFocusContainerElevationD9Ej5fM, m2131getElevatedHoverContainerElevationD9Ej5fM, m2127getDraggedContainerElevationD9Ej5fM, m2129getElevatedDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
