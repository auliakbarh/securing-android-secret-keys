...
public final class RememberSaveableKt {
    ...
    public static final /* synthetic */ void access$requireCanBeSaved(SaveableStateRegistry saveableStateRegistry, Object obj) {
        requireCanBeSaved(saveableStateRegistry, obj);
    }

    /* renamed from: rememberSaveable */
    public static final <T> T m2275rememberSaveable(Object[] inputs, Saver<T, ? extends Object> saver, final String str, Function0<? extends T> init, Composer composer, int i, int i2) {
        ...
        if (saveableStateRegistry != null) {
            ...
            EffectsKt.DisposableEffect(saveableStateRegistry, str, new Function1<DisposableEffectScope, DisposableEffectResult>() { // from class: androidx.compose.runtime.saveable.RememberSaveableKt$rememberSaveable$1
                ...
                public final DisposableEffectResult invoke(DisposableEffectScope DisposableEffect) {
                    ...
                    RememberSaveableKt.access$requireCanBeSaved(SaveableStateRegistry.this, function0.invoke());
    ...
    public static final <T> MutableState<T> rememberSaveable(Object[] inputs, Saver<T, ? extends Object> stateSaver, String str, Function0<? extends MutableState<T>> init, Composer composer, int i, int i2) {
        ...
        MutableState<T> mutableState = (MutableState) m2275rememberSaveable(Arrays.copyOf(inputs, inputs.length), (Saver<Object, ? extends Object>) mutableStateSaver(stateSaver), str2, (Function0<? extends Object>) init, composer, (i & 896) | 8 | (i & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
