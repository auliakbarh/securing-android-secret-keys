...
public final class BackwardsCompatNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode, PointerInputModifierNode, ModifierLocalModifierNode, ModifierLocalReadScope, ParentDataModifierNode, LayoutAwareModifierNode, GlobalPositionAwareModifierNode, FocusEventModifierNode, FocusPropertiesModifierNode, FocusRequesterModifierNode, OwnerScope, BuildDrawCacheParams {
    ...
    private final void unInitializeModifier() {
        ...
        if ((NodeKind.m4080constructorimpl(32) & backwardsCompatNode.getKindSet$ui_release()) != 0) {
        ...
        if ((backwardsCompatNode.getKindSet$ui_release() & NodeKind.m4080constructorimpl(8)) != 0) {
    ...
    private final void initializeModifier(boolean z) {
        ...
        if ((NodeKind.m4080constructorimpl(4) & backwardsCompatNode.getKindSet$ui_release()) != 0) {
        ...
        if ((NodeKind.m4080constructorimpl(2) & backwardsCompatNode.getKindSet$ui_release()) != 0) {
        ...
        if ((NodeKind.m4080constructorimpl(128) & backwardsCompatNode.getKindSet$ui_release()) != 0) {
                    ...
                    DelegatableNodeKt.requireOwner(this).registerOnLayoutCompletedListener(new Owner.OnLayoutCompletedListener() { // from class: androidx.compose.ui.node.BackwardsCompatNode$initializeModifier$2
                        ...
                        public void onLayoutComplete() {
                            ...
                            if (layoutCoordinates == null) {
                                ...
                                backwardsCompatNode2.onPlaced(DelegatableNodeKt.m3978requireCoordinator64DMado(backwardsCompatNode2, NodeKind.m4080constructorimpl(128)));
                            }
                        }
                    });
                }
        ...
        if ((NodeKind.m4080constructorimpl(256) & backwardsCompatNode.getKindSet$ui_release()) != 0 && (element instanceof OnGloballyPositionedModifier)) {
        ...
        if ((NodeKind.m4080constructorimpl(16) & backwardsCompatNode.getKindSet$ui_release()) != 0 && (element instanceof PointerInputModifier)) {
            ((PointerInputModifier) element).getPointerInputFilter().setLayoutCoordinates$ui_release(getCoordinator$ui_release());
        }
        if ((NodeKind.m4080constructorimpl(8) & backwardsCompatNode.getKindSet$ui_release()) != 0) {
            DelegatableNodeKt.requireOwner(this).onSemanticsChange();
        }
    }
    ...
    public long mo2294getSizeNHjbRc() {
        return IntSizeKt.m5042toSizeozmzZPI(DelegatableNodeKt.m3978requireCoordinator64DMado(this, NodeKind.m4080constructorimpl(128)).mo3872getSizeYbymL2g());
    }
    ...
    public <T> T getCurrent(ModifierLocal<T> modifierLocal) {
        ...
        BackwardsCompatNode backwardsCompatNode = this;
        int m4080constructorimpl = NodeKind.m4080constructorimpl(32);
    ...
    public MeasureResult mo236measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        return ((LayoutModifier) element).mo36measure3p2s80s(measure, measurable, j);
    }
    ...
    public void mo141onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long j) {
        ...
        ((PointerInputModifier) element).getPointerInputFilter().mo3768onPointerEventH0pRuoY(pointerEvent, pass, j);
    }
    ...
    public void mo3963onRemeasuredozmzZPI(long j) {
        Modifier.Element element = this.element;
        if (element instanceof OnRemeasuredModifier) {
            ((OnRemeasuredModifier) element).mo249onRemeasuredozmzZPI(j);
        }
    }
