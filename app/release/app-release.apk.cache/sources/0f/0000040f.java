        ...
        public static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    Offset m2378boximpl = Offset.m2378boximpl(this.$down.m3747getPositionF1C5BW0());
                    this.label = 1;
                    if (function3.invoke(pressGestureScopeImpl, m2378boximpl, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else if (i != 1) {
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        ...
        public static final class AnonymousClass8 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> function3 = this.$onPress;
                    PressGestureScopeImpl pressGestureScopeImpl = this.$pressScope;
                    Offset m2378boximpl = Offset.m2378boximpl(this.$secondDown.m3747getPositionF1C5BW0());
                    this.label = 1;
                    if (function3.invoke(pressGestureScopeImpl, m2378boximpl, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
        ...
        public static final class AnonymousClass9 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (pointerInputChange == null) {
                    ...
                    if (function1 != null) {
                        function1.invoke(Offset.m2378boximpl(this.$upOrCancel.element.m3747getPositionF1C5BW0()));
                        return Unit.INSTANCE;
                    }
                    return null;
                }
                ...
                this.$onDoubleTap.invoke(Offset.m2378boximpl(pointerInputChange.m3747getPositionF1C5BW0()));
                return Unit.INSTANCE;
            }
