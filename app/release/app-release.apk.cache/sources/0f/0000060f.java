...
public final class LazyListMeasureKt {
    ...
    public static final LazyListMeasureResult m586measureLazyListCD5nmq0(int i, LazyListMeasuredItemProvider measuredItemProvider, int i2, int i3, int i4, int i5, int i6, int i7, float f, long j, boolean z, List<Integer> headerIndexes, Arrangement.Vertical vertical, Arrangement.Horizontal horizontal, boolean z2, Density density, LazyListItemPlacementAnimator placementAnimator, int i8, List<Integer> pinnedItems, Function3<? super Integer, ? super Integer, ? super Function1<? super Placeable.PlacementScope, Unit>, ? extends MeasureResult> layout) {
        ...
        if (i3 >= 0) {
            if (i4 >= 0) {
                if (i <= 0) {
                    return new LazyListMeasureResult(null, 0, false, 0.0f, layout.invoke(Integer.valueOf(Constraints.m4830getMinWidthimpl(j)), Integer.valueOf(Constraints.m4829getMinHeightimpl(j)), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.LazyListMeasureKt$measureLazyList$1
                ...
                int m4842constrainWidthK40F9xA = ConstraintsKt.m4842constrainWidthK40F9xA(j, z ? i49 : i11);
                if (z) {
                    i49 = i11;
                }
                int m4841constrainHeightK40F9xA = ConstraintsKt.m4841constrainHeightK40F9xA(j, i49);
                float f3 = f2;
                int i52 = i10;
                final List<LazyListMeasuredItem> calculateItemsOffsets = calculateItemsOffsets(arrayDeque2, createItemsBeforeList, createItemsAfterList, m4842constrainWidthK40F9xA, m4841constrainHeightK40F9xA, i11, i2, i15, z, vertical, horizontal, z2, density);
                int i53 = i11;
                LazyListMeasuredItem lazyListMeasuredItem4 = lazyListMeasuredItem;
                placementAnimator.onMeasured((int) f3, m4842constrainWidthK40F9xA, m4841constrainHeightK40F9xA, calculateItemsOffsets, measuredItemProvider, z);
                final LazyListMeasuredItem findOrComposeLazyListHeader = headerIndexes.isEmpty() ^ true ? LazyListHeadersKt.findOrComposeLazyListHeader(calculateItemsOffsets, measuredItemProvider, headerIndexes, i3, m4842constrainWidthK40F9xA, m4841constrainHeightK40F9xA) : null;
                boolean z4 = i52 < i || i53 > i2;
                MeasureResult invoke = layout.invoke(Integer.valueOf(m4842constrainWidthK40F9xA), Integer.valueOf(m4841constrainHeightK40F9xA), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.LazyListMeasureKt$measureLazyList$5
                    ...
                    public final void invoke2(Placeable.PlacementScope invoke2) {
                        ...
                        List<LazyListMeasuredItem> list = calculateItemsOffsets;
                        LazyListMeasuredItem lazyListMeasuredItem5 = findOrComposeLazyListHeader;
                        int size5 = list.size();
                        for (int i54 = 0; i54 < size5; i54++) {
                            LazyListMeasuredItem lazyListMeasuredItem6 = list.get(i54);
                ...
                return new LazyListMeasureResult(lazyListMeasuredItem4, i16, z4, f3, invoke, arrayList, i21, i27, i, z2, z ? Orientation.Vertical : Orientation.Horizontal, i4, i5);
            }
