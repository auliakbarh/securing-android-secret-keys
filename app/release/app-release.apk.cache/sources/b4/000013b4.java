...
public final class StampedPathEffectStyle {
    ...
    private static final int Translate = m2958constructorimpl(0);
    private static final int Rotate = m2958constructorimpl(1);
    private static final int Morph = m2958constructorimpl(2);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ StampedPathEffectStyle m2957boximpl(int i) {
        return new StampedPathEffectStyle(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m2958constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2959equalsimpl(int i, Object obj) {
        return (obj instanceof StampedPathEffectStyle) && i == ((StampedPathEffectStyle) obj).m2963unboximpl();
    }
    ...
    public static String m2962toStringimpl(int i) {
        return m2960equalsimpl0(i, Translate) ? "Translate" : m2960equalsimpl0(i, Rotate) ? "Rotate" : m2960equalsimpl0(i, Morph) ? "Morph" : "Unknown";
    }
}