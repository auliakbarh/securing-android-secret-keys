...
public final class BoxKt {
    ...
    private static final MeasurePolicy EmptyBoxMeasurePolicy = new MeasurePolicy() { // from class: androidx.compose.foundation.layout.BoxKt$EmptyBoxMeasurePolicy$1
        ...
        public final MeasureResult mo10measure3p2s80s(MeasureScope MeasurePolicy, List<? extends Measurable> list, long j) {
            Intrinsics.checkNotNullParameter(MeasurePolicy, "$this$MeasurePolicy");
            Intrinsics.checkNotNullParameter(list, "<anonymous parameter 0>");
            return MeasureScope.layout$default(MeasurePolicy, Constraints.m4830getMinWidthimpl(j), Constraints.m4829getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt$EmptyBoxMeasurePolicy$1$measure$1
    ...
    public static final /* synthetic */ boolean access$getMatchesParentSize(Measurable measurable) {
        return getMatchesParentSize(measurable);
    }
    ...
    public static final void Box(Modifier modifier, Alignment alignment, boolean z, Function3<? super BoxScope, ? super Composer, ? super Integer, Unit> content, Composer composer, int i, int i2) {
        ...
        modifierMaterializerOf.invoke(SkippableUpdater.m2253boximpl(SkippableUpdater.m2254constructorimpl(composer)), composer, Integer.valueOf((i4 >> 3) & 112));
    ...
    public static final MeasurePolicy boxMeasurePolicy(final Alignment alignment, final boolean z) {
        ...
        return new MeasurePolicy() { // from class: androidx.compose.foundation.layout.BoxKt$boxMeasurePolicy$1
            @Override // androidx.compose.ui.layout.MeasurePolicy
            /* renamed from: measure-3p2s80s */
            public final MeasureResult mo10measure3p2s80s(final MeasureScope MeasurePolicy, final List<? extends Measurable> measurables, long j) {
                ...
                if (measurables.isEmpty()) {
                    return MeasureScope.layout$default(MeasurePolicy, Constraints.m4830getMinWidthimpl(j), Constraints.m4829getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt$boxMeasurePolicy$1$measure$1
                        /* renamed from: invoke  reason: avoid collision after fix types in other method */
                        public final void invoke2(Placeable.PlacementScope layout) {
                            Intrinsics.checkNotNullParameter(layout, "$this$layout");
                        }
                ...
                long m4819copyZbe2FdA$default = z ? j : Constraints.m4819copyZbe2FdA$default(j, 0, 0, 0, 0, 10, null);
                if (measurables.size() == 1) {
                    final Measurable measurable = measurables.get(0);
                    if (!BoxKt.access$getMatchesParentSize(measurable)) {
                        Placeable mo3865measureBRTryo02 = measurable.mo3865measureBRTryo0(m4819copyZbe2FdA$default);
                        int max = Math.max(Constraints.m4830getMinWidthimpl(j), mo3865measureBRTryo02.getWidth());
                        i = Math.max(Constraints.m4829getMinHeightimpl(j), mo3865measureBRTryo02.getHeight());
                        mo3865measureBRTryo0 = mo3865measureBRTryo02;
                        m4830getMinWidthimpl = max;
                    } else {
                        m4830getMinWidthimpl = Constraints.m4830getMinWidthimpl(j);
                        int m4829getMinHeightimpl = Constraints.m4829getMinHeightimpl(j);
                        mo3865measureBRTryo0 = measurable.mo3865measureBRTryo0(Constraints.Companion.m4836fixedJhjzzOo(Constraints.m4830getMinWidthimpl(j), Constraints.m4829getMinHeightimpl(j)));
                        i = m4829getMinHeightimpl;
                    }
                    final Alignment alignment2 = alignment;
                    final int i2 = m4830getMinWidthimpl;
                    final int i3 = i;
                    return MeasureScope.layout$default(MeasurePolicy, m4830getMinWidthimpl, i, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt$boxMeasurePolicy$1$measure$2
                        ...
                        public final void invoke2(Placeable.PlacementScope layout) {
                            Intrinsics.checkNotNullParameter(layout, "$this$layout");
                            BoxKt.access$placeInBox(layout, Placeable.this, measurable, MeasurePolicy.getLayoutDirection(), i2, i3, alignment2);
                        }
                    }, 4, null);
                }
                final Placeable[] placeableArr = new Placeable[measurables.size()];
                final Ref.IntRef intRef = new Ref.IntRef();
                intRef.element = Constraints.m4830getMinWidthimpl(j);
                final Ref.IntRef intRef2 = new Ref.IntRef();
                intRef2.element = Constraints.m4829getMinHeightimpl(j);
                ...
                for (int i4 = 0; i4 < size; i4++) {
                    ...
                    if (BoxKt.access$getMatchesParentSize(measurable2)) {
                        ...
                        Placeable mo3865measureBRTryo03 = measurable2.mo3865measureBRTryo0(m4819copyZbe2FdA$default);
                        placeableArr[i4] = mo3865measureBRTryo03;
                        intRef.element = Math.max(intRef.element, mo3865measureBRTryo03.getWidth());
                        intRef2.element = Math.max(intRef2.element, mo3865measureBRTryo03.getHeight());
                    }
                }
                if (z2) {
                    ...
                    for (int i5 = 0; i5 < size2; i5++) {
                        ...
                        if (BoxKt.access$getMatchesParentSize(measurable3)) {
                            placeableArr[i5] = measurable3.mo3865measureBRTryo0(Constraints);
                        }
                    }
                }
                ...
                return MeasureScope.layout$default(MeasurePolicy, i6, i7, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt$boxMeasurePolicy$1$measure$5
                    ...
                    public final void invoke2(Placeable.PlacementScope layout) {
                        ...
                        while (i9 < length) {
                            ...
                            BoxKt.access$placeInBox(layout, placeable, list.get(i8), measureScope.getLayoutDirection(), intRef3.element, intRef4.element, alignment4);
                            i9++;
                            i8++;
                        }
                    }
    ...
    public static final void placeInBox(Placeable.PlacementScope placementScope, Placeable placeable, Measurable measurable, LayoutDirection layoutDirection, int i, int i2, Alignment alignment) {
        ...
        Placeable.PlacementScope.m3922place70tqf50$default(placementScope, placeable, ((boxChildDataNode == null || (alignment2 = boxChildDataNode.getAlignment()) == null) ? alignment : alignment2).mo2279alignKFBX0sM(IntSizeKt.IntSize(placeable.getWidth(), placeable.getHeight()), IntSizeKt.IntSize(i, i2), layoutDirection), 0.0f, 2, null);
    }
    ...
    public static final void Box(final Modifier modifier, Composer composer, final int i) {
        ...
        if ((i2 & 11) != 2 || !startRestartGroup.getSkipping()) {
            ...
            modifierMaterializerOf.invoke(SkippableUpdater.m2253boximpl(SkippableUpdater.m2254constructorimpl(startRestartGroup)), startRestartGroup, Integer.valueOf((i3 >> 3) & 112));
