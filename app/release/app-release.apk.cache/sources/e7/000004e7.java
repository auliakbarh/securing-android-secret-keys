...
public final class FlowLayoutKt {
    ...
    public static final /* synthetic */ int access$intrinsicCrossAxisSize(List list, Function3 function3, Function3 function32, int i, int i2, int i3, int i4) {
        return intrinsicCrossAxisSize(list, function3, function32, i, i2, i3, i4);
    }

    public static final /* synthetic */ int access$maxIntrinsicMainAxisSize(List list, Function3 function3, int i, int i2, int i3) {
        return maxIntrinsicMainAxisSize(list, function3, i, i2, i3);
    }

    public static final /* synthetic */ int access$minIntrinsicMainAxisSize(List list, Function3 function3, Function3 function32, int i, int i2, int i3, int i4) {
        return minIntrinsicMainAxisSize(list, function3, function32, i, i2, i3, i4);
    }
    ...
    public static final void FlowRow(Modifier modifier, Arrangement.Horizontal horizontal, Arrangement.Vertical vertical, int i, Function3<? super FlowRowScope, ? super Composer, ? super Integer, Unit> content, Composer composer, int i2, int i3) {
        ...
        Updater.m2269setimpl(m2262constructorimpl, rowMeasurementHelper, ComposeUiNode.Companion.getSetMeasurePolicy());
        ...
        modifierMaterializerOf.invoke(SkippableUpdater.m2253boximpl(SkippableUpdater.m2254constructorimpl(composer)), composer, Integer.valueOf((i5 >> 3) & 112));
    ...
    public static final void FlowColumn(Modifier modifier, Arrangement.Vertical vertical, Arrangement.Horizontal horizontal, int i, Function3<? super FlowColumnScope, ? super Composer, ? super Integer, Unit> content, Composer composer, int i2, int i3) {
        ...
        Composer m2262constructorimpl = Updater.m2262constructorimpl(composer);
        Updater.m2269setimpl(m2262constructorimpl, columnMeasurementHelper, ComposeUiNode.Companion.getSetMeasurePolicy());
        Updater.m2269setimpl(m2262constructorimpl, currentCompositionLocalMap, ComposeUiNode.Companion.getSetResolvedCompositionLocals());
        Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash = ComposeUiNode.Companion.getSetCompositeKeyHash();
        if (m2262constructorimpl.getInserting() || !Intrinsics.areEqual(m2262constructorimpl.rememberedValue(), Integer.valueOf(currentCompositeKeyHash))) {
            m2262constructorimpl.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash));
    ...
    public static final MeasurePolicy rowMeasurementHelper(Arrangement.Horizontal horizontalArrangement, Arrangement.Vertical verticalArrangement, int i, Composer composer, int i2) {
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = m427flowMeasurePolicybs7tms(LayoutOrientation.Horizontal, getHorizontalArrangement(horizontalArrangement), horizontalArrangement.mo396getSpacingD9Ej5fM(), SizeMode.Wrap, CROSS_AXIS_ALIGNMENT_TOP, getVerticalArrangement(verticalArrangement), verticalArrangement.mo396getSpacingD9Ej5fM(), i);
    ...
    public static final MeasurePolicy columnMeasurementHelper(Arrangement.Vertical verticalArrangement, Arrangement.Horizontal horizontalArrangement, int i, Composer composer, int i2) {
        ...
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = m427flowMeasurePolicybs7tms(LayoutOrientation.Vertical, getVerticalArrangement(verticalArrangement), verticalArrangement.mo396getSpacingD9Ej5fM(), SizeMode.Wrap, CROSS_AXIS_ALIGNMENT_START, getHorizontalArrangement(horizontalArrangement), horizontalArrangement.mo396getSpacingD9Ej5fM(), i);
            composer.updateRememberedValue(rememberedValue);
        }
        composer.endReplaceableGroup();
        MeasurePolicy measurePolicy = (MeasurePolicy) rememberedValue;
    ...
    /* renamed from: flowMeasurePolicy-bs7tm-s */
    public static final MeasurePolicy m427flowMeasurePolicybs7tms(LayoutOrientation layoutOrientation, Function5<? super Integer, ? super int[], ? super LayoutDirection, ? super Density, ? super int[], Unit> function5, float f, SizeMode sizeMode, CrossAxisAlignment crossAxisAlignment, Function5<? super Integer, ? super int[], ? super LayoutDirection, ? super Density, ? super int[], Unit> function52, float f2, int i) {
        return new MeasurePolicy(function5, f, sizeMode, crossAxisAlignment, i, f2, function52) { // from class: androidx.compose.foundation.layout.FlowLayoutKt$flowMeasurePolicy$1
            ...
            public MeasureResult mo10measure3p2s80s(final MeasureScope measure, List<? extends Measurable> measurables, long j) {
                ...
                final FlowResult m426breakDownItemsw1Onq5I = FlowLayoutKt.m426breakDownItemsw1Onq5I(measure, rowColumnMeasurementHelper, LayoutOrientation.this, OrientationIndependentConstraints.m448constructorimpl(j, LayoutOrientation.this), this.$maxItemsInMainAxis);
                MutableVector<RowColumnMeasureHelperResult> items = m426breakDownItemsw1Onq5I.getItems();
                ...
                int crossAxisTotalSize = m426breakDownItemsw1Onq5I.getCrossAxisTotalSize() + (measure.mo318roundToPx0680j_4(this.$crossAxisArrangementSpacing) * (items.getSize() - 1));
                ...
                if (LayoutOrientation.this == LayoutOrientation.Horizontal) {
                    crossAxisTotalSize = m426breakDownItemsw1Onq5I.getMainAxisTotalSize();
                    mainAxisTotalSize = crossAxisTotalSize;
                } else {
                    mainAxisTotalSize = m426breakDownItemsw1Onq5I.getMainAxisTotalSize();
                }
                return MeasureScope.layout$default(measure, ConstraintsKt.m4842constrainWidthK40F9xA(j, crossAxisTotalSize), ConstraintsKt.m4841constrainHeightK40F9xA(j, mainAxisTotalSize), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutKt$flowMeasurePolicy$1$measure$2
                    /* JADX INFO: Access modifiers changed from: package-private */
            ...
            public int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> measurables, int i2) {
                ...
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                if (LayoutOrientation.this == LayoutOrientation.Horizontal) {
                    return minIntrinsicMainAxisSize(measurables, i2, intrinsicMeasureScope.mo318roundToPx0680j_4(this.$mainAxisArrangementSpacing), intrinsicMeasureScope.mo318roundToPx0680j_4(this.$crossAxisArrangementSpacing));
                }
                return intrinsicCrossAxisSize(measurables, i2, intrinsicMeasureScope.mo318roundToPx0680j_4(this.$mainAxisArrangementSpacing), intrinsicMeasureScope.mo318roundToPx0680j_4(this.$crossAxisArrangementSpacing));
            }
            ...
            public int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> measurables, int i2) {
                ...
                return maxIntrinsicMainAxisSize(measurables, i2, intrinsicMeasureScope.mo318roundToPx0680j_4(this.$mainAxisArrangementSpacing));
            }
            ...
            public final int minIntrinsicMainAxisSize(List<? extends IntrinsicMeasurable> measurables, int i2, int i3, int i4) {
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                return FlowLayoutKt.access$minIntrinsicMainAxisSize(measurables, this.minMainAxisIntrinsicItemSize, this.minCrossAxisIntrinsicItemSize, i2, i3, i4, this.$maxItemsInMainAxis);
            }

            public final int maxIntrinsicMainAxisSize(List<? extends IntrinsicMeasurable> measurables, int i2, int i3) {
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                return FlowLayoutKt.access$maxIntrinsicMainAxisSize(measurables, this.maxMainAxisIntrinsicItemSize, i2, i3, this.$maxItemsInMainAxis);
            }

            public final int intrinsicCrossAxisSize(List<? extends IntrinsicMeasurable> measurables, int i2, int i3, int i4) {
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                return FlowLayoutKt.access$intrinsicCrossAxisSize(measurables, this.minMainAxisIntrinsicItemSize, this.minCrossAxisIntrinsicItemSize, i2, i3, i4, this.$maxItemsInMainAxis);
            }
        };
    }
    ...
    private static final int m428measureAndCache6m2dt9o(Measurable measurable, long j, LayoutOrientation layoutOrientation, Function1<? super Placeable, Unit> function1) {
        if (RowColumnImplKt.getWeight(RowColumnImplKt.getRowColumnParentData(measurable)) == 0.0f) {
            Placeable mo3865measureBRTryo0 = measurable.mo3865measureBRTryo0(OrientationIndependentConstraints.m461toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m450copyyUG9Ft0$default(j, 0, 0, 0, 0, 14, null), layoutOrientation));
            function1.invoke(mo3865measureBRTryo0);
            return mainAxisSize(mo3865measureBRTryo0, layoutOrientation);
        }
    ...
    public static final FlowResult m426breakDownItemsw1Onq5I(MeasureScope breakDownItems, RowColumnMeasurementHelper measureHelper, LayoutOrientation orientation, long j, int i) {
        ...
        int ceil = (int) Math.ceil(breakDownItems.mo324toPx0680j_4(measureHelper.m505getArrangementSpacingD9Ej5fM()));
        long m446constructorimpl = OrientationIndependentConstraints.m446constructorimpl(m4830getMinWidthimpl, m4828getMaxWidthimpl, 0, m4827getMaxHeightimpl);
        Measurable measurable = (Measurable) CollectionsKt.getOrNull(measurables, 0);
        Integer valueOf = measurable != null ? Integer.valueOf(m428measureAndCache6m2dt9o(measurable, m446constructorimpl, orientation, new Function1<Placeable, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutKt$breakDownItems$nextSize$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
        ...
        while (i3 < size) {
            ...
            Integer valueOf2 = measurable2 != null ? Integer.valueOf(m428measureAndCache6m2dt9o(measurable2, m446constructorimpl, orientation, new Function1<Placeable, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutKt$breakDownItems$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
            ...
            int min = Math.min(Math.max(m4830getMinWidthimpl, i7), m4828getMaxWidthimpl);
            numArr[i6] = Integer.valueOf(i8);
            i6++;
            i2 = m4828getMaxWidthimpl;
            valueOf2 = valueOf2 != null ? Integer.valueOf(valueOf2.intValue() - ceil) : null;
            i5 = i8;
            i4 = 0;
            m4830getMinWidthimpl = min;
            i3 = i8;
            valueOf = valueOf2;
        }
        int i9 = m4830getMinWidthimpl;
        long m461toBoxConstraintsOenEA2s = OrientationIndependentConstraints.m461toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m450copyyUG9Ft0$default(m446constructorimpl, i9, 0, 0, 0, 14, null), orientation);
        int i10 = 0;
        int i11 = 0;
        int i12 = 0;
        Integer num = (Integer) ArraysKt.getOrNull(numArr, 0);
        while (num != null) {
            RowColumnMeasureHelperResult m506measureWithoutPlacing_EkL_Y = measureHelper.m506measureWithoutPlacing_EkL_Y(breakDownItems, m461toBoxConstraintsOenEA2s, i10, num.intValue());
            i11 += m506measureWithoutPlacing_EkL_Y.getCrossAxisSize();
            i9 = Math.max(i9, m506measureWithoutPlacing_EkL_Y.getMainAxisSize());
            mutableVector.add(m506measureWithoutPlacing_EkL_Y);
            i10 = num.intValue();
            i12++;
            num = (Integer) ArraysKt.getOrNull(numArr, i12);
        }
        return new FlowResult(Math.max(i9, Constraints.m4830getMinWidthimpl(j)), Math.max(i11, Constraints.m4829getMinHeightimpl(j)), mutableVector);
    }
}