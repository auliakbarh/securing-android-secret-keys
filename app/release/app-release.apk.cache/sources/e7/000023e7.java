...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m6474getAdjustmentUwyO8pc() {
    ...
    public TimeMark mo6471minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m6617minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo6470elapsedNowUwyO8pc() {
        return Duration.m6515minusLRDsOJo(this.mark.mo6470elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo6473plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m6516plusLRDsOJo(this.adjustment, j), null);
    }
}