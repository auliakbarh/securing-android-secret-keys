...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m6478getAdjustmentUwyO8pc() {
    ...
    public TimeMark mo6475minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m6621minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo6474elapsedNowUwyO8pc() {
        return Duration.m6519minusLRDsOJo(this.mark.mo6474elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo6477plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m6520plusLRDsOJo(this.adjustment, j), null);
    }
}