...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m6475getAdjustmentUwyO8pc() {
    ...
    public TimeMark mo6472minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m6618minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo6471elapsedNowUwyO8pc() {
        return Duration.m6516minusLRDsOJo(this.mark.mo6471elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo6474plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m6517plusLRDsOJo(this.adjustment, j), null);
    }
}