...
public final class PointerType {
    ...
    private static final int Unknown = m3816constructorimpl(0);
    private static final int Touch = m3816constructorimpl(1);
    private static final int Mouse = m3816constructorimpl(2);
    private static final int Stylus = m3816constructorimpl(3);
    private static final int Eraser = m3816constructorimpl(4);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ PointerType m3815boximpl(int i) {
        return new PointerType(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m3816constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m3817equalsimpl(int i, Object obj) {
        return (obj instanceof PointerType) && i == ((PointerType) obj).m3821unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m3818equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m3819hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m3820toStringimpl(int i) {
