...
public final class RenderEffectKt {
    ...
    public static /* synthetic */ BlurEffect m2930BlurEffect3YTHUZs$default(float f, float f2, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            i = TileMode.Companion.m2994getClamp3opZhB0();
        }
        return m2929BlurEffect3YTHUZs(f, f2, i);
    }

    /* renamed from: BlurEffect-3YTHUZs  reason: not valid java name */
    public static final BlurEffect m2929BlurEffect3YTHUZs(float f, float f2, int i) {
