...
public final class TextStyleKt {
    ...
    public static final int m4435resolveTextDirectionYj3eThk(LayoutDirection layoutDirection, TextDirection textDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        int m4779getContents_7Xco = TextDirection.Companion.m4779getContents_7Xco();
        if (textDirection != null && TextDirection.m4775equalsimpl0(textDirection.m4778unboximpl(), m4779getContents_7Xco)) {
            int i = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i != 1) {
                if (i == 2) {
                    return TextDirection.Companion.m4781getContentOrRtls_7Xco();
                }
                throw new NoWhenBranchMatchedException();
            }
            return TextDirection.Companion.m4780getContentOrLtrs_7Xco();
        } else if (textDirection == null) {
            int i2 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i2 != 1) {
                if (i2 == 2) {
                    return TextDirection.Companion.m4783getRtls_7Xco();
                }
                throw new NoWhenBranchMatchedException();
            }
            return TextDirection.Companion.m4782getLtrs_7Xco();
        } else {
            return textDirection.m4778unboximpl();
        }
    }
