...
public final class DateInputKt {
    ...
    private static final float InputTextNonErroneousBottomPadding = Dp.m4872constructorimpl(16);

    public static final /* synthetic */ void access$DateInputTextField_zm97o8M$lambda$4(MutableState mutableState, TextFieldValue textFieldValue) {
    ...
    public static final void DateInputContent(final StateData stateData, final DatePickerFormatter dateFormatter, final Function1<? super Long, Boolean> dateValidator, Composer composer, final int i) {
        ...
        if ((i4 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            String m1464getStringNWtq28 = Strings_androidKt.m1464getStringNWtq28(Strings.Companion.m1410getDateInputInvalidForPatternadMyvUU(), startRestartGroup, 6);
            String m1464getStringNWtq282 = Strings_androidKt.m1464getStringNWtq28(Strings.Companion.m1412getDateInputInvalidYearRangeadMyvUU(), startRestartGroup, 6);
            String m1464getStringNWtq283 = Strings_androidKt.m1464getStringNWtq28(Strings.Companion.m1411getDateInputInvalidNotAllowedadMyvUU(), startRestartGroup, 6);
            ...
            if (changed2 || rememberedValue2 == Composer.Companion.getEmpty()) {
                ...
                DateInputValidator dateInputValidator = new DateInputValidator(stateData, dateInputFormat2, dateFormatter, dateValidator, m1464getStringNWtq28, m1464getStringNWtq282, m1464getStringNWtq283, "");
            ...
            final String m1464getStringNWtq284 = Strings_androidKt.m1464getStringNWtq28(Strings.Companion.m1413getDateInputLabeladMyvUU(), startRestartGroup, i3);
            ...
            ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(startRestartGroup, -438341159, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputContent$1
                ...
                public final void invoke(Composer composer3, int i5) {
                    ...
                    String str2 = m1464getStringNWtq284;
                    Modifier.Companion companion = Modifier.Companion;
                    final String str3 = m1464getStringNWtq284;
                    ...
                    TextKt.m1551Text4IGK_g(str2, SemanticsModifierKt.semantics$default(companion, false, (Function1) rememberedValue3, 1, null), 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer3, 0, 0, 131068);
                    if (ComposerKt.isTraceInProgress()) {
            ...
            ComposableLambda composableLambda2 = ComposableLambdaKt.composableLambda(startRestartGroup, 1914447672, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputContent$2
                ...
                public final void invoke(Composer composer3, int i5) {
                    ...
                    TextKt.m1551Text4IGK_g(upperCase, SemanticsModifierKt.clearAndSetSemantics(Modifier.Companion, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputContent$2.1
                        /* renamed from: invoke  reason: avoid collision after fix types in other method */
            ...
            m1131DateInputTextFieldzm97o8M(padding, composableLambda, composableLambda2, stateData, value, (Function1) rememberedValue3, InputIdentifier.Companion.m1251getSingleDateInputJ2x2o4M(), dateInputValidator2, dateInputFormat, defaultLocale, startRestartGroup, ((i4 << 9) & 7168) | 1075315126);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    public static final void m1131DateInputTextFieldzm97o8M(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final StateData stateData, final CalendarDate calendarDate, final Function1<? super CalendarDate, Unit> onDateChanged, final int i, final DateInputValidator dateInputValidator, final DateInputFormat dateInputFormat, final Locale locale, Composer composer, final int i2) {
        ...
        final MutableState mutableState = (MutableState) RememberSaveableKt.m2275rememberSaveable(new Object[0], (Saver<Object, ? extends Object>) null, (String) null, (Function0<? extends Object>) new Function0<MutableState<String>>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$errorText$1
        ...
        final MutableState rememberSaveable = RememberSaveableKt.rememberSaveable(new Object[0], (Saver) TextFieldValue.Companion.getSaver(), (String) null, (Function0) new Function0<MutableState<TextFieldValue>>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$text$2
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            ...
            public final MutableState<TextFieldValue> invoke() {
                ...
                mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(new TextFieldValue((calendarDate2 == null || (r0 = stateData2.getCalendarModel().formatWithPattern(calendarDate2.getUtcTimeMillis(), dateInputFormat.getPatternWithoutDelimiters(), locale)) == null) ? "" : "", TextRangeKt.TextRange(0, 0), (TextRange) null, 4, (DefaultConstructorMarker) null), null, 2, null);
                return mutableStateOf$default;
            }
        ...
        Function1<TextFieldValue, Unit> function1 = new Function1<TextFieldValue, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$1
            ...
            public final void invoke2(TextFieldValue input) {
                ...
                if (input.getText().length() <= DateInputFormat.this.getPatternWithoutDelimiters().length()) {
                    ...
                    DateInputKt.access$DateInputTextField_zm97o8M$lambda$4(rememberSaveable, input);
                    ...
                    mutableState.setValue(dateInputValidator.m1132validateXivgLIo(parse, i, locale));
                    onDateChanged.invoke(mutableState.getValue().length() == 0 ? parse : null);
                }
            }
        };
        Modifier m483paddingqDBjuR0$default = PaddingKt.m483paddingqDBjuR0$default(modifier, 0.0f, 0.0f, 0.0f, StringsKt.isBlank((CharSequence) mutableState.getValue()) ^ true ? Dp.m4872constructorimpl(0) : InputTextNonErroneousBottomPadding, 7, null);
        startRestartGroup.startReplaceableGroup(1157296644);
        ComposerKt.sourceInformation(startRestartGroup, "CC(remember)P(1):Composables.kt#9igjgp");
        ...
        startRestartGroup.endReplaceableGroup();
        int i3 = i2 << 15;
        OutlinedTextFieldKt.OutlinedTextField(DateInputTextField_zm97o8M$lambda$3, (Function1<? super TextFieldValue, Unit>) function1, SemanticsModifierKt.semantics$default(m483paddingqDBjuR0$default, false, (Function1) rememberedValue, 1, null), false, false, (TextStyle) null, function2, function22, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda(startRestartGroup, 785795078, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$3
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
            ...
            public final void invoke(Composer composer2, int i4) {
                ...
                if (!StringsKt.isBlank(mutableState.getValue())) {
                    TextKt.m1551Text4IGK_g(mutableState.getValue(), (Modifier) null, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 0, 0, 131070);
                }
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
            }
        }), !StringsKt.isBlank((CharSequence) mutableState.getValue()), (VisualTransformation) new DateVisualTransformation(dateInputFormat), new KeyboardOptions(0, false, KeyboardType.Companion.m4611getNumberPjHm6EE(), ImeAction.Companion.m4563getDoneeUduSuo(), 1, null), (KeyboardActions) null, true, 0, 0, (MutableInteractionSource) null, (Shape) null, (TextFieldColors) null, startRestartGroup, (3670016 & i3) | (i3 & 29360128), 12779904, 0, 8195896);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$4
            ...
            public final void invoke(Composer composer2, int i4) {
                DateInputKt.m1131DateInputTextFieldzm97o8M(Modifier.this, function2, function22, stateData, calendarDate, onDateChanged, i, dateInputValidator, dateInputFormat, locale, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
            }
        });
    }
    ...
    static {
        float f = 24;
        InputTextFieldPadding = PaddingKt.m476PaddingValuesa9UjIt4$default(Dp.m4872constructorimpl(f), Dp.m4872constructorimpl(10), Dp.m4872constructorimpl(f), 0.0f, 8, null);
    }
}