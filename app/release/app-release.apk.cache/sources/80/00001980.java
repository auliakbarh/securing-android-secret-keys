...
public final class AndroidParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    public AndroidParagraphIntrinsics(String text, TextStyle style, List<AnnotatedString.Range<SpanStyle>> spanStyles, List<AnnotatedString.Range<Placeholder>> placeholders, FontFamily.Resolver fontFamilyResolver, Density density) {
        ...
        this.textDirectionHeuristic = AndroidParagraphIntrinsics_androidKt.m4631resolveTextDirectionHeuristics9GRLPo0(style.m4433getTextDirectionmmuk1to(), style.getLocaleList());
        Function4<FontFamily, FontWeight, FontStyle, FontSynthesis, Typeface> function4 = new Function4<FontFamily, FontWeight, FontStyle, FontSynthesis, Typeface>() { // from class: androidx.compose.ui.text.platform.AndroidParagraphIntrinsics$resolveTypeface$1
            ...
            public /* bridge */ /* synthetic */ Typeface invoke(FontFamily fontFamily, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis) {
                return m4630invokeDPcqOEQ(fontFamily, fontWeight, fontStyle.m4502unboximpl(), fontSynthesis.m4513unboximpl());
            }

            /* renamed from: invoke-DPcqOEQ  reason: not valid java name */
            public final Typeface m4630invokeDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int i, int i2) {
                Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
                State<Object> mo4474resolveDPcqOEQ = AndroidParagraphIntrinsics.this.getFontFamilyResolver().mo4474resolveDPcqOEQ(fontFamily, fontWeight, i, i2);
                if (!(mo4474resolveDPcqOEQ instanceof TypefaceResult.Immutable)) {
                    TypefaceDirtyTrackerLinkedList typefaceDirtyTrackerLinkedList = new TypefaceDirtyTrackerLinkedList(mo4474resolveDPcqOEQ, AndroidParagraphIntrinsics.access$getResolvedTypefaces$p(AndroidParagraphIntrinsics.this));
                    AndroidParagraphIntrinsics.access$setResolvedTypefaces$p(AndroidParagraphIntrinsics.this, typefaceDirtyTrackerLinkedList);
                    return typefaceDirtyTrackerLinkedList.getTypeface();
                }
                Object value = mo4474resolveDPcqOEQ.getValue();
    ...
    public static final /* synthetic */ TypefaceDirtyTrackerLinkedList access$getResolvedTypefaces$p(AndroidParagraphIntrinsics androidParagraphIntrinsics) {
        return androidParagraphIntrinsics.resolvedTypefaces;
    }

    public static final /* synthetic */ void access$setResolvedTypefaces$p(AndroidParagraphIntrinsics androidParagraphIntrinsics, TypefaceDirtyTrackerLinkedList typefaceDirtyTrackerLinkedList) {
