...
public final class ResourceFont implements Font {
    ...
    public static /* synthetic */ void m4535getLoadingStrategyPKNRLFQ$annotations() {
    }

    @Override // androidx.compose.ui.text.font.Font
    /* renamed from: getLoadingStrategy-PKNRLFQ */
    public int mo4446getLoadingStrategyPKNRLFQ() {
    ...
    public int mo4454getStyle_LCdwA() {
        return this.style;
    }
    ...
    */
    public /* synthetic */ ResourceFont(int r8, androidx.compose.ui.text.font.FontWeight r9, int r10, androidx.compose.ui.text.font.FontVariation.Settings r11, int r12, int r13, kotlin.jvm.internal.DefaultConstructorMarker r14) {
        ...
        La:
            ...
            int r10 = r9.m4504getNormal_LCdwA()
        L15:
            r3 = r10
            r9 = r13 & 8
            if (r9 == 0) goto L23
            ...
            androidx.compose.ui.text.font.FontVariation$Settings r11 = r9.m4519Settings6EWAqTQ(r2, r3, r10)
        L23:
            r4 = r11
            r9 = r13 & 16
            if (r9 == 0) goto L2e
            ...
            int r12 = r9.m4490getAsyncPKNRLFQ()
        L2e:
            r5 = r12
            r6 = 0
            r0 = r7
    ...
    public static /* synthetic */ ResourceFont m4534copyRetOiIg$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
        ...
        if ((i3 & 4) != 0) {
            i2 = resourceFont.mo4454getStyle_LCdwA();
        }
        return resourceFont.m4537copyRetOiIg(i, fontWeight, i2);
    }

    /* renamed from: copy-RetOiIg  reason: not valid java name */
    public final ResourceFont m4537copyRetOiIg(int i, FontWeight weight, int i2) {
        Intrinsics.checkNotNullParameter(weight, "weight");
        return m4533copyF3nL8kk$default(this, i, weight, i2, mo4446getLoadingStrategyPKNRLFQ(), null, 16, null);
    }

    /* renamed from: copy-F3nL8kk$default  reason: not valid java name */
    public static /* synthetic */ ResourceFont m4533copyF3nL8kk$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, FontVariation.Settings settings, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = resourceFont.resId;
        }
        if ((i4 & 2) != 0) {
        ...
        int i5 = i2;
        if ((i4 & 8) != 0) {
            i3 = resourceFont.mo4446getLoadingStrategyPKNRLFQ();
        }
        int i6 = i3;
        if ((i4 & 16) != 0) {
            settings = resourceFont.variationSettings;
        }
        return resourceFont.m4536copyF3nL8kk(i, fontWeight2, i5, i6, settings);
    }

    /* renamed from: copy-F3nL8kk  reason: not valid java name */
    public final ResourceFont m4536copyF3nL8kk(int i, FontWeight weight, int i2, int i3, FontVariation.Settings variationSettings) {
        Intrinsics.checkNotNullParameter(weight, "weight");
        Intrinsics.checkNotNullParameter(variationSettings, "variationSettings");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ResourceFont) {
            ...
            return this.resId == resourceFont.resId && Intrinsics.areEqual(getWeight(), resourceFont.getWeight()) && FontStyle.m4499equalsimpl0(mo4454getStyle_LCdwA(), resourceFont.mo4454getStyle_LCdwA()) && Intrinsics.areEqual(this.variationSettings, resourceFont.variationSettings) && FontLoadingStrategy.m4486equalsimpl0(mo4446getLoadingStrategyPKNRLFQ(), resourceFont.mo4446getLoadingStrategyPKNRLFQ());
        }
        return false;
    }

    public int hashCode() {
        return (((((((this.resId * 31) + getWeight().hashCode()) * 31) + FontStyle.m4500hashCodeimpl(mo4454getStyle_LCdwA())) * 31) + FontLoadingStrategy.m4487hashCodeimpl(mo4446getLoadingStrategyPKNRLFQ())) * 31) + this.variationSettings.hashCode();
    }

    public String toString() {
        return "ResourceFont(resId=" + this.resId + ", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m4501toStringimpl(mo4454getStyle_LCdwA())) + ", loadingStrategy=" + ((Object) FontLoadingStrategy.m4488toStringimpl(mo4446getLoadingStrategyPKNRLFQ())) + ')';
    }
}