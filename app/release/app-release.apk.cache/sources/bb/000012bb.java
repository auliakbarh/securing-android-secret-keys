...
public final class BlurredEdgeTreatment {
    ...
    private static final Shape Rectangle = m2286constructorimpl(RectangleShapeKt.getRectangleShape());
    private static final Shape Unbounded = m2286constructorimpl(null);
    private final Shape shape;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ BlurredEdgeTreatment m2285boximpl(Shape shape) {
        return new BlurredEdgeTreatment(shape);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static Shape m2286constructorimpl(Shape shape) {
        return shape;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2287equalsimpl(Shape shape, Object obj) {
        return (obj instanceof BlurredEdgeTreatment) && Intrinsics.areEqual(shape, ((BlurredEdgeTreatment) obj).m2291unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m2288equalsimpl0(Shape shape, Shape shape2) {
        return Intrinsics.areEqual(shape, shape2);
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m2289hashCodeimpl(Shape shape) {
        if (shape == null) {
            return 0;
        }
    ...
    public static String m2290toStringimpl(Shape shape) {
        return "BlurredEdgeTreatment(shape=" + shape + ')';
    }

    public boolean equals(Object obj) {
        return m2287equalsimpl(this.shape, obj);
    }
    ...
    public int hashCode() {
        return m2289hashCodeimpl(this.shape);
    }

    public String toString() {
        return m2290toStringimpl(this.shape);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ Shape m2291unboximpl() {
        return this.shape;
    }
