...
public final class TransformGestureDetectorKt {
    ...
    public static final float calculateRotation(PointerEvent pointerEvent) {
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            ...
            if (pointerInputChange2.getPressed() && pointerInputChange2.getPreviousPressed()) {
                long m3747getPositionF1C5BW0 = pointerInputChange2.m3747getPositionF1C5BW0();
                long m2393minusMKHz9U = Offset.m2393minusMKHz9U(pointerInputChange2.m3748getPreviousPositionF1C5BW0(), calculateCentroid2);
                long m2393minusMKHz9U2 = Offset.m2393minusMKHz9U(m3747getPositionF1C5BW0, calculateCentroid);
                float m350anglek4lQ0M = m350anglek4lQ0M(m2393minusMKHz9U2) - m350anglek4lQ0M(m2393minusMKHz9U);
                float m2387getDistanceimpl = Offset.m2387getDistanceimpl(Offset.m2394plusMKHz9U(m2393minusMKHz9U2, m2393minusMKHz9U)) / 2.0f;
                if (m350anglek4lQ0M > 180.0f) {
                    m350anglek4lQ0M -= 360.0f;
                } else if (m350anglek4lQ0M < -180.0f) {
                    m350anglek4lQ0M += 360.0f;
                }
                f2 += m350anglek4lQ0M * m2387getDistanceimpl;
                f += m2387getDistanceimpl;
            }
        }
        if (f == 0.0f) {
            return 0.0f;
    ...
    private static final float m350anglek4lQ0M(long j) {
        if (Offset.m2389getXimpl(j) == 0.0f && Offset.m2390getYimpl(j) == 0.0f) {
            return 0.0f;
        }
        return ((-((float) Math.atan2(Offset.m2389getXimpl(j), Offset.m2390getYimpl(j)))) * 180.0f) / 3.1415927f;
    }
    ...
    public static final long calculatePan(PointerEvent pointerEvent) {
        Intrinsics.checkNotNullParameter(pointerEvent, "<this>");
        long calculateCentroid = calculateCentroid(pointerEvent, true);
        if (Offset.m2386equalsimpl0(calculateCentroid, Offset.Companion.m2404getUnspecifiedF1C5BW0())) {
            return Offset.Companion.m2405getZeroF1C5BW0();
        }
        return Offset.m2393minusMKHz9U(calculateCentroid, calculateCentroid(pointerEvent, false));
    }
    ...
    public static final float calculateCentroidSize(PointerEvent pointerEvent, boolean z) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (pointerInputChange.getPressed() && pointerInputChange.getPreviousPressed()) {
                f += Offset.m2387getDistanceimpl(Offset.m2393minusMKHz9U(z ? pointerInputChange.m3747getPositionF1C5BW0() : pointerInputChange.m3748getPreviousPositionF1C5BW0(), calculateCentroid));
                i++;
            }
        }
        return f / i;
    ...
    public static final long calculateCentroid(PointerEvent pointerEvent, boolean z) {
        Intrinsics.checkNotNullParameter(pointerEvent, "<this>");
        long m2405getZeroF1C5BW0 = Offset.Companion.m2405getZeroF1C5BW0();
        List<PointerInputChange> changes = pointerEvent.getChanges();
        int size = changes.size();
        int i = 0;
        for (int i2 = 0; i2 < size; i2++) {
            PointerInputChange pointerInputChange = changes.get(i2);
            if (pointerInputChange.getPressed() && pointerInputChange.getPreviousPressed()) {
                m2405getZeroF1C5BW0 = Offset.m2394plusMKHz9U(m2405getZeroF1C5BW0, z ? pointerInputChange.m3747getPositionF1C5BW0() : pointerInputChange.m3748getPreviousPositionF1C5BW0());
                i++;
            }
        }
        if (i == 0) {
        ...
        return Offset.m2384divtuRUvjQ(m2405getZeroF1C5BW0, i);
    }
}