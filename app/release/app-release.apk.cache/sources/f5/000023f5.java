...
public final class LongSaturatedMathKt {
    ...
    public static final long m6613saturatingAddNuflL3o(long j, DurationUnit unit, long j2) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        long m6530toLongimpl = Duration.m6530toLongimpl(j2, unit);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m6612checkInfiniteSumDefinedPjuGub4(j, j2, m6530toLongimpl);
        }
        if ((1 | (m6530toLongimpl - 1)) == Long.MAX_VALUE) {
            return m6614saturatingAddInHalvesNuflL3o(j, unit, j2);
        }
        long j3 = j + m6530toLongimpl;
        return ((j ^ j3) & (m6530toLongimpl ^ j3)) < 0 ? j < 0 ? Long.MIN_VALUE : Long.MAX_VALUE : j3;
    }

    /* renamed from: checkInfiniteSumDefined-PjuGub4  reason: not valid java name */
    private static final long m6612checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
        if (!Duration.m6516isInfiniteimpl(j2) || (j ^ j3) >= 0) {
            return j;
        }
    ...
    private static final long m6614saturatingAddInHalvesNuflL3o(long j, DurationUnit durationUnit, long j2) {
        long m6487divUwyO8pc = Duration.m6487divUwyO8pc(j2, 2);
        long m6530toLongimpl = Duration.m6530toLongimpl(m6487divUwyO8pc, durationUnit);
        return (1 | (m6530toLongimpl - 1)) == Long.MAX_VALUE ? m6530toLongimpl : m6613saturatingAddNuflL3o(m6613saturatingAddNuflL3o(j, durationUnit, m6487divUwyO8pc), durationUnit, Duration.m6519minusLRDsOJo(j2, m6487divUwyO8pc));
    }

    private static final long infinityOfSign(long j) {
        return j < 0 ? Duration.Companion.m6586getNEG_INFINITEUwyO8pc$kotlin_stdlib() : Duration.Companion.m6585getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long j, long j2, DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if ((1 | (j2 - 1)) == Long.MAX_VALUE) {
            return Duration.m6537unaryMinusUwyO8pc(infinityOfSign(j2));
        }
    ...
    public static final long saturatingOriginsDiff(long j, long j2, DurationUnit unit) {
        ...
        if (((j2 - 1) | 1) == Long.MAX_VALUE) {
            if (j == j2) {
                return Duration.Companion.m6587getZEROUwyO8pc();
            }
            return Duration.m6537unaryMinusUwyO8pc(infinityOfSign(j2));
    ...
    private static final long saturatingFiniteDiff(long j, long j2, DurationUnit durationUnit) {
        ...
        if (((j3 ^ j) & (~(j3 ^ j2))) < 0) {
            if (durationUnit.compareTo(DurationUnit.MILLISECONDS) < 0) {
                ...
                return Duration.m6520plusLRDsOJo(DurationKt.toDuration((j / convertDurationUnit) - (j2 / convertDurationUnit), DurationUnit.MILLISECONDS), DurationKt.toDuration(j4, durationUnit));
            }
            return Duration.m6537unaryMinusUwyO8pc(infinityOfSign(j3));
        }
