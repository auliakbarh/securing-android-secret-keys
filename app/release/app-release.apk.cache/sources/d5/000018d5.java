...
public final class FontFamilyResolverImpl implements FontFamily.Resolver {
    ...
    public FontFamilyResolverImpl(PlatformFontLoader platformFontLoader, PlatformResolveInterceptor platformResolveInterceptor, TypefaceRequestCache typefaceRequestCache, FontListFontFamilyTypefaceAdapter fontListFontFamilyTypefaceAdapter, PlatformFontFamilyTypefaceAdapter platformFamilyTypefaceAdapter) {
        ...
        this.createDefaultTypeface = new Function1<TypefaceRequest, Object>() { // from class: androidx.compose.ui.text.font.FontFamilyResolverImpl$createDefaultTypeface$1
            ...
            public final Object invoke(TypefaceRequest it) {
                ...
                return FontFamilyResolverImpl.access$resolve(FontFamilyResolverImpl.this, TypefaceRequest.m4538copye1PVR60$default(it, null, null, 0, 0, null, 30, null)).getValue();
            }
        };
    }

    public static final /* synthetic */ State access$resolve(FontFamilyResolverImpl fontFamilyResolverImpl, TypefaceRequest typefaceRequest) {
        return fontFamilyResolverImpl.resolve(typefaceRequest);
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:52:0x0073 A[LOOP:0: B:51:0x0071->B:52:0x0073, LOOP_END] */
    ...
    */
    ...
    public State<Object> mo4474resolveDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int i, int i2) {
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        return resolve(new TypefaceRequest(this.platformResolveInterceptor.interceptFontFamily(fontFamily), this.platformResolveInterceptor.interceptFontWeight(fontWeight), this.platformResolveInterceptor.m4522interceptFontStyleT2F_aPo(i), this.platformResolveInterceptor.m4523interceptFontSynthesisMscr08Y(i2), this.platformFontLoader.getCacheKey(), null));
    }
