...
final class DerivedHeightModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    public MeasureResult mo36measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        final Placeable mo3865measureBRTryo0 = measurable.mo3865measureBRTryo0(Constraints.m4819copyZbe2FdA$default(j, 0, 0, intValue, intValue, 3, null));
        return MeasureScope.layout$default(measure, mo3865measureBRTryo0.getWidth(), intValue, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.DerivedHeightModifier$measure$2
