...
public final class FontMatcher {
    ...
    public final List<Font> m4493matchFontRetOiIg(FontFamily fontFamily, FontWeight fontWeight, int i) {
        Intrinsics.checkNotNullParameter(fontFamily, "fontFamily");
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        if (!(fontFamily instanceof FontListFontFamily)) {
            throw new IllegalArgumentException("Only FontFamily instances that presents a list of Fonts can be used");
        }
        return m4494matchFontRetOiIg((FontListFontFamily) fontFamily, fontWeight, i);
    }

    /* renamed from: matchFont-RetOiIg  reason: not valid java name */
    public final List<Font> m4494matchFontRetOiIg(FontListFontFamily fontFamily, FontWeight fontWeight, int i) {
        Intrinsics.checkNotNullParameter(fontFamily, "fontFamily");
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        return m4495matchFontRetOiIg(fontFamily.getFonts(), fontWeight, i);
    }

    /* renamed from: matchFont-RetOiIg  reason: not valid java name */
    public final List<Font> m4495matchFontRetOiIg(List<? extends Font> fontList, FontWeight fontWeight, int i) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            Font font2 = font;
            if (Intrinsics.areEqual(font2.getWeight(), fontWeight) && FontStyle.m4499equalsimpl0(font2.mo4454getStyle_LCdwA(), i)) {
                arrayList.add(font);
            }
        }
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            ...
            if (FontStyle.m4499equalsimpl0(font3.mo4454getStyle_LCdwA(), i)) {
