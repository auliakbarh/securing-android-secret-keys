...
public final class HitTestResult implements List<Modifier.Node>, KMappedMarker {
    ...
    public final boolean hasHit() {
        long m3998findBestHitDistanceptXAw2c = m3998findBestHitDistanceptXAw2c();
        return DistanceAndInLayer.m3993getDistanceimpl(m3998findBestHitDistanceptXAw2c) < 0.0f && DistanceAndInLayer.m3995isInLayerimpl(m3998findBestHitDistanceptXAw2c);
    }
    ...
    public final boolean isHitInMinimumTouchTargetBetter(float f, boolean z) {
        ...
        return DistanceAndInLayer.m3989compareToS_HNhKs(m3998findBestHitDistanceptXAw2c(), DistanceAndInLayer) > 0;
    }

    /* renamed from: findBestHitDistance-ptXAw2c  reason: not valid java name */
    private final long m3998findBestHitDistanceptXAw2c() {
        long DistanceAndInLayer;
        ...
        if (i <= lastIndex) {
            while (true) {
                long m3990constructorimpl = DistanceAndInLayer.m3990constructorimpl(this.distanceFromEdgeAndInLayer[i]);
                if (DistanceAndInLayer.m3989compareToS_HNhKs(m3990constructorimpl, DistanceAndInLayer) < 0) {
                    DistanceAndInLayer = m3990constructorimpl;
                }
                if (DistanceAndInLayer.m3993getDistanceimpl(DistanceAndInLayer) < 0.0f && DistanceAndInLayer.m3995isInLayerimpl(DistanceAndInLayer)) {
    ...
    public final void hit(Modifier.Node node, boolean z, Function0<Unit> childHitTest) {
        Intrinsics.checkNotNullParameter(node, "node");
        Intrinsics.checkNotNullParameter(childHitTest, "childHitTest");
        hitInMinimumTouchTarget(node, -1.0f, z, childHitTest);
    }

    public final void hitInMinimumTouchTarget(Modifier.Node node, float f, boolean z, Function0<Unit> childHitTest) {
        long DistanceAndInLayer;
        Intrinsics.checkNotNullParameter(node, "node");
        Intrinsics.checkNotNullParameter(childHitTest, "childHitTest");
        int i = this.hitDepth;
    ...
    public final void speculativeHit(Modifier.Node node, float f, boolean z, Function0<Unit> childHitTest) {
        Intrinsics.checkNotNullParameter(node, "node");
        Intrinsics.checkNotNullParameter(childHitTest, "childHitTest");
        ...
        hitInMinimumTouchTarget(node, f, z, childHitTest);
        if (this.hitDepth + 1 < CollectionsKt.getLastIndex(hitTestResult) && DistanceAndInLayer.m3989compareToS_HNhKs(m3998findBestHitDistanceptXAw2c, m3998findBestHitDistanceptXAw2c()) > 0) {
