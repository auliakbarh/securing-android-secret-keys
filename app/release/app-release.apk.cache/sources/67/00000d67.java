...
public final class OutlinedTextFieldMeasurePolicy implements MeasurePolicy {
    ...
    public static final /* synthetic */ float access$getAnimationProgress$p(OutlinedTextFieldMeasurePolicy outlinedTextFieldMeasurePolicy) {
        return outlinedTextFieldMeasurePolicy.animationProgress;
    }

    public static final /* synthetic */ PaddingValues access$getPaddingValues$p(OutlinedTextFieldMeasurePolicy outlinedTextFieldMeasurePolicy) {
        return outlinedTextFieldMeasurePolicy.paddingValues;
    }

    public static final /* synthetic */ boolean access$getSingleLine$p(OutlinedTextFieldMeasurePolicy outlinedTextFieldMeasurePolicy) {
        return outlinedTextFieldMeasurePolicy.singleLine;
    }
    ...
    public MeasureResult mo10measure3p2s80s(final MeasureScope measure, List<? extends Measurable> measurables, long j) {
        ...
        Object obj6;
        Object obj7;
        final int m1325calculateWidthDHJA7U0;
        final int m1324calculateHeightDHJA7U0;
        Intrinsics.checkNotNullParameter(measure, "$this$measure");
        Intrinsics.checkNotNullParameter(measurables, "measurables");
        int i = measure.mo318roundToPx0680j_4(this.paddingValues.mo429calculateBottomPaddingD9Ej5fM());
        ...
        Placeable mo3865measureBRTryo03 = measurable3 != null ? measurable3.mo3865measureBRTryo0(ConstraintsKt.m4845offsetNN6EwU$default(m4819copyZbe2FdA$default, -widthOrZero2, 0, 2, null)) : null;
        int widthOrZero3 = widthOrZero2 + TextFieldImplKt.widthOrZero(mo3865measureBRTryo03);
        int max3 = Math.max(max2, TextFieldImplKt.heightOrZero(mo3865measureBRTryo03));
        ...
        if (measurable4 != null) {
            ...
            placeable2 = measurable4.mo3865measureBRTryo0(ConstraintsKt.m4845offsetNN6EwU$default(m4819copyZbe2FdA$default, -widthOrZero3, 0, 2, null));
        } else {
            placeable = mo3865measureBRTryo02;
            placeable2 = null;
        }
        ...
        int i2 = measure.mo318roundToPx0680j_4(this.paddingValues.mo430calculateLeftPaddingu2uoSUM(measure.getLayoutDirection())) + measure.mo318roundToPx0680j_4(this.paddingValues.mo431calculateRightPaddingu2uoSUM(measure.getLayoutDirection()));
        int i3 = z ? (-widthOrZero4) - i2 : -i2;
        int i4 = -i;
        long m4844offsetNN6EwU = ConstraintsKt.m4844offsetNN6EwU(m4819copyZbe2FdA$default, i3, i4);
        ...
        final Placeable mo3865measureBRTryo04 = measurable5 != null ? measurable5.mo3865measureBRTryo0(m4844offsetNN6EwU) : null;
        if (mo3865measureBRTryo04 != null) {
            this.onLabelMeasured.invoke(Size.m2446boximpl(SizeKt.Size(mo3865measureBRTryo04.getWidth(), mo3865measureBRTryo04.getHeight())));
        }
        int max5 = Math.max(TextFieldImplKt.heightOrZero(mo3865measureBRTryo04) / 2, measure.mo318roundToPx0680j_4(this.paddingValues.mo432calculateTopPaddingD9Ej5fM()));
        long m4819copyZbe2FdA$default2 = Constraints.m4819copyZbe2FdA$default(ConstraintsKt.m4844offsetNN6EwU(j, -widthOrZero4, i4 - max5), 0, 0, 0, 0, 11, null);
        ...
        while (it6.hasNext()) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable6), TextFieldImplKt.TextFieldId)) {
                final Placeable mo3865measureBRTryo05 = measurable6.mo3865measureBRTryo0(m4819copyZbe2FdA$default2);
                long m4819copyZbe2FdA$default3 = Constraints.m4819copyZbe2FdA$default(m4819copyZbe2FdA$default2, 0, 0, 0, 0, 14, null);
                ...
                Placeable mo3865measureBRTryo06 = measurable7 != null ? measurable7.mo3865measureBRTryo0(m4819copyZbe2FdA$default3) : null;
                long m4819copyZbe2FdA$default4 = Constraints.m4819copyZbe2FdA$default(ConstraintsKt.m4845offsetNN6EwU$default(m4819copyZbe2FdA$default, 0, -Math.max(max4, Math.max(TextFieldImplKt.heightOrZero(mo3865measureBRTryo05), TextFieldImplKt.heightOrZero(mo3865measureBRTryo06)) + max5 + i), 1, null), 0, 0, 0, 0, 11, null);
                ...
                Placeable mo3865measureBRTryo07 = measurable8 != null ? measurable8.mo3865measureBRTryo0(m4819copyZbe2FdA$default4) : null;
                int heightOrZero = TextFieldImplKt.heightOrZero(mo3865measureBRTryo07);
                m1325calculateWidthDHJA7U0 = OutlinedTextFieldKt.m1325calculateWidthDHJA7U0(TextFieldImplKt.widthOrZero(mo3865measureBRTryo0), TextFieldImplKt.widthOrZero(placeable), TextFieldImplKt.widthOrZero(mo3865measureBRTryo03), TextFieldImplKt.widthOrZero(placeable3), mo3865measureBRTryo05.getWidth(), TextFieldImplKt.widthOrZero(mo3865measureBRTryo04), TextFieldImplKt.widthOrZero(mo3865measureBRTryo06), z, j, measure.getDensity(), this.paddingValues);
                m1324calculateHeightDHJA7U0 = OutlinedTextFieldKt.m1324calculateHeightDHJA7U0(TextFieldImplKt.heightOrZero(mo3865measureBRTryo0), TextFieldImplKt.heightOrZero(placeable), TextFieldImplKt.heightOrZero(mo3865measureBRTryo03), TextFieldImplKt.heightOrZero(placeable3), mo3865measureBRTryo05.getHeight(), TextFieldImplKt.heightOrZero(mo3865measureBRTryo04), TextFieldImplKt.heightOrZero(mo3865measureBRTryo06), TextFieldImplKt.heightOrZero(mo3865measureBRTryo07), j, measure.getDensity(), this.paddingValues);
                int i5 = m1324calculateHeightDHJA7U0 - heightOrZero;
                for (Measurable measurable9 : list) {
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable9), TextFieldImplKt.ContainerId)) {
                        final Placeable mo3865measureBRTryo08 = measurable9.mo3865measureBRTryo0(ConstraintsKt.Constraints(m1325calculateWidthDHJA7U0 != Integer.MAX_VALUE ? m1325calculateWidthDHJA7U0 : 0, m1325calculateWidthDHJA7U0, i5 != Integer.MAX_VALUE ? i5 : 0, i5));
                        final Placeable placeable4 = mo3865measureBRTryo0;
                        final Placeable placeable5 = placeable;
                        final Placeable placeable6 = mo3865measureBRTryo03;
                        final Placeable placeable7 = placeable3;
                        final Placeable placeable8 = mo3865measureBRTryo06;
                        final Placeable placeable9 = mo3865measureBRTryo07;
                        return MeasureScope.layout$default(measure, m1325calculateWidthDHJA7U0, m1324calculateHeightDHJA7U0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.OutlinedTextFieldMeasurePolicy$measure$2
                            ...
                            public final void invoke2(Placeable.PlacementScope layout) {
                                ...
                                OutlinedTextFieldKt.place(layout, m1324calculateHeightDHJA7U0, m1325calculateWidthDHJA7U0, placeable4, placeable5, placeable6, placeable7, mo3865measureBRTryo05, mo3865measureBRTryo04, placeable8, mo3865measureBRTryo08, placeable9, OutlinedTextFieldMeasurePolicy.access$getAnimationProgress$p(this), OutlinedTextFieldMeasurePolicy.access$getSingleLine$p(this), measure.getDensity(), measure.getLayoutDirection(), OutlinedTextFieldMeasurePolicy.access$getPaddingValues$p(this));
                            }
                        }, 4, null);
                    }
                }
    ...
    private final int intrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        Object obj5;
        Object obj6;
        int m1325calculateWidthDHJA7U0;
        ...
        for (Object obj7 : list2) {
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) obj7), TextFieldImplKt.TextFieldId)) {
                ...
                m1325calculateWidthDHJA7U0 = OutlinedTextFieldKt.m1325calculateWidthDHJA7U0(intValue4, intValue3, intValue5, intValue6, intValue, intValue2, intrinsicMeasurable6 != null ? function2.invoke(intrinsicMeasurable6, Integer.valueOf(i)).intValue() : 0, this.animationProgress < 1.0f, TextFieldImplKt.getZeroConstraints(), intrinsicMeasureScope.getDensity(), this.paddingValues);
                return m1325calculateWidthDHJA7U0;
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
    ...
    private final int intrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        Object obj6;
        Object obj7;
        int m1324calculateHeightDHJA7U0;
        List<? extends IntrinsicMeasurable> list2 = list;
        for (Object obj8 : list2) {
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) obj8), TextFieldImplKt.TextFieldId)) {
                ...
                m1324calculateHeightDHJA7U0 = OutlinedTextFieldKt.m1324calculateHeightDHJA7U0(intValue4, intValue3, intValue5, intValue6, intValue, intValue2, intValue7, intrinsicMeasurable7 != null ? function2.invoke(intrinsicMeasurable7, Integer.valueOf(i)).intValue() : 0, TextFieldImplKt.getZeroConstraints(), intrinsicMeasureScope.getDensity(), this.paddingValues);
                return m1324calculateHeightDHJA7U0;
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
