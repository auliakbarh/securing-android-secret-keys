...
public final class KeyMapping_androidKt {
    private static final KeyMapping platformDefaultKeyMapping = new KeyMapping() { // from class: androidx.compose.foundation.text.KeyMapping_androidKt$platformDefaultKeyMapping$1
        ...
        public KeyCommand mo758mapZmokQxo(KeyEvent event) {
            Intrinsics.checkNotNullParameter(event, "event");
            KeyCommand keyCommand = null;
            if (KeyEvent_androidKt.m3620isShiftPressedZmokQxo(event) && KeyEvent_androidKt.m3617isAltPressedZmokQxo(event)) {
            ...
            return keyCommand == null ? KeyMappingKt.getDefaultKeyMapping().mo758mapZmokQxo(event) : keyCommand;
        }
    };
