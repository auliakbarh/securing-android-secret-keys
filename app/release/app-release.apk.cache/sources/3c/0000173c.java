...
public final class OutlineResolver {
    ...
    public OutlineResolver(Density density) {
        ...
        this.size = Size.Companion.m2467getZeroNHjbRc();
        this.shape = RectangleShapeKt.getRectangleShape();
        this.rectTopLeft = Offset.Companion.m2405getZeroF1C5BW0();
        this.rectSize = Size.Companion.m2467getZeroNHjbRc();
    ...
    public final boolean m4219isInOutlinek4lQ0M(long j) {
        androidx.compose.ui.graphics.Outline outline;
        if (this.outlineNeeded && (outline = this.calculatedOutline) != null) {
            return ShapeContainingUtilKt.isInOutline(outline, Offset.m2389getXimpl(j), Offset.m2390getYimpl(j), this.tmpTouchPointPath, this.tmpOpPath);
        }
        return true;
    }
    ...
    public final void clipToOutline(Canvas canvas) {
        ...
        if (clipPath != null) {
            Canvas.m2599clipPathmtrdDE$default(canvas, clipPath, 0, 2, null);
            return;
        }
        ...
        if (f > 0.0f) {
            ...
            if (path == null || !m4218isSameBounds4L21HEs(roundRect, this.rectTopLeft, this.rectSize, f)) {
                RoundRect m2443RoundRectgG7oq9Y = RoundRectKt.m2443RoundRectgG7oq9Y(Offset.m2389getXimpl(this.rectTopLeft), Offset.m2390getYimpl(this.rectTopLeft), Offset.m2389getXimpl(this.rectTopLeft) + Size.m2458getWidthimpl(this.rectSize), Offset.m2390getYimpl(this.rectTopLeft) + Size.m2455getHeightimpl(this.rectSize), CornerRadiusKt.CornerRadius$default(this.roundedCornerRadius, 0.0f, 2, null));
                if (path == null) {
                    path = AndroidPath_androidKt.Path();
                } else {
                    path.reset();
                }
                path.addRoundRect(m2443RoundRectgG7oq9Y);
                this.tmpRoundRect = m2443RoundRectgG7oq9Y;
                this.tmpPath = path;
            }
            Canvas.m2599clipPathmtrdDE$default(canvas, path, 0, 2, null);
            return;
        }
        Canvas.m2600clipRectN_I0leg$default(canvas, Offset.m2389getXimpl(this.rectTopLeft), Offset.m2390getYimpl(this.rectTopLeft), Offset.m2389getXimpl(this.rectTopLeft) + Size.m2458getWidthimpl(this.rectSize), Offset.m2390getYimpl(this.rectTopLeft) + Size.m2455getHeightimpl(this.rectSize), 0, 16, null);
    }

    /* renamed from: update-uvyYCjk  reason: not valid java name */
    public final void m4220updateuvyYCjk(long j) {
        if (Size.m2454equalsimpl0(this.size, j)) {
            return;
        }
        this.size = j;
        this.cacheIsDirty = true;
    ...
    private final void updateCache() {
        if (this.cacheIsDirty) {
            ...
            if (this.outlineNeeded && Size.m2458getWidthimpl(j) > 0.0f && Size.m2455getHeightimpl(this.size) > 0.0f) {
                this.isSupportedOutline = true;
    ...
    private final void updateCacheWithRoundRect(RoundRect roundRect) {
        float m2364getXimpl = CornerRadius.m2364getXimpl(roundRect.m2439getTopLeftCornerRadiuskKHJgLs());
        ...
        if (RoundRectKt.isSimple(roundRect)) {
            this.cachedOutline.setRoundRect(MathKt.roundToInt(roundRect.getLeft()), MathKt.roundToInt(roundRect.getTop()), MathKt.roundToInt(roundRect.getRight()), MathKt.roundToInt(roundRect.getBottom()), m2364getXimpl);
            this.roundedCornerRadius = m2364getXimpl;
            return;
        }
    ...
    private final boolean m4218isSameBounds4L21HEs(RoundRect roundRect, long j, long j2, float f) {
        return roundRect != null && RoundRectKt.isSimple(roundRect) && roundRect.getLeft() == Offset.m2389getXimpl(j) && roundRect.getTop() == Offset.m2390getYimpl(j) && roundRect.getRight() == Offset.m2389getXimpl(j) + Size.m2458getWidthimpl(j2) && roundRect.getBottom() == Offset.m2390getYimpl(j) + Size.m2455getHeightimpl(j2) && CornerRadius.m2364getXimpl(roundRect.m2439getTopLeftCornerRadiuskKHJgLs()) == f;
    }
}