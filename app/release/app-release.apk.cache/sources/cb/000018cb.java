...
final class DeviceFontFamilyNameFont extends AndroidFont {
    ...
    private DeviceFontFamilyNameFont(String familyName, FontWeight weight, int i, FontVariation.Settings variationSettings) {
        super(FontLoadingStrategy.Companion.m4492getOptionalLocalPKNRLFQ(), NamedFontLoader.INSTANCE, variationSettings, null);
    ...
    public final android.graphics.Typeface loadCached(Context context) {
        ...
        return PlatformTypefacesKt.PlatformTypefaces().mo4526optionalOnDeviceFontFamilyByName78DK7lM(this.familyName, getWeight(), mo4454getStyle_LCdwA(), getVariationSettings(), context);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeviceFontFamilyNameFont) {
            ...
            return DeviceFontFamilyName.m4467equalsimpl0(this.familyName, deviceFontFamilyNameFont.familyName) && Intrinsics.areEqual(getWeight(), deviceFontFamilyNameFont.getWeight()) && FontStyle.m4499equalsimpl0(mo4454getStyle_LCdwA(), deviceFontFamilyNameFont.mo4454getStyle_LCdwA()) && Intrinsics.areEqual(getVariationSettings(), deviceFontFamilyNameFont.getVariationSettings());
        }
        return false;
    }

    public int hashCode() {
        return (((((DeviceFontFamilyName.m4468hashCodeimpl(this.familyName) * 31) + getWeight().hashCode()) * 31) + FontStyle.m4500hashCodeimpl(mo4454getStyle_LCdwA())) * 31) + getVariationSettings().hashCode();
    }

    public String toString() {
        return "Font(familyName=\"" + ((Object) DeviceFontFamilyName.m4469toStringimpl(this.familyName)) + "\", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m4501toStringimpl(mo4454getStyle_LCdwA())) + ')';
    }
}