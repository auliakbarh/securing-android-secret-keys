...
public final class MenuKt {
    ...
    private static final float MenuVerticalMargin = Dp.m4872constructorimpl(48);
    private static final float DropdownMenuItemHorizontalPadding = Dp.m4872constructorimpl(12);
    private static final float DropdownMenuVerticalPadding = Dp.m4872constructorimpl(8);
    private static final float DropdownMenuItemDefaultMinWidth = Dp.m4872constructorimpl(112);
    private static final float DropdownMenuItemDefaultMaxWidth = Dp.m4872constructorimpl(280);

    public static final /* synthetic */ float access$DropdownMenuContent$lambda$1(State state) {
        return DropdownMenuContent$lambda$1(state);
    }

    public static final /* synthetic */ float access$DropdownMenuContent$lambda$3(State state) {
        return DropdownMenuContent$lambda$3(state);
    }
    ...
    */
    ...
    public static final void DropdownMenuItemContent(final Function2<? super Composer, ? super Integer, Unit> text, final Function0<Unit> onClick, final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final boolean z, final MenuItemColors colors, final PaddingValues contentPadding, final MutableInteractionSource interactionSource, Composer composer, final int i) {
        ...
        if ((191739611 & i3) != 38347922 || !startRestartGroup.getSkipping()) {
            ...
            Modifier padding = PaddingKt.padding(SizeKt.m530sizeInqDBjuR0$default(SizeKt.fillMaxWidth$default(ClickableKt.m189clickableO2vRcR0$default(modifier, interactionSource, RippleKt.m965rememberRipple9IZ8Weo(true, 0.0f, 0L, startRestartGroup, 6, 6), z, null, null, onClick, 24, null), 0.0f, 1, null), DropdownMenuItemDefaultMinWidth, MenuTokens.INSTANCE.m1959getListItemContainerHeightD9Ej5fM(), DropdownMenuItemDefaultMaxWidth, 0.0f, 8, null), contentPadding);
                ...
                public final void invoke(Composer composer3, int i4) {
                    ...
                    if ((i4 & 11) != 2 || !composer3.getSkipping()) {
                        ...
                        if (function2 != null) {
                            ...
                            final int i6 = i3;
                            CompositionLocalKt.CompositionLocalProvider(providedValueArr, ComposableLambdaKt.composableLambda(composer3, 2035552199, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.1
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                /* JADX WARN: Multi-variable type inference failed */
                                {
                                    super(2);
                                ...
                                public final void invoke(Composer composer4, int i7) {
                                    ...
                                    if ((i7 & 11) != 2 || !composer4.getSkipping()) {
                                        ...
                                        Modifier m511defaultMinSizeVpY3zN4$default = SizeKt.m511defaultMinSizeVpY3zN4$default(Modifier.Companion, MenuTokens.INSTANCE.m1960getListItemLeadingIconSizeD9Ej5fM(), 0.0f, 2, null);
                                        ...
                                        Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf2 = LayoutKt.materializerOf(m511defaultMinSizeVpY3zN4$default);
                                        ...
                                        Composer m2262constructorimpl2 = Updater.m2262constructorimpl(composer4);
                                        ...
                                        materializerOf2.invoke(SkippableUpdater.m2253boximpl(SkippableUpdater.m2254constructorimpl(composer4)), composer4, 0);
                        ...
                        final int i8 = i3;
                        CompositionLocalKt.CompositionLocalProvider(providedValueArr2, ComposableLambdaKt.composableLambda(composer3, -1728894036, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.2
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(2);
                            ...
                            public final void invoke(Composer composer4, int i9) {
                                ...
                                if ((i9 & 11) != 2 || !composer4.getSkipping()) {
                                    ...
                                    if (function24 != null) {
                                        m4872constructorimpl = MenuKt.DropdownMenuItemHorizontalPadding;
                                    } else {
                                        m4872constructorimpl = Dp.m4872constructorimpl(0);
                                    }
                                    float f = m4872constructorimpl;
                                    if (function25 != null) {
                                        m4872constructorimpl2 = MenuKt.DropdownMenuItemHorizontalPadding;
                                    } else {
                                        m4872constructorimpl2 = Dp.m4872constructorimpl(0);
                                    }
                                    Modifier m483paddingqDBjuR0$default = PaddingKt.m483paddingqDBjuR0$default(weight$default, f, 0.0f, m4872constructorimpl2, 0.0f, 10, null);
                        ...
                        if (function22 != null) {
                            ...
                            final int i10 = i3;
                            CompositionLocalKt.CompositionLocalProvider(providedValueArr3, ComposableLambdaKt.composableLambda(composer3, 580312062, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.3
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                /* JADX WARN: Multi-variable type inference failed */
                                {
                                    super(2);
                                ...
                                public final void invoke(Composer composer4, int i11) {
                                    ...
                                    if ((i11 & 11) != 2 || !composer4.getSkipping()) {
                                        ...
                                        Modifier m511defaultMinSizeVpY3zN4$default = SizeKt.m511defaultMinSizeVpY3zN4$default(Modifier.Companion, MenuTokens.INSTANCE.m1961getListItemTrailingIconSizeD9Ej5fM(), 0.0f, 2, null);
