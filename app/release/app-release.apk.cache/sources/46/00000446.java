...
public final class LazyGridSnapLayoutInfoProviderKt {
            ...
            public float calculateSnapStepSize(Density density) {
                ...
                if (!getSingleAxisItems().isEmpty()) {
                    ...
                    if (getLayoutInfo().getOrientation() == Orientation.Vertical) {
                        ...
                        i = 0;
                        while (i2 < size) {
                            i += IntSize.m5031getHeightimpl(singleAxisItems.get(i2).mo612getSizeYbymL2g());
                            i2++;
                        }
                    } else {
                        ...
                        i = 0;
                        while (i2 < size2) {
                            i += IntSize.m5032getWidthimpl(singleAxisItems2.get(i2).mo612getSizeYbymL2g());
                            i2++;
                        }
                    }
    ...
    public static final int getSingleAxisViewportSize(LazyGridLayoutInfo lazyGridLayoutInfo) {
        ...
        if (lazyGridLayoutInfo.getOrientation() == Orientation.Vertical) {
            return IntSize.m5031getHeightimpl(lazyGridLayoutInfo.mo593getViewportSizeYbymL2g());
        }
        return IntSize.m5032getWidthimpl(lazyGridLayoutInfo.mo593getViewportSizeYbymL2g());
    }
    ...
    public static final int sizeOnMainAxis(LazyGridItemInfo lazyGridItemInfo, Orientation orientation) {
        ...
        if (orientation == Orientation.Vertical) {
            return IntSize.m5031getHeightimpl(lazyGridItemInfo.mo612getSizeYbymL2g());
        }
        return IntSize.m5032getWidthimpl(lazyGridItemInfo.mo612getSizeYbymL2g());
    }
    ...
    public static final int offsetOnMainAxis(LazyGridItemInfo lazyGridItemInfo, Orientation orientation) {
        ...
        Intrinsics.checkNotNullParameter(orientation, "orientation");
        if (orientation == Orientation.Vertical) {
            return IntOffset.m4991getYimpl(lazyGridItemInfo.mo611getOffsetnOccac());
        }
        return IntOffset.m4990getXimpl(lazyGridItemInfo.mo611getOffsetnOccac());
    }
}