...
public final class LayoutNodeSubcompositionsState {
    ...
    public LayoutNodeSubcompositionsState(LayoutNode root, SubcomposeSlotReusePolicy slotReusePolicy) {
        ...
        this.intermediateMeasurePolicy = new Function2<SubcomposeIntermediateMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState$intermediateMeasurePolicy$1
            ...
            public /* bridge */ /* synthetic */ MeasureResult invoke(SubcomposeIntermediateMeasureScope subcomposeIntermediateMeasureScope, Constraints constraints) {
                return m3885invoke0kLqBqw(subcomposeIntermediateMeasureScope, constraints.m4834unboximpl());
            }

            /* renamed from: invoke-0kLqBqw  reason: not valid java name */
            public final MeasureResult m3885invoke0kLqBqw(SubcomposeIntermediateMeasureScope subcomposeIntermediateMeasureScope, long j) {
        ...
        return new LayoutNode.NoIntrinsicsMeasurePolicy(str) { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState$createMeasurePolicy$1
            ...
            public MeasureResult mo10measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j) {
                ...
                if ((LayoutNodeSubcompositionsState.this.root.getLayoutState$ui_release() != LayoutNode.LayoutState.Measuring && LayoutNodeSubcompositionsState.this.root.getLayoutState$ui_release() != LayoutNode.LayoutState.LayingOut) || LayoutNodeSubcompositionsState.this.root.getLookaheadRoot$ui_release() == null) {
                    ...
                    intermediateMeasureScopeImpl2.m3883setLookaheadConstraintsBRTryo0(j);
                    final MeasureResult invoke = block.invoke(LayoutNodeSubcompositionsState.this.scope, Constraints.m4816boximpl(j));
                    ...
                    intermediateMeasureScopeImpl3.m3884setLookaheadSizeozmzZPI(IntSizeKt.IntSize(invoke.getWidth(), invoke.getHeight()));
                ...
                return intermediateMeasurePolicy$ui_release.invoke(intermediateMeasureScopeImpl, Constraints.m4816boximpl(j));
            }
        };
    }
    ...
    public final SubcomposeLayoutState.PrecomposedSlotHandle precompose(final Object obj, Function2<? super Composer, ? super Integer, Unit> content) {
        ...
        return new SubcomposeLayoutState.PrecomposedSlotHandle() { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState$precompose$1
            ...
            public void mo3886premeasure0kLqBqw(int i, long j) {
                Map map2;
                map2 = LayoutNodeSubcompositionsState.this.precomposeMap;
                LayoutNode layoutNode2 = (LayoutNode) map2.get(obj);
                ...
                if (!layoutNode2.isPlaced()) {
                    ...
                    LayoutNodeKt.requireOwner(layoutNode2).mo4135measureAndLayout0kLqBqw(layoutNode2.getChildren$ui_release().get(i), j);
    ...
    public final class IntermediateMeasureScopeImpl implements SubcomposeIntermediateMeasureScope, MeasureScope {
        ...
        public long mo3881getLookaheadConstraintsmsEJaDk() {
            return this.lookaheadConstraints;
        }

        @Override // androidx.compose.ui.layout.SubcomposeIntermediateMeasureScope
        /* renamed from: getLookaheadSize-YbymL2g  reason: not valid java name */
        public long mo3882getLookaheadSizeYbymL2g() {
        ...
        public void m3883setLookaheadConstraintsBRTryo0(long j) {
        ...
        public void m3884setLookaheadSizeozmzZPI(long j) {
    ...
    private final void subcompose(LayoutNode layoutNode, Object obj, Function2<? super Composer, ? super Integer, Unit> function2) {
        ...
        if (nodeState == null) {
            nodeState = new NodeState(obj, ComposableSingletons$SubcomposeLayoutKt.INSTANCE.m3855getLambda1$ui_release(), null, 4, null);
