...
public final class ScrollDraggableState implements DraggableState, DragScope {
    ...
    public void dragBy(float f) {
        ...
        value.m334dispatchScroll3eAAhYA(this.latestScrollScope, value.m343toOffsettuRUvjQ(f), NestedScrollSource.Companion.m3644getDragWNlRxjI());
    }
    ...
    public void dispatchRawDelta(float f) {
        ScrollingLogic value = this.scrollLogic.getValue();
        value.m337performRawScrollMKHz9U(value.m343toOffsettuRUvjQ(f));
    }
}