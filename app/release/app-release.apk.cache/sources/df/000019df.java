...
public final class Constraints {
    ...
    public static final /* synthetic */ Constraints m4816boximpl(long j) {
        return new Constraints(j);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m4817constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4820equalsimpl(long j, Object obj) {
        return (obj instanceof Constraints) && j == ((Constraints) obj).m4834unboximpl();
    }
    ...
    private static final int m4822getFocusIndeximpl(long j) {
        return (int) (j & 3);
    }
    ...
    public final /* synthetic */ long m4834unboximpl() {
        return this.value;
    }
    ...
    public static final int m4830getMinWidthimpl(long j) {
        return ((int) (j >> MinFocusHeight)) & WidthMask[m4822getFocusIndeximpl(j)];
    }

    /* renamed from: getMaxWidth-impl  reason: not valid java name */
    public static final int m4828getMaxWidthimpl(long j) {
        int i = ((int) (j >> 33)) & WidthMask[m4822getFocusIndeximpl(j)];
        if (i == 0) {
    ...
    public static final int m4829getMinHeightimpl(long j) {
        int m4822getFocusIndeximpl = m4822getFocusIndeximpl(j);
        return ((int) (j >> MinHeightOffsets[m4822getFocusIndeximpl])) & HeightMask[m4822getFocusIndeximpl];
    }

    /* renamed from: getMaxHeight-impl  reason: not valid java name */
    public static final int m4827getMaxHeightimpl(long j) {
        int m4822getFocusIndeximpl = m4822getFocusIndeximpl(j);
        int i = ((int) (j >> (MinHeightOffsets[m4822getFocusIndeximpl] + 31))) & HeightMask[m4822getFocusIndeximpl];
        if (i == 0) {
            return Integer.MAX_VALUE;
        }
        return i - 1;
    ...
    public static final boolean m4824getHasBoundedWidthimpl(long j) {
        return (((int) (j >> 33)) & WidthMask[m4822getFocusIndeximpl(j)]) != 0;
    }

    /* renamed from: getHasBoundedHeight-impl  reason: not valid java name */
    public static final boolean m4823getHasBoundedHeightimpl(long j) {
        int m4822getFocusIndeximpl = m4822getFocusIndeximpl(j);
        return (((int) (j >> (MinHeightOffsets[m4822getFocusIndeximpl] + 31))) & HeightMask[m4822getFocusIndeximpl]) != 0;
    }

    /* renamed from: getHasFixedWidth-impl  reason: not valid java name */
    public static final boolean m4826getHasFixedWidthimpl(long j) {
        return m4828getMaxWidthimpl(j) == m4830getMinWidthimpl(j);
    }

    /* renamed from: getHasFixedHeight-impl  reason: not valid java name */
    public static final boolean m4825getHasFixedHeightimpl(long j) {
        return m4827getMaxHeightimpl(j) == m4829getMinHeightimpl(j);
    }

    /* renamed from: isZero-impl  reason: not valid java name */
    public static final boolean m4832isZeroimpl(long j) {
        return m4828getMaxWidthimpl(j) == 0 || m4827getMaxHeightimpl(j) == 0;
    }

    /* renamed from: copy-Zbe2FdA$default  reason: not valid java name */
    public static /* synthetic */ long m4819copyZbe2FdA$default(long j, int i, int i2, int i3, int i4, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            i = m4830getMinWidthimpl(j);
        }
        int i6 = i;
        if ((i5 & 2) != 0) {
            i2 = m4828getMaxWidthimpl(j);
        }
        int i7 = i2;
        if ((i5 & 4) != 0) {
            i3 = m4829getMinHeightimpl(j);
        }
        int i8 = i3;
        if ((i5 & 8) != 0) {
            i4 = m4827getMaxHeightimpl(j);
        }
        return m4818copyZbe2FdA(j, i6, i7, i8, i4);
    }

    /* renamed from: copy-Zbe2FdA  reason: not valid java name */
    public static final long m4818copyZbe2FdA(long j, int i, int i2, int i3, int i4) {
        if (i3 < 0 || i < 0) {
        ...
        if (i2 >= i || i2 == Integer.MAX_VALUE) {
            ...
            return Companion.m4835createConstraintsZbe2FdA$ui_unit_release(i, i2, i3, i4);
        }
        throw new IllegalArgumentException(("maxWidth(" + i2 + ") must be >= minWidth(" + i + ')').toString());
    }

    public String toString() {
        return m4833toStringimpl(this.value);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m4833toStringimpl(long j) {
        int m4828getMaxWidthimpl = m4828getMaxWidthimpl(j);
        String valueOf = m4828getMaxWidthimpl == Integer.MAX_VALUE ? "Infinity" : String.valueOf(m4828getMaxWidthimpl);
        int m4827getMaxHeightimpl = m4827getMaxHeightimpl(j);
        return "Constraints(minWidth = " + m4830getMinWidthimpl(j) + ", maxWidth = " + valueOf + ", minHeight = " + m4829getMinHeightimpl(j) + ", maxHeight = " + (m4827getMaxHeightimpl != Integer.MAX_VALUE ? String.valueOf(m4827getMaxHeightimpl) : "Infinity") + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m4836fixedJhjzzOo(int i, int i2) {
            if (i < 0 || i2 < 0) {
                throw new IllegalArgumentException(("width(" + i + ") and height(" + i2 + ") must be >= 0").toString());
            }
            return m4835createConstraintsZbe2FdA$ui_unit_release(i, i, i2, i2);
        }

        /* renamed from: fixedWidth-OenEA2s  reason: not valid java name */
        public final long m4838fixedWidthOenEA2s(int i) {
            if (i < 0) {
                throw new IllegalArgumentException(("width(" + i + ") must be >= 0").toString());
            }
            return m4835createConstraintsZbe2FdA$ui_unit_release(i, i, 0, Integer.MAX_VALUE);
        }

        /* renamed from: fixedHeight-OenEA2s  reason: not valid java name */
        public final long m4837fixedHeightOenEA2s(int i) {
            if (i < 0) {
                throw new IllegalArgumentException(("height(" + i + ") must be >= 0").toString());
            }
            return m4835createConstraintsZbe2FdA$ui_unit_release(0, Integer.MAX_VALUE, i, i);
        }

        /* renamed from: createConstraints-Zbe2FdA$ui_unit_release  reason: not valid java name */
        public final long m4835createConstraintsZbe2FdA$ui_unit_release(int i, int i2, int i3, int i4) {
            long j;
            ...
            return Constraints.m4817constructorimpl((i7 << 33) | j | (i << Constraints.MinFocusHeight) | (i3 << i9) | (i8 << (i9 + 31)));
        }
