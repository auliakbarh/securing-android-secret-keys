...
public abstract class CornerBasedShape implements Shape {
    ...
    public abstract Outline mo715createOutlineLjSzlW0(long j, float f, float f2, float f3, float f4, LayoutDirection layoutDirection);
    ...
    public final Outline mo207createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Intrinsics.checkNotNullParameter(density, "density");
        float mo723toPxTmRCtEA = this.topStart.mo723toPxTmRCtEA(j, density);
        float mo723toPxTmRCtEA2 = this.topEnd.mo723toPxTmRCtEA(j, density);
        float mo723toPxTmRCtEA3 = this.bottomEnd.mo723toPxTmRCtEA(j, density);
        float mo723toPxTmRCtEA4 = this.bottomStart.mo723toPxTmRCtEA(j, density);
        float m2457getMinDimensionimpl = Size.m2457getMinDimensionimpl(j);
        float f = mo723toPxTmRCtEA + mo723toPxTmRCtEA4;
        if (f > m2457getMinDimensionimpl) {
            float f2 = m2457getMinDimensionimpl / f;
            mo723toPxTmRCtEA *= f2;
            mo723toPxTmRCtEA4 *= f2;
        }
        float f3 = mo723toPxTmRCtEA4;
        float f4 = mo723toPxTmRCtEA2 + mo723toPxTmRCtEA3;
        if (f4 > m2457getMinDimensionimpl) {
            float f5 = m2457getMinDimensionimpl / f4;
            mo723toPxTmRCtEA2 *= f5;
            mo723toPxTmRCtEA3 *= f5;
        }
        if (mo723toPxTmRCtEA < 0.0f || mo723toPxTmRCtEA2 < 0.0f || mo723toPxTmRCtEA3 < 0.0f || f3 < 0.0f) {
            throw new IllegalArgumentException(("Corner size in Px can't be negative(topStart = " + mo723toPxTmRCtEA + ", topEnd = " + mo723toPxTmRCtEA2 + ", bottomEnd = " + mo723toPxTmRCtEA3 + ", bottomStart = " + f3 + ")!").toString());
        }
        return mo715createOutlineLjSzlW0(j, mo723toPxTmRCtEA, mo723toPxTmRCtEA2, mo723toPxTmRCtEA3, f3, layoutDirection);
    }
