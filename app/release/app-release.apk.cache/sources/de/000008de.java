...
public final class SelectionController implements RememberObserver {
    ...
    private SelectionController(SelectionRegistrar selectionRegistrar, long j, StaticTextSelectionParams params) {
        ...
        makeSelectionModifier = SelectionControllerKt.makeSelectionModifier(selectionRegistrar, nextSelectableId, new Function0<LayoutCoordinates>() { // from class: androidx.compose.foundation.text.modifiers.SelectionController$modifier$1
            ...
            public final LayoutCoordinates invoke() {
                return SelectionController.access$getParams$p(SelectionController.this).getLayoutCoordinates();
            }
            ...
            public final TextLayoutResult invoke() {
                return SelectionController.access$getParams$p(SelectionController.this).getTextLayoutResult();
            }
    ...
    public static final /* synthetic */ StaticTextSelectionParams access$getParams$p(SelectionController selectionController) {
        return selectionController.params;
    }
    ...
    public final void draw(DrawScope drawScope) {
        ...
        if (!this.params.getShouldClip()) {
            DrawScope.m3162drawPathLG529CI$default(drawScope, pathForRange, this.backgroundSelectionColor, 0.0f, null, null, 0, 60, null);
            return;
        }
