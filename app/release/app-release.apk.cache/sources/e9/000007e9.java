...
public final class CutCornerShape extends CornerBasedShape {
    ...
    public Outline mo715createOutlineLjSzlW0(long j, float f, float f2, float f3, float f4, LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m2458getWidthimpl(j) - f, 0.0f);
        Path.lineTo(Size.m2458getWidthimpl(j), f);
        float f6 = layoutDirection == LayoutDirection.Ltr ? f3 : f4;
        Path.lineTo(Size.m2458getWidthimpl(j), Size.m2455getHeightimpl(j) - f6);
        Path.lineTo(Size.m2458getWidthimpl(j) - f6, Size.m2455getHeightimpl(j));
        if (layoutDirection == LayoutDirection.Ltr) {
            f3 = f4;
        }
        Path.lineTo(f3, Size.m2455getHeightimpl(j));
        Path.lineTo(0.0f, Size.m2455getHeightimpl(j) - f3);
        Path.close();
