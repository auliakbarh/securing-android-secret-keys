...
public final class TextAnnotatedStringNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public static final /* synthetic */ MultiParagraphLayoutCache access$getLayoutCache(TextAnnotatedStringNode textAnnotatedStringNode) {
        return textAnnotatedStringNode.getLayoutCache();
    }
    ...
    public /* synthetic */ TextAnnotatedStringNode(AnnotatedString annotatedString, TextStyle textStyle, FontFamily.Resolver resolver, Function1 function1, int i, boolean z, int i2, int i3, List list, Function1 function12, SelectionController selectionController, ColorProducer colorProducer, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, resolver, (i4 & 8) != 0 ? null : function1, (i4 & 16) != 0 ? TextOverflow.Companion.m4813getClipgIe3tQ8() : i, (i4 & 32) != 0 ? true : z, (i4 & 64) != 0 ? Integer.MAX_VALUE : i2, (i4 & 128) != 0 ? 1 : i3, (i4 & 256) != 0 ? null : list, (i4 & 512) != 0 ? null : function12, (i4 & 1024) != 0 ? null : selectionController, (i4 & 2048) != 0 ? null : colorProducer, null);
    }
    ...
    public final boolean m866updateLayoutRelatedArgsMPT68mk(TextStyle style, List<AnnotatedString.Range<Placeholder>> list, int i, int i2, boolean z, FontFamily.Resolver fontFamilyResolver, int i3) {
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(fontFamilyResolver, "fontFamilyResolver");
        ...
        if (TextOverflow.m4806equalsimpl0(this.overflow, i3)) {
            return z2;
        }
        this.overflow = i3;
        return true;
    ...
    public final void doInvalidations(boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        if (z2 || z3 || z4) {
            getLayoutCache().m848updateZNqEYIc(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, this.placeholders);
        ...
        if (function1 == null) {
            function1 = new Function1<List<TextLayoutResult>, Boolean>() { // from class: androidx.compose.foundation.text.modifiers.TextAnnotatedStringNode$applySemantics$1
                ...
                public final Boolean invoke(List<TextLayoutResult> textLayoutResult) {
                    ...
                    TextLayoutResult layoutOrNull = TextAnnotatedStringNode.access$getLayoutCache(TextAnnotatedStringNode.this).getLayoutOrNull();
    ...
    public final MeasureResult m865measureNonExtension3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measureScope, "measureScope");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return mo236measure3p2s80s(measureScope, measurable, j);
    }
    ...
    public MeasureResult mo236measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        boolean m847layoutWithConstraintsK40F9xA = layoutCache.m847layoutWithConstraintsK40F9xA(j, measure.getLayoutDirection());
        ...
        if (m847layoutWithConstraintsK40F9xA) {
        ...
        final Placeable mo3865measureBRTryo0 = measurable.mo3865measureBRTryo0(Constraints.Companion.m4836fixedJhjzzOo(IntSize.m5032getWidthimpl(textLayoutResult.m4376getSizeYbymL2g()), IntSize.m5031getHeightimpl(textLayoutResult.m4376getSizeYbymL2g())));
        int m5032getWidthimpl = IntSize.m5032getWidthimpl(textLayoutResult.m4376getSizeYbymL2g());
        int m5031getHeightimpl = IntSize.m5031getHeightimpl(textLayoutResult.m4376getSizeYbymL2g());
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return measure.layout(m5032getWidthimpl, m5031getHeightimpl, map, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.modifiers.TextAnnotatedStringNode$measure$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        boolean z = textLayoutResult.getHasVisualOverflow() && !TextOverflow.m4806equalsimpl0(this.overflow, TextOverflow.Companion.m4815getVisiblegIe3tQ8());
        if (z) {
            Rect m2429Recttz77jQw = RectKt.m2429Recttz77jQw(Offset.Companion.m2405getZeroF1C5BW0(), SizeKt.Size(IntSize.m5032getWidthimpl(textLayoutResult.m4376getSizeYbymL2g()), IntSize.m5031getHeightimpl(textLayoutResult.m4376getSizeYbymL2g())));
            canvas.save();
            Canvas.m2601clipRectmtrdDE$default(canvas, m2429Recttz77jQw, 0, 2, null);
        }
        try {
            ...
            if (brush == null) {
                ...
                long m2705invoke0d7_KjU = colorProducer != null ? colorProducer.m2705invoke0d7_KjU() : Color.Companion.m2664getUnspecified0d7_KjU();
                if (m2705invoke0d7_KjU == Color.Companion.m2664getUnspecified0d7_KjU()) {
                    if (this.style.m4424getColor0d7_KjU() != Color.Companion.m2664getUnspecified0d7_KjU()) {
                        m2705invoke0d7_KjU = this.style.m4424getColor0d7_KjU();
                    } else {
                        m2705invoke0d7_KjU = Color.Companion.m2654getBlack0d7_KjU();
                    }
                }
                multiParagraph.m4293paintLG529CI(canvas, (r14 & 2) != 0 ? Color.Companion.m2664getUnspecified0d7_KjU() : m2705invoke0d7_KjU, (r14 & 4) != 0 ? null : shadow2, (r14 & 8) != 0 ? null : textDecoration2, (r14 & 16) == 0 ? drawStyle2 : null, (r14 & 32) != 0 ? DrawScope.Companion.m3172getDefaultBlendMode0nO6VwU() : 0);
            } else {
                multiParagraph.m4295painthn5TExg(canvas, brush, (r17 & 4) != 0 ? Float.NaN : this.style.getAlpha(), (r17 & 8) != 0 ? null : shadow2, (r17 & 16) != 0 ? null : textDecoration2, (r17 & 32) != 0 ? null : drawStyle2, (r17 & 64) != 0 ? DrawScope.Companion.m3172getDefaultBlendMode0nO6VwU() : 0);
            }
