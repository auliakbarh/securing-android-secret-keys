...
public abstract class DelegatingNode extends Modifier.Node {
    ...
    public final <T extends DelegatableNode> T delegate(T delegatableNode) {
        ...
        if (node != delegatableNode) {
            ...
            if (isAttached()) {
                if ((calculateNodeKindSetFromIncludingDelegates & NodeKind.m4080constructorimpl(2)) != 0 && (kindSet$ui_release & NodeKind.m4080constructorimpl(2)) == 0) {
    ...
    protected final void undelegate(DelegatableNode instance) {
        ...
        for (Modifier.Node node2 = this.delegate; node2 != null; node2 = node2.getChild$ui_release()) {
            if (node2 == instance) {
                ...
                if (isAttached() && (kindSet$ui_release & NodeKind.m4080constructorimpl(2)) != 0 && (NodeKind.m4080constructorimpl(2) & calculateNodeKindSetFromIncludingDelegates) == 0) {
                    NodeChain nodes$ui_release = DelegatableNodeKt.requireLayoutNode(this).getNodes$ui_release();
                    getNode().updateCoordinator$ui_release(null);
                    nodes$ui_release.syncCoordinators();
                    return;
    ...
    private final void validateDelegateKindSet(int i, Modifier.Node node) {
        int kindSet$ui_release = getKindSet$ui_release();
        if ((i & NodeKind.m4080constructorimpl(2)) != 0 && (NodeKind.m4080constructorimpl(2) & kindSet$ui_release) != 0 && !(this instanceof LayoutModifierNode)) {
