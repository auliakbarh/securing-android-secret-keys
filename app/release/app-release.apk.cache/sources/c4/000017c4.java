...
public final class LiveRegionMode {
    ...
    private static final int Polite = m4230constructorimpl(0);
    private static final int Assertive = m4230constructorimpl(1);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ LiveRegionMode m4229boximpl(int i) {
        return new LiveRegionMode(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m4230constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4231equalsimpl(int i, Object obj) {
        return (obj instanceof LiveRegionMode) && i == ((LiveRegionMode) obj).m4235unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m4232equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m4233hashCodeimpl(int i) {
    ...
    public int hashCode() {
        return m4233hashCodeimpl(this.value);
    }
    ...
    public String toString() {
        return m4234toStringimpl(this.value);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m4234toStringimpl(int i) {
        return m4232equalsimpl0(i, Polite) ? "Polite" : m4232equalsimpl0(i, Assertive) ? "Assertive" : "Unknown";
    }
}