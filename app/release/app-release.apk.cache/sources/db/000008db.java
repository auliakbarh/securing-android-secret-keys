...
public final class ParagraphLayoutCache {
    ...
    public final long m851getLayoutSizeYbymL2g$foundation_release() {
    ...
    public final void m853setLayoutSizeozmzZPI$foundation_release(long j) {
        this.layoutSize = j;
    }
    ...
    private ParagraphLayoutCache(String text, TextStyle style, FontFamily.Resolver fontFamilyResolver, int i, boolean z, int i2, int i3) {
        ...
        this.prevConstraints = Constraints.Companion.m4836fixedJhjzzOo(0, 0);
    ...
    public /* synthetic */ ParagraphLayoutCache(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.Companion.m4813getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, null);
    }
    ...
    public final boolean m852layoutWithConstraintsK40F9xA(long j, LayoutDirection layoutDirection) {
        long m4839constrain4WqzIAM;
        long m4839constrain4WqzIAM2;
        ...
        if (this.minLines > 1) {
            ...
            j = from.m841coerceMinLinesOh53vG4$foundation_release(j, this.minLines);
        }
        boolean z2 = false;
        if (!m850newLayoutWillBeDifferentK40F9xA(j, layoutDirection)) {
            if (!Constraints.m4821equalsimpl0(j, this.prevConstraints)) {
                Paragraph paragraph = this.paragraph;
                Intrinsics.checkNotNull(paragraph);
                this.layoutSize = ConstraintsKt.m4839constrain4WqzIAM(j, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(paragraph.getWidth()), TextDelegateKt.ceilToIntPx(paragraph.getHeight())));
                if (TextOverflow.m4806equalsimpl0(this.overflow, TextOverflow.Companion.m4815getVisiblegIe3tQ8()) || (IntSize.m5032getWidthimpl(m4839constrain4WqzIAM2) >= paragraph.getWidth() && IntSize.m5031getHeightimpl(m4839constrain4WqzIAM2) >= paragraph.getHeight())) {
                    z = false;
                }
                this.didOverflow = z;
            }
        ...
        Paragraph m849layoutTextK40F9xA = m849layoutTextK40F9xA(j, layoutDirection);
        this.prevConstraints = j;
        this.layoutSize = ConstraintsKt.m4839constrain4WqzIAM(j, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(m849layoutTextK40F9xA.getWidth()), TextDelegateKt.ceilToIntPx(m849layoutTextK40F9xA.getHeight())));
        if (!TextOverflow.m4806equalsimpl0(this.overflow, TextOverflow.Companion.m4815getVisiblegIe3tQ8()) && (IntSize.m5032getWidthimpl(m4839constrain4WqzIAM) < m849layoutTextK40F9xA.getWidth() || IntSize.m5031getHeightimpl(m4839constrain4WqzIAM) < m849layoutTextK40F9xA.getHeight())) {
            z2 = true;
        }
        this.didOverflow = z2;
        this.paragraph = m849layoutTextK40F9xA;
        return true;
    }
    ...
    public final int intrinsicHeight(int i, LayoutDirection layoutDirection) {
        ...
        if (i != i2 || i2 == -1) {
            int ceilToIntPx = TextDelegateKt.ceilToIntPx(m849layoutTextK40F9xA(ConstraintsKt.Constraints(0, i, 0, Integer.MAX_VALUE), layoutDirection).getHeight());
    ...
    public final void m854updateL6sJoHM(String text, TextStyle style, FontFamily.Resolver fontFamilyResolver, int i, boolean z, int i2, int i3) {
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(fontFamilyResolver, "fontFamilyResolver");
        this.text = text;
    ...
    private final Paragraph m849layoutTextK40F9xA(long j, LayoutDirection layoutDirection) {
        ParagraphIntrinsics layoutDirection2 = setLayoutDirection(layoutDirection);
        return ParagraphKt.m4303Paragraph_EkL_Y(layoutDirection2, LayoutUtilsKt.m838finalConstraintstfFHcEY(j, this.softWrap, this.overflow, layoutDirection2.getMaxIntrinsicWidth()), LayoutUtilsKt.m839finalMaxLinesxdlQI24(this.softWrap, this.overflow, this.maxLines), TextOverflow.m4806equalsimpl0(this.overflow, TextOverflow.Companion.m4814getEllipsisgIe3tQ8()));
    }

    /* renamed from: newLayoutWillBeDifferent-K40F9xA  reason: not valid java name */
    private final boolean m850newLayoutWillBeDifferentK40F9xA(long j, LayoutDirection layoutDirection) {
        ...
        return Constraints.m4828getMaxWidthimpl(j) != Constraints.m4828getMaxWidthimpl(this.prevConstraints) || ((float) Constraints.m4827getMaxHeightimpl(j)) < paragraph.getHeight() || paragraph.getDidExceedMaxLines();
    }
    ...
    public final TextLayoutResult slowCreateTextLayoutResultOrNull() {
        ...
        long m4819copyZbe2FdA$default = Constraints.m4819copyZbe2FdA$default(this.prevConstraints, 0, 0, 0, 0, 10, null);
        return new TextLayoutResult(new TextLayoutInput(annotatedString, this.style, CollectionsKt.emptyList(), this.maxLines, this.softWrap, this.overflow, density, layoutDirection, this.fontFamilyResolver, m4819copyZbe2FdA$default, (DefaultConstructorMarker) null), new MultiParagraph(new MultiParagraphIntrinsics(annotatedString, this.style, CollectionsKt.emptyList(), density, this.fontFamilyResolver), m4819copyZbe2FdA$default, this.maxLines, TextOverflow.m4806equalsimpl0(this.overflow, TextOverflow.Companion.m4814getEllipsisgIe3tQ8()), null), this.layoutSize, null);
    }
