...
public final class Oklab extends ColorSpace {
    ...
    public Oklab(String name, int i) {
        super(name, ColorModel.Companion.m3034getLabxdoWZVw(), i, null);
    ...
    public long toXy$ui_graphics_release(float f, float f2, float f3) {
        ...
        return (Float.floatToIntBits(ColorSpaceKt.mul3x3Float3_0(fArr2, f4, f5, f6)) << 32) | (Float.floatToIntBits(ColorSpaceKt.mul3x3Float3_1(fArr2, f4, f5, f6)) & 4294967295L);
    }
