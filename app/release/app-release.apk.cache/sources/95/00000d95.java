...
public final class ScaffoldKt {
    ...
    private static final float FabSpacing = Dp.m4872constructorimpl(16);

    /* renamed from: access$ScaffoldLayout-FMILGgc */
    public static final /* synthetic */ void m1357access$ScaffoldLayoutFMILGgc(int i, Function2 function2, Function3 function3, Function2 function22, Function2 function23, WindowInsets windowInsets, Function2 function24, Composer composer, int i2) {
        m1356ScaffoldLayoutFMILGgc(i, function2, function3, function22, function23, windowInsets, function24, composer, i2);
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:268:0x0120  */
    ...
    /* JADX WARN: Removed duplicated region for block: B:302:0x019f  */
    /* JADX WARN: Removed duplicated region for block: B:304:0x01a3  */
    /* JADX WARN: Removed duplicated region for block: B:305:0x01aa  */
    /* JADX WARN: Removed duplicated region for block: B:307:0x01ad  */
    /* JADX WARN: Removed duplicated region for block: B:308:0x01b4  */
    ...
    /* JADX WARN: Removed duplicated region for block: B:314:0x01c9  */
    /* JADX WARN: Removed duplicated region for block: B:316:0x01cc  */
    ...
    /* JADX WARN: Removed duplicated region for block: B:327:0x01ff  */
    /* JADX WARN: Removed duplicated region for block: B:328:0x0211  */
    /* JADX WARN: Removed duplicated region for block: B:331:0x021f  */
    ...
    */
    ...
    public static final void m1356ScaffoldLayoutFMILGgc(final int i, final Function2<? super Composer, ? super Integer, Unit> function2, final Function3<? super PaddingValues, ? super Composer, ? super Integer, Unit> function3, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final WindowInsets windowInsets, final Function2<? super Composer, ? super Integer, Unit> function24, Composer composer, final int i2) {
        ...
        if ((2995931 & i4) != 599186 || !startRestartGroup.getSkipping()) {
            ...
            Object[] objArr = {function2, function22, windowInsets, function23, FabPosition.m1196boximpl(i), function24, function3};
            ...
            if (z || rememberedValue == Composer.Companion.getEmpty()) {
                ...
                rememberedValue = (Function2) new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material3.ScaffoldKt$ScaffoldLayout$1$1
                    ...
                    public /* bridge */ /* synthetic */ MeasureResult invoke(SubcomposeMeasureScope subcomposeMeasureScope, Constraints constraints) {
                        return m1358invoke0kLqBqw(subcomposeMeasureScope, constraints.m4834unboximpl());
                    }

                    /* renamed from: invoke-0kLqBqw  reason: not valid java name */
                    public final MeasureResult m1358invoke0kLqBqw(final SubcomposeMeasureScope SubcomposeLayout, long j) {
                        ...
                        final long m4819copyZbe2FdA$default = Constraints.m4819copyZbe2FdA$default(j, 0, 0, 0, 0, 10, null);
                        ...
                        return MeasureScope.layout$default(SubcomposeLayout, m4828getMaxWidthimpl, m4827getMaxHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.ScaffoldKt$ScaffoldLayout$1$1.1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(1);
                            ...
                            public final void invoke2(Placeable.PlacementScope layout) {
                                ...
                                long j2 = m4819copyZbe2FdA$default;
                                ...
                                for (Measurable measurable : subcompose) {
                                    arrayList.add(measurable.mo3865measureBRTryo0(j2));
                                }
                                ...
                                long j3 = m4819copyZbe2FdA$default;
                                ...
                                for (Measurable measurable2 : subcompose2) {
                                    ...
                                    arrayList4.add(measurable2.mo3865measureBRTryo0(ConstraintsKt.m4844offsetNN6EwU(j3, (-windowInsets3.getLeft(subcomposeMeasureScope2, subcomposeMeasureScope.getLayoutDirection())) - windowInsets3.getRight(subcomposeMeasureScope2, subcomposeMeasureScope.getLayoutDirection()), -windowInsets3.getBottom(subcomposeMeasureScope2))));
                                ...
                                long j4 = m4819copyZbe2FdA$default;
                                ...
                                for (Measurable measurable3 : SubcomposeMeasureScope.this.subcompose(ScaffoldLayoutContent.Fab, function27)) {
                                    ...
                                    Placeable mo3865measureBRTryo0 = measurable3.mo3865measureBRTryo0(ConstraintsKt.m4844offsetNN6EwU(j4, (-windowInsets4.getLeft(subcomposeMeasureScope4, subcomposeMeasureScope3.getLayoutDirection())) - windowInsets4.getRight(subcomposeMeasureScope4, subcomposeMeasureScope3.getLayoutDirection()), -windowInsets4.getBottom(subcomposeMeasureScope4)));
                                    mo3865measureBRTryo0 = (mo3865measureBRTryo0.getHeight() == 0 || mo3865measureBRTryo0.getWidth() == 0) ? null : null;
                                    if (mo3865measureBRTryo0 != null) {
                                        arrayList6.add(mo3865measureBRTryo0);
                                    }
                                }
                                ...
                                List<Measurable> subcompose3 = subcomposeMeasureScope7.subcompose(scaffoldLayoutContent, ComposableLambdaKt.composableLambdaInstance(-1455477816, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ScaffoldKt$ScaffoldLayout$1$1$1$bottomBarPlaceables$1
                                    ...
                                    public final void invoke(Composer composer2, int i13) {
                                        ...
                                        if ((i13 & 11) != 2 || !composer2.getSkipping()) {
                                            ...
                                            CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ScaffoldKt.getLocalFabPlacement().provides(FabPlacement.this)}, function29, composer2, ((i12 >> 15) & 112) | 8);
                                            if (ComposerKt.isTraceInProgress()) {
                                ...
                                long j5 = m4819copyZbe2FdA$default;
                                ...
                                for (Measurable measurable4 : subcompose3) {
                                    arrayList9.add(measurable4.mo3865measureBRTryo0(j5));
                                }
                                ...
                                if (fabPlacement != null) {
                                    ...
                                    if (valueOf == null) {
                                        ...
                                        i9 = height12 + subcomposeMeasureScope8.mo318roundToPx0680j_4(f2) + windowInsets5.getBottom(subcomposeMeasureScope8);
                                    } else {
                                        int intValue = valueOf.intValue() + fabPlacement.getHeight();
                                        f = ScaffoldKt.FabSpacing;
                                        i9 = intValue + subcomposeMeasureScope8.mo318roundToPx0680j_4(f);
                                    }
                                ...
                                List<Measurable> subcompose4 = subcomposeMeasureScope9.subcompose(scaffoldLayoutContent2, ComposableLambdaKt.composableLambdaInstance(1643221465, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ScaffoldKt$ScaffoldLayout$1$1$1$bodyContentPlaceables$1
                                    ...
                                    public final void invoke(Composer composer2, int i14) {
                                        float f5;
                                        float mo429calculateBottomPaddingD9Ej5fM;
                                        Integer num3;
                                        ...
                                        if ((i14 & 11) != 2 || !composer2.getSkipping()) {
                                            ...
                                            if (arrayList2.isEmpty()) {
                                                f5 = asPaddingValues.mo432calculateTopPaddingD9Ej5fM();
                                            } else {
                                                f5 = subcomposeMeasureScope10.mo321toDpu2uoSUM(height3);
                                            }
                                            if (arrayList10.isEmpty() || (num3 = num2) == null) {
                                                mo429calculateBottomPaddingD9Ej5fM = asPaddingValues.mo429calculateBottomPaddingD9Ej5fM();
                                            } else {
                                                mo429calculateBottomPaddingD9Ej5fM = subcomposeMeasureScope10.mo321toDpu2uoSUM(num3.intValue());
                                            }
                                            function33.invoke(PaddingKt.m475PaddingValuesa9UjIt4(PaddingKt.calculateStartPadding(asPaddingValues, subcomposeMeasureScope10.getLayoutDirection()), f5, PaddingKt.calculateEndPadding(asPaddingValues, subcomposeMeasureScope10.getLayoutDirection()), mo429calculateBottomPaddingD9Ej5fM), composer2, Integer.valueOf((i13 >> 3) & 112));
                                            if (ComposerKt.isTraceInProgress()) {
                                                ComposerKt.traceEventEnd();
                                                return;
                                            }
                                ...
                                long j6 = m4819copyZbe2FdA$default;
                                ...
                                for (Measurable measurable5 : subcompose4) {
                                    arrayList12.add(measurable5.mo3865measureBRTryo0(j6));
                                }
                                ...
                                int i14 = m4828getMaxWidthimpl;
                                WindowInsets windowInsets7 = windowInsets2;
                                SubcomposeMeasureScope subcomposeMeasureScope11 = SubcomposeMeasureScope.this;
                                int i15 = m4827getMaxHeightimpl;
                                for (Placeable placeable7 : arrayList5) {
                                    Placeable.PlacementScope.place$default(layout, placeable7, windowInsets7.getLeft(subcomposeMeasureScope11, subcomposeMeasureScope11.getLayoutDirection()) + ((i14 - width3) / 2), i15 - intValue2, 0.0f, 4, null);
                                }
                                int i16 = m4827getMaxHeightimpl;
                                for (Placeable placeable8 : arrayList11) {
                                    Placeable.PlacementScope.place$default(layout, placeable8, 0, i16 - (valueOf != null ? valueOf.intValue() : 0), 0.0f, 4, null);
                                }
                                if (fabPlacement2 != null) {
                                    int i17 = m4827getMaxHeightimpl;
                                    for (Placeable placeable9 : arrayList7) {
                                        int left = fabPlacement2.getLeft();
                                        Intrinsics.checkNotNull(num);
                                        Placeable.PlacementScope.place$default(layout, placeable9, left, i17 - num.intValue(), 0.0f, 4, null);
                                    }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ScaffoldKt$ScaffoldLayout$2
            ...
            public final void invoke(Composer composer2, int i7) {
                ScaffoldKt.m1357access$ScaffoldLayoutFMILGgc(i, function2, function3, function22, function23, windowInsets, function24, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
            }
        });
    }
}