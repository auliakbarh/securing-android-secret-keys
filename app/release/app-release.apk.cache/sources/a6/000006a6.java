...
public final class LazyLayoutAnimateItemModifierNode extends Modifier.Node {
    ...
    public final long m625getRawOffsetnOccac() {
    ...
    public final void m626setRawOffsetgyyYBs(long j) {
        this.rawOffset = j;
    }
    ...
    public LazyLayoutAnimateItemModifierNode(FiniteAnimationSpec<IntOffset> placementAnimationSpec) {
        ...
        this.placementDeltaAnimation = new Animatable<>(IntOffset.m4981boximpl(IntOffset.Companion.m5000getZeronOccac()), VectorConvertersKt.getVectorConverter(IntOffset.Companion), null, null, 12, null);
        mutableStateOf$default2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m4981boximpl(IntOffset.Companion.m5000getZeronOccac()), null, 2, null);
    ...
    public final void m622setPlacementDeltagyyYBs(long j) {
        this.placementDelta$delegate.setValue(IntOffset.m4981boximpl(j));
    }

    /* renamed from: getPlacementDelta-nOcc-ac  reason: not valid java name */
    public final long m624getPlacementDeltanOccac() {
        return ((IntOffset) this.placementDelta$delegate.getValue()).m4999unboximpl();
    }
    ...
    public final void m623animatePlacementDeltagyyYBs(long j) {
        long m624getPlacementDeltanOccac = m624getPlacementDeltanOccac();
        long IntOffset = IntOffsetKt.IntOffset(IntOffset.m4990getXimpl(m624getPlacementDeltanOccac) - IntOffset.m4990getXimpl(j), IntOffset.m4991getYimpl(m624getPlacementDeltanOccac) - IntOffset.m4991getYimpl(j));
        m622setPlacementDeltagyyYBs(IntOffset);
    ...
    public void onDetach() {
        m622setPlacementDeltagyyYBs(IntOffset.Companion.m5000getZeronOccac());
    ...
    public static final class Companion {
        ...
        public final long m627getNotInitializednOccac() {
