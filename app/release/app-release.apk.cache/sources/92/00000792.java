...
public final class PagerMeasureKt {
    ...
    /* renamed from: access$getAndMeasure-SGf7dI0 */
    public static final /* synthetic */ MeasuredPage m694access$getAndMeasureSGf7dI0(LazyLayoutMeasureScope lazyLayoutMeasureScope, int i, long j, PagerLazyLayoutItemProvider pagerLazyLayoutItemProvider, long j2, Orientation orientation, Alignment.Horizontal horizontal, Alignment.Vertical vertical, LayoutDirection layoutDirection, boolean z, int i2) {
        return m695getAndMeasureSGf7dI0(lazyLayoutMeasureScope, i, j, pagerLazyLayoutItemProvider, j2, orientation, horizontal, vertical, layoutDirection, z, i2);
    }
    ...
    public static final PagerMeasureResult m696measurePagerntgEbfI(final LazyLayoutMeasureScope measurePager, int i, final PagerLazyLayoutItemProvider pagerItemProvider, int i2, int i3, int i4, int i5, int i6, int i7, float f, long j, final Orientation orientation, final Alignment.Vertical vertical, final Alignment.Horizontal horizontal, final boolean z, final long j2, final int i8, int i9, List<Integer> pinnedPages, Function3<? super Integer, ? super Integer, ? super Function1<? super Placeable.PlacementScope, Unit>, ? extends MeasureResult> layout) {
        ...
        if (i3 >= 0) {
            ...
            if (i <= 0) {
                return new PagerMeasureResult(CollectionsKt.emptyList(), 0, i8, i5, i4, orientation, -i3, i2 + i4, false, 0.0f, null, null, 0, false, layout.invoke(Integer.valueOf(Constraints.m4830getMinWidthimpl(j)), Integer.valueOf(Constraints.m4829getMinHeightimpl(j)), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$2
            ...
            final long Constraints$default = ConstraintsKt.Constraints$default(0, orientation == Orientation.Vertical ? Constraints.m4828getMaxWidthimpl(j) : i8, 0, orientation != Orientation.Vertical ? Constraints.m4827getMaxHeightimpl(j) : i8, 5, null);
            int i27 = i6;
            if (i27 >= i) {
                i27 = i - 1;
                i10 = 0;
            ...
            while (i31 < 0 && i27 > 0) {
                ...
                int i36 = i26;
                MeasuredPage m695getAndMeasureSGf7dI0 = m695getAndMeasureSGf7dI0(measurePager, i33, Constraints$default, pagerItemProvider, j2, orientation, horizontal, vertical, measurePager.getLayoutDirection(), z, i8);
                arrayDeque6.add(i36, m695getAndMeasureSGf7dI0);
                i32 = Math.max(i32, m695getAndMeasureSGf7dI0.getCrossAxisSize());
                i31 += i34;
                coerceAtLeast = i34;
            ...
            for (int i46 = i38; i46 < size; i46++) {
                MeasuredPage measuredPage3 = (MeasuredPage) arrayDeque8.get(i46);
                i45++;
                i44 += i37;
            }
            int i47 = i39;
            ...
            while (true) {
                if (i50 >= i52) {
                    ...
                    i17 = i2;
                    break;
                } else if (i49 >= coerceAtLeast2 && i49 > 0 && !arrayDeque7.isEmpty()) {
                    i12 = i51;
                    arrayDeque = arrayDeque8;
                    i14 = i43;
                    i17 = i42;
                    ...
                    int i60 = i43;
                    MeasuredPage m695getAndMeasureSGf7dI02 = m695getAndMeasureSGf7dI0(measurePager, i50, Constraints$default, pagerItemProvider, j2, orientation, horizontal, vertical, measurePager.getLayoutDirection(), z, i8);
                    i49 += i37;
                    if (i49 <= i54) {
                        i25 = i58;
                        if (i25 != i57 - 1) {
                    ...
                    int max = Math.max(i56, m695getAndMeasureSGf7dI02.getCrossAxisSize());
                    arrayDeque4 = arrayDeque9;
                    arrayDeque4.add(m695getAndMeasureSGf7dI02);
                    i53 = i55;
                    i51 = max;
                    i50 = i25 + 1;
                    i42 = i2;
            ...
            if (i16 < i17) {
                ...
                while (i65 < i62 && i63 > 0) {
                    ...
                    MeasuredPage m695getAndMeasureSGf7dI03 = m695getAndMeasureSGf7dI0(measurePager, i66, Constraints$default, pagerItemProvider, j2, orientation, horizontal, vertical, measurePager.getLayoutDirection(), z, i8);
                    arrayDeque11.add(0, m695getAndMeasureSGf7dI03);
                    i64 = Math.max(i64, m695getAndMeasureSGf7dI03.getCrossAxisSize());
                    i65 += i37;
                    i62 = i3;
            ...
            if (i3 > 0 || i5 < 0) {
                ...
                while (i71 < size2 && i70 != 0) {
                    ...
                    i70 -= i72;
                    i71++;
                    measuredPage4 = (MeasuredPage) arrayDeque3.get(i71);
                    i37 = i72;
                }
            ...
            List<MeasuredPage> createPagesBeforeList = createPagesBeforeList(i19, i9, pinnedPages, new Function1<Integer, MeasuredPage>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$extraPagesBefore$1
                ...
                public final MeasuredPage invoke(int i74) {
                    ...
                    return PagerMeasureKt.m694access$getAndMeasureSGf7dI0(lazyLayoutMeasureScope, i74, Constraints$default, pagerItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope.getLayoutDirection(), z, i8);
                }
            });
            ...
            List<MeasuredPage> createPagesAfterList = createPagesAfterList(((MeasuredPage) arrayDeque3.last()).getIndex(), i, i9, pinnedPages, new Function1<Integer, MeasuredPage>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$extraPagesAfter$1
                ...
                public final MeasuredPage invoke(int i77) {
                    LazyLayoutMeasureScope lazyLayoutMeasureScope = LazyLayoutMeasureScope.this;
                    return PagerMeasureKt.m694access$getAndMeasureSGf7dI0(lazyLayoutMeasureScope, i77, Constraints$default, pagerItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope.getLayoutDirection(), z, i8);
                }
            });
            ...
            boolean z3 = Intrinsics.areEqual(measuredPage5, arrayDeque12.first()) && createPagesBeforeList.isEmpty() && createPagesAfterList.isEmpty();
            ...
            int m4842constrainWidthK40F9xA = ConstraintsKt.m4842constrainWidthK40F9xA(j3, i24);
            if (orientation == Orientation.Vertical) {
                i77 = i76;
            }
            int m4841constrainHeightK40F9xA = ConstraintsKt.m4841constrainHeightK40F9xA(j3, i77);
            LazyLayoutMeasureScope lazyLayoutMeasureScope = measurePager;
            int i79 = i18;
            final List<MeasuredPage> calculatePagesOffsets = calculatePagesOffsets(measurePager, arrayDeque, createPagesBeforeList, createPagesAfterList, m4842constrainWidthK40F9xA, m4841constrainHeightK40F9xA, i76, i2, i69, orientation, z, lazyLayoutMeasureScope, i5, i8);
            if (z3) {
                ...
                for (int i80 = 0; i80 < size5; i80++) {
                    ...
                    if (measuredPage7.getIndex() >= ((MeasuredPage) arrayDeque12.first()).getIndex() && measuredPage7.getIndex() <= ((MeasuredPage) arrayDeque12.last()).getIndex()) {
                        arrayList2.add(measuredPage6);
                    }
                }
                arrayList = arrayList2;
            }
            int i81 = orientation == Orientation.Vertical ? m4841constrainHeightK40F9xA : m4842constrainWidthK40F9xA;
            if (arrayList.isEmpty()) {
                ...
                float f3 = -Math.abs(SnapPositionInLayoutKt.calculateDistanceToDesiredSnapPosition(lazyLayoutMeasureScope, i81, i3, i4, i8, measuredPage9.getOffset(), measuredPage9.getIndex(), PagerStateKt.getSnapAlignmentStartToStart()));
                ...
                if (1 <= lastIndex) {
                    ...
                    float f4 = f3;
                    while (true) {
                        MeasuredPage measuredPage11 = arrayList.get(i82);
                        MeasuredPage measuredPage12 = measuredPage11;
                        int i83 = i82;
                        z2 = z4;
                        float f5 = -Math.abs(SnapPositionInLayoutKt.calculateDistanceToDesiredSnapPosition(lazyLayoutMeasureScope, i81, i3, i4, i8, measuredPage12.getOffset(), measuredPage12.getIndex(), PagerStateKt.getSnapAlignmentStartToStart()));
            ...
            return new PagerMeasureResult(arrayList, i, i8, i5, i4, orientation, i29, i14, z, f2, measuredPage5, measuredPage2, i23, (i79 < i || i76 > i2) ? z2 : false, layout.invoke(Integer.valueOf(m4842constrainWidthK40F9xA), Integer.valueOf(m4841constrainHeightK40F9xA), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$6
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                ...
                public final void invoke2(Placeable.PlacementScope invoke) {
                    Intrinsics.checkNotNullParameter(invoke, "$this$invoke");
                    List<MeasuredPage> list = calculatePagesOffsets;
                    int size6 = list.size();
                    for (int i84 = 0; i84 < size6; i84++) {
                        list.get(i84).place(invoke);
                    }
                }
            }));
        }
    ...
    public static final MeasuredPage m695getAndMeasureSGf7dI0(LazyLayoutMeasureScope lazyLayoutMeasureScope, int i, long j, PagerLazyLayoutItemProvider pagerLazyLayoutItemProvider, long j2, Orientation orientation, Alignment.Horizontal horizontal, Alignment.Vertical vertical, LayoutDirection layoutDirection, boolean z, int i2) {
        return new MeasuredPage(i, i2, lazyLayoutMeasureScope.mo637measure0kLqBqw(i, j), j2, pagerLazyLayoutItemProvider.getKey(i), orientation, horizontal, vertical, layoutDirection, z, null);
    }
    ...
    private static final List<MeasuredPage> calculatePagesOffsets(LazyLayoutMeasureScope lazyLayoutMeasureScope, List<MeasuredPage> list, List<MeasuredPage> list2, List<MeasuredPage> list3, int i, int i2, int i3, int i4, int i5, Orientation orientation, boolean z, Density density, int i6, int i7) {
        ...
        if (z2) {
            ...
            Arrangement.HorizontalOrVertical m393spacedBy0680j_4 = Arrangement.Absolute.INSTANCE.m393spacedBy0680j_4(lazyLayoutMeasureScope.mo321toDpu2uoSUM(i7));
            if (orientation == Orientation.Vertical) {
                m393spacedBy0680j_4.arrange(density, i9, iArr, iArr2);
            } else {
                m393spacedBy0680j_4.arrange(density, i9, iArr, LayoutDirection.Ltr, iArr2);
            }
