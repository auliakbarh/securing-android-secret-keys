...
public interface Path {
    ...
    void mo2520addPathUv8p0NA(Path path, long j);
    ...
    boolean mo2522opN5in7k0(Path path, Path path2, int i);
    ...
    void mo2523setFillTypeoQ8Xj4U(int i);

    /* renamed from: transform-58bKbWc */
    default void mo2524transform58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
    }

    /* renamed from: translate-k-4lQ0M */
    void mo2525translatek4lQ0M(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static void m2895transform58bKbWc(Path path, float[] matrix) {
            Intrinsics.checkNotNullParameter(matrix, "matrix");
            Path.super.mo2524transform58bKbWc(matrix);
        }
    }
    ...
    static /* synthetic */ void m2892addPathUv8p0NA$default(Path path, Path path2, long j, int i, Object obj) {
        if (obj != null) {
        ...
        path.mo2520addPathUv8p0NA(path2, j);
    }
    ...
    public static final class Companion {
        ...
        public final Path m2893combinexh6zSI8(int i, Path path1, Path path2) {
            Intrinsics.checkNotNullParameter(path1, "path1");
            Intrinsics.checkNotNullParameter(path2, "path2");
            Path Path = AndroidPath_androidKt.Path();
            if (Path.mo2522opN5in7k0(path1, path2, i)) {
                return Path;
            }
