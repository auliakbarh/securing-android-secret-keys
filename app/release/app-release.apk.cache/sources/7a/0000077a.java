...
public final class PagerBeyondBoundsState implements LazyLayoutBeyondBoundsState {
    ...
    public int getLastPlacedIndex() {
        return Math.min(getItemCount() - 1, ((PageInfo) CollectionsKt.last((List<? extends Object>) this.state.getLayoutInfo$foundation_release().getVisiblePagesInfo())).getIndex() + this.beyondBoundsPageCount);
    }
}