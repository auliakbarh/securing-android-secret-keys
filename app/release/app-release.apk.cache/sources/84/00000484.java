...
public final class AlignmentLineOffsetDpElement extends ModifierNodeElement<AlignmentLineOffsetDpNode> {
    ...
    public final float m368getAfterD9Ej5fM() {
        return this.after;
    }
    ...
    public final float m369getBeforeD9Ej5fM() {
        return this.before;
    }
    ...
    private AlignmentLineOffsetDpElement(AlignmentLine alignmentLine, float f, float f2, Function1<? super InspectorInfo, Unit> inspectorInfo) {
        ...
        if ((f < 0.0f && !Dp.m4877equalsimpl0(f, Dp.Companion.m4892getUnspecifiedD9Ej5fM())) || (f2 < 0.0f && !Dp.m4877equalsimpl0(f2, Dp.Companion.m4892getUnspecifiedD9Ej5fM()))) {
    ...
    public void update(AlignmentLineOffsetDpNode node) {
        ...
        node.m373setBefore0680j_4(this.before);
        node.m372setAfter0680j_4(this.after);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetDpElement.alignmentLine) && Dp.m4877equalsimpl0(this.before, alignmentLineOffsetDpElement.before) && Dp.m4877equalsimpl0(this.after, alignmentLineOffsetDpElement.after);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + Dp.m4878hashCodeimpl(this.before)) * 31) + Dp.m4878hashCodeimpl(this.after);
    }
}