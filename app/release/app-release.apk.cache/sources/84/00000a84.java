...
public final class RippleHostView extends View {
    ...
    public static /* synthetic */ void m961$r8$lambda$4nztiuYeQHklB09QfMAnp7Ay8E(RippleHostView rippleHostView) {
    ...
    public final void m962addRippleKOepWvA(PressInteraction.Press interaction, boolean z, long j, int i, long j2, float f, Function0<Unit> onInvalidateRipple) {
        ...
        m963updateRipplePropertiesbiQXAtU(j, i, j2, f);
        if (z) {
            unprojectedRipple.setHotspot(Offset.m2389getXimpl(interaction.m357getPressPositionF1C5BW0()), Offset.m2390getYimpl(interaction.m357getPressPositionF1C5BW0()));
        } else {
    ...
    public final void m963updateRipplePropertiesbiQXAtU(long j, int i, long j2, float f) {
        UnprojectedRipple unprojectedRipple = this.ripple;
        if (unprojectedRipple == null) {
            return;
        }
        unprojectedRipple.trySetRadius(i);
        unprojectedRipple.m970setColorDxMtmZc(j2, f);
        Rect rect = new Rect(0, 0, MathKt.roundToInt(Size.m2458getWidthimpl(j)), MathKt.roundToInt(Size.m2455getHeightimpl(j)));
        setLeft(rect.left);
        setTop(rect.top);
        setRight(rect.right);
        ...
        if (z || longValue >= MinimumRippleStateChangeTime) {
            ...
            Runnable runnable2 = new Runnable() { // from class: androidx.compose.material.ripple.RippleHostView$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    RippleHostView.m961$r8$lambda$4nztiuYeQHklB09QfMAnp7Ay8E(RippleHostView.this);
                }
            };
