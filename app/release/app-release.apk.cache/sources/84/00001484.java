...
public final class InputMode {
    ...
    private static final int Touch = m3290constructorimpl(1);
    private static final int Keyboard = m3290constructorimpl(2);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ InputMode m3289boximpl(int i) {
    ...
    public static boolean m3291equalsimpl(int i, Object obj) {
        return (obj instanceof InputMode) && i == ((InputMode) obj).m3295unboximpl();
    }
    ...
    public static String m3294toStringimpl(int i) {
        return m3292equalsimpl0(i, Touch) ? "Touch" : m3292equalsimpl0(i, Keyboard) ? "Keyboard" : "Error";
    }
    ...
    public static final class Companion {
        ...
        public final int m3297getTouchaOaMEAU() {
            return InputMode.Touch;
        }

        /* renamed from: getKeyboard-aOaMEAU  reason: not valid java name */
        public final int m3296getKeyboardaOaMEAU() {
