...
public class Connector {
    ...
    public final int m3041getRenderIntentuksYyKA() {
    ...
    private Connector(ColorSpace source, ColorSpace destination, int i) {
        this(source, destination, ColorModel.m3028equalsimpl0(source.m3037getModelxdoWZVw(), ColorModel.Companion.m3035getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(source, Illuminant.INSTANCE.getD50(), null, 2, null) : source, ColorModel.m3028equalsimpl0(destination.m3037getModelxdoWZVw(), ColorModel.Companion.m3035getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(destination, Illuminant.INSTANCE.getD50(), null, 2, null) : destination, i, Companion.m3044computeTransformYBCOT_4(source, destination, i), null);
        Intrinsics.checkNotNullParameter(source, "source");
        Intrinsics.checkNotNullParameter(destination, "destination");
    }
    ...
    public long mo3042transformToColorwmQWz5c$ui_graphics_release(float f, float f2, float f3, float f4) {
        ...
        return this.transformDestination.mo3038xyzaToColorJlNiLsg$ui_graphics_release(f6, f5, z$ui_graphics_release, f4, this.destination);
    }
        ...
        */
        private RgbConnector(androidx.compose.ui.graphics.colorspace.Rgb r10, androidx.compose.ui.graphics.colorspace.Rgb r11, int r12) {
            /*
                ...
                r9.mSource = r10
                r9.mDestination = r11
                float[] r10 = r9.m3045computeTransformYBCOT_4(r10, r11, r12)
                r9.mTransform = r10
                return
            */
        ...
        private final float[] m3045computeTransformYBCOT_4(Rgb rgb, Rgb rgb2, int i) {
            ...
            if (RenderIntent.m3049equalsimpl0(i, RenderIntent.Companion.m3053getAbsoluteuksYyKA())) {
    ...
    public static final class Companion {
        ...
        /* renamed from: computeTransform-YBCOT_4  reason: not valid java name */
        public final float[] m3044computeTransformYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
            if (RenderIntent.m3049equalsimpl0(i, RenderIntent.Companion.m3053getAbsoluteuksYyKA())) {
                boolean m3028equalsimpl0 = ColorModel.m3028equalsimpl0(colorSpace.m3037getModelxdoWZVw(), ColorModel.Companion.m3035getRgbxdoWZVw());
                boolean m3028equalsimpl02 = ColorModel.m3028equalsimpl0(colorSpace2.m3037getModelxdoWZVw(), ColorModel.Companion.m3035getRgbxdoWZVw());
                if (m3028equalsimpl0 && m3028equalsimpl02) {
                    return null;
                }
                if (m3028equalsimpl0 || m3028equalsimpl02) {
                    if (!m3028equalsimpl0) {
                    ...
                    float[] xyz$ui_graphics_release = m3028equalsimpl0 ? rgb.getWhitePoint().toXyz$ui_graphics_release() : Illuminant.INSTANCE.getD50Xyz$ui_graphics_release();
                    float[] xyz$ui_graphics_release2 = m3028equalsimpl02 ? rgb.getWhitePoint().toXyz$ui_graphics_release() : Illuminant.INSTANCE.getD50Xyz$ui_graphics_release();
        ...
        public final Connector identity$ui_graphics_release(final ColorSpace source) {
            Intrinsics.checkNotNullParameter(source, "source");
            final int m3055getRelativeuksYyKA = RenderIntent.Companion.m3055getRelativeuksYyKA();
            return new Connector(source, m3055getRelativeuksYyKA) { // from class: androidx.compose.ui.graphics.colorspace.Connector$Companion$identity$1
                @Override // androidx.compose.ui.graphics.colorspace.Connector
                public float[] transform(float[] v) {
                    Intrinsics.checkNotNullParameter(v, "v");
                    return v;
                ...
                {
                    super(source, source, m3055getRelativeuksYyKA, null);
                }
    ...
    static {
        ...
        SrgbToOklabPerceptual = new Connector(ColorSpaces.INSTANCE.getSrgb(), ColorSpaces.INSTANCE.getOklab(), RenderIntent.Companion.m3054getPerceptualuksYyKA(), null);
        OklabToSrgbPerceptual = new Connector(ColorSpaces.INSTANCE.getOklab(), ColorSpaces.INSTANCE.getSrgb(), RenderIntent.Companion.m3054getPerceptualuksYyKA(), null);
    }
}