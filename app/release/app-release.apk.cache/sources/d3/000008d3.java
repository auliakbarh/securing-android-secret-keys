...
final class VerticalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo36measure3p2s80s(final MeasureScope measure, Measurable measurable, long j) {
        ...
        final Placeable mo3865measureBRTryo0 = measurable.mo3865measureBRTryo0(Constraints.m4819copyZbe2FdA$default(j, 0, 0, 0, Integer.MAX_VALUE, 7, null));
        final int min = Math.min(mo3865measureBRTryo0.getHeight(), Constraints.m4827getMaxHeightimpl(j));
        return MeasureScope.layout$default(measure, mo3865measureBRTryo0.getWidth(), min, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.VerticalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                this.getScrollerPosition().update(Orientation.Vertical, TextFieldScrollKt.access$getCursorRectInScroller(measureScope, cursorOffset, transformedText, invoke != null ? invoke.getValue() : null, false, mo3865measureBRTryo0.getWidth()), min, mo3865measureBRTryo0.getHeight());
                Placeable.PlacementScope.placeRelative$default(layout, mo3865measureBRTryo0, 0, MathKt.roundToInt(-this.getScrollerPosition().getOffset()), 0.0f, 4, null);
            }
        }, 4, null);
    }
}