...
public final class ButtonDefaults {
    ...
    public final ButtonColors m1001buttonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long m2627copywmQWz5c$default = (i2 & 4) != 0 ? Color.m2627copywmQWz5c$default(ColorSchemeKt.toColor(FilledButtonTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long m2627copywmQWz5c$default2 = (i2 & 8) != 0 ? Color.m2627copywmQWz5c$default(ColorSchemeKt.toColor(FilledButtonTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-339300779, i, -1, "androidx.compose.material3.ButtonDefaults.buttonColors (Button.kt:552)");
        }
        ButtonColors buttonColors = new ButtonColors(color, color2, m2627copywmQWz5c$default, m2627copywmQWz5c$default2, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ButtonColors m1003elevatedButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long m2627copywmQWz5c$default = (i2 & 4) != 0 ? Color.m2627copywmQWz5c$default(ColorSchemeKt.toColor(ElevatedButtonTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long m2627copywmQWz5c$default2 = (i2 & 8) != 0 ? Color.m2627copywmQWz5c$default(ColorSchemeKt.toColor(ElevatedButtonTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ButtonColors m1005filledTonalButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long m2627copywmQWz5c$default = (i2 & 4) != 0 ? Color.m2627copywmQWz5c$default(ColorSchemeKt.toColor(FilledTonalButtonTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long m2627copywmQWz5c$default2 = (i2 & 8) != 0 ? Color.m2627copywmQWz5c$default(ColorSchemeKt.toColor(FilledTonalButtonTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ButtonColors m1011outlinedButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long m2663getTransparent0d7_KjU = (i2 & 1) != 0 ? Color.Companion.m2663getTransparent0d7_KjU() : j;
        long color = (i2 & 2) != 0 ? ColorSchemeKt.toColor(OutlinedButtonTokens.INSTANCE.getLabelTextColor(), composer, 6) : j2;
        long m2663getTransparent0d7_KjU2 = (i2 & 4) != 0 ? Color.Companion.m2663getTransparent0d7_KjU() : j3;
        long m2627copywmQWz5c$default = (i2 & 8) != 0 ? Color.m2627copywmQWz5c$default(ColorSchemeKt.toColor(OutlinedButtonTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1778526249, i, -1, "androidx.compose.material3.ButtonDefaults.outlinedButtonColors (Button.kt:629)");
        }
        ButtonColors buttonColors = new ButtonColors(m2663getTransparent0d7_KjU, color, m2663getTransparent0d7_KjU2, m2627copywmQWz5c$default, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ButtonColors m1012textButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long m2663getTransparent0d7_KjU2 = (i2 & 4) != 0 ? Color.Companion.m2663getTransparent0d7_KjU() : j3;
        long m2627copywmQWz5c$default = (i2 & 8) != 0 ? Color.m2627copywmQWz5c$default(ColorSchemeKt.toColor(TextButtonTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ButtonElevation m1002buttonElevationR_JCAzs(float f, float f2, float f3, float f4, float f5, Composer composer, int i, int i2) {
        ...
        float m1884getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? FilledButtonTokens.INSTANCE.m1884getContainerElevationD9Ej5fM() : f;
        float m1890getPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? FilledButtonTokens.INSTANCE.m1890getPressedContainerElevationD9Ej5fM() : f2;
        float m1887getFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? FilledButtonTokens.INSTANCE.m1887getFocusContainerElevationD9Ej5fM() : f3;
        float m1888getHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? FilledButtonTokens.INSTANCE.m1888getHoverContainerElevationD9Ej5fM() : f4;
        float m1886getDisabledContainerElevationD9Ej5fM = (i2 & 16) != 0 ? FilledButtonTokens.INSTANCE.m1886getDisabledContainerElevationD9Ej5fM() : f5;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1827791191, i, -1, "androidx.compose.material3.ButtonDefaults.buttonElevation (Button.kt:679)");
        }
        ButtonElevation buttonElevation = new ButtonElevation(m1884getContainerElevationD9Ej5fM, m1890getPressedContainerElevationD9Ej5fM, m1887getFocusContainerElevationD9Ej5fM, m1888getHoverContainerElevationD9Ej5fM, m1886getDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ButtonElevation m1004elevatedButtonElevationR_JCAzs(float f, float f2, float f3, float f4, float f5, Composer composer, int i, int i2) {
        ...
        float m1800getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? ElevatedButtonTokens.INSTANCE.m1800getContainerElevationD9Ej5fM() : f;
        float m1806getPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? ElevatedButtonTokens.INSTANCE.m1806getPressedContainerElevationD9Ej5fM() : f2;
        float m1803getFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? ElevatedButtonTokens.INSTANCE.m1803getFocusContainerElevationD9Ej5fM() : f3;
        float m1804getHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? ElevatedButtonTokens.INSTANCE.m1804getHoverContainerElevationD9Ej5fM() : f4;
        float m1802getDisabledContainerElevationD9Ej5fM = (i2 & 16) != 0 ? ElevatedButtonTokens.INSTANCE.m1802getDisabledContainerElevationD9Ej5fM() : f5;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ButtonElevation buttonElevation = new ButtonElevation(m1800getContainerElevationD9Ej5fM, m1806getPressedContainerElevationD9Ej5fM, m1803getFocusContainerElevationD9Ej5fM, m1804getHoverContainerElevationD9Ej5fM, m1802getDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ButtonElevation m1006filledTonalButtonElevationR_JCAzs(float f, float f2, float f3, float f4, float f5, Composer composer, int i, int i2) {
        ...
        float m1907getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? FilledTonalButtonTokens.INSTANCE.m1907getContainerElevationD9Ej5fM() : f;
        float m1913getPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? FilledTonalButtonTokens.INSTANCE.m1913getPressedContainerElevationD9Ej5fM() : f2;
        float m1910getFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? FilledTonalButtonTokens.INSTANCE.m1910getFocusContainerElevationD9Ej5fM() : f3;
        float m1911getHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? FilledTonalButtonTokens.INSTANCE.m1911getHoverContainerElevationD9Ej5fM() : f4;
        float m4872constructorimpl = (i2 & 16) != 0 ? Dp.m4872constructorimpl(0) : f5;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ButtonElevation buttonElevation = new ButtonElevation(m1907getContainerElevationD9Ej5fM, m1913getPressedContainerElevationD9Ej5fM, m1910getFocusContainerElevationD9Ej5fM, m1911getHoverContainerElevationD9Ej5fM, m4872constructorimpl, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final BorderStroke getOutlinedButtonBorder(Composer composer, int i) {
        ...
        BorderStroke m185BorderStrokecXLIe8U = BorderStrokeKt.m185BorderStrokecXLIe8U(OutlinedButtonTokens.INSTANCE.m1992getOutlineWidthD9Ej5fM(), ColorSchemeKt.toColor(OutlinedButtonTokens.INSTANCE.getOutlineColor(), composer, 6));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    static {
        float m4872constructorimpl = Dp.m4872constructorimpl(24);
        ButtonHorizontalPadding = m4872constructorimpl;
        float f = 8;
        float m4872constructorimpl2 = Dp.m4872constructorimpl(f);
        ButtonVerticalPadding = m4872constructorimpl2;
        PaddingValues m475PaddingValuesa9UjIt4 = PaddingKt.m475PaddingValuesa9UjIt4(m4872constructorimpl, m4872constructorimpl2, m4872constructorimpl, m4872constructorimpl2);
        ContentPadding = m475PaddingValuesa9UjIt4;
        float f2 = 16;
        float m4872constructorimpl3 = Dp.m4872constructorimpl(f2);
        ButtonWithIconHorizontalStartPadding = m4872constructorimpl3;
        ButtonWithIconContentPadding = PaddingKt.m475PaddingValuesa9UjIt4(m4872constructorimpl3, m4872constructorimpl2, m4872constructorimpl, m4872constructorimpl2);
        float m4872constructorimpl4 = Dp.m4872constructorimpl(12);
        TextButtonHorizontalPadding = m4872constructorimpl4;
        TextButtonContentPadding = PaddingKt.m475PaddingValuesa9UjIt4(m4872constructorimpl4, m475PaddingValuesa9UjIt4.mo432calculateTopPaddingD9Ej5fM(), m4872constructorimpl4, m475PaddingValuesa9UjIt4.mo429calculateBottomPaddingD9Ej5fM());
        float m4872constructorimpl5 = Dp.m4872constructorimpl(f2);
        TextButtonWithIconHorizontalEndPadding = m4872constructorimpl5;
        TextButtonWithIconContentPadding = PaddingKt.m475PaddingValuesa9UjIt4(m4872constructorimpl4, m475PaddingValuesa9UjIt4.mo432calculateTopPaddingD9Ej5fM(), m4872constructorimpl5, m475PaddingValuesa9UjIt4.mo429calculateBottomPaddingD9Ej5fM());
        MinWidth = Dp.m4872constructorimpl(58);
        MinHeight = Dp.m4872constructorimpl(40);
        IconSize = FilledButtonTokens.INSTANCE.m1889getIconSizeD9Ej5fM();
        IconSpacing = Dp.m4872constructorimpl(f);
    }
}