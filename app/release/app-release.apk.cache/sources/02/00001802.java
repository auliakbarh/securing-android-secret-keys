...
public final class CacheTextLayoutInput {
    ...
    public int hashCode() {
        ...
        return (((((((((((((((((((textLayoutInput.getText().hashCode() * 31) + textLayoutInput.getStyle().hashCodeLayoutAffectingAttributes$ui_text_release()) * 31) + textLayoutInput.getPlaceholders().hashCode()) * 31) + textLayoutInput.getMaxLines()) * 31) + Boolean.hashCode(textLayoutInput.getSoftWrap())) * 31) + TextOverflow.m4807hashCodeimpl(textLayoutInput.m4372getOverflowgIe3tQ8())) * 31) + textLayoutInput.getDensity().hashCode()) * 31) + textLayoutInput.getLayoutDirection().hashCode()) * 31) + textLayoutInput.getFontFamilyResolver().hashCode()) * 31) + Integer.hashCode(Constraints.m4828getMaxWidthimpl(textLayoutInput.m4371getConstraintsmsEJaDk()))) * 31) + Integer.hashCode(Constraints.m4827getMaxHeightimpl(textLayoutInput.m4371getConstraintsmsEJaDk()));
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CacheTextLayoutInput) {
            ...
            return Intrinsics.areEqual(textLayoutInput.getText(), cacheTextLayoutInput.textLayoutInput.getText()) && textLayoutInput.getStyle().hasSameLayoutAffectingAttributes(cacheTextLayoutInput.textLayoutInput.getStyle()) && Intrinsics.areEqual(textLayoutInput.getPlaceholders(), cacheTextLayoutInput.textLayoutInput.getPlaceholders()) && textLayoutInput.getMaxLines() == cacheTextLayoutInput.textLayoutInput.getMaxLines() && textLayoutInput.getSoftWrap() == cacheTextLayoutInput.textLayoutInput.getSoftWrap() && TextOverflow.m4806equalsimpl0(textLayoutInput.m4372getOverflowgIe3tQ8(), cacheTextLayoutInput.textLayoutInput.m4372getOverflowgIe3tQ8()) && Intrinsics.areEqual(textLayoutInput.getDensity(), cacheTextLayoutInput.textLayoutInput.getDensity()) && textLayoutInput.getLayoutDirection() == cacheTextLayoutInput.textLayoutInput.getLayoutDirection() && textLayoutInput.getFontFamilyResolver() == cacheTextLayoutInput.textLayoutInput.getFontFamilyResolver() && Constraints.m4828getMaxWidthimpl(textLayoutInput.m4371getConstraintsmsEJaDk()) == Constraints.m4828getMaxWidthimpl(cacheTextLayoutInput.textLayoutInput.m4371getConstraintsmsEJaDk()) && Constraints.m4827getMaxHeightimpl(textLayoutInput.m4371getConstraintsmsEJaDk()) == Constraints.m4827getMaxHeightimpl(cacheTextLayoutInput.textLayoutInput.m4371getConstraintsmsEJaDk());
        }
        return false;
    }
}