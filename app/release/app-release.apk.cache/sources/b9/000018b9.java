...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m4453getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int i) {
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.Companion)) >= 0, FontStyle.m4499equalsimpl0(i, FontStyle.Companion.m4503getItalic_LCdwA()));
    }
}