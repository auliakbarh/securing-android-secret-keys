...
public final class LazyListItemProviderImpl implements LazyListItemProvider {
    ...
    public static final /* synthetic */ LazyListIntervalContent access$getIntervalContent$p(LazyListItemProviderImpl lazyListItemProviderImpl) {
        return lazyListItemProviderImpl.intervalContent;
    }
    ...
    public void Item(final int i, final Object key, Composer composer, final int i2) {
        ...
        LazyLayoutPinnableItemKt.LazyLayoutPinnableItem(key, i, this.state.getPinnedItems$foundation_release(), ComposableLambdaKt.composableLambda(startRestartGroup, -824725566, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.LazyListItemProviderImpl$Item$1
            ...
            public final void invoke(Composer composer2, int i3) {
                ...
                if ((i3 & 11) != 2 || !composer2.getSkipping()) {
                    ...
                    IntervalList.Interval<LazyListInterval> interval = LazyListItemProviderImpl.access$getIntervalContent$p(LazyListItemProviderImpl.this).getIntervals().get(i4);
