...
public final class BaselineShift {
    ...
    private static final float Superscript = m4660constructorimpl(0.5f);
    private static final float Subscript = m4660constructorimpl(-0.5f);
    private static final float None = m4660constructorimpl(0.0f);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ BaselineShift m4659boximpl(float f) {
        return new BaselineShift(f);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static float m4660constructorimpl(float f) {
        return f;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4661equalsimpl(float f, Object obj) {
        return (obj instanceof BaselineShift) && Float.compare(f, ((BaselineShift) obj).m4665unboximpl()) == 0;
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m4662equalsimpl0(float f, float f2) {
        return Float.compare(f, f2) == 0;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m4663hashCodeimpl(float f) {
        return Float.hashCode(f);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m4664toStringimpl(float f) {
        return "BaselineShift(multiplier=" + f + ')';
    }

    public boolean equals(Object obj) {
        return m4661equalsimpl(this.multiplier, obj);
    }
    ...
    public int hashCode() {
        return m4663hashCodeimpl(this.multiplier);
    }

    public String toString() {
        return m4664toStringimpl(this.multiplier);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ float m4665unboximpl() {
        return this.multiplier;
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m4666getNoney9eOQZs$annotations() {
        }

        /* renamed from: getSubscript-y9eOQZs$annotations  reason: not valid java name */
        public static /* synthetic */ void m4667getSubscripty9eOQZs$annotations() {
        }

        /* renamed from: getSuperscript-y9eOQZs$annotations  reason: not valid java name */
        public static /* synthetic */ void m4668getSuperscripty9eOQZs$annotations() {
        }
