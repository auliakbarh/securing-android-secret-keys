...
public final class TopAppBarColors {
    ...
    public final long m1668getActionIconContentColor0d7_KjU$material3_release() {
    ...
    public final long m1669getNavigationIconContentColor0d7_KjU$material3_release() {
    ...
    public final long m1670getTitleContentColor0d7_KjU$material3_release() {
    ...
    public final long m1667containerColorXeAY9LY$material3_release(float f, Composer composer, int i) {
        ...
        long m2679lerpjxsXWHM = ColorKt.m2679lerpjxsXWHM(this.containerColor, this.scrolledContainerColor, EasingKt.getFastOutLinearInEasing().transform(f));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m2679lerpjxsXWHM;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m2629equalsimpl0(this.containerColor, topAppBarColors.containerColor) && Color.m2629equalsimpl0(this.scrolledContainerColor, topAppBarColors.scrolledContainerColor) && Color.m2629equalsimpl0(this.navigationIconContentColor, topAppBarColors.navigationIconContentColor) && Color.m2629equalsimpl0(this.titleContentColor, topAppBarColors.titleContentColor) && Color.m2629equalsimpl0(this.actionIconContentColor, topAppBarColors.actionIconContentColor);
    }

    public int hashCode() {
        return (((((((Color.m2635hashCodeimpl(this.containerColor) * 31) + Color.m2635hashCodeimpl(this.scrolledContainerColor)) * 31) + Color.m2635hashCodeimpl(this.navigationIconContentColor)) * 31) + Color.m2635hashCodeimpl(this.titleContentColor)) * 31) + Color.m2635hashCodeimpl(this.actionIconContentColor);
    }
}