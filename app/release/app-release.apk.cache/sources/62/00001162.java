...
public final class Updater<T> {
    ...
    public static final /* synthetic */ Updater m2261boximpl(Composer composer) {
        return new Updater(composer);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static <T> Composer m2262constructorimpl(Composer composer) {
        Intrinsics.checkNotNullParameter(composer, "composer");
        return composer;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2263equalsimpl(Composer composer, Object obj) {
        return (obj instanceof Updater) && Intrinsics.areEqual(composer, ((Updater) obj).m2273unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m2264equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m2265hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m2270toStringimpl(Composer composer) {
        return "Updater(composer=" + composer + ')';
    }

    public boolean equals(Object obj) {
        return m2263equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m2265hashCodeimpl(this.composer);
    }

    public String toString() {
        return m2270toStringimpl(this.composer);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ Composer m2273unboximpl() {
    ...
    public static final void m2268setimpl(Composer composer, int i, Function2<? super T, ? super Integer, Unit> block) {
    ...
    /* renamed from: set-impl  reason: not valid java name */
    public static final <V> void m2269setimpl(Composer composer, V v, Function2<? super T, ? super V, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    public static final void m2271updateimpl(Composer composer, int i, Function2<? super T, ? super Integer, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    /* renamed from: update-impl  reason: not valid java name */
    public static final <V> void m2272updateimpl(Composer composer, V v, Function2<? super T, ? super V, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        boolean inserting = composer.getInserting();
    ...
    public static final void m2266initimpl(Composer composer, final Function1<? super T, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    public static final void m2267reconcileimpl(Composer composer, final Function1<? super T, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
