...
public final class LazyGridItemProviderImpl implements LazyGridItemProvider {
    ...
    public static final /* synthetic */ LazyGridIntervalContent access$getIntervalContent$p(LazyGridItemProviderImpl lazyGridItemProviderImpl) {
        return lazyGridItemProviderImpl.intervalContent;
    }
    ...
    public void Item(final int i, final Object key, Composer composer, final int i2) {
        ...
        LazyLayoutPinnableItemKt.LazyLayoutPinnableItem(key, i, this.state.getPinnedItems$foundation_release(), ComposableLambdaKt.composableLambda(startRestartGroup, 726189336, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridItemProviderImpl$Item$1
            ...
            public final void invoke(Composer composer2, int i3) {
                ...
                if ((i3 & 11) != 2 || !composer2.getSkipping()) {
                    ...
                    int i4 = i;
                    IntervalList.Interval<LazyGridInterval> interval = LazyGridItemProviderImpl.access$getIntervalContent$p(LazyGridItemProviderImpl.this).getIntervals().get(i4);
