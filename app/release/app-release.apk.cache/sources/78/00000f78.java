...
public final class TimePicker_androidKt {
    ...
    public static final int getDefaultTimePickerLayoutType(Composer composer, int i) {
        ...
        if (configuration.screenHeightDp < configuration.screenWidthDp) {
            m1589getVerticalQJTpgSE = TimePickerLayoutType.Companion.m1588getHorizontalQJTpgSE();
        } else {
            m1589getVerticalQJTpgSE = TimePickerLayoutType.Companion.m1589getVerticalQJTpgSE();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m1589getVerticalQJTpgSE;
    }
}