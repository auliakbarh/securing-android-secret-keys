...
public final class AndroidAccessibilitySpannableString_androidKt {
    ...
    private static final void setSpanStyle(SpannableString spannableString, SpanStyle spanStyle, int i, int i2, Density density, FontFamily.Resolver resolver) {
        ...
        SpannableExtensions_androidKt.m4650setColorRPmYEkk(spannableString2, spanStyle.m4362getColor0d7_KjU(), i, i2);
        SpannableExtensions_androidKt.m4651setFontSizeKmRG4DE(spannableString2, spanStyle.m4363getFontSizeXSAIIZE(), density, i, i2);
        if (spanStyle.getFontWeight() != null || spanStyle.m4364getFontStyle4Lr2A7w() != null) {
            FontWeight fontWeight = spanStyle.getFontWeight();
            if (fontWeight == null) {
                fontWeight = FontWeight.Companion.getNormal();
            }
            FontStyle m4364getFontStyle4Lr2A7w = spanStyle.m4364getFontStyle4Lr2A7w();
            spannableString.setSpan(new StyleSpan(AndroidFontUtils_androidKt.m4453getAndroidTypefaceStyleFO1MlWM(fontWeight, m4364getFontStyle4Lr2A7w != null ? m4364getFontStyle4Lr2A7w.m4502unboximpl() : FontStyle.Companion.m4504getNormal_LCdwA())), i, i2, 33);
        }
        if (spanStyle.getFontFamily() != null) {
            if (spanStyle.getFontFamily() instanceof GenericFontFamily) {
                ...
                Object value = FontFamily.Resolver.m4473resolveDPcqOEQ$default(resolver, fontFamily, null, 0, m4365getFontSynthesisZQGJjVo != null ? m4365getFontSynthesisZQGJjVo.m4513unboximpl() : FontSynthesis.Companion.m4514getAllGVVA2EU(), 6, null).getValue();
        ...
        SpannableExtensions_androidKt.m4648setBackgroundRPmYEkk(spannableString2, spanStyle.m4360getBackground0d7_KjU(), i, i2);
    }
}