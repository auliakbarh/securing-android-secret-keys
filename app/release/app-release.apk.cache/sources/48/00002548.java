...
public final class AgentPremain {
    ...
    public static /* synthetic */ void $r8$lambda$8e1eAWGNJu9vYr96rU9gzKJ_uMQ(Signal signal) {
        m6688installSignalHandler$lambda1(signal);
    }
    ...
    static {
        ...
        try {
            ...
            m5158constructorimpl = Result.m5158constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m5158constructorimpl = Result.m5158constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = Result.m5164isFailureimpl(m5158constructorimpl) ? null : m5158constructorimpl;
        if (bool != null) {
    ...
    public static final void m6688installSignalHandler$lambda1(Signal signal) {
