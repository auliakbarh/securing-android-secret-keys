...
public final class AgentPremain {
    ...
    public static /* synthetic */ void $r8$lambda$8e1eAWGNJu9vYr96rU9gzKJ_uMQ(Signal signal) {
        m6685installSignalHandler$lambda1(signal);
    }
    ...
    static {
        ...
        try {
            ...
            m5155constructorimpl = Result.m5155constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m5155constructorimpl = Result.m5155constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = Result.m5161isFailureimpl(m5155constructorimpl) ? null : m5155constructorimpl;
        if (bool != null) {
    ...
    public static final void m6685installSignalHandler$lambda1(Signal signal) {
