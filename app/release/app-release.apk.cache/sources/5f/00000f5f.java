...
public final class TimePickerKt$clockDial$2 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier composed, Composer composer, int i) {
        ...
        if (rememberedValue3 == Composer.Companion.getEmpty()) {
            rememberedValue3 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m4981boximpl(IntOffset.Companion.m5000getZeronOccac()), null, 2, null);
        ...
        float mo324toPx0680j_4 = ((Density) consume).mo324toPx0680j_4(f);
        ...
        if (changed || rememberedValue5 == Composer.Companion.getEmpty()) {
            rememberedValue5 = (Function1) new Function1<IntSize, Unit>() { // from class: androidx.compose.material3.TimePickerKt$clockDial$2$1$1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
                    m1577invokeozmzZPI(intSize.m5036unboximpl());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-ozmzZPI  reason: not valid java name */
                public final void m1577invokeozmzZPI(long j) {
                    TimePickerState.this.m1593setCentergyyYBs$material3_release(IntSizeKt.m5038getCenterozmzZPI(j));
                }
            };
            composer.updateRememberedValue(rememberedValue5);
        }
        composer.endReplaceableGroup();
        Modifier pointerInput = SuspendingPointerInputFilterKt.pointerInput(SuspendingPointerInputFilterKt.pointerInput(OnRemeasuredModifierKt.onSizeChanged(companion, (Function1) rememberedValue5), new Object[]{this.$state, IntOffset.m4981boximpl(invoke$lambda$7(mutableState3)), Float.valueOf(mo324toPx0680j_4)}, (Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object>) new AnonymousClass2(mutableState, mutableState2, coroutineScope, this.$state, mo324toPx0680j_4, this.$autoSwitchToMinute, null)), new Object[]{this.$state, IntOffset.m4981boximpl(invoke$lambda$7(mutableState3)), Float.valueOf(mo324toPx0680j_4)}, (Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object>) new AnonymousClass3(coroutineScope, this.$state, this.$autoSwitchToMinute, mo324toPx0680j_4, mutableState, mutableState2, null));
        if (ComposerKt.isTraceInProgress()) {
    ...
    private static final long invoke$lambda$7(MutableState<IntOffset> mutableState) {
        return mutableState.getValue().m4999unboximpl();
    }
    ...
    public static final class AnonymousClass2 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        ...
        public static final class AnonymousClass1 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
            ...
            public /* bridge */ /* synthetic */ Object invoke(PressGestureScope pressGestureScope, Offset offset, Continuation<? super Unit> continuation) {
                return m1578invoked4ec7I(pressGestureScope, offset.m2399unboximpl(), continuation);
            }

            /* renamed from: invoke-d-4ec7I  reason: not valid java name */
            public final Object m1578invoked4ec7I(PressGestureScope pressGestureScope, long j, Continuation<? super Unit> continuation) {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (this.label == 0) {
                    ...
                    long j = this.J$0;
                    TimePickerKt$clockDial$2.invoke$lambda$2(this.$offsetX$delegate, Offset.m2389getXimpl(j));
                    TimePickerKt$clockDial$2.invoke$lambda$5(this.$offsetY$delegate, Offset.m2390getYimpl(j));
                    return Unit.INSTANCE;
                }
            ...
            if (i == 0) {
                ...
                if (TapGestureDetectorKt.detectTapGestures$default((PointerInputScope) this.L$0, null, null, new AnonymousClass1(this.$offsetX$delegate, this.$offsetY$delegate, null), new Function1<Offset, Unit>() { // from class: androidx.compose.material3.TimePickerKt.clockDial.2.2.2
                    ...
                    public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                        m1579invokek4lQ0M(offset.m2399unboximpl());
                        return Unit.INSTANCE;
                    }

                    /* renamed from: invoke-k-4lQ0M  reason: not valid java name */
                    public final void m1579invokek4lQ0M(long j) {
                    ...
                    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                        ...
                        public final Object invokeSuspend(Object obj) {
                            ...
                            if (i == 0) {
                                ResultKt.throwOnFailure(obj);
                                this.label = 1;
                                if (this.$state.onTap$material3_release(Offset.m2389getXimpl(this.$it), Offset.m2390getYimpl(this.$it), this.$maxDist, this.$autoSwitchToMinute, this) == coroutine_suspended) {
                ...
                if (DragGestureDetectorKt.detectDragGestures$default((PointerInputScope) this.L$0, null, new Function0<Unit>() { // from class: androidx.compose.material3.TimePickerKt.clockDial.2.3.1
                    ...
                    public static final class C00421 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                        ...
                        public final Object invokeSuspend(Object obj) {
                            ...
                            if (i == 0) {
                                ResultKt.throwOnFailure(obj);
                                if (Selection.m1374equalsimpl0(this.$state.m1591getSelectionJiIwxys$material3_release(), Selection.Companion.m1378getHourJiIwxys()) && this.$autoSwitchToMinute) {
                                    this.$state.m1594setSelectioniHAOin8$material3_release(Selection.Companion.m1379getMinuteJiIwxys());
                                    this.label = 1;
                                    if (this.$state.animateToCurrent$material3_release(this) == coroutine_suspended) {
                                        return coroutine_suspended;
                                    }
                                } else if (Selection.m1374equalsimpl0(this.$state.m1591getSelectionJiIwxys$material3_release(), Selection.Companion.m1379getMinuteJiIwxys())) {
                                    this.label = 2;
                    ...
                    public /* bridge */ /* synthetic */ Unit invoke(PointerInputChange pointerInputChange, Offset offset) {
                        m1580invokeUv8p0NA(pointerInputChange, offset.m2399unboximpl());
                        return Unit.INSTANCE;
                    }

                    /* renamed from: invoke-Uv8p0NA  reason: not valid java name */
                    public final void m1580invokeUv8p0NA(PointerInputChange pointerInputChange, long j) {
                    ...
                    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                        ...
                        public final Object invokeSuspend(Object obj) {
                            ...
                            if (i == 0) {
                                ...
                                TimePickerKt$clockDial$2.invoke$lambda$2(mutableState, TimePickerKt$clockDial$2.invoke$lambda$1(mutableState) + Offset.m2389getXimpl(this.$dragAmount));
                                MutableState<Float> mutableState2 = this.$offsetY$delegate;
                                TimePickerKt$clockDial$2.invoke$lambda$5(mutableState2, TimePickerKt$clockDial$2.invoke$lambda$4(mutableState2) + Offset.m2390getYimpl(this.$dragAmount));
                                TimePickerState timePickerState = this.$state;
                                atan = TimePickerKt.atan(TimePickerKt$clockDial$2.invoke$lambda$4(this.$offsetY$delegate) - IntOffset.m4991getYimpl(this.$state.m1590getCenternOccac$material3_release()), TimePickerKt$clockDial$2.invoke$lambda$1(this.$offsetX$delegate) - IntOffset.m4990getXimpl(this.$state.m1590getCenternOccac$material3_release()));
                                this.label = 1;
