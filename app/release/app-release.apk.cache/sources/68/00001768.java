...
public final class ViewLayer extends View implements OwnedLayer, GraphicLayerInfo {
    ...
    public ViewLayer(AndroidComposeView ownerView, DrawChildContainer container, Function1<? super Canvas, Unit> drawBlock, Function0<Unit> invalidateParentLayer) {
        ...
        this.mTransformOrigin = TransformOrigin.Companion.m3012getCenterSzJe1aQ();
    ...
    public void mo4131updateLayerPropertiesdDxrwY(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape, boolean z, RenderEffect renderEffect, long j2, long j3, int i, LayoutDirection layoutDirection, Density density) {
        ...
        setRotationX(f7);
        setRotationY(f8);
        setPivotX(TransformOrigin.m3007getPivotFractionXimpl(this.mTransformOrigin) * getWidth());
        setPivotY(TransformOrigin.m3008getPivotFractionYimpl(this.mTransformOrigin) * getHeight());
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(viewLayer, ColorKt.m2682toArgb8_81llA(j2));
            ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(viewLayer, ColorKt.m2682toArgb8_81llA(j3));
        }
        if (Build.VERSION.SDK_INT >= 31) {
            ViewLayerVerificationHelper31.INSTANCE.setRenderEffect(this, renderEffect);
        }
        if (CompositingStrategy.m2709equalsimpl0(i, CompositingStrategy.Companion.m2715getOffscreenNrFUSI())) {
            setLayerType(2, null);
        } else if (CompositingStrategy.m2709equalsimpl0(i, CompositingStrategy.Companion.m2714getModulateAlphaNrFUSI())) {
            setLayerType(0, null);
            z2 = false;
        } else {
            setLayerType(0, null);
    ...
    public boolean mo4126isInLayerk4lQ0M(long j) {
        ...
        if (this.clipToBounds) {
            return 0.0f <= m2389getXimpl && m2389getXimpl < ((float) getWidth()) && 0.0f <= m2390getYimpl && m2390getYimpl < ((float) getHeight());
    ...
    public void mo4129resizeozmzZPI(long j) {
        ...
        if (m5032getWidthimpl == getWidth() && m5031getHeightimpl == getHeight()) {
            return;
        }
        float f = m5032getWidthimpl;
        setPivotX(TransformOrigin.m3007getPivotFractionXimpl(this.mTransformOrigin) * f);
        float f2 = m5031getHeightimpl;
        setPivotY(TransformOrigin.m3008getPivotFractionYimpl(this.mTransformOrigin) * f2);
        this.outlineResolver.m4220updateuvyYCjk(SizeKt.Size(f, f2));
        updateOutlineResolver();
        layout(getLeft(), getTop(), getLeft() + m5032getWidthimpl, getTop() + m5031getHeightimpl);
        resetClipBounds();
        this.matrixCache.invalidate();
    }
    ...
    public void mo4128movegyyYBs(long j) {
        ...
        if (m4990getXimpl != getLeft()) {
            offsetLeftAndRight(m4990getXimpl - getLeft());
            this.matrixCache.invalidate();
        }
        int m4991getYimpl = IntOffset.m4991getYimpl(j);
        if (m4991getYimpl != getTop()) {
            offsetTopAndBottom(m4991getYimpl - getTop());
            this.matrixCache.invalidate();
        }
    }
    ...
    public long mo4127mapOffset8S9VItk(long j, boolean z) {
        if (z) {
            float[] m4196calculateInverseMatrixbWbORWo = this.matrixCache.m4196calculateInverseMatrixbWbORWo(this);
        ...
        return androidx.compose.ui.graphics.Matrix.m2859mapMKHz9U(this.matrixCache.m4197calculateMatrixGrdbGEg(this), j);
    }
    ...
    public void mapBounds(MutableRect rect, boolean z) {
        ...
        androidx.compose.ui.graphics.Matrix.m2861mapimpl(this.matrixCache.m4197calculateMatrixGrdbGEg(this), rect);
    }
    ...
    public void mo4130transform58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        androidx.compose.ui.graphics.Matrix.m2870timesAssign58bKbWc(matrix, this.matrixCache.m4197calculateMatrixGrdbGEg(this));
    }
