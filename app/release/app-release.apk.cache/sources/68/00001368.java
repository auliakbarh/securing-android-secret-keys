...
public final class ColorKt {
            ...
            if (f2 <= colorSpace.getMaxValue(1) && minValue2 <= f2) {
                ...
                if (f3 <= colorSpace.getMaxValue(2) && minValue3 <= f3 && 0.0f <= f4 && f4 <= 1.0f) {
                    if (colorSpace.isSrgb()) {
                        return Color.m2624constructorimpl(ULong.m5333constructorimpl(ULong.m5333constructorimpl(ULong.m5333constructorimpl((((((int) ((f * 255.0f) + 0.5f)) << 16) | (((int) ((f4 * 255.0f) + 0.5f)) << 24)) | (((int) ((f2 * 255.0f) + 0.5f)) << 8)) | ((int) ((f3 * 255.0f) + 0.5f))) & 4294967295L) << 32));
                        ...
                        return Color.m2624constructorimpl(ULong.m5333constructorimpl(ULong.m5333constructorimpl(ULong.m5333constructorimpl(ULong.m5333constructorimpl(ULong.m5333constructorimpl(ULong.m5333constructorimpl(ULong.m5333constructorimpl(m2732constructorimpl2) & 65535) << 32) | ULong.m5333constructorimpl(ULong.m5333constructorimpl(ULong.m5333constructorimpl(m2732constructorimpl) & 65535) << 48)) | ULong.m5333constructorimpl(ULong.m5333constructorimpl(ULong.m5333constructorimpl(m2732constructorimpl3) & 65535) << 16)) | ULong.m5333constructorimpl(ULong.m5333constructorimpl(ULong.m5333constructorimpl((int) ((Math.max(0.0f, Math.min(f4, 1.0f)) * 1023.0f) + 0.5f)) & 1023) << 6)) | ULong.m5333constructorimpl(ULong.m5333constructorimpl(id$ui_graphics_release) & 63)));
                    }
                }
            }
        }
    ...
    public static final long Color(int i) {
        return Color.m2624constructorimpl(ULong.m5333constructorimpl(ULong.m5333constructorimpl(i) << 32));
    }

    public static final long Color(long j) {
        return Color.m2624constructorimpl(ULong.m5333constructorimpl(ULong.m5333constructorimpl(ULong.m5333constructorimpl(j) & 4294967295L) << 32));
    }
    ...
    public static final int m2682toArgb8_81llA(long j) {
        return (int) ULong.m5333constructorimpl(Color.m2625convertvNxB06k(j, ColorSpaces.INSTANCE.getSrgb()) >>> 32);
    }
