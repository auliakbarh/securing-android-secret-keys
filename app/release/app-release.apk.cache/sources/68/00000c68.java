...
public final class FilterChipDefaults {
    ...
    private static final float Height = FilterChipTokens.INSTANCE.m1916getContainerHeightD9Ej5fM();
    private static final float IconSize = FilterChipTokens.INSTANCE.m1932getIconSizeD9Ej5fM();
    ...
    public final float m1211getIconSizeD9Ej5fM() {
        return IconSize;
    }
    ...
    public final SelectableChipColors m1208filterChipColorsXqyqHi0(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, Composer composer, int i, int i2, int i3) {
        ...
        long m2663getTransparent0d7_KjU = (i3 & 1) != 0 ? Color.Companion.m2663getTransparent0d7_KjU() : j;
        ...
        long m2663getTransparent0d7_KjU2 = (i3 & 8) != 0 ? Color.Companion.m2663getTransparent0d7_KjU() : j4;
        long m2627copywmQWz5c$default = (i3 & 16) != 0 ? Color.m2627copywmQWz5c$default(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j5;
        long m2627copywmQWz5c$default2 = (i3 & 32) != 0 ? Color.m2627copywmQWz5c$default(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getDisabledLeadingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j6;
        long j13 = (i3 & 64) != 0 ? m2627copywmQWz5c$default2 : j7;
        long color3 = (i3 & 128) != 0 ? ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getFlatSelectedContainerColor(), composer, 6) : j8;
        long m2627copywmQWz5c$default3 = (i3 & 256) != 0 ? Color.m2627copywmQWz5c$default(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getFlatDisabledSelectedContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j9;
        ...
        SelectableChipColors selectableChipColors = new SelectableChipColors(m2663getTransparent0d7_KjU, color, color2, color2, m2663getTransparent0d7_KjU2, m2627copywmQWz5c$default, m2627copywmQWz5c$default2, j13, color3, m2627copywmQWz5c$default3, color4, color5, j14, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final SelectableChipElevation m1209filterChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float m1923getFlatContainerElevationD9Ej5fM = (i2 & 1) != 0 ? FilterChipTokens.INSTANCE.m1923getFlatContainerElevationD9Ej5fM() : f;
        float m1927getFlatSelectedPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? FilterChipTokens.INSTANCE.m1927getFlatSelectedPressedContainerElevationD9Ej5fM() : f2;
        float m1924getFlatSelectedFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? FilterChipTokens.INSTANCE.m1924getFlatSelectedFocusContainerElevationD9Ej5fM() : f3;
        float m1925getFlatSelectedHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? FilterChipTokens.INSTANCE.m1925getFlatSelectedHoverContainerElevationD9Ej5fM() : f4;
        float m1917getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? FilterChipTokens.INSTANCE.m1917getDraggedContainerElevationD9Ej5fM() : f5;
        float f7 = (i2 & 32) != 0 ? m1923getFlatContainerElevationD9Ej5fM : f6;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-757972185, i, -1, "androidx.compose.material3.FilterChipDefaults.filterChipElevation (Chip.kt:866)");
        }
        SelectableChipElevation selectableChipElevation = new SelectableChipElevation(m1923getFlatContainerElevationD9Ej5fM, m1927getFlatSelectedPressedContainerElevationD9Ej5fM, m1924getFlatSelectedFocusContainerElevationD9Ej5fM, m1925getFlatSelectedHoverContainerElevationD9Ej5fM, m1917getDraggedContainerElevationD9Ej5fM, f7, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final SelectableChipBorder m1207filterChipBordergHcDVlo(long j, long j2, long j3, long j4, float f, float f2, Composer composer, int i, int i2) {
        ...
        long m2663getTransparent0d7_KjU = (i2 & 2) != 0 ? Color.Companion.m2663getTransparent0d7_KjU() : j2;
        long m2627copywmQWz5c$default = (i2 & 4) != 0 ? Color.m2627copywmQWz5c$default(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getFlatDisabledUnselectedOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long m2663getTransparent0d7_KjU2 = (i2 & 8) != 0 ? Color.Companion.m2663getTransparent0d7_KjU() : j4;
        float m1930getFlatUnselectedOutlineWidthD9Ej5fM = (i2 & 16) != 0 ? FilterChipTokens.INSTANCE.m1930getFlatUnselectedOutlineWidthD9Ej5fM() : f;
        float m1926getFlatSelectedOutlineWidthD9Ej5fM = (i2 & 32) != 0 ? FilterChipTokens.INSTANCE.m1926getFlatSelectedOutlineWidthD9Ej5fM() : f2;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1884534961, i, -1, "androidx.compose.material3.FilterChipDefaults.filterChipBorder (Chip.kt:896)");
        }
        SelectableChipBorder selectableChipBorder = new SelectableChipBorder(color, m2663getTransparent0d7_KjU, m2627copywmQWz5c$default, m2663getTransparent0d7_KjU2, m1930getFlatUnselectedOutlineWidthD9Ej5fM, m1926getFlatSelectedOutlineWidthD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final SelectableChipColors m1205elevatedFilterChipColorsXqyqHi0(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, Composer composer, int i, int i2, int i3) {
        ...
        long m2627copywmQWz5c$default = (i3 & 8) != 0 ? Color.m2627copywmQWz5c$default(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getElevatedDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        long m2627copywmQWz5c$default2 = (i3 & 16) != 0 ? Color.m2627copywmQWz5c$default(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j5;
        long m2627copywmQWz5c$default3 = (i3 & 32) != 0 ? Color.m2627copywmQWz5c$default(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getDisabledLeadingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j6;
        long j13 = (i3 & 64) != 0 ? m2627copywmQWz5c$default3 : j7;
        long color4 = (i3 & 128) != 0 ? ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getElevatedSelectedContainerColor(), composer, 6) : j8;
        long j14 = (i3 & 256) != 0 ? m2627copywmQWz5c$default : j9;
        ...
        SelectableChipColors selectableChipColors = new SelectableChipColors(color, color2, color3, color3, m2627copywmQWz5c$default, m2627copywmQWz5c$default2, m2627copywmQWz5c$default3, j13, color4, j14, color5, color6, j15, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final SelectableChipElevation m1206elevatedFilterChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float m1918getElevatedContainerElevationD9Ej5fM = (i2 & 1) != 0 ? FilterChipTokens.INSTANCE.m1918getElevatedContainerElevationD9Ej5fM() : f;
        float m1922getElevatedPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? FilterChipTokens.INSTANCE.m1922getElevatedPressedContainerElevationD9Ej5fM() : f2;
        float m1920getElevatedFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? FilterChipTokens.INSTANCE.m1920getElevatedFocusContainerElevationD9Ej5fM() : f3;
        float m1921getElevatedHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? FilterChipTokens.INSTANCE.m1921getElevatedHoverContainerElevationD9Ej5fM() : f4;
        float m1917getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? FilterChipTokens.INSTANCE.m1917getDraggedContainerElevationD9Ej5fM() : f5;
        float m1919getElevatedDisabledContainerElevationD9Ej5fM = (i2 & 32) != 0 ? FilterChipTokens.INSTANCE.m1919getElevatedDisabledContainerElevationD9Ej5fM() : f6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        SelectableChipElevation selectableChipElevation = new SelectableChipElevation(m1918getElevatedContainerElevationD9Ej5fM, m1922getElevatedPressedContainerElevationD9Ej5fM, m1920getElevatedFocusContainerElevationD9Ej5fM, m1921getElevatedHoverContainerElevationD9Ej5fM, m1917getDraggedContainerElevationD9Ej5fM, m1919getElevatedDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
