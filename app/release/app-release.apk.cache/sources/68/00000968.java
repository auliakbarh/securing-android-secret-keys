...
public final class TextSelectionColorsKt {
    ...
    private static final ProvidableCompositionLocal<TextSelectionColors> LocalTextSelectionColors = CompositionLocalKt.compositionLocalOf$default(null, new Function0<TextSelectionColors>() { // from class: androidx.compose.foundation.text.selection.TextSelectionColorsKt$LocalTextSelectionColors$1
        ...
        public final TextSelectionColors invoke() {
            return TextSelectionColorsKt.access$getDefaultTextSelectionColors$p();
        }
    }, 1, null);

    public static final /* synthetic */ TextSelectionColors access$getDefaultTextSelectionColors$p() {
    ...
    static {
        ...
        DefaultTextSelectionColors = new TextSelectionColors(Color, Color.m2627copywmQWz5c$default(Color, 0.4f, 0.0f, 0.0f, 0.0f, 14, null), null);
    }
}