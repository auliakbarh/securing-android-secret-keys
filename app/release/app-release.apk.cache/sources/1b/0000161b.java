...
public final class LayoutNodeDrawScope implements DrawScope, ContentDrawScope {
    ...
    public void mo3072drawArcillE91I(Brush brush, float f, float f2, boolean z, long j, long j2, float f3, DrawStyle style, ColorFilter colorFilter, int i) {
        ...
        this.canvasDrawScope.mo3072drawArcillE91I(brush, f, f2, z, j, j2, f3, style, colorFilter, i);
    }
    ...
    public void mo3073drawArcyD3GUKo(long j, float f, float f2, boolean z, long j2, long j3, float f3, DrawStyle style, ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(style, "style");
        this.canvasDrawScope.mo3073drawArcyD3GUKo(j, f, f2, z, j2, j3, f3, style, colorFilter, i);
    }
    ...
    public void mo3074drawCircleV9BoPsw(Brush brush, float f, long j, float f2, DrawStyle style, ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(brush, "brush");
        Intrinsics.checkNotNullParameter(style, "style");
        this.canvasDrawScope.mo3074drawCircleV9BoPsw(brush, f, j, f2, style, colorFilter, i);
    }
    ...
    public void mo3075drawCircleVaOC9Bg(long j, float f, long j2, float f2, DrawStyle style, ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(style, "style");
        this.canvasDrawScope.mo3075drawCircleVaOC9Bg(j, f, j2, f2, style, colorFilter, i);
    }
    ...
    public /* synthetic */ void mo3076drawImage9jGpkUE(ImageBitmap image, long j, long j2, long j3, long j4, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        ...
        Intrinsics.checkNotNullParameter(style, "style");
        this.canvasDrawScope.mo3076drawImage9jGpkUE(image, j, j2, j3, j4, f, style, colorFilter, i);
    }
    ...
    public void mo3077drawImageAZ2fEMs(ImageBitmap image, long j, long j2, long j3, long j4, float f, DrawStyle style, ColorFilter colorFilter, int i, int i2) {
        Intrinsics.checkNotNullParameter(image, "image");
        Intrinsics.checkNotNullParameter(style, "style");
        this.canvasDrawScope.mo3077drawImageAZ2fEMs(image, j, j2, j3, j4, f, style, colorFilter, i, i2);
    }
    ...
    public void mo3078drawImagegbVJVH8(ImageBitmap image, long j, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(image, "image");
        Intrinsics.checkNotNullParameter(style, "style");
        this.canvasDrawScope.mo3078drawImagegbVJVH8(image, j, f, style, colorFilter, i);
    }
    ...
    public void mo3079drawLine1RTmtNc(Brush brush, long j, long j2, float f, int i, PathEffect pathEffect, float f2, ColorFilter colorFilter, int i2) {
        Intrinsics.checkNotNullParameter(brush, "brush");
        this.canvasDrawScope.mo3079drawLine1RTmtNc(brush, j, j2, f, i, pathEffect, f2, colorFilter, i2);
    }
    ...
    public void mo3080drawLineNGM6Ib0(long j, long j2, long j3, float f, int i, PathEffect pathEffect, float f2, ColorFilter colorFilter, int i2) {
        this.canvasDrawScope.mo3080drawLineNGM6Ib0(j, j2, j3, f, i, pathEffect, f2, colorFilter, i2);
    }
    ...
    public void mo3081drawOvalAsUm42w(Brush brush, long j, long j2, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(brush, "brush");
        Intrinsics.checkNotNullParameter(style, "style");
        this.canvasDrawScope.mo3081drawOvalAsUm42w(brush, j, j2, f, style, colorFilter, i);
    }
    ...
    public void mo3082drawOvalnJ9OG0(long j, long j2, long j3, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(style, "style");
        this.canvasDrawScope.mo3082drawOvalnJ9OG0(j, j2, j3, f, style, colorFilter, i);
    }
    ...
    public void mo3083drawPathGBMwjPU(Path path, Brush brush, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        ...
        Intrinsics.checkNotNullParameter(brush, "brush");
        Intrinsics.checkNotNullParameter(style, "style");
        this.canvasDrawScope.mo3083drawPathGBMwjPU(path, brush, f, style, colorFilter, i);
    }
    ...
    public void mo3084drawPathLG529CI(Path path, long j, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(path, "path");
        Intrinsics.checkNotNullParameter(style, "style");
        this.canvasDrawScope.mo3084drawPathLG529CI(path, j, f, style, colorFilter, i);
    }
    ...
    public void mo3085drawPointsF8ZwMP8(List<Offset> points, int i, long j, float f, int i2, PathEffect pathEffect, float f2, ColorFilter colorFilter, int i3) {
        ...
        this.canvasDrawScope.mo3085drawPointsF8ZwMP8(points, i, j, f, i2, pathEffect, f2, colorFilter, i3);
    }
    ...
    public void mo3086drawPointsGsft0Ws(List<Offset> points, int i, Brush brush, float f, int i2, PathEffect pathEffect, float f2, ColorFilter colorFilter, int i3) {
        Intrinsics.checkNotNullParameter(points, "points");
        Intrinsics.checkNotNullParameter(brush, "brush");
        this.canvasDrawScope.mo3086drawPointsGsft0Ws(points, i, brush, f, i2, pathEffect, f2, colorFilter, i3);
    }
    ...
    public void mo3087drawRectAsUm42w(Brush brush, long j, long j2, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(brush, "brush");
        Intrinsics.checkNotNullParameter(style, "style");
        this.canvasDrawScope.mo3087drawRectAsUm42w(brush, j, j2, f, style, colorFilter, i);
    }
    ...
    public void mo3088drawRectnJ9OG0(long j, long j2, long j3, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(style, "style");
        this.canvasDrawScope.mo3088drawRectnJ9OG0(j, j2, j3, f, style, colorFilter, i);
    }
    ...
    public void mo3089drawRoundRectZuiqVtQ(Brush brush, long j, long j2, long j3, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(brush, "brush");
        Intrinsics.checkNotNullParameter(style, "style");
        this.canvasDrawScope.mo3089drawRoundRectZuiqVtQ(brush, j, j2, j3, f, style, colorFilter, i);
    }
    ...
    public void mo3090drawRoundRectuAw5IA(long j, long j2, long j3, long j4, DrawStyle style, float f, ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(style, "style");
        this.canvasDrawScope.mo3090drawRoundRectuAw5IA(j, j2, j3, j4, style, f, colorFilter, i);
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: getCenter-F1C5BW0 */
    public long mo3170getCenterF1C5BW0() {
        return this.canvasDrawScope.mo3170getCenterF1C5BW0();
    }
    ...
    public long mo3171getSizeNHjbRc() {
        return this.canvasDrawScope.mo3171getSizeNHjbRc();
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx--R2X_6o */
    public int mo317roundToPxR2X_6o(long j) {
        return this.canvasDrawScope.mo317roundToPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx-0680j_4 */
    public int mo318roundToPx0680j_4(float f) {
        return this.canvasDrawScope.mo318roundToPx0680j_4(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-GaN1DYA */
    public float mo319toDpGaN1DYA(long j) {
        return this.canvasDrawScope.mo319toDpGaN1DYA(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo320toDpu2uoSUM(float f) {
        return this.canvasDrawScope.mo320toDpu2uoSUM(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo321toDpu2uoSUM(int i) {
        return this.canvasDrawScope.mo321toDpu2uoSUM(i);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDpSize-k-rfVVM */
    public long mo322toDpSizekrfVVM(long j) {
        return this.canvasDrawScope.mo322toDpSizekrfVVM(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx--R2X_6o */
    public float mo323toPxR2X_6o(long j) {
        return this.canvasDrawScope.mo323toPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx-0680j_4 */
    public float mo324toPx0680j_4(float f) {
        return this.canvasDrawScope.mo324toPx0680j_4(f);
    }
    ...
    public long mo325toSizeXkaWNTQ(long j) {
        return this.canvasDrawScope.mo325toSizeXkaWNTQ(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-0xMU5do */
    public long mo326toSp0xMU5do(float f) {
        return this.canvasDrawScope.mo326toSp0xMU5do(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo327toSpkPz2Gy4(float f) {
        return this.canvasDrawScope.mo327toSpkPz2Gy4(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo328toSpkPz2Gy4(int i) {
        return this.canvasDrawScope.mo328toSpkPz2Gy4(i);
    }
    ...
    public void drawContent() {
        ...
        Modifier.Node access$nextDrawNode = LayoutNodeDrawScopeKt.access$nextDrawNode(drawModifierNode2);
        if (access$nextDrawNode == null) {
            NodeCoordinator m3978requireCoordinator64DMado = DelegatableNodeKt.m3978requireCoordinator64DMado(drawModifierNode2, NodeKind.m4080constructorimpl(4));
            if (m3978requireCoordinator64DMado.getTail() == drawModifierNode.getNode()) {
                m3978requireCoordinator64DMado = m3978requireCoordinator64DMado.getWrapped$ui_release();
                Intrinsics.checkNotNull(m3978requireCoordinator64DMado);
            }
            m3978requireCoordinator64DMado.performDraw(canvas);
            return;
        }
        ...
        while (access$nextDrawNode != null) {
            ...
            } else if ((access$nextDrawNode.getKindSet$ui_release() & m4080constructorimpl) != 0 && (access$nextDrawNode instanceof DelegatingNode)) {
                int i = 0;
    ...
    public final void performDraw(DrawModifierNode drawModifierNode, Canvas canvas) {
        ...
        NodeCoordinator m3978requireCoordinator64DMado = DelegatableNodeKt.m3978requireCoordinator64DMado(drawModifierNode, NodeKind.m4080constructorimpl(4));
        m3978requireCoordinator64DMado.getLayoutNode().getMDrawScope$ui_release().m4016drawDirectx_KDEd0$ui_release(canvas, IntSizeKt.m5042toSizeozmzZPI(m3978requireCoordinator64DMado.mo3872getSizeYbymL2g()), m3978requireCoordinator64DMado, drawModifierNode);
    }

    /* renamed from: drawDirect-x_KDEd0$ui_release  reason: not valid java name */
    public final void m4016drawDirectx_KDEd0$ui_release(Canvas canvas, long j, NodeCoordinator coordinator, DrawModifierNode drawNode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
    ...
    public final void m4015drawx_KDEd0$ui_release(Canvas canvas, long j, NodeCoordinator coordinator, Modifier.Node drawNode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        Intrinsics.checkNotNullParameter(coordinator, "coordinator");
        Intrinsics.checkNotNullParameter(drawNode, "drawNode");
        int m4080constructorimpl = NodeKind.m4080constructorimpl(4);
        ...
        while (drawNode != null) {
            if (drawNode instanceof DrawModifierNode) {
                m4016drawDirectx_KDEd0$ui_release(canvas, j, coordinator, (DrawModifierNode) drawNode);
            } else if ((drawNode.getKindSet$ui_release() & m4080constructorimpl) != 0 && (drawNode instanceof DelegatingNode)) {
                int i = 0;
