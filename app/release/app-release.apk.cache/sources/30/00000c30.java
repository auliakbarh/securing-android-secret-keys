...
public final class DisplayMode {
    ...
    private static final int Picker = m1166constructorimpl(0);
    private static final int Input = m1166constructorimpl(1);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ DisplayMode m1165boximpl(int i) {
        return new DisplayMode(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m1166constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1167equalsimpl(int i, Object obj) {
        return (obj instanceof DisplayMode) && i == ((DisplayMode) obj).m1171unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m1168equalsimpl0(int i, int i2) {
        return i == i2;
    }
    ...
    public boolean equals(Object obj) {
        return m1167equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m1169hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m1173getPickerjFl4v0() {
            return DisplayMode.Picker;
        }

        /* renamed from: getInput-jFl-4v0  reason: not valid java name */
        public final int m1172getInputjFl4v0() {
            return DisplayMode.Input;
        }
    }

    public String toString() {
        return m1170toStringimpl(this.value);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1170toStringimpl(int i) {
        return m1168equalsimpl0(i, Picker) ? "Picker" : m1168equalsimpl0(i, Input) ? "Input" : "Unknown";
    }
}