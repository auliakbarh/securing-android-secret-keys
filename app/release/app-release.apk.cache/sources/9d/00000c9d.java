...
public final class InputIdentifier {
    ...
    private static final int SingleDateInput = m1244constructorimpl(0);
    private static final int StartDateInput = m1244constructorimpl(1);
    private static final int EndDateInput = m1244constructorimpl(2);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ InputIdentifier m1243boximpl(int i) {
        return new InputIdentifier(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m1244constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1245equalsimpl(int i, Object obj) {
        return (obj instanceof InputIdentifier) && i == ((InputIdentifier) obj).m1249unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m1245equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m1247hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m1251getSingleDateInputJ2x2o4M() {
            return InputIdentifier.SingleDateInput;
        }

        /* renamed from: getStartDateInput-J2x2o4M  reason: not valid java name */
        public final int m1252getStartDateInputJ2x2o4M() {
            return InputIdentifier.StartDateInput;
        }

        /* renamed from: getEndDateInput-J2x2o4M  reason: not valid java name */
        public final int m1250getEndDateInputJ2x2o4M() {
            return InputIdentifier.EndDateInput;
        }
    }

    public String toString() {
        return m1248toStringimpl(this.value);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1248toStringimpl(int i) {
        return m1246equalsimpl0(i, SingleDateInput) ? "SingleDateInput" : m1246equalsimpl0(i, StartDateInput) ? "StartDateInput" : m1246equalsimpl0(i, EndDateInput) ? "EndDateInput" : "Unknown";
    }
}