...
public final class TextDrawStyleKt {
    public static final TextForegroundStyle lerp(TextForegroundStyle start, TextForegroundStyle stop, float f) {
        ...
        if (!z && !(stop instanceof BrushStyle)) {
            return TextForegroundStyle.Companion.m4785from8_81llA(ColorKt.m2679lerpjxsXWHM(start.mo4673getColor0d7_KjU(), stop.mo4673getColor0d7_KjU(), f));
        }
        if (z && (stop instanceof BrushStyle)) {
    ...
    public static final long m4784modulateDxMtmZc(long j, float f) {
        return (Float.isNaN(f) || f >= 1.0f) ? j : Color.m2627copywmQWz5c$default(j, Color.m2630getAlphaimpl(j) * f, 0.0f, 0.0f, 0.0f, 14, null);
    }
