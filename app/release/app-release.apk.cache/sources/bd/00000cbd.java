...
public final class ListItemType implements Comparable<ListItemType> {
    ...
    private static final int OneLine = m1266constructorimpl(1);
    private static final int TwoLine = m1266constructorimpl(2);
    private static final int ThreeLine = m1266constructorimpl(3);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ ListItemType m1264boximpl(int i) {
        return new ListItemType(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m1266constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1267equalsimpl(int i, Object obj) {
        return (obj instanceof ListItemType) && i == ((ListItemType) obj).m1272unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m1267equalsimpl(this.lines, obj);
    }

    public int hashCode() {
        return m1269hashCodeimpl(this.lines);
    }

    public String toString() {
        return m1270toStringimpl(this.lines);
    }
    ...
    public /* bridge */ /* synthetic */ int compareTo(ListItemType listItemType) {
        return m1271compareToyh95HIg(listItemType.m1272unboximpl());
    }
    ...
    public static int m1265compareToyh95HIg(int i, int i2) {
        return Intrinsics.compare(i, i2);
    }

    /* renamed from: compareTo-yh95HIg  reason: not valid java name */
    public int m1271compareToyh95HIg(int i) {
        return m1265compareToyh95HIg(this.lines, i);
    }
    ...
    public static final class Companion {
        ...
        public final int m1274getOneLineAlXitO8() {
            return ListItemType.OneLine;
        }

        /* renamed from: getTwoLine-AlXitO8  reason: not valid java name */
        public final int m1276getTwoLineAlXitO8() {
            return ListItemType.TwoLine;
        }

        /* renamed from: getThreeLine-AlXitO8  reason: not valid java name */
        public final int m1275getThreeLineAlXitO8() {
            return ListItemType.ThreeLine;
        }

        /* renamed from: getListItemType-7AlIA9s$material3_release  reason: not valid java name */
        public final int m1273getListItemType7AlIA9s$material3_release(boolean z, boolean z2) {
            if (z && z2) {
                return m1275getThreeLineAlXitO8();
            }
            if (z || z2) {
                return m1276getTwoLineAlXitO8();
            }
            return m1274getOneLineAlXitO8();
        }
    }
}