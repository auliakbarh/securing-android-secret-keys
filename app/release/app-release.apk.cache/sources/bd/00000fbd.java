...
public final class ExposedDropdownMenuPopupKt {
    ...
    public static final void ExposedDropdownMenuPopup(Function0<Unit> function0, final PopupPositionProvider popupPositionProvider, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i, final int i2) {
        ...
        if ((i6 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            UUID popupId = (UUID) RememberSaveableKt.m2275rememberSaveable(new Object[0], (Saver<Object, ? extends Object>) null, (String) null, (Function0<? extends Object>) new Function0<UUID>() { // from class: androidx.compose.material3.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupId$1
                @Override // kotlin.jvm.functions.Function0
                        ...
                        if ((i7 & 11) != 2 || !composer3.getSkipping()) {
                            ...
                            Modifier alpha = AlphaKt.alpha(OnRemeasuredModifierKt.onSizeChanged(semantics$default, new Function1<IntSize, Unit>() { // from class: androidx.compose.material3.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupLayout$1$1$1.2
                                ...
                                public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
                                    m1677invokeozmzZPI(intSize.m5036unboximpl());
                                    return Unit.INSTANCE;
                                }

                                /* renamed from: invoke-ozmzZPI  reason: not valid java name */
                                public final void m1677invokeozmzZPI(long j) {
                                    PopupLayout.this.m1679setPopupContentSizefhxjrPA(IntSize.m5024boximpl(j));
                            ...
                            Updater.m2269setimpl(m2262constructorimpl, exposedDropdownMenuPopupKt$SimpleStack$1, ComposeUiNode.Companion.getSetMeasurePolicy());
                            Updater.m2269setimpl(m2262constructorimpl, density2, ComposeUiNode.Companion.getSetDensity());
                            Updater.m2269setimpl(m2262constructorimpl, layoutDirection3, ComposeUiNode.Companion.getSetLayoutDirection());
            ...
            Modifier onGloballyPositioned = OnGloballyPositionedModifierKt.onGloballyPositioned(Modifier.Companion, new Function1<LayoutCoordinates, Unit>() { // from class: androidx.compose.material3.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$5
                ...
                public final void invoke2(LayoutCoordinates childCoordinates) {
                    ...
                    PopupLayout.this.setParentBounds(IntRectKt.m5022IntRectVbeCjmY(IntOffsetKt.IntOffset(MathKt.roundToInt(Offset.m2389getXimpl(positionInWindow)), MathKt.roundToInt(Offset.m2390getYimpl(positionInWindow))), mo3872getSizeYbymL2g));
                    PopupLayout.this.updatePosition();
                }
            });
    ...
    private static final void SimpleStack(Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i) {
        ...
        Updater.m2269setimpl(m2262constructorimpl, viewConfiguration, ComposeUiNode.Companion.getSetViewConfiguration());
        materializerOf.invoke(SkippableUpdater.m2253boximpl(SkippableUpdater.m2254constructorimpl(composer)), composer, Integer.valueOf((i2 >> 3) & 112));
