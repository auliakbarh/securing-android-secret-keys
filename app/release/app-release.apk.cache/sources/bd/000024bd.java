...
public final class HandlerDispatcherKt {
    ...
    public static /* synthetic */ void $r8$lambda$Z1vOW_gMqzuAA1kBf19jmX0gPxw(CancellableContinuation cancellableContinuation, long j) {
        m6658postFrameCallback$lambda6(cancellableContinuation, j);
    }
    ...
    static {
        ...
        try {
            ...
            m5154constructorimpl = Result.m5154constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m5154constructorimpl = Result.m5154constructorimpl(ResultKt.createFailure(th));
        }
        Main = Result.m5160isFailureimpl(m5154constructorimpl) ? null : m5154constructorimpl;
    }
    ...
    public static final void m6658postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j) {
    ...
    public static final Object awaitFrame(Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo6708dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrame$lambda-3$$inlined$Runnable$1
