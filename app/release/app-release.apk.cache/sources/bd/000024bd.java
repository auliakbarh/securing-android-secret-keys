...
public final class HandlerDispatcherKt {
    ...
    public static /* synthetic */ void $r8$lambda$Z1vOW_gMqzuAA1kBf19jmX0gPxw(CancellableContinuation cancellableContinuation, long j) {
        m6662postFrameCallback$lambda6(cancellableContinuation, j);
    }
    ...
    static {
        ...
        try {
            ...
            m5158constructorimpl = Result.m5158constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m5158constructorimpl = Result.m5158constructorimpl(ResultKt.createFailure(th));
        }
        Main = Result.m5164isFailureimpl(m5158constructorimpl) ? null : m5158constructorimpl;
    }
    ...
    public static final void m6662postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j) {
    ...
    public static final Object awaitFrame(Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo6712dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrame$lambda-3$$inlined$Runnable$1
