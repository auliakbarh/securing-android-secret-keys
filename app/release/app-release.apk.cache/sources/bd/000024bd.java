...
public final class HandlerDispatcherKt {
    ...
    public static /* synthetic */ void $r8$lambda$Z1vOW_gMqzuAA1kBf19jmX0gPxw(CancellableContinuation cancellableContinuation, long j) {
        m6659postFrameCallback$lambda6(cancellableContinuation, j);
    }
    ...
    static {
        ...
        try {
            ...
            m5155constructorimpl = Result.m5155constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m5155constructorimpl = Result.m5155constructorimpl(ResultKt.createFailure(th));
        }
        Main = Result.m5161isFailureimpl(m5155constructorimpl) ? null : m5155constructorimpl;
    }
    ...
    public static final void m6659postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j) {
    ...
    public static final Object awaitFrame(Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo6709dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrame$lambda-3$$inlined$Runnable$1
