...
final class BoxWithConstraintsScopeImpl implements BoxWithConstraintsScope, BoxScope {
    ...
    public static /* synthetic */ BoxWithConstraintsScopeImpl m422copy0kLqBqw$default(BoxWithConstraintsScopeImpl boxWithConstraintsScopeImpl, Density density, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return boxWithConstraintsScopeImpl.m424copy0kLqBqw(density, j);
    }
    ...
    public final long m423component2msEJaDk() {
        return this.constraints;
    }

    /* renamed from: copy-0kLqBqw  reason: not valid java name */
    public final BoxWithConstraintsScopeImpl m424copy0kLqBqw(Density density, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BoxWithConstraintsScopeImpl) {
            ...
            return Intrinsics.areEqual(this.density, boxWithConstraintsScopeImpl.density) && Constraints.m4821equalsimpl0(this.constraints, boxWithConstraintsScopeImpl.constraints);
        }
        return false;
    }
    ...
    public long mo417getConstraintsmsEJaDk() {
        return this.constraints;
    }

    public int hashCode() {
        return (this.density.hashCode() * 31) + Constraints.m4831hashCodeimpl(this.constraints);
    }
    ...
    public String toString() {
        return "BoxWithConstraintsScopeImpl(density=" + this.density + ", constraints=" + ((Object) Constraints.m4833toStringimpl(this.constraints)) + ')';
    }
    ...
    public float mo421getMinWidthD9Ej5fM() {
        return this.density.mo321toDpu2uoSUM(Constraints.m4830getMinWidthimpl(mo417getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMaxWidth-D9Ej5fM */
    public float mo419getMaxWidthD9Ej5fM() {
        return Constraints.m4824getHasBoundedWidthimpl(mo417getConstraintsmsEJaDk()) ? this.density.mo321toDpu2uoSUM(Constraints.m4828getMaxWidthimpl(mo417getConstraintsmsEJaDk())) : Dp.Companion.m4891getInfinityD9Ej5fM();
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMinHeight-D9Ej5fM */
    public float mo420getMinHeightD9Ej5fM() {
        return this.density.mo321toDpu2uoSUM(Constraints.m4829getMinHeightimpl(mo417getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMaxHeight-D9Ej5fM */
    public float mo418getMaxHeightD9Ej5fM() {
        return Constraints.m4823getHasBoundedHeightimpl(mo417getConstraintsmsEJaDk()) ? this.density.mo321toDpu2uoSUM(Constraints.m4827getMaxHeightimpl(mo417getConstraintsmsEJaDk())) : Dp.Companion.m4891getInfinityD9Ej5fM();
    }
}