...
final class DerivedWidthModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    public MeasureResult mo36measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        final Placeable mo3865measureBRTryo0 = measurable.mo3865measureBRTryo0(Constraints.m4819copyZbe2FdA$default(j, intValue, intValue, 0, 0, 12, null));
        return MeasureScope.layout$default(measure, intValue, mo3865measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.DerivedWidthModifier$measure$2
