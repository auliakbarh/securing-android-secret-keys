...
public final class SizeKt {
    ...
    public static final Modifier m531width3ABfNKs(Modifier width, final float f) {
        ...
        return width.then(new SizeElement(f, 0.0f, f, 0.0f, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$width-3ABfNKs$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.setValue(Dp.m4870boximpl(f));
            }
        } : InspectableValueKt.getNoInspectorInfo(), 10, null));
    }

    /* renamed from: height-3ABfNKs */
    public static final Modifier m512height3ABfNKs(Modifier height, final float f) {
    ...
    public static final Modifier m527size6HolHcs(Modifier size, long j) {
        Intrinsics.checkNotNullParameter(size, "$this$size");
        return m528sizeVpY3zN4(size, DpSize.m4970getWidthD9Ej5fM(j), DpSize.m4968getHeightD9Ej5fM(j));
    }

    /* renamed from: widthIn-VpY3zN4$default */
    public static /* synthetic */ Modifier m533widthInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m532widthInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: widthIn-VpY3zN4 */
    public static final Modifier m532widthInVpY3zN4(Modifier widthIn, final float f, final float f2) {
        ...
        return widthIn.then(new SizeElement(f, 0.0f, f2, 0.0f, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$widthIn-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("min", Dp.m4870boximpl(f));
                inspectorInfo.getProperties().set("max", Dp.m4870boximpl(f2));
            }
        } : InspectableValueKt.getNoInspectorInfo(), 10, null));
    }

    /* renamed from: heightIn-VpY3zN4$default */
    public static /* synthetic */ Modifier m514heightInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.Companion.m4892getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m513heightInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: heightIn-VpY3zN4 */
    public static final Modifier m513heightInVpY3zN4(Modifier heightIn, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m530sizeInqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.Companion.m4892getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        if ((i & 4) != 0) {
            f3 = Dp.Companion.m4892getUnspecifiedD9Ej5fM();
        }
        if ((i & 8) != 0) {
            f4 = Dp.Companion.m4892getUnspecifiedD9Ej5fM();
        }
        return m529sizeInqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* renamed from: sizeIn-qDBjuR0 */
    public static final Modifier m529sizeInqDBjuR0(Modifier sizeIn, final float f, final float f2, final float f3, final float f4) {
        ...
        return sizeIn.then(new SizeElement(f, f2, f3, f4, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$sizeIn-qDBjuR0$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("minWidth", Dp.m4870boximpl(f));
                inspectorInfo.getProperties().set("minHeight", Dp.m4870boximpl(f2));
                inspectorInfo.getProperties().set("maxWidth", Dp.m4870boximpl(f3));
                inspectorInfo.getProperties().set("maxHeight", Dp.m4870boximpl(f4));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }

    /* renamed from: requiredWidth-3ABfNKs */
    public static final Modifier m523requiredWidth3ABfNKs(Modifier requiredWidth, final float f) {
    ...
    public static final Modifier m515requiredHeight3ABfNKs(Modifier requiredHeight, final float f) {
    ...
    public static final Modifier m519requiredSize6HolHcs(Modifier requiredSize, long j) {
        Intrinsics.checkNotNullParameter(requiredSize, "$this$requiredSize");
        return m520requiredSizeVpY3zN4(requiredSize, DpSize.m4970getWidthD9Ej5fM(j), DpSize.m4968getHeightD9Ej5fM(j));
    }

    /* renamed from: requiredWidthIn-VpY3zN4$default */
    public static /* synthetic */ Modifier m525requiredWidthInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.Companion.m4892getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m524requiredWidthInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: requiredWidthIn-VpY3zN4 */
    public static final Modifier m524requiredWidthInVpY3zN4(Modifier requiredWidthIn, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m517requiredHeightInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.Companion.m4892getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m516requiredHeightInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: requiredHeightIn-VpY3zN4 */
    public static final Modifier m516requiredHeightInVpY3zN4(Modifier requiredHeightIn, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m522requiredSizeInqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.Companion.m4892getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m521requiredSizeInqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* renamed from: requiredSizeIn-qDBjuR0 */
    public static final Modifier m521requiredSizeInqDBjuR0(Modifier requiredSizeIn, final float f, final float f2, final float f3, final float f4) {
    ...
    public static final Modifier wrapContentWidth(Modifier modifier, Alignment.Horizontal align, boolean z) {
        ...
        if (!Intrinsics.areEqual(align, Alignment.Companion.getCenterHorizontally()) || z) {
            width = (!Intrinsics.areEqual(align, Alignment.Companion.getStart()) || z) ? WrapContentElement.Companion.width(align, z) : WrapContentWidthStart;
        } else {
    ...
    public static final Modifier wrapContentHeight(Modifier modifier, Alignment.Vertical align, boolean z) {
        ...
        if (!Intrinsics.areEqual(align, Alignment.Companion.getCenterVertically()) || z) {
            height = (!Intrinsics.areEqual(align, Alignment.Companion.getTop()) || z) ? WrapContentElement.Companion.height(align, z) : WrapContentHeightTop;
        } else {
    ...
    public static final Modifier wrapContentSize(Modifier modifier, Alignment align, boolean z) {
        ...
        if (!Intrinsics.areEqual(align, Alignment.Companion.getCenter()) || z) {
            size = (!Intrinsics.areEqual(align, Alignment.Companion.getTopStart()) || z) ? WrapContentElement.Companion.size(align, z) : WrapContentSizeTopStart;
        } else {
    ...
    public static /* synthetic */ Modifier m511defaultMinSizeVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.Companion.m4892getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m510defaultMinSizeVpY3zN4(modifier, f, f2);
    }

    /* renamed from: defaultMinSize-VpY3zN4 */
    public static final Modifier m510defaultMinSizeVpY3zN4(Modifier defaultMinSize, float f, float f2) {
        Intrinsics.checkNotNullParameter(defaultMinSize, "$this$defaultMinSize");
        return defaultMinSize.then(new UnspecifiedConstraintsElement(f, f2, null));
    }

    /* renamed from: size-3ABfNKs */
    public static final Modifier m526size3ABfNKs(Modifier size, final float f) {
        Intrinsics.checkNotNullParameter(size, "$this$size");
    ...
    public static final Modifier m528sizeVpY3zN4(Modifier size, final float f, final float f2) {
        Intrinsics.checkNotNullParameter(size, "$this$size");
        return size.then(new SizeElement(f, f2, f, f2, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$size-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                Intrinsics.checkNotNullParameter(inspectorInfo, "$this$null");
                inspectorInfo.setName("size");
                inspectorInfo.getProperties().set("width", Dp.m4870boximpl(f));
                inspectorInfo.getProperties().set("height", Dp.m4870boximpl(f2));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }

    /* renamed from: requiredSize-3ABfNKs */
    public static final Modifier m518requiredSize3ABfNKs(Modifier requiredSize, final float f) {
        Intrinsics.checkNotNullParameter(requiredSize, "$this$requiredSize");
    ...
    public static final Modifier m520requiredSizeVpY3zN4(Modifier requiredSize, final float f, final float f2) {
        Intrinsics.checkNotNullParameter(requiredSize, "$this$requiredSize");
