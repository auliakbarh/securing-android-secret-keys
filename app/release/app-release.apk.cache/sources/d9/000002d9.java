...
public final class ClickableSemanticsNode extends Modifier.Node implements SemanticsModifierNode {
    ...
    /* renamed from: update-UMe6uN4 */
    public final void m203updateUMe6uN4(boolean z, String str, Role role, Function0<Unit> onClick, String str2, Function0<Unit> function0) {
    ...
    public static final /* synthetic */ Function0 access$getOnClick$p(ClickableSemanticsNode clickableSemanticsNode) {
        return clickableSemanticsNode.onClick;
    }

    public static final /* synthetic */ Function0 access$getOnLongClick$p(ClickableSemanticsNode clickableSemanticsNode) {
        return clickableSemanticsNode.onLongClick;
    }
    ...
    public void applySemantics(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        ...
        if (role != null) {
            ...
            SemanticsPropertiesKt.m4259setRolekuIjeqM(semanticsPropertyReceiver, role.m4244unboximpl());
        }
        SemanticsPropertiesKt.onClick(semanticsPropertyReceiver, this.onClickLabel, new Function0<Boolean>() { // from class: androidx.compose.foundation.ClickableSemanticsNode$applySemantics$1
            ...
            public final Boolean invoke() {
                ClickableSemanticsNode.access$getOnClick$p(ClickableSemanticsNode.this).invoke();
                return true;
            }
        });
        if (this.onLongClick != null) {
            SemanticsPropertiesKt.onLongClick(semanticsPropertyReceiver, this.onLongClickLabel, new Function0<Boolean>() { // from class: androidx.compose.foundation.ClickableSemanticsNode$applySemantics$2
                ...
                @Override // kotlin.jvm.functions.Function0
                public final Boolean invoke() {
                    Function0 access$getOnLongClick$p = ClickableSemanticsNode.access$getOnLongClick$p(ClickableSemanticsNode.this);
