...
public final class BottomAppBarDefaults {
    ...
    private static final float ContainerElevation = BottomAppBarTokens.INSTANCE.m1693getContainerElevationD9Ej5fM();
    ...
    static {
        ...
        ContentPadding = PaddingKt.m476PaddingValuesa9UjIt4$default(f, bottomAppBarVerticalPadding, f2, 0.0f, 8, null);
    }
    ...
    public final WindowInsets getWindowInsets(Composer composer, int i) {
        ...
        WindowInsets m552onlybOOhFvg = WindowInsetsKt.m552onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.Companion, composer, 8), WindowInsetsSides.m563plusgK_yJZ4(WindowInsetsSides.Companion.m573getHorizontalJoeWqyM(), WindowInsetsSides.Companion.m571getBottomJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
