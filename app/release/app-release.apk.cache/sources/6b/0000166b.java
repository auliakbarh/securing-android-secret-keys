...
public final class OwnerSnapshotObserver {
    ...
    public final void observeLayoutSnapshotReads$ui_release(LayoutNode node, boolean z, Function0<Unit> block) {
    ...
    public final void observeLayoutModifierSnapshotReads$ui_release(LayoutNode node, boolean z, Function0<Unit> block) {
        Intrinsics.checkNotNullParameter(node, "node");
        Intrinsics.checkNotNullParameter(block, "block");
        if (z && node.getLookaheadRoot$ui_release() != null) {
    ...
    public final void observeMeasureSnapshotReads$ui_release(LayoutNode node, boolean z, Function0<Unit> block) {
        Intrinsics.checkNotNullParameter(node, "node");
        Intrinsics.checkNotNullParameter(block, "block");
        if (z && node.getLookaheadRoot$ui_release() != null) {
