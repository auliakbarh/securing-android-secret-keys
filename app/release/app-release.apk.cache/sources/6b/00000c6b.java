...
public class FloatingActionButtonElevation {
    ...
    private final State<Dp> animateElevation(InteractionSource interactionSource, Composer composer, int i) {
        ...
        EffectsKt.LaunchedEffect(Dp.m4870boximpl(f2), new FloatingActionButtonElevation$animateElevation$2(animatable, this, f2, interaction, null), composer, 64);
    ...
    public boolean equals(Object obj) {
        ...
        return Dp.m4877equalsimpl0(this.defaultElevation, floatingActionButtonElevation.defaultElevation) && Dp.m4877equalsimpl0(this.pressedElevation, floatingActionButtonElevation.pressedElevation) && Dp.m4877equalsimpl0(this.focusedElevation, floatingActionButtonElevation.focusedElevation) && Dp.m4877equalsimpl0(this.hoveredElevation, floatingActionButtonElevation.hoveredElevation);
    }

    public int hashCode() {
        return (((((Dp.m4878hashCodeimpl(this.defaultElevation) * 31) + Dp.m4878hashCodeimpl(this.pressedElevation)) * 31) + Dp.m4878hashCodeimpl(this.focusedElevation)) * 31) + Dp.m4878hashCodeimpl(this.hoveredElevation);
    }
}