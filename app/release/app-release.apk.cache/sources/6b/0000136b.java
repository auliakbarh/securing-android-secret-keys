...
final class ColorSpaceVerificationHelper {
    ...
    public static /* synthetic */ double $r8$lambda$QFu0dile_y9I3drz06WdO7yW50A(Function1 function1, double d) {
        return androidColorSpace$lambda$1(function1, d);
    }

    public static /* synthetic */ double $r8$lambda$QjPy_9duDqaY6Xqc17Bckdmcey8(ColorSpace colorSpace, double d) {
        return composeColorSpace$lambda$2(colorSpace, d);
    }

    public static /* synthetic */ double $r8$lambda$eGlfWATOmIjmWkkLSguMlMWw7_8(Function1 function1, double d) {
        return androidColorSpace$lambda$0(function1, d);
    }

    public static /* synthetic */ double $r8$lambda$pQY73vf2dPh7NEalGYV8cBq8u3g(ColorSpace colorSpace, double d) {
        return composeColorSpace$lambda$3(colorSpace, d);
    }
                ...
                if (transferParameters2 != null) {
                    ...
                    DoubleUnaryOperator doubleUnaryOperator = new DoubleUnaryOperator() { // from class: androidx.compose.ui.graphics.ColorSpaceVerificationHelper$$ExternalSyntheticLambda0
                        ...
                        public final double applyAsDouble(double d) {
                            return ColorSpaceVerificationHelper.$r8$lambda$eGlfWATOmIjmWkkLSguMlMWw7_8(Function1.this, d);
                        }
                    };
                    ...
                    rgb = new ColorSpace.Rgb(name, primaries$ui_graphics_release, xyz$ui_graphics_release, doubleUnaryOperator, new DoubleUnaryOperator() { // from class: androidx.compose.ui.graphics.ColorSpaceVerificationHelper$$ExternalSyntheticLambda1
                        @Override // java.util.function.DoubleUnaryOperator
                        public final double applyAsDouble(double d) {
                            return ColorSpaceVerificationHelper.$r8$lambda$QFu0dile_y9I3drz06WdO7yW50A(Function1.this, d);
                        }
        ...
        if (colorSpace instanceof ColorSpace.Rgb) {
            ...
            srgb = new Rgb(name, primaries, whitePoint2, rgb.getTransform(), new DoubleFunction() { // from class: androidx.compose.ui.graphics.ColorSpaceVerificationHelper$$ExternalSyntheticLambda2
                ...
                public final double invoke(double d) {
                    return ColorSpaceVerificationHelper.$r8$lambda$QjPy_9duDqaY6Xqc17Bckdmcey8(colorSpace, d);
                }
            }, new DoubleFunction() { // from class: androidx.compose.ui.graphics.ColorSpaceVerificationHelper$$ExternalSyntheticLambda3
                @Override // androidx.compose.ui.graphics.colorspace.DoubleFunction
                public final double invoke(double d) {
                    return ColorSpaceVerificationHelper.$r8$lambda$pQY73vf2dPh7NEalGYV8cBq8u3g(colorSpace, d);
                }
