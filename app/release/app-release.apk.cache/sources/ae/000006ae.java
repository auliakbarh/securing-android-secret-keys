...
public final class LazyLayoutBeyondBoundsModifierLocal implements ModifierLocalProvider<BeyondBoundsLayout>, BeyondBoundsLayout {
    ...
    public static final /* synthetic */ boolean m628access$hasMoreContentFR3nfPY(LazyLayoutBeyondBoundsModifierLocal lazyLayoutBeyondBoundsModifierLocal, LazyLayoutBeyondBoundsInfo.Interval interval, int i) {
        return lazyLayoutBeyondBoundsModifierLocal.m630hasMoreContentFR3nfPY(interval, i);
    }
    ...
    public <T> T mo633layouto7g1Pn8(final int i, Function1<? super BeyondBoundsLayout.BeyondBoundsScope, ? extends T> block) {
        ...
        T t = null;
        while (t == null && m630hasMoreContentFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, i)) {
            this.beyondBoundsInfo.removeInterval((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element);
            objectRef.element = (T) m629addNextIntervalFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, i);
            ...
            t = block.invoke(new BeyondBoundsLayout.BeyondBoundsScope() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutBeyondBoundsModifierLocal$layout$2
                @Override // androidx.compose.ui.layout.BeyondBoundsLayout.BeyondBoundsScope
                public boolean getHasMoreContent() {
                    return LazyLayoutBeyondBoundsModifierLocal.m628access$hasMoreContentFR3nfPY(LazyLayoutBeyondBoundsModifierLocal.this, objectRef.element, i);
                }
            });
        }
        this.beyondBoundsInfo.removeInterval((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element);
    ...
    /* renamed from: isForward-4vf7U8o */
    private final boolean m631isForward4vf7U8o(int i) {
        if (BeyondBoundsLayout.LayoutDirection.m3845equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m3851getBeforehoxUOeE())) {
            return false;
        }
        if (!BeyondBoundsLayout.LayoutDirection.m3845equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m3850getAfterhoxUOeE())) {
            if (BeyondBoundsLayout.LayoutDirection.m3845equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m3849getAbovehoxUOeE())) {
                return this.reverseLayout;
            }
            if (BeyondBoundsLayout.LayoutDirection.m3845equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m3852getBelowhoxUOeE())) {
                if (this.reverseLayout) {
                    return false;
                }
            } else if (BeyondBoundsLayout.LayoutDirection.m3845equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m3853getLefthoxUOeE())) {
            ...
            } else if (!BeyondBoundsLayout.LayoutDirection.m3845equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m3854getRighthoxUOeE())) {
    ...
    /* renamed from: addNextInterval-FR3nfPY */
    private final LazyLayoutBeyondBoundsInfo.Interval m629addNextIntervalFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval interval, int i) {
    ...
    /* renamed from: hasMoreContent-FR3nfPY */
    public final boolean m630hasMoreContentFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval interval, int i) {
        if (m632isOppositeToOrientation4vf7U8o(i)) {
            return false;
        }
        if (m631isForward4vf7U8o(i)) {
    ...
    /* renamed from: isOppositeToOrientation-4vf7U8o */
    private final boolean m632isOppositeToOrientation4vf7U8o(int i) {
        if (BeyondBoundsLayout.LayoutDirection.m3845equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m3849getAbovehoxUOeE()) || BeyondBoundsLayout.LayoutDirection.m3845equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m3852getBelowhoxUOeE())) {
            if (this.orientation == Orientation.Horizontal) {
                return true;
            }
        } else if (BeyondBoundsLayout.LayoutDirection.m3845equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m3853getLefthoxUOeE()) || BeyondBoundsLayout.LayoutDirection.m3845equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m3854getRighthoxUOeE())) {
            if (this.orientation == Orientation.Vertical) {
                return true;
            }
        } else if (!BeyondBoundsLayout.LayoutDirection.m3845equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m3851getBeforehoxUOeE()) && !BeyondBoundsLayout.LayoutDirection.m3845equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m3850getAfterhoxUOeE())) {
            LazyLayoutBeyondBoundsModifierLocalKt.unsupportedDirection();
            throw new KotlinNothingValueException();
        }
        return false;
