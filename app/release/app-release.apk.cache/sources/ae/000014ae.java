...
public final class HitPathTracker {
    ...
    public final void m3676addHitPathKNwqfcY(long j, List<? extends Modifier.Node> pointerInputNodes) {
        Node node;
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (z) {
                ...
                if (node4 != null) {
                    node4.markIsIn();
                    if (!node4.getPointerIds().contains(PointerId.m3727boximpl(j))) {
                        node4.getPointerIds().add(PointerId.m3727boximpl(j));
                    }
                    node2 = node4;
                } else {
                    z = false;
            ...
            node5.getPointerIds().add(PointerId.m3727boximpl(j));
