...
public final class SnapFlingBehavior implements FlingBehavior {
    ...
    public SnapFlingBehavior(LazyListState lazyListState, DecayAnimationSpec<Float> decayAnimationSpec, AnimationSpec<Float> snapAnimationSpec, Density density) {
        ...
        this.velocityThreshold = density.mo324toPx0680j_4(this.MinFlingVelocityDp);
        ...
        this.MinFlingVelocityDp = Dp.m4872constructorimpl(400);
    }

    public static final /* synthetic */ void access$animateDecay$consumeDelta(AnimationScope animationScope, ScrollScope scrollScope, float f) {
        animateDecay$consumeDelta(animationScope, scrollScope, f);
    }

    public static final /* synthetic */ float access$coerceToTarget(SnapFlingBehavior snapFlingBehavior, float f, float f2) {
        return snapFlingBehavior.coerceToTarget(f, f2);
    }
    ...
    public static final /* synthetic */ float access$getDefaultScrollMotionDurationScaleFactor$p(SnapFlingBehavior snapFlingBehavior) {
        return snapFlingBehavior.DefaultScrollMotionDurationScaleFactor;
    }
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:55:0x00ad A[PHI: r3 
      PHI: (r3v13 java.lang.Object) = (r3v12 java.lang.Object), (r3v1 java.lang.Object) binds: [B:53:0x00aa, B:40:0x0032] A[DONT_GENERATE, DONT_INLINE], RETURN] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    */
    ...
    private final int getSingleAxisViewportSize(LazyListLayoutInfo lazyListLayoutInfo) {
        return lazyListLayoutInfo.getOrientation() == Orientation.Vertical ? IntSize.m5031getHeightimpl(lazyListLayoutInfo.mo582getViewportSizeYbymL2g()) : IntSize.m5032getWidthimpl(lazyListLayoutInfo.mo582getViewportSizeYbymL2g());
    }
}