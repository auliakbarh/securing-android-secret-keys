...
public final class LayoutKt {
    public static final void Layout(Function2<? super Composer, ? super Integer, Unit> content, Modifier modifier, MeasurePolicy measurePolicy, Composer composer, int i, int i2) {
        ...
        modifierMaterializerOf.invoke(SkippableUpdater.m2253boximpl(SkippableUpdater.m2254constructorimpl(composer)), composer, Integer.valueOf((i3 >> 3) & 112));
    ...
    public static final void Layout(List<? extends Function2<? super Composer, ? super Integer, Unit>> contents, Modifier modifier, MultiContentMeasurePolicy measurePolicy, Composer composer, int i, int i2) {
        ...
        Composer m2262constructorimpl = Updater.m2262constructorimpl(composer);
        Updater.m2269setimpl(m2262constructorimpl, measurePolicy2, ComposeUiNode.Companion.getSetMeasurePolicy());
        Updater.m2269setimpl(m2262constructorimpl, currentCompositionLocalMap, ComposeUiNode.Companion.getSetResolvedCompositionLocals());
        Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash = ComposeUiNode.Companion.getSetCompositeKeyHash();
        if (m2262constructorimpl.getInserting() || !Intrinsics.areEqual(m2262constructorimpl.rememberedValue(), Integer.valueOf(currentCompositeKeyHash))) {
            m2262constructorimpl.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash));
    ...
    public static final Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> modifierMaterializerOf(final Modifier modifier) {
        ...
        return ComposableLambdaKt.composableLambdaInstance(-1586257396, true, new Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit>() { // from class: androidx.compose.ui.layout.LayoutKt$materializerOf$1
            ...
            public /* bridge */ /* synthetic */ Unit invoke(SkippableUpdater<ComposeUiNode> skippableUpdater, Composer composer, Integer num) {
                m3879invokeDeg8D_g(skippableUpdater.m2260unboximpl(), composer, num.intValue());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-Deg8D_g  reason: not valid java name */
            public final void m3879invokeDeg8D_g(Composer composer, Composer composer2, int i) {
    ...
    public static final Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf(final Modifier modifier) {
        ...
        return ComposableLambdaKt.composableLambdaInstance(-55743822, true, new Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit>() { // from class: androidx.compose.ui.layout.LayoutKt$materializerOfWithCompositionLocalInjection$1
            ...
            @Override // kotlin.jvm.functions.Function3
            public /* bridge */ /* synthetic */ Unit invoke(SkippableUpdater<ComposeUiNode> skippableUpdater, Composer composer, Integer num) {
                m3880invokeDeg8D_g(skippableUpdater.m2260unboximpl(), composer, num.intValue());
                return Unit.INSTANCE;
            }
            ...
            public final void m3880invokeDeg8D_g(Composer composer, Composer composer2, int i) {
                ...
                composer.startReplaceableGroup(509942095);
                Composer m2262constructorimpl = Updater.m2262constructorimpl(composer);
                Updater.m2269setimpl(m2262constructorimpl, materializeWithCompositionLocalInjectionInternal, ComposeUiNode.Companion.getSetModifier());
                Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash = ComposeUiNode.Companion.getSetCompositeKeyHash();
                if (m2262constructorimpl.getInserting() || !Intrinsics.areEqual(m2262constructorimpl.rememberedValue(), Integer.valueOf(currentCompositeKeyHash))) {
                    m2262constructorimpl.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash));
                    m2262constructorimpl.apply(Integer.valueOf(currentCompositeKeyHash), setCompositeKeyHash);
    ...
    public static final void MultiMeasureLayout(Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> content, final MeasurePolicy measurePolicy, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            Updater.m2269setimpl(m2262constructorimpl, measurePolicy, ComposeUiNode.Companion.getSetMeasurePolicy());
            Updater.m2269setimpl(m2262constructorimpl, currentCompositionLocalMap, ComposeUiNode.Companion.getSetResolvedCompositionLocals());
            Updater.m2266initimpl(m2262constructorimpl, new Function1<LayoutNode, Unit>() { // from class: androidx.compose.ui.layout.LayoutKt$MultiMeasureLayout$1$1
