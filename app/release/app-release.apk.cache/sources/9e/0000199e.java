...
public final class DrawStyleSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public void updateDrawState(TextPaint textPaint) {
        if (textPaint != null) {
            ...
            if (Intrinsics.areEqual(drawStyle, Fill.INSTANCE)) {
                ...
                textPaint.setStrokeJoin(m4656toAndroidJoinWw9F2mQ(((Stroke) this.drawStyle).m3235getJoinLxFBmk8()));
                textPaint.setStrokeCap(m4655toAndroidCapBeK7IIE(((Stroke) this.drawStyle).m3234getCapKaPHkGw()));
    ...
    private final Paint.Join m4656toAndroidJoinWw9F2mQ(int i) {
        return StrokeJoin.m2980equalsimpl0(i, StrokeJoin.Companion.m2985getMiterLxFBmk8()) ? Paint.Join.MITER : StrokeJoin.m2980equalsimpl0(i, StrokeJoin.Companion.m2986getRoundLxFBmk8()) ? Paint.Join.ROUND : StrokeJoin.m2980equalsimpl0(i, StrokeJoin.Companion.m2984getBevelLxFBmk8()) ? Paint.Join.BEVEL : Paint.Join.MITER;
    }

    /* renamed from: toAndroidCap-BeK7IIE  reason: not valid java name */
    private final Paint.Cap m4655toAndroidCapBeK7IIE(int i) {
        return StrokeCap.m2970equalsimpl0(i, StrokeCap.Companion.m2974getButtKaPHkGw()) ? Paint.Cap.BUTT : StrokeCap.m2970equalsimpl0(i, StrokeCap.Companion.m2975getRoundKaPHkGw()) ? Paint.Cap.ROUND : StrokeCap.m2970equalsimpl0(i, StrokeCap.Companion.m2976getSquareKaPHkGw()) ? Paint.Cap.SQUARE : Paint.Cap.BUTT;
    }
}