    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (Dp.m4877equalsimpl0(m4886unboximpl, f)) {
                focus = new PressInteraction.Press(Offset.Companion.m2405getZeroF1C5BW0(), null);
            } else {
            ...
            this.label = 1;
            if (ElevationKt.m1188animateElevationrAjV9yQ(this.$animatable, this.$target, focus, this.$interaction, this) == coroutine_suspended) {
