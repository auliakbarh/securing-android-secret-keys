...
public final class RowKt {
    ...
    static {
        ...
        float mo396getSpacingD9Ej5fM = Arrangement.INSTANCE.getStart().mo396getSpacingD9Ej5fM();
        ...
        DefaultRowMeasurePolicy = RowColumnImplKt.m504rowColumnMeasurePolicyTDGSqEk(layoutOrientation, new Function5<Integer, int[], LayoutDirection, Density, int[], Unit>() { // from class: androidx.compose.foundation.layout.RowKt$DefaultRowMeasurePolicy$1
        ...
        }, mo396getSpacingD9Ej5fM, SizeMode.Wrap, vertical$foundation_layout_release);
    }
    ...
    public static final MeasurePolicy rowMeasurePolicy(final Arrangement.Horizontal horizontalArrangement, Alignment.Vertical verticalAlignment, Composer composer, int i) {
        ...
        if (Intrinsics.areEqual(horizontalArrangement, Arrangement.INSTANCE.getStart()) && Intrinsics.areEqual(verticalAlignment, Alignment.Companion.getTop())) {
            ...
            if (changed || rememberedValue == Composer.Companion.getEmpty()) {
                LayoutOrientation layoutOrientation = LayoutOrientation.Horizontal;
                float mo396getSpacingD9Ej5fM = horizontalArrangement.mo396getSpacingD9Ej5fM();
                ...
                rememberedValue = RowColumnImplKt.m504rowColumnMeasurePolicyTDGSqEk(layoutOrientation, new Function5<Integer, int[], LayoutDirection, Density, int[], Unit>() { // from class: androidx.compose.foundation.layout.RowKt$rowMeasurePolicy$1$1
