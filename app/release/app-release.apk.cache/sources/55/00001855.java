...
public final class TextMeasurer {
    ...
    public static /* synthetic */ TextLayoutResult m4379measurexDpz5zY$default(TextMeasurer textMeasurer, AnnotatedString annotatedString, TextStyle textStyle, int i, boolean z, int i2, List list, long j, LayoutDirection layoutDirection, Density density, FontFamily.Resolver resolver, boolean z2, int i3, Object obj) {
        return textMeasurer.m4381measurexDpz5zY(annotatedString, (i3 & 2) != 0 ? TextStyle.Companion.getDefault() : textStyle, (i3 & 4) != 0 ? TextOverflow.Companion.m4813getClipgIe3tQ8() : i, (i3 & 8) != 0 ? true : z, (i3 & 16) != 0 ? Integer.MAX_VALUE : i2, (i3 & 32) != 0 ? CollectionsKt.emptyList() : list, (i3 & 64) != 0 ? ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null) : j, (i3 & 128) != 0 ? textMeasurer.fallbackLayoutDirection : layoutDirection, (i3 & 256) != 0 ? textMeasurer.fallbackDensity : density, (i3 & 512) != 0 ? textMeasurer.fallbackFontFamilyResolver : resolver, (i3 & 1024) != 0 ? false : z2);
    }

    /* renamed from: measure-xDpz5zY  reason: not valid java name */
    public final TextLayoutResult m4381measurexDpz5zY(AnnotatedString text, TextStyle style, int i, boolean z, int i2, List<AnnotatedString.Range<Placeholder>> placeholders, long j, LayoutDirection layoutDirection, Density density, FontFamily.Resolver fontFamilyResolver, boolean z2) {
        ...
        if (textLayoutResult != null) {
            return textLayoutResult.m4374copyO0kMr_c(textLayoutInput, ConstraintsKt.m4839constrain4WqzIAM(j, IntSizeKt.IntSize(ParagraphKt.ceilToInt(textLayoutResult.getMultiParagraph().getWidth()), ParagraphKt.ceilToInt(textLayoutResult.getMultiParagraph().getHeight()))));
        }
    ...
    public final TextLayoutResult m4380measurewNUYSr0(String text, TextStyle style, int i, boolean z, int i2, long j, LayoutDirection layoutDirection, Density density, FontFamily.Resolver fontFamilyResolver, boolean z2) {
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(fontFamilyResolver, "fontFamilyResolver");
        return m4379measurexDpz5zY$default(this, new AnnotatedString(text, null, null, 6, null), style, i, z, i2, null, j, layoutDirection, density, fontFamilyResolver, z2, 32, null);
    }
    ...
    public static final class Companion {
        ...
        public final TextLayoutResult layout(TextLayoutInput textLayoutInput) {
            ...
            int m4830getMinWidthimpl = Constraints.m4830getMinWidthimpl(textLayoutInput.m4371getConstraintsmsEJaDk());
            int m4828getMaxWidthimpl = ((textLayoutInput.getSoftWrap() || TextOverflow.m4806equalsimpl0(textLayoutInput.m4372getOverflowgIe3tQ8(), TextOverflow.Companion.m4814getEllipsisgIe3tQ8())) && Constraints.m4824getHasBoundedWidthimpl(textLayoutInput.m4371getConstraintsmsEJaDk())) ? Constraints.m4828getMaxWidthimpl(textLayoutInput.m4371getConstraintsmsEJaDk()) : Integer.MAX_VALUE;
            int maxLines = (textLayoutInput.getSoftWrap() || !TextOverflow.m4806equalsimpl0(textLayoutInput.m4372getOverflowgIe3tQ8(), TextOverflow.Companion.m4814getEllipsisgIe3tQ8())) ? textLayoutInput.getMaxLines() : 1;
            if (m4830getMinWidthimpl != m4828getMaxWidthimpl) {
                m4828getMaxWidthimpl = RangesKt.coerceIn(ParagraphKt.ceilToInt(multiParagraphIntrinsics.getMaxIntrinsicWidth()), m4830getMinWidthimpl, m4828getMaxWidthimpl);
            }
            MultiParagraph multiParagraph = new MultiParagraph(multiParagraphIntrinsics, ConstraintsKt.Constraints$default(0, m4828getMaxWidthimpl, 0, Constraints.m4827getMaxHeightimpl(textLayoutInput.m4371getConstraintsmsEJaDk()), 5, null), maxLines, TextOverflow.m4806equalsimpl0(textLayoutInput.m4372getOverflowgIe3tQ8(), TextOverflow.Companion.m4814getEllipsisgIe3tQ8()), null);
            return new TextLayoutResult(textLayoutInput, multiParagraph, ConstraintsKt.m4839constrain4WqzIAM(textLayoutInput.m4371getConstraintsmsEJaDk(), IntSizeKt.IntSize((int) Math.ceil(multiParagraph.getWidth()), (int) Math.ceil(multiParagraph.getHeight()))), null);
        }
    }
}