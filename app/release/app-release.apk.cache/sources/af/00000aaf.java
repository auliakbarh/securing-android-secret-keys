...
public final class AnimatedPaddingValues implements PaddingValues {
    ...
    public float mo432calculateTopPaddingD9Ej5fM() {
        return Dp.m4872constructorimpl(this.topPadding.getValue().m4886unboximpl() * this.animationProgress.getValue().floatValue());
    }

    @Override // androidx.compose.foundation.layout.PaddingValues
    /* renamed from: calculateBottomPadding-D9Ej5fM */
    public float mo429calculateBottomPaddingD9Ej5fM() {
        return Dp.m4872constructorimpl(SearchBarKt.getSearchBarVerticalPadding() * this.animationProgress.getValue().floatValue());
    }
