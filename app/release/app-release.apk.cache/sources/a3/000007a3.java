...
public abstract class PagerState implements ScrollableState {
    ...
    public final long m699getPremeasureConstraintsmsEJaDk$foundation_release() {
    ...
    public final void m701setPremeasureConstraintsBRTryo0$foundation_release(long j) {
    ...
    public PagerState(int i, float f) {
        ...
        double d = f;
        if (-0.5d <= d && d <= 0.5d) {
            mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m2378boximpl(Offset.Companion.m2405getZeroF1C5BW0()), null, 2, null);
            ...
            this.scrollableState = ScrollableStateKt.ScrollableState(new Function1<Float, Float>() { // from class: androidx.compose.foundation.pager.PagerState$scrollableState$1
                ...
                public final Float invoke(float f2) {
                    return Float.valueOf(-PagerState.access$performScroll(PagerState.this, -f2));
                }
            ...
            this.settledPage$delegate = SnapshotStateKt.derivedStateOf(SnapshotStateKt.structuralEqualityPolicy(), new Function0<Integer>() { // from class: androidx.compose.foundation.pager.PagerState$settledPage$2
                ...
                public final Integer invoke() {
                    ...
                    if (PagerState.this.isScrollInProgress()) {
                        currentPage = PagerState.access$getSettledPageState(PagerState.this);
                    } else {
            ...
            this.targetPage$delegate = SnapshotStateKt.derivedStateOf(SnapshotStateKt.structuralEqualityPolicy(), new Function0<Integer>() { // from class: androidx.compose.foundation.pager.PagerState$targetPage$2
                ...
                public final Integer invoke() {
                    ...
                    } else if (PagerState.access$getAnimationTargetPage(PagerState.this) != -1) {
                        roundToInt = PagerState.access$getAnimationTargetPage(PagerState.this);
                    } else if (PagerState.this.getSnapRemainingScrollOffset$foundation_release() == 0.0f) {
                        if (Math.abs(PagerState.this.getCurrentPageOffsetFraction()) >= Math.abs(PagerState.access$getPositionThresholdFraction(PagerState.this))) {
                            roundToInt = PagerState.this.getCurrentPage() + ((int) Math.signum(PagerState.this.getCurrentPageOffsetFraction()));
                        } else {
                            roundToInt = PagerState.this.getCurrentPage();
                        }
                    } else {
                        float snapRemainingScrollOffset$foundation_release = PagerState.this.getSnapRemainingScrollOffset$foundation_release() / PagerState.access$getPageAvailableSpace(PagerState.this);
                        roundToInt = MathKt.roundToInt(snapRemainingScrollOffset$foundation_release) + PagerState.this.getCurrentPage();
                    }
                    return Integer.valueOf(PagerState.access$coerceInPageRange(PagerState.this, roundToInt));
                }
            });
            this.currentPageOffsetFraction$delegate = SnapshotStateKt.derivedStateOf(SnapshotStateKt.structuralEqualityPolicy(), new Function0<Float>() { // from class: androidx.compose.foundation.pager.PagerState$currentPageOffsetFraction$2
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(0);
                }
            ...
            this.remeasurementModifier = new RemeasurementModifier() { // from class: androidx.compose.foundation.pager.PagerState$remeasurementModifier$1
                ...
                public void onRemeasurementAvailable(Remeasurement remeasurement) {
                    ...
                    PagerState.access$setRemeasurement(PagerState.this, remeasurement);
                }
            };
    ...
    public static final /* synthetic */ int access$coerceInPageRange(PagerState pagerState, int i) {
        return pagerState.coerceInPageRange(i);
    }

    public static final /* synthetic */ int access$getAnimationTargetPage(PagerState pagerState) {
        return pagerState.getAnimationTargetPage();
    }

    public static final /* synthetic */ int access$getPageAvailableSpace(PagerState pagerState) {
        return pagerState.getPageAvailableSpace();
    }

    public static final /* synthetic */ float access$getPositionThresholdFraction(PagerState pagerState) {
        return pagerState.getPositionThresholdFraction();
    }

    public static final /* synthetic */ int access$getSettledPageState(PagerState pagerState) {
        return pagerState.getSettledPageState();
    }

    public static final /* synthetic */ float access$performScroll(PagerState pagerState, float f) {
        return pagerState.performScroll(f);
    }

    public static final /* synthetic */ void access$setRemeasurement(PagerState pagerState, Remeasurement remeasurement) {
        pagerState.setRemeasurement(remeasurement);
    }
    ...
    public final long m700getUpDownDifferenceF1C5BW0$foundation_release() {
        return ((Offset) this.upDownDifference$delegate.getValue()).m2399unboximpl();
    }

    /* renamed from: setUpDownDifference-k-4lQ0M$foundation_release */
    public final void m702setUpDownDifferencek4lQ0M$foundation_release(long j) {
        this.upDownDifference$delegate.setValue(Offset.m2378boximpl(j));
    }
    ...
    public final float getPositionThresholdFraction() {
        return Math.min(this.density.mo324toPx0680j_4(PagerStateKt.getDefaultPositionThreshold()), getPageSize$foundation_release() / 2.0f) / getPageSize$foundation_release();
    }
