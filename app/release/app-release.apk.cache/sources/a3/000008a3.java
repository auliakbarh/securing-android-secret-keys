...
public final class TextFieldKeyInputKt {
    ...
    public static final Modifier m814textFieldKeyInput2WJ9YEU(Modifier textFieldKeyInput, final TextFieldState state, final TextFieldSelectionManager manager, final TextFieldValue value, final Function1<? super TextFieldValue, Unit> onValueChange, final boolean z, final boolean z2, final OffsetMapping offsetMapping, final UndoManager undoManager, final int i) {
        ...
        return ComposedModifierKt.composed$default(textFieldKeyInput, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.TextFieldKeyInputKt$textFieldKeyInput$2
            ...
            public /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function1<KeyEvent, Boolean> {
                ...
                public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                    return m816invokeZmokQxo(keyEvent.m3603unboximpl());
                }

                /* renamed from: invoke-ZmokQxo  reason: not valid java name */
                public final Boolean m816invokeZmokQxo(android.view.KeyEvent p0) {
                    Intrinsics.checkNotNullParameter(p0, "p0");
                    return Boolean.valueOf(((TextFieldKeyInput) this.receiver).m813processZmokQxo(p0));
                }
            }
        }, 1, null);
    }
