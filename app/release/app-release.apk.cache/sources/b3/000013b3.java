...
public final class SolidColor extends Brush {
    ...
    public final long m2956getValue0d7_KjU() {
        return this.value;
    }
    ...
    public void mo2575applyToPq9zytI(long j, Paint p, float f) {
        long m2627copywmQWz5c$default;
        Intrinsics.checkNotNullParameter(p, "p");
        p.setAlpha(1.0f);
        if (f == 1.0f) {
            m2627copywmQWz5c$default = this.value;
        } else {
            long j2 = this.value;
            m2627copywmQWz5c$default = Color.m2627copywmQWz5c$default(j2, Color.m2630getAlphaimpl(j2) * f, 0.0f, 0.0f, 0.0f, 14, null);
        }
        p.mo2509setColor8_81llA(m2627copywmQWz5c$default);
        if (p.getShader() != null) {
            p.setShader(null);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof SolidColor) && Color.m2629equalsimpl0(this.value, ((SolidColor) obj).value);
    }
    ...
    public String toString() {
        return "SolidColor(value=" + ((Object) Color.m2636toStringimpl(this.value)) + ')';
    }
}