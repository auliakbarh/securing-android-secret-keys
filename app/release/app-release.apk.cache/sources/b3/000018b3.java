...
public final class AndroidFontLoader implements PlatformFontLoader {
    ...
    public android.graphics.Typeface loadBlocking(Font font) {
        ...
        if (font instanceof ResourceFont) {
            ...
            } else if (FontLoadingStrategy.m4486equalsimpl0(mo4446getLoadingStrategyPKNRLFQ, FontLoadingStrategy.Companion.m4492getOptionalLocalPKNRLFQ())) {
                try {
                    ...
                    m5154constructorimpl = Result.m5154constructorimpl(load);
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.Companion;
                    m5154constructorimpl = Result.m5154constructorimpl(ResultKt.createFailure(th));
                }
                typeface = Result.m5160isFailureimpl(m5154constructorimpl) ? null : m5154constructorimpl;
            } else if (FontLoadingStrategy.m4486equalsimpl0(mo4446getLoadingStrategyPKNRLFQ, FontLoadingStrategy.Companion.m4490getAsyncPKNRLFQ())) {
                throw new UnsupportedOperationException("Unsupported Async font load path");
            } else {
                throw new IllegalArgumentException("Unknown loading type " + ((Object) FontLoadingStrategy.m4488toStringimpl(font.mo4446getLoadingStrategyPKNRLFQ())));
            }
