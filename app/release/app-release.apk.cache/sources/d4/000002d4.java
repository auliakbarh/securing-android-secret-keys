...
final class ClickableNode extends AbstractClickableNode {
    ...
    public final void m200updateXHw0xAI(MutableInteractionSource interactionSource, boolean z, String str, Role role, Function0<Unit> onClick) {
        Intrinsics.checkNotNullParameter(interactionSource, "interactionSource");
        Intrinsics.checkNotNullParameter(onClick, "onClick");
        m143updateCommonXHw0xAI(interactionSource, z, str, role, onClick);
        getClickableSemanticsNode().m203updateUMe6uN4(z, str, role, onClick, null, null);
