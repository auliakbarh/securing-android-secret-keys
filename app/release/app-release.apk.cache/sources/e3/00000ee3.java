...
public final class TextFieldDefaultsKt {
    ...
    public static final State<BorderStroke> m1540animateBorderStrokeAsStateNuRrP5Q(boolean z, boolean z2, InteractionSource interactionSource, TextFieldColors textFieldColors, float f, float f2, Composer composer, int i) {
        ...
        if (z) {
            ...
            rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Dp.m4870boximpl(f2), composer, (i >> 15) & 14);
            composer.endReplaceableGroup();
        }
        State<BorderStroke> rememberUpdatedState2 = SnapshotStateKt.rememberUpdatedState(new BorderStroke(rememberUpdatedState.getValue().m4886unboximpl(), new SolidColor(indicatorColor$material3_release.getValue().m2638unboximpl(), null), null), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
