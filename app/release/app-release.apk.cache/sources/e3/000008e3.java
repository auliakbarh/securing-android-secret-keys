...
public final class SelectionControllerKt {
    /* renamed from: access$outOfBoundary-2x9bVx0 */
    public static final /* synthetic */ boolean m859access$outOfBoundary2x9bVx0(TextLayoutResult textLayoutResult, long j, long j2) {
        return m860outOfBoundary2x9bVx0(textLayoutResult, j, j2);
    }
    ...
    public static final Modifier makeSelectionModifier(final SelectionRegistrar selectionRegistrar, final long j, final Function0<? extends LayoutCoordinates> function0, final Function0<TextLayoutResult> function02, boolean z) {
        if (z) {
            ?? r12 = new TextDragObserver() { // from class: androidx.compose.foundation.text.modifiers.SelectionControllerKt$makeSelectionModifier$longPressDragObserver$1
                ...
                private long dragTotalDistance = Offset.Companion.m2405getZeroF1C5BW0();
                ...
                public void mo800onDownk4lQ0M(long j2) {
                }
                ...
                public void mo802onStartk4lQ0M(long j2) {
                    ...
                    if (invoke != null) {
                        ...
                        if (SelectionControllerKt.m859access$outOfBoundary2x9bVx0(function03.invoke(), j2, j2)) {
                            selectionRegistrar2.notifySelectionUpdateSelectAll(j3);
                        } else {
                            selectionRegistrar2.mo934notifySelectionUpdateStartd4ec7I(invoke, j2, SelectionAdjustment.Companion.getWord());
                        }
                        this.lastPosition = j2;
                    }
                ...
                public void mo801onDragk4lQ0M(long j2) {
                    LayoutCoordinates invoke = function0.invoke();
                    if (invoke != null) {
                        SelectionRegistrar selectionRegistrar2 = selectionRegistrar;
                        long j3 = j;
                        ...
                        if (invoke.isAttached() && SelectionRegistrarKt.hasSelection(selectionRegistrar2, j3)) {
                            long m2394plusMKHz9U = Offset.m2394plusMKHz9U(this.dragTotalDistance, j2);
                            this.dragTotalDistance = m2394plusMKHz9U;
                            long m2394plusMKHz9U2 = Offset.m2394plusMKHz9U(this.lastPosition, m2394plusMKHz9U);
                            if (SelectionControllerKt.m859access$outOfBoundary2x9bVx0(function03.invoke(), this.lastPosition, m2394plusMKHz9U2) || !selectionRegistrar2.mo933notifySelectionUpdate5iVPX68(invoke, m2394plusMKHz9U2, this.lastPosition, false, SelectionAdjustment.Companion.getCharacterWithWordAccelerate())) {
                                return;
                            }
                            this.lastPosition = m2394plusMKHz9U2;
                            this.dragTotalDistance = Offset.Companion.m2405getZeroF1C5BW0();
                        }
                    }
                }
        ...
        ?? r11 = new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.modifiers.SelectionControllerKt$makeSelectionModifier$mouseSelectionObserver$1
            ...
            public boolean mo862onExtendk4lQ0M(long j2) {
                LayoutCoordinates invoke = function0.invoke();
                if (invoke != null) {
                    SelectionRegistrar selectionRegistrar2 = selectionRegistrar;
                    long j3 = j;
                    if (invoke.isAttached()) {
                        if (selectionRegistrar2.mo933notifySelectionUpdate5iVPX68(invoke, j2, this.lastPosition, false, SelectionAdjustment.Companion.getNone())) {
                            this.lastPosition = j2;
                        }
            ...
            public boolean mo863onExtendDragk4lQ0M(long j2) {
                LayoutCoordinates invoke = function0.invoke();
                if (invoke != null) {
                    SelectionRegistrar selectionRegistrar2 = selectionRegistrar;
                    long j3 = j;
            ...
            public boolean mo864onStart3MmeM6k(long j2, SelectionAdjustment adjustment) {
                ...
                if (invoke != null) {
                    ...
                    long j3 = j;
                    if (invoke.isAttached()) {
                        selectionRegistrar2.mo934notifySelectionUpdateStartd4ec7I(invoke, j2, adjustment);
                        this.lastPosition = j2;
                        return SelectionRegistrarKt.hasSelection(selectionRegistrar2, j3);
                    }
                    return false;
            ...
            public boolean mo861onDrag3MmeM6k(long j2, SelectionAdjustment adjustment) {
                Intrinsics.checkNotNullParameter(adjustment, "adjustment");
                LayoutCoordinates invoke = function0.invoke();
                if (invoke != null) {
                    SelectionRegistrar selectionRegistrar2 = selectionRegistrar;
                    long j3 = j;
                    if (invoke.isAttached() && SelectionRegistrarKt.hasSelection(selectionRegistrar2, j3)) {
                        if (selectionRegistrar2.mo933notifySelectionUpdate5iVPX68(invoke, j2, this.lastPosition, false, adjustment)) {
                            this.lastPosition = j2;
                            return true;
                        }
                        return true;
    ...
    public static final boolean m860outOfBoundary2x9bVx0(TextLayoutResult textLayoutResult, long j, long j2) {
        if (textLayoutResult == null) {
            return false;
        }
        int length = textLayoutResult.getLayoutInput().getText().getText().length();
        int m4375getOffsetForPositionk4lQ0M = textLayoutResult.m4375getOffsetForPositionk4lQ0M(j);
        int m4375getOffsetForPositionk4lQ0M2 = textLayoutResult.m4375getOffsetForPositionk4lQ0M(j2);
        int i = length - 1;
        return (m4375getOffsetForPositionk4lQ0M >= i && m4375getOffsetForPositionk4lQ0M2 >= i) || (m4375getOffsetForPositionk4lQ0M < 0 && m4375getOffsetForPositionk4lQ0M2 < 0);
    }
}