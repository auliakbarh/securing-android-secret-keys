...
final class FixedDpInsets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        ...
        return density.mo318roundToPx0680j_4(this.leftDp);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getTop(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.mo318roundToPx0680j_4(this.topDp);
    }
    ...
    public int getRight(Density density, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        return density.mo318roundToPx0680j_4(this.rightDp);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getBottom(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.mo318roundToPx0680j_4(this.bottomDp);
    }

    public String toString() {
        return "Insets(left=" + ((Object) Dp.m4883toStringimpl(this.leftDp)) + ", top=" + ((Object) Dp.m4883toStringimpl(this.topDp)) + ", right=" + ((Object) Dp.m4883toStringimpl(this.rightDp)) + ", bottom=" + ((Object) Dp.m4883toStringimpl(this.bottomDp)) + ')';
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FixedDpInsets) {
            ...
            return Dp.m4877equalsimpl0(this.leftDp, fixedDpInsets.leftDp) && Dp.m4877equalsimpl0(this.topDp, fixedDpInsets.topDp) && Dp.m4877equalsimpl0(this.rightDp, fixedDpInsets.rightDp) && Dp.m4877equalsimpl0(this.bottomDp, fixedDpInsets.bottomDp);
        }
        return false;
    }

    public int hashCode() {
        return (((((Dp.m4878hashCodeimpl(this.leftDp) * 31) + Dp.m4878hashCodeimpl(this.topDp)) * 31) + Dp.m4878hashCodeimpl(this.rightDp)) * 31) + Dp.m4878hashCodeimpl(this.bottomDp);
    }
}