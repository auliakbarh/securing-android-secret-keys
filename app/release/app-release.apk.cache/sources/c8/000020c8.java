        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m5728contentEqualskV0jMPg(((UByteArray) t).m5244unboximpl(), ((UByteArray) t2).m5244unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m5726contentEqualsFGO6Aew(((UShortArray) t).m5507unboximpl(), ((UShortArray) t2).m5507unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m5727contentEqualsKJPZfPQ(((UIntArray) t).m5323unboximpl(), ((UIntArray) t2).m5323unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m5729contentEqualslec5QzE(((ULongArray) t).m5402unboximpl(), ((ULongArray) t2).m5402unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m5734contentToString2csIQuQ(uByteArray != null ? uByteArray.m5244unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                sb.append(UArraysKt.m5736contentToStringd6D3K8(uShortArray != null ? uShortArray.m5507unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                sb.append(UArraysKt.m5735contentToStringXUkPCBk(uIntArray != null ? uIntArray.m5323unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                sb.append(UArraysKt.m5737contentToStringuLth9ew(uLongArray != null ? uLongArray.m5402unboximpl() : null));
            } else {
