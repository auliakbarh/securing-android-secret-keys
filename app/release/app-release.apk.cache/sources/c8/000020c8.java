        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m5725contentEqualskV0jMPg(((UByteArray) t).m5241unboximpl(), ((UByteArray) t2).m5241unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m5723contentEqualsFGO6Aew(((UShortArray) t).m5504unboximpl(), ((UShortArray) t2).m5504unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m5724contentEqualsKJPZfPQ(((UIntArray) t).m5320unboximpl(), ((UIntArray) t2).m5320unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m5726contentEqualslec5QzE(((ULongArray) t).m5399unboximpl(), ((ULongArray) t2).m5399unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m5731contentToString2csIQuQ(uByteArray != null ? uByteArray.m5241unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                sb.append(UArraysKt.m5733contentToStringd6D3K8(uShortArray != null ? uShortArray.m5504unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                sb.append(UArraysKt.m5732contentToStringXUkPCBk(uIntArray != null ? uIntArray.m5320unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                sb.append(UArraysKt.m5734contentToStringuLth9ew(uLongArray != null ? uLongArray.m5399unboximpl() : null));
            } else {
