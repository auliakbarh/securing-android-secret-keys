...
public final class Vertices {
    ...
    public final int m3023getVertexModec2xauaI() {
    ...
    private final int[] encodeColorList(List<Color> list) {
        ...
        for (int i = 0; i < size; i++) {
            iArr[i] = ColorKt.m2682toArgb8_81llA(list.get(i).m2638unboximpl());
        }
        return iArr;
    }
    ...
    private final float[] encodePointList(List<Offset> list) {
        ...
        for (int i = 0; i < size; i++) {
            long m2399unboximpl = list.get(i / 2).m2399unboximpl();
            if (i % 2 == 0) {
                m2390getYimpl = Offset.m2389getXimpl(m2399unboximpl);
            } else {
                m2390getYimpl = Offset.m2390getYimpl(m2399unboximpl);
            }
            fArr[i] = m2390getYimpl;
        }
        return fArr;
    }
}