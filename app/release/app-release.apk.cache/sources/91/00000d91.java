...
public final class RichTooltipColors {
    ...
    public final long m1351getActionContentColor0d7_KjU() {
        return this.actionContentColor;
    }

    /* renamed from: getContainerColor-0d7_KjU  reason: not valid java name */
    public final long m1352getContainerColor0d7_KjU() {
        return this.containerColor;
    }

    /* renamed from: getContentColor-0d7_KjU  reason: not valid java name */
    public final long m1353getContentColor0d7_KjU() {
        return this.contentColor;
    }

    /* renamed from: getTitleContentColor-0d7_KjU  reason: not valid java name */
    public final long m1354getTitleContentColor0d7_KjU() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RichTooltipColors) {
            ...
            return Color.m2629equalsimpl0(this.containerColor, richTooltipColors.containerColor) && Color.m2629equalsimpl0(this.contentColor, richTooltipColors.contentColor) && Color.m2629equalsimpl0(this.titleContentColor, richTooltipColors.titleContentColor) && Color.m2629equalsimpl0(this.actionContentColor, richTooltipColors.actionContentColor);
        }
        return false;
    }

    public int hashCode() {
        return (((((Color.m2635hashCodeimpl(this.containerColor) * 31) + Color.m2635hashCodeimpl(this.contentColor)) * 31) + Color.m2635hashCodeimpl(this.titleContentColor)) * 31) + Color.m2635hashCodeimpl(this.actionContentColor);
    }
}