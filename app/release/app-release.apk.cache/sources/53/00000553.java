...
public final class RowColumnMeasurementHelper {
    ...
    public final float m505getArrangementSpacingD9Ej5fM() {
    ...
    public final RowColumnMeasureHelperResult m506measureWithoutPlacing_EkL_Y(MeasureScope measureScope, long j, int i, int i2) {
        int i3;
        ...
        long m448constructorimpl = OrientationIndependentConstraints.m448constructorimpl(j, this.orientation);
        int i13 = measureScope.mo318roundToPx0680j_4(this.arrangementSpacing);
        int i14 = i2 - i;
        float f = 0.0f;
        int i15 = 0;
        int i16 = i;
        ...
        while (true) {
            ...
            if (weight > f) {
                ...
                int m4828getMaxWidthimpl = Constraints.m4828getMaxWidthimpl(m448constructorimpl);
                Placeable placeable = this.placeables[i16];
                if (placeable == null) {
                    i9 = m4828getMaxWidthimpl;
                    i10 = i18;
                    i11 = i16;
                    i12 = i15;
                    placeable = measurable.mo3865measureBRTryo0(OrientationIndependentConstraints.m461toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m450copyyUG9Ft0$default(m448constructorimpl, 0, m4828getMaxWidthimpl == Integer.MAX_VALUE ? Integer.MAX_VALUE : m4828getMaxWidthimpl - i20, 0, 0, 8, null), this.orientation));
                } else {
                    i9 = m4828getMaxWidthimpl;
                    i10 = i18;
                    i11 = i16;
        ...
        if (i19 == 0) {
            ...
            if (i25 > 0 && Constraints.m4828getMaxWidthimpl(m448constructorimpl) != Integer.MAX_VALUE) {
                m4830getMinWidthimpl = Constraints.m4828getMaxWidthimpl(m448constructorimpl);
            } else {
                m4830getMinWidthimpl = Constraints.m4830getMinWidthimpl(m448constructorimpl);
            }
            int i26 = i13 * (i19 - 1);
            int i27 = (m4830getMinWidthimpl - i20) - i26;
            ...
            while (i30 < i2) {
                if (this.placeables[i30] == null) {
                    ...
                    Placeable mo3865measureBRTryo0 = measurable2.mo3865measureBRTryo0(OrientationIndependentConstraints.m461toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m446constructorimpl(i5, max3, i23, Constraints.m4827getMaxHeightimpl(m448constructorimpl)), this.orientation));
                    i31 += mainAxisSize(mo3865measureBRTryo0);
                    i4 = Math.max(i4, crossAxisSize(mo3865measureBRTryo0));
                    int i33 = (i21 != 0 || RowColumnImplKt.isRelative(rowColumnParentData2)) ? 1 : i23;
                    this.placeables[i30] = mo3865measureBRTryo0;
                    i29 = i6;
                    i21 = i33;
                }
                i30++;
            ...
            coerceAtMost = RangesKt.coerceAtMost(i31 + i26, Constraints.m4828getMaxWidthimpl(m448constructorimpl) - i20);
        }
        if (i21 != 0) {
            int i34 = i23;
            int i35 = i34;
        ...
        int max4 = Math.max(i20 + coerceAtMost, Constraints.m4830getMinWidthimpl(m448constructorimpl));
        if (Constraints.m4827getMaxHeightimpl(m448constructorimpl) == Integer.MAX_VALUE || this.crossAxisSize != SizeMode.Expand) {
            max = Math.max(i4, Math.max(Constraints.m4829getMinHeightimpl(m448constructorimpl), i7 + i8));
        } else {
            max = Constraints.m4827getMaxHeightimpl(m448constructorimpl);
        }
