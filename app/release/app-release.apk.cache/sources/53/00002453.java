...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo6713scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m6648delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m6649toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m6649toDelayMillisLRDsOJo(long j) {
        if (Duration.m6483compareToLRDsOJo(j, Duration.Companion.m6587getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m6502getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}