...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo6710scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m6645delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m6646toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m6646toDelayMillisLRDsOJo(long j) {
        if (Duration.m6480compareToLRDsOJo(j, Duration.Companion.m6584getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m6499getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}