...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo6709scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m6644delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m6645toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m6645toDelayMillisLRDsOJo(long j) {
        if (Duration.m6479compareToLRDsOJo(j, Duration.Companion.m6583getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m6498getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}