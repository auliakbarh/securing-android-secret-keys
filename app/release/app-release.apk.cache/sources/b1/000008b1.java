...
public final class TextFieldScrollKt {
    ...
    public static final Modifier textFieldScroll(Modifier modifier, TextFieldScrollerPosition scrollerPosition, TextFieldValue textFieldValue, VisualTransformation visualTransformation, Function0<TextLayoutResultProxy> textLayoutResultProvider) {
        ...
        int m820getOffsetToFollow5zctL8 = scrollerPosition.m820getOffsetToFollow5zctL8(textFieldValue.m4622getSelectiond9O1mEE());
        scrollerPosition.m822setPreviousSelection5zctL8(textFieldValue.m4622getSelectiond9O1mEE());
        ...
        if (i == 1) {
            verticalScrollLayoutModifier = new VerticalScrollLayoutModifier(scrollerPosition, m820getOffsetToFollow5zctL8, filterWithValidation, textLayoutResultProvider);
        } else if (i != 2) {
            throw new NoWhenBranchMatchedException();
        } else {
            verticalScrollLayoutModifier = new HorizontalScrollLayoutModifier(scrollerPosition, m820getOffsetToFollow5zctL8, filterWithValidation, textLayoutResultProvider);
        }
    ...
    public static final Rect getCursorRectInScroller(Density density, int i, TransformedText transformedText, TextLayoutResult textLayoutResult, boolean z, int i2) {
        ...
        Rect rect = zero;
        int mo318roundToPx0680j_4 = density.mo318roundToPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness());
        if (z) {
            left = (i2 - rect.getLeft()) - mo318roundToPx0680j_4;
        } else {
            left = rect.getLeft();
        }
        float f = left;
        if (z) {
            ...
            left2 = rect.getLeft() + mo318roundToPx0680j_4;
        }
