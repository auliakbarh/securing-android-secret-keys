...
public final class PagerStateKt {
    ...
    private static final float DefaultPositionThreshold = Dp.m4872constructorimpl(56);
    private static final PagerLayoutInfo EmptyLayoutInfo = new PagerLayoutInfo() { // from class: androidx.compose.foundation.pager.PagerStateKt$EmptyLayoutInfo$1
        ...
        private final long viewportSize = IntSize.Companion.m5037getZeroYbymL2g();
        ...
        public long mo693getViewportSizeYbymL2g() {
    ...
    public static final PagerState rememberPagerState(final int i, final float f, final Function0<Integer> pageCount, Composer composer, int i2, int i3) {
        ...
        PagerStateImpl pagerStateImpl = (PagerStateImpl) RememberSaveableKt.m2275rememberSaveable(objArr, saver, (String) null, (Function0<? extends Object>) rememberedValue, composer, 72, 4);
