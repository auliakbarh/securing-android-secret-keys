...
final class BackgroundNode extends Modifier.Node implements DrawModifierNode {
    ...
    public final long m159getColor0d7_KjU() {
        return this.color;
    }
    ...
    public final void m160setColor8_81llA(long j) {
        this.color = j;
    }
    ...
    private final void drawRect(ContentDrawScope contentDrawScope) {
        if (!Color.m2629equalsimpl0(this.color, Color.Companion.m2664getUnspecified0d7_KjU())) {
            DrawScope.m3166drawRectnJ9OG0$default(contentDrawScope, this.color, 0L, 0L, 0.0f, null, null, 0, 126, null);
        }
        Brush brush = this.brush;
        if (brush != null) {
            DrawScope.m3165drawRectAsUm42w$default(contentDrawScope, brush, 0L, 0L, this.alpha, null, null, 0, 118, null);
        }
    }

    private final void drawOutline(ContentDrawScope contentDrawScope) {
        Outline mo207createOutlinePq9zytI;
        if (Size.m2453equalsimpl(contentDrawScope.mo3171getSizeNHjbRc(), this.lastSize) && contentDrawScope.getLayoutDirection() == this.lastLayoutDirection && Intrinsics.areEqual(this.lastShape, this.shape)) {
            mo207createOutlinePq9zytI = this.lastOutline;
            Intrinsics.checkNotNull(mo207createOutlinePq9zytI);
        } else {
            mo207createOutlinePq9zytI = this.shape.mo207createOutlinePq9zytI(contentDrawScope.mo3171getSizeNHjbRc(), contentDrawScope.getLayoutDirection(), contentDrawScope);
        }
        if (!Color.m2629equalsimpl0(this.color, Color.Companion.m2664getUnspecified0d7_KjU())) {
            OutlineKt.m2880drawOutlinewDX37Ww(contentDrawScope, mo207createOutlinePq9zytI, this.color, (r17 & 4) != 0 ? 1.0f : 0.0f, (r17 & 8) != 0 ? Fill.INSTANCE : null, (r17 & 16) != 0 ? null : null, (r17 & 32) != 0 ? DrawScope.Companion.m3172getDefaultBlendMode0nO6VwU() : 0);
        }
        Brush brush = this.brush;
        if (brush != null) {
            OutlineKt.m2879drawOutlinehn5TExg$default(contentDrawScope, mo207createOutlinePq9zytI, brush, this.alpha, null, null, 0, 56, null);
        }
        this.lastOutline = mo207createOutlinePq9zytI;
        this.lastSize = Size.m2446boximpl(contentDrawScope.mo3171getSizeNHjbRc());
