...
public interface RippleTheme {
    ...
    long mo957defaultColorWaAFU9c(Composer composer, int i);
    ...
    public static final class Companion {
        ...
        public final long m967defaultRippleColor5vOe2sY(long j, boolean z) {
            return (z || ((double) ColorKt.m2680luminance8_81llA(j)) >= 0.5d) ? j : Color.Companion.m2665getWhite0d7_KjU();
        }

        /* renamed from: defaultRippleAlpha-DxMtmZc  reason: not valid java name */
        public final RippleAlpha m966defaultRippleAlphaDxMtmZc(long j, boolean z) {
            if (z) {
                if (ColorKt.m2680luminance8_81llA(j) > 0.5d) {
