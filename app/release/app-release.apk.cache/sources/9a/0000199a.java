...
public final class SpannableExtensions_androidKt {
    ...
    public static final void setTextIndent(Spannable spannable, TextIndent textIndent, float f, Density density) {
        float m5053getValueimpl;
        Intrinsics.checkNotNullParameter(spannable, "<this>");
        Intrinsics.checkNotNullParameter(density, "density");
        if (textIndent != null) {
            if ((TextUnit.m5050equalsimpl0(textIndent.m4788getFirstLineXSAIIZE(), TextUnitKt.getSp(0)) && TextUnit.m5050equalsimpl0(textIndent.m4789getRestLineXSAIIZE(), TextUnitKt.getSp(0))) || TextUnitKt.m5071isUnspecifiedR2X_6o(textIndent.m4788getFirstLineXSAIIZE()) || TextUnitKt.m5071isUnspecifiedR2X_6o(textIndent.m4789getRestLineXSAIIZE())) {
                return;
            }
            long m5052getTypeUIouoOA = TextUnit.m5052getTypeUIouoOA(textIndent.m4788getFirstLineXSAIIZE());
            float f2 = 0.0f;
            if (TextUnitType.m5081equalsimpl0(m5052getTypeUIouoOA, TextUnitType.Companion.m5086getSpUIouoOA())) {
                m5053getValueimpl = density.mo323toPxR2X_6o(textIndent.m4788getFirstLineXSAIIZE());
            } else {
                m5053getValueimpl = TextUnitType.m5081equalsimpl0(m5052getTypeUIouoOA, TextUnitType.Companion.m5085getEmUIouoOA()) ? TextUnit.m5053getValueimpl(textIndent.m4788getFirstLineXSAIIZE()) * f : 0.0f;
            }
            long m5052getTypeUIouoOA2 = TextUnit.m5052getTypeUIouoOA(textIndent.m4789getRestLineXSAIIZE());
            if (TextUnitType.m5081equalsimpl0(m5052getTypeUIouoOA2, TextUnitType.Companion.m5086getSpUIouoOA())) {
                f2 = density.mo323toPxR2X_6o(textIndent.m4789getRestLineXSAIIZE());
            } else if (TextUnitType.m5081equalsimpl0(m5052getTypeUIouoOA2, TextUnitType.Companion.m5085getEmUIouoOA())) {
                f2 = TextUnit.m5053getValueimpl(textIndent.m4789getRestLineXSAIIZE()) * f;
            }
            setSpan(spannable, new LeadingMarginSpan.Standard((int) Math.ceil(m5053getValueimpl), (int) Math.ceil(f2)), 0, spannable.length());
        }
    }

    /* renamed from: setLineHeight-KmRG4DE  reason: not valid java name */
    public static final void m4652setLineHeightKmRG4DE(Spannable setLineHeight, long j, float f, Density density, LineHeightStyle lineHeightStyle) {
        Intrinsics.checkNotNullParameter(setLineHeight, "$this$setLineHeight");
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(lineHeightStyle, "lineHeightStyle");
        float m4647resolveLineHeightInPxo2QH7mI = m4647resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(m4647resolveLineHeightInPxo2QH7mI)) {
            return;
        }
        Spannable spannable = setLineHeight;
        setSpan(setLineHeight, new LineHeightStyleSpan(m4647resolveLineHeightInPxo2QH7mI, 0, (spannable.length() == 0 || StringsKt.last(spannable) == '\n') ? setLineHeight.length() + 1 : setLineHeight.length(), LineHeightStyle.Trim.m4751isTrimFirstLineTopimpl$ui_text_release(lineHeightStyle.m4734getTrimEVpEnUU()), LineHeightStyle.Trim.m4752isTrimLastLineBottomimpl$ui_text_release(lineHeightStyle.m4734getTrimEVpEnUU()), lineHeightStyle.m4733getAlignmentPIaL0Z0()), 0, setLineHeight.length());
    }

    /* renamed from: setLineHeight-r9BaKPg  reason: not valid java name */
    public static final void m4653setLineHeightr9BaKPg(Spannable setLineHeight, long j, float f, Density density) {
        Intrinsics.checkNotNullParameter(setLineHeight, "$this$setLineHeight");
        Intrinsics.checkNotNullParameter(density, "density");
        float m4647resolveLineHeightInPxo2QH7mI = m4647resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(m4647resolveLineHeightInPxo2QH7mI)) {
        ...
        setSpan(setLineHeight, new LineHeightSpan(m4647resolveLineHeightInPxo2QH7mI), 0, setLineHeight.length());
    }

    /* renamed from: resolveLineHeightInPx-o2QH7mI  reason: not valid java name */
    private static final float m4647resolveLineHeightInPxo2QH7mI(long j, float f, Density density) {
        long m5052getTypeUIouoOA = TextUnit.m5052getTypeUIouoOA(j);
        if (TextUnitType.m5081equalsimpl0(m5052getTypeUIouoOA, TextUnitType.Companion.m5086getSpUIouoOA())) {
            return density.mo323toPxR2X_6o(j);
        }
        if (TextUnitType.m5081equalsimpl0(m5052getTypeUIouoOA, TextUnitType.Companion.m5085getEmUIouoOA())) {
            return TextUnit.m5053getValueimpl(j) * f;
        }
        return Float.NaN;
    }
    ...
    public static final void setSpanStyles(Spannable spannable, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> spanStyles, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> resolveTypeface) {
        MetricAffectingSpan m4646createLetterSpacingSpaneAf_CNQ;
        Intrinsics.checkNotNullParameter(spannable, "<this>");
        ...
        if (z) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (start2 >= 0 && start2 < spannable.length() && end2 > start2 && end2 <= spannable.length() && (m4646createLetterSpacingSpaneAf_CNQ = m4646createLetterSpacingSpaneAf_CNQ(item.m4366getLetterSpacingXSAIIZE(), density)) != null) {
                    setSpan(spannable, m4646createLetterSpacingSpaneAf_CNQ, start2, end2);
                }
            }
        }
    }
    ...
    private static final void setSpanStyle(Spannable spannable, AnnotatedString.Range<SpanStyle> range, Density density) {
        ...
        m4649setBaselineShift0ocSgnM(spannable, item.m4361getBaselineShift5SSeXJ0(), start, end);
        m4650setColorRPmYEkk(spannable, item.m4362getColor0d7_KjU(), start, end);
        setBrush(spannable, item.getBrush(), item.getAlpha(), start, end);
        setTextDecoration(spannable, item.getTextDecoration(), start, end);
        m4651setFontSizeKmRG4DE(spannable, item.m4363getFontSizeXSAIIZE(), density, start, end);
        ...
        m4648setBackgroundRPmYEkk(spannable, item.m4360getBackground0d7_KjU(), start, end);
    ...
    private static final MetricAffectingSpan m4646createLetterSpacingSpaneAf_CNQ(long j, Density density) {
        long m5052getTypeUIouoOA = TextUnit.m5052getTypeUIouoOA(j);
        if (TextUnitType.m5081equalsimpl0(m5052getTypeUIouoOA, TextUnitType.Companion.m5086getSpUIouoOA())) {
            return new LetterSpacingSpanPx(density.mo323toPxR2X_6o(j));
        }
        if (TextUnitType.m5081equalsimpl0(m5052getTypeUIouoOA, TextUnitType.Companion.m5085getEmUIouoOA())) {
            return new LetterSpacingSpanEm(TextUnit.m5053getValueimpl(j));
        }
        return null;
    }

    private static final boolean getNeedsLetterSpacingSpan(SpanStyle spanStyle) {
        return TextUnitType.m5081equalsimpl0(TextUnit.m5052getTypeUIouoOA(spanStyle.m4366getLetterSpacingXSAIIZE()), TextUnitType.Companion.m5086getSpUIouoOA()) || TextUnitType.m5081equalsimpl0(TextUnit.m5052getTypeUIouoOA(spanStyle.m4366getLetterSpacingXSAIIZE()), TextUnitType.Companion.m5085getEmUIouoOA());
    }

    private static final void setShadow(Spannable spannable, Shadow shadow, int i, int i2) {
        if (shadow != null) {
            setSpan(spannable, new ShadowSpan(ColorKt.m2682toArgb8_81llA(shadow.m2946getColor0d7_KjU()), Offset.m2389getXimpl(shadow.m2947getOffsetF1C5BW0()), Offset.m2390getYimpl(shadow.m2947getOffsetF1C5BW0()), TextPaintExtensions_androidKt.correctBlurRadius(shadow.getBlurRadius())), i, i2);
        }
    }
    ...
    public static final void m4651setFontSizeKmRG4DE(Spannable setFontSize, long j, Density density, int i, int i2) {
        Intrinsics.checkNotNullParameter(setFontSize, "$this$setFontSize");
        Intrinsics.checkNotNullParameter(density, "density");
        long m5052getTypeUIouoOA = TextUnit.m5052getTypeUIouoOA(j);
        if (TextUnitType.m5081equalsimpl0(m5052getTypeUIouoOA, TextUnitType.Companion.m5086getSpUIouoOA())) {
            setSpan(setFontSize, new AbsoluteSizeSpan(MathKt.roundToInt(density.mo323toPxR2X_6o(j)), false), i, i2);
        } else if (TextUnitType.m5081equalsimpl0(m5052getTypeUIouoOA, TextUnitType.Companion.m5085getEmUIouoOA())) {
            setSpan(setFontSize, new RelativeSizeSpan(TextUnit.m5053getValueimpl(j)), i, i2);
        }
    }
    ...
    private static final void m4649setBaselineShift0ocSgnM(Spannable spannable, BaselineShift baselineShift, int i, int i2) {
        if (baselineShift != null) {
            setSpan(spannable, new BaselineShiftSpan(baselineShift.m4665unboximpl()), i, i2);
        }
    }
    ...
    private static final void setBrush(Spannable spannable, Brush brush, float f, int i, int i2) {
        if (brush != null) {
            if (brush instanceof SolidColor) {
                m4650setColorRPmYEkk(spannable, ((SolidColor) brush).m2956getValue0d7_KjU(), i, i2);
    ...
    private static final boolean hasFontAttributes(TextStyle textStyle) {
        return TextPaintExtensions_androidKt.hasFontAttributes(textStyle.toSpanStyle()) || textStyle.m4427getFontSynthesisZQGJjVo() != null;
    }
    ...
    private static final void setFontAttributes(final Spannable spannable, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, final Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (TextPaintExtensions_androidKt.hasFontAttributes(range2.getItem()) || range2.getItem().m4365getFontSynthesisZQGJjVo() != null) {
                arrayList.add(range);
            }
        }
        ArrayList arrayList2 = arrayList;
        flattenFontStylesAndApply(hasFontAttributes(textStyle) ? new SpanStyle(0L, 0L, textStyle.getFontWeight(), textStyle.m4426getFontStyle4Lr2A7w(), textStyle.m4427getFontSynthesisZQGJjVo(), textStyle.getFontFamily(), (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65475, (DefaultConstructorMarker) null) : null, arrayList2, new Function3<SpanStyle, Integer, Integer, Unit>() { // from class: androidx.compose.ui.text.platform.extensions.SpannableExtensions_androidKt$setFontAttributes$1
            ...
            public final void invoke(SpanStyle spanStyle, int i2, int i3) {
                ...
                FontStyle m4364getFontStyle4Lr2A7w = spanStyle.m4364getFontStyle4Lr2A7w();
                ...
                FontSynthesis m4365getFontSynthesisZQGJjVo = spanStyle.m4365getFontSynthesisZQGJjVo();
                spannable2.setSpan(new TypefaceSpan(function42.invoke(fontFamily, fontWeight, m4496boximpl, FontSynthesis.m4505boximpl(m4365getFontSynthesisZQGJjVo != null ? m4365getFontSynthesisZQGJjVo.m4513unboximpl() : FontSynthesis.Companion.m4514getAllGVVA2EU()))), i2, i3, 33);
            }
        });
    }

    /* renamed from: setBackground-RPmYEkk  reason: not valid java name */
    public static final void m4648setBackgroundRPmYEkk(Spannable setBackground, long j, int i, int i2) {
        Intrinsics.checkNotNullParameter(setBackground, "$this$setBackground");
        if (j != Color.Companion.m2664getUnspecified0d7_KjU()) {
            setSpan(setBackground, new BackgroundColorSpan(ColorKt.m2682toArgb8_81llA(j)), i, i2);
        }
    }

    /* renamed from: setColor-RPmYEkk  reason: not valid java name */
    public static final void m4650setColorRPmYEkk(Spannable setColor, long j, int i, int i2) {
        Intrinsics.checkNotNullParameter(setColor, "$this$setColor");
        if (j != Color.Companion.m2664getUnspecified0d7_KjU()) {
            setSpan(setColor, new ForegroundColorSpan(ColorKt.m2682toArgb8_81llA(j)), i, i2);
        }
    }
}