...
abstract class AbstractClickableNode extends DelegatingNode implements PointerInputModifierNode, KeyInputModifierNode {
    ...
    public static final class InteractionData {
        ...
        private long centreOffset = Offset.Companion.m2405getZeroF1C5BW0();

        /* renamed from: getCentreOffset-F1C5BW0  reason: not valid java name */
        public final long m144getCentreOffsetF1C5BW0() {
        ...
        public final void m145setCentreOffsetk4lQ0M(long j) {
            this.centreOffset = j;
        }
    ...
    public boolean mo142onPreKeyEventZmokQxo(KeyEvent event) {
    ...
    public static /* synthetic */ void m139updateCommonXHw0xAI$default(AbstractClickableNode abstractClickableNode, MutableInteractionSource mutableInteractionSource, boolean z, String str, Role role, Function0 function0, int i, Object obj) {
        if (obj != null) {
        ...
        abstractClickableNode.m143updateCommonXHw0xAI(mutableInteractionSource, z, str, role, function0);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    /* renamed from: updateCommon-XHw0xAI  reason: not valid java name */
    public final void m143updateCommonXHw0xAI(MutableInteractionSource interactionSource, boolean z, String str, Role role, Function0<Unit> onClick) {
        Intrinsics.checkNotNullParameter(interactionSource, "interactionSource");
        Intrinsics.checkNotNullParameter(onClick, "onClick");
    ...
    public void mo141onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long j) {
        Intrinsics.checkNotNullParameter(pointerEvent, "pointerEvent");
        Intrinsics.checkNotNullParameter(pass, "pass");
        getClickablePointerInputNode().mo141onPointerEventH0pRuoY(pointerEvent, pass, j);
    }
    ...
    public boolean mo140onKeyEventZmokQxo(KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, "event");
        if (this.enabled && Clickable_androidKt.m206isPressZmokQxo(event)) {
            if (!this.interactionData.getCurrentKeyPressInteractions().containsKey(Key.m3303boximpl(KeyEvent_androidKt.m3614getKeyZmokQxo(event)))) {
                PressInteraction.Press press = new PressInteraction.Press(this.interactionData.m144getCentreOffsetF1C5BW0(), null);
                this.interactionData.getCurrentKeyPressInteractions().put(Key.m3303boximpl(KeyEvent_androidKt.m3614getKeyZmokQxo(event)), press);
        ...
        } else if (this.enabled && Clickable_androidKt.m204isClickZmokQxo(event)) {
            PressInteraction.Press remove = this.interactionData.getCurrentKeyPressInteractions().remove(Key.m3303boximpl(KeyEvent_androidKt.m3614getKeyZmokQxo(event)));
            if (remove != null) {
