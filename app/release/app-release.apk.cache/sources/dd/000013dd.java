...
public final class RenderIntent {
    ...
    private static final int Perceptual = m3047constructorimpl(0);
    private static final int Relative = m3047constructorimpl(1);
    private static final int Saturation = m3047constructorimpl(2);
    private static final int Absolute = m3047constructorimpl(3);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ RenderIntent m3046boximpl(int i) {
        return new RenderIntent(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m3047constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m3048equalsimpl(int i, Object obj) {
        return (obj instanceof RenderIntent) && i == ((RenderIntent) obj).m3052unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m3049equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m3050hashCodeimpl(int i) {
    ...
    public final /* synthetic */ int m3052unboximpl() {
        return this.value;
    }
    ...
    public String toString() {
        return m3051toStringimpl(this.value);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m3051toStringimpl(int i) {
        return m3049equalsimpl0(i, Perceptual) ? "Perceptual" : m3049equalsimpl0(i, Relative) ? "Relative" : m3049equalsimpl0(i, Saturation) ? "Saturation" : m3049equalsimpl0(i, Absolute) ? "Absolute" : "Unknown";
    }
}