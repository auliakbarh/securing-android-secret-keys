...
public final class ClipScrollableContainerKt {
    private static final float MaxSupportedElevation = Dp.m4872constructorimpl(30);
    private static final Modifier HorizontalScrollableClipModifier = ClipKt.clip(Modifier.Companion, new Shape() { // from class: androidx.compose.foundation.ClipScrollableContainerKt$HorizontalScrollableClipModifier$1
        ...
        public Outline mo207createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
            ...
            float mo318roundToPx0680j_4 = density.mo318roundToPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
            return new Outline.Rectangle(new Rect(0.0f, -mo318roundToPx0680j_4, Size.m2458getWidthimpl(j), Size.m2455getHeightimpl(j) + mo318roundToPx0680j_4));
        }
    });
    private static final Modifier VerticalScrollableClipModifier = ClipKt.clip(Modifier.Companion, new Shape() { // from class: androidx.compose.foundation.ClipScrollableContainerKt$VerticalScrollableClipModifier$1
        ...
        public Outline mo207createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
            ...
            Intrinsics.checkNotNullParameter(density, "density");
            float mo318roundToPx0680j_4 = density.mo318roundToPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
            return new Outline.Rectangle(new Rect(-mo318roundToPx0680j_4, 0.0f, Size.m2458getWidthimpl(j) + mo318roundToPx0680j_4, Size.m2455getHeightimpl(j)));
        }
    });
