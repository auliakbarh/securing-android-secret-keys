...
public final class TransitionKt {
    public static final <S> State<Color> animateColor(Transition<S> transition, Function3<? super Transition.Segment<S>, ? super Composer, ? super Integer, ? extends FiniteAnimationSpec<Color>> function3, String str, Function3<? super S, ? super Composer, ? super Integer, Color> targetValueByState, Composer composer, int i, int i2) {
        ...
        String str2 = str;
        ColorSpace m2632getColorSpaceimpl = Color.m2632getColorSpaceimpl(targetValueByState.invoke(transition.getTargetState(), composer, Integer.valueOf((i >> 6) & 112)).m2638unboximpl());
        composer.startReplaceableGroup(1157296644);
        ComposerKt.sourceInformation(composer, "CC(remember)P(1):Composables.kt#9igjgp");
        boolean changed = composer.changed(m2632getColorSpaceimpl);
    ...
    public static final State<Color> m77animateColorDTcfvLk(InfiniteTransition animateColor, long j, long j2, InfiniteRepeatableSpec<Color> animationSpec, String str, Composer composer, int i, int i2) {
        ...
        if (rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = ColorVectorConverterKt.getVectorConverter(Color.Companion).invoke(Color.m2632getColorSpaceimpl(j2));
            composer.updateRememberedValue(rememberedValue);
        }
        composer.endReplaceableGroup();
        int i3 = i << 3;
        State<Color> animateValue = InfiniteTransitionKt.animateValue(animateColor, Color.m2618boximpl(j), Color.m2618boximpl(j2), (TwoWayConverter) rememberedValue, animationSpec, str2, composer, InfiniteTransition.$stable | 4096 | (i & 14) | (i & 112) | (i & 896) | (InfiniteRepeatableSpec.$stable << 12) | (57344 & i3) | (i3 & 458752), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State m78animateColorRIQooxk(InfiniteTransition animateColor, long j, long j2, InfiniteRepeatableSpec animationSpec, Composer composer, int i) {
        Intrinsics.checkNotNullParameter(animateColor, "$this$animateColor");
        Intrinsics.checkNotNullParameter(animationSpec, "animationSpec");
        ...
        State<Color> m77animateColorDTcfvLk = m77animateColorDTcfvLk(animateColor, j, j2, animationSpec, "ColorAnimation", composer, InfiniteTransition.$stable | 24576 | (i & 14) | (i & 112) | (i & 896) | (InfiniteRepeatableSpec.$stable << 9) | (i & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m77animateColorDTcfvLk;
    }
}