            ...
            if (!FontLoadingStrategy.m4486equalsimpl0(mo4446getLoadingStrategyPKNRLFQ, FontLoadingStrategy.Companion.m4491getBlockingPKNRLFQ())) {
                if (!FontLoadingStrategy.m4486equalsimpl0(mo4446getLoadingStrategyPKNRLFQ, FontLoadingStrategy.Companion.m4492getOptionalLocalPKNRLFQ())) {
                    ...
                    synchronized (asyncTypefaceCache.cacheLock) {
                        ...
                        if (asyncTypefaceResult != null) {
                            m5158constructorimpl = asyncTypefaceResult.m4463unboximpl();
                        } else {
                            Unit unit = Unit.INSTANCE;
                            try {
                                Result.Companion companion = Result.Companion;
                                m5158constructorimpl = Result.m5158constructorimpl(platformFontLoader.loadBlocking(font));
                            } catch (Throwable th) {
                            ...
                            AsyncTypefaceCache.put$default(asyncTypefaceCache, font, platformFontLoader, m5158constructorimpl, false, 8, null);
                        }
                    }
                    if (m5158constructorimpl != null) {
                        return TuplesKt.to(list2, FontSynthesis_androidKt.m4518synthesizeTypefaceFxwP2eA(typefaceRequest.m4543getFontSynthesisGVVA2EU(), m5158constructorimpl, font, typefaceRequest.getFontWeight(), typefaceRequest.m4542getFontStyle_LCdwA()));
                    }
                }
            } else {
                synchronized (asyncTypefaceCache.cacheLock) {
