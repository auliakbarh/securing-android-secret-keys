...
public final class RoundRectKt {
    ...
    public static final RoundRect m2443RoundRectgG7oq9Y(float f, float f2, float f3, float f4, long j) {
        return RoundRect(f, f2, f3, f4, CornerRadius.m2364getXimpl(j), CornerRadius.m2365getYimpl(j));
    }
    ...
    public static final RoundRect m2444RoundRectsniSvfs(Rect rect, long j) {
        Intrinsics.checkNotNullParameter(rect, "rect");
        return RoundRect(rect, CornerRadius.m2364getXimpl(j), CornerRadius.m2365getYimpl(j));
    }

    /* renamed from: RoundRect-ZAM2FJo  reason: not valid java name */
    public static final RoundRect m2441RoundRectZAM2FJo(Rect rect, long j, long j2, long j3, long j4) {
        Intrinsics.checkNotNullParameter(rect, "rect");
        return new RoundRect(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), j, j2, j3, j4, null);
    }

    /* renamed from: translate-Uv8p0NA  reason: not valid java name */
    public static final RoundRect m2445translateUv8p0NA(RoundRect translate, long j) {
        Intrinsics.checkNotNullParameter(translate, "$this$translate");
        return new RoundRect(translate.getLeft() + Offset.m2389getXimpl(j), translate.getTop() + Offset.m2390getYimpl(j), translate.getRight() + Offset.m2389getXimpl(j), translate.getBottom() + Offset.m2390getYimpl(j), translate.m2439getTopLeftCornerRadiuskKHJgLs(), translate.m2440getTopRightCornerRadiuskKHJgLs(), translate.m2438getBottomRightCornerRadiuskKHJgLs(), translate.m2437getBottomLeftCornerRadiuskKHJgLs(), null);
    }
    ...
    public static final Rect getSafeInnerRect(RoundRect roundRect) {
        Intrinsics.checkNotNullParameter(roundRect, "<this>");
        return new Rect(roundRect.getLeft() + (Math.max(CornerRadius.m2364getXimpl(roundRect.m2437getBottomLeftCornerRadiuskKHJgLs()), CornerRadius.m2364getXimpl(roundRect.m2439getTopLeftCornerRadiuskKHJgLs())) * 0.29289323f), roundRect.getTop() + (Math.max(CornerRadius.m2365getYimpl(roundRect.m2439getTopLeftCornerRadiuskKHJgLs()), CornerRadius.m2365getYimpl(roundRect.m2440getTopRightCornerRadiuskKHJgLs())) * 0.29289323f), roundRect.getRight() - (Math.max(CornerRadius.m2364getXimpl(roundRect.m2440getTopRightCornerRadiuskKHJgLs()), CornerRadius.m2364getXimpl(roundRect.m2438getBottomRightCornerRadiuskKHJgLs())) * 0.29289323f), roundRect.getBottom() - (Math.max(CornerRadius.m2365getYimpl(roundRect.m2438getBottomRightCornerRadiuskKHJgLs()), CornerRadius.m2365getYimpl(roundRect.m2437getBottomLeftCornerRadiuskKHJgLs())) * 0.29289323f));
    }
    ...
    public static final boolean isRect(RoundRect roundRect) {
        Intrinsics.checkNotNullParameter(roundRect, "<this>");
        return (CornerRadius.m2364getXimpl(roundRect.m2439getTopLeftCornerRadiuskKHJgLs()) == 0.0f || CornerRadius.m2365getYimpl(roundRect.m2439getTopLeftCornerRadiuskKHJgLs()) == 0.0f) && (CornerRadius.m2364getXimpl(roundRect.m2440getTopRightCornerRadiuskKHJgLs()) == 0.0f || CornerRadius.m2365getYimpl(roundRect.m2440getTopRightCornerRadiuskKHJgLs()) == 0.0f) && ((CornerRadius.m2364getXimpl(roundRect.m2437getBottomLeftCornerRadiuskKHJgLs()) == 0.0f || CornerRadius.m2365getYimpl(roundRect.m2437getBottomLeftCornerRadiuskKHJgLs()) == 0.0f) && (CornerRadius.m2364getXimpl(roundRect.m2438getBottomRightCornerRadiuskKHJgLs()) == 0.0f || CornerRadius.m2365getYimpl(roundRect.m2438getBottomRightCornerRadiuskKHJgLs()) == 0.0f));
    }

    public static final boolean isEllipse(RoundRect roundRect) {
        Intrinsics.checkNotNullParameter(roundRect, "<this>");
        return CornerRadius.m2364getXimpl(roundRect.m2439getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m2364getXimpl(roundRect.m2440getTopRightCornerRadiuskKHJgLs()) && CornerRadius.m2365getYimpl(roundRect.m2439getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m2365getYimpl(roundRect.m2440getTopRightCornerRadiuskKHJgLs()) && CornerRadius.m2364getXimpl(roundRect.m2440getTopRightCornerRadiuskKHJgLs()) == CornerRadius.m2364getXimpl(roundRect.m2438getBottomRightCornerRadiuskKHJgLs()) && CornerRadius.m2365getYimpl(roundRect.m2440getTopRightCornerRadiuskKHJgLs()) == CornerRadius.m2365getYimpl(roundRect.m2438getBottomRightCornerRadiuskKHJgLs()) && CornerRadius.m2364getXimpl(roundRect.m2438getBottomRightCornerRadiuskKHJgLs()) == CornerRadius.m2364getXimpl(roundRect.m2437getBottomLeftCornerRadiuskKHJgLs()) && CornerRadius.m2365getYimpl(roundRect.m2438getBottomRightCornerRadiuskKHJgLs()) == CornerRadius.m2365getYimpl(roundRect.m2437getBottomLeftCornerRadiuskKHJgLs()) && ((double) roundRect.getWidth()) <= ((double) CornerRadius.m2364getXimpl(roundRect.m2439getTopLeftCornerRadiuskKHJgLs())) * 2.0d && ((double) roundRect.getHeight()) <= ((double) CornerRadius.m2365getYimpl(roundRect.m2439getTopLeftCornerRadiuskKHJgLs())) * 2.0d;
    }
    ...
    public static final boolean isSimple(RoundRect roundRect) {
        Intrinsics.checkNotNullParameter(roundRect, "<this>");
        return CornerRadius.m2364getXimpl(roundRect.m2439getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m2365getYimpl(roundRect.m2439getTopLeftCornerRadiuskKHJgLs()) && CornerRadius.m2364getXimpl(roundRect.m2439getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m2364getXimpl(roundRect.m2440getTopRightCornerRadiuskKHJgLs()) && CornerRadius.m2364getXimpl(roundRect.m2439getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m2365getYimpl(roundRect.m2440getTopRightCornerRadiuskKHJgLs()) && CornerRadius.m2364getXimpl(roundRect.m2439getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m2364getXimpl(roundRect.m2438getBottomRightCornerRadiuskKHJgLs()) && CornerRadius.m2364getXimpl(roundRect.m2439getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m2365getYimpl(roundRect.m2438getBottomRightCornerRadiuskKHJgLs()) && CornerRadius.m2364getXimpl(roundRect.m2439getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m2364getXimpl(roundRect.m2437getBottomLeftCornerRadiuskKHJgLs()) && CornerRadius.m2364getXimpl(roundRect.m2439getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m2365getYimpl(roundRect.m2437getBottomLeftCornerRadiuskKHJgLs());
    }

    public static final RoundRect lerp(RoundRect start, RoundRect stop, float f) {
        Intrinsics.checkNotNullParameter(start, "start");
        Intrinsics.checkNotNullParameter(stop, "stop");
        return new RoundRect(MathHelpersKt.lerp(start.getLeft(), stop.getLeft(), f), MathHelpersKt.lerp(start.getTop(), stop.getTop(), f), MathHelpersKt.lerp(start.getRight(), stop.getRight(), f), MathHelpersKt.lerp(start.getBottom(), stop.getBottom(), f), CornerRadiusKt.m2375lerp3Ry4LBc(start.m2439getTopLeftCornerRadiuskKHJgLs(), stop.m2439getTopLeftCornerRadiuskKHJgLs(), f), CornerRadiusKt.m2375lerp3Ry4LBc(start.m2440getTopRightCornerRadiuskKHJgLs(), stop.m2440getTopRightCornerRadiuskKHJgLs(), f), CornerRadiusKt.m2375lerp3Ry4LBc(start.m2438getBottomRightCornerRadiuskKHJgLs(), stop.m2438getBottomRightCornerRadiuskKHJgLs(), f), CornerRadiusKt.m2375lerp3Ry4LBc(start.m2437getBottomLeftCornerRadiuskKHJgLs(), stop.m2437getBottomLeftCornerRadiuskKHJgLs(), f), null);
    }
}