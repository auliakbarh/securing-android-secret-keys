...
public final class KeyboardOptions {
    ...
    public final int m763getCapitalizationIUNYP9k() {
        return this.capitalization;
    }

    /* renamed from: getImeAction-eUduSuo  reason: not valid java name */
    public final int m764getImeActioneUduSuo() {
        return this.imeAction;
    }

    /* renamed from: getKeyboardType-PjHm6EE  reason: not valid java name */
    public final int m765getKeyboardTypePjHm6EE() {
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.Companion.m4589getNoneIUNYP9k() : i, (i4 & 2) != 0 ? true : z, (i4 & 4) != 0 ? KeyboardType.Companion.m4615getTextPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.Companion.m4562getDefaulteUduSuo() : i3, null);
    }
    ...
    public static /* synthetic */ KeyboardOptions m761copy3m2b7yw$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
        ...
        return keyboardOptions.m762copy3m2b7yw(i, z, i2, i3);
    }

    /* renamed from: copy-3m2b7yw  reason: not valid java name */
    public final KeyboardOptions m762copy3m2b7yw(int i, boolean z, int i2, int i3) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof KeyboardOptions) {
            ...
            return KeyboardCapitalization.m4580equalsimpl0(this.capitalization, keyboardOptions.capitalization) && this.autoCorrect == keyboardOptions.autoCorrect && KeyboardType.m4595equalsimpl0(this.keyboardType, keyboardOptions.keyboardType) && ImeAction.m4550equalsimpl0(this.imeAction, keyboardOptions.imeAction);
        }
        return false;
    }

    public int hashCode() {
        return (((((KeyboardCapitalization.m4581hashCodeimpl(this.capitalization) * 31) + Boolean.hashCode(this.autoCorrect)) * 31) + KeyboardType.m4596hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m4551hashCodeimpl(this.imeAction);
    }

    public String toString() {
        return "KeyboardOptions(capitalization=" + ((Object) KeyboardCapitalization.m4582toStringimpl(this.capitalization)) + ", autoCorrect=" + this.autoCorrect + ", keyboardType=" + ((Object) KeyboardType.m4597toStringimpl(this.keyboardType)) + ", imeAction=" + ((Object) ImeAction.m4552toStringimpl(this.imeAction)) + ')';
    }
}