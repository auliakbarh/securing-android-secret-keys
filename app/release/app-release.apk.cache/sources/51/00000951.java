...
public final class TextFieldSelectionManager {
    ...
    public TextFieldSelectionManager(UndoManager undoManager) {
        ...
        this.dragBeginPosition = Offset.Companion.m2405getZeroF1C5BW0();
        this.dragTotalDistance = Offset.Companion.m2405getZeroF1C5BW0();
        ...
        this.touchSelectionObserver = new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$touchSelectionObserver$1
            ...
            public void mo800onDownk4lQ0M(long j) {
            }
            ...
            public void mo802onStartk4lQ0M(long j) {
                TextFieldState state$foundation_release;
                TextLayoutResultProxy layoutResult;
                TextFieldValue m939createTextFieldValueFDrldGo;
                long j2;
                ...
                if ((state$foundation_release2 == null || (layoutResult3 = state$foundation_release2.getLayoutResult()) == null || !layoutResult3.m835isPositionOnTextk4lQ0M(j)) && (state$foundation_release = TextFieldSelectionManager.this.getState$foundation_release()) != null && (layoutResult = state$foundation_release.getLayoutResult()) != null) {
                    TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                    int transformedToOriginal = textFieldSelectionManager.getOffsetMapping$foundation_release().transformedToOriginal(TextLayoutResultProxy.getLineEnd$default(layoutResult, layoutResult.getLineForVerticalPosition(Offset.m2390getYimpl(j)), false, 2, null));
                    HapticFeedback hapticFeedBack = textFieldSelectionManager.getHapticFeedBack();
                    if (hapticFeedBack != null) {
                        hapticFeedBack.mo3277performHapticFeedbackCdsT49E(HapticFeedbackType.Companion.m3286getTextHandleMove5zf0vsI());
                    }
                    m939createTextFieldValueFDrldGo = textFieldSelectionManager.m939createTextFieldValueFDrldGo(textFieldSelectionManager.getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(transformedToOriginal, transformedToOriginal));
                    textFieldSelectionManager.enterSelectionMode$foundation_release();
                    textFieldSelectionManager.getOnValueChange$foundation_release().invoke(m939createTextFieldValueFDrldGo);
                    ...
                    if (state$foundation_release3 != null && (layoutResult2 = state$foundation_release3.getLayoutResult()) != null) {
                        ...
                        int m832getOffsetForPosition3MmeM6k$default = TextLayoutResultProxy.m832getOffsetForPosition3MmeM6k$default(layoutResult2, j, false, 2, null);
                        textFieldSelectionManager2.updateSelection(textFieldSelectionManager2.getValue$foundation_release(), m832getOffsetForPosition3MmeM6k$default, m832getOffsetForPosition3MmeM6k$default, false, SelectionAdjustment.Companion.getWord());
                        textFieldSelectionManager2.dragBeginOffsetInText = Integer.valueOf(m832getOffsetForPosition3MmeM6k$default);
                    }
                    TextFieldSelectionManager.this.dragBeginPosition = j;
                    TextFieldSelectionManager textFieldSelectionManager3 = TextFieldSelectionManager.this;
                    j2 = textFieldSelectionManager3.dragBeginPosition;
                    textFieldSelectionManager3.m941setCurrentDragPosition_kEHs6E(Offset.m2378boximpl(j2));
                    TextFieldSelectionManager.this.dragTotalDistance = Offset.Companion.m2405getZeroF1C5BW0();
                }
            }

            @Override // androidx.compose.foundation.text.TextDragObserver
            /* renamed from: onDrag-k-4lQ0M */
            public void mo801onDragk4lQ0M(long j) {
                long j2;
                TextLayoutResultProxy layoutResult;
                long j3;
                long j4;
                Integer num;
                long j5;
                int m834getOffsetForPosition3MmeM6k;
                ...
                textFieldSelectionManager.dragTotalDistance = Offset.m2394plusMKHz9U(j2, j);
                ...
                if (state$foundation_release != null && (layoutResult = state$foundation_release.getLayoutResult()) != null) {
                    ...
                    textFieldSelectionManager2.m941setCurrentDragPosition_kEHs6E(Offset.m2378boximpl(Offset.m2394plusMKHz9U(j3, j4)));
                    num = textFieldSelectionManager2.dragBeginOffsetInText;
                    if (num != null) {
                        m834getOffsetForPosition3MmeM6k = num.intValue();
                    } else {
                        j5 = textFieldSelectionManager2.dragBeginPosition;
                        m834getOffsetForPosition3MmeM6k = layoutResult.m834getOffsetForPosition3MmeM6k(j5, false);
                    }
                    int i = m834getOffsetForPosition3MmeM6k;
                    Offset m944getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m944getCurrentDragPosition_m7T9E();
                    Intrinsics.checkNotNull(m944getCurrentDragPosition_m7T9E);
                    textFieldSelectionManager2.updateSelection(textFieldSelectionManager2.getValue$foundation_release(), i, layoutResult.m834getOffsetForPosition3MmeM6k(m944getCurrentDragPosition_m7T9E.m2399unboximpl(), false), false, SelectionAdjustment.Companion.getWord());
                }
                TextFieldState state$foundation_release2 = TextFieldSelectionManager.this.getState$foundation_release();
            ...
            public void onStop() {
                ...
                TextFieldSelectionManager.this.m941setCurrentDragPosition_kEHs6E(null);
                TextFieldState state$foundation_release = TextFieldSelectionManager.this.getState$foundation_release();
        ...
        this.mouseSelectionObserver = new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$mouseSelectionObserver$1
            ...
            public boolean mo862onExtendk4lQ0M(long j) {
                TextLayoutResultProxy layoutResult;
                TextFieldState state$foundation_release = TextFieldSelectionManager.this.getState$foundation_release();
                if (state$foundation_release == null || (layoutResult = state$foundation_release.getLayoutResult()) == null) {
                    return false;
                ...
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                textFieldSelectionManager.updateSelection(textFieldSelectionManager.getValue$foundation_release(), textFieldSelectionManager.getOffsetMapping$foundation_release().originalToTransformed(TextRange.m4403getStartimpl(textFieldSelectionManager.getValue$foundation_release().m4622getSelectiond9O1mEE())), TextLayoutResultProxy.m832getOffsetForPosition3MmeM6k$default(layoutResult, j, false, 2, null), false, SelectionAdjustment.Companion.getNone());
                return true;
            }

            @Override // androidx.compose.foundation.text.selection.MouseSelectionObserver
            /* renamed from: onExtendDrag-k-4lQ0M */
            public boolean mo863onExtendDragk4lQ0M(long j) {
                TextFieldState state$foundation_release;
                TextLayoutResultProxy layoutResult;
                ...
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                textFieldSelectionManager.updateSelection(textFieldSelectionManager.getValue$foundation_release(), textFieldSelectionManager.getOffsetMapping$foundation_release().originalToTransformed(TextRange.m4403getStartimpl(textFieldSelectionManager.getValue$foundation_release().m4622getSelectiond9O1mEE())), layoutResult.m834getOffsetForPosition3MmeM6k(j, false), false, SelectionAdjustment.Companion.getNone());
                return true;
            }

            @Override // androidx.compose.foundation.text.selection.MouseSelectionObserver
            /* renamed from: onStart-3MmeM6k */
            public boolean mo864onStart3MmeM6k(long j, SelectionAdjustment adjustment) {
                TextLayoutResultProxy layoutResult;
                long j2;
                ...
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                textFieldSelectionManager.dragBeginOffsetInText = Integer.valueOf(TextLayoutResultProxy.m832getOffsetForPosition3MmeM6k$default(layoutResult, j, false, 2, null));
                j2 = textFieldSelectionManager.dragBeginPosition;
                int m832getOffsetForPosition3MmeM6k$default = TextLayoutResultProxy.m832getOffsetForPosition3MmeM6k$default(layoutResult, j2, false, 2, null);
                textFieldSelectionManager.updateSelection(textFieldSelectionManager.getValue$foundation_release(), m832getOffsetForPosition3MmeM6k$default, m832getOffsetForPosition3MmeM6k$default, false, adjustment);
                return true;
            }

            @Override // androidx.compose.foundation.text.selection.MouseSelectionObserver
            /* renamed from: onDrag-3MmeM6k */
            public boolean mo861onDrag3MmeM6k(long j, SelectionAdjustment adjustment) {
                TextFieldState state$foundation_release;
                TextLayoutResultProxy layoutResult;
                Integer num;
                Intrinsics.checkNotNullParameter(adjustment, "adjustment");
                ...
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                int m834getOffsetForPosition3MmeM6k = layoutResult.m834getOffsetForPosition3MmeM6k(j, false);
                ...
                textFieldSelectionManager.updateSelection(value$foundation_release, num.intValue(), m834getOffsetForPosition3MmeM6k, false, adjustment);
                return true;
            }
        };
    }
    ...
    public final Offset m944getCurrentDragPosition_m7T9E() {
    ...
    public final TextDragObserver handleDragObserver$foundation_release(final boolean z) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$handleDragObserver$1
            ...
            public void mo800onDownk4lQ0M(long j) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                textFieldSelectionManager.m941setCurrentDragPosition_kEHs6E(Offset.m2378boximpl(SelectionHandlesKt.m893getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m946getHandlePositiontuRUvjQ$foundation_release(z))));
            }
            ...
            public void mo802onStartk4lQ0M(long j) {
                long j2;
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                textFieldSelectionManager.dragBeginPosition = SelectionHandlesKt.m893getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m946getHandlePositiontuRUvjQ$foundation_release(z));
                TextFieldSelectionManager textFieldSelectionManager2 = TextFieldSelectionManager.this;
                j2 = textFieldSelectionManager2.dragBeginPosition;
                textFieldSelectionManager2.m941setCurrentDragPosition_kEHs6E(Offset.m2378boximpl(j2));
                TextFieldSelectionManager.this.dragTotalDistance = Offset.Companion.m2405getZeroF1C5BW0();
                TextFieldSelectionManager.this.setDraggingHandle(z ? Handle.SelectionStart : Handle.SelectionEnd);
                TextFieldState state$foundation_release = TextFieldSelectionManager.this.getState$foundation_release();
                if (state$foundation_release == null) {
            ...
            public void mo801onDragk4lQ0M(long j) {
                ...
                int m4375getOffsetForPositionk4lQ0M;
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                j2 = textFieldSelectionManager.dragTotalDistance;
                textFieldSelectionManager.dragTotalDistance = Offset.m2394plusMKHz9U(j2, j);
                TextFieldState state$foundation_release = TextFieldSelectionManager.this.getState$foundation_release();
                if (state$foundation_release != null && (layoutResult = state$foundation_release.getLayoutResult()) != null && (value = layoutResult.getValue()) != null) {
                    ...
                    if (z2) {
                        Offset m944getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m944getCurrentDragPosition_m7T9E();
                        Intrinsics.checkNotNull(m944getCurrentDragPosition_m7T9E);
                        originalToTransformed = value.m4375getOffsetForPositionk4lQ0M(m944getCurrentDragPosition_m7T9E.m2399unboximpl());
                    } else {
                        originalToTransformed = textFieldSelectionManager2.getOffsetMapping$foundation_release().originalToTransformed(TextRange.m4403getStartimpl(textFieldSelectionManager2.getValue$foundation_release().m4622getSelectiond9O1mEE()));
                    }
                    int i = originalToTransformed;
                    if (z2) {
                        m4375getOffsetForPositionk4lQ0M = textFieldSelectionManager2.getOffsetMapping$foundation_release().originalToTransformed(TextRange.m4398getEndimpl(textFieldSelectionManager2.getValue$foundation_release().m4622getSelectiond9O1mEE()));
                    } else {
                        Offset m944getCurrentDragPosition_m7T9E2 = textFieldSelectionManager2.m944getCurrentDragPosition_m7T9E();
                        Intrinsics.checkNotNull(m944getCurrentDragPosition_m7T9E2);
                        m4375getOffsetForPositionk4lQ0M = value.m4375getOffsetForPositionk4lQ0M(m944getCurrentDragPosition_m7T9E2.m2399unboximpl());
                    }
                    textFieldSelectionManager2.updateSelection(textFieldSelectionManager2.getValue$foundation_release(), i, m4375getOffsetForPositionk4lQ0M, z2, SelectionAdjustment.Companion.getCharacter());
                }
                TextFieldState state$foundation_release2 = TextFieldSelectionManager.this.getState$foundation_release();
                if (state$foundation_release2 == null) {
                    return;
    ...
    public final TextDragObserver cursorDragObserver$foundation_release() {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$cursorDragObserver$1
            ...
            public void mo800onDownk4lQ0M(long j) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                textFieldSelectionManager.m941setCurrentDragPosition_kEHs6E(Offset.m2378boximpl(SelectionHandlesKt.m893getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m946getHandlePositiontuRUvjQ$foundation_release(true))));
            }
            ...
            public void mo802onStartk4lQ0M(long j) {
                long j2;
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                textFieldSelectionManager.dragBeginPosition = SelectionHandlesKt.m893getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m946getHandlePositiontuRUvjQ$foundation_release(true));
                TextFieldSelectionManager textFieldSelectionManager2 = TextFieldSelectionManager.this;
                j2 = textFieldSelectionManager2.dragBeginPosition;
                textFieldSelectionManager2.m941setCurrentDragPosition_kEHs6E(Offset.m2378boximpl(j2));
                TextFieldSelectionManager.this.dragTotalDistance = Offset.Companion.m2405getZeroF1C5BW0();
            ...
            public void mo801onDragk4lQ0M(long j) {
                ...
                Offset m944getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m944getCurrentDragPosition_m7T9E();
                Intrinsics.checkNotNull(m944getCurrentDragPosition_m7T9E);
                int transformedToOriginal = offsetMapping$foundation_release.transformedToOriginal(value.m4375getOffsetForPositionk4lQ0M(m944getCurrentDragPosition_m7T9E.m2399unboximpl()));
                long TextRange = TextRangeKt.TextRange(transformedToOriginal, transformedToOriginal);
                if (TextRange.m4396equalsimpl0(TextRange, textFieldSelectionManager2.getValue$foundation_release().m4622getSelectiond9O1mEE())) {
                    return;
                }
                ...
                m939createTextFieldValueFDrldGo = textFieldSelectionManager2.m939createTextFieldValueFDrldGo(textFieldSelectionManager2.getValue$foundation_release().getAnnotatedString(), TextRange);
                onValueChange$foundation_release.invoke(m939createTextFieldValueFDrldGo);
            }
    ...
    public static /* synthetic */ void m940deselect_kEHs6E$foundation_release$default(TextFieldSelectionManager textFieldSelectionManager, Offset offset, int i, Object obj) {
        if ((i & 1) != 0) {
            offset = null;
        }
        textFieldSelectionManager.m943deselect_kEHs6E$foundation_release(offset);
    }

    /* renamed from: deselect-_kEHs6E$foundation_release */
    public final void m943deselect_kEHs6E$foundation_release(Offset offset) {
        HandleState handleState;
        int m4400getMaximpl;
        if (!TextRange.m4397getCollapsedimpl(getValue$foundation_release().m4622getSelectiond9O1mEE())) {
            TextFieldState textFieldState = this.state;
            ...
            if (offset != null && layoutResult != null) {
                m4400getMaximpl = this.offsetMapping.transformedToOriginal(TextLayoutResultProxy.m832getOffsetForPosition3MmeM6k$default(layoutResult, offset.m2399unboximpl(), false, 2, null));
            } else {
                m4400getMaximpl = TextRange.m4400getMaximpl(getValue$foundation_release().m4622getSelectiond9O1mEE());
            }
            this.onValueChange.invoke(TextFieldValue.m4617copy3r_uNRQ$default(getValue$foundation_release(), (AnnotatedString) null, TextRangeKt.TextRange(m4400getMaximpl), (TextRange) null, 5, (Object) null));
        }
    ...
    public final void copy$foundation_release(boolean z) {
        ...
        if (z) {
            int m4400getMaximpl = TextRange.m4400getMaximpl(getValue$foundation_release().m4622getSelectiond9O1mEE());
            this.onValueChange.invoke(m939createTextFieldValueFDrldGo(getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(m4400getMaximpl, m4400getMaximpl)));
            setHandleState(HandleState.None);
        }
    }
    ...
    public final void paste$foundation_release() {
        ...
        int m4401getMinimpl = TextRange.m4401getMinimpl(getValue$foundation_release().m4622getSelectiond9O1mEE()) + text.length();
        this.onValueChange.invoke(m939createTextFieldValueFDrldGo(plus, TextRangeKt.TextRange(m4401getMinimpl, m4401getMinimpl)));
        setHandleState(HandleState.None);
    ...
    public final void cut$foundation_release() {
        ...
        int m4401getMinimpl = TextRange.m4401getMinimpl(getValue$foundation_release().m4622getSelectiond9O1mEE());
        this.onValueChange.invoke(m939createTextFieldValueFDrldGo(plus, TextRangeKt.TextRange(m4401getMinimpl, m4401getMinimpl)));
        setHandleState(HandleState.None);
        UndoManager undoManager = this.undoManager;
        if (undoManager != null) {
    ...
    public final void selectAll$foundation_release() {
        TextFieldValue m939createTextFieldValueFDrldGo = m939createTextFieldValueFDrldGo(getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(0, getValue$foundation_release().getText().length()));
        this.onValueChange.invoke(m939createTextFieldValueFDrldGo);
        this.oldValue = TextFieldValue.m4617copy3r_uNRQ$default(this.oldValue, (AnnotatedString) null, m939createTextFieldValueFDrldGo.m4622getSelectiond9O1mEE(), (TextRange) null, 5, (Object) null);
        TextFieldState textFieldState = this.state;
        if (textFieldState == null) {
            return;
        }
    ...
    public final long m946getHandlePositiontuRUvjQ$foundation_release(boolean z) {
        long m4622getSelectiond9O1mEE = getValue$foundation_release().m4622getSelectiond9O1mEE();
        int m4403getStartimpl = z ? TextRange.m4403getStartimpl(m4622getSelectiond9O1mEE) : TextRange.m4398getEndimpl(m4622getSelectiond9O1mEE);
        TextFieldState textFieldState = this.state;
        TextLayoutResultProxy layoutResult = textFieldState != null ? textFieldState.getLayoutResult() : null;
        Intrinsics.checkNotNull(layoutResult);
        return TextSelectionDelegateKt.getSelectionHandleCoordinates(layoutResult.getValue(), this.offsetMapping.originalToTransformed(m4403getStartimpl), z, TextRange.m4402getReversedimpl(getValue$foundation_release().m4622getSelectiond9O1mEE()));
    }

    /* renamed from: getCursorPosition-tuRUvjQ$foundation_release */
    public final long m945getCursorPositiontuRUvjQ$foundation_release(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        int originalToTransformed = this.offsetMapping.originalToTransformed(TextRange.m4403getStartimpl(getValue$foundation_release().m4622getSelectiond9O1mEE()));
        TextFieldState textFieldState = this.state;
        TextLayoutResultProxy layoutResult = textFieldState != null ? textFieldState.getLayoutResult() : null;
        Intrinsics.checkNotNull(layoutResult);
        ...
        return OffsetKt.Offset(cursorRect.getLeft() + (density.mo324toPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness()) / 2), cursorRect.getBottom());
    }

    public final void showSelectionToolbar$foundation_release() {
        ClipboardManager clipboardManager;
        boolean z = this.visualTransformation instanceof PasswordVisualTransformation;
        Function0<Unit> function0 = (TextRange.m4397getCollapsedimpl(getValue$foundation_release().m4622getSelectiond9O1mEE()) || z) ? null : new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$showSelectionToolbar$copy$1
        ...
        Function0<Unit> function02 = (TextRange.m4397getCollapsedimpl(getValue$foundation_release().m4622getSelectiond9O1mEE()) || !getEditable() || z) ? null : new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$showSelectionToolbar$cut$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
        ...
        Function0<Unit> function04 = TextRange.m4399getLengthimpl(getValue$foundation_release().m4622getSelectiond9O1mEE()) != getValue$foundation_release().getText().length() ? new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$showSelectionToolbar$selectAll$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
    ...
    public final void m942contextMenuOpenAdjustmentk4lQ0M(long j) {
        TextLayoutResultProxy layoutResult;
        TextFieldState textFieldState = this.state;
        if (textFieldState == null || (layoutResult = textFieldState.getLayoutResult()) == null) {
            return;
        }
        int m832getOffsetForPosition3MmeM6k$default = TextLayoutResultProxy.m832getOffsetForPosition3MmeM6k$default(layoutResult, j, false, 2, null);
        if (TextRange.m4394containsimpl(getValue$foundation_release().m4622getSelectiond9O1mEE(), m832getOffsetForPosition3MmeM6k$default)) {
            return;
        }
        updateSelection(getValue$foundation_release(), m832getOffsetForPosition3MmeM6k$default, m832getOffsetForPosition3MmeM6k$default, false, SelectionAdjustment.Companion.getWord());
    }
    ...
    private final Rect getContentRect() {
        ...
        if (textFieldState != null) {
            ...
            if (textFieldState != null) {
                int originalToTransformed = this.offsetMapping.originalToTransformed(TextRange.m4403getStartimpl(getValue$foundation_release().m4622getSelectiond9O1mEE()));
                int originalToTransformed2 = this.offsetMapping.originalToTransformed(TextRange.m4398getEndimpl(getValue$foundation_release().m4622getSelectiond9O1mEE()));
                TextFieldState textFieldState2 = this.state;
                long m2405getZeroF1C5BW0 = (textFieldState2 == null || (layoutCoordinates4 = textFieldState2.getLayoutCoordinates()) == null) ? Offset.Companion.m2405getZeroF1C5BW0() : layoutCoordinates4.mo3874localToRootMKHz9U(m946getHandlePositiontuRUvjQ$foundation_release(true));
                TextFieldState textFieldState3 = this.state;
                long m2405getZeroF1C5BW02 = (textFieldState3 == null || (layoutCoordinates3 = textFieldState3.getLayoutCoordinates()) == null) ? Offset.Companion.m2405getZeroF1C5BW0() : layoutCoordinates3.mo3874localToRootMKHz9U(m946getHandlePositiontuRUvjQ$foundation_release(false));
                ...
                if (textFieldState4 == null || (layoutCoordinates2 = textFieldState4.getLayoutCoordinates()) == null) {
                    ...
                    f = Offset.m2390getYimpl(layoutCoordinates2.mo3874localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult == null || (value2 = layoutResult.getValue()) == null || (cursorRect2 = value2.getCursorRect(originalToTransformed)) == null) ? 0.0f : cursorRect2.getTop())));
                }
                ...
                if (textFieldState5 != null && (layoutCoordinates = textFieldState5.getLayoutCoordinates()) != null) {
                    ...
                    f2 = Offset.m2390getYimpl(layoutCoordinates.mo3874localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult2 == null || (value = layoutResult2.getValue()) == null || (cursorRect = value.getCursorRect(originalToTransformed2)) == null) ? 0.0f : cursorRect.getTop())));
                }
                return new Rect(Math.min(Offset.m2389getXimpl(m2405getZeroF1C5BW0), Offset.m2389getXimpl(m2405getZeroF1C5BW02)), Math.min(f, f2), Math.max(Offset.m2389getXimpl(m2405getZeroF1C5BW0), Offset.m2389getXimpl(m2405getZeroF1C5BW02)), Math.max(Offset.m2390getYimpl(m2405getZeroF1C5BW0), Offset.m2390getYimpl(m2405getZeroF1C5BW02)) + (Dp.m4872constructorimpl(25) * textFieldState.getTextDelegate().getDensity().getDensity()));
            }
        }
    ...
    public final void updateSelection(TextFieldValue textFieldValue, int i, int i2, boolean z, SelectionAdjustment selectionAdjustment) {
        TextLayoutResultProxy layoutResult;
        long TextRange = TextRangeKt.TextRange(this.offsetMapping.originalToTransformed(TextRange.m4403getStartimpl(textFieldValue.m4622getSelectiond9O1mEE())), this.offsetMapping.originalToTransformed(TextRange.m4398getEndimpl(textFieldValue.m4622getSelectiond9O1mEE())));
        TextFieldState textFieldState = this.state;
        long m936getTextFieldSelectionbb3KNj8 = TextFieldSelectionDelegateKt.m936getTextFieldSelectionbb3KNj8((textFieldState == null || (layoutResult = textFieldState.getLayoutResult()) == null) ? null : layoutResult.getValue(), i, i2, TextRange.m4397getCollapsedimpl(TextRange) ? null : TextRange.m4391boximpl(TextRange), z, selectionAdjustment);
        long TextRange2 = TextRangeKt.TextRange(this.offsetMapping.transformedToOriginal(TextRange.m4403getStartimpl(m936getTextFieldSelectionbb3KNj8)), this.offsetMapping.transformedToOriginal(TextRange.m4398getEndimpl(m936getTextFieldSelectionbb3KNj8)));
        if (TextRange.m4396equalsimpl0(TextRange2, textFieldValue.m4622getSelectiond9O1mEE())) {
            return;
        }
        ...
        this.onValueChange.invoke(m939createTextFieldValueFDrldGo(textFieldValue.getAnnotatedString(), TextRange2));
        TextFieldState textFieldState2 = this.state;
        if (textFieldState2 != null) {
    ...
    public final TextFieldValue m939createTextFieldValueFDrldGo(AnnotatedString annotatedString, long j) {
    ...
    public final void m941setCurrentDragPosition_kEHs6E(Offset offset) {
