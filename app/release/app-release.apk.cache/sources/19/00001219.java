...
public final class SaveableStateHolderImpl implements SaveableStateHolder {
    ...
    public static final /* synthetic */ Map access$getRegistryHolders$p(SaveableStateHolderImpl saveableStateHolderImpl) {
        return saveableStateHolderImpl.registryHolders;
    }

    public static final /* synthetic */ Map access$getSavedStates$p(SaveableStateHolderImpl saveableStateHolderImpl) {
        return saveableStateHolderImpl.savedStates;
    }

    public static final /* synthetic */ Map access$saveAll(SaveableStateHolderImpl saveableStateHolderImpl) {
    ...
    public void SaveableStateProvider(final Object key, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i) {
        ...
        EffectsKt.DisposableEffect(Unit.INSTANCE, new Function1<DisposableEffectScope, DisposableEffectResult>() { // from class: androidx.compose.runtime.saveable.SaveableStateHolderImpl$SaveableStateProvider$1$1
            ...
            public final DisposableEffectResult invoke(DisposableEffectScope DisposableEffect) {
                ...
                boolean z = !SaveableStateHolderImpl.access$getRegistryHolders$p(SaveableStateHolderImpl.this).containsKey(key);
                Object obj = key;
                if (!z) {
                    throw new IllegalArgumentException(("Key " + obj + " was used multiple times ").toString());
                }
                SaveableStateHolderImpl.access$getSavedStates$p(SaveableStateHolderImpl.this).remove(key);
                SaveableStateHolderImpl.access$getRegistryHolders$p(SaveableStateHolderImpl.this).put(key, registryHolder);
                ...
                return new DisposableEffectResult() { // from class: androidx.compose.runtime.saveable.SaveableStateHolderImpl$SaveableStateProvider$1$1$invoke$$inlined$onDispose$1
                    ...
                    public void dispose() {
                        SaveableStateHolderImpl.RegistryHolder.this.saveTo(SaveableStateHolderImpl.access$getSavedStates$p(saveableStateHolderImpl));
                        SaveableStateHolderImpl.access$getRegistryHolders$p(saveableStateHolderImpl).remove(obj2);
                    }
                };
            }
        }, startRestartGroup, 6);
