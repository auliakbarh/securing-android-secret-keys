...
public final class DefaultIntrinsicMeasurable implements Measurable {
    ...
    public Placeable mo3865measureBRTryo0(long j) {
        ...
        if (this.widthHeight == IntrinsicWidthHeight.Width) {
            ...
            return new FixedSizeIntrinsicsPlaceable(minIntrinsicWidth, Constraints.m4827getMaxHeightimpl(j));
        }
        if (this.minMax == IntrinsicMinMax.Max) {
        ...
        return new FixedSizeIntrinsicsPlaceable(Constraints.m4828getMaxWidthimpl(j), minIntrinsicHeight);
    }
