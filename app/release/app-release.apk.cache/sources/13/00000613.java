...
public final class LazyListMeasuredItem implements LazyListItemInfo {
    ...
    public final long m589getOffsetBjo55l4(int i) {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < placeablesCount; i++) {
            ...
            long m589getOffsetBjo55l4 = m589getOffsetBjo55l4(i);
            ...
            if (lazyLayoutAnimateItemModifierNode != null) {
                ...
                long IntOffset = IntOffsetKt.IntOffset(IntOffset.m4990getXimpl(m589getOffsetBjo55l4) + IntOffset.m4990getXimpl(m624getPlacementDeltanOccac), IntOffset.m4991getYimpl(m589getOffsetBjo55l4) + IntOffset.m4991getYimpl(m624getPlacementDeltanOccac));
                if ((m588getMainAxisgyyYBs(m589getOffsetBjo55l4) <= mainAxisSize && m588getMainAxisgyyYBs(IntOffset) <= mainAxisSize) || (m588getMainAxisgyyYBs(m589getOffsetBjo55l4) >= i2 && m588getMainAxisgyyYBs(IntOffset) >= i2)) {
                    lazyLayoutAnimateItemModifierNode.cancelAnimation();
                }
                m589getOffsetBjo55l4 = IntOffset;
            }
            if (this.reverseLayout) {
                if (!this.isVertical) {
                    m4990getXimpl = (this.mainAxisLayoutSize - IntOffset.m4990getXimpl(m589getOffsetBjo55l4)) - getMainAxisSize(placeable);
                } else {
                    m4990getXimpl = IntOffset.m4990getXimpl(m589getOffsetBjo55l4);
                }
                if (this.isVertical) {
                    m4991getYimpl = (this.mainAxisLayoutSize - IntOffset.m4991getYimpl(m589getOffsetBjo55l4)) - getMainAxisSize(placeable);
                } else {
                    m4991getYimpl = IntOffset.m4991getYimpl(m589getOffsetBjo55l4);
                }
                m589getOffsetBjo55l4 = IntOffsetKt.IntOffset(m4990getXimpl, m4991getYimpl);
            }
            long j = this.visualOffset;
            long IntOffset2 = IntOffsetKt.IntOffset(IntOffset.m4990getXimpl(m589getOffsetBjo55l4) + IntOffset.m4990getXimpl(j), IntOffset.m4991getYimpl(m589getOffsetBjo55l4) + IntOffset.m4991getYimpl(j));
            if (this.isVertical) {
    ...
    private final int m588getMainAxisgyyYBs(long j) {
    ...
    private final long m587copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
