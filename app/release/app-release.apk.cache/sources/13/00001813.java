...
public final class ParagraphInfo {
    ...
    public final long m4300toLocalMKHz9U(long j) {
        return OffsetKt.Offset(Offset.m2389getXimpl(j), Offset.m2390getYimpl(j) - this.top);
    }

    public final Rect toGlobal(Rect rect) {
        Intrinsics.checkNotNullParameter(rect, "<this>");
        return rect.m2426translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    public final Path toGlobal(Path path) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        path.mo2525translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return path;
    }

    /* renamed from: toGlobal-GEjPoXI  reason: not valid java name */
    public final long m4299toGlobalGEjPoXI(long j) {
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m4403getStartimpl(j)), toGlobalIndex(TextRange.m4398getEndimpl(j)));
    }
}