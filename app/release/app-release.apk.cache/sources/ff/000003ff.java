...
public final class ScrollingLogic$doFlingAnimation$2 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final Function1<Offset, Offset> function1 = new Function1<Offset, Offset>() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$outerScopeScroll$1
                ...
                public /* bridge */ /* synthetic */ Offset invoke(Offset offset) {
                    return Offset.m2378boximpl(m346invokeMKHz9U(offset.m2399unboximpl()));
                }

                /* renamed from: invoke-MK-Hz9U  reason: not valid java name */
                public final long m346invokeMKHz9U(long j2) {
                    ScrollingLogic scrollingLogic4 = ScrollingLogic.this;
                    return scrollingLogic4.m338reverseIfNeededMKHz9U(scrollingLogic4.m334dispatchScroll3eAAhYA(scrollScope, scrollingLogic4.m338reverseIfNeededMKHz9U(j2), NestedScrollSource.Companion.m3645getFlingWNlRxjI()));
                }
            };
            ...
            ScrollScope scrollScope2 = new ScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$scope$1
                ...
                public float scrollBy(float f) {
                    ...
                    return scrollingLogic5.m342toFloatk4lQ0M(function1.invoke(Offset.m2378boximpl(scrollingLogic5.m343toOffsettuRUvjQ(f))).m2399unboximpl());
                }
            };
            ...
            float reverseIfNeeded = scrollingLogic.reverseIfNeeded(scrollingLogic.m341toFloatTH1AsA0(j2));
        ...
        longRef.element = scrollingLogic.m344updateQWom1Mo(j, scrollingLogic2.reverseIfNeeded(((Number) obj).floatValue()));
