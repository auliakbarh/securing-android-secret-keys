...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        android.graphics.Typeface mo4524createDefaultFO1MlWM;
        ...
        if (fontFamily == null || (fontFamily instanceof DefaultFontFamily)) {
            mo4524createDefaultFO1MlWM = this.platformTypefaceResolver.mo4524createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m4542getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            mo4524createDefaultFO1MlWM = this.platformTypefaceResolver.mo4525createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m4542getFontStyle_LCdwA());
            ...
            mo4524createDefaultFO1MlWM = ((AndroidTypeface) typeface).mo4625getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m4542getFontStyle_LCdwA(), typefaceRequest.m4543getFontSynthesisGVVA2EU());
        }
        return new TypefaceResult.Immutable(mo4524createDefaultFO1MlWM, false, 2, null);
    }
}