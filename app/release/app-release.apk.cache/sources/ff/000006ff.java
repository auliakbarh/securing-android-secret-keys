...
public final class LazyStaggeredGridAnimateScrollScope implements LazyAnimateScrollScope {
    ...
    public Integer getTargetItemOffset(int i) {
        ...
        if (findVisibleItem != null) {
            ...
            return Integer.valueOf(this.state.isVertical$foundation_release() ? IntOffset.m4991getYimpl(mo653getOffsetnOccac) : IntOffset.m4990getXimpl(mo653getOffsetnOccac));
        }
        return null;
    }
    ...
    public float expectedDistanceTo(int i, int i2) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            ...
            i3 += this.state.isVertical$foundation_release() ? IntSize.m5031getHeightimpl(lazyStaggeredGridItemInfo.mo654getSizeYbymL2g()) : IntSize.m5032getWidthimpl(lazyStaggeredGridItemInfo.mo654getSizeYbymL2g());
        }
