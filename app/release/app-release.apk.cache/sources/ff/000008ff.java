...
public final class HandlePositionProvider implements PopupPositionProvider {
    ...
    public long mo873calculatePositionllwVHH4(IntRect anchorBounds, long j, LayoutDirection layoutDirection, long j2) {
        ...
        if (i != 1) {
            if (i != 2) {
                if (i == 3) {
                    return IntOffsetKt.IntOffset((anchorBounds.getLeft() + IntOffset.m4990getXimpl(this.offset)) - (IntSize.m5032getWidthimpl(j2) / 2), anchorBounds.getTop() + IntOffset.m4991getYimpl(this.offset));
                }
                throw new NoWhenBranchMatchedException();
            }
            return IntOffsetKt.IntOffset((anchorBounds.getLeft() + IntOffset.m4990getXimpl(this.offset)) - IntSize.m5032getWidthimpl(j2), anchorBounds.getTop() + IntOffset.m4991getYimpl(this.offset));
        }
        return IntOffsetKt.IntOffset(anchorBounds.getLeft() + IntOffset.m4990getXimpl(this.offset), anchorBounds.getTop() + IntOffset.m4991getYimpl(this.offset));
    }
}