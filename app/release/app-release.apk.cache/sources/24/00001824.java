...
public final class SaversKt {
    private static final Saver<AnnotatedString, Object> AnnotatedStringSaver = SaverKt.Saver(new Function2<SaverScope, AnnotatedString, Object>() { // from class: androidx.compose.ui.text.SaversKt$AnnotatedStringSaver$1
        ...
        public final Object invoke(SaverScope Saver, AnnotatedString it) {
            ...
            return CollectionsKt.arrayListOf(SaversKt.save(it.getText()), SaversKt.save(it.getSpanStyles(), SaversKt.access$getAnnotationRangeListSaver$p(), Saver), SaversKt.save(it.getParagraphStyles(), SaversKt.access$getAnnotationRangeListSaver$p(), Saver), SaversKt.save(it.getAnnotations$ui_text_release(), SaversKt.access$getAnnotationRangeListSaver$p(), Saver));
        }
        ...
        public final AnnotatedString invoke(Object it) {
            ...
            List list4 = null;
            List list5 = (Intrinsics.areEqual(obj, (Object) false) || obj == null) ? null : (List) SaversKt.access$getAnnotationRangeListSaver$p().restore(obj);
            Object obj2 = list3.get(2);
            List list6 = (Intrinsics.areEqual(obj2, (Object) false) || obj2 == null) ? null : (List) SaversKt.access$getAnnotationRangeListSaver$p().restore(obj2);
            ...
            if (!Intrinsics.areEqual(obj4, (Object) false) && obj4 != null) {
                list4 = (List) access$getAnnotationRangeListSaver$p.restore(obj4);
            }
    ...
    private static final Saver<List<AnnotatedString.Range<? extends Object>>, Object> AnnotationRangeListSaver = SaverKt.Saver(new Function2<SaverScope, List<? extends AnnotatedString.Range<? extends Object>>, Object>() { // from class: androidx.compose.ui.text.SaversKt$AnnotationRangeListSaver$1
        ...
        public final Object invoke(SaverScope Saver, List<? extends AnnotatedString.Range<? extends Object>> it) {
            ...
            for (int i = 0; i < size; i++) {
                arrayList.add(SaversKt.save(it.get(i), SaversKt.access$getAnnotationRangeSaver$p(), Saver));
            }
            return arrayList;
        }
        ...
        public final List<? extends AnnotatedString.Range<? extends Object>> invoke(Object it) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                Saver access$getAnnotationRangeSaver$p = SaversKt.access$getAnnotationRangeSaver$p();
                AnnotatedString.Range range = null;
                if (!Intrinsics.areEqual(obj, (Object) false) && obj != null) {
                    range = (AnnotatedString.Range) access$getAnnotationRangeSaver$p.restore(obj);
                }
    ...
    private static final Saver<AnnotatedString.Range<? extends Object>, Object> AnnotationRangeSaver = SaverKt.Saver(new Function2<SaverScope, AnnotatedString.Range<? extends Object>, Object>() { // from class: androidx.compose.ui.text.SaversKt$AnnotationRangeSaver$1
        ...
        public final Object invoke(SaverScope Saver, AnnotatedString.Range<? extends Object> it) {
            ...
            if (i == 1) {
                ...
                save = SaversKt.save((VerbatimTtsAnnotation) item4, SaversKt.access$getVerbatimTtsAnnotationSaver$p(), Saver);
            } else if (i == 4) {
                ...
                save = SaversKt.save((UrlAnnotation) item5, SaversKt.access$getUrlAnnotationSaver$p(), Saver);
            } else if (i != 5) {
        ...
        public final AnnotatedString.Range<? extends Object> invoke(Object it) {
            ...
            if (i == 1) {
                ...
                if (!Intrinsics.areEqual(obj7, (Object) false) && obj7 != null) {
                    r2 = (VerbatimTtsAnnotation) access$getVerbatimTtsAnnotationSaver$p.restore(obj7);
                }
                Intrinsics.checkNotNull(r2);
                return new AnnotatedString.Range<>(r2, intValue, intValue2, str);
            } else if (i != 4) {
                ...
                Saver access$getUrlAnnotationSaver$p = SaversKt.access$getUrlAnnotationSaver$p();
                if (!Intrinsics.areEqual(obj9, (Object) false) && obj9 != null) {
                    r2 = (UrlAnnotation) access$getUrlAnnotationSaver$p.restore(obj9);
                }
                Intrinsics.checkNotNull(r2);
                return new AnnotatedString.Range<>(r2, intValue, intValue2, str);
            }
    ...
    private static final Saver<ParagraphStyle, Object> ParagraphStyleSaver = SaverKt.Saver(new Function2<SaverScope, ParagraphStyle, Object>() { // from class: androidx.compose.ui.text.SaversKt$ParagraphStyleSaver$1
        ...
        public final Object invoke(SaverScope Saver, ParagraphStyle it) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            Intrinsics.checkNotNullParameter(it, "it");
            return CollectionsKt.arrayListOf(SaversKt.save(it.m4318getTextAlignbuA522U()), SaversKt.save(it.m4320getTextDirectionmmuk1to()), SaversKt.save(TextUnit.m5043boximpl(it.m4317getLineHeightXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), Saver), SaversKt.save(it.getTextIndent(), SaversKt.getSaver(TextIndent.Companion), Saver));
        }
        ...
        public final ParagraphStyle invoke(Object it) {
            ...
            long m5062unboximpl = restore.m5062unboximpl();
            Object obj4 = list.get(3);
            return new ParagraphStyle(textAlign, textDirection, m5062unboximpl, (Intrinsics.areEqual(obj4, (Object) false) || obj4 == null) ? null : SaversKt.getSaver(TextIndent.Companion).restore(obj4), null, null, null, null, null, 496, null);
        }
    });
    private static final Saver<SpanStyle, Object> SpanStyleSaver = SaverKt.Saver(new Function2<SaverScope, SpanStyle, Object>() { // from class: androidx.compose.ui.text.SaversKt$SpanStyleSaver$1
        ...
        public final Object invoke(SaverScope Saver, SpanStyle it) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            Intrinsics.checkNotNullParameter(it, "it");
            return CollectionsKt.arrayListOf(SaversKt.save(Color.m2618boximpl(it.m4362getColor0d7_KjU()), SaversKt.getSaver(Color.Companion), Saver), SaversKt.save(TextUnit.m5043boximpl(it.m4363getFontSizeXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), Saver), SaversKt.save(it.getFontWeight(), SaversKt.getSaver(FontWeight.Companion), Saver), SaversKt.save(it.m4364getFontStyle4Lr2A7w()), SaversKt.save(it.m4365getFontSynthesisZQGJjVo()), SaversKt.save(-1), SaversKt.save(it.getFontFeatureSettings()), SaversKt.save(TextUnit.m5043boximpl(it.m4366getLetterSpacingXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), Saver), SaversKt.save(it.m4361getBaselineShift5SSeXJ0(), SaversKt.getSaver(BaselineShift.Companion), Saver), SaversKt.save(it.getTextGeometricTransform(), SaversKt.getSaver(TextGeometricTransform.Companion), Saver), SaversKt.save(it.getLocaleList(), SaversKt.getSaver(LocaleList.Companion), Saver), SaversKt.save(Color.m2618boximpl(it.m4360getBackground0d7_KjU()), SaversKt.getSaver(Color.Companion), Saver), SaversKt.save(it.getTextDecoration(), SaversKt.getSaver(TextDecoration.Companion), Saver), SaversKt.save(it.getShadow(), SaversKt.getSaver(Shadow.Companion), Saver));
        }
        ...
        public final SpanStyle invoke(Object it) {
            ...
            Intrinsics.checkNotNull(restore);
            long m2638unboximpl = restore.m2638unboximpl();
            Object obj2 = list.get(1);
            ...
            long m5062unboximpl = restore2.m5062unboximpl();
            Object obj3 = list.get(2);
            ...
            long m5062unboximpl2 = restore4.m5062unboximpl();
            ...
            long m2638unboximpl2 = restore8.m2638unboximpl();
            ...
            return new SpanStyle(m2638unboximpl, m5062unboximpl, restore3, fontStyle, fontSynthesis, (FontFamily) null, str, m5062unboximpl2, restore5, restore6, restore7, m2638unboximpl2, restore9, (Intrinsics.areEqual(obj13, (Object) false) || obj13 == null) ? null : SaversKt.getSaver(Shadow.Companion).restore(obj13), (PlatformSpanStyle) null, (DrawStyle) null, 49184, (DefaultConstructorMarker) null);
        }
    });
    ...
    private static final Saver<TextIndent, Object> TextIndentSaver = SaverKt.Saver(new Function2<SaverScope, TextIndent, Object>() { // from class: androidx.compose.ui.text.SaversKt$TextIndentSaver$1
        ...
        public final Object invoke(SaverScope Saver, TextIndent it) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            Intrinsics.checkNotNullParameter(it, "it");
            return CollectionsKt.arrayListOf(SaversKt.save(TextUnit.m5043boximpl(it.m4788getFirstLineXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), Saver), SaversKt.save(TextUnit.m5043boximpl(it.m4789getRestLineXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), Saver));
        }
        ...
        public final TextIndent invoke(Object it) {
            ...
            return new TextIndent(m5062unboximpl, textUnit.m5062unboximpl(), null);
        }
    });
    ...
    private static final Saver<BaselineShift, Object> BaselineShiftSaver = SaverKt.Saver(new Function2<SaverScope, BaselineShift, Object>() { // from class: androidx.compose.ui.text.SaversKt$BaselineShiftSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, BaselineShift baselineShift) {
            return m4342invoke8a2Sb4w(saverScope, baselineShift.m4665unboximpl());
        }

        /* renamed from: invoke-8a2Sb4w  reason: not valid java name */
        public final Object m4342invoke8a2Sb4w(SaverScope Saver, float f) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
        ...
        public final BaselineShift invoke(Object it) {
            Intrinsics.checkNotNullParameter(it, "it");
            return BaselineShift.m4659boximpl(BaselineShift.m4660constructorimpl(((Float) it).floatValue()));
        }
    });
    private static final Saver<TextRange, Object> TextRangeSaver = SaverKt.Saver(new Function2<SaverScope, TextRange, Object>() { // from class: androidx.compose.ui.text.SaversKt$TextRangeSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, TextRange textRange) {
            return m4348invokeFDrldGo(saverScope, textRange.m4407unboximpl());
        }

        /* JADX WARN: Multi-variable type inference failed */
        /* renamed from: invoke-FDrldGo  reason: not valid java name */
        public final Object m4348invokeFDrldGo(SaverScope Saver, long j) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            return CollectionsKt.arrayListOf(SaversKt.save(Integer.valueOf(TextRange.m4403getStartimpl(j))), SaversKt.save(Integer.valueOf(TextRange.m4398getEndimpl(j))));
        }
        ...
        public final TextRange invoke(Object it) {
            ...
            Intrinsics.checkNotNull(num2);
            return TextRange.m4391boximpl(TextRangeKt.TextRange(intValue, num2.intValue()));
        }
    });
    private static final Saver<Shadow, Object> ShadowSaver = SaverKt.Saver(new Function2<SaverScope, Shadow, Object>() { // from class: androidx.compose.ui.text.SaversKt$ShadowSaver$1
        ...
        public final Object invoke(SaverScope Saver, Shadow it) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            Intrinsics.checkNotNullParameter(it, "it");
            return CollectionsKt.arrayListOf(SaversKt.save(Color.m2618boximpl(it.m2946getColor0d7_KjU()), SaversKt.getSaver(Color.Companion), Saver), SaversKt.save(Offset.m2378boximpl(it.m2947getOffsetF1C5BW0()), SaversKt.getSaver(Offset.Companion), Saver), SaversKt.save(Float.valueOf(it.getBlurRadius())));
        }
        ...
        public final Shadow invoke(Object it) {
            ...
            Intrinsics.checkNotNull(restore2);
            long m2399unboximpl = restore2.m2399unboximpl();
            Object obj3 = list.get(2);
            Float f = obj3 != null ? (Float) obj3 : null;
            Intrinsics.checkNotNull(f);
            return new Shadow(m2638unboximpl, m2399unboximpl, f.floatValue(), null);
        }
    });
    private static final Saver<Color, Object> ColorSaver = SaverKt.Saver(new Function2<SaverScope, Color, Object>() { // from class: androidx.compose.ui.text.SaversKt$ColorSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, Color color) {
            return m4344invoke4WTKRHQ(saverScope, color.m2638unboximpl());
        }

        /* renamed from: invoke-4WTKRHQ  reason: not valid java name */
        public final Object m4344invoke4WTKRHQ(SaverScope Saver, long j) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            return ULong.m5324boximpl(j);
        }
        ...
        public final Color invoke(Object it) {
            Intrinsics.checkNotNullParameter(it, "it");
            return Color.m2618boximpl(Color.m2624constructorimpl(((ULong) it).m5382unboximpl()));
        }
    });
    private static final Saver<TextUnit, Object> TextUnitSaver = SaverKt.Saver(new Function2<SaverScope, TextUnit, Object>() { // from class: androidx.compose.ui.text.SaversKt$TextUnitSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, TextUnit textUnit) {
            return m4350invokempE4wyQ(saverScope, textUnit.m5062unboximpl());
        }

        /* renamed from: invoke-mpE4wyQ  reason: not valid java name */
        public final Object m4350invokempE4wyQ(SaverScope Saver, long j) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            return CollectionsKt.arrayListOf(SaversKt.save(Float.valueOf(TextUnit.m5053getValueimpl(j))), SaversKt.save(TextUnitType.m5078boximpl(TextUnit.m5052getTypeUIouoOA(j))));
        }
        ...
        public final TextUnit invoke(Object it) {
            ...
            return TextUnit.m5043boximpl(TextUnitKt.m5065TextUnitanM5pPY(floatValue, textUnitType.m5084unboximpl()));
        }
    });
    private static final Saver<Offset, Object> OffsetSaver = SaverKt.Saver(new Function2<SaverScope, Offset, Object>() { // from class: androidx.compose.ui.text.SaversKt$OffsetSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, Offset offset) {
            return m4346invokeUv8p0NA(saverScope, offset.m2399unboximpl());
        }

        /* JADX WARN: Multi-variable type inference failed */
        /* renamed from: invoke-Uv8p0NA  reason: not valid java name */
        public final Object m4346invokeUv8p0NA(SaverScope Saver, long j) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            return Offset.m2386equalsimpl0(j, Offset.Companion.m2404getUnspecifiedF1C5BW0()) ? (Serializable) false : CollectionsKt.arrayListOf(SaversKt.save(Float.valueOf(Offset.m2389getXimpl(j))), SaversKt.save(Float.valueOf(Offset.m2390getYimpl(j))));
        }
        ...
        public final Offset invoke(Object it) {
            ...
            if (Intrinsics.areEqual(it, (Object) false)) {
                return Offset.m2378boximpl(Offset.Companion.m2404getUnspecifiedF1C5BW0());
            }
            List list = (List) it;
            Object obj = list.get(0);
            Float f = obj != null ? (Float) obj : null;
            ...
            return Offset.m2378boximpl(OffsetKt.Offset(floatValue, f2.floatValue()));
        }
    });
    ...
    public static final /* synthetic */ Saver access$getAnnotationRangeListSaver$p() {
        return AnnotationRangeListSaver;
    }

    public static final /* synthetic */ Saver access$getAnnotationRangeSaver$p() {
        return AnnotationRangeSaver;
    }

    public static final /* synthetic */ Saver access$getUrlAnnotationSaver$p() {
        return UrlAnnotationSaver;
    }

    public static final /* synthetic */ Saver access$getVerbatimTtsAnnotationSaver$p() {
