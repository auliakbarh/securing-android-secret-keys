...
public final class RippleAnimation {
    ...
    */
    ...
    public final void m958draw4WTKRHQ(DrawScope draw, long j) {
        Float valueOf;
        Intrinsics.checkNotNullParameter(draw, "$this$draw");
        if (this.startRadius == null) {
            this.startRadius = Float.valueOf(RippleAnimationKt.m960getRippleStartRadiusuvyYCjk(draw.mo3171getSizeNHjbRc()));
        }
        if (this.targetRadius == null) {
            if (Float.isNaN(this.radius)) {
                valueOf = Float.valueOf(RippleAnimationKt.m959getRippleEndRadiuscSwnlzA(draw, this.bounded, draw.mo3171getSizeNHjbRc()));
            } else {
                valueOf = Float.valueOf(draw.mo324toPx0680j_4(this.radius));
            }
            this.targetRadius = valueOf;
        }
        if (this.origin == null) {
            this.origin = Offset.m2378boximpl(draw.mo3170getCenterF1C5BW0());
        }
        if (this.targetCenter == null) {
            this.targetCenter = Offset.m2378boximpl(OffsetKt.Offset(Size.m2458getWidthimpl(draw.mo3171getSizeNHjbRc()) / 2.0f, Size.m2455getHeightimpl(draw.mo3171getSizeNHjbRc()) / 2.0f));
        }
        ...
        float m2389getXimpl = Offset.m2389getXimpl(offset.m2399unboximpl());
        Offset offset2 = this.targetCenter;
        Intrinsics.checkNotNull(offset2);
        float lerp2 = MathHelpersKt.lerp(m2389getXimpl, Offset.m2389getXimpl(offset2.m2399unboximpl()), this.animatedCenterPercent.getValue().floatValue());
        Offset offset3 = this.origin;
        Intrinsics.checkNotNull(offset3);
        float m2390getYimpl = Offset.m2390getYimpl(offset3.m2399unboximpl());
        Offset offset4 = this.targetCenter;
        Intrinsics.checkNotNull(offset4);
        long Offset = OffsetKt.Offset(lerp2, MathHelpersKt.lerp(m2390getYimpl, Offset.m2390getYimpl(offset4.m2399unboximpl()), this.animatedCenterPercent.getValue().floatValue()));
        long m2627copywmQWz5c$default = Color.m2627copywmQWz5c$default(j, Color.m2630getAlphaimpl(j) * floatValue, 0.0f, 0.0f, 0.0f, 14, null);
        if (!this.bounded) {
            DrawScope.m3153drawCircleVaOC9Bg$default(draw, m2627copywmQWz5c$default, lerp, Offset, 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
            return;
        }
        float m2458getWidthimpl = Size.m2458getWidthimpl(draw.mo3171getSizeNHjbRc());
        float m2455getHeightimpl = Size.m2455getHeightimpl(draw.mo3171getSizeNHjbRc());
        ...
        drawContext.getTransform().mo3099clipRectN_I0leg(0.0f, 0.0f, m2458getWidthimpl, m2455getHeightimpl, m2617getIntersectrtfAjoo);
        DrawScope.m3153drawCircleVaOC9Bg$default(draw, m2627copywmQWz5c$default, lerp, Offset, 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
