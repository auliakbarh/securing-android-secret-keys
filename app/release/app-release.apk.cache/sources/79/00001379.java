...
public final class GraphicsLayerElement extends ModifierNodeElement<SimpleGraphicsLayerModifier> {
    ...
    public final long m2773component11SzJe1aQ() {
    ...
    public final long m2774component150d7_KjU() {
        return this.ambientShadowColor;
    }

    /* renamed from: component16-0d7_KjU  reason: not valid java name */
    public final long m2775component160d7_KjU() {
        return this.spotShadowColor;
    }

    /* renamed from: component17--NrFUSI  reason: not valid java name */
    public final int m2776component17NrFUSI() {
    ...
    public final GraphicsLayerElement m2777copyJVvOYNQ(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape, boolean z, RenderEffect renderEffect, long j2, long j3, int i) {
    ...
    public final long m2778getAmbientShadowColor0d7_KjU() {
        return this.ambientShadowColor;
    }
    ...
    public final int m2779getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }
    ...
    public final long m2780getSpotShadowColor0d7_KjU() {
        return this.spotShadowColor;
    }

    /* renamed from: getTransformOrigin-SzJe1aQ  reason: not valid java name */
    public final long m2781getTransformOriginSzJe1aQ() {
        return this.transformOrigin;
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int hashCode = ((((((((((((((((((((((Float.hashCode(this.scaleX) * 31) + Float.hashCode(this.scaleY)) * 31) + Float.hashCode(this.alpha)) * 31) + Float.hashCode(this.translationX)) * 31) + Float.hashCode(this.translationY)) * 31) + Float.hashCode(this.shadowElevation)) * 31) + Float.hashCode(this.rotationX)) * 31) + Float.hashCode(this.rotationY)) * 31) + Float.hashCode(this.rotationZ)) * 31) + Float.hashCode(this.cameraDistance)) * 31) + TransformOrigin.m3009hashCodeimpl(this.transformOrigin)) * 31) + this.shape.hashCode()) * 31;
        boolean z = this.clip;
        int i = z;
        if (z != 0) {
            i = 1;
        ...
        return ((((((i2 + (renderEffect == null ? 0 : renderEffect.hashCode())) * 31) + Color.m2635hashCodeimpl(this.ambientShadowColor)) * 31) + Color.m2635hashCodeimpl(this.spotShadowColor)) * 31) + CompositingStrategy.m2710hashCodeimpl(this.compositingStrategy);
    }

    public String toString() {
        StringBuilder sb = new StringBuilder("GraphicsLayerElement(scaleX=");
        sb.append(this.scaleX).append(", scaleY=").append(this.scaleY).append(", alpha=").append(this.alpha).append(", translationX=").append(this.translationX).append(", translationY=").append(this.translationY).append(", shadowElevation=").append(this.shadowElevation).append(", rotationX=").append(this.rotationX).append(", rotationY=").append(this.rotationY).append(", rotationZ=").append(this.rotationZ).append(", cameraDistance=").append(this.cameraDistance).append(", transformOrigin=").append((Object) TransformOrigin.m3010toStringimpl(this.transformOrigin)).append(", shape=");
        sb.append(this.shape).append(", clip=").append(this.clip).append(", renderEffect=").append(this.renderEffect).append(", ambientShadowColor=").append((Object) Color.m2636toStringimpl(this.ambientShadowColor)).append(", spotShadowColor=").append((Object) Color.m2636toStringimpl(this.spotShadowColor)).append(", compositingStrategy=").append((Object) CompositingStrategy.m2711toStringimpl(this.compositingStrategy)).append(')');
        return sb.toString();
    }
    ...
    public void update(SimpleGraphicsLayerModifier node) {
        ...
        node.m2955setTransformOrigin__ExYCQ(this.transformOrigin);
        node.setShape(this.shape);
        node.setClip(this.clip);
        node.setRenderEffect(this.renderEffect);
        node.m2952setAmbientShadowColor8_81llA(this.ambientShadowColor);
        node.m2954setSpotShadowColor8_81llA(this.spotShadowColor);
        node.m2953setCompositingStrategyaDBOjCE(this.compositingStrategy);
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("transformOrigin", TransformOrigin.m2999boximpl(this.transformOrigin));
        ...
        inspectorInfo.getProperties().set("ambientShadowColor", Color.m2618boximpl(this.ambientShadowColor));
        inspectorInfo.getProperties().set("spotShadowColor", Color.m2618boximpl(this.spotShadowColor));
        inspectorInfo.getProperties().set("compositingStrategy", CompositingStrategy.m2706boximpl(this.compositingStrategy));
    }
}