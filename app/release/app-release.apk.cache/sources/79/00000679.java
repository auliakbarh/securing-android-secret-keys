...
public final class LazyGridMeasuredItem implements LazyGridItemInfo {
    ...
    public final int getCrossAxisOffset() {
        return this.isVertical ? IntOffset.m4990getXimpl(mo611getOffsetnOccac()) : IntOffset.m4991getYimpl(mo611getOffsetnOccac());
    }
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < placeablesCount; i++) {
            ...
            long mo611getOffsetnOccac = mo611getOffsetnOccac();
            ...
            if (lazyLayoutAnimateItemModifierNode != null) {
                ...
                long IntOffset = IntOffsetKt.IntOffset(IntOffset.m4990getXimpl(mo611getOffsetnOccac) + IntOffset.m4990getXimpl(m624getPlacementDeltanOccac), IntOffset.m4991getYimpl(mo611getOffsetnOccac) + IntOffset.m4991getYimpl(m624getPlacementDeltanOccac));
                if ((m616getMainAxisgyyYBs(mo611getOffsetnOccac) <= mainAxisSize && m616getMainAxisgyyYBs(IntOffset) <= mainAxisSize) || (m616getMainAxisgyyYBs(mo611getOffsetnOccac) >= i2 && m616getMainAxisgyyYBs(IntOffset) >= i2)) {
                    lazyLayoutAnimateItemModifierNode.cancelAnimation();
                }
                mo611getOffsetnOccac = IntOffset;
            }
            if (this.reverseLayout) {
                if (!this.isVertical) {
                    m4990getXimpl = (this.mainAxisLayoutSize - IntOffset.m4990getXimpl(mo611getOffsetnOccac)) - getMainAxisSize(placeable);
                } else {
                    m4990getXimpl = IntOffset.m4990getXimpl(mo611getOffsetnOccac);
                }
                if (this.isVertical) {
                    m4991getYimpl = (this.mainAxisLayoutSize - IntOffset.m4991getYimpl(mo611getOffsetnOccac)) - getMainAxisSize(placeable);
                } else {
                    m4991getYimpl = IntOffset.m4991getYimpl(mo611getOffsetnOccac);
                }
                mo611getOffsetnOccac = IntOffsetKt.IntOffset(m4990getXimpl, m4991getYimpl);
            }
            long j = this.visualOffset;
            long IntOffset2 = IntOffsetKt.IntOffset(IntOffset.m4990getXimpl(mo611getOffsetnOccac) + IntOffset.m4990getXimpl(j), IntOffset.m4991getYimpl(mo611getOffsetnOccac) + IntOffset.m4991getYimpl(j));
            if (this.isVertical) {
                Placeable.PlacementScope.m3925placeWithLayeraW9wM$default(scope, placeable, IntOffset2, 0.0f, null, 6, null);
            } else {
                Placeable.PlacementScope.m3924placeRelativeWithLayeraW9wM$default(scope, placeable, IntOffset2, 0.0f, null, 6, null);
            }
        }
    }
    ...
    private final long m615copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
