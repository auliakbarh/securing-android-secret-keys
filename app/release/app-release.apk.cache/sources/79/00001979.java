...
public final class AndroidDefaultTypeface implements AndroidTypeface {
    ...
    public Typeface mo4625getNativeTypefacePYhJU0U(FontWeight fontWeight, int i, int i2) {
        ...
        if (Build.VERSION.SDK_INT < 28) {
            Typeface defaultFromStyle = Typeface.defaultFromStyle(AndroidFontUtils_androidKt.m4453getAndroidTypefaceStyleFO1MlWM(fontWeight, i));
        ...
        return typefaceHelperMethodsApi28.create(DEFAULT, fontWeight.getWeight(), FontStyle.m4499equalsimpl0(i, FontStyle.Companion.m4503getItalic_LCdwA()));
    }
}