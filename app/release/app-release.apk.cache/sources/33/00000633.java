...
final class GridSlotCache implements Function2<Density, Constraints, LazyGridSlots> {
    ...
    public /* bridge */ /* synthetic */ LazyGridSlots invoke(Density density, Constraints constraints) {
        return m602invoke0kLqBqw(density, constraints.m4834unboximpl());
    }

    /* renamed from: invoke-0kLqBqw  reason: not valid java name */
    public LazyGridSlots m602invoke0kLqBqw(Density density, long j) {
        ...
        LazyGridSlots invoke = this.calculation.invoke(density, Constraints.m4816boximpl(j));
