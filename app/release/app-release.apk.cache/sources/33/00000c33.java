...
public final class DividerKt {
    ...
    public static final void m1175Divider9IZ8Weo(Modifier modifier, float f, long j, Composer composer, final int i, final int i2) {
        int i3;
        float f2;
        ...
        if ((i3 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            if ((i & 1) == 0 || startRestartGroup.getDefaultsInvalid()) {
                ...
                if (i5 != 0) {
                    f = DividerDefaults.INSTANCE.m1174getThicknessD9Ej5fM();
                }
                if ((i2 & 4) != 0) {
            ...
            if (Dp.m4877equalsimpl0(f, Dp.Companion.m4890getHairlineD9Ej5fM())) {
                ComposerKt.sourceInformationMarkerStart(startRestartGroup, 2023513938, "CC:CompositionLocal.kt#9igjgp");
                Object consume = startRestartGroup.consume(CompositionLocalsKt.getLocalDensity());
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                f2 = Dp.m4872constructorimpl(1.0f / ((Density) consume).getDensity());
            } else {
                f2 = f;
            }
            startRestartGroup.endReplaceableGroup();
            BoxKt.Box(BackgroundKt.m158backgroundbw27NRU$default(SizeKt.m512height3ABfNKs(SizeKt.fillMaxWidth$default(modifier, 0.0f, 1, null), f2), j, null, 2, null), startRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DividerKt$Divider$1
            ...
            public final void invoke(Composer composer2, int i6) {
                DividerKt.m1175Divider9IZ8Weo(Modifier.this, f3, j2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
}