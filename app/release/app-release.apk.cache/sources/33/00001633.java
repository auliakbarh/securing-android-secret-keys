...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    public void m4033setPositiongyyYBs(long j) {
        this.position = j;
    }

    /* renamed from: access$setMeasurementConstraints-BRTryo0 */
    public static final /* synthetic */ void m4030access$setMeasurementConstraintsBRTryo0(LookaheadDelegate lookaheadDelegate, long j) {
        lookaheadDelegate.m3921setMeasurementConstraintsBRTryo0(j);
    }
    ...
    public final void set_measureResult(MeasureResult measureResult) {
        ...
        if (measureResult != null) {
            m3920setMeasuredSizeozmzZPI(IntSizeKt.IntSize(measureResult.getWidth(), measureResult.getHeight()));
            unit = Unit.INSTANCE;
        } else {
            unit = null;
        }
        if (unit == null) {
            m3920setMeasuredSizeozmzZPI(IntSize.Companion.m5037getZeroYbymL2g());
        }
    ...
    public void replace$ui_release() {
        mo3866placeAtf8xVGno(mo4029getPositionnOccac(), 0.0f, null);
    }

    @Override // androidx.compose.ui.layout.Placeable
    /* renamed from: placeAt-f8xVGno */
    public final void mo3866placeAtf8xVGno(long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
        if (!IntOffset.m4989equalsimpl0(mo4029getPositionnOccac(), j)) {
            m4033setPositiongyyYBs(j);
    ...
    public final Placeable m4031performingMeasureK40F9xA(long j, Function0<? extends MeasureResult> block) {
    ...
    public final long m4032positionInBjo55l4$ui_release(LookaheadDelegate ancestor) {
        Intrinsics.checkNotNullParameter(ancestor, "ancestor");
        long m5000getZeronOccac = IntOffset.Companion.m5000getZeronOccac();
        LookaheadDelegate lookaheadDelegate = this;
        while (!Intrinsics.areEqual(lookaheadDelegate, ancestor)) {
            long mo4029getPositionnOccac = lookaheadDelegate.mo4029getPositionnOccac();
            m5000getZeronOccac = IntOffsetKt.IntOffset(IntOffset.m4990getXimpl(m5000getZeronOccac) + IntOffset.m4990getXimpl(mo4029getPositionnOccac), IntOffset.m4991getYimpl(m5000getZeronOccac) + IntOffset.m4991getYimpl(mo4029getPositionnOccac));
