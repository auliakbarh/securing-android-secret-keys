...
public final class SwipeableV2State<T> {
    ...
    public final float m1491getVelocityThresholdD9Ej5fM$material3_release() {
    ...
    private SwipeableV2State(T t, AnimationSpec<Float> animationSpec, Function1<? super T, Boolean> confirmValueChange, Function2<? super Density, ? super Float, Float> positionalThreshold, float f) {
        ...
        this.targetValue$delegate = SnapshotStateKt.derivedStateOf(new Function0<T>(this) { // from class: androidx.compose.material3.SwipeableV2State$targetValue$2
            ...
            public final T invoke() {
                T t2 = (T) SwipeableV2State.access$getAnimationTarget(this.this$0);
                if (t2 == null) {
                    SwipeableV2State<T> swipeableV2State = this.this$0;
                    Float offset = swipeableV2State.getOffset();
                    if (offset != null) {
                        return (T) SwipeableV2State.access$computeTarget(swipeableV2State, offset.floatValue(), swipeableV2State.getCurrentValue(), 0.0f);
                    }
        ...
        this.progress$delegate = SnapshotStateKt.derivedStateOf(new Function0<Float>(this) { // from class: androidx.compose.material3.SwipeableV2State$progress$2
            final /* synthetic */ SwipeableV2State<T> this$0;
        ...
        this.minOffset$delegate = SnapshotStateKt.derivedStateOf(new Function0<Float>(this) { // from class: androidx.compose.material3.SwipeableV2State$minOffset$2
            final /* synthetic */ SwipeableV2State<T> this$0;
        ...
        this.maxOffset$delegate = SnapshotStateKt.derivedStateOf(new Function0<Float>(this) { // from class: androidx.compose.material3.SwipeableV2State$maxOffset$2
            final /* synthetic */ SwipeableV2State<T> this$0;
    ...
    public static final /* synthetic */ Object access$computeTarget(SwipeableV2State swipeableV2State, float f, Object obj, float f2) {
        return swipeableV2State.computeTarget(f, obj, f2);
    }

    public static final /* synthetic */ Object access$getAnimationTarget(SwipeableV2State swipeableV2State) {
        return swipeableV2State.getAnimationTarget();
    }

    public static final /* synthetic */ void access$snap(SwipeableV2State swipeableV2State, Object obj) {
        swipeableV2State.snap(obj);
    }

    public /* synthetic */ SwipeableV2State(Object obj, SpringSpec<Float> springSpec, AnonymousClass1 anonymousClass1, Function2<Density, Float, Float> function2, float f, int i, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        } : anonymousClass1, (i & 8) != 0 ? SwipeableV2Defaults.INSTANCE.getPositionalThreshold() : function2, (i & 16) != 0 ? SwipeableV2Defaults.INSTANCE.m1488getVelocityThresholdD9Ej5fM() : f, null);
    }
    ...
    */
    ...
    public final T computeTarget(float f, T t, float f2) {
        ...
        float mo324toPx0680j_4 = requireDensity.mo324toPx0680j_4(this.velocityThreshold);
        if (Intrinsics.areEqual(f3, f) || f3 == null) {
            return t;
        }
        if (f3.floatValue() < f) {
            if (f2 >= mo324toPx0680j_4) {
                closestAnchor3 = SwipeableV2Kt.closestAnchor(anchors$material3_release, f, true);
                return (T) closestAnchor3;
            }
            closestAnchor = SwipeableV2Kt.closestAnchor(anchors$material3_release, f, true);
            if (f < Math.abs(f3.floatValue() + Math.abs(this.positionalThreshold.invoke(requireDensity, Float.valueOf(Math.abs(((Number) MapsKt.getValue(anchors$material3_release, closestAnchor)).floatValue() - f3.floatValue()))).floatValue()))) {
                return t;
            }
        } else if (f2 <= (-mo324toPx0680j_4)) {
            closestAnchor2 = SwipeableV2Kt.closestAnchor(anchors$material3_release, f, false);
            return (T) closestAnchor2;
        } else {
            closestAnchor = SwipeableV2Kt.closestAnchor(anchors$material3_release, f, false);
            float abs = Math.abs(f3.floatValue() - Math.abs(this.positionalThreshold.invoke(requireDensity, Float.valueOf(Math.abs(f3.floatValue() - ((Number) MapsKt.getValue(anchors$material3_release, closestAnchor)).floatValue()))).floatValue()));
            if (f < 0.0f) {
                if (Math.abs(f) < abs) {
                    return t;
                }
    ...
    public final boolean trySnapTo$material3_release(final T t) {
        return this.swipeMutex.tryMutate(new Function0<Unit>(this) { // from class: androidx.compose.material3.SwipeableV2State$trySnapTo$1
            ...
            public final void invoke2() {
                SwipeableV2State.access$snap(this.this$0, t);
            }
        });
    }
    ...
    public static final class Companion {
        ...
        public final <T> Saver<SwipeableV2State<T>, T> m1492SavereqLRuRQ(final AnimationSpec<Float> animationSpec, final Function1<? super T, Boolean> confirmValueChange, final Function2<? super Density, ? super Float, Float> positionalThreshold, final float f) {
            Intrinsics.checkNotNullParameter(animationSpec, "animationSpec");
            Intrinsics.checkNotNullParameter(confirmValueChange, "confirmValueChange");
            Intrinsics.checkNotNullParameter(positionalThreshold, "positionalThreshold");
