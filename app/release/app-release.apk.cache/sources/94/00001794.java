    ...
    private static final boolean calculateIfHorizontallyStacked(List<SemanticsNode> list) {
        ...
        if (list.size() == 0 || list.size() == 1) {
            ...
            while (i < lastIndex) {
                ...
                emptyList.add(Offset.m2378boximpl(OffsetKt.Offset(Math.abs(Offset.m2389getXimpl(semanticsNode4.getBoundsInRoot().m2419getCenterF1C5BW0()) - Offset.m2389getXimpl(semanticsNode3.getBoundsInRoot().m2419getCenterF1C5BW0())), Math.abs(Offset.m2390getYimpl(semanticsNode4.getBoundsInRoot().m2419getCenterF1C5BW0()) - Offset.m2390getYimpl(semanticsNode3.getBoundsInRoot().m2419getCenterF1C5BW0())))));
                semanticsNode = semanticsNode2;
            }
        }
        if (emptyList.size() == 1) {
            m2399unboximpl = ((Offset) CollectionsKt.first((List<? extends Object>) emptyList)).m2399unboximpl();
            ...
            if (1 <= lastIndex2) {
                int i2 = 1;
                while (true) {
                    first = Offset.m2378boximpl(Offset.m2394plusMKHz9U(((Offset) first).m2399unboximpl(), ((Offset) emptyList.get(i2)).m2399unboximpl()));
                    if (i2 == lastIndex2) {
                        break;
                    }
                    i2++;
            ...
            m2399unboximpl = ((Offset) first).m2399unboximpl();
        }
        return Offset.m2380component2impl(m2399unboximpl) < Offset.m2379component1impl(m2399unboximpl);
    }
