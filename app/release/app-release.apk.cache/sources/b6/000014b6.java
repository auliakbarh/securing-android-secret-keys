...
public final class PointerEventKt {
    ...
    public static final boolean positionChanged(PointerInputChange pointerInputChange) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "<this>");
        return !Offset.m2386equalsimpl0(positionChangeInternal(pointerInputChange, false), Offset.Companion.m2405getZeroF1C5BW0());
    }

    public static final boolean positionChangedIgnoreConsumed(PointerInputChange pointerInputChange) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "<this>");
        return !Offset.m2386equalsimpl0(positionChangeInternal(pointerInputChange, true), Offset.Companion.m2405getZeroF1C5BW0());
    }
    ...
    private static final long positionChangeInternal(PointerInputChange pointerInputChange, boolean z) {
        long m2393minusMKHz9U = Offset.m2393minusMKHz9U(pointerInputChange.m3747getPositionF1C5BW0(), pointerInputChange.m3748getPreviousPositionF1C5BW0());
        return (z || !pointerInputChange.isConsumed()) ? m2393minusMKHz9U : Offset.Companion.m2405getZeroF1C5BW0();
    }
    ...
    public static final void consumePositionChange(PointerInputChange pointerInputChange) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "<this>");
        if (Offset.m2386equalsimpl0(positionChange(pointerInputChange), Offset.Companion.m2405getZeroF1C5BW0())) {
            return;
        }
        pointerInputChange.consume();
    }
    ...
    public static final boolean m3692isOutOfBoundsO0kMr_c(PointerInputChange isOutOfBounds, long j) {
        Intrinsics.checkNotNullParameter(isOutOfBounds, "$this$isOutOfBounds");
        long m3747getPositionF1C5BW0 = isOutOfBounds.m3747getPositionF1C5BW0();
        float m2389getXimpl = Offset.m2389getXimpl(m3747getPositionF1C5BW0);
        float m2390getYimpl = Offset.m2390getYimpl(m3747getPositionF1C5BW0);
        return m2389getXimpl < 0.0f || m2389getXimpl > ((float) IntSize.m5032getWidthimpl(j)) || m2390getYimpl < 0.0f || m2390getYimpl > ((float) IntSize.m5031getHeightimpl(j));
    }

    /* renamed from: isOutOfBounds-jwHxaWs  reason: not valid java name */
    public static final boolean m3693isOutOfBoundsjwHxaWs(PointerInputChange isOutOfBounds, long j, long j2) {
        Intrinsics.checkNotNullParameter(isOutOfBounds, "$this$isOutOfBounds");
        if (!PointerType.m3818equalsimpl0(isOutOfBounds.m3750getTypeT8wyACA(), PointerType.Companion.m3825getTouchT8wyACA())) {
            return m3692isOutOfBoundsO0kMr_c(isOutOfBounds, j);
        }
        long m3747getPositionF1C5BW0 = isOutOfBounds.m3747getPositionF1C5BW0();
        float m2389getXimpl = Offset.m2389getXimpl(m3747getPositionF1C5BW0);
        float m2390getYimpl = Offset.m2390getYimpl(m3747getPositionF1C5BW0);
        return m2389getXimpl < (-Size.m2458getWidthimpl(j2)) || m2389getXimpl > ((float) IntSize.m5032getWidthimpl(j)) + Size.m2458getWidthimpl(j2) || m2390getYimpl < (-Size.m2455getHeightimpl(j2)) || m2390getYimpl > ((float) IntSize.m5031getHeightimpl(j)) + Size.m2455getHeightimpl(j2);
    }
}