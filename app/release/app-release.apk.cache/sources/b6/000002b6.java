...
public final class BorderKt {
    ...
    public static final Modifier border(Modifier modifier, BorderStroke border, Shape shape) {
        ...
        return m171borderziNgDLE(modifier, border.m184getWidthD9Ej5fM(), border.getBrush(), shape);
    }

    /* renamed from: border-xT4_qwU$default  reason: not valid java name */
    public static /* synthetic */ Modifier m170borderxT4_qwU$default(Modifier modifier, float f, long j, Shape shape, int i, Object obj) {
        if ((i & 4) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        return m169borderxT4_qwU(modifier, f, j, shape);
    }

    /* renamed from: border-xT4_qwU  reason: not valid java name */
    public static final Modifier m169borderxT4_qwU(Modifier border, float f, long j, Shape shape) {
        Intrinsics.checkNotNullParameter(border, "$this$border");
        Intrinsics.checkNotNullParameter(shape, "shape");
        return m171borderziNgDLE(border, f, new SolidColor(j, null), shape);
    }

    /* renamed from: border-ziNgDLE  reason: not valid java name */
    public static final Modifier m171borderziNgDLE(Modifier border, float f, Brush brush, Shape shape) {
        Intrinsics.checkNotNullParameter(border, "$this$border");
    ...
    public static final DrawResult m172drawRectBorderNsqcLGU(CacheDrawScope cacheDrawScope, final Brush brush, long j, long j2, boolean z, float f) {
        final long m2405getZeroF1C5BW0 = z ? Offset.Companion.m2405getZeroF1C5BW0() : j;
        final long m2295getSizeNHjbRc = z ? cacheDrawScope.m2295getSizeNHjbRc() : j2;
        ...
        return cacheDrawScope.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.BorderKt$drawRectBorder$1
            ...
            public final void invoke2(ContentDrawScope onDrawWithContent) {
                Intrinsics.checkNotNullParameter(onDrawWithContent, "$this$onDrawWithContent");
                onDrawWithContent.drawContent();
                DrawScope.m3165drawRectAsUm42w$default(onDrawWithContent, Brush.this, m2405getZeroF1C5BW0, m2295getSizeNHjbRc, 0.0f, stroke, null, 0, LocationRequestCompat.QUALITY_LOW_POWER, null);
            }
        });
    }
    ...
    public static final Path createRoundRectPath(Path path, RoundRect roundRect, float f, boolean z) {
        ...
        if (!z) {
            ...
            path.mo2522opN5in7k0(path, Path, PathOperation.Companion.m2913getDifferenceb3I0S0c());
        }
        return path;
    }

    private static final RoundRect createInsetRoundedRect(float f, RoundRect roundRect) {
        return new RoundRect(f, f, roundRect.getWidth() - f, roundRect.getHeight() - f, m173shrinkKibmq7A(roundRect.m2439getTopLeftCornerRadiuskKHJgLs(), f), m173shrinkKibmq7A(roundRect.m2440getTopRightCornerRadiuskKHJgLs(), f), m173shrinkKibmq7A(roundRect.m2438getBottomRightCornerRadiuskKHJgLs(), f), m173shrinkKibmq7A(roundRect.m2437getBottomLeftCornerRadiuskKHJgLs(), f), null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: shrink-Kibmq7A  reason: not valid java name */
    public static final long m173shrinkKibmq7A(long j, float f) {
        return CornerRadiusKt.CornerRadius(Math.max(0.0f, CornerRadius.m2364getXimpl(j) - f), Math.max(0.0f, CornerRadius.m2365getYimpl(j) - f));
    }
}