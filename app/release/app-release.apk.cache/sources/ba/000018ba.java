...
public abstract class AndroidPreloadedFont extends AndroidFont {
    ...
    public final int mo4454getStyle_LCdwA() {
        return this.style;
    }
    ...
    private AndroidPreloadedFont(FontWeight weight, int i, FontVariation.Settings variationSettings) {
        super(FontLoadingStrategy.Companion.m4491getBlockingPKNRLFQ(), AndroidPreloadedFontTypefaceLoader.INSTANCE, variationSettings, null);
