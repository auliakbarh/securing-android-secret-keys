...
public final class SweepGradient extends ShaderBrush {
    ...
    public Shader mo2597createShaderuvyYCjk(long j) {
        ...
        if (OffsetKt.m2410isUnspecifiedk4lQ0M(this.center)) {
            Offset = SizeKt.m2468getCenteruvyYCjk(j);
        } else {
            Offset = OffsetKt.Offset(Offset.m2389getXimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m2458getWidthimpl(j) : Offset.m2389getXimpl(this.center), Offset.m2390getYimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m2455getHeightimpl(j) : Offset.m2390getYimpl(this.center));
        }
        return ShaderKt.m2940SweepGradientShader9KIMszo(Offset, this.colors, this.stops);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SweepGradient) {
            ...
            return Offset.m2386equalsimpl0(this.center, sweepGradient.center) && Intrinsics.areEqual(this.colors, sweepGradient.colors) && Intrinsics.areEqual(this.stops, sweepGradient.stops);
        }
        return false;
    }

    public int hashCode() {
        int m2391hashCodeimpl = ((Offset.m2391hashCodeimpl(this.center) * 31) + this.colors.hashCode()) * 31;
        List<Float> list = this.stops;
        return m2391hashCodeimpl + (list != null ? list.hashCode() : 0);
    }

    public String toString() {
        return "SweepGradient(" + (OffsetKt.m2408isSpecifiedk4lQ0M(this.center) ? "center=" + ((Object) Offset.m2397toStringimpl(this.center)) + ", " : "") + "colors=" + this.colors + ", stops=" + this.stops + ')';
    }
}