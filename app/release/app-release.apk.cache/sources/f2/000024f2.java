...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object mo6663trySendJP2dKIU = sendChannel.mo6663trySendJP2dKIU(e);
        if (!(mo6663trySendJP2dKIU instanceof ChannelResult.Failed)) {
            Unit unit = (Unit) mo6663trySendJP2dKIU;
            return ChannelResult.Companion.m6683successJP2dKIU(Unit.INSTANCE);
        }
        return ((ChannelResult) BuildersKt.runBlocking$default(null, new ChannelsKt__ChannelsKt$trySendBlocking$2(sendChannel, e, null), 1, null)).m6680unboximpl();
    }
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m6678isSuccessimpl(sendChannel.mo6663trySendJP2dKIU(e))) {
            return;
        }
