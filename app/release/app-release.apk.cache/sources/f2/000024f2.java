...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object mo6666trySendJP2dKIU = sendChannel.mo6666trySendJP2dKIU(e);
        if (!(mo6666trySendJP2dKIU instanceof ChannelResult.Failed)) {
            Unit unit = (Unit) mo6666trySendJP2dKIU;
            return ChannelResult.Companion.m6686successJP2dKIU(Unit.INSTANCE);
        }
        return ((ChannelResult) BuildersKt.runBlocking$default(null, new ChannelsKt__ChannelsKt$trySendBlocking$2(sendChannel, e, null), 1, null)).m6683unboximpl();
    }
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m6681isSuccessimpl(sendChannel.mo6666trySendJP2dKIU(e))) {
            return;
        }
