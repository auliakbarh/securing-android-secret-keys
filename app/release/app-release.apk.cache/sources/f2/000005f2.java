...
public final class LazyListBeyondBoundsState implements LazyLayoutBeyondBoundsState {
    ...
    public int getLastPlacedIndex() {
        return Math.min(getItemCount() - 1, ((LazyListItemInfo) CollectionsKt.last((List<? extends Object>) this.state.getLayoutInfo().getVisibleItemsInfo())).getIndex() + this.beyondBoundsItemCount);
    }
}