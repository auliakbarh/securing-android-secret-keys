...
public final class FontListFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public final Object preload(FontFamily fontFamily, PlatformFontLoader platformFontLoader, Continuation<? super Unit> continuation) {
        if (fontFamily instanceof FontListFontFamily) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (FontLoadingStrategy.m4486equalsimpl0(font.mo4446getLoadingStrategyPKNRLFQ(), FontLoadingStrategy.Companion.m4490getAsyncPKNRLFQ())) {
                    arrayList.add(font);
                }
            }
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                arrayList3.add(TuplesKt.to(font2.getWeight(), FontStyle.m4496boximpl(font2.mo4454getStyle_LCdwA())));
            }
            ...
            for (int i4 = 0; i4 < size4; i4++) {
                ...
                int m4502unboximpl = ((FontStyle) pair.component2()).m4502unboximpl();
                List list = (List) FontListFontFamilyTypefaceAdapterKt.access$firstImmediatelyAvailable(fontMatcher.m4495matchFontRetOiIg(fonts, fontWeight, m4502unboximpl), new TypefaceRequest(fontFamily, fontWeight, m4502unboximpl, FontSynthesis.Companion.m4514getAllGVVA2EU(), platformFontLoader.getCacheKey(), null), this.asyncTypefaceCache, platformFontLoader, new Function1<TypefaceRequest, Unit>() { // from class: androidx.compose.ui.text.font.FontListFontFamilyTypefaceAdapter$preload$2$1
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        ...
        if (typefaceRequest.getFontFamily() instanceof FontListFontFamily) {
            Pair access$firstImmediatelyAvailable = FontListFontFamilyTypefaceAdapterKt.access$firstImmediatelyAvailable(fontMatcher.m4495matchFontRetOiIg(((FontListFontFamily) typefaceRequest.getFontFamily()).getFonts(), typefaceRequest.getFontWeight(), typefaceRequest.m4542getFontStyle_LCdwA()), typefaceRequest, this.asyncTypefaceCache, platformFontLoader, createDefaultTypeface);
