...
final class CombinedClickableNode extends AbstractClickableNode {
    ...
    public final void m208updatecJG_KMw(MutableInteractionSource interactionSource, boolean z, String str, Role role, Function0<Unit> onClick, String str2, Function0<Unit> function0, Function0<Unit> function02) {
        Intrinsics.checkNotNullParameter(interactionSource, "interactionSource");
        Intrinsics.checkNotNullParameter(onClick, "onClick");
        ...
        this.onLongClick = function0;
        m143updateCommonXHw0xAI(interactionSource, z, str, role, onClick);
        getClickableSemanticsNode().m203updateUMe6uN4(z, str, role, onClick, str2, function0);
        getClickablePointerInputNode().update(z, interactionSource, onClick, function0, function02);
    }
}