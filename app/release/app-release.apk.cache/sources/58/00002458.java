        ...
        try {
            ...
            if (job != null && !job.isActive()) {
                ...
                if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                    ...
                    continuation.resumeWith(Result.m5155constructorimpl(ResultKt.createFailure(cancellationException)));
                }
                cancellationException = cancellationException2;
                continuation.resumeWith(Result.m5155constructorimpl(ResultKt.createFailure(cancellationException)));
            } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                Result.Companion companion2 = Result.Companion;
                continuation.resumeWith(Result.m5155constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
            } else {
                Result.Companion companion3 = Result.Companion;
                continuation.resumeWith(Result.m5155constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(takeState$kotlinx_coroutines_core)));
            }
            ...
            try {
                ...
                m5155constructorimpl2 = Result.m5155constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion5 = Result.Companion;
                m5155constructorimpl2 = Result.m5155constructorimpl(ResultKt.createFailure(th));
            }
            handleFatalException(null, Result.m5158exceptionOrNullimpl(m5155constructorimpl2));
        } catch (Throwable th2) {
            try {
                ...
                m5155constructorimpl = Result.m5155constructorimpl(ResultKt.createFailure(th3));
            }
            handleFatalException(th2, Result.m5158exceptionOrNullimpl(m5155constructorimpl));
        }
    }
