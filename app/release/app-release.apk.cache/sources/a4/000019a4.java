...
public final class ColorStyle implements TextForegroundStyle {
    ...
    public static /* synthetic */ ColorStyle m4674copy8_81llA$default(ColorStyle colorStyle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = colorStyle.value;
        }
        return colorStyle.m4676copy8_81llA(j);
    }

    /* renamed from: component1-0d7_KjU  reason: not valid java name */
    public final long m4675component10d7_KjU() {
        return this.value;
    }

    /* renamed from: copy-8_81llA  reason: not valid java name */
    public final ColorStyle m4676copy8_81llA(long j) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof ColorStyle) && Color.m2629equalsimpl0(this.value, ((ColorStyle) obj).value);
    }
    ...
    public long mo4673getColor0d7_KjU() {
        return this.value;
    }

    /* renamed from: getValue-0d7_KjU  reason: not valid java name */
    public final long m4677getValue0d7_KjU() {
        return this.value;
    }

    public int hashCode() {
        return Color.m2635hashCodeimpl(this.value);
    }

    public String toString() {
        return "ColorStyle(value=" + ((Object) Color.m2636toStringimpl(this.value)) + ')';
    }
    ...
    public float getAlpha() {
        return Color.m2630getAlphaimpl(mo4673getColor0d7_KjU());
    }
}