...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo957defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long m967defaultRippleColor5vOe2sY = RippleTheme.Companion.m967defaultRippleColor5vOe2sY(Color.Companion.m2654getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m967defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        RippleAlpha m966defaultRippleAlphaDxMtmZc = RippleTheme.Companion.m966defaultRippleAlphaDxMtmZc(Color.Companion.m2654getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m966defaultRippleAlphaDxMtmZc;
    }
}