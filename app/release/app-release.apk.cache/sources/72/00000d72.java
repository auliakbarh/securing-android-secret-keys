...
public final class ProgressIndicatorDefaults {
    ...
    private static final float CircularStrokeWidth = CircularProgressIndicatorTokens.INSTANCE.m1715getActiveIndicatorWidthD9Ej5fM();
    private static final int LinearStrokeCap = StrokeCap.Companion.m2974getButtKaPHkGw();
    private static final int CircularDeterminateStrokeCap = StrokeCap.Companion.m2974getButtKaPHkGw();
    private static final int CircularIndeterminateStrokeCap = StrokeCap.Companion.m2976getSquareKaPHkGw();
    ...
    public final long getCircularTrackColor(Composer composer, int i) {
        ...
        long m2663getTransparent0d7_KjU = Color.Companion.m2663getTransparent0d7_KjU();
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m2663getTransparent0d7_KjU;
    }
}