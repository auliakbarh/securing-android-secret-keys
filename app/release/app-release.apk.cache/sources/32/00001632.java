...
public abstract class LookaheadCapablePlaceable extends Placeable implements MeasureScopeWithLayoutNode {
    ...
    public abstract long mo4029getPositionnOccac();
    ...
    public final int get(AlignmentLine alignmentLine) {
        ...
        if (getHasMeasureResult() && (calculateAlignmentLine = calculateAlignmentLine(alignmentLine)) != Integer.MIN_VALUE) {
            if (alignmentLine instanceof VerticalAlignmentLine) {
                m4991getYimpl = IntOffset.m4990getXimpl(m3917getApparentToRealOffsetnOccac());
            } else {
                m4991getYimpl = IntOffset.m4991getYimpl(m3917getApparentToRealOffsetnOccac());
            }
            return calculateAlignmentLine + m4991getYimpl;
        }
