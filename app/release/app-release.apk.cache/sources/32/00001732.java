...
public final class LayerMatrixCache<T> {
    ...
    public final float[] m4197calculateMatrixGrdbGEg(T t) {
        float[] fArr = this.matrixCache;
        if (fArr == null) {
            fArr = androidx.compose.ui.graphics.Matrix.m2853constructorimpl$default(null, 1, null);
        ...
        if (this.isDirty) {
            ...
            if (matrix2 == null || !Intrinsics.areEqual(matrix, matrix2)) {
                AndroidMatrixConversions_androidKt.m2501setFromtUYjHk(fArr, matrix);
    ...
    public final float[] m4196calculateInverseMatrixbWbORWo(T t) {
        ...
        if (this.isInverseDirty) {
            this.isInverseValid = InvertMatrixKt.m4194invertToJiSxe2E(m4197calculateMatrixGrdbGEg(t), fArr);
