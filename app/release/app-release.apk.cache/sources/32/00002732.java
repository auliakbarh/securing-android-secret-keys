...
public final class SelectBuilderImpl<R> extends LockFreeLinkedListHead implements SelectBuilder<R>, SelectInstance<R>, Continuation<R>, CoroutineStackFrame {
    ...
    public final void handleBuilderException(Throwable th) {
        if (trySelect()) {
            ...
            resumeWith(Result.m5154constructorimpl(ResultKt.createFailure(th)));
    ...
    public void resumeWith(Object obj) {
        ...
        while (true) {
            ...
            if (obj2 == SelectKt.access$getUNDECIDED$p()) {
                ...
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_result$FU, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.access$getRESUMED$p())) {
                    if (Result.m5160isFailureimpl(obj)) {
                        Continuation<R> continuation = this.uCont;
                        Throwable m5157exceptionOrNullimpl = Result.m5157exceptionOrNullimpl(obj);
                        Intrinsics.checkNotNull(m5157exceptionOrNullimpl);
                        Result.Companion companion = Result.Companion;
                        if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                            m5157exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(m5157exceptionOrNullimpl, (CoroutineStackFrame) continuation);
                        }
                        continuation.resumeWith(Result.m5154constructorimpl(ResultKt.createFailure(m5157exceptionOrNullimpl)));
                        return;
                    }
        ...
        while (true) {
            ...
            if (obj == SelectKt.access$getUNDECIDED$p()) {
                ...
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_result$FU, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.access$getRESUMED$p())) {
                    ...
                    Result.Companion companion = Result.Companion;
                    intercepted.resumeWith(Result.m5154constructorimpl(ResultKt.createFailure(th)));
                    return;
                }
            }
        }
