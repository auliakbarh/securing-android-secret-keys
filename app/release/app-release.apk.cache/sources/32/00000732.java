...
public final class LazyStaggeredGridKt {
    public static final /* synthetic */ void access$ScrollPositionUpdater(Function0 function0, LazyStaggeredGridState lazyStaggeredGridState, Composer composer, int i) {
        ScrollPositionUpdater(function0, lazyStaggeredGridState, composer, i);
    }

    /* renamed from: LazyStaggeredGrid-LJWHXA8 */
    public static final void m655LazyStaggeredGridLJWHXA8(final LazyStaggeredGridState state, final Orientation orientation, final Function2<? super Density, ? super Constraints, LazyStaggeredGridSlots> slots, Modifier modifier, PaddingValues paddingValues, boolean z, FlingBehavior flingBehavior, boolean z2, float f, float f2, final Function1<? super LazyStaggeredGridScope, Unit> content, Composer composer, final int i, final int i2, final int i3) {
        ...
        PaddingValues m472PaddingValues0680j_4 = (i3 & 16) != 0 ? PaddingKt.m472PaddingValues0680j_4(Dp.m4872constructorimpl(0)) : paddingValues;
        ...
        float m4872constructorimpl = (i3 & 256) != 0 ? Dp.m4872constructorimpl(0) : f;
        float m4872constructorimpl2 = (i3 & 512) != 0 ? Dp.m4872constructorimpl(0) : f2;
        ...
        Function2<LazyLayoutMeasureScope, Constraints, LazyStaggeredGridMeasureResult> m664rememberStaggeredGridMeasurePolicynbWgWpA = LazyStaggeredGridMeasurePolicyKt.m664rememberStaggeredGridMeasurePolicynbWgWpA(state, rememberStaggeredGridItemProviderLambda, m472PaddingValues0680j_4, z3, orientation, m4872constructorimpl, m4872constructorimpl2, slots, startRestartGroup, (i5 & 7168) | (i5 & 896) | 8 | ((i4 << 9) & 57344) | (i6 & 458752) | (3670016 & i6) | ((i4 << 15) & 29360128));
        ...
        final boolean z6 = z4;
        final float f3 = m4872constructorimpl;
        final float f4 = m4872constructorimpl2;
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridKt$LazyStaggeredGrid$1
            ...
            public final void invoke(Composer composer2, int i9) {
                LazyStaggeredGridKt.m655LazyStaggeredGridLJWHXA8(LazyStaggeredGridState.this, orientation, slots, modifier2, paddingValues2, z5, flingBehavior3, z6, f3, f4, content, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), RecomposeScopeImplKt.updateChangedFlags(i2), i3);
            }
        });
    }
    ...
    public static final void ScrollPositionUpdater(final Function0<? extends LazyLayoutItemProvider> function0, final LazyStaggeredGridState lazyStaggeredGridState, Composer composer, final int i) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridKt$ScrollPositionUpdater$1
            ...
            public final void invoke(Composer composer2, int i2) {
                LazyStaggeredGridKt.access$ScrollPositionUpdater(function0, lazyStaggeredGridState, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
}