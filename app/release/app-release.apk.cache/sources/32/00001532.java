...
public interface LayoutCoordinates {
    ...
    long mo3873localPositionOfR5De75A(LayoutCoordinates layoutCoordinates, long j);

    /* renamed from: localToRoot-MK-Hz9U  reason: not valid java name */
    long mo3874localToRootMKHz9U(long j);

    /* renamed from: localToWindow-MK-Hz9U  reason: not valid java name */
    long mo3875localToWindowMKHz9U(long j);

    /* renamed from: windowToLocal-MK-Hz9U  reason: not valid java name */
    long mo3877windowToLocalMKHz9U(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static void m3878transformFromEL8BTi8(LayoutCoordinates layoutCoordinates, LayoutCoordinates sourceCoordinates, float[] matrix) {
            Intrinsics.checkNotNullParameter(sourceCoordinates, "sourceCoordinates");
            Intrinsics.checkNotNullParameter(matrix, "matrix");
            LayoutCoordinates.super.mo3876transformFromEL8BTi8(sourceCoordinates, matrix);
        }
    }
    ...
    /* renamed from: transformFrom-EL8BTi8  reason: not valid java name */
    default void mo3876transformFromEL8BTi8(LayoutCoordinates sourceCoordinates, float[] matrix) {
        Intrinsics.checkNotNullParameter(sourceCoordinates, "sourceCoordinates");
        Intrinsics.checkNotNullParameter(matrix, "matrix");
