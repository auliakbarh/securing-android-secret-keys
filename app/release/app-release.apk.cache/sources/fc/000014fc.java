...
public final class VelocityTrackerKt {
    ...
    public static final void addPointerInputChange(VelocityTracker velocityTracker, PointerInputChange event) {
        ...
        if (PointerEventKt.changedToDownIgnoreConsumed(event)) {
            velocityTracker.m3841setCurrentPointerPositionAccumulatork4lQ0M$ui_release(event.m3747getPositionF1C5BW0());
            velocityTracker.resetTracking();
        }
        long m3748getPreviousPositionF1C5BW0 = event.m3748getPreviousPositionF1C5BW0();
        List<HistoricalChange> historical = event.getHistorical();
        int size = historical.size();
        int i = 0;
        while (i < size) {
            HistoricalChange historicalChange = historical.get(i);
            long m2393minusMKHz9U = Offset.m2393minusMKHz9U(historicalChange.m3675getPositionF1C5BW0(), m3748getPreviousPositionF1C5BW0);
            long m3675getPositionF1C5BW0 = historicalChange.m3675getPositionF1C5BW0();
            velocityTracker.m3841setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m2394plusMKHz9U(velocityTracker.m3840getCurrentPointerPositionAccumulatorF1C5BW0$ui_release(), m2393minusMKHz9U));
            velocityTracker.m3838addPositionUv8p0NA(historicalChange.getUptimeMillis(), velocityTracker.m3840getCurrentPointerPositionAccumulatorF1C5BW0$ui_release());
            i++;
            m3748getPreviousPositionF1C5BW0 = m3675getPositionF1C5BW0;
        }
        velocityTracker.m3841setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m2394plusMKHz9U(velocityTracker.m3840getCurrentPointerPositionAccumulatorF1C5BW0$ui_release(), Offset.m2393minusMKHz9U(event.m3747getPositionF1C5BW0(), m3748getPreviousPositionF1C5BW0)));
        velocityTracker.m3838addPositionUv8p0NA(event.getUptimeMillis(), velocityTracker.m3840getCurrentPointerPositionAccumulatorF1C5BW0$ui_release());
    }
