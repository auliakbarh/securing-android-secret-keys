...
public final class WrapContentNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo236measure3p2s80s(final MeasureScope measure, Measurable measurable, long j) {
        ...
        int m4830getMinWidthimpl = this.direction != Direction.Vertical ? 0 : Constraints.m4830getMinWidthimpl(j);
        int m4829getMinHeightimpl = this.direction == Direction.Horizontal ? Constraints.m4829getMinHeightimpl(j) : 0;
        int i = Integer.MAX_VALUE;
        int m4828getMaxWidthimpl = (this.direction == Direction.Vertical || !this.unbounded) ? Constraints.m4828getMaxWidthimpl(j) : Integer.MAX_VALUE;
        if (this.direction == Direction.Horizontal || !this.unbounded) {
            i = Constraints.m4827getMaxHeightimpl(j);
        }
        final Placeable mo3865measureBRTryo0 = measurable.mo3865measureBRTryo0(ConstraintsKt.Constraints(m4830getMinWidthimpl, m4828getMaxWidthimpl, m4829getMinHeightimpl, i));
        final int coerceIn = RangesKt.coerceIn(mo3865measureBRTryo0.getWidth(), Constraints.m4830getMinWidthimpl(j), Constraints.m4828getMaxWidthimpl(j));
        final int coerceIn2 = RangesKt.coerceIn(mo3865measureBRTryo0.getHeight(), Constraints.m4829getMinHeightimpl(j), Constraints.m4827getMaxHeightimpl(j));
        return MeasureScope.layout$default(measure, coerceIn, coerceIn2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.WrapContentNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.m3922place70tqf50$default(layout, mo3865measureBRTryo0, WrapContentNode.this.getAlignmentCallback().invoke(IntSize.m5024boximpl(IntSizeKt.IntSize(coerceIn - mo3865measureBRTryo0.getWidth(), coerceIn2 - mo3865measureBRTryo0.getHeight())), measure.getLayoutDirection()).m4999unboximpl(), 0.0f, 2, null);
            }
        }, 4, null);
    }
}