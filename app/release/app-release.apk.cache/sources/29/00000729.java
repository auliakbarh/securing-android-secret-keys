...
public final class LazyStaggeredGridItemProviderImpl implements LazyStaggeredGridItemProvider {
    ...
    public static final /* synthetic */ LazyStaggeredGridIntervalContent access$getIntervalContent$p(LazyStaggeredGridItemProviderImpl lazyStaggeredGridItemProviderImpl) {
        return lazyStaggeredGridItemProviderImpl.intervalContent;
    }
    ...
    public void Item(final int i, final Object key, Composer composer, final int i2) {
        ...
        LazyLayoutPinnableItemKt.LazyLayoutPinnableItem(key, i, this.state.getPinnedItems$foundation_release(), ComposableLambdaKt.composableLambda(startRestartGroup, 608834466, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridItemProviderImpl$Item$1
            ...
            public final void invoke(Composer composer2, int i3) {
                ...
                if ((i3 & 11) != 2 || !composer2.getSkipping()) {
                    ...
                    int i4 = i;
                    IntervalList.Interval<LazyStaggeredGridInterval> interval = LazyStaggeredGridItemProviderImpl.access$getIntervalContent$p(LazyStaggeredGridItemProviderImpl.this).getIntervals().get(i4);
