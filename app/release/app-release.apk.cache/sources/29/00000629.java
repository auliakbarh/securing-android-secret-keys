...
public final class ParentSizeNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo236measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        int m4830getMinWidthimpl = roundToInt != Integer.MAX_VALUE ? roundToInt : Constraints.m4830getMinWidthimpl(j);
        int m4829getMinHeightimpl = roundToInt2 != Integer.MAX_VALUE ? roundToInt2 : Constraints.m4829getMinHeightimpl(j);
        if (roundToInt == Integer.MAX_VALUE) {
            roundToInt = Constraints.m4828getMaxWidthimpl(j);
        }
        if (roundToInt2 == Integer.MAX_VALUE) {
            roundToInt2 = Constraints.m4827getMaxHeightimpl(j);
        }
        final Placeable mo3865measureBRTryo0 = measurable.mo3865measureBRTryo0(ConstraintsKt.Constraints(m4830getMinWidthimpl, roundToInt, m4829getMinHeightimpl, roundToInt2));
        return MeasureScope.layout$default(measure, mo3865measureBRTryo0.getWidth(), mo3865measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.ParentSizeNode$measure$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
