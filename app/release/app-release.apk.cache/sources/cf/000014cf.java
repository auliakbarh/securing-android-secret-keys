...
public final class PointerInputEventData {
    ...
    public final long m3754component1J3iCeTQ() {
        return this.id;
    }

    /* renamed from: component10-F1C5BW0  reason: not valid java name */
    public final long m3755component10F1C5BW0() {
    ...
    public final long m3756component3F1C5BW0() {
        return this.positionOnScreen;
    }

    /* renamed from: component4-F1C5BW0  reason: not valid java name */
    public final long m3757component4F1C5BW0() {
    ...
    public final int m3758component7T8wyACA() {
        return this.type;
    }
    ...
    public final PointerInputEventData m3759copygYeeOSc(long j, long j2, long j3, long j4, boolean z, float f, int i, boolean z2, List<HistoricalChange> historical, long j5) {
    ...
    public final long m3760getIdJ3iCeTQ() {
        return this.id;
    }
    ...
    public final long m3761getPositionF1C5BW0() {
        return this.position;
    }

    /* renamed from: getPositionOnScreen-F1C5BW0  reason: not valid java name */
    public final long m3762getPositionOnScreenF1C5BW0() {
        return this.positionOnScreen;
    }
    ...
    public final long m3763getScrollDeltaF1C5BW0() {
        return this.scrollDelta;
    }

    /* renamed from: getType-T8wyACA  reason: not valid java name */
    public final int m3764getTypeT8wyACA() {
        return this.type;
    }
    ...
    public int hashCode() {
        int m3731hashCodeimpl = ((((((PointerId.m3731hashCodeimpl(this.id) * 31) + Long.hashCode(this.uptime)) * 31) + Offset.m2391hashCodeimpl(this.positionOnScreen)) * 31) + Offset.m2391hashCodeimpl(this.position)) * 31;
        boolean z = this.down;
        int i = z;
        if (z != 0) {
            i = 1;
        }
        int hashCode = (((((m3731hashCodeimpl + i) * 31) + Float.hashCode(this.pressure)) * 31) + PointerType.m3819hashCodeimpl(this.type)) * 31;
        boolean z2 = this.issuesEnterExit;
        return ((((hashCode + (z2 ? 1 : z2 ? 1 : 0)) * 31) + this.historical.hashCode()) * 31) + Offset.m2391hashCodeimpl(this.scrollDelta);
    }

    public String toString() {
        return "PointerInputEventData(id=" + ((Object) PointerId.m3732toStringimpl(this.id)) + ", uptime=" + this.uptime + ", positionOnScreen=" + ((Object) Offset.m2397toStringimpl(this.positionOnScreen)) + ", position=" + ((Object) Offset.m2397toStringimpl(this.position)) + ", down=" + this.down + ", pressure=" + this.pressure + ", type=" + ((Object) PointerType.m3820toStringimpl(this.type)) + ", issuesEnterExit=" + this.issuesEnterExit + ", historical=" + this.historical + ", scrollDelta=" + ((Object) Offset.m2397toStringimpl(this.scrollDelta)) + ')';
    }
    ...
    public /* synthetic */ PointerInputEventData(long j, long j2, long j3, long j4, boolean z, float f, int i, boolean z2, List list, long j5, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, j2, j3, j4, z, f, i, (i2 & 128) != 0 ? false : z2, (i2 & 256) != 0 ? new ArrayList() : list, (i2 & 512) != 0 ? Offset.Companion.m2405getZeroF1C5BW0() : j5, null);
    }
}