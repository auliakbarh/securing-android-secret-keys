...
final class SizeAnimationModifier$animateTo$data$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = Animatable.animateTo$default(this.$this_apply.getAnim(), IntSize.m5024boximpl(this.$targetSize), this.this$0.getAnimSpec(), null, null, this, 12, null);
        ...
        if (animationResult.getEndReason() == AnimationEndReason.Finished && (listener = this.this$0.getListener()) != null) {
            listener.invoke(IntSize.m5024boximpl(this.$this_apply.m72getStartSizeYbymL2g()), animationResult.getEndState().getValue());
        }
