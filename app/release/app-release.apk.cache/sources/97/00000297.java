...
public final class VisibilityThresholdsKt {
    ...
    public static final long getVisibilityThreshold(DpOffset.Companion companion) {
        Intrinsics.checkNotNullParameter(companion, "<this>");
        return DpKt.m4893DpOffsetYgX7TsA(getVisibilityThreshold(Dp.Companion), getVisibilityThreshold(Dp.Companion));
    }
    ...
    public static final float getVisibilityThreshold(Dp.Companion companion) {
        Intrinsics.checkNotNullParameter(companion, "<this>");
        return Dp.m4872constructorimpl(DpVisibilityThreshold);
    }
}