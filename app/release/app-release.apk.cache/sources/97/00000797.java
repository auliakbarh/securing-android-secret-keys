...
public final class PagerMeasurePolicyKt {
    ...
    public static final Function2<LazyLayoutMeasureScope, Constraints, MeasureResult> m697rememberPagerMeasurePolicyBxUkNYg(final Function0<PagerLazyLayoutItemProvider> itemProviderLambda, final PagerState state, final PaddingValues contentPadding, final boolean z, final Orientation orientation, final int i, final float f, final PageSize pageSize, final Alignment.Horizontal horizontal, final Alignment.Vertical vertical, final Function0<Integer> pageCount, Composer composer, int i2, int i3) {
        ...
        Object[] objArr = {contentPadding, Dp.m4870boximpl(f), pageSize, state, contentPadding, Boolean.valueOf(z), orientation, horizontal, vertical, pageCount};
        ...
        if (z2 || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = (Function2) new Function2<LazyLayoutMeasureScope, Constraints, PagerMeasureResult>() { // from class: androidx.compose.foundation.pager.PagerMeasurePolicyKt$rememberPagerMeasurePolicy$1$1
                ...
                public /* bridge */ /* synthetic */ PagerMeasureResult invoke(LazyLayoutMeasureScope lazyLayoutMeasureScope, Constraints constraints) {
                    return m698invoke0kLqBqw(lazyLayoutMeasureScope, constraints.m4834unboximpl());
                }

                /* renamed from: invoke-0kLqBqw  reason: not valid java name */
                public final PagerMeasureResult m698invoke0kLqBqw(final LazyLayoutMeasureScope lazyLayoutMeasureScope, final long j) {
                    int i5;
                    int i6;
                    ...
                    CheckScrollableContainerConstraintsKt.m186checkScrollableContainerConstraintsK40F9xA(j, z3 ? Orientation.Vertical : Orientation.Horizontal);
                    if (z3) {
                        i5 = lazyLayoutMeasureScope.mo318roundToPx0680j_4(contentPadding.mo430calculateLeftPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                    } else {
                        i5 = lazyLayoutMeasureScope.mo318roundToPx0680j_4(PaddingKt.calculateStartPadding(contentPadding, lazyLayoutMeasureScope.getLayoutDirection()));
                    }
                    if (z3) {
                        i6 = lazyLayoutMeasureScope.mo318roundToPx0680j_4(contentPadding.mo431calculateRightPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                    } else {
                        i6 = lazyLayoutMeasureScope.mo318roundToPx0680j_4(PaddingKt.calculateEndPadding(contentPadding, lazyLayoutMeasureScope.getLayoutDirection()));
                    }
                    int i7 = lazyLayoutMeasureScope.mo318roundToPx0680j_4(contentPadding.mo432calculateTopPaddingD9Ej5fM());
                    int i8 = lazyLayoutMeasureScope.mo318roundToPx0680j_4(contentPadding.mo429calculateBottomPaddingD9Ej5fM());
                    final int i9 = i7 + i8;
                    final int i10 = i5 + i6;
                    int i11 = z3 ? i9 : i10;
                    ...
                    int i14 = lazyLayoutMeasureScope.mo318roundToPx0680j_4(f);
                    if (z3) {
                        m4828getMaxWidthimpl = Constraints.m4827getMaxHeightimpl(j) - i9;
                    } else {
                        m4828getMaxWidthimpl = Constraints.m4828getMaxWidthimpl(j) - i10;
                    }
                    if (!z || m4828getMaxWidthimpl > 0) {
                        IntOffset = IntOffsetKt.IntOffset(i5, i7);
                    } else {
                        if (!z3) {
                            i5 += m4828getMaxWidthimpl;
                        }
                        if (z3) {
                            i7 += m4828getMaxWidthimpl;
                        }
                        IntOffset = IntOffsetKt.IntOffset(i5, i7);
                    }
                    long j2 = IntOffset;
                    int calculateMainAxisPageSize = pageSize.calculateMainAxisPageSize(lazyLayoutMeasureScope2, m4828getMaxWidthimpl, i14);
                    state.m701setPremeasureConstraintsBRTryo0$foundation_release(ConstraintsKt.Constraints$default(0, Orientation.this == Orientation.Vertical ? Constraints.m4828getMaxWidthimpl(m4844offsetNN6EwU) : calculateMainAxisPageSize, 0, Orientation.this != Orientation.Vertical ? Constraints.m4827getMaxHeightimpl(m4844offsetNN6EwU) : calculateMainAxisPageSize, 5, null));
                    ...
                    try {
                        ...
                        state.applyMeasureResult$foundation_release(m696measurePagerntgEbfI);
                        return m696measurePagerntgEbfI;
                    } catch (Throwable th) {
                        createNonObservableSnapshot.dispose();
                        throw th;
                    }
