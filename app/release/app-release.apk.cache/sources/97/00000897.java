...
public final class TextFieldKeyInput {
    ...
    public static final /* synthetic */ void access$apply(TextFieldKeyInput textFieldKeyInput, List list) {
        textFieldKeyInput.apply(list);
    }

    public static final /* synthetic */ int access$getImeAction$p(TextFieldKeyInput textFieldKeyInput) {
        return textFieldKeyInput.imeAction;
    }

    public static final /* synthetic */ Function1 access$getOnValueChange$p(TextFieldKeyInput textFieldKeyInput) {
        return textFieldKeyInput.onValueChange;
    }
    ...
    private final CommitTextCommand m812typedCommandZmokQxo(KeyEvent keyEvent) {
        Integer m756consumeZmokQxo;
        if (TextFieldKeyInput_androidKt.m817isTypedEventZmokQxo(keyEvent) && (m756consumeZmokQxo = this.keyCombiner.m756consumeZmokQxo(keyEvent)) != null) {
            String sb = StringHelpers_jvmKt.appendCodePointX(new StringBuilder(), m756consumeZmokQxo.intValue()).toString();
    ...
    public final boolean m813processZmokQxo(KeyEvent event) {
        final KeyCommand mo758mapZmokQxo;
        Intrinsics.checkNotNullParameter(event, "event");
        CommitTextCommand m812typedCommandZmokQxo = m812typedCommandZmokQxo(event);
        if (m812typedCommandZmokQxo != null) {
            if (this.editable) {
                apply(m812typedCommandZmokQxo);
                this.preparedSelectionState.resetCachedX();
                return true;
            }
            return false;
        } else if (KeyEventType.m3607equalsimpl0(KeyEvent_androidKt.m3615getTypeZmokQxo(event), KeyEventType.Companion.m3611getKeyDownCS__XNY()) && (mo758mapZmokQxo = this.keyMapping.mo758mapZmokQxo(event)) != null && (!mo758mapZmokQxo.getEditsText() || this.editable)) {
                ...
                public final void invoke2(TextFieldPreparedSelection commandExecutionContext) {
                    ...
                    switch (WhenMappings.$EnumSwitchMapping$0[KeyCommand.this.ordinal()]) {
                        ...
                        case 20:
                            List<EditCommand> deleteIfSelectedOr = commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.3
                                ...
                                public final EditCommand invoke(TextFieldPreparedSelection deleteIfSelectedOr2) {
                                    ...
                                    return new DeleteSurroundingTextCommand(TextRange.m4398getEndimpl(deleteIfSelectedOr2.m871getSelectiond9O1mEE()) - deleteIfSelectedOr2.getPrecedingCharacterIndex(), 0);
                                }
                            });
                            if (deleteIfSelectedOr != null) {
                                TextFieldKeyInput.access$apply(this, deleteIfSelectedOr);
                                return;
                            }
                            return;
                        case 21:
                            List<EditCommand> deleteIfSelectedOr2 = commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.4
                                ...
                                public final EditCommand invoke(TextFieldPreparedSelection deleteIfSelectedOr3) {
                                    ...
                                    if (nextCharacterIndex != -1) {
                                        return new DeleteSurroundingTextCommand(0, nextCharacterIndex - TextRange.m4398getEndimpl(deleteIfSelectedOr3.m871getSelectiond9O1mEE()));
                                    }
                                    return null;
                                }
                            });
                            if (deleteIfSelectedOr2 != null) {
                                TextFieldKeyInput.access$apply(this, deleteIfSelectedOr2);
                                return;
                            }
                            return;
                        case 22:
                            List<EditCommand> deleteIfSelectedOr3 = commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.5
                                ...
                                public final EditCommand invoke(TextFieldPreparedSelection deleteIfSelectedOr4) {
                                    ...
                                    if (previousWordOffset != null) {
                                        deleteSurroundingTextCommand = new DeleteSurroundingTextCommand(TextRange.m4398getEndimpl(deleteIfSelectedOr4.m871getSelectiond9O1mEE()) - previousWordOffset.intValue(), 0);
                                    } else {
                            ...
                            if (deleteIfSelectedOr3 != null) {
                                TextFieldKeyInput.access$apply(this, deleteIfSelectedOr3);
                                return;
                            }
                            return;
                        case 23:
                            List<EditCommand> deleteIfSelectedOr4 = commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.6
                                ...
                                public final EditCommand invoke(TextFieldPreparedSelection deleteIfSelectedOr5) {
                                    ...
                                    return nextWordOffset != null ? new DeleteSurroundingTextCommand(0, nextWordOffset.intValue() - TextRange.m4398getEndimpl(deleteIfSelectedOr5.m871getSelectiond9O1mEE())) : null;
                                }
                            });
                            if (deleteIfSelectedOr4 != null) {
                                TextFieldKeyInput.access$apply(this, deleteIfSelectedOr4);
                                return;
                            }
                            return;
                        case 24:
                            List<EditCommand> deleteIfSelectedOr5 = commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.7
                                ...
                                public final EditCommand invoke(TextFieldPreparedSelection deleteIfSelectedOr6) {
                                    ...
                                    if (lineStartByOffset != null) {
                                        deleteSurroundingTextCommand = new DeleteSurroundingTextCommand(TextRange.m4398getEndimpl(deleteIfSelectedOr6.m871getSelectiond9O1mEE()) - lineStartByOffset.intValue(), 0);
                                    } else {
                                        deleteSurroundingTextCommand = null;
                                    }
                                    return deleteSurroundingTextCommand;
                            ...
                            if (deleteIfSelectedOr5 != null) {
                                TextFieldKeyInput.access$apply(this, deleteIfSelectedOr5);
                                return;
                            }
                            return;
                        case 25:
                            List<EditCommand> deleteIfSelectedOr6 = commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.8
                                ...
                                public final EditCommand invoke(TextFieldPreparedSelection deleteIfSelectedOr7) {
                                    ...
                                    return lineEndByOffset != null ? new DeleteSurroundingTextCommand(0, lineEndByOffset.intValue() - TextRange.m4398getEndimpl(deleteIfSelectedOr7.m871getSelectiond9O1mEE())) : null;
                                }
                            });
                            if (deleteIfSelectedOr6 != null) {
                                TextFieldKeyInput.access$apply(this, deleteIfSelectedOr6);
                                return;
                            }
                            return;
                        case 26:
                            if (!this.getSingleLine()) {
                                ...
                                this.getState().getOnImeActionPerformed().invoke(ImeAction.m4547boximpl(TextFieldKeyInput.access$getImeAction$p(this)));
                                return;
                            }
                        ...
                        case MotionEventCompat.AXIS_GENERIC_15 /* 46 */:
                            ...
                            TextFieldKeyInput.access$getOnValueChange$p(this).invoke(undo);
                            return;
                        case MotionEventCompat.AXIS_GENERIC_16 /* 47 */:
                            ...
                            TextFieldKeyInput.access$getOnValueChange$p(this).invoke(redo);
                            return;
                        case 48:
    ...
    private final void commandExecutionContext(Function1<? super TextFieldPreparedSelection, Unit> function1) {
        ...
        if (TextRange.m4396equalsimpl0(textFieldPreparedSelection.m871getSelectiond9O1mEE(), this.value.m4622getSelectiond9O1mEE()) && Intrinsics.areEqual(textFieldPreparedSelection.getAnnotatedString(), this.value.getAnnotatedString())) {
            return;
        }
