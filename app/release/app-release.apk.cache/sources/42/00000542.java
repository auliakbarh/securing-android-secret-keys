...
public interface PaddingValues {
    ...
    float mo430calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection);

    /* renamed from: calculateRightPadding-u2uoSUM */
    float mo431calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection);

    /* renamed from: calculateTopPadding-D9Ej5fM */
    float mo432calculateTopPaddingD9Ej5fM();
    ...
    public static final class Absolute implements PaddingValues {
        ...
        private static /* synthetic */ void m492getBottomD9Ej5fM$annotations() {
        }

        /* renamed from: getLeft-D9Ej5fM$annotations  reason: not valid java name */
        private static /* synthetic */ void m493getLeftD9Ej5fM$annotations() {
        }

        /* renamed from: getRight-D9Ej5fM$annotations  reason: not valid java name */
        private static /* synthetic */ void m494getRightD9Ej5fM$annotations() {
        }

        /* renamed from: getTop-D9Ej5fM$annotations  reason: not valid java name */
        private static /* synthetic */ void m495getTopD9Ej5fM$annotations() {
        }

        @Override // androidx.compose.foundation.layout.PaddingValues
        /* renamed from: calculateBottomPadding-D9Ej5fM */
        public float mo429calculateBottomPaddingD9Ej5fM() {
            return this.bottom;
        }

        @Override // androidx.compose.foundation.layout.PaddingValues
        /* renamed from: calculateLeftPadding-u2uoSUM */
        public float mo430calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
        ...
        @Override // androidx.compose.foundation.layout.PaddingValues
        /* renamed from: calculateRightPadding-u2uoSUM */
        public float mo431calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
            Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
            return this.right;
        }
        ...
        @Override // androidx.compose.foundation.layout.PaddingValues
        /* renamed from: calculateTopPadding-D9Ej5fM */
        public float mo432calculateTopPaddingD9Ej5fM() {
            return this.top;
        }
        ...
        public boolean equals(Object obj) {
            if (obj instanceof Absolute) {
                ...
                return Dp.m4877equalsimpl0(this.left, absolute.left) && Dp.m4877equalsimpl0(this.top, absolute.top) && Dp.m4877equalsimpl0(this.right, absolute.right) && Dp.m4877equalsimpl0(this.bottom, absolute.bottom);
            }
            return false;
        }

        public int hashCode() {
            return (((((Dp.m4878hashCodeimpl(this.left) * 31) + Dp.m4878hashCodeimpl(this.top)) * 31) + Dp.m4878hashCodeimpl(this.right)) * 31) + Dp.m4878hashCodeimpl(this.bottom);
        }

        public String toString() {
            return "PaddingValues.Absolute(left=" + ((Object) Dp.m4883toStringimpl(this.left)) + ", top=" + ((Object) Dp.m4883toStringimpl(this.top)) + ", right=" + ((Object) Dp.m4883toStringimpl(this.right)) + ", bottom=" + ((Object) Dp.m4883toStringimpl(this.bottom)) + ')';
        }

        public /* synthetic */ Absolute(float f, float f2, float f3, float f4, int i, DefaultConstructorMarker defaultConstructorMarker) {
            this((i & 1) != 0 ? Dp.m4872constructorimpl(0) : f, (i & 2) != 0 ? Dp.m4872constructorimpl(0) : f2, (i & 4) != 0 ? Dp.m4872constructorimpl(0) : f3, (i & 8) != 0 ? Dp.m4872constructorimpl(0) : f4, null);
        }
    }
}