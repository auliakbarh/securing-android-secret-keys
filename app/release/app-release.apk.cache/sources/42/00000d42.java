...
public final class NavigationRailItemColors {
    ...
    public final State<Color> iconColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> m67animateColorAsStateeuL9pac = SingleValueAnimationKt.m67animateColorAsStateeuL9pac(!z2 ? this.disabledIconColor : z ? this.selectedIconColor : this.unselectedIconColor, AnimationSpecKt.tween$default(150, 0, null, 6, null), null, null, composer, 48, 12);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> textColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> m67animateColorAsStateeuL9pac = SingleValueAnimationKt.m67animateColorAsStateeuL9pac(!z2 ? this.disabledTextColor : z ? this.selectedTextColor : this.unselectedTextColor, AnimationSpecKt.tween$default(150, 0, null, 6, null), null, null, composer, 48, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m2629equalsimpl0(this.selectedIconColor, navigationRailItemColors.selectedIconColor) && Color.m2629equalsimpl0(this.unselectedIconColor, navigationRailItemColors.unselectedIconColor) && Color.m2629equalsimpl0(this.selectedTextColor, navigationRailItemColors.selectedTextColor) && Color.m2629equalsimpl0(this.unselectedTextColor, navigationRailItemColors.unselectedTextColor) && Color.m2629equalsimpl0(this.selectedIndicatorColor, navigationRailItemColors.selectedIndicatorColor) && Color.m2629equalsimpl0(this.disabledIconColor, navigationRailItemColors.disabledIconColor) && Color.m2629equalsimpl0(this.disabledTextColor, navigationRailItemColors.disabledTextColor);
    }
