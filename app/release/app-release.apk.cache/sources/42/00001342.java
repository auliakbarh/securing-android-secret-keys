...
public final class AndroidPaint_androidKt {
    ...
    public static final void m2514setNativeBlendModeGB0RdKg(android.graphics.Paint setNativeBlendMode, int i) {
        Intrinsics.checkNotNullParameter(setNativeBlendMode, "$this$setNativeBlendMode");
        if (Build.VERSION.SDK_INT >= 29) {
            WrapperVerificationHelperMethods.INSTANCE.m3024setBlendModeGB0RdKg(setNativeBlendMode, i);
        } else {
            setNativeBlendMode.setXfermode(new PorterDuffXfermode(AndroidBlendMode_androidKt.m2482toPorterDuffModes9anfk8(i)));
        }
    }
    ...
    public static final void m2515setNativeColor4WTKRHQ(android.graphics.Paint setNativeColor, long j) {
        Intrinsics.checkNotNullParameter(setNativeColor, "$this$setNativeColor");
        setNativeColor.setColor(ColorKt.m2682toArgb8_81llA(j));
    }

    /* renamed from: setNativeStyle--5YerkU  reason: not valid java name */
    public static final void m2519setNativeStyle5YerkU(android.graphics.Paint setNativeStyle, int i) {
        Intrinsics.checkNotNullParameter(setNativeStyle, "$this$setNativeStyle");
        setNativeStyle.setStyle(PaintingStyle.m2885equalsimpl0(i, PaintingStyle.Companion.m2890getStrokeTiuSbCo()) ? Paint.Style.STROKE : Paint.Style.FILL);
    }
    ...
    public static final int getNativeStyle(android.graphics.Paint paint) {
        ...
        if (style != null && WhenMappings.$EnumSwitchMapping$0[style.ordinal()] == 1) {
            return PaintingStyle.Companion.m2890getStrokeTiuSbCo();
        }
        return PaintingStyle.Companion.m2889getFillTiuSbCo();
    }
    ...
    public static final int getNativeStrokeCap(android.graphics.Paint paint) {
        ...
        if (i != 1) {
            if (i != 2) {
                if (i == 3) {
                    return StrokeCap.Companion.m2976getSquareKaPHkGw();
                }
    ...
    public static final void m2517setNativeStrokeCapCSYIeUk(android.graphics.Paint setNativeStrokeCap, int i) {
        Paint.Cap cap;
        Intrinsics.checkNotNullParameter(setNativeStrokeCap, "$this$setNativeStrokeCap");
        if (StrokeCap.m2970equalsimpl0(i, StrokeCap.Companion.m2976getSquareKaPHkGw())) {
            cap = Paint.Cap.SQUARE;
        } else if (StrokeCap.m2970equalsimpl0(i, StrokeCap.Companion.m2975getRoundKaPHkGw())) {
            cap = Paint.Cap.ROUND;
        } else {
            cap = StrokeCap.m2970equalsimpl0(i, StrokeCap.Companion.m2974getButtKaPHkGw()) ? Paint.Cap.BUTT : Paint.Cap.BUTT;
        }
    ...
    public static final int getNativeStrokeJoin(android.graphics.Paint paint) {
        ...
        if (i != 1) {
            ...
            return StrokeJoin.Companion.m2984getBevelLxFBmk8();
        }
        return StrokeJoin.Companion.m2985getMiterLxFBmk8();
    }

    /* renamed from: setNativeStrokeJoin-kLtJ_vA  reason: not valid java name */
    public static final void m2518setNativeStrokeJoinkLtJ_vA(android.graphics.Paint setNativeStrokeJoin, int i) {
        Paint.Join join;
        Intrinsics.checkNotNullParameter(setNativeStrokeJoin, "$this$setNativeStrokeJoin");
        if (StrokeJoin.m2980equalsimpl0(i, StrokeJoin.Companion.m2985getMiterLxFBmk8())) {
            join = Paint.Join.MITER;
        } else if (StrokeJoin.m2980equalsimpl0(i, StrokeJoin.Companion.m2984getBevelLxFBmk8())) {
            join = Paint.Join.BEVEL;
        } else {
            join = StrokeJoin.m2980equalsimpl0(i, StrokeJoin.Companion.m2986getRoundLxFBmk8()) ? Paint.Join.ROUND : Paint.Join.MITER;
        }
    ...
    public static final int getNativeFilterQuality(android.graphics.Paint paint) {
        ...
        if (!paint.isFilterBitmap()) {
            return FilterQuality.Companion.m2726getNonefv9h1I();
        }
        return FilterQuality.Companion.m2724getLowfv9h1I();
    }

    /* renamed from: setNativeFilterQuality-50PEsBU  reason: not valid java name */
    public static final void m2516setNativeFilterQuality50PEsBU(android.graphics.Paint setNativeFilterQuality, int i) {
        Intrinsics.checkNotNullParameter(setNativeFilterQuality, "$this$setNativeFilterQuality");
        setNativeFilterQuality.setFilterBitmap(!FilterQuality.m2719equalsimpl0(i, FilterQuality.Companion.m2726getNonefv9h1I()));
    }
