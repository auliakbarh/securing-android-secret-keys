...
public abstract class Painter {
    ...
    public abstract long mo3240getIntrinsicSizeNHjbRc();
    ...
    public static /* synthetic */ void m3245drawx_KDEd0$default(Painter painter, DrawScope drawScope, long j, float f, ColorFilter colorFilter, int i, Object obj) {
        if (obj != null) {
        ...
        painter.m3246drawx_KDEd0(drawScope, j, f2, colorFilter);
    }

    /* renamed from: draw-x_KDEd0  reason: not valid java name */
    public final void m3246drawx_KDEd0(DrawScope draw, long j, float f, ColorFilter colorFilter) {
        Intrinsics.checkNotNullParameter(draw, "$this$draw");
        configureAlpha(f);
        configureColorFilter(colorFilter);
        configureLayoutDirection(draw.getLayoutDirection());
        float m2458getWidthimpl = Size.m2458getWidthimpl(draw.mo3171getSizeNHjbRc()) - Size.m2458getWidthimpl(j);
        float m2455getHeightimpl = Size.m2455getHeightimpl(draw.mo3171getSizeNHjbRc()) - Size.m2455getHeightimpl(j);
        draw.getDrawContext().getTransform().inset(0.0f, 0.0f, m2458getWidthimpl, m2455getHeightimpl);
        if (f > 0.0f && Size.m2458getWidthimpl(j) > 0.0f && Size.m2455getHeightimpl(j) > 0.0f) {
            if (this.useLayer) {
                Rect m2429Recttz77jQw = RectKt.m2429Recttz77jQw(Offset.Companion.m2405getZeroF1C5BW0(), SizeKt.Size(Size.m2458getWidthimpl(j), Size.m2455getHeightimpl(j)));
                Canvas canvas = draw.getDrawContext().getCanvas();
                try {
                    canvas.saveLayer(m2429Recttz77jQw, obtainPaint());
                    onDraw(draw);
                } finally {
                    canvas.restore();
                }
