...
public final class HistoricalChange {
    ...
    public final long m3675getPositionF1C5BW0() {
    ...
    public String toString() {
        return "HistoricalChange(uptimeMillis=" + this.uptimeMillis + ", position=" + ((Object) Offset.m2397toStringimpl(this.position)) + ')';
    }
}