...
public final class AndroidRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    public static final /* synthetic */ void access$setInvalidateTick(AndroidRippleIndicationInstance androidRippleIndicationInstance, boolean z) {
        androidRippleIndicationInstance.setInvalidateTick(z);
    }
    ...
    private AndroidRippleIndicationInstance(boolean z, float f, State<Color> color, State<RippleAlpha> rippleAlpha, RippleContainer rippleContainer) {
        ...
        this.rippleSize = Size.Companion.m2467getZeroNHjbRc();
        this.rippleRadius = -1;
        this.onInvalidateRipple = new Function0<Unit>() { // from class: androidx.compose.material.ripple.AndroidRippleIndicationInstance$onInvalidateRipple$1
            ...
            public final void invoke2() {
                ...
                AndroidRippleIndicationInstance.access$setInvalidateTick(androidRippleIndicationInstance, !AndroidRippleIndicationInstance.access$getInvalidateTick(androidRippleIndicationInstance));
            }
        };
    }
    ...
    public void drawIndication(ContentDrawScope contentDrawScope) {
        ...
        this.rippleSize = contentDrawScope.mo3171getSizeNHjbRc();
        if (Float.isNaN(this.radius)) {
            i = MathKt.roundToInt(RippleAnimationKt.m959getRippleEndRadiuscSwnlzA(contentDrawScope, this.bounded, contentDrawScope.mo3171getSizeNHjbRc()));
        } else {
            i = contentDrawScope.mo318roundToPx0680j_4(this.radius);
        }
        this.rippleRadius = i;
        long m2638unboximpl = this.color.getValue().m2638unboximpl();
        float pressedAlpha = this.rippleAlpha.getValue().getPressedAlpha();
        contentDrawScope.drawContent();
        ContentDrawScope contentDrawScope2 = contentDrawScope;
        m964drawStateLayerH2RKhps(contentDrawScope2, this.radius, m2638unboximpl);
        Canvas canvas = contentDrawScope2.getDrawContext().getCanvas();
        getInvalidateTick();
        RippleHostView rippleHostView = getRippleHostView();
        if (rippleHostView != null) {
            rippleHostView.m963updateRipplePropertiesbiQXAtU(contentDrawScope.mo3171getSizeNHjbRc(), this.rippleRadius, m2638unboximpl, pressedAlpha);
    ...
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) {
        ...
        rippleHostView.m962addRippleKOepWvA(interaction, this.bounded, this.rippleSize, this.rippleRadius, this.color.getValue().m2638unboximpl(), this.rippleAlpha.getValue().getPressedAlpha(), this.onInvalidateRipple);
