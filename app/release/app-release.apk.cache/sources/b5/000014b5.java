...
public final class PointerEvent {
    ...
    public final int m3688getButtonsry648PA() {
        return this.buttons;
    }
    ...
    public final int m3689getKeyboardModifiersk7X9c1A() {
        return this.keyboardModifiers;
    }

    /* renamed from: getType-7fucELk  reason: not valid java name */
    public final int m3690getType7fucELk() {
        return this.type;
    }

    /* renamed from: setType-EhbLWgg$ui_release  reason: not valid java name */
    public final void m3691setTypeEhbLWgg$ui_release(int i) {
        this.type = i;
    }
    ...
    public PointerEvent(List<PointerInputChange> changes, InternalPointerEvent internalPointerEvent) {
        ...
        this.buttons = PointerButtons.m3681constructorimpl(motionEvent$ui_release != null ? motionEvent$ui_release.getButtonState() : 0);
        MotionEvent motionEvent$ui_release2 = getMotionEvent$ui_release();
        this.keyboardModifiers = PointerKeyboardModifiers.m3809constructorimpl(motionEvent$ui_release2 != null ? motionEvent$ui_release2.getMetaState() : 0);
        this.type = m3687calculatePointerEventType7fucELk();
    }
    ...
    private final int m3687calculatePointerEventType7fucELk() {
        MotionEvent motionEvent$ui_release = getMotionEvent$ui_release();
                    ...
                    if (actionMasked != 2) {
                        switch (actionMasked) {
                            ...
                            case 7:
                                break;
                            case 8:
                                return PointerEventType.Companion.m3706getScroll7fucELk();
                            case 9:
                                return PointerEventType.Companion.m3701getEnter7fucELk();
                            case 10:
                                return PointerEventType.Companion.m3702getExit7fucELk();
                            default:
                                return PointerEventType.Companion.m3707getUnknown7fucELk();
                        }
                    }
                    return PointerEventType.Companion.m3703getMove7fucELk();
                }
                return PointerEventType.Companion.m3705getRelease7fucELk();
            }
            return PointerEventType.Companion.m3704getPress7fucELk();
        }
    ...
    public final PointerEvent copy(List<PointerInputChange> changes, MotionEvent motionEvent) {
        ...
        while (i < size) {
            ...
            linkedHashMap.put(PointerId.m3727boximpl(pointerInputChange.m3746getIdJ3iCeTQ()), pointerInputChange);
            ArrayList arrayList2 = arrayList;
            long m3746getIdJ3iCeTQ = pointerInputChange.m3746getIdJ3iCeTQ();
            long uptimeMillis = pointerInputChange.getUptimeMillis();
            long m3747getPositionF1C5BW0 = pointerInputChange.m3747getPositionF1C5BW0();
            long m3747getPositionF1C5BW02 = pointerInputChange.m3747getPositionF1C5BW0();
            boolean pressed = pointerInputChange.getPressed();
            float pressure = pointerInputChange.getPressure();
            int m3750getTypeT8wyACA = pointerInputChange.m3750getTypeT8wyACA();
            InternalPointerEvent internalPointerEvent = this.internalPointerEvent;
            int i2 = i;
            if (internalPointerEvent != null) {
                z = true;
                if (internalPointerEvent.m3677issuesEnterExitEvent0FcD4WY(pointerInputChange.m3746getIdJ3iCeTQ())) {
                    arrayList2.add(new PointerInputEventData(m3746getIdJ3iCeTQ, uptimeMillis, m3747getPositionF1C5BW0, m3747getPositionF1C5BW02, pressed, pressure, m3750getTypeT8wyACA, z, null, 0L, 768, null));
                    i = i2 + 1;
                }
            }
            z = false;
