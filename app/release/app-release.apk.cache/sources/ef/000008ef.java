...
public final class TextStringSimpleNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public static final /* synthetic */ ParagraphLayoutCache access$getLayoutCache(TextStringSimpleNode textStringSimpleNode) {
        return textStringSimpleNode.getLayoutCache();
    }
    ...
    public /* synthetic */ TextStringSimpleNode(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, ColorProducer colorProducer, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.Companion.m4813getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, (i4 & 128) != 0 ? null : colorProducer, null);
    }
    ...
    public final boolean m867updateLayoutRelatedArgsHuAbxIM(TextStyle style, int i, int i2, boolean z, FontFamily.Resolver fontFamilyResolver, int i3) {
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(fontFamilyResolver, "fontFamilyResolver");
    ...
    public final void doInvalidations(boolean z, boolean z2, boolean z3) {
        ...
        if (z2 || z3) {
            getLayoutCache().m854updateL6sJoHM(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines);
        ...
        if (function1 == null) {
            function1 = new Function1<List<TextLayoutResult>, Boolean>() { // from class: androidx.compose.foundation.text.modifiers.TextStringSimpleNode$applySemantics$1
                ...
                public final Boolean invoke(List<TextLayoutResult> textLayoutResult) {
                    ...
                    TextLayoutResult slowCreateTextLayoutResultOrNull = TextStringSimpleNode.access$getLayoutCache(TextStringSimpleNode.this).slowCreateTextLayoutResultOrNull();
    ...
    public MeasureResult mo236measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        boolean m852layoutWithConstraintsK40F9xA = layoutCache.m852layoutWithConstraintsK40F9xA(j, measure.getLayoutDirection());
        ...
        long m851getLayoutSizeYbymL2g$foundation_release = layoutCache.m851getLayoutSizeYbymL2g$foundation_release();
        if (m852layoutWithConstraintsK40F9xA) {
        ...
        final Placeable mo3865measureBRTryo0 = measurable.mo3865measureBRTryo0(Constraints.Companion.m4836fixedJhjzzOo(IntSize.m5032getWidthimpl(m851getLayoutSizeYbymL2g$foundation_release), IntSize.m5031getHeightimpl(m851getLayoutSizeYbymL2g$foundation_release)));
        int m5032getWidthimpl = IntSize.m5032getWidthimpl(m851getLayoutSizeYbymL2g$foundation_release);
        int m5031getHeightimpl = IntSize.m5031getHeightimpl(m851getLayoutSizeYbymL2g$foundation_release);
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return measure.layout(m5032getWidthimpl, m5031getHeightimpl, map, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.modifiers.TextStringSimpleNode$measure$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (didOverflow$foundation_release) {
            Rect m2429Recttz77jQw = RectKt.m2429Recttz77jQw(Offset.Companion.m2405getZeroF1C5BW0(), SizeKt.Size(IntSize.m5032getWidthimpl(getLayoutCache().m851getLayoutSizeYbymL2g$foundation_release()), IntSize.m5031getHeightimpl(getLayoutCache().m851getLayoutSizeYbymL2g$foundation_release())));
            canvas.save();
        ...
        try {
            ...
            if (brush != null) {
                Paragraph.m4298painthn5TExg$default(paragraph$foundation_release, canvas, brush, this.style.getAlpha(), shadow2, textDecoration2, drawStyle2, 0, 64, null);
            } else {
                ...
                Paragraph.m4296paintLG529CI$default(paragraph$foundation_release, canvas, m2705invoke0d7_KjU, shadow2, textDecoration2, drawStyle2, 0, 32, null);
            }
        } finally {
            if (didOverflow$foundation_release) {
                canvas.restore();
