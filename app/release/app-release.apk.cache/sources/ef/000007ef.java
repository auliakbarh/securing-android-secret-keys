...
public final class RoundedCornerShape extends CornerBasedShape {
    ...
    public Outline mo715createOutlineLjSzlW0(long j, float f, float f2, float f3, float f4, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        if (f + f2 + f3 + f4 == 0.0f) {
            return new Outline.Rectangle(SizeKt.m2479toRectuvyYCjk(j));
        }
        return new Outline.Rounded(RoundRectKt.m2441RoundRectZAM2FJo(SizeKt.m2479toRectuvyYCjk(j), CornerRadiusKt.CornerRadius$default(layoutDirection == LayoutDirection.Ltr ? f : f2, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(layoutDirection == LayoutDirection.Ltr ? f2 : f, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(layoutDirection == LayoutDirection.Ltr ? f3 : f4, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(layoutDirection == LayoutDirection.Ltr ? f4 : f3, 0.0f, 2, null)));
    }
