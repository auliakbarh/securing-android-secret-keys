...
public final class SuspendingPointerInputModifierNodeImpl extends Modifier.Node implements SuspendingPointerInputModifierNode, PointerInputScope, Density {
    ...
    public long mo3783getSizeYbymL2g() {
    ...
    public SuspendingPointerInputModifierNodeImpl(Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object> pointerInputHandler) {
        ...
        this.boundsSize = IntSize.Companion.m5037getZeroYbymL2g();
    }
    ...
    public long mo3782getExtendedTouchPaddingNHjbRc() {
        long j = mo325toSizeXkaWNTQ(getViewConfiguration().mo4009getMinimumTouchTargetSizeMYxV2XQ());
        long mo3783getSizeYbymL2g = mo3783getSizeYbymL2g();
        return SizeKt.Size(Math.max(0.0f, Size.m2458getWidthimpl(j) - IntSize.m5032getWidthimpl(mo3783getSizeYbymL2g)) / 2.0f, Math.max(0.0f, Size.m2455getHeightimpl(j) - IntSize.m5031getHeightimpl(mo3783getSizeYbymL2g)) / 2.0f);
    }
        ...
        for (int i = 0; i < size; i++) {
            if (!(!changes.get(i).getPressed())) {
                ...
                for (int i2 = 0; i2 < size2; i2++) {
                    ...
                    arrayList2.add(new PointerInputChange(pointerInputChange.m3746getIdJ3iCeTQ(), pointerInputChange.getUptimeMillis(), pointerInputChange.m3747getPositionF1C5BW0(), false, pointerInputChange.getPressure(), pointerInputChange.getUptimeMillis(), pointerInputChange.m3747getPositionF1C5BW0(), pointerInputChange.getPressed(), pointerInputChange.getPressed(), 0, 0L, 1536, (DefaultConstructorMarker) null));
                }
    ...
    public final class PointerEventHandlerCoroutine<R> implements AwaitPointerEventScope, Density, Continuation<R> {
        ...
        @Override // androidx.compose.ui.input.pointer.AwaitPointerEventScope
        /* renamed from: getSize-YbymL2g */
        public long mo3661getSizeYbymL2g() {
        ...
        @Override // androidx.compose.ui.input.pointer.AwaitPointerEventScope
        /* renamed from: getExtendedTouchPadding-NH-jbRc */
        public long mo3660getExtendedTouchPaddingNHjbRc() {
            return this.this$0.mo3782getExtendedTouchPaddingNHjbRc();
        }
        ...
        public final void offerPointerEvent(PointerEvent event, PointerEventPass pass) {
            ...
            cancellableContinuation.resumeWith(Result.m5155constructorimpl(event));
        }
        ...
        */
        public <T> java.lang.Object withTimeout(long r11, kotlin.jvm.functions.Function2<? super androidx.compose.ui.input.pointer.AwaitPointerEventScope, ? super kotlin.coroutines.Continuation<? super T>, ? extends java.lang.Object> r13, kotlin.coroutines.Continuation<? super T> r14) {
            ...
            L38:
                ...
                java.lang.Object r2 = kotlin.Result.m5155constructorimpl(r2)
                r14.resumeWith(r2)
            L5b:
    ...
    public <R> Object awaitPointerEventScope(Function2<? super AwaitPointerEventScope, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
        ...
        synchronized (this.pointerHandlers) {
            ...
            Result.Companion companion = Result.Companion;
            createCoroutine.resumeWith(Result.m5155constructorimpl(Unit.INSTANCE));
            Unit unit = Unit.INSTANCE;
        }
