    ...
    */
    public PopupLayout(kotlin.jvm.functions.Function0<kotlin.Unit> r8, java.lang.String r9, android.view.View r10, androidx.compose.ui.unit.Density r11, androidx.compose.ui.window.PopupPositionProvider r12, java.util.UUID r13) {
        /*
            ...
            r12 = 8
            float r12 = (float) r12
            float r12 = androidx.compose.ui.unit.Dp.m4872constructorimpl(r12)
            ...
            androidx.compose.material3.internal.PopupLayout$dismissOnOutsideClick$1 r0 = new kotlin.jvm.functions.Function2<androidx.compose.ui.geometry.Offset, androidx.compose.ui.unit.IntRect, java.lang.Boolean>() { // from class: androidx.compose.material3.internal.PopupLayout$dismissOnOutsideClick$1
                ...
                public final java.lang.Boolean invoke(androidx.compose.ui.geometry.Offset r4, androidx.compose.ui.unit.IntRect r5) {
                    /*
                        ...
                        goto L4e
                    L9:
                        long r1 = r4.m2399unboximpl()
                        float r1 = androidx.compose.ui.geometry.Offset.m2389getXimpl(r1)
                        int r2 = r5.getLeft()
                        float r2 = (float) r2
                        ...
                        if (r1 > 0) goto L4d
                        long r1 = r4.m2399unboximpl()
                        float r1 = androidx.compose.ui.geometry.Offset.m2390getYimpl(r1)
                        int r2 = r5.getTop()
                        float r2 = (float) r2
                        int r1 = (r1 > r2 ? 1 : (r1 == r2 ? 0 : -1))
                        if (r1 < 0) goto L4d
                        long r1 = r4.m2399unboximpl()
                        float r4 = androidx.compose.ui.geometry.Offset.m2390getYimpl(r1)
                        int r5 = r5.getBottom()
                        float r5 = (float) r5
            ...
            float r10 = r11.mo324toPx0680j_4(r12)
            r7.setElevation(r10)
            ...
            kotlin.jvm.functions.Function2 r10 = r10.m1676getLambda1$material3_release()
    ...
    public final IntSize m1678getPopupContentSizebOM6tXw() {
    ...
    public final void updatePosition() {
        IntSize m1678getPopupContentSizebOM6tXw;
        IntRect parentBounds = getParentBounds();
        if (parentBounds == null || (m1678getPopupContentSizebOM6tXw = m1678getPopupContentSizebOM6tXw()) == null) {
            return;
        }
        long m5036unboximpl = m1678getPopupContentSizebOM6tXw.m5036unboximpl();
        Rect rect = this.previousWindowVisibleFrame;
        this.composeView.getWindowVisibleDisplayFrame(rect);
        IntRect intBounds = toIntBounds(rect);
        long mo873calculatePositionllwVHH4 = this.positionProvider.mo873calculatePositionllwVHH4(parentBounds, IntSizeKt.IntSize(intBounds.getWidth(), intBounds.getHeight()), this.parentLayoutDirection, m5036unboximpl);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:26:0x007f, code lost:
        if (r5.dismissOnOutsideClick.invoke((r6.getX() == 0.0f && r6.getY() == 0.0f) ? null : androidx.compose.ui.geometry.Offset.m2378boximpl(androidx.compose.ui.geometry.OffsetKt.Offset(r5.params.x + r6.getX(), r5.params.y + r6.getY())), r0).booleanValue() != false) goto L27;
     */
    @Override // android.view.View
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r6) {
        ...
        L59:
            ...
            androidx.compose.ui.geometry.Offset r1 = androidx.compose.ui.geometry.Offset.m2378boximpl(r3)
        L75:
    ...
    public final void m1679setPopupContentSizefhxjrPA(IntSize intSize) {
