...
public final class EditProcessor {
    ...
    private TextFieldValue mBufferState = new TextFieldValue(AnnotatedStringKt.emptyAnnotatedString(), TextRange.Companion.m4408getZerod9O1mEE(), (TextRange) null, (DefaultConstructorMarker) null);
    private EditingBuffer mBuffer = new EditingBuffer(this.mBufferState.getAnnotatedString(), this.mBufferState.m4622getSelectiond9O1mEE(), (DefaultConstructorMarker) null);
    ...
    public static final /* synthetic */ String access$toStringForLog(EditProcessor editProcessor, EditCommand editCommand) {
        return editProcessor.toStringForLog(editCommand);
    }

    public final void reset(TextFieldValue value, TextInputSession textInputSession) {
        Intrinsics.checkNotNullParameter(value, "value");
        boolean z = true;
        boolean z2 = !Intrinsics.areEqual(value.m4621getCompositionMzsxiRA(), this.mBuffer.m4544getCompositionMzsxiRA$ui_text_release());
        boolean z3 = false;
        if (!Intrinsics.areEqual(this.mBufferState.getAnnotatedString(), value.getAnnotatedString())) {
            this.mBuffer = new EditingBuffer(value.getAnnotatedString(), value.m4622getSelectiond9O1mEE(), (DefaultConstructorMarker) null);
        } else if (TextRange.m4396equalsimpl0(this.mBufferState.m4622getSelectiond9O1mEE(), value.m4622getSelectiond9O1mEE())) {
            z = false;
        } else {
            this.mBuffer.setSelection$ui_text_release(TextRange.m4401getMinimpl(value.m4622getSelectiond9O1mEE()), TextRange.m4400getMaximpl(value.m4622getSelectiond9O1mEE()));
            z3 = true;
            z = false;
        }
        if (value.m4621getCompositionMzsxiRA() == null) {
            this.mBuffer.commitComposition$ui_text_release();
        } else if (!TextRange.m4397getCollapsedimpl(value.m4621getCompositionMzsxiRA().m4407unboximpl())) {
            this.mBuffer.setComposition$ui_text_release(TextRange.m4401getMinimpl(value.m4621getCompositionMzsxiRA().m4407unboximpl()), TextRange.m4400getMaximpl(value.m4621getCompositionMzsxiRA().m4407unboximpl()));
        }
        if (z || (!z3 && z2)) {
            this.mBuffer.commitComposition$ui_text_release();
            value = TextFieldValue.m4617copy3r_uNRQ$default(value, (AnnotatedString) null, 0L, (TextRange) null, 3, (Object) null);
        }
    ...
    private final String generateBatchErrorMessage(List<? extends EditCommand> list, final EditCommand editCommand) {
        ...
        StringBuilder append = sb.append("Error while applying EditCommand batch to buffer (length=" + this.mBuffer.getLength$ui_text_release() + ", composition=" + this.mBuffer.m4544getCompositionMzsxiRA$ui_text_release() + ", selection=" + ((Object) TextRange.m4406toStringimpl(this.mBuffer.m4545getSelectiond9O1mEE$ui_text_release())) + "):");
        ...
        CollectionsKt.joinTo(list, sb, (r14 & 2) != 0 ? ", " : "\n", (r14 & 4) != 0 ? "" : null, (r14 & 8) != 0 ? "" : null, (r14 & 16) != 0 ? -1 : 0, (r14 & 32) != 0 ? "..." : null, (r14 & 64) != 0 ? null : new Function1<EditCommand, CharSequence>() { // from class: androidx.compose.ui.text.input.EditProcessor$generateBatchErrorMessage$1$1
            ...
            public final CharSequence invoke(EditCommand it) {
                ...
                return (EditCommand.this == it ? " > " : "   ") + EditProcessor.access$toStringForLog(this, it);
            }
        });
    ...
    public final TextFieldValue apply(List<? extends EditCommand> editCommands) {
        ...
        try {
            ...
            TextFieldValue textFieldValue = new TextFieldValue(this.mBuffer.toAnnotatedString$ui_text_release(), this.mBuffer.m4545getSelectiond9O1mEE$ui_text_release(), this.mBuffer.m4544getCompositionMzsxiRA$ui_text_release(), (DefaultConstructorMarker) null);
