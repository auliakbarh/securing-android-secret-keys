...
public final class DateRangePickerState {
    ...
    public final int m1155getDisplayModejFl4v0() {
        return ((DisplayMode) this.displayMode$delegate.getValue()).m1171unboximpl();
    }

    /* renamed from: setDisplayMode-vCnGnXg  reason: not valid java name */
    public final void m1156setDisplayModevCnGnXg(int i) {
        this.displayMode$delegate.setValue(DisplayMode.m1165boximpl(i));
    }
