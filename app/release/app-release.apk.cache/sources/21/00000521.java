...
interface IntrinsicSizeModifier extends LayoutModifier {
    ...
    long mo433calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j);
    ...
    default MeasureResult mo36measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measure, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        long mo433calculateContentConstraintsl58MMJ0 = mo433calculateContentConstraintsl58MMJ0(measure, measurable, j);
        if (getEnforceIncoming()) {
            mo433calculateContentConstraintsl58MMJ0 = ConstraintsKt.m4840constrainN9IONVI(j, mo433calculateContentConstraintsl58MMJ0);
        }
        final Placeable mo3865measureBRTryo0 = measurable.mo3865measureBRTryo0(mo433calculateContentConstraintsl58MMJ0);
        return MeasureScope.layout$default(measure, mo3865measureBRTryo0.getWidth(), mo3865measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.IntrinsicSizeModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.m3923placeRelative70tqf50$default(layout, Placeable.this, IntOffset.Companion.m5000getZeronOccac(), 0.0f, 2, null);
            }
        }, 4, null);
    }
