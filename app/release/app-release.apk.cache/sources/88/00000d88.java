...
public final class RadioButtonColors {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m2629equalsimpl0(this.selectedColor, radioButtonColors.selectedColor) && Color.m2629equalsimpl0(this.unselectedColor, radioButtonColors.unselectedColor) && Color.m2629equalsimpl0(this.disabledSelectedColor, radioButtonColors.disabledSelectedColor) && Color.m2629equalsimpl0(this.disabledUnselectedColor, radioButtonColors.disabledUnselectedColor);
    }

    public int hashCode() {
        return (((((Color.m2635hashCodeimpl(this.selectedColor) * 31) + Color.m2635hashCodeimpl(this.unselectedColor)) * 31) + Color.m2635hashCodeimpl(this.disabledSelectedColor)) * 31) + Color.m2635hashCodeimpl(this.disabledUnselectedColor);
    }
}