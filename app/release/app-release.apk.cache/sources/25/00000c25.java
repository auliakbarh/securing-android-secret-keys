    ...
    public DateVisualTransformation(DateInputFormat dateInputFormat) {
        ...
        this.dateOffsetTranslator = new OffsetMapping() { // from class: androidx.compose.material3.DateVisualTransformation$dateOffsetTranslator$1
            ...
            public int originalToTransformed(int i) {
                if (i < DateVisualTransformation.access$getFirstDelimiterOffset$p(DateVisualTransformation.this)) {
                    return i;
                }
                if (i < DateVisualTransformation.access$getSecondDelimiterOffset$p(DateVisualTransformation.this)) {
                    return i + 1;
                }
                if (i > DateVisualTransformation.access$getDateFormatLength$p(DateVisualTransformation.this)) {
                    i = DateVisualTransformation.access$getDateFormatLength$p(DateVisualTransformation.this);
                }
                return i + 2;
            }
            ...
            public int transformedToOriginal(int i) {
                return i <= DateVisualTransformation.access$getFirstDelimiterOffset$p(DateVisualTransformation.this) + (-1) ? i : i <= DateVisualTransformation.access$getSecondDelimiterOffset$p(DateVisualTransformation.this) + (-1) ? i - 1 : i <= DateVisualTransformation.access$getDateFormatLength$p(DateVisualTransformation.this) + 1 ? i - 2 : DateVisualTransformation.access$getDateFormatLength$p(DateVisualTransformation.this);
            }
        };
    }

    public static final /* synthetic */ int access$getDateFormatLength$p(DateVisualTransformation dateVisualTransformation) {
        return dateVisualTransformation.dateFormatLength;
    }

    public static final /* synthetic */ int access$getFirstDelimiterOffset$p(DateVisualTransformation dateVisualTransformation) {
        return dateVisualTransformation.firstDelimiterOffset;
    }

    public static final /* synthetic */ int access$getSecondDelimiterOffset$p(DateVisualTransformation dateVisualTransformation) {
        return dateVisualTransformation.secondDelimiterOffset;
    }
