...
public final class LayoutModifierNodeCoordinatorKt {
    ...
    public static final int calculateAlignmentAndPlaceChildAsNeeded(LookaheadCapablePlaceable lookaheadCapablePlaceable, AlignmentLine alignmentLine) {
        ...
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            m4990getXimpl = IntOffset.m4991getYimpl(child.mo4029getPositionnOccac());
        } else {
            m4990getXimpl = IntOffset.m4990getXimpl(child.mo4029getPositionnOccac());
        }
        return i + m4990getXimpl;
    }
}