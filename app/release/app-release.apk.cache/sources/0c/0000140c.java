...
public final class ColorPainter extends Painter {
    ...
    public final long m3244getColor0d7_KjU() {
        return this.color;
    }
    ...
    public void onDraw(DrawScope drawScope) {
        ...
        DrawScope.m3166drawRectnJ9OG0$default(drawScope, this.color, 0L, 0L, this.alpha, null, this.colorFilter, 0, 86, null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof ColorPainter) && Color.m2629equalsimpl0(this.color, ((ColorPainter) obj).color);
    }

    public int hashCode() {
        return Color.m2635hashCodeimpl(this.color);
    }

    public String toString() {
        return "ColorPainter(color=" + ((Object) Color.m2636toStringimpl(this.color)) + ')';
    }
}