...
public final class MultiParagraph {
    ...
    private MultiParagraph(MultiParagraphIntrinsics intrinsics, long j, int i, boolean z) {
        boolean z2;
        int m4827getMaxHeightimpl;
        Intrinsics.checkNotNullParameter(intrinsics, "intrinsics");
        this.intrinsics = intrinsics;
        this.maxLines = i;
        if (Constraints.m4830getMinWidthimpl(j) != 0 || Constraints.m4829getMinHeightimpl(j) != 0) {
        ...
        while (i4 < size) {
            ...
            if (Constraints.m4823getHasBoundedHeightimpl(j)) {
                m4827getMaxHeightimpl = RangesKt.coerceAtLeast(Constraints.m4827getMaxHeightimpl(j) - ParagraphKt.ceilToInt(f), i2);
            } else {
                m4827getMaxHeightimpl = Constraints.m4827getMaxHeightimpl(j);
            }
            Paragraph m4303Paragraph_EkL_Y = ParagraphKt.m4303Paragraph_EkL_Y(intrinsics2, ConstraintsKt.Constraints$default(0, m4828getMaxWidthimpl, 0, m4827getMaxHeightimpl, 5, null), this.maxLines - i3, z);
            float height = f + m4303Paragraph_EkL_Y.getHeight();
            int lineCount = i3 + m4303Paragraph_EkL_Y.getLineCount();
            List<ParagraphIntrinsicInfo> list = infoList$ui_text_release;
            arrayList.add(new ParagraphInfo(m4303Paragraph_EkL_Y, paragraphIntrinsicInfo.getStartIndex(), paragraphIntrinsicInfo.getEndIndex(), i3, lineCount, f, height));
            if (m4303Paragraph_EkL_Y.getDidExceedMaxLines() || (lineCount == this.maxLines && i4 != CollectionsKt.getLastIndex(this.intrinsics.getInfoList$ui_text_release()))) {
                z2 = true;
                i3 = lineCount;
                f = height;
                break;
        ...
        this.width = Constraints.m4828getMaxWidthimpl(j);
    ...
    public static /* synthetic */ void m4289paintRPmYEkk$default(MultiParagraph multiParagraph, Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration, int i, Object obj) {
        if ((i & 2) != 0) {
            j = Color.Companion.m2664getUnspecified0d7_KjU();
        }
        multiParagraph.m4294paintRPmYEkk(canvas, j, (i & 4) != 0 ? null : shadow, (i & 8) != 0 ? null : textDecoration);
    }
    ...
    public final /* synthetic */ void m4294paintRPmYEkk(Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            paragraphInfo.getParagraph().mo4266paintRPmYEkk(canvas, j, shadow, textDecoration);
    ...
    public final void m4293paintLG529CI(Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        canvas.save();
        List<ParagraphInfo> list = this.paragraphInfoList;
        int size = list.size();
        for (int i2 = 0; i2 < size; i2++) {
            ...
            paragraphInfo.getParagraph().mo4265paintLG529CI(canvas, j, shadow, textDecoration, drawStyle, i);
            canvas.translate(0.0f, paragraphInfo.getParagraph().getHeight());
        }
        canvas.restore();
    }
    ...
    public final void m4295painthn5TExg(Canvas canvas, Brush brush, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        Intrinsics.checkNotNullParameter(brush, "brush");
        AndroidMultiParagraphDrawKt.m4627drawMultiParagraph7AXcY_I(this, canvas, brush, f, shadow, textDecoration, drawStyle, i);
    }
    ...
    public final Path getPathForRange(int i, int i2) {
        ...
        for (int findParagraphByIndex = MultiParagraphKt.findParagraphByIndex(this.paragraphInfoList, i); findParagraphByIndex < size; findParagraphByIndex++) {
            ...
            if (paragraphInfo.getStartIndex() != paragraphInfo.getEndIndex()) {
                Path.m2892addPathUv8p0NA$default(Path, paragraphInfo.toGlobal(paragraphInfo.getParagraph().getPathForRange(paragraphInfo.toLocalIndex(i), paragraphInfo.toLocalIndex(i2))), 0L, 2, null);
            }
        }
        return Path;
    }
    ...
    public final int m4291getOffsetForPositionk4lQ0M(long j) {
        int lastIndex;
        if (Offset.m2390getYimpl(j) <= 0.0f) {
            lastIndex = 0;
        } else {
            lastIndex = Offset.m2390getYimpl(j) >= this.height ? CollectionsKt.getLastIndex(this.paragraphInfoList) : MultiParagraphKt.findParagraphByY(this.paragraphInfoList, Offset.m2390getYimpl(j));
        }
        ParagraphInfo paragraphInfo = this.paragraphInfoList.get(lastIndex);
        if (paragraphInfo.getLength() == 0) {
            return Math.max(0, paragraphInfo.getStartIndex() - 1);
        }
        return paragraphInfo.toGlobalIndex(paragraphInfo.getParagraph().mo4263getOffsetForPositionk4lQ0M(paragraphInfo.m4300toLocalMKHz9U(j)));
    }
    ...
    public final long m4292getWordBoundaryjx7JFs(int i) {
        int findParagraphByIndex;
        requireIndexInRangeInclusiveEnd(i);
        if (i == getAnnotatedString().length()) {
            findParagraphByIndex = CollectionsKt.getLastIndex(this.paragraphInfoList);
        ...
        ParagraphInfo paragraphInfo = this.paragraphInfoList.get(findParagraphByIndex);
        return paragraphInfo.m4299toGlobalGEjPoXI(paragraphInfo.getParagraph().mo4264getWordBoundaryjx7JFs(paragraphInfo.toLocalIndex(i)));
    }
