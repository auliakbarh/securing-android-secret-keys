...
public final class SliderTokens {
    ...
    private static final float DisabledHandleElevation = ElevationTokens.INSTANCE.m1814getLevel0D9Ej5fM();
    ...
    private static final float HandleElevation = ElevationTokens.INSTANCE.m1815getLevel1D9Ej5fM();
    ...
    private static final float LabelContainerElevation = ElevationTokens.INSTANCE.m1814getLevel0D9Ej5fM();
    private static final float LabelContainerHeight = Dp.m4872constructorimpl((float) 28.0d);
    ...
    private static final float TrackElevation = ElevationTokens.INSTANCE.m1814getLevel0D9Ej5fM();
    private static final ColorSchemeKeyTokens OverlapHandleOutlineColor = ColorSchemeKeyTokens.OnPrimary;
    private static final float OverlapHandleOutlineWidth = Dp.m4872constructorimpl((float) 1.0d);
    ...
    private static final float TickMarksContainerSize = Dp.m4872constructorimpl((float) 2.0d);
    ...
    public final float m2110getActiveTrackHeightD9Ej5fM() {
    ...
    public final float m2111getDisabledHandleElevationD9Ej5fM() {
    ...
    public final float m2112getHandleElevationD9Ej5fM() {
        return HandleElevation;
    }

    /* renamed from: getHandleHeight-D9Ej5fM  reason: not valid java name */
    public final float m2113getHandleHeightD9Ej5fM() {
        return HandleHeight;
    }
    ...
    public final float m2114getHandleWidthD9Ej5fM() {
        return HandleWidth;
    }
    ...
    public final float m2115getInactiveTrackHeightD9Ej5fM() {
    ...
    public final float m2116getLabelContainerElevationD9Ej5fM() {
        return LabelContainerElevation;
    }

    /* renamed from: getLabelContainerHeight-D9Ej5fM  reason: not valid java name */
    public final float m2117getLabelContainerHeightD9Ej5fM() {
    ...
    public final float m2118getOverlapHandleOutlineWidthD9Ej5fM() {
    ...
    public final float m2119getStateLayerSizeD9Ej5fM() {
    ...
    public final float m2120getTickMarksContainerSizeD9Ej5fM() {
    ...
    public final float m2121getTrackElevationD9Ej5fM() {
    ...
    static {
        float f = (float) 4.0d;
        ActiveTrackHeight = Dp.m4872constructorimpl(f);
        float f2 = (float) 20.0d;
        HandleHeight = Dp.m4872constructorimpl(f2);
        HandleWidth = Dp.m4872constructorimpl(f2);
        InactiveTrackHeight = Dp.m4872constructorimpl(f);
    }
}