...
public final class DebugStringsKt {
    ...
    public static final String toDebugString(Continuation<?> continuation) {
        String m5158constructorimpl;
        if (continuation instanceof DispatchedContinuation) {
            return continuation.toString();
        }
        try {
            Result.Companion companion = Result.Companion;
            m5158constructorimpl = Result.m5158constructorimpl(continuation + '@' + getHexAddress(continuation));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m5158constructorimpl = Result.m5158constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m5161exceptionOrNullimpl(m5158constructorimpl) != null) {
            m5158constructorimpl = continuation.getClass().getName() + '@' + getHexAddress(continuation);
        }
        return (String) m5158constructorimpl;
    }
