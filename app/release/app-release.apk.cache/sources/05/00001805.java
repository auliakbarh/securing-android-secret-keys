...
public final class EmojiSupportMatch {
    ...
    private static final int Default = m4280constructorimpl(0);
    private static final int None = m4280constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ EmojiSupportMatch m4279boximpl(int i) {
        return new EmojiSupportMatch(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m4280constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4281equalsimpl(int i, Object obj) {
        return (obj instanceof EmojiSupportMatch) && i == ((EmojiSupportMatch) obj).m4285unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m4282equalsimpl0(int i, int i2) {
        return i == i2;
    }
    ...
    public int hashCode() {
        return m4283hashCodeimpl(this.value);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ int m4285unboximpl() {
        return this.value;
    }
    ...
    public String toString() {
        return m4284toStringimpl(this.value);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m4284toStringimpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m4286getDefault_3YsG6Y() {
            return EmojiSupportMatch.Default;
        }

        /* renamed from: getNone-_3YsG6Y  reason: not valid java name */
        public final int m4287getNone_3YsG6Y() {
