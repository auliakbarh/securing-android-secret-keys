...
public final class DateRangePickerKt {
    ...
    private static final PaddingValues CalendarMonthSubheadPadding = PaddingKt.m476PaddingValuesa9UjIt4$default(Dp.m4872constructorimpl(24), Dp.m4872constructorimpl(20), 0.0f, Dp.m4872constructorimpl(8), 4, null);
    private static final float HeaderHeightOffset = Dp.m4872constructorimpl(60);

    public static final /* synthetic */ void access$DateRangePickerContent(StateData stateData, DatePickerFormatter datePickerFormatter, Function1 function1, DatePickerColors datePickerColors, Composer composer, int i) {
        DateRangePickerContent(stateData, datePickerFormatter, function1, datePickerColors, composer, i);
    }

    public static final /* synthetic */ void access$SwitchableDateEntryContent(DateRangePickerState dateRangePickerState, DatePickerFormatter datePickerFormatter, Function1 function1, DatePickerColors datePickerColors, Composer composer, int i) {
        SwitchableDateEntryContent(dateRangePickerState, datePickerFormatter, function1, datePickerColors, composer, i);
    }

    public static final /* synthetic */ void access$VerticalMonthsList(Function1 function1, StateData stateData, LazyListState lazyListState, DatePickerFormatter datePickerFormatter, Function1 function12, DatePickerColors datePickerColors, Composer composer, int i) {
        VerticalMonthsList(function1, stateData, lazyListState, datePickerFormatter, function12, datePickerColors, composer, i);
    }

    public static final /* synthetic */ void access$updateDateSelection(StateData stateData, long j) {
        updateDateSelection(stateData, j);
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:282:0x027a  */
    /*
    ...
    */
    ...
    public static final DateRangePickerState m1152rememberDateRangePickerStatepMw4iz8(Long l, Long l2, Long l3, IntRange intRange, int i, Composer composer, int i2, int i3) {
        ...
        final int m1173getPickerjFl4v0 = (i3 & 16) != 0 ? DisplayMode.Companion.m1173getPickerjFl4v0() : i;
        ...
        DateRangePickerState dateRangePickerState = (DateRangePickerState) RememberSaveableKt.m2275rememberSaveable(new Object[0], (Saver<Object, ? extends Object>) DateRangePickerState.Companion.Saver(), (String) null, (Function0<? extends Object>) new Function0<DateRangePickerState>() { // from class: androidx.compose.material3.DateRangePickerKt$rememberDateRangePickerState$1
            ...
            public final DateRangePickerState invoke() {
                return new DateRangePickerState(l4, l5, l6, yearRange, m1173getPickerjFl4v0, null);
            }
        }, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void SwitchableDateEntryContent(final DateRangePickerState dateRangePickerState, final DatePickerFormatter datePickerFormatter, final Function1<? super Long, Boolean> function1, final DatePickerColors datePickerColors, Composer composer, final int i) {
        ...
        if ((i3 & 5851) != 1170 || !startRestartGroup.getSkipping()) {
            ...
            int m1155getDisplayModejFl4v0 = dateRangePickerState.m1155getDisplayModejFl4v0();
            CrossfadeKt.Crossfade(DisplayMode.m1165boximpl(m1155getDisplayModejFl4v0), SemanticsModifierKt.semantics$default(Modifier.Companion, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$SwitchableDateEntryContent$1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(DisplayMode displayMode, Composer composer2, Integer num) {
                    m1154invokeQujVXRc(displayMode.m1171unboximpl(), composer2, num.intValue());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-QujVXRc  reason: not valid java name */
                public final void m1154invokeQujVXRc(int i4, Composer composer2, int i5) {
                    int i6;
                    ...
                    if ((i6 & 91) != 18 || !composer2.getSkipping()) {
                        ...
                        if (DisplayMode.m1168equalsimpl0(i4, DisplayMode.Companion.m1173getPickerjFl4v0())) {
                            ...
                            int i7 = i3;
                            DateRangePickerKt.DateRangePickerContent(stateData$material3_release, datePickerFormatter2, function12, datePickerColors2, composer2, (i7 & 112) | (i7 & 896) | (i7 & 7168));
                            ...
                            int i8 = i3;
                            DateRangeInputKt.DateRangeInputContent(stateData$material3_release2, datePickerFormatter3, function13, composer2, (i8 & 896) | (i8 & 112));
                            composer2.endReplaceableGroup();
                        } else {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$SwitchableDateEntryContent$3
            ...
            public final void invoke(Composer composer2, int i4) {
                DateRangePickerKt.access$SwitchableDateEntryContent(DateRangePickerState.this, datePickerFormatter, function1, datePickerColors, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    public static final void DateRangePickerContent(final StateData stateData, final DatePickerFormatter datePickerFormatter, final Function1<? super Long, Boolean> function1, final DatePickerColors datePickerColors, Composer composer, final int i) {
        ...
        if ((i2 & 5851) != 1170 || !startRestartGroup.getSkipping()) {
            ...
            if (changed || rememberedValue == Composer.Companion.getEmpty()) {
                rememberedValue = (Function1) new Function1<Long, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$DateRangePickerContent$onDateSelected$1$1
                    ...
                    public final void invoke(long j) {
                        DateRangePickerKt.access$updateDateSelection(StateData.this, j);
                    }
                };
            ...
            Modifier m481paddingVpY3zN4$default = PaddingKt.m481paddingVpY3zN4$default(Modifier.Companion, DatePickerKt.getDatePickerHorizontalPadding(), 0.0f, 2, null);
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf = LayoutKt.materializerOf(m481paddingVpY3zN4$default);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$DateRangePickerContent$2
            ...
            public final void invoke(Composer composer2, int i4) {
                DateRangePickerKt.access$DateRangePickerContent(StateData.this, datePickerFormatter, function1, datePickerColors, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    public static final void VerticalMonthsList(final Function1<? super Long, Unit> function1, final StateData stateData, final LazyListState lazyListState, final DatePickerFormatter datePickerFormatter, final Function1<? super Long, Boolean> function12, final DatePickerColors datePickerColors, Composer composer, final int i) {
            ...
            TextKt.ProvideTextStyle(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography(startRestartGroup, 6), DatePickerModalTokens.INSTANCE.getRangeSelectionMonthSubheadFont()), ComposableLambdaKt.composableLambda(startRestartGroup, 56792252, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$VerticalMonthsList$1
                ...
                public final void invoke(Composer composer2, int i4) {
                    ...
                    if ((i4 & 11) != 2 || !composer2.getSkipping()) {
                        ...
                        composer2.endReplaceableGroup();
                        final String m1464getStringNWtq28 = Strings_androidKt.m1464getStringNWtq28(Strings.Companion.m1436getDateRangePickerScrollToShowPreviousMonthadMyvUU(), composer2, 6);
                        final String m1464getStringNWtq282 = Strings_androidKt.m1464getStringNWtq28(Strings.Companion.m1435getDateRangePickerScrollToShowNextMonthadMyvUU(), composer2, 6);
                                ...
                                LazyListScope.items$default(LazyColumn, totalMonthsInRange, null, null, ComposableLambdaKt.composableLambdaInstance(1246706073, true, new Function4<LazyItemScope, Integer, Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt.VerticalMonthsList.1.2.1
                                    ...
                                    public final void invoke(LazyItemScope items, int i7, Composer composer3, int i8) {
                                        ...
                                        if ((i9 & 731) != 146 || !composer3.getSkipping()) {
                                            ...
                                            TextKt.m1551Text4IGK_g(formatMonthYear$material3_release, SemanticsModifierKt.semantics$default(ClickableKt.m191clickableXHw0xAI$default(PaddingKt.padding(Modifier.Companion, DateRangePickerKt.getCalendarMonthSubheadPadding()), false, null, null, new Function0<Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$VerticalMonthsList$1$2$1$1$1
                                                /* renamed from: invoke  reason: avoid collision after fix types in other method */
                                            ...
                                            }, 1, null), datePickerColors4.m1136getSubheadContentColor0d7_KjU$material3_release(), 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer3, 0, 0, 131064);
                                            int i11 = i10 << 3;
                                            int i12 = i10 << 6;
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$VerticalMonthsList$3
            ...
            public final void invoke(Composer composer2, int i5) {
                DateRangePickerKt.access$VerticalMonthsList(function1, stateData, lazyListState, datePickerFormatter, function12, datePickerColors, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    public static final void m1151drawRangeBackgroundmxwnekA(ContentDrawScope drawRangeBackground, SelectedRangeInfo selectedRangeInfo, long j) {
        ...
        float f = drawRangeBackground.mo324toPx0680j_4(DatePickerKt.getRecommendedSizeForAccessibility());
        float f2 = drawRangeBackground.mo324toPx0680j_4(DatePickerKt.getRecommendedSizeForAccessibility());
        float f3 = drawRangeBackground.mo324toPx0680j_4(DatePickerModalTokens.INSTANCE.m1785getDateStateLayerHeightD9Ej5fM());
        float f4 = 2;
        float f5 = (f2 - f3) / f4;
        float f6 = 7;
        float m2458getWidthimpl2 = (Size.m2458getWidthimpl(drawRangeBackground.mo3171getSizeNHjbRc()) - (f6 * f)) / f6;
        long m4999unboximpl = selectedRangeInfo.getGridCoordinates().getFirst().m4999unboximpl();
        int m4982component1impl = IntOffset.m4982component1impl(m4999unboximpl);
        int m4983component2impl = IntOffset.m4983component2impl(m4999unboximpl);
        long m4999unboximpl2 = selectedRangeInfo.getGridCoordinates().getSecond().m4999unboximpl();
        int m4982component1impl2 = IntOffset.m4982component1impl(m4999unboximpl2);
        int m4983component2impl2 = IntOffset.m4983component2impl(m4999unboximpl2);
        float f7 = f + m2458getWidthimpl2;
        float f8 = m2458getWidthimpl2 / f4;
        float f9 = (m4982component1impl * f7) + (selectedRangeInfo.getFirstIsSelectionStart() ? f / f4 : 0.0f) + f8;
        float f10 = (m4983component2impl * f2) + f5;
        float f11 = m4982component1impl2 * f7;
        if (selectedRangeInfo.getLastIsSelectionEnd()) {
            f /= f4;
        }
        float f12 = f11 + f + f8;
        float f13 = (m4983component2impl2 * f2) + f5;
        boolean z = drawRangeBackground.getLayoutDirection() == LayoutDirection.Rtl;
        if (z) {
            f9 = Size.m2458getWidthimpl(drawRangeBackground.mo3171getSizeNHjbRc()) - f9;
            f12 = Size.m2458getWidthimpl(drawRangeBackground.mo3171getSizeNHjbRc()) - f12;
        }
        ContentDrawScope contentDrawScope = drawRangeBackground;
        long Offset = OffsetKt.Offset(f9, f10);
        if (m4983component2impl == m4983component2impl2) {
            m2458getWidthimpl = f12 - f9;
        } else {
            m2458getWidthimpl = z ? -f9 : Size.m2458getWidthimpl(drawRangeBackground.mo3171getSizeNHjbRc()) - f9;
        }
        DrawScope.m3166drawRectnJ9OG0$default(contentDrawScope, j, Offset, SizeKt.Size(m2458getWidthimpl, f3), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
        if (m4983component2impl != m4983component2impl2) {
            for (int i = (m4983component2impl2 - m4983component2impl) - 1; i > 0; i--) {
                DrawScope.m3166drawRectnJ9OG0$default(contentDrawScope, j, OffsetKt.Offset(0.0f, (i * f2) + f10), SizeKt.Size(Size.m2458getWidthimpl(drawRangeBackground.mo3171getSizeNHjbRc()), f3), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
            }
            long Offset2 = OffsetKt.Offset(drawRangeBackground.getLayoutDirection() != LayoutDirection.Ltr ? Size.m2458getWidthimpl(drawRangeBackground.mo3171getSizeNHjbRc()) : 0.0f, f13);
            if (z) {
                f12 -= Size.m2458getWidthimpl(drawRangeBackground.mo3171getSizeNHjbRc());
            }
            DrawScope.m3166drawRectnJ9OG0$default(contentDrawScope, j, Offset2, SizeKt.Size(f12, f3), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
        }
    }
    ...
    static {
        float f = 64;
        float f2 = 12;
        DateRangePickerTitlePadding = PaddingKt.m476PaddingValuesa9UjIt4$default(Dp.m4872constructorimpl(f), 0.0f, Dp.m4872constructorimpl(f2), 0.0f, 10, null);
        DateRangePickerHeadlinePadding = PaddingKt.m476PaddingValuesa9UjIt4$default(Dp.m4872constructorimpl(f), 0.0f, Dp.m4872constructorimpl(f2), Dp.m4872constructorimpl(f2), 2, null);
    }
}