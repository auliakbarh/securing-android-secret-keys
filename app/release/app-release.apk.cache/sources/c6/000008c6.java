...
public final class TextLayoutHelperKt {
    ...
    public static final boolean m830canReuse7_7YC6M(TextLayoutResult canReuse, AnnotatedString text, TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int i, boolean z, int i2, Density density, LayoutDirection layoutDirection, FontFamily.Resolver fontFamilyResolver, long j) {
        ...
        if (!canReuse.getMultiParagraph().getIntrinsics().getHasStaleResolvedFonts() && Intrinsics.areEqual(layoutInput.getText(), text) && layoutInput.getStyle().hasSameLayoutAffectingAttributes(style) && Intrinsics.areEqual(layoutInput.getPlaceholders(), placeholders) && layoutInput.getMaxLines() == i && layoutInput.getSoftWrap() == z && TextOverflow.m4806equalsimpl0(layoutInput.m4372getOverflowgIe3tQ8(), i2) && Intrinsics.areEqual(layoutInput.getDensity(), density) && layoutInput.getLayoutDirection() == layoutDirection && Intrinsics.areEqual(layoutInput.getFontFamilyResolver(), fontFamilyResolver) && Constraints.m4830getMinWidthimpl(j) == Constraints.m4830getMinWidthimpl(layoutInput.m4371getConstraintsmsEJaDk())) {
            if (z || TextOverflow.m4806equalsimpl0(i2, TextOverflow.Companion.m4814getEllipsisgIe3tQ8())) {
                return Constraints.m4828getMaxWidthimpl(j) == Constraints.m4828getMaxWidthimpl(layoutInput.m4371getConstraintsmsEJaDk()) && Constraints.m4827getMaxHeightimpl(j) == Constraints.m4827getMaxHeightimpl(layoutInput.m4371getConstraintsmsEJaDk());
            }
            return true;
        }
        return false;
