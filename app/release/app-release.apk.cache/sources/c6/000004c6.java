...
public final class ColumnKt {
    ...
    static {
        ...
        float mo396getSpacingD9Ej5fM = Arrangement.INSTANCE.getTop().mo396getSpacingD9Ej5fM();
        ...
        DefaultColumnMeasurePolicy = RowColumnImplKt.m504rowColumnMeasurePolicyTDGSqEk(layoutOrientation, new Function5<Integer, int[], LayoutDirection, Density, int[], Unit>() { // from class: androidx.compose.foundation.layout.ColumnKt$DefaultColumnMeasurePolicy$1
        ...
        }, mo396getSpacingD9Ej5fM, SizeMode.Wrap, horizontal$foundation_layout_release);
    }
    ...
    public static final MeasurePolicy columnMeasurePolicy(final Arrangement.Vertical verticalArrangement, Alignment.Horizontal horizontalAlignment, Composer composer, int i) {
        ...
        if (Intrinsics.areEqual(verticalArrangement, Arrangement.INSTANCE.getTop()) && Intrinsics.areEqual(horizontalAlignment, Alignment.Companion.getStart())) {
            ...
            if (changed || rememberedValue == Composer.Companion.getEmpty()) {
                LayoutOrientation layoutOrientation = LayoutOrientation.Vertical;
                float mo396getSpacingD9Ej5fM = verticalArrangement.mo396getSpacingD9Ej5fM();
                ...
                rememberedValue = RowColumnImplKt.m504rowColumnMeasurePolicyTDGSqEk(layoutOrientation, new Function5<Integer, int[], LayoutDirection, Density, int[], Unit>() { // from class: androidx.compose.foundation.layout.ColumnKt$columnMeasurePolicy$1$1
