...
public final class Selection {
    ...
    private static final int Hour = m1372constructorimpl(0);
    private static final int Minute = m1372constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ Selection m1371boximpl(int i) {
        return new Selection(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m1372constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1373equalsimpl(int i, Object obj) {
        return (obj instanceof Selection) && i == ((Selection) obj).m1377unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m1374equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m1375hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1376toStringimpl(int i) {
        return "Selection(value=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m1373equalsimpl(this.value, obj);
    }
    ...
    public String toString() {
        return m1376toStringimpl(this.value);
    }
