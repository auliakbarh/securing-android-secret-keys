...
public abstract class Adaptation {
    ...
    private static final Adaptation Bradford = new Adaptation(new float[]{0.8951f, -0.7502f, 0.0389f, 0.2664f, 1.7135f, -0.0685f, -0.1614f, 0.0367f, 1.0296f}) { // from class: androidx.compose.ui.graphics.colorspace.Adaptation$Companion$Bradford$1
        public String toString() {
            return "Bradford";
        }
    };
    private static final Adaptation VonKries = new Adaptation(new float[]{0.40024f, -0.2263f, 0.0f, 0.7076f, 1.16532f, 0.0f, -0.08081f, 0.0457f, 0.91822f}) { // from class: androidx.compose.ui.graphics.colorspace.Adaptation$Companion$VonKries$1
        public String toString() {
            return "VonKries";
        }
    };
    private static final Adaptation Ciecat02 = new Adaptation(new float[]{0.7328f, -0.7036f, 0.003f, 0.4296f, 1.6975f, 0.0136f, -0.1624f, 0.0061f, 0.9834f}) { // from class: androidx.compose.ui.graphics.colorspace.Adaptation$Companion$Ciecat02$1
        public String toString() {
            return "Ciecat02";
        }
    };
