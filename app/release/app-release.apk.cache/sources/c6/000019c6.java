...
public final class TextIndent {
    ...
    public final long m4788getFirstLineXSAIIZE() {
        return this.firstLine;
    }

    /* renamed from: getRestLine-XSAIIZE  reason: not valid java name */
    public final long m4789getRestLineXSAIIZE() {
    ...
    public static /* synthetic */ TextIndent m4786copyNB67dxo$default(TextIndent textIndent, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textIndent.m4787copyNB67dxo(j, j2);
    }

    /* renamed from: copy-NB67dxo  reason: not valid java name */
    public final TextIndent m4787copyNB67dxo(long j, long j2) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TextIndent) {
            ...
            return TextUnit.m5050equalsimpl0(this.firstLine, textIndent.firstLine) && TextUnit.m5050equalsimpl0(this.restLine, textIndent.restLine);
        }
        return false;
    }

    public int hashCode() {
        return (TextUnit.m5054hashCodeimpl(this.firstLine) * 31) + TextUnit.m5054hashCodeimpl(this.restLine);
    }

    public String toString() {
        return "TextIndent(firstLine=" + ((Object) TextUnit.m5060toStringimpl(this.firstLine)) + ", restLine=" + ((Object) TextUnit.m5060toStringimpl(this.restLine)) + ')';
    }
}