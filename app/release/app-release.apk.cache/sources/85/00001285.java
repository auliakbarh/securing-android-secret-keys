...
public final class BiasAbsoluteAlignment implements Alignment {
    ...
    public long mo2279alignKFBX0sM(long j, long j2, LayoutDirection layoutDirection) {
        ...
        long IntSize = IntSizeKt.IntSize(IntSize.m5032getWidthimpl(j2) - IntSize.m5032getWidthimpl(j), IntSize.m5031getHeightimpl(j2) - IntSize.m5031getHeightimpl(j));
        float f = 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt((IntSize.m5032getWidthimpl(IntSize) / 2.0f) * (this.horizontalBias + f)), MathKt.roundToInt((IntSize.m5031getHeightimpl(IntSize) / 2.0f) * (f + this.verticalBias)));
    }
