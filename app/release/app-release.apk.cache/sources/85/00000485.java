...
final class AlignmentLineOffsetDpNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m372setAfter0680j_4(float f) {
        this.after = f;
    }
    ...
    public final void m373setBefore0680j_4(float f) {
        this.before = f;
    }
    ...
    public MeasureResult mo236measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        m359alignmentLineOffsetMeasuretjqqzMA = AlignmentLineKt.m359alignmentLineOffsetMeasuretjqqzMA(measure, this.alignmentLine, this.before, this.after, measurable, j);
