...
public interface ContentScale {
    ...
    long mo3856computeScaleFactorH7hwNQA(long j, long j2);
    ...
    public static final class Companion {
        ...
        private static final ContentScale Crop = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Crop$1
            ...
            public long mo3856computeScaleFactorH7hwNQA(long j, long j2) {
                float m3858access$computeFillMaxDimensioniLBOSCw = ContentScaleKt.m3858access$computeFillMaxDimensioniLBOSCw(j, j2);
                return ScaleFactorKt.ScaleFactor(m3858access$computeFillMaxDimensioniLBOSCw, m3858access$computeFillMaxDimensioniLBOSCw);
            }
        };
        private static final ContentScale Fit = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Fit$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo3856computeScaleFactorH7hwNQA(long j, long j2) {
                float m3859access$computeFillMinDimensioniLBOSCw = ContentScaleKt.m3859access$computeFillMinDimensioniLBOSCw(j, j2);
                return ScaleFactorKt.ScaleFactor(m3859access$computeFillMinDimensioniLBOSCw, m3859access$computeFillMinDimensioniLBOSCw);
            }
        };
        private static final ContentScale FillHeight = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillHeight$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo3856computeScaleFactorH7hwNQA(long j, long j2) {
                float m3857access$computeFillHeightiLBOSCw = ContentScaleKt.m3857access$computeFillHeightiLBOSCw(j, j2);
                return ScaleFactorKt.ScaleFactor(m3857access$computeFillHeightiLBOSCw, m3857access$computeFillHeightiLBOSCw);
            }
        };
        private static final ContentScale FillWidth = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillWidth$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo3856computeScaleFactorH7hwNQA(long j, long j2) {
                float m3860access$computeFillWidthiLBOSCw = ContentScaleKt.m3860access$computeFillWidthiLBOSCw(j, j2);
                return ScaleFactorKt.ScaleFactor(m3860access$computeFillWidthiLBOSCw, m3860access$computeFillWidthiLBOSCw);
            }
        };
        private static final ContentScale Inside = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Inside$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo3856computeScaleFactorH7hwNQA(long j, long j2) {
                if (Size.m2458getWidthimpl(j) <= Size.m2458getWidthimpl(j2) && Size.m2455getHeightimpl(j) <= Size.m2455getHeightimpl(j2)) {
        ...
        private static final ContentScale FillBounds = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillBounds$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo3856computeScaleFactorH7hwNQA(long j, long j2) {
                return ScaleFactorKt.ScaleFactor(ContentScaleKt.m3860access$computeFillWidthiLBOSCw(j, j2), ContentScaleKt.m3857access$computeFillHeightiLBOSCw(j, j2));
            }
        };
