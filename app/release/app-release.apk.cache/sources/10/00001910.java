...
public final class TypefaceRequest {
    ...
    public static /* synthetic */ TypefaceRequest m4538copye1PVR60$default(TypefaceRequest typefaceRequest, FontFamily fontFamily, FontWeight fontWeight, int i, int i2, Object obj, int i3, Object obj2) {
        if ((i3 & 1) != 0) {
        ...
        return typefaceRequest.m4541copye1PVR60(fontFamily, fontWeight2, i4, i5, obj);
    }
    ...
    public final int m4539component3_LCdwA() {
        return this.fontStyle;
    }

    /* renamed from: component4-GVVA2EU  reason: not valid java name */
    public final int m4540component4GVVA2EU() {
    ...
    public final TypefaceRequest m4541copye1PVR60(FontFamily fontFamily, FontWeight fontWeight, int i, int i2, Object obj) {
    ...
    public final int m4542getFontStyle_LCdwA() {
        return this.fontStyle;
    }

    /* renamed from: getFontSynthesis-GVVA2EU  reason: not valid java name */
    public final int m4543getFontSynthesisGVVA2EU() {
        return this.fontSynthesis;
    }
    ...
    public int hashCode() {
        ...
        int hashCode = (((((((fontFamily == null ? 0 : fontFamily.hashCode()) * 31) + this.fontWeight.hashCode()) * 31) + FontStyle.m4500hashCodeimpl(this.fontStyle)) * 31) + FontSynthesis.m4509hashCodeimpl(this.fontSynthesis)) * 31;
        Object obj = this.resourceLoaderCacheKey;
        return hashCode + (obj != null ? obj.hashCode() : 0);
    }

    public String toString() {
        return "TypefaceRequest(fontFamily=" + this.fontFamily + ", fontWeight=" + this.fontWeight + ", fontStyle=" + ((Object) FontStyle.m4501toStringimpl(this.fontStyle)) + ", fontSynthesis=" + ((Object) FontSynthesis.m4512toStringimpl(this.fontSynthesis)) + ", resourceLoaderCacheKey=" + this.resourceLoaderCacheKey + ')';
    }
