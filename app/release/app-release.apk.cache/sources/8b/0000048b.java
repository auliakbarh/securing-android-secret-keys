...
final class AndroidFlingSpline {
    ...
    public final long m380flingPositionLfoxSSI(float f) {
        float f2;
        float f3;
        float f4 = 100;
        int i = (int) (f4 * f);
        ...
        return FlingResult.m382constructorimpl((Float.floatToIntBits(f3) & 4294967295L) | (Float.floatToIntBits(f2) << 32));
    }
    ...
    public static final class FlingResult {
        ...
        public static boolean m383equalsimpl(long j, Object obj) {
            return (obj instanceof FlingResult) && j == ((FlingResult) obj).m389unboximpl();
        }
