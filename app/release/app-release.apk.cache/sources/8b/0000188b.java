...
public final class TextLayout {
    ...
    public TextLayout(CharSequence charSequence, float f, TextPaint textPaint, int i, TextUtils.TruncateAt truncateAt, int i2, float f2, float f3, boolean z, boolean z2, int i3, int i4, int i5, int i6, int i7, int i8, int[] iArr, int[] iArr2, LayoutIntrinsics layoutIntrinsics) {
        ...
        try {
            ...
            this.topPadding = Math.max(VerticalPaddings.m4442getTopPaddingimpl(verticalPaddings), VerticalPaddings.m4442getTopPaddingimpl(lineHeightPaddings));
            this.bottomPadding = Math.max(VerticalPaddings.m4441getBottomPaddingimpl(verticalPaddings), VerticalPaddings.m4441getBottomPaddingimpl(lineHeightPaddings));
            ...
            this.layoutHelper$delegate = LazyKt.lazy(LazyThreadSafetyMode.NONE, (Function0) new Function0<LayoutHelper>() { // from class: androidx.compose.ui.text.android.TextLayout$layoutHelper$2
