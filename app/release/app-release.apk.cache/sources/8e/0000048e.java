...
public final class Arrangement {
    ...
    private static final HorizontalOrVertical Center = new HorizontalOrVertical() { // from class: androidx.compose.foundation.layout.Arrangement$Center$1
        private final float spacing = Dp.m4872constructorimpl(0);

        @Override // androidx.compose.foundation.layout.Arrangement.HorizontalOrVertical, androidx.compose.foundation.layout.Arrangement.Horizontal, androidx.compose.foundation.layout.Arrangement.Vertical
        /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
        public float mo396getSpacingD9Ej5fM() {
            return this.spacing;
        }
    ...
    public interface Horizontal {
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
            public static float m398getSpacingD9Ej5fM(Horizontal horizontal) {
                return Horizontal.super.mo396getSpacingD9Ej5fM();
            }
        }

        /* renamed from: getSpacing-D9Ej5fM */
        default float mo396getSpacingD9Ej5fM() {
    ...
    public interface Vertical {
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
            public static float m406getSpacingD9Ej5fM(Vertical vertical) {
                return Vertical.super.mo396getSpacingD9Ej5fM();
            }
        }
    ...
    public interface HorizontalOrVertical extends Horizontal, Vertical {
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
            public static float m400getSpacingD9Ej5fM(HorizontalOrVertical horizontalOrVertical) {
                return HorizontalOrVertical.super.mo396getSpacingD9Ej5fM();
            }
        }
    ...
    public final HorizontalOrVertical m390spacedBy0680j_4(float f) {
    ...
    public final Horizontal m391spacedByD5KLDUw(float f, final Alignment.Horizontal alignment) {
    ...
    /* renamed from: spacedBy-D5KLDUw  reason: not valid java name */
    public final Vertical m392spacedByD5KLDUw(float f, final Alignment.Vertical alignment) {
        Intrinsics.checkNotNullParameter(alignment, "alignment");
    ...
    public final Horizontal aligned(final Alignment.Horizontal alignment) {
        Intrinsics.checkNotNullParameter(alignment, "alignment");
        return new SpacedAligned(Dp.m4872constructorimpl(0), true, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement$aligned$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(2);
            }
    ...
    public final Vertical aligned(final Alignment.Vertical alignment) {
        Intrinsics.checkNotNullParameter(alignment, "alignment");
        return new SpacedAligned(Dp.m4872constructorimpl(0), false, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement$aligned$2
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(2);
            }
    ...
    public static final class Absolute {
        ...
        /* renamed from: spacedBy-0680j_4  reason: not valid java name */
        public final HorizontalOrVertical m393spacedBy0680j_4(float f) {
            return new SpacedAligned(f, false, null, null);
        }

        /* renamed from: spacedBy-D5KLDUw  reason: not valid java name */
        public final Horizontal m394spacedByD5KLDUw(float f, final Alignment.Horizontal alignment) {
            Intrinsics.checkNotNullParameter(alignment, "alignment");
        ...
        /* renamed from: spacedBy-D5KLDUw  reason: not valid java name */
        public final Vertical m395spacedByD5KLDUw(float f, final Alignment.Vertical alignment) {
            Intrinsics.checkNotNullParameter(alignment, "alignment");
        ...
        public final Horizontal aligned(final Alignment.Horizontal alignment) {
            Intrinsics.checkNotNullParameter(alignment, "alignment");
            return new SpacedAligned(Dp.m4872constructorimpl(0), false, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement$Absolute$aligned$1
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(2);
                }
    ...
    public static final class SpacedAligned implements HorizontalOrVertical {
        ...
        public static /* synthetic */ SpacedAligned m401copy8Feqmps$default(SpacedAligned spacedAligned, float f, boolean z, Function2 function2, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return spacedAligned.m403copy8Feqmps(f, z, function2);
        }

        /* renamed from: component1-D9Ej5fM  reason: not valid java name */
        public final float m402component1D9Ej5fM() {
            return this.space;
        }
        ...
        public final SpacedAligned m403copy8Feqmps(float f, boolean z, Function2<? super Integer, ? super LayoutDirection, Integer> function2) {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof SpacedAligned) {
                ...
                return Dp.m4877equalsimpl0(this.space, spacedAligned.space) && this.rtlMirror == spacedAligned.rtlMirror && Intrinsics.areEqual(this.alignment, spacedAligned.alignment);
            }
            return false;
        }
        ...
        public final float m404getSpaceD9Ej5fM() {
            return this.space;
        }
        ...
        /* JADX WARN: Multi-variable type inference failed */
        public int hashCode() {
            int m4878hashCodeimpl = Dp.m4878hashCodeimpl(this.space) * 31;
            boolean z = this.rtlMirror;
            int i = z;
            if (z != 0) {
                i = 1;
            }
            int i2 = (m4878hashCodeimpl + i) * 31;
        ...
        public void arrange(Density density, int i, int[] sizes, LayoutDirection layoutDirection, int[] outPositions) {
            ...
            int mo318roundToPx0680j_4 = density.mo318roundToPx0680j_4(this.space);
            ...
            if (!z) {
                ...
                while (i4 < length) {
                    ...
                    outPositions[i5] = min;
                    int min2 = Math.min(mo318roundToPx0680j_4, (i - min) - i6);
                ...
                for (int length2 = sizes.length - 1; -1 < length2; length2--) {
                    ...
                    i3 = Math.min(mo318roundToPx0680j_4, (i - min3) - i8);
        ...
        public String toString() {
            return (this.rtlMirror ? "" : "Absolute") + "Arrangement#spacedAligned(" + ((Object) Dp.m4883toStringimpl(this.space)) + ", " + this.alignment + ')';
        }
    }
