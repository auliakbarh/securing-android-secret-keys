...
public final class PointerInputChangeEventProducer {
    ...
    public final InternalPointerEvent produce(PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator) {
        long j;
        boolean down;
        long mo3828screenToLocalMKHz9U;
        ...
        for (int i = 0; i < size; i++) {
            ...
            PointerInputData pointerInputData = this.previousPointerInputData.get(PointerId.m3727boximpl(pointerInputEventData.m3760getIdJ3iCeTQ()));
            if (pointerInputData == null) {
                j = pointerInputEventData.getUptime();
                mo3828screenToLocalMKHz9U = pointerInputEventData.m3761getPositionF1C5BW0();
                down = false;
            } else {
                long uptime = pointerInputData.getUptime();
                j = uptime;
                down = pointerInputData.getDown();
                mo3828screenToLocalMKHz9U = positionCalculator.mo3828screenToLocalMKHz9U(pointerInputData.m3751getPositionOnScreenF1C5BW0());
            }
            linkedHashMap.put(PointerId.m3727boximpl(pointerInputEventData.m3760getIdJ3iCeTQ()), new PointerInputChange(pointerInputEventData.m3760getIdJ3iCeTQ(), pointerInputEventData.getUptime(), pointerInputEventData.m3761getPositionF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.getPressure(), j, mo3828screenToLocalMKHz9U, down, false, pointerInputEventData.m3764getTypeT8wyACA(), (List) pointerInputEventData.getHistorical(), pointerInputEventData.m3763getScrollDeltaF1C5BW0(), (DefaultConstructorMarker) null));
            if (pointerInputEventData.getDown()) {
                this.previousPointerInputData.put(PointerId.m3727boximpl(pointerInputEventData.m3760getIdJ3iCeTQ()), new PointerInputData(pointerInputEventData.getUptime(), pointerInputEventData.m3762getPositionOnScreenF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.m3764getTypeT8wyACA(), null));
            } else {
                this.previousPointerInputData.remove(PointerId.m3727boximpl(pointerInputEventData.m3760getIdJ3iCeTQ()));
            }
        }
    ...
    public static final class PointerInputData {
        ...
        public final long m3751getPositionOnScreenF1C5BW0() {
            return this.positionOnScreen;
        }

        /* renamed from: getType-T8wyACA  reason: not valid java name */
        public final int m3752getTypeT8wyACA() {
            return this.type;
        }
