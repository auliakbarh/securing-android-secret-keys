...
public final class TextFieldState {
    ...
    public TextFieldState(TextDelegate textDelegate, RecomposeScope recomposeScope) {
        ...
        mutableStateOf$default2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m4870boximpl(Dp.m4872constructorimpl(0)), null, 2, null);
        ...
        this.onValueChange = new Function1<TextFieldValue, Unit>() { // from class: androidx.compose.foundation.text.TextFieldState$onValueChange$1
            ...
            public final void invoke2(TextFieldValue it) {
                ...
                TextFieldState.access$getOnValueChangeOriginal$p(TextFieldState.this).invoke(it);
        ...
        this.onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.foundation.text.TextFieldState$onImeActionPerformed$1
            ...
            public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                m829invokeKlQnJC8(imeAction.m4553unboximpl());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-KlQnJC8  reason: not valid java name */
            public final void m829invokeKlQnJC8(int i) {
                TextFieldState.access$getKeyboardActionRunner$p(TextFieldState.this).m760runActionKlQnJC8(i);
            }
        };
        this.selectionPaint = AndroidPaint_androidKt.Paint();
    }

    public static final /* synthetic */ KeyboardActionRunner access$getKeyboardActionRunner$p(TextFieldState textFieldState) {
        return textFieldState.keyboardActionRunner;
    }

    public static final /* synthetic */ Function1 access$getOnValueChangeOriginal$p(TextFieldState textFieldState) {
        return textFieldState.onValueChangeOriginal;
    }
    ...
    public final float m826getMinHeightForSingleLineFieldD9Ej5fM() {
        return ((Dp) this.minHeightForSingleLineField$delegate.getValue()).m4886unboximpl();
    }

    /* renamed from: setMinHeightForSingleLineField-0680j_4 */
    public final void m827setMinHeightForSingleLineField0680j_4(float f) {
        this.minHeightForSingleLineField$delegate.setValue(Dp.m4870boximpl(f));
    }
    ...
    public final void m828updatefnh65Uc(AnnotatedString untransformedText, AnnotatedString visualText, TextStyle textStyle, boolean z, Density density, FontFamily.Resolver fontFamilyResolver, Function1<? super TextFieldValue, Unit> onValueChange, KeyboardActions keyboardActions, FocusManager focusManager, long j) {
        TextDelegate m798updateTextDelegaterm0N8CA;
        ...
        this.selectionPaint.mo2509setColor8_81llA(j);
        ...
        m798updateTextDelegaterm0N8CA = TextDelegateKt.m798updateTextDelegaterm0N8CA(this.textDelegate, visualText, textStyle, density, fontFamilyResolver, (r23 & 32) != 0 ? true : z, (r23 & 64) != 0 ? TextOverflow.Companion.m4813getClipgIe3tQ8() : 0, (r23 & 128) != 0 ? Integer.MAX_VALUE : 0, (r23 & 256) != 0 ? 1 : 0, CollectionsKt.emptyList());
        if (this.textDelegate != m798updateTextDelegaterm0N8CA) {
            this.isLayoutResultStale = true;
        }
        this.textDelegate = m798updateTextDelegaterm0N8CA;
    }
