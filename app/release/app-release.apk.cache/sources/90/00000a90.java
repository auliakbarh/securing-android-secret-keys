...
public final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m970setColorDxMtmZc(long j, float f) {
        long m969calculateRippleColor5vOe2sY = m969calculateRippleColor5vOe2sY(j, f);
        Color color = this.rippleColor;
        if (color != null && Color.m2629equalsimpl0(color.m2638unboximpl(), m969calculateRippleColor5vOe2sY)) {
            return;
        }
        this.rippleColor = Color.m2618boximpl(m969calculateRippleColor5vOe2sY);
        setColor(ColorStateList.valueOf(ColorKt.m2682toArgb8_81llA(m969calculateRippleColor5vOe2sY)));
    }
    ...
    private final long m969calculateRippleColor5vOe2sY(long j, float f) {
        if (Build.VERSION.SDK_INT < 28) {
            f *= 2;
        }
        return Color.m2627copywmQWz5c$default(j, RangesKt.coerceAtMost(f, 1.0f), 0.0f, 0.0f, 0.0f, 14, null);
    }
