...
public final class WindowInsetsNestedScrollConnection implements NestedScrollConnection, WindowInsetsAnimationControlListener {
    ...
    public long mo333onPreScrollOzD1aCk(long j, int i) {
        return m555scroll8S9VItk(j, this.sideCalculator.hideMotion(Offset.m2389getXimpl(j), Offset.m2390getYimpl(j)));
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostScroll-DzOQY0M */
    public long mo332onPostScrollDzOQY0M(long j, long j2, int i) {
        return m555scroll8S9VItk(j2, this.sideCalculator.showMotion(Offset.m2389getXimpl(j2), Offset.m2390getYimpl(j2)));
    }

    /* renamed from: scroll-8S9VItk  reason: not valid java name */
    private final long m555scroll8S9VItk(long j, float f) {
        ...
        if (f != 0.0f) {
            ...
            if (this.windowInsets.isVisible() != (i > 0) || windowInsetsAnimationController != null) {
                if (windowInsetsAnimationController == null) {
                    ...
                    return this.sideCalculator.mo507consumedOffsetsMKHz9U(j);
                }
    ...
    public Object mo556onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        return m554flinghuYlsQE(j, this.sideCalculator.hideMotion(Velocity.m5097getXimpl(j), Velocity.m5098getYimpl(j)), false, continuation);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostFling-RZ2iAVY */
    public Object mo331onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        return m554flinghuYlsQE(j2, this.sideCalculator.showMotion(Velocity.m5097getXimpl(j2), Velocity.m5098getYimpl(j2)), true, continuation);
    }
    ...
    */
    public final java.lang.Object m554flinghuYlsQE(long r26, float r28, boolean r29, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r30) {
        /*
            Method dump skipped, instructions count: 426
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.layout.WindowInsetsNestedScrollConnection.m554flinghuYlsQE(long, float, boolean, kotlin.coroutines.Continuation):java.lang.Object");
    }
