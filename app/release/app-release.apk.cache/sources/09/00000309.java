...
final class HoverableNode extends Modifier.Node implements PointerInputModifierNode {
    ...
    public void mo141onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long j) {
        ...
        if (pass == PointerEventPass.Main) {
            int m3690getType7fucELk = pointerEvent.m3690getType7fucELk();
            if (PointerEventType.m3697equalsimpl0(m3690getType7fucELk, PointerEventType.Companion.m3701getEnter7fucELk())) {
            ...
            } else if (PointerEventType.m3697equalsimpl0(m3690getType7fucELk, PointerEventType.Companion.m3702getExit7fucELk())) {
