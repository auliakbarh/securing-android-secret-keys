...
public final class LayoutModifierNodeCoordinator extends NodeCoordinator {
    ...
    private final class LookaheadDelegateForLayoutModifierNode extends LookaheadDelegate {
        ...
        public Placeable mo3865measureBRTryo0(long j) {
            ...
            LookaheadDelegate.m4030access$setMeasurementConstraintsBRTryo0(lookaheadDelegateForLayoutModifierNode, j);
            layoutModifierNodeCoordinator.lookaheadConstraints = Constraints.m4816boximpl(j);
            LookaheadDelegate lookaheadDelegate = layoutModifierNodeCoordinator.getWrappedNonNull().getLookaheadDelegate();
            Intrinsics.checkNotNull(lookaheadDelegate);
            LookaheadDelegate.access$set_measureResult(lookaheadDelegateForLayoutModifierNode, layoutModifierNodeCoordinator.getLayoutModifierNode().mo236measure3p2s80s(this, lookaheadDelegate, j));
    ...
    /* renamed from: measure-BRTryo0 */
    public Placeable mo3865measureBRTryo0(long j) {
        MeasureResult mo236measure3p2s80s;
        ...
        if (layoutModifierNode instanceof IntermediateLayoutModifierNode) {
            ...
            mo236measure3p2s80s = ((IntermediateLayoutModifierNode) layoutModifierNode).m3867intermediateMeasureTeuZzU(this, wrappedNonNull, j, IntSize, constraints.m4834unboximpl());
        } else {
            mo236measure3p2s80s = layoutModifierNode.mo236measure3p2s80s(this, getWrappedNonNull(), j);
        }
        setMeasureResult$ui_release(mo236measure3p2s80s);
    ...
    public void mo3866placeAtf8xVGno(long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
        ...
        int m5032getWidthimpl = IntSize.m5032getWidthimpl(m3918getMeasuredSizeYbymL2g());
        ...
        Placeable.PlacementScope.parentWidth = m5032getWidthimpl;
    ...
    static {
        ...
        Paint.mo2509setColor8_81llA(Color.Companion.m2655getBlue0d7_KjU());
