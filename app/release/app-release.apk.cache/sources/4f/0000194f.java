...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final void updateInputState(TextFieldValue state, InputMethodManager inputMethodManager) {
        ...
        if (this.isActive) {
            ...
            TextRange m4621getCompositionMzsxiRA = state.m4621getCompositionMzsxiRA();
            int m4401getMinimpl = m4621getCompositionMzsxiRA != null ? TextRange.m4401getMinimpl(m4621getCompositionMzsxiRA.m4407unboximpl()) : -1;
            TextRange m4621getCompositionMzsxiRA2 = state.m4621getCompositionMzsxiRA();
            inputMethodManager.updateSelection(TextRange.m4401getMinimpl(state.m4622getSelectiond9O1mEE()), TextRange.m4400getMaximpl(state.m4622getSelectiond9O1mEE()), m4401getMinimpl, m4621getCompositionMzsxiRA2 != null ? TextRange.m4400getMaximpl(m4621getCompositionMzsxiRA2.m4407unboximpl()) : -1);
        }
    }
    ...
    public CharSequence getSelectedText(int i) {
        if (TextRange.m4397getCollapsedimpl(this.mTextFieldValue.m4622getSelectiond9O1mEE())) {
            return null;
        }
    ...
    public boolean performEditorAction(int i) {
        int m4562getDefaulteUduSuo;
        boolean z = this.isActive;
        if (z) {
            if (i == 0) {
                m4562getDefaulteUduSuo = ImeAction.Companion.m4562getDefaulteUduSuo();
            } else {
                switch (i) {
                    case 2:
                        m4562getDefaulteUduSuo = ImeAction.Companion.m4564getGoeUduSuo();
                        break;
                    case 3:
                        m4562getDefaulteUduSuo = ImeAction.Companion.m4568getSearcheUduSuo();
                        break;
                    case 4:
                        m4562getDefaulteUduSuo = ImeAction.Companion.m4569getSendeUduSuo();
                        break;
                    case 5:
                        m4562getDefaulteUduSuo = ImeAction.Companion.m4565getNexteUduSuo();
                        break;
                    case 6:
                        m4562getDefaulteUduSuo = ImeAction.Companion.m4563getDoneeUduSuo();
                        break;
                    case 7:
                        m4562getDefaulteUduSuo = ImeAction.Companion.m4567getPreviouseUduSuo();
                        break;
                    default:
            ...
            this.eventCallback.mo4576onImeActionKlQnJC8(m4562getDefaulteUduSuo);
            return true;
        }
        return z;
    }
    ...
    public int getCursorCapsMode(int i) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m4401getMinimpl(this.mTextFieldValue.m4622getSelectiond9O1mEE()), i);
    }
}