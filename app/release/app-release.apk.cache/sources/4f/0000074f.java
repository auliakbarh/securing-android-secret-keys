...
final class LazyStaggeredGridSlotCache implements Function2<Density, Constraints, LazyStaggeredGridSlots> {
    ...
    public /* bridge */ /* synthetic */ LazyStaggeredGridSlots invoke(Density density, Constraints constraints) {
        return m670invoke0kLqBqw(density, constraints.m4834unboximpl());
    }

    /* renamed from: invoke-0kLqBqw  reason: not valid java name */
    public LazyStaggeredGridSlots m670invoke0kLqBqw(Density density, long j) {
        Intrinsics.checkNotNullParameter(density, "density");
        if (this.cachedSizes != null && Constraints.m4821equalsimpl0(this.cachedConstraints, j) && this.cachedDensity == density.getDensity()) {
        ...
        LazyStaggeredGridSlots invoke = this.calculation.invoke(density, Constraints.m4816boximpl(j));
