    ...
    */
    ...
    private final void invalidateConsumersOfNodeForKey(Modifier.Node node, ModifierLocal<?> modifierLocal, Set<BackwardsCompatNode> set) {
        ...
        while (mutableVector.isNotEmpty()) {
            ...
            if ((node3.getAggregateChildKindSet$ui_release() & m4080constructorimpl) != 0) {
                for (Modifier.Node node4 = node3; node4 != null; node4 = node4.getChild$ui_release()) {
                    if ((node4.getKindSet$ui_release() & m4080constructorimpl) != 0) {
                        ...
                        while (node5 != null) {
                            ...
                            } else if ((node5.getKindSet$ui_release() & m4080constructorimpl) != 0 && (node5 instanceof DelegatingNode)) {
                                int i = 0;
