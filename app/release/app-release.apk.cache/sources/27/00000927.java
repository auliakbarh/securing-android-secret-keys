...
public final class SelectionManager {
    ...
    public SelectionManager(SelectionRegistrarImpl selectionRegistrar) {
        ...
        mutableStateOf$default3 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m2378boximpl(Offset.Companion.m2405getZeroF1C5BW0()), null, 2, null);
        this.dragBeginPosition$delegate = mutableStateOf$default3;
        mutableStateOf$default4 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m2378boximpl(Offset.Companion.m2405getZeroF1C5BW0()), null, 2, null);
        ...
        selectionRegistrar.setOnSelectionUpdateStartCallback$foundation_release(new Function3<LayoutCoordinates, Offset, SelectionAdjustment, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.2
            ...
            public /* bridge */ /* synthetic */ Unit invoke(LayoutCoordinates layoutCoordinates, Offset offset, SelectionAdjustment selectionAdjustment) {
                m921invoked4ec7I(layoutCoordinates, offset.m2399unboximpl(), selectionAdjustment);
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-d-4ec7I  reason: not valid java name */
            public final void m921invoked4ec7I(LayoutCoordinates layoutCoordinates, long j, SelectionAdjustment selectionMode) {
                Intrinsics.checkNotNullParameter(layoutCoordinates, "layoutCoordinates");
                Intrinsics.checkNotNullParameter(selectionMode, "selectionMode");
                Offset m906convertToContainerCoordinatesQ7Q5hAU = SelectionManager.this.m906convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, j);
                if (m906convertToContainerCoordinatesQ7Q5hAU != null) {
                    SelectionManager.this.m912startSelection9KIMszo(m906convertToContainerCoordinatesQ7Q5hAU.m2399unboximpl(), false, selectionMode);
        ...
        selectionRegistrar.setOnSelectionUpdateCallback$foundation_release(new Function5<LayoutCoordinates, Offset, Offset, Boolean, SelectionAdjustment, Boolean>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.4
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(LayoutCoordinates layoutCoordinates, Offset offset, Offset offset2, Boolean bool, SelectionAdjustment selectionAdjustment) {
                return m922invoke5iVPX68(layoutCoordinates, offset.m2399unboximpl(), offset2.m2399unboximpl(), bool.booleanValue(), selectionAdjustment);
            }

            /* renamed from: invoke-5iVPX68  reason: not valid java name */
            public final Boolean m922invoke5iVPX68(LayoutCoordinates layoutCoordinates, long j, long j2, boolean z, SelectionAdjustment selectionMode) {
                Intrinsics.checkNotNullParameter(layoutCoordinates, "layoutCoordinates");
                Intrinsics.checkNotNullParameter(selectionMode, "selectionMode");
                return Boolean.valueOf(SelectionManager.this.m920updateSelectionRHHTvR4$foundation_release(SelectionManager.this.m906convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, j), SelectionManager.this.m906convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, j2), z, selectionMode));
            }
        });
        selectionRegistrar.setOnSelectionUpdateEndCallback$foundation_release(new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.5
            ...
            public final void invoke2() {
                ...
                SelectionManager.this.m907setCurrentDragPosition_kEHs6E(null);
            }
        });
        ...
        selectionRegistrar.setAfterSelectableUnsubscribe$foundation_release(new Function1<Long, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.7
            ...
            public final void invoke(long j) {
                ...
                SelectionManager.this.m911setStartHandlePosition_kEHs6E(null);
                SelectionManager.this.m910setEndHandlePosition_kEHs6E(null);
            }
        });
    }
    ...
    public final Modifier getModifier() {
        return KeyInputModifierKt.onKeyEvent(FocusableKt.focusable$default(FocusChangedModifierKt.onFocusChanged(FocusRequesterModifierKt.focusRequester(OnGloballyPositionedModifierKt.onGloballyPositioned(onClearSelectionRequested(Modifier.Companion, new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager$modifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m923invokeZmokQxo(keyEvent.m3603unboximpl());
            }

            /* renamed from: invoke-ZmokQxo  reason: not valid java name */
            public final Boolean m923invokeZmokQxo(android.view.KeyEvent it) {
                boolean z;
                Intrinsics.checkNotNullParameter(it, "it");
                if (SelectionManager_androidKt.m927isCopyKeyEventZmokQxo(it)) {
    ...
    public final void setContainerLayoutCoordinates(LayoutCoordinates layoutCoordinates) {
        ...
        Offset m2378boximpl = layoutCoordinates != null ? Offset.m2378boximpl(LayoutCoordinatesKt.positionInWindow(layoutCoordinates)) : null;
        if (Intrinsics.areEqual(this.previousPosition, m2378boximpl)) {
            return;
        }
        this.previousPosition = m2378boximpl;
        updateHandleOffsets();
    ...
    public final void m908setDragBeginPositionk4lQ0M(long j) {
        this.dragBeginPosition$delegate.setValue(Offset.m2378boximpl(j));
    }

    /* renamed from: getDragBeginPosition-F1C5BW0$foundation_release  reason: not valid java name */
    public final long m915getDragBeginPositionF1C5BW0$foundation_release() {
        return ((Offset) this.dragBeginPosition$delegate.getValue()).m2399unboximpl();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: setDragTotalDistance-k-4lQ0M  reason: not valid java name */
    public final void m909setDragTotalDistancek4lQ0M(long j) {
        this.dragTotalDistance$delegate.setValue(Offset.m2378boximpl(j));
    }

    /* renamed from: getDragTotalDistance-F1C5BW0$foundation_release  reason: not valid java name */
    public final long m916getDragTotalDistanceF1C5BW0$foundation_release() {
        return ((Offset) this.dragTotalDistance$delegate.getValue()).m2399unboximpl();
    }

    /* renamed from: getStartHandlePosition-_m7T9-E  reason: not valid java name */
    public final Offset m918getStartHandlePosition_m7T9E() {
        return (Offset) this.startHandlePosition$delegate.getValue();
    }

    /* renamed from: getEndHandlePosition-_m7T9-E  reason: not valid java name */
    public final Offset m917getEndHandlePosition_m7T9E() {
    ...
    public final Offset m914getCurrentDragPosition_m7T9E() {
    ...
    public final void updateHandleOffsets() {
        ...
        if (selection == null || layoutCoordinates == null || !layoutCoordinates.isAttached() || layoutCoordinates2 == null || layoutCoordinates3 == null) {
            m911setStartHandlePosition_kEHs6E(null);
            m910setEndHandlePosition_kEHs6E(null);
            return;
        }
        long mo3873localPositionOfR5De75A = layoutCoordinates.mo3873localPositionOfR5De75A(layoutCoordinates2, anchorSelectable$foundation_release.mo874getHandlePositiondBAh8RU(selection, true));
        long mo3873localPositionOfR5De75A2 = layoutCoordinates.mo3873localPositionOfR5De75A(layoutCoordinates3, anchorSelectable$foundation_release2.mo874getHandlePositiondBAh8RU(selection, false));
        Rect visibleBounds = SelectionManagerKt.visibleBounds(layoutCoordinates);
        Offset m2378boximpl = Offset.m2378boximpl(mo3873localPositionOfR5De75A);
        m2378boximpl.m2399unboximpl();
        if (!SelectionManagerKt.m926containsInclusiveUv8p0NA(visibleBounds, mo3873localPositionOfR5De75A) && getDraggingHandle() != Handle.SelectionStart) {
            m2378boximpl = null;
        }
        m911setStartHandlePosition_kEHs6E(m2378boximpl);
        Offset m2378boximpl2 = Offset.m2378boximpl(mo3873localPositionOfR5De75A2);
        m2378boximpl2.m2399unboximpl();
        if (SelectionManagerKt.m926containsInclusiveUv8p0NA(visibleBounds, mo3873localPositionOfR5De75A2) || getDraggingHandle() == Handle.SelectionEnd) {
            offset = m2378boximpl2;
        }
        m910setEndHandlePosition_kEHs6E(offset);
    }
    ...
    private final Rect getContentRect() {
        ...
        if (layoutCoordinates3 != null && layoutCoordinates3.isAttached()) {
            long mo3873localPositionOfR5De75A = layoutCoordinates3.mo3873localPositionOfR5De75A(layoutCoordinates, anchorSelectable$foundation_release.mo874getHandlePositiondBAh8RU(selection, true));
            long mo3873localPositionOfR5De75A2 = layoutCoordinates3.mo3873localPositionOfR5De75A(layoutCoordinates2, anchorSelectable$foundation_release2.mo874getHandlePositiondBAh8RU(selection, false));
            long mo3874localToRootMKHz9U = layoutCoordinates3.mo3874localToRootMKHz9U(mo3873localPositionOfR5De75A);
            long mo3874localToRootMKHz9U2 = layoutCoordinates3.mo3874localToRootMKHz9U(mo3873localPositionOfR5De75A2);
            return new Rect(Math.min(Offset.m2389getXimpl(mo3874localToRootMKHz9U), Offset.m2389getXimpl(mo3874localToRootMKHz9U2)), Math.min(Offset.m2390getYimpl(layoutCoordinates3.mo3874localToRootMKHz9U(layoutCoordinates3.mo3873localPositionOfR5De75A(layoutCoordinates, OffsetKt.Offset(0.0f, anchorSelectable$foundation_release.getBoundingBox(selection.getStart().getOffset()).getTop())))), Offset.m2390getYimpl(layoutCoordinates3.mo3874localToRootMKHz9U(layoutCoordinates3.mo3873localPositionOfR5De75A(layoutCoordinates2, OffsetKt.Offset(0.0f, anchorSelectable$foundation_release2.getBoundingBox(selection.getEnd().getOffset()).getTop()))))), Math.max(Offset.m2389getXimpl(mo3874localToRootMKHz9U), Offset.m2389getXimpl(mo3874localToRootMKHz9U2)), Math.max(Offset.m2390getYimpl(mo3874localToRootMKHz9U), Offset.m2390getYimpl(mo3874localToRootMKHz9U2)) + ((float) (SelectionHandlesKt.getHandleHeight() * 4.0d)));
        }
        return Rect.Companion.getZero();
    }
    ...
    public final TextDragObserver handleDragObserver(final boolean z) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.SelectionManager$handleDragObserver$1
            ...
            public void mo800onDownk4lQ0M(long j) {
                ...
                long m893getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m893getAdjustedCoordinatesk4lQ0M(anchorSelectable$foundation_release.mo874getHandlePositiondBAh8RU(selection, z));
                SelectionManager selectionManager = SelectionManager.this;
                selectionManager.m907setCurrentDragPosition_kEHs6E(Offset.m2378boximpl(selectionManager.requireContainerCoordinates$foundation_release().mo3873localPositionOfR5De75A(layoutCoordinates, m893getAdjustedCoordinatesk4lQ0M)));
            ...
            public void mo802onStartk4lQ0M(long j) {
                LayoutCoordinates layoutCoordinates;
                long mo874getHandlePositiondBAh8RU;
                SelectionManager.this.hideSelectionToolbar$foundation_release();
                Selection selection = SelectionManager.this.getSelection();
                ...
                if (z) {
                    ...
                    mo874getHandlePositiondBAh8RU = selectable.mo874getHandlePositiondBAh8RU(selection, true);
                } else {
                    Intrinsics.checkNotNull(selectable2);
                    mo874getHandlePositiondBAh8RU = selectable2.mo874getHandlePositiondBAh8RU(selection, false);
                }
                long m893getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m893getAdjustedCoordinatesk4lQ0M(mo874getHandlePositiondBAh8RU);
                SelectionManager selectionManager = SelectionManager.this;
                selectionManager.m908setDragBeginPositionk4lQ0M(selectionManager.requireContainerCoordinates$foundation_release().mo3873localPositionOfR5De75A(layoutCoordinates, m893getAdjustedCoordinatesk4lQ0M));
                SelectionManager.this.m909setDragTotalDistancek4lQ0M(Offset.Companion.m2405getZeroF1C5BW0());
            }
            ...
            public void mo801onDragk4lQ0M(long j) {
                SelectionManager selectionManager = SelectionManager.this;
                selectionManager.m909setDragTotalDistancek4lQ0M(Offset.m2394plusMKHz9U(selectionManager.m916getDragTotalDistanceF1C5BW0$foundation_release(), j));
                long m2394plusMKHz9U = Offset.m2394plusMKHz9U(SelectionManager.this.m915getDragBeginPositionF1C5BW0$foundation_release(), SelectionManager.this.m916getDragTotalDistanceF1C5BW0$foundation_release());
                if (SelectionManager.this.m920updateSelectionRHHTvR4$foundation_release(Offset.m2378boximpl(m2394plusMKHz9U), Offset.m2378boximpl(SelectionManager.this.m915getDragBeginPositionF1C5BW0$foundation_release()), z, SelectionAdjustment.Companion.getCharacterWithWordAccelerate())) {
                    SelectionManager.this.m908setDragBeginPositionk4lQ0M(m2394plusMKHz9U);
                    SelectionManager.this.m909setDragTotalDistancek4lQ0M(Offset.Companion.m2405getZeroF1C5BW0());
                }
            }
    ...
    public final Offset m906convertToContainerCoordinatesQ7Q5hAU(LayoutCoordinates layoutCoordinates, long j) {
        LayoutCoordinates layoutCoordinates2 = this.containerLayoutCoordinates;
        if (layoutCoordinates2 == null || !layoutCoordinates2.isAttached()) {
            return null;
        }
        return Offset.m2378boximpl(requireContainerCoordinates$foundation_release().mo3873localPositionOfR5De75A(layoutCoordinates, j));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: startSelection-9KIMszo  reason: not valid java name */
    public final void m912startSelection9KIMszo(long j, boolean z, SelectionAdjustment selectionAdjustment) {
        m919updateSelection3R_tFg$foundation_release(j, j, null, z, selectionAdjustment);
    }

    /* renamed from: updateSelection-RHHTvR4$foundation_release  reason: not valid java name */
    public final boolean m920updateSelectionRHHTvR4$foundation_release(Offset offset, Offset offset2, boolean z, SelectionAdjustment adjustment) {
        Selection selection;
        long selectableId;
        Offset m906convertToContainerCoordinatesQ7Q5hAU;
        ...
        if (selectable == null) {
            m906convertToContainerCoordinatesQ7Q5hAU = null;
        } else {
            LayoutCoordinates layoutCoordinates = selectable.getLayoutCoordinates();
            Intrinsics.checkNotNull(layoutCoordinates);
            m906convertToContainerCoordinatesQ7Q5hAU = m906convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, SelectionHandlesKt.m893getAdjustedCoordinatesk4lQ0M(selectable.mo874getHandlePositiondBAh8RU(selection, !z)));
        }
        if (m906convertToContainerCoordinatesQ7Q5hAU != null) {
            long m2399unboximpl = m906convertToContainerCoordinatesQ7Q5hAU.m2399unboximpl();
            long m2399unboximpl2 = z ? offset.m2399unboximpl() : m2399unboximpl;
            if (!z) {
                m2399unboximpl = offset.m2399unboximpl();
            }
            return m919updateSelection3R_tFg$foundation_release(m2399unboximpl2, m2399unboximpl, offset2, z, adjustment);
        }
        return false;
    }

    /* renamed from: updateSelection-3R_-tFg$foundation_release  reason: not valid java name */
    public final boolean m919updateSelection3R_tFg$foundation_release(long j, long j2, Offset offset, boolean z, SelectionAdjustment adjustment) {
        Intrinsics.checkNotNullParameter(adjustment, "adjustment");
        setDraggingHandle(z ? Handle.SelectionStart : Handle.SelectionEnd);
        m907setCurrentDragPosition_kEHs6E(z ? Offset.m2378boximpl(j) : Offset.m2378boximpl(j2));
        LinkedHashMap linkedHashMap = new LinkedHashMap();
        List<Selectable> sort = this.selectionRegistrar.sort(requireContainerCoordinates$foundation_release());
        int size = sort.size();
        ...
        while (i < size) {
            ...
            Pair<Selection, Boolean> mo876updateSelectionqCDeeow = selectable.mo876updateSelectionqCDeeow(j, j2, offset, z, requireContainerCoordinates$foundation_release(), adjustment, this.selectionRegistrar.getSubselections().get(Long.valueOf(selectable.getSelectableId())));
            Selection component1 = mo876updateSelectionqCDeeow.component1();
            z2 = z2 || mo876updateSelectionqCDeeow.component2().booleanValue();
            if (component1 != null) {
    ...
    public final void m913contextMenuOpenAdjustmentk4lQ0M(long j) {
        Selection selection = getSelection();
        if (selection == null || TextRange.m4397getCollapsedimpl(selection.m883toTextRanged9O1mEE())) {
            m912startSelection9KIMszo(j, true, SelectionAdjustment.Companion.getWord());
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: setStartHandlePosition-_kEHs6E  reason: not valid java name */
    public final void m911setStartHandlePosition_kEHs6E(Offset offset) {
        this.startHandlePosition$delegate.setValue(offset);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: setEndHandlePosition-_kEHs6E  reason: not valid java name */
    public final void m910setEndHandlePosition_kEHs6E(Offset offset) {
    ...
    public final void m907setCurrentDragPosition_kEHs6E(Offset offset) {
