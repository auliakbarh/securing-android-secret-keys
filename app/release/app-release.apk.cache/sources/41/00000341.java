...
public final class OverscrollConfiguration {
    ...
    public final long m239getGlowColor0d7_KjU() {
    ...
    public /* synthetic */ OverscrollConfiguration(long j, PaddingValues paddingValues, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? ColorKt.Color(4284900966L) : j, (i & 2) != 0 ? PaddingKt.m474PaddingValuesYgX7TsA$default(0.0f, 0.0f, 3, null) : paddingValues, null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(getClass(), obj != null ? obj.getClass() : null)) {
            ...
            return Color.m2629equalsimpl0(this.glowColor, overscrollConfiguration.glowColor) && Intrinsics.areEqual(this.drawPadding, overscrollConfiguration.drawPadding);
        }
        return false;
    }

    public int hashCode() {
        return (Color.m2635hashCodeimpl(this.glowColor) * 31) + this.drawPadding.hashCode();
    }

    public String toString() {
        return "OverscrollConfiguration(glowColor=" + ((Object) Color.m2636toStringimpl(this.glowColor)) + ", drawPadding=" + this.drawPadding + ')';
    }
}