...
public final class TextStyle {
    ...
    public /* synthetic */ TextStyle(long j, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow, TextAlign textAlign, TextDirection textDirection, long j5, TextIndent textIndent, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Color.Companion.m2664getUnspecified0d7_KjU() : j, (i & 2) != 0 ? TextUnit.Companion.m5064getUnspecifiedXSAIIZE() : j2, (i & 4) != 0 ? null : fontWeight, (i & 8) != 0 ? null : fontStyle, (i & 16) != 0 ? null : fontSynthesis, (i & 32) != 0 ? null : fontFamily, (i & 64) != 0 ? null : str, (i & 128) != 0 ? TextUnit.Companion.m5064getUnspecifiedXSAIIZE() : j3, (i & 256) != 0 ? null : baselineShift, (i & 512) != 0 ? null : textGeometricTransform, (i & 1024) != 0 ? null : localeList, (i & 2048) != 0 ? Color.Companion.m2664getUnspecified0d7_KjU() : j4, (i & 4096) != 0 ? null : textDecoration, (i & 8192) != 0 ? null : shadow, (i & 16384) != 0 ? null : textAlign, (i & 32768) != 0 ? null : textDirection, (i & 65536) != 0 ? TextUnit.Companion.m5064getUnspecifiedXSAIIZE() : j5, (i & 131072) != 0 ? null : textIndent, null);
    }
    ...
    public final TextStyle m4434mergeZ1GrekI(long j, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow, DrawStyle drawStyle, TextAlign textAlign, TextDirection textDirection, long j5, TextIndent textIndent, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, PlatformTextStyle platformTextStyle, TextMotion textMotion) {
        SpanStyle m4367fastMergedSHsh3o = SpanStyleKt.m4367fastMergedSHsh3o(this.spanStyle, j, null, Float.NaN, j2, fontWeight, fontStyle, fontSynthesis, fontFamily, str, j3, baselineShift, textGeometricTransform, localeList, j4, textDecoration, shadow, platformTextStyle != null ? platformTextStyle.getSpanStyle() : null, drawStyle);
        ParagraphStyle m4321fastMergeHtYhynw = ParagraphStyleKt.m4321fastMergeHtYhynw(this.paragraphStyle, textAlign, textDirection, j5, textIndent, platformTextStyle != null ? platformTextStyle.getParagraphStyle() : null, lineHeightStyle, lineBreak, hyphens, textMotion);
        return (this.spanStyle == m4367fastMergedSHsh3o && this.paragraphStyle == m4321fastMergeHtYhynw) ? this : new TextStyle(m4367fastMergedSHsh3o, m4321fastMergeHtYhynw);
    }
    ...
    public final /* synthetic */ TextStyle m4418copyHL5avdY(long j, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow, TextAlign textAlign, TextDirection textDirection, long j5, TextIndent textIndent) {
        TextForegroundStyle m4785from8_81llA;
        if (Color.m2629equalsimpl0(j, this.spanStyle.m4362getColor0d7_KjU())) {
            m4785from8_81llA = this.spanStyle.getTextForegroundStyle$ui_text_release();
        } else {
            m4785from8_81llA = TextForegroundStyle.Companion.m4785from8_81llA(j);
        }
        return new TextStyle(new SpanStyle(m4785from8_81llA, j2, fontWeight, fontStyle, fontSynthesis, fontFamily, str, j3, baselineShift, textGeometricTransform, localeList, j4, textDecoration, shadow, this.spanStyle.getPlatformStyle(), this.spanStyle.getDrawStyle(), (DefaultConstructorMarker) null), new ParagraphStyle(textAlign, textDirection, j5, textIndent, this.paragraphStyle.getPlatformStyle(), getLineHeightStyle(), m4430getLineBreakLgCVezo(), m4428getHyphensEaSxIns(), getTextMotion(), (DefaultConstructorMarker) null), this.platformStyle);
    }

    @Deprecated(level = DeprecationLevel.HIDDEN, message = "TextStyle copy constructors that do not take new stable parameters like LineHeightStyle, LineBreak, Hyphens are deprecated. Please use the new stable copy constructor.")
    /* renamed from: copy-NOaFTUo  reason: not valid java name */
    public final /* synthetic */ TextStyle m4419copyNOaFTUo(long j, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow, TextAlign textAlign, TextDirection textDirection, long j5, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle) {
        TextForegroundStyle m4785from8_81llA;
        if (Color.m2629equalsimpl0(j, this.spanStyle.m4362getColor0d7_KjU())) {
            m4785from8_81llA = this.spanStyle.getTextForegroundStyle$ui_text_release();
        } else {
        ...
        return new TextStyle(new SpanStyle(m4785from8_81llA, j2, fontWeight, fontStyle, fontSynthesis, fontFamily, str, j3, baselineShift, textGeometricTransform, localeList, j4, textDecoration, shadow, platformTextStyle != null ? platformTextStyle.getSpanStyle() : null, this.spanStyle.getDrawStyle(), (DefaultConstructorMarker) null), new ParagraphStyle(textAlign, textDirection, j5, textIndent, platformTextStyle != null ? platformTextStyle.getParagraphStyle() : null, lineHeightStyle, m4430getLineBreakLgCVezo(), m4428getHyphensEaSxIns(), getTextMotion(), (DefaultConstructorMarker) null), platformTextStyle);
    }
    ...
    public final /* synthetic */ TextStyle m4417copyCXVQc50(long j, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow, TextAlign textAlign, TextDirection textDirection, long j5, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens) {
        TextForegroundStyle m4785from8_81llA;
        if (Color.m2629equalsimpl0(j, this.spanStyle.m4362getColor0d7_KjU())) {
            m4785from8_81llA = this.spanStyle.getTextForegroundStyle$ui_text_release();
        } else {
        ...
        return new TextStyle(new SpanStyle(m4785from8_81llA, j2, fontWeight, fontStyle, fontSynthesis, fontFamily, str, j3, baselineShift, textGeometricTransform, localeList, j4, textDecoration, shadow, platformTextStyle != null ? platformTextStyle.getSpanStyle() : null, getDrawStyle(), (DefaultConstructorMarker) null), new ParagraphStyle(textAlign, textDirection, j5, textIndent, platformTextStyle != null ? platformTextStyle.getParagraphStyle() : null, lineHeightStyle, lineBreak, hyphens, getTextMotion(), (DefaultConstructorMarker) null), platformTextStyle);
    }

    /* renamed from: copy-v2rsoow  reason: not valid java name */
    public final TextStyle m4421copyv2rsoow(long j, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow, DrawStyle drawStyle, TextAlign textAlign, TextDirection textDirection, long j5, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, TextMotion textMotion) {
        TextForegroundStyle m4785from8_81llA;
        if (Color.m2629equalsimpl0(j, this.spanStyle.m4362getColor0d7_KjU())) {
            m4785from8_81llA = this.spanStyle.getTextForegroundStyle$ui_text_release();
        } else {
        ...
        return new TextStyle(new SpanStyle(m4785from8_81llA, j2, fontWeight, fontStyle, fontSynthesis, fontFamily, str, j3, baselineShift, textGeometricTransform, localeList, j4, textDecoration, shadow, platformTextStyle != null ? platformTextStyle.getSpanStyle() : null, drawStyle, (DefaultConstructorMarker) null), new ParagraphStyle(textAlign, textDirection, j5, textIndent, platformTextStyle != null ? platformTextStyle.getParagraphStyle() : null, lineHeightStyle, lineBreak, hyphens, textMotion, (DefaultConstructorMarker) null), platformTextStyle);
    }

    /* renamed from: copy-aIRg9q4$default  reason: not valid java name */
    public static /* synthetic */ TextStyle m4414copyaIRg9q4$default(TextStyle textStyle, Brush brush, float f, long j, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j2, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j3, TextDecoration textDecoration, Shadow shadow, DrawStyle drawStyle, TextAlign textAlign, TextDirection textDirection, long j4, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, TextMotion textMotion, int i, Object obj) {
        Shadow shadow2;
        ...
        long m4363getFontSizeXSAIIZE = (i & 4) != 0 ? textStyle.spanStyle.m4363getFontSizeXSAIIZE() : j;
        FontWeight fontWeight2 = (i & 8) != 0 ? textStyle.spanStyle.getFontWeight() : fontWeight;
        FontStyle m4364getFontStyle4Lr2A7w = (i & 16) != 0 ? textStyle.spanStyle.m4364getFontStyle4Lr2A7w() : fontStyle;
        FontSynthesis m4365getFontSynthesisZQGJjVo = (i & 32) != 0 ? textStyle.spanStyle.m4365getFontSynthesisZQGJjVo() : fontSynthesis;
        ...
        long m4366getLetterSpacingXSAIIZE = (i & 256) != 0 ? textStyle.spanStyle.m4366getLetterSpacingXSAIIZE() : j2;
        BaselineShift m4361getBaselineShift5SSeXJ0 = (i & 512) != 0 ? textStyle.spanStyle.m4361getBaselineShift5SSeXJ0() : baselineShift;
        ...
        long m4360getBackground0d7_KjU = (i & 4096) != 0 ? textStyle.spanStyle.m4360getBackground0d7_KjU() : j3;
        ...
        if ((i & 65536) != 0) {
            ...
            textAlign2 = textStyle.paragraphStyle.m4318getTextAlignbuA522U();
        } else {
            drawStyle3 = drawStyle2;
        ...
        if ((i & 131072) != 0) {
            ...
            textDirection2 = textStyle.paragraphStyle.m4320getTextDirectionmmuk1to();
        } else {
            textAlign3 = textAlign2;
        ...
        if ((i & 262144) != 0) {
            ...
            j5 = textStyle.paragraphStyle.m4317getLineHeightXSAIIZE();
        } else {
            textDirection3 = textDirection2;
            j5 = j4;
        }
        ...
        if ((i & 4194304) != 0) {
            ...
            lineBreak2 = textStyle.paragraphStyle.m4315getLineBreakLgCVezo();
        } else {
            lineHeightStyle3 = lineHeightStyle2;
        ...
        if ((i & 8388608) != 0) {
            ...
            hyphens2 = textStyle.paragraphStyle.m4313getHyphensEaSxIns();
        } else {
            lineBreak3 = lineBreak2;
            hyphens2 = hyphens;
        }
        return textStyle.m4420copyaIRg9q4(brush, alpha, m4363getFontSizeXSAIIZE, fontWeight2, m4364getFontStyle4Lr2A7w, m4365getFontSynthesisZQGJjVo, fontFamily2, fontFeatureSettings, m4366getLetterSpacingXSAIIZE, m4361getBaselineShift5SSeXJ0, textGeometricTransform2, localeList2, m4360getBackground0d7_KjU, textDecoration2, shadow2, drawStyle3, textAlign3, textDirection3, j5, textIndent2, platformTextStyle3, lineHeightStyle3, lineBreak3, hyphens2, (i & 16777216) != 0 ? textStyle.paragraphStyle.getTextMotion() : textMotion);
    }

    /* renamed from: copy-aIRg9q4  reason: not valid java name */
    public final TextStyle m4420copyaIRg9q4(Brush brush, float f, long j, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j2, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j3, TextDecoration textDecoration, Shadow shadow, DrawStyle drawStyle, TextAlign textAlign, TextDirection textDirection, long j4, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, TextMotion textMotion) {
    ...
    public final long m4424getColor0d7_KjU() {
        return this.spanStyle.m4362getColor0d7_KjU();
    }
    ...
    public final long m4425getFontSizeXSAIIZE() {
        return this.spanStyle.m4363getFontSizeXSAIIZE();
    }
    ...
    public final FontStyle m4426getFontStyle4Lr2A7w() {
        return this.spanStyle.m4364getFontStyle4Lr2A7w();
    }

    /* renamed from: getFontSynthesis-ZQGJjVo  reason: not valid java name */
    public final FontSynthesis m4427getFontSynthesisZQGJjVo() {
        return this.spanStyle.m4365getFontSynthesisZQGJjVo();
    }
    ...
    public final long m4429getLetterSpacingXSAIIZE() {
        return this.spanStyle.m4366getLetterSpacingXSAIIZE();
    }

    /* renamed from: getBaselineShift-5SSeXJ0  reason: not valid java name */
    public final BaselineShift m4423getBaselineShift5SSeXJ0() {
        return this.spanStyle.m4361getBaselineShift5SSeXJ0();
    }
    ...
    public final long m4422getBackground0d7_KjU() {
        return this.spanStyle.m4360getBackground0d7_KjU();
    }
    ...
    public final TextAlign m4432getTextAlignbuA522U() {
        return this.paragraphStyle.m4318getTextAlignbuA522U();
    }

    /* renamed from: getTextDirection-mmuk1to  reason: not valid java name */
    public final TextDirection m4433getTextDirectionmmuk1to() {
        return this.paragraphStyle.m4320getTextDirectionmmuk1to();
    }

    /* renamed from: getLineHeight-XSAIIZE  reason: not valid java name */
    public final long m4431getLineHeightXSAIIZE() {
        return this.paragraphStyle.m4317getLineHeightXSAIIZE();
    }
    ...
    public final Hyphens m4428getHyphensEaSxIns() {
        return this.paragraphStyle.m4313getHyphensEaSxIns();
    }

    /* renamed from: getLineBreak-LgCVezo  reason: not valid java name */
    public final LineBreak m4430getLineBreakLgCVezo() {
        return this.paragraphStyle.m4315getLineBreakLgCVezo();
    }
    ...
    public String toString() {
        ...
        sb.append((Object) Color.m2636toStringimpl(m4424getColor0d7_KjU())).append(", brush=").append(getBrush()).append(", alpha=").append(getAlpha()).append(", fontSize=").append((Object) TextUnit.m5060toStringimpl(m4425getFontSizeXSAIIZE())).append(", fontWeight=").append(getFontWeight()).append(", fontStyle=").append(m4426getFontStyle4Lr2A7w()).append(", fontSynthesis=").append(m4427getFontSynthesisZQGJjVo()).append(", fontFamily=").append(getFontFamily()).append(", fontFeatureSettings=").append(getFontFeatureSettings()).append(", letterSpacing=").append((Object) TextUnit.m5060toStringimpl(m4429getLetterSpacingXSAIIZE())).append(", baselineShift=").append(m4423getBaselineShift5SSeXJ0()).append(", textGeometricTransform=");
        sb.append(getTextGeometricTransform()).append(", localeList=").append(getLocaleList()).append(", background=").append((Object) Color.m2636toStringimpl(m4422getBackground0d7_KjU())).append(", textDecoration=").append(getTextDecoration()).append(", shadow=").append(getShadow()).append(", drawStyle=").append(getDrawStyle()).append(", textAlign=").append(m4432getTextAlignbuA522U()).append(", textDirection=").append(m4433getTextDirectionmmuk1to()).append(", lineHeight=").append((Object) TextUnit.m5060toStringimpl(m4431getLineHeightXSAIIZE())).append(", textIndent=").append(getTextIndent()).append(", platformStyle=").append(this.platformStyle).append(", lineHeightStyle=").append(getLineHeightStyle());
        sb.append(", lineBreak=").append(m4430getLineBreakLgCVezo()).append(", hyphens=").append(m4428getHyphensEaSxIns()).append(", textMotion=").append(getTextMotion()).append(')');
        return sb.toString();
    }
