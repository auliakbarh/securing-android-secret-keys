...
interface SideCalculator {
    ...
    long mo507consumedOffsetsMKHz9U(long j);

    /* renamed from: consumedVelocity-QWom1Mo  reason: not valid java name */
    long mo508consumedVelocityQWom1Mo(long j, float f);
    ...
    public static final class Companion {
        ...
        private static final SideCalculator$Companion$LeftSideCalculator$1 LeftSideCalculator = new SideCalculator() { // from class: androidx.compose.foundation.layout.SideCalculator$Companion$LeftSideCalculator$1
            ...
            public long mo507consumedOffsetsMKHz9U(long j) {
                return androidx.compose.ui.geometry.OffsetKt.Offset(Offset.m2389getXimpl(j), 0.0f);
            }

            @Override // androidx.compose.foundation.layout.SideCalculator
            /* renamed from: consumedVelocity-QWom1Mo */
            public long mo508consumedVelocityQWom1Mo(long j, float f) {
                return VelocityKt.Velocity(Velocity.m5097getXimpl(j) - f, 0.0f);
            }
        };
        private static final SideCalculator$Companion$TopSideCalculator$1 TopSideCalculator = new SideCalculator() { // from class: androidx.compose.foundation.layout.SideCalculator$Companion$TopSideCalculator$1
            ...
            /* renamed from: consumedOffsets-MK-Hz9U */
            public long mo507consumedOffsetsMKHz9U(long j) {
                return androidx.compose.ui.geometry.OffsetKt.Offset(0.0f, Offset.m2390getYimpl(j));
            }

            @Override // androidx.compose.foundation.layout.SideCalculator
            /* renamed from: consumedVelocity-QWom1Mo */
            public long mo508consumedVelocityQWom1Mo(long j, float f) {
                return VelocityKt.Velocity(0.0f, Velocity.m5098getYimpl(j) - f);
            }
        };
        ...
        public final SideCalculator m509chooseCalculatorni1skBw(int i, LayoutDirection layoutDirection) {
            Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
            if (WindowInsetsSides.m560equalsimpl0(i, WindowInsetsSides.Companion.m574getLeftJoeWqyM())) {
                return LeftSideCalculator;
            }
            if (WindowInsetsSides.m560equalsimpl0(i, WindowInsetsSides.Companion.m577getTopJoeWqyM())) {
                return TopSideCalculator;
            }
            if (WindowInsetsSides.m560equalsimpl0(i, WindowInsetsSides.Companion.m575getRightJoeWqyM())) {
                return RightSideCalculator;
            }
            if (WindowInsetsSides.m560equalsimpl0(i, WindowInsetsSides.Companion.m571getBottomJoeWqyM())) {
                return BottomSideCalculator;
            }
            if (WindowInsetsSides.m560equalsimpl0(i, WindowInsetsSides.Companion.m576getStartJoeWqyM())) {
                if (layoutDirection == LayoutDirection.Ltr) {
                    return LeftSideCalculator;
                }
                return RightSideCalculator;
            } else if (WindowInsetsSides.m560equalsimpl0(i, WindowInsetsSides.Companion.m572getEndJoeWqyM())) {
                if (layoutDirection == LayoutDirection.Ltr) {
                    return RightSideCalculator;
                }
                return LeftSideCalculator;
