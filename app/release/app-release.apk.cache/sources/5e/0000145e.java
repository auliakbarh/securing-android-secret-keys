...
public final class VectorPainter extends Painter {
    ...
    public VectorPainter() {
        ...
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m2446boximpl(Size.Companion.m2467getZeroNHjbRc()), null, 2, null);
    ...
    public static final /* synthetic */ void access$setDirty(VectorPainter vectorPainter, boolean z) {
        vectorPainter.setDirty(z);
    }

    /* renamed from: getSize-NH-jbRc$ui_release */
    public final long m3266getSizeNHjbRc$ui_release() {
        return ((Size) this.size$delegate.getValue()).m2463unboximpl();
    }

    /* renamed from: setSize-uvyYCjk$ui_release */
    public final void m3267setSizeuvyYCjk$ui_release(long j) {
        this.size$delegate.setValue(Size.m2446boximpl(j));
    }
    ...
    private final Composition composeVector(CompositionContext compositionContext, final Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> function4) {
        ...
        composition.setContent(ComposableLambdaKt.composableLambdaInstance(-1916507005, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorPainter$composeVector$1
            ...
            public final void invoke(Composer composer, int i) {
                ...
                function4.invoke(Float.valueOf(VectorPainter.access$getVector$p(this).getViewportWidth()), Float.valueOf(VectorPainter.access$getVector$p(this).getViewportHeight()), composer, 0);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public long mo3240getIntrinsicSizeNHjbRc() {
        return m3266getSizeNHjbRc$ui_release();
    }
