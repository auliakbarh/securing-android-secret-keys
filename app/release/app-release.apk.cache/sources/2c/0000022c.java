...
public final class Motion {
    ...
    public static final /* synthetic */ Motion m94boximpl(long j) {
        return new Motion(j);
    }
    ...
    public static boolean m98equalsimpl(long j, Object obj) {
        return (obj instanceof Motion) && j == ((Motion) obj).m104unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m99equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public boolean equals(Object obj) {
        return m98equalsimpl(this.packedValue, obj);
    }
    ...
    public int hashCode() {
        return m102hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m103toStringimpl(this.packedValue);
    }
    ...
    public static final long m96copyXB9eQnU(long j, float f, float f2) {
        return SpringSimulationKt.Motion(f, f2);
    }

    /* renamed from: copy-XB9eQnU$default  reason: not valid java name */
    public static /* synthetic */ long m97copyXB9eQnU$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m100getValueimpl(j);
        }
        if ((i & 2) != 0) {
            f2 = m101getVelocityimpl(j);
        }
        return m96copyXB9eQnU(j, f, f2);
    }

    /* renamed from: getValue-impl  reason: not valid java name */
    public static final float m100getValueimpl(long j) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* renamed from: getVelocity-impl  reason: not valid java name */
    public static final float m101getVelocityimpl(long j) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
