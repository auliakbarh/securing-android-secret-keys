...
final class MarqueeModifierElement extends ModifierNodeElement<MarqueeModifierNode> {
    ...
    private final int m231component2ZbEOnfQ() {
    ...
    private final float m232component6D9Ej5fM() {
        return this.velocity;
    }

    /* renamed from: copy-lWfNwf4$default  reason: not valid java name */
    public static /* synthetic */ MarqueeModifierElement m233copylWfNwf4$default(MarqueeModifierElement marqueeModifierElement, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f, int i5, Object obj) {
        if ((i5 & 1) != 0) {
        ...
        return marqueeModifierElement.m234copylWfNwf4(i, i6, i7, i8, marqueeSpacing2, f);
    }

    /* renamed from: copy-lWfNwf4  reason: not valid java name */
    public final MarqueeModifierElement m234copylWfNwf4(int i, int i2, int i3, int i4, MarqueeSpacing spacing, float f) {
        Intrinsics.checkNotNullParameter(spacing, "spacing");
        return new MarqueeModifierElement(i, i2, i3, i4, spacing, f, null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MarqueeModifierElement) {
            ...
            return this.iterations == marqueeModifierElement.iterations && MarqueeAnimationMode.m223equalsimpl0(this.animationMode, marqueeModifierElement.animationMode) && this.delayMillis == marqueeModifierElement.delayMillis && this.initialDelayMillis == marqueeModifierElement.initialDelayMillis && Intrinsics.areEqual(this.spacing, marqueeModifierElement.spacing) && Dp.m4877equalsimpl0(this.velocity, marqueeModifierElement.velocity);
        }
        return false;
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((((Integer.hashCode(this.iterations) * 31) + MarqueeAnimationMode.m224hashCodeimpl(this.animationMode)) * 31) + Integer.hashCode(this.delayMillis)) * 31) + Integer.hashCode(this.initialDelayMillis)) * 31) + this.spacing.hashCode()) * 31) + Dp.m4878hashCodeimpl(this.velocity);
    }

    public String toString() {
        return "MarqueeModifierElement(iterations=" + this.iterations + ", animationMode=" + ((Object) MarqueeAnimationMode.m225toStringimpl(this.animationMode)) + ", delayMillis=" + this.delayMillis + ", initialDelayMillis=" + this.initialDelayMillis + ", spacing=" + this.spacing + ", velocity=" + ((Object) Dp.m4883toStringimpl(this.velocity)) + ')';
    }
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("animationMode", MarqueeAnimationMode.m220boximpl(this.animationMode));
        ...
        inspectorInfo.getProperties().set("velocity", Dp.m4870boximpl(this.velocity));
    }
    ...
    public void update(MarqueeModifierNode node) {
        ...
        node.m238updatelWfNwf4(this.iterations, this.animationMode, this.delayMillis, this.initialDelayMillis, this.spacing, this.velocity);
    }
}