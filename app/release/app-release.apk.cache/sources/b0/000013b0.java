...
public final class SimpleGraphicsLayerModifier extends Modifier.Node implements LayoutModifierNode {
    ...
    public final long m2948getAmbientShadowColor0d7_KjU() {
    ...
    public final int m2949getCompositingStrategyNrFUSI() {
    ...
    public final long m2950getSpotShadowColor0d7_KjU() {
        return this.spotShadowColor;
    }

    /* renamed from: getTransformOrigin-SzJe1aQ */
    public final long m2951getTransformOriginSzJe1aQ() {
    ...
    public final void m2952setAmbientShadowColor8_81llA(long j) {
    ...
    public final void m2953setCompositingStrategyaDBOjCE(int i) {
    ...
    public final void m2954setSpotShadowColor8_81llA(long j) {
        this.spotShadowColor = j;
    }

    /* renamed from: setTransformOrigin-__ExYCQ */
    public final void m2955setTransformOrigin__ExYCQ(long j) {
    ...
    public static final /* synthetic */ Function1 access$getLayerBlock$p(SimpleGraphicsLayerModifier simpleGraphicsLayerModifier) {
        return simpleGraphicsLayerModifier.layerBlock;
    }
    ...
    public /* synthetic */ SimpleGraphicsLayerModifier(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape, boolean z, RenderEffect renderEffect, long j2, long j3, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(f, f2, f3, f4, f5, f6, f7, f8, f9, f10, j, shape, z, renderEffect, j2, j3, (i2 & 65536) != 0 ? CompositingStrategy.Companion.m2713getAutoNrFUSI() : i, null);
    }
    ...
    private SimpleGraphicsLayerModifier(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape, boolean z, RenderEffect renderEffect, long j2, long j3, int i) {
        ...
        this.layerBlock = new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.ui.graphics.SimpleGraphicsLayerModifier$layerBlock$1
            ...
            public final void invoke2(GraphicsLayerScope graphicsLayerScope) {
                ...
                graphicsLayerScope.mo2817setTransformOrigin__ExYCQ(SimpleGraphicsLayerModifier.this.m2951getTransformOriginSzJe1aQ());
                ...
                graphicsLayerScope.mo2814setAmbientShadowColor8_81llA(SimpleGraphicsLayerModifier.this.m2948getAmbientShadowColor0d7_KjU());
                graphicsLayerScope.mo2816setSpotShadowColor8_81llA(SimpleGraphicsLayerModifier.this.m2950getSpotShadowColor0d7_KjU());
                graphicsLayerScope.mo2815setCompositingStrategyaDBOjCE(SimpleGraphicsLayerModifier.this.m2949getCompositingStrategyNrFUSI());
            }
        };
    }

    public final void invalidateLayerBlock() {
        NodeCoordinator wrapped$ui_release = DelegatableNodeKt.m3978requireCoordinator64DMado(this, NodeKind.m4080constructorimpl(2)).getWrapped$ui_release();
    ...
    public MeasureResult mo236measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measure, mo3865measureBRTryo0.getWidth(), mo3865measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.graphics.SimpleGraphicsLayerModifier$measure$1
            /* JADX INFO: Access modifiers changed from: package-private */
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.placeWithLayer$default(layout, Placeable.this, 0, 0, 0.0f, SimpleGraphicsLayerModifier.access$getLayerBlock$p(this), 4, null);
            }
        }, 4, null);
    }
