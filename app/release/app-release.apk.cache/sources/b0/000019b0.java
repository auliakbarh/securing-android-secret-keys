...
public final class LineHeightStyle {
    ...
    private static final LineHeightStyle Default = new LineHeightStyle(Alignment.Companion.m4744getProportionalPIaL0Z0(), Trim.Companion.m4755getBothEVpEnUU(), null);
    ...
    public final float m4733getAlignmentPIaL0Z0() {
        return this.alignment;
    }

    /* renamed from: getTrim-EVpEnUU  reason: not valid java name */
    public final int m4734getTrimEVpEnUU() {
        return this.trim;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LineHeightStyle) {
            ...
            return Alignment.m4738equalsimpl0(this.alignment, lineHeightStyle.alignment) && Trim.m4749equalsimpl0(this.trim, lineHeightStyle.trim);
        }
        return false;
    }

    public int hashCode() {
        return (Alignment.m4739hashCodeimpl(this.alignment) * 31) + Trim.m4750hashCodeimpl(this.trim);
    }

    public String toString() {
        return "LineHeightStyle(alignment=" + ((Object) Alignment.m4740toStringimpl(this.alignment)) + ", trim=" + ((Object) Trim.m4753toStringimpl(this.trim)) + ')';
    }
    ...
    public static final class Trim {
        ...
        public static final Companion Companion = new Companion(null);
        private static final int FirstLineTop = m4747constructorimpl(1);
        private static final int LastLineBottom = m4747constructorimpl(16);
        private static final int Both = m4747constructorimpl(17);
        private static final int None = m4747constructorimpl(0);

        /* renamed from: box-impl  reason: not valid java name */
        public static final /* synthetic */ Trim m4746boximpl(int i) {
            return new Trim(i);
        }

        /* renamed from: constructor-impl  reason: not valid java name */
        private static int m4747constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl  reason: not valid java name */
        public static boolean m4748equalsimpl(int i, Object obj) {
            return (obj instanceof Trim) && i == ((Trim) obj).m4754unboximpl();
        }

        /* renamed from: equals-impl0  reason: not valid java name */
        public static final boolean m4749equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* renamed from: hashCode-impl  reason: not valid java name */
        public static int m4750hashCodeimpl(int i) {
            return Integer.hashCode(i);
        }

        /* renamed from: isTrimFirstLineTop-impl$ui_text_release  reason: not valid java name */
        public static final boolean m4751isTrimFirstLineTopimpl$ui_text_release(int i) {
            return (i & 1) > 0;
        }

        /* renamed from: isTrimLastLineBottom-impl$ui_text_release  reason: not valid java name */
        public static final boolean m4752isTrimLastLineBottomimpl$ui_text_release(int i) {
            return (i & 16) > 0;
        }
        ...
        public boolean equals(Object obj) {
            return m4748equalsimpl(this.value, obj);
        }
        ...
        public String toString() {
            return m4753toStringimpl(this.value);
        }
        ...
        public static final class Companion {
            ...
            public final int m4756getFirstLineTopEVpEnUU() {
                return Trim.FirstLineTop;
            }

            /* renamed from: getLastLineBottom-EVpEnUU  reason: not valid java name */
            public final int m4757getLastLineBottomEVpEnUU() {
                return Trim.LastLineBottom;
            }

            /* renamed from: getBoth-EVpEnUU  reason: not valid java name */
            public final int m4755getBothEVpEnUU() {
                return Trim.Both;
            }

            /* renamed from: getNone-EVpEnUU  reason: not valid java name */
            public final int m4758getNoneEVpEnUU() {
                return Trim.None;
            }
        }
    }
    ...
    public static final class Alignment {
        ...
        public static final Companion Companion = new Companion(null);
        private static final float Top = m4736constructorimpl(0.0f);
        private static final float Center = m4736constructorimpl(0.5f);
        private static final float Proportional = m4736constructorimpl(-1.0f);
        private static final float Bottom = m4736constructorimpl(1.0f);

        /* renamed from: box-impl  reason: not valid java name */
        public static final /* synthetic */ Alignment m4735boximpl(float f) {
            return new Alignment(f);
        }

        /* renamed from: equals-impl  reason: not valid java name */
        public static boolean m4737equalsimpl(float f, Object obj) {
            return (obj instanceof Alignment) && Float.compare(f, ((Alignment) obj).m4741unboximpl()) == 0;
        }

        /* renamed from: equals-impl0  reason: not valid java name */
        public static final boolean m4738equalsimpl0(float f, float f2) {
            return Float.compare(f, f2) == 0;
        }

        /* renamed from: hashCode-impl  reason: not valid java name */
        public static int m4739hashCodeimpl(float f) {
            return Float.hashCode(f);
        }

        public boolean equals(Object obj) {
            return m4737equalsimpl(this.topRatio, obj);
        }

        public int hashCode() {
            return m4739hashCodeimpl(this.topRatio);
        }

        /* renamed from: unbox-impl  reason: not valid java name */
        public final /* synthetic */ float m4741unboximpl() {
        ...
        /* renamed from: constructor-impl  reason: not valid java name */
        public static float m4736constructorimpl(float f) {
        ...
        public String toString() {
            return m4740toStringimpl(this.topRatio);
        }

        /* renamed from: toString-impl  reason: not valid java name */
        public static String m4740toStringimpl(float f) {
        ...
        public static final class Companion {
            ...
            public final float m4745getTopPIaL0Z0() {
                return Alignment.Top;
            }

            /* renamed from: getCenter-PIaL0Z0  reason: not valid java name */
            public final float m4743getCenterPIaL0Z0() {
                return Alignment.Center;
            }

            /* renamed from: getProportional-PIaL0Z0  reason: not valid java name */
            public final float m4744getProportionalPIaL0Z0() {
                return Alignment.Proportional;
            }

            /* renamed from: getBottom-PIaL0Z0  reason: not valid java name */
            public final float m4742getBottomPIaL0Z0() {
