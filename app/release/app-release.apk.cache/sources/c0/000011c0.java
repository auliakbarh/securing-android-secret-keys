...
public final class PersistentOrderedMap<K, V> extends AbstractMap<K, V> implements PersistentMap<K, V> {
    ...
    public PersistentOrderedMap<K, V> put(K k, V v) {
        ...
        return new PersistentOrderedMap<>(this.firstKey, k, this.hashMap.put((PersistentHashMap<K, LinkedValue<V>>) obj, (Object) ((LinkedValue) obj2).withNext(k)).put((PersistentHashMap) k, (K) new LinkedValue(v, obj)));
    }
