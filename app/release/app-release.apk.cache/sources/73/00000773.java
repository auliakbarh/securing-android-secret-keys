...
public final class MeasuredPage implements PageInfo {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            long m686getOffsetBjo55l4 = m686getOffsetBjo55l4(i);
            if (this.reverseLayout) {
                if (!this.isVertical) {
                    m4990getXimpl = (this.mainAxisLayoutSize - IntOffset.m4990getXimpl(m686getOffsetBjo55l4)) - getMainAxisSize(placeable);
                } else {
                    m4990getXimpl = IntOffset.m4990getXimpl(m686getOffsetBjo55l4);
                }
                if (this.isVertical) {
                    m4991getYimpl = (this.mainAxisLayoutSize - IntOffset.m4991getYimpl(m686getOffsetBjo55l4)) - getMainAxisSize(placeable);
                } else {
                    m4991getYimpl = IntOffset.m4991getYimpl(m686getOffsetBjo55l4);
                }
                m686getOffsetBjo55l4 = IntOffsetKt.IntOffset(m4990getXimpl, m4991getYimpl);
            }
            long j = this.visualOffset;
            long IntOffset = IntOffsetKt.IntOffset(IntOffset.m4990getXimpl(m686getOffsetBjo55l4) + IntOffset.m4990getXimpl(j), IntOffset.m4991getYimpl(m686getOffsetBjo55l4) + IntOffset.m4991getYimpl(j));
            if (this.isVertical) {
                Placeable.PlacementScope.m3925placeWithLayeraW9wM$default(scope, placeable, IntOffset, 0.0f, null, 6, null);
            } else {
                Placeable.PlacementScope.m3924placeRelativeWithLayeraW9wM$default(scope, placeable, IntOffset, 0.0f, null, 6, null);
            }
        }
    }

    /* renamed from: getOffset-Bjo55l4  reason: not valid java name */
    private final long m686getOffsetBjo55l4(int i) {
    ...
    private final long m685copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
