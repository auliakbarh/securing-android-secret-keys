...
public final class DeprecatedBridgeFontResourceLoader implements Font.ResourceLoader {
    ...
    public Object load(Font font) {
        ...
        return FontFamily.Resolver.m4473resolveDPcqOEQ$default(this.fontFamilyResolver, FontKt.toFontFamily(font), font.getWeight(), font.mo4454getStyle_LCdwA(), 0, 8, null).getValue();
    }
