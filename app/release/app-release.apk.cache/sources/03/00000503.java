...
final class InsetsPaddingValues implements PaddingValues {
    ...
    public float mo430calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
        ...
        return density.mo321toDpu2uoSUM(this.insets.getLeft(density, layoutDirection));
    }
    ...
    public float mo432calculateTopPaddingD9Ej5fM() {
        Density density = this.density;
        return density.mo321toDpu2uoSUM(this.insets.getTop(density));
    }
    ...
    public float mo431calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Density density = this.density;
        return density.mo321toDpu2uoSUM(this.insets.getRight(density, layoutDirection));
    }
    ...
    public float mo429calculateBottomPaddingD9Ej5fM() {
        Density density = this.density;
        return density.mo321toDpu2uoSUM(this.insets.getBottom(density));
    }
