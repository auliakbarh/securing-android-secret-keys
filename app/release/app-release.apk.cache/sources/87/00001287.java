...
public final class BiasAlignment implements Alignment {
    ...
    public long mo2279alignKFBX0sM(long j, long j2, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        float m5032getWidthimpl = (IntSize.m5032getWidthimpl(j2) - IntSize.m5032getWidthimpl(j)) / 2.0f;
        float m5031getHeightimpl = (IntSize.m5031getHeightimpl(j2) - IntSize.m5031getHeightimpl(j)) / 2.0f;
        float f = 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt(m5032getWidthimpl * ((layoutDirection == LayoutDirection.Ltr ? this.horizontalBias : (-1) * this.horizontalBias) + f)), MathKt.roundToInt(m5031getHeightimpl * (f + this.verticalBias)));
    }
