...
public final class InputModeManagerImpl implements InputModeManager {
    ...
    private InputModeManagerImpl(int i, Function1<? super InputMode, Boolean> onRequestInputModeChange) {
        ...
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(InputMode.m3289boximpl(i), null, 2, null);
        this.inputMode$delegate = mutableStateOf$default;
    }

    @Override // androidx.compose.ui.input.InputModeManager
    /* renamed from: getInputMode-aOaMEAU */
    public int mo3298getInputModeaOaMEAU() {
        return ((InputMode) this.inputMode$delegate.getValue()).m3295unboximpl();
    }

    /* renamed from: setInputMode-iuPiT84  reason: not valid java name */
    public void m3300setInputModeiuPiT84(int i) {
        this.inputMode$delegate.setValue(InputMode.m3289boximpl(i));
    }

    @Override // androidx.compose.ui.input.InputModeManager
    /* renamed from: requestInputMode-iuPiT84 */
    public boolean mo3299requestInputModeiuPiT84(int i) {
        return this.onRequestInputModeChange.invoke(InputMode.m3289boximpl(i)).booleanValue();
    }
}