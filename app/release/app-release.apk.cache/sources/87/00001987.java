...
public final class AndroidTextPaint extends TextPaint {
    ...
    public final void setShadow(Shadow shadow) {
        ...
        if (Intrinsics.areEqual(shadow, Shadow.Companion.getNone())) {
            ...
            setShadowLayer(TextPaintExtensions_androidKt.correctBlurRadius(this.shadow.getBlurRadius()), Offset.m2389getXimpl(this.shadow.m2947getOffsetF1C5BW0()), Offset.m2390getYimpl(this.shadow.m2947getOffsetF1C5BW0()), ColorKt.m2682toArgb8_81llA(this.shadow.m2946getColor0d7_KjU()));
        }
    }

    /* renamed from: setBrush-12SF9DM$default  reason: not valid java name */
    public static /* synthetic */ void m4636setBrush12SF9DM$default(AndroidTextPaint androidTextPaint, Brush brush, long j, float f, int i, Object obj) {
        if ((i & 4) != 0) {
            f = Float.NaN;
        }
        androidTextPaint.m4639setBrush12SF9DM(brush, j, f);
    }

    /* renamed from: setBrush-12SF9DM  reason: not valid java name */
    public final void m4639setBrush12SF9DM(Brush brush, long j, float f) {
        if (((brush instanceof SolidColor) && ((SolidColor) brush).m2956getValue0d7_KjU() != Color.Companion.m2664getUnspecified0d7_KjU()) || ((brush instanceof ShaderBrush) && j != Size.Companion.m2466getUnspecifiedNHjbRc())) {
            brush.mo2575applyToPq9zytI(j, this.composePaint, Float.isNaN(f) ? this.composePaint.getAlpha() : RangesKt.coerceIn(f, 0.0f, 1.0f));
        } else if (brush == null) {
    ...
    public final void setDrawStyle(DrawStyle drawStyle) {
        ...
        if (Intrinsics.areEqual(drawStyle, Fill.INSTANCE)) {
            this.composePaint.mo2513setStylek9PVt8s(PaintingStyle.Companion.m2889getFillTiuSbCo());
        } else if (drawStyle instanceof Stroke) {
            this.composePaint.mo2513setStylek9PVt8s(PaintingStyle.Companion.m2890getStrokeTiuSbCo());
            Stroke stroke = (Stroke) drawStyle;
            this.composePaint.setStrokeWidth(stroke.getWidth());
            this.composePaint.setStrokeMiterLimit(stroke.getMiter());
            this.composePaint.mo2512setStrokeJoinWw9F2mQ(stroke.m3235getJoinLxFBmk8());
            this.composePaint.mo2511setStrokeCapBeK7IIE(stroke.m3234getCapKaPHkGw());
            this.composePaint.setPathEffect(stroke.getPathEffect());
        }
    }

    /* renamed from: getBlendMode-0nO6VwU  reason: not valid java name */
    public final int m4637getBlendMode0nO6VwU() {
        return this.composePaint.mo2502getBlendMode0nO6VwU();
    }

    /* renamed from: setBlendMode-s9anfk8  reason: not valid java name */
    public final void m4638setBlendModes9anfk8(int i) {
        this.composePaint.mo2508setBlendModes9anfk8(i);
    }

    /* renamed from: setColor-8_81llA  reason: not valid java name */
    public final void m4640setColor8_81llA(long j) {
        if (j != Color.Companion.m2664getUnspecified0d7_KjU()) {
            this.composePaint.mo2509setColor8_81llA(j);
            this.composePaint.setShader(null);
        }
    }
}