...
public final class TimePickerLayoutType {
    ...
    private static final int Horizontal = m1582constructorimpl(0);
    private static final int Vertical = m1582constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ TimePickerLayoutType m1581boximpl(int i) {
        return new TimePickerLayoutType(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m1582constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1583equalsimpl(int i, Object obj) {
        return (obj instanceof TimePickerLayoutType) && i == ((TimePickerLayoutType) obj).m1587unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m1584equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m1585hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m1583equalsimpl(this.value, obj);
    }
    ...
    public static final class Companion {
        ...
        public final int m1588getHorizontalQJTpgSE() {
            return TimePickerLayoutType.Horizontal;
        }

        /* renamed from: getVertical-QJTpgSE  reason: not valid java name */
        public final int m1589getVerticalQJTpgSE() {
            return TimePickerLayoutType.Vertical;
        }
    }

    public String toString() {
        return m1586toStringimpl(this.value);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1586toStringimpl(int i) {
        return m1584equalsimpl0(i, Horizontal) ? "Horizontal" : m1584equalsimpl0(i, Vertical) ? "Vertical" : "Unknown";
    }
}