...
public abstract class LazyListMeasuredItemProvider {
    ...
    public final long m590getChildConstraintsmsEJaDk() {
    ...
    private LazyListMeasuredItemProvider(long j, boolean z, LazyListItemProvider itemProvider, LazyLayoutMeasureScope measureScope) {
        ...
        this.childConstraints = ConstraintsKt.Constraints$default(0, z ? Constraints.m4828getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, !z ? Constraints.m4827getMaxHeightimpl(j) : Integer.MAX_VALUE, 5, null);
    }

    public final LazyListMeasuredItem getAndMeasure(int i) {
        return createItem(i, this.itemProvider.getKey(i), this.itemProvider.getContentType(i), this.measureScope.mo637measure0kLqBqw(i, this.childConstraints));
    }
