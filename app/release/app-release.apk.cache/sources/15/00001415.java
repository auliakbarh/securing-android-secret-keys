...
public final class ImageVector {
    ...
    public final float m3248getDefaultHeightD9Ej5fM() {
        return this.defaultHeight;
    }

    /* renamed from: getDefaultWidth-D9Ej5fM  reason: not valid java name */
    public final float m3249getDefaultWidthD9Ej5fM() {
    ...
    public final int m3250getTintBlendMode0nO6VwU() {
        return this.tintBlendMode;
    }

    /* renamed from: getTintColor-0d7_KjU  reason: not valid java name */
    public final long m3251getTintColor0d7_KjU() {
    ...
    public static final class Builder {
        ...
        public /* synthetic */ Builder(String str, float f, float f2, float f3, float f4, long j, int i, boolean z, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this((i2 & 1) != 0 ? "" : str, f, f2, f3, f4, (i2 & 32) != 0 ? Color.Companion.m2664getUnspecified0d7_KjU() : j, (i2 & 64) != 0 ? BlendMode.Companion.m2570getSrcIn0nO6VwU() : i, (i2 & 128) != 0 ? false : z, (DefaultConstructorMarker) null);
        }
        ...
        public /* synthetic */ Builder(String str, float f, float f2, float f3, float f4, long j, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this((i2 & 1) != 0 ? "" : str, f, f2, f3, f4, (i2 & 32) != 0 ? Color.Companion.m2664getUnspecified0d7_KjU() : j, (i2 & 64) != 0 ? BlendMode.Companion.m2570getSrcIn0nO6VwU() : i, (DefaultConstructorMarker) null);
        }
        ...
        public final Builder addGroup(String name, float f, float f2, float f3, float f4, float f5, float f6, float f7, List<? extends PathNode> clipPathData) {
            ...
            ensureNotConsumed();
            ImageVectorKt.access$push(this.nodes, new GroupParams(name, f, f2, f3, f4, f5, f6, f7, clipPathData, null, 512, null));
            return this;
        }
        ...
        public final Builder m3253addPathoIyEayM(List<? extends PathNode> pathData, int i, String name, Brush brush, float f, Brush brush2, float f2, float f3, int i2, int i3, float f4, float f5, float f6, float f7) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ImageVector) {
            ...
            return Intrinsics.areEqual(this.name, imageVector.name) && Dp.m4877equalsimpl0(this.defaultWidth, imageVector.defaultWidth) && Dp.m4877equalsimpl0(this.defaultHeight, imageVector.defaultHeight) && this.viewportWidth == imageVector.viewportWidth && this.viewportHeight == imageVector.viewportHeight && Intrinsics.areEqual(this.root, imageVector.root) && Color.m2629equalsimpl0(this.tintColor, imageVector.tintColor) && BlendMode.m2541equalsimpl0(this.tintBlendMode, imageVector.tintBlendMode) && this.autoMirror == imageVector.autoMirror;
        }
        return false;
    }

    public int hashCode() {
        return (((((((((((((((this.name.hashCode() * 31) + Dp.m4878hashCodeimpl(this.defaultWidth)) * 31) + Dp.m4878hashCodeimpl(this.defaultHeight)) * 31) + Float.hashCode(this.viewportWidth)) * 31) + Float.hashCode(this.viewportHeight)) * 31) + this.root.hashCode()) * 31) + Color.m2635hashCodeimpl(this.tintColor)) * 31) + BlendMode.m2542hashCodeimpl(this.tintBlendMode)) * 31) + Boolean.hashCode(this.autoMirror);
    }
}