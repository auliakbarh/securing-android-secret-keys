...
public final class FocusTargetNode extends Modifier.Node implements FocusTargetModifierNode, ObserverModifierNode, ModifierLocalModifierNode {
    ...
    public final FocusProperties fetchFocusProperties$ui_release() {
        ...
        int m4080constructorimpl = NodeKind.m4080constructorimpl(2048);
                ...
                while (node2 != null) {
                    if ((node2.getKindSet$ui_release() & i) != 0) {
                        if (node2 != node && (node2.getKindSet$ui_release() & m4080constructorimpl2) != 0) {
                            break loop0;
                        } else if ((node2.getKindSet$ui_release() & m4080constructorimpl) != 0) {
    ...
    public final void m2335fetchCustomEnteraToIllA$ui_release(int i, Function1<? super FocusRequester, Unit> block) {
        ...
        try {
            FocusRequester invoke = fetchFocusProperties$ui_release().getEnter().invoke(FocusDirection.m2305boximpl(i));
    ...
    public final void m2336fetchCustomExitaToIllA$ui_release(int i, Function1<? super FocusRequester, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        ...
        try {
            FocusRequester invoke = fetchFocusProperties$ui_release().getExit().invoke(FocusDirection.m2305boximpl(i));
            if (invoke != FocusRequester.Companion.getDefault()) {
                block.invoke(invoke);
            }
        } finally {
    ...
    public final void scheduleInvalidationForFocusEvents$ui_release() {
        ...
        FocusTargetNode focusTargetNode = this;
        int m4080constructorimpl2 = NodeKind.m4080constructorimpl(4096) | NodeKind.m4080constructorimpl(1024);
        if (!focusTargetNode.getNode().isAttached()) {
            throw new IllegalStateException("visitAncestors called on an unattached node".toString());
        }
        ...
        while (requireLayoutNode != null) {
            if ((requireLayoutNode.getNodes$ui_release().getHead$ui_release().getAggregateChildKindSet$ui_release() & m4080constructorimpl2) != 0) {
                while (parent$ui_release != null) {
                    if ((parent$ui_release.getKindSet$ui_release() & m4080constructorimpl2) != 0 && (NodeKind.m4080constructorimpl(1024) & parent$ui_release.getKindSet$ui_release()) == 0 && parent$ui_release.isAttached()) {
                        int m4080constructorimpl3 = NodeKind.m4080constructorimpl(4096);
                        ...
                        while (node2 != null) {
                            if (node2 instanceof FocusEventModifierNode) {
                            ...
                            } else if ((node2.getKindSet$ui_release() & m4080constructorimpl3) != 0 && (node2 instanceof DelegatingNode)) {
                                int i2 = 0;
                                for (Modifier.Node delegate$ui_release2 = ((DelegatingNode) node2).getDelegate$ui_release(); delegate$ui_release2 != null; delegate$ui_release2 = delegate$ui_release2.getChild$ui_release()) {
                                    if ((delegate$ui_release2.getKindSet$ui_release() & m4080constructorimpl3) != 0) {
                                        i2++;
                                        if (i2 == 1) {
