...
public final class DeviceRenderNodeData {
    ...
    public final int m4184component25NrFUSI() {
    ...
    public final DeviceRenderNodeData m4185copyfuCbV5c(long j, int i, int i2, int i3, int i4, int i5, int i6, float f, float f2, float f3, float f4, float f5, int i7, int i8, float f6, float f7, float f8, float f9, float f10, float f11, boolean z, boolean z2, float f12, RenderEffect renderEffect, int i9) {
    ...
    public final int m4186getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }
    ...
    public int hashCode() {
        ...
        return ((hashCode2 + (renderEffect == null ? 0 : renderEffect.hashCode())) * 31) + CompositingStrategy.m2710hashCodeimpl(this.compositingStrategy);
    }
    ...
    public final void m4187setCompositingStrategyaDBOjCE(int i) {
    ...
    public String toString() {
        ...
        sb.append(", renderEffect=").append(this.renderEffect).append(", compositingStrategy=").append((Object) CompositingStrategy.m2711toStringimpl(this.compositingStrategy)).append(')');
        return sb.toString();
    }
