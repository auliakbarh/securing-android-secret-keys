...
public final class VectorComponent extends VNode {
    ...
    public VectorComponent() {
        ...
        this.previousDrawSize = Size.Companion.m2466getUnspecifiedNHjbRc();
    ...
    public final void draw(DrawScope drawScope, float f, ColorFilter colorFilter) {
        ...
        if (this.isDirty || !Size.m2454equalsimpl0(this.previousDrawSize, drawScope.mo3171getSizeNHjbRc())) {
            this.root.setScaleX(Size.m2458getWidthimpl(drawScope.mo3171getSizeNHjbRc()) / this.viewportWidth);
            this.root.setScaleY(Size.m2455getHeightimpl(drawScope.mo3171getSizeNHjbRc()) / this.viewportHeight);
            this.cacheDrawScope.m3247drawCachedImageCJJARo(IntSizeKt.IntSize((int) Math.ceil(Size.m2458getWidthimpl(drawScope.mo3171getSizeNHjbRc())), (int) Math.ceil(Size.m2455getHeightimpl(drawScope.mo3171getSizeNHjbRc()))), drawScope, drawScope.getLayoutDirection(), this.drawVectorBlock);
            this.isDirty = false;
            this.previousDrawSize = drawScope.mo3171getSizeNHjbRc();
        }
