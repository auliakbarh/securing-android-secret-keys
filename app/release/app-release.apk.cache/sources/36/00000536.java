...
final class OffsetPxNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo236measure3p2s80s(final MeasureScope measure, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measure, mo3865measureBRTryo0.getWidth(), mo3865measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetPxNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                long m4999unboximpl = OffsetPxNode.this.getOffset().invoke(measure).m4999unboximpl();
                if (OffsetPxNode.this.getRtlAware()) {
                    Placeable.PlacementScope.placeRelativeWithLayer$default(layout, mo3865measureBRTryo0, IntOffset.m4990getXimpl(m4999unboximpl), IntOffset.m4991getYimpl(m4999unboximpl), 0.0f, null, 12, null);
                } else {
                    Placeable.PlacementScope.placeWithLayer$default(layout, mo3865measureBRTryo0, IntOffset.m4990getXimpl(m4999unboximpl), IntOffset.m4991getYimpl(m4999unboximpl), 0.0f, null, 12, null);
                }
            }
        }, 4, null);
    }
