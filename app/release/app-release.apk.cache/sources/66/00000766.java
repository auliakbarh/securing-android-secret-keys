...
public final class ConsumeAllFlingOnDirection implements NestedScrollConnection {
    ...
    public final long m683consumeOnOrientationQWom1Mo(long j, Orientation orientation) {
        Intrinsics.checkNotNullParameter(orientation, "orientation");
        if (orientation == Orientation.Vertical) {
            return Velocity.m5093copyOhffZ5M$default(j, 0.0f, 0.0f, 2, null);
        }
        return Velocity.m5093copyOhffZ5M$default(j, 0.0f, 0.0f, 1, null);
    }

    /* renamed from: consumeOnOrientation-8S9VItk  reason: not valid java name */
    public final long m682consumeOnOrientation8S9VItk(long j, Orientation orientation) {
        Intrinsics.checkNotNullParameter(orientation, "orientation");
        if (orientation == Orientation.Vertical) {
            return Offset.m2383copydBAh8RU$default(j, 0.0f, 0.0f, 2, null);
        }
        return Offset.m2383copydBAh8RU$default(j, 0.0f, 0.0f, 1, null);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostScroll-DzOQY0M */
    public long mo332onPostScrollDzOQY0M(long j, long j2, int i) {
        return NestedScrollSource.m3639equalsimpl0(i, NestedScrollSource.Companion.m3645getFlingWNlRxjI()) ? m682consumeOnOrientation8S9VItk(j2, this.orientation) : Offset.Companion.m2405getZeroF1C5BW0();
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostFling-RZ2iAVY */
    public Object mo331onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        return Velocity.m5088boximpl(m683consumeOnOrientationQWom1Mo(j2, this.orientation));
    }
}