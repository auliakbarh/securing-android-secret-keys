...
public final class AndroidConfig implements ScrollConfig {
    ...
    public long mo242calculateMouseWheelScroll8xgXZGE(Density calculateMouseWheelScroll, PointerEvent event, long j) {
        Intrinsics.checkNotNullParameter(calculateMouseWheelScroll, "$this$calculateMouseWheelScroll");
        Intrinsics.checkNotNullParameter(event, "event");
        List<PointerInputChange> changes = event.getChanges();
        Offset m2378boximpl = Offset.m2378boximpl(Offset.Companion.m2405getZeroF1C5BW0());
        int size = changes.size();
        for (int i = 0; i < size; i++) {
            m2378boximpl = Offset.m2378boximpl(Offset.m2394plusMKHz9U(m2378boximpl.m2399unboximpl(), changes.get(i).m3749getScrollDeltaF1C5BW0()));
        }
        return Offset.m2396timestuRUvjQ(m2378boximpl.m2399unboximpl(), -calculateMouseWheelScroll.mo324toPx0680j_4(Dp.m4872constructorimpl(64)));
    }
}