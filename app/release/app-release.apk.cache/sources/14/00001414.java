...
public final class GroupComponent extends VNode {
    ...
    private final void updateMatrix() {
        ...
        if (fArr == null) {
            fArr = Matrix.m2853constructorimpl$default(null, 1, null);
            this.groupMatrix = fArr;
        } else {
            Matrix.m2862resetimpl(fArr);
        }
        Matrix.m2873translateimpl$default(fArr, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, null);
        Matrix.m2865rotateZimpl(fArr, this.rotation);
        Matrix.m2866scaleimpl(fArr, this.scaleX, this.scaleY, 1.0f);
        Matrix.m2873translateimpl$default(fArr, -this.pivotX, -this.pivotY, 0.0f, 4, null);
    }
    ...
    public void draw(DrawScope drawScope) {
        ...
        float[] fArr = this.groupMatrix;
        if (fArr != null) {
            transform.mo3104transform58bKbWc((fArr != null ? Matrix.m2851boximpl(fArr) : null).m2874unboximpl());
        }
        Path path = this.clipPath;
        if (getWillClipPath() && path != null) {
            DrawTransform.m3221clipPathmtrdDE$default(transform, path, 0, 2, null);
        }
