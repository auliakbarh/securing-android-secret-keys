...
public final class ScrollState implements ScrollableState {
    ...
    private final ScrollableState scrollableState = ScrollableStateKt.ScrollableState(new Function1<Float, Float>() { // from class: androidx.compose.foundation.ScrollState$scrollableState$1
        ...
        public final Float invoke(float f) {
            float value = ScrollState.this.getValue() + f + ScrollState.access$getAccumulator$p(ScrollState.this);
            ...
            ScrollState.access$setAccumulator$p(ScrollState.this, value2 - roundToInt);
            if (z) {
                f = value2;
            }
    ...
    public static final /* synthetic */ void access$setAccumulator$p(ScrollState scrollState, float f) {
        scrollState.accumulator = f;
    }
