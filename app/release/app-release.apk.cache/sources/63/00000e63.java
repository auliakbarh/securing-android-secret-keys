...
public final class SwipeableKt {
    ...
    public static final <T> SwipeableState<T> rememberSwipeableState(final T initialValue, final AnimationSpec<Float> animationSpec, final Function1<? super T, Boolean> function1, Composer composer, int i, int i2) {
        ...
        SwipeableState<T> swipeableState = (SwipeableState) RememberSaveableKt.m2275rememberSaveable(new Object[0], (Saver<Object, ? extends Object>) SwipeableState.Companion.Saver(animationSpec, function1), (String) null, (Function0<? extends Object>) new Function0<SwipeableState<T>>() { // from class: androidx.compose.material3.SwipeableKt$rememberSwipeableState$2
    ...
    public static final <T> Modifier m1485swipeablepPrIpRY(Modifier swipeable, final SwipeableState<T> state, final Map<Float, ? extends T> anchors, final Orientation orientation, final boolean z, final boolean z2, final MutableInteractionSource mutableInteractionSource, final Function2<? super T, ? super T, ? extends ThresholdConfig> thresholds, final ResistanceConfig resistanceConfig, final float f) {
        ...
        return ComposedModifierKt.composed(swipeable, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.material3.SwipeableKt$swipeable-pPrIpRY$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("velocityThreshold", Dp.m4870boximpl(f));
            }
            ...
            public final Modifier invoke(Modifier composed, Composer composer, int i) {
                ...
                DraggableState draggableState$material3_release = state.getDraggableState$material3_release();
                ...
                composer.endReplaceableGroup();
                draggable = DraggableKt.draggable(companion2, draggableState$material3_release, orientation2, (r20 & 4) != 0 ? true : z3, (r20 & 8) != 0 ? null : mutableInteractionSource2, (r20 & 16) != 0 ? false : isAnimationRunning, (r20 & 32) != 0 ? new DraggableKt$draggable$1(null) : null, (r20 & 64) != 0 ? new DraggableKt$draggable$2(null) : (Function3) rememberedValue, (r20 & 128) != 0 ? false : z2);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                composer.endReplaceableGroup();
            ...
            public static final class AnonymousClass3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (i == 0) {
                        ...
                        this.$state.setVelocityThreshold$material3_release(this.$density.mo324toPx0680j_4(this.$velocityThreshold));
                        this.label = 1;
