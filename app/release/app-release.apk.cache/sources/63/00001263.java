...
public final class SnapshotStateObserver {
    ...
    public static final class ObservedScopeMap {
        ...
        public ObservedScopeMap(Function1<Object, Unit> onChanged) {
            ...
            this.derivedStateObserver = new DerivedStateObserver() { // from class: androidx.compose.runtime.snapshots.SnapshotStateObserver$ObservedScopeMap$derivedStateObserver$1
                ...
                public void start(DerivedState<?> derivedState) {
                    ...
                    SnapshotStateObserver.ObservedScopeMap.access$setDeriveStateScopeCount$p(observedScopeMap, SnapshotStateObserver.ObservedScopeMap.access$getDeriveStateScopeCount$p(observedScopeMap) + 1);
                }
        ...
        public static final /* synthetic */ int access$getDeriveStateScopeCount$p(ObservedScopeMap observedScopeMap) {
            return observedScopeMap.deriveStateScopeCount;
        }

        public static final /* synthetic */ void access$setDeriveStateScopeCount$p(ObservedScopeMap observedScopeMap, int i) {
            observedScopeMap.deriveStateScopeCount = i;
        }
