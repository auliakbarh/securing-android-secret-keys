...
public final class DecodeHelper {
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (decodeByte != 1) {
                ...
                if (decodeByte == 2) {
                    ...
                    mutableSpanStyle.m4208setFontSizeR2X_6o(m4180decodeTextUnitXSAIIZE());
                    ...
                    mutableSpanStyle.m4209setFontStylemLjRB2g(FontStyle.m4496boximpl(m4178decodeFontStyle_LCdwA()));
                    mutableSpanStyle2 = mutableSpanStyle;
                            ...
                            if (decodeByte != 8) {
                                if (decodeByte != 9) {
                                    if (decodeByte != 10) {
                                        ...
                                        mutableSpanStyle.m4205setBackground8_81llA(m4177decodeColor0d7_KjU());
                                    }
                                } else if (dataAvailable() < 8) {
                                    break;
                                } else {
                                ...
                                mutableSpanStyle.m4206setBaselineShift_isdbwI(BaselineShift.m4659boximpl(m4175decodeBaselineShifty9eOQZs()));
                            }
                        } else if (dataAvailable() < 5) {
                            break;
                        } else {
                            mutableSpanStyle.m4211setLetterSpacingR2X_6o(m4180decodeTextUnitXSAIIZE());
                        }
                    } else {
                    ...
                    mutableSpanStyle.m4210setFontSynthesistDdu0R4(FontSynthesis.m4505boximpl(m4179decodeFontSynthesisGVVA2EU()));
                    mutableSpanStyle2 = mutableSpanStyle;
                }
            } else if (dataAvailable() < 8) {
                break;
            } else {
                mutableSpanStyle2.m4207setColor8_81llA(m4177decodeColor0d7_KjU());
            }
        }
        mutableSpanStyle = mutableSpanStyle2;
    ...
    public final long m4177decodeColor0d7_KjU() {
        return Color.m2624constructorimpl(m4176decodeULongsVKNKU());
    }

    /* renamed from: decodeTextUnit-XSAIIZE  reason: not valid java name */
    public final long m4180decodeTextUnitXSAIIZE() {
        long m5087getUnspecifiedUIouoOA;
        byte decodeByte = decodeByte();
        if (decodeByte == 1) {
            m5087getUnspecifiedUIouoOA = TextUnitType.Companion.m5086getSpUIouoOA();
        } else if (decodeByte == 2) {
            m5087getUnspecifiedUIouoOA = TextUnitType.Companion.m5085getEmUIouoOA();
        } else {
            m5087getUnspecifiedUIouoOA = TextUnitType.Companion.m5087getUnspecifiedUIouoOA();
        }
        if (TextUnitType.m5081equalsimpl0(m5087getUnspecifiedUIouoOA, TextUnitType.Companion.m5087getUnspecifiedUIouoOA())) {
            return TextUnit.Companion.m5064getUnspecifiedXSAIIZE();
        }
        return TextUnitKt.m5065TextUnitanM5pPY(decodeFloat(), m5087getUnspecifiedUIouoOA);
    }
    ...
    public final int m4178decodeFontStyle_LCdwA() {
        byte decodeByte = decodeByte();
        if (decodeByte == 0) {
            return FontStyle.Companion.m4504getNormal_LCdwA();
        }
        if (decodeByte == 1) {
            return FontStyle.Companion.m4503getItalic_LCdwA();
        }
        return FontStyle.Companion.m4504getNormal_LCdwA();
    }

    /* renamed from: decodeFontSynthesis-GVVA2EU  reason: not valid java name */
    public final int m4179decodeFontSynthesisGVVA2EU() {
        byte decodeByte = decodeByte();
        if (decodeByte == 0) {
            return FontSynthesis.Companion.m4515getNoneGVVA2EU();
        }
        if (decodeByte == 1) {
            return FontSynthesis.Companion.m4514getAllGVVA2EU();
        }
        if (decodeByte == 3) {
            return FontSynthesis.Companion.m4516getStyleGVVA2EU();
        }
        if (decodeByte == 2) {
            return FontSynthesis.Companion.m4517getWeightGVVA2EU();
        }
        return FontSynthesis.Companion.m4515getNoneGVVA2EU();
    }

    /* renamed from: decodeBaselineShift-y9eOQZs  reason: not valid java name */
    private final float m4175decodeBaselineShifty9eOQZs() {
        return BaselineShift.m4660constructorimpl(decodeFloat());
    }
    ...
    private final Shadow decodeShadow() {
        return new Shadow(m4177decodeColor0d7_KjU(), OffsetKt.Offset(decodeFloat(), decodeFloat()), decodeFloat(), null);
    }
    ...
    private final long m4176decodeULongsVKNKU() {
        return ULong.m5330constructorimpl(this.parcel.readLong());
    }
