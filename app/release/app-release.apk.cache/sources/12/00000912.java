...
public final class SelectionContainerKt {
    public static final /* synthetic */ void access$SelectionContainer$lambda$2(MutableState mutableState, Selection selection) {
            ...
            if (changed || rememberedValue2 == Composer.Companion.getEmpty()) {
                rememberedValue2 = (Function1) new Function1<Selection, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionContainerKt$SelectionContainer$1$1
                    ...
                    public final void invoke2(Selection selection) {
                        SelectionContainerKt.access$SelectionContainer$lambda$2(mutableState, selection);
                    }
                };
                    ...
                    if ((i5 & 11) != 2 || !composer2.getSkipping()) {
                        ...
                        SimpleLayoutKt.SimpleLayout(then, ComposableLambdaKt.composableLambda(composer2, 1375295262, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionContainerKt$SelectionContainer$3$1.1
                            ...
                            public final void invoke(Composer composer3, int i7) {
                                ...
                                Offset m917getEndHandlePosition_m7T9E;
                                ...
                                if ((i7 & 11) != 2 || !composer3.getSkipping()) {
                                    ...
                                    if (TouchMode_androidKt.isInTouchMode() && selectionManager2.getHasFocus() && (selection2 = selectionManager2.getSelection()) != null) {
                                        ...
                                        for (int i8 = 0; i8 < size; i8++) {
                                            ...
                                            if (booleanValue) {
                                                m917getEndHandlePosition_m7T9E = selectionManager3.m918getStartHandlePosition_m7T9E();
                                            } else {
                                                m917getEndHandlePosition_m7T9E = selectionManager3.m917getEndHandlePosition_m7T9E();
                                            }
                                            if (booleanValue) {
                                            ...
                                            if (m917getEndHandlePosition_m7T9E != null) {
                                                AndroidSelectionHandles_androidKt.m869SelectionHandle8fL75g(m917getEndHandlePosition_m7T9E.m2399unboximpl(), booleanValue, direction, selection2.getHandlesCrossed(), SuspendingPointerInputFilterKt.pointerInput(Modifier.Companion, textDragObserver, new SelectionContainerKt$SelectionContainer$3$1$1$1$1$1(textDragObserver, null)), null, composer3, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE);
                                            }
                                        }
                                    }
                                    if (ComposerKt.isTraceInProgress()) {
