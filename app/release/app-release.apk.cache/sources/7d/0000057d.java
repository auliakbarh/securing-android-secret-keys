...
final class UnspecifiedConstraintsElement extends ModifierNodeElement<UnspecifiedConstraintsNode> {
    ...
    public final float m543getMinHeightD9Ej5fM() {
        return this.minHeight;
    }

    /* renamed from: getMinWidth-D9Ej5fM  reason: not valid java name */
    public final float m544getMinWidthD9Ej5fM() {
    ...
    public void update(UnspecifiedConstraintsNode node) {
        ...
        node.m548setMinWidth0680j_4(this.minWidth);
        node.m547setMinHeight0680j_4(this.minHeight);
    }
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("minWidth", Dp.m4870boximpl(this.minWidth));
        inspectorInfo.getProperties().set("minHeight", Dp.m4870boximpl(this.minHeight));
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof UnspecifiedConstraintsElement) {
            ...
            return Dp.m4877equalsimpl0(this.minWidth, unspecifiedConstraintsElement.minWidth) && Dp.m4877equalsimpl0(this.minHeight, unspecifiedConstraintsElement.minHeight);
        }
        return false;
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (Dp.m4878hashCodeimpl(this.minWidth) * 31) + Dp.m4878hashCodeimpl(this.minHeight);
    }
}