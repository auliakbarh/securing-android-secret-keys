...
public final class TooltipKt {
    ...
    private static final float TooltipMinWidth = Dp.m4872constructorimpl(40);
    private static final float PlainTooltipMaxWidth = Dp.m4872constructorimpl((float) ComposerKt.invocationKey);

    /* renamed from: access$PlainTooltipImpl-Iv8Zu3U */
    public static final /* synthetic */ void m1665access$PlainTooltipImplIv8Zu3U(long j, Function2 function2, Composer composer, int i) {
        m1663PlainTooltipImplIv8Zu3U(j, function2, composer, i);
    }

    public static final /* synthetic */ void access$RichTooltipImpl(RichTooltipColors richTooltipColors, Function2 function2, Function2 function22, Function2 function23, Composer composer, int i) {
        RichTooltipImpl(richTooltipColors, function2, function22, function23, composer, i);
    }

    /* renamed from: access$TooltipBox-XDn_Kpo */
    public static final /* synthetic */ void m1666access$TooltipBoxXDn_Kpo(Function2 function2, PopupPositionProvider popupPositionProvider, Modifier modifier, Shape shape, TooltipState tooltipState, long j, float f, float f2, Function3 function3, Composer composer, int i) {
        m1664TooltipBoxXDn_Kpo(function2, popupPositionProvider, modifier, shape, tooltipState, j, f, f2, function3, composer, i);
    }

    public static final /* synthetic */ Modifier access$animateTooltip(Modifier modifier, Transition transition) {
        return animateTooltip(modifier, transition);
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:263:0x023a  */
    /* JADX WARN: Removed duplicated region for block: B:265:? A[RETURN, SYNTHETIC] */
    /* renamed from: PlainTooltipBox-nBX6wN0 */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final void m1662PlainTooltipBoxnBX6wN0(final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r23, androidx.compose.ui.Modifier r24, androidx.compose.material3.PlainTooltipState r25, androidx.compose.ui.graphics.Shape r26, long r27, long r29, final kotlin.jvm.functions.Function3<? super androidx.compose.material3.TooltipBoxScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r31, androidx.compose.runtime.Composer r32, final int r33, final int r34) {
        /*
            Method dump skipped, instructions count: 590
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.TooltipKt.m1662PlainTooltipBoxnBX6wN0(kotlin.jvm.functions.Function2, androidx.compose.ui.Modifier, androidx.compose.material3.PlainTooltipState, androidx.compose.ui.graphics.Shape, long, long, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:226:0x00e8  */
    ...
    /* JADX WARN: Removed duplicated region for block: B:272:0x0191  */
    ...
    /* JADX WARN: Removed duplicated region for block: B:291:0x02a9  */
    ...
    */
    ...
    /* renamed from: TooltipBox-XDn_Kpo */
    public static final void m1664TooltipBoxXDn_Kpo(final Function2<? super Composer, ? super Integer, Unit> function2, final PopupPositionProvider popupPositionProvider, final Modifier modifier, final Shape shape, final TooltipState tooltipState, final long j, final float f, final float f2, final Function3<? super TooltipBoxScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i) {
        int i2;
        ...
        if ((191739611 & i2) != 38347922 || !startRestartGroup.getSkipping()) {
            ...
            startRestartGroup.endReplaceableGroup();
            final String m1464getStringNWtq28 = Strings_androidKt.m1464getStringNWtq28(Strings.Companion.m1462getTooltipLongPressLabeladMyvUU(), startRestartGroup, 6);
            startRestartGroup.startReplaceableGroup(-492369756);
            ComposerKt.sourceInformation(startRestartGroup, "CC(remember):Composables.kt#9igjgp");
            ...
            if (((Boolean) updateTransition.getCurrentState()).booleanValue() || ((Boolean) updateTransition.getTargetState()).booleanValue()) {
                final String m1464getStringNWtq282 = Strings_androidKt.m1464getStringNWtq28(Strings.Companion.m1463getTooltipPaneDescriptionadMyvUU(), startRestartGroup, 6);
                final int i3 = i2;
                TooltipPopup_androidKt.TooltipPopup(popupPositionProvider, new Function0<Unit>() { // from class: androidx.compose.material3.TooltipKt$TooltipBox$1$1
                    ...
                    public final void invoke(Composer composer2, int i4) {
                        ...
                        if ((i4 & 11) != 2 || !composer2.getSkipping()) {
                            ...
                            Modifier access$animateTooltip = TooltipKt.access$animateTooltip(SizeKt.m530sizeInqDBjuR0$default(Modifier.this, TooltipKt.getTooltipMinWidth(), TooltipKt.getTooltipMinHeight(), f2, 0.0f, 8, null), updateTransition);
                            final String str = m1464getStringNWtq282;
                            ...
                            Modifier semantics$default = SemanticsModifierKt.semantics$default(access$animateTooltip, false, (Function1) rememberedValue3, 1, null);
                            Shape shape2 = shape;
                            long j2 = j;
                            float f3 = f;
                            Function2<Composer, Integer, Unit> function22 = function2;
                            int i5 = i3;
                            SurfaceKt.m1473SurfaceT9BRK9s(semantics$default, shape2, j2, 0L, f3, f3, null, function22, composer2, ((i5 >> 6) & 112) | ((i5 >> 9) & 896) | (57344 & (i5 >> 6)) | ((i5 >> 3) & 458752) | ((i5 << 21) & 29360128), 72);
                            if (ComposerKt.isTraceInProgress()) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TooltipKt$TooltipBox$2
            ...
            public final void invoke(Composer composer2, int i4) {
                TooltipKt.m1666access$TooltipBoxXDn_Kpo(function2, popupPositionProvider, modifier, shape, tooltipState, j, f, f2, function3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }

    /* renamed from: PlainTooltipImpl-Iv8Zu3U */
    public static final void m1663PlainTooltipImplIv8Zu3U(final long j, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        int i2;
        ...
        if ((i2 & 91) != 18 || !startRestartGroup.getSkipping()) {
            ...
            CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2618boximpl(j)), TextKt.getLocalTextStyle().provides(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography(startRestartGroup, 6), PlainTooltipTokens.INSTANCE.getSupportingTextFont()))}, function2, startRestartGroup, (i2 & 112) | 8);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            startRestartGroup.endReplaceableGroup();
            startRestartGroup.endNode();
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TooltipKt$PlainTooltipImpl$2
            ...
            public final void invoke(Composer composer2, int i3) {
                TooltipKt.m1665access$PlainTooltipImplIv8Zu3U(j, function2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    public static final void RichTooltipImpl(final RichTooltipColors richTooltipColors, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, Composer composer, final int i) {
        ...
        if ((i2 & 5851) != 1170 || !startRestartGroup.getSkipping()) {
            ...
            Modifier m481paddingVpY3zN4$default = PaddingKt.m481paddingVpY3zN4$default(Modifier.Companion, RichTooltipHorizontalPadding, 0.0f, 2, null);
            ...
            if (function22 == null) {
                ...
                Modifier m365paddingFromBaselineVpY3zN4$default = AlignmentLineKt.m365paddingFromBaselineVpY3zN4$default(Modifier.Companion, HeightToSubheadFirstLine, 0.0f, 2, null);
                startRestartGroup.startReplaceableGroup(733328855);
                ComposerKt.sourceInformation(startRestartGroup, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                MeasurePolicy rememberBoxMeasurePolicy = BoxKt.rememberBoxMeasurePolicy(Alignment.Companion.getTopStart(), false, startRestartGroup, 0);
                startRestartGroup.startReplaceableGroup(-1323940314);
                ...
                Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf2 = LayoutKt.materializerOf(m365paddingFromBaselineVpY3zN4$default);
                i3 = i2;
                if (!(startRestartGroup.getApplier() instanceof Applier)) {
                    ComposablesKt.invalidApplier();
                }
                ...
                CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2618boximpl(richTooltipColors.m1354getTitleContentColor0d7_KjU())), TextKt.getLocalTextStyle().provides(fromToken2)}, function22, startRestartGroup, 8);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endNode();
            ...
            CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2618boximpl(richTooltipColors.m1353getContentColor0d7_KjU())), TextKt.getLocalTextStyle().provides(fromToken3)}, function2, startRestartGroup, (i3 & 112) | 8);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            startRestartGroup.endReplaceableGroup();
            startRestartGroup.endNode();
            ...
            if (function23 != null) {
                Modifier m483paddingqDBjuR0$default = PaddingKt.m483paddingqDBjuR0$default(SizeKt.m517requiredHeightInVpY3zN4$default(Modifier.Companion, ActionLabelMinHeight, 0.0f, 2, null), 0.0f, 0.0f, 0.0f, ActionLabelBottomPadding, 7, null);
                startRestartGroup.startReplaceableGroup(733328855);
                ComposerKt.sourceInformation(startRestartGroup, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                ...
                CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2618boximpl(richTooltipColors.m1351getActionContentColor0d7_KjU())), TextKt.getLocalTextStyle().provides(fromToken)}, function23, startRestartGroup, 8);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endNode();
    ...
    private static final Modifier textVerticalPadding(Modifier modifier, boolean z, boolean z2) {
        if (!z && !z2) {
            return PaddingKt.m481paddingVpY3zN4$default(modifier, 0.0f, PlainTooltipVerticalPadding, 1, null);
        }
        return PaddingKt.m483paddingqDBjuR0$default(AlignmentLineKt.m365paddingFromBaselineVpY3zN4$default(modifier, HeightFromSubheadToTextFirstLine, 0.0f, 2, null), 0.0f, 0.0f, 0.0f, TextBottomPadding, 7, null);
    }
    ...
    static {
        float f = 4;
        TooltipAnchorPadding = Dp.m4872constructorimpl(f);
        float f2 = 24;
        TooltipMinHeight = Dp.m4872constructorimpl(f2);
        float m4872constructorimpl = Dp.m4872constructorimpl(f);
        PlainTooltipVerticalPadding = m4872constructorimpl;
        float f3 = 8;
        float m4872constructorimpl2 = Dp.m4872constructorimpl(f3);
        PlainTooltipHorizontalPadding = m4872constructorimpl2;
        PlainTooltipContentPadding = PaddingKt.m473PaddingValuesYgX7TsA(m4872constructorimpl2, m4872constructorimpl);
        RichTooltipMaxWidth = Dp.m4872constructorimpl(320);
        float f4 = 16;
        RichTooltipHorizontalPadding = Dp.m4872constructorimpl(f4);
        HeightToSubheadFirstLine = Dp.m4872constructorimpl(28);
        HeightFromSubheadToTextFirstLine = Dp.m4872constructorimpl(f2);
        TextBottomPadding = Dp.m4872constructorimpl(f4);
        ActionLabelMinHeight = Dp.m4872constructorimpl(36);
        ActionLabelBottomPadding = Dp.m4872constructorimpl(f3);
    }
}