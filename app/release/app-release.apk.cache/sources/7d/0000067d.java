...
public abstract class LazyGridMeasuredLineProvider {
    ...
    public final long m619childConstraintsJhjzzOo$foundation_release(int i, int i2) {
        int i3;
        if (i2 == 1) {
        ...
        if (this.isVertical) {
            return Constraints.Companion.m4838fixedWidthOenEA2s(coerceAtLeast);
        }
        return Constraints.Companion.m4837fixedHeightOenEA2s(coerceAtLeast);
    }

    /* renamed from: itemConstraints-OenEA2s  reason: not valid java name */
    public final long m620itemConstraintsOenEA2s(int i) {
        LazyGridSpanLayoutProvider lazyGridSpanLayoutProvider = this.spanLayoutProvider;
        return m619childConstraintsJhjzzOo$foundation_release(0, lazyGridSpanLayoutProvider.spanOf(i, lazyGridSpanLayoutProvider.getSlotsPerLine()));
    }
    ...
    public final LazyGridMeasuredLine getAndMeasure(int i) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            int m598getCurrentLineSpanimpl = GridItemSpan.m598getCurrentLineSpanimpl(lineConfiguration.getSpans().get(i4).m601unboximpl());
            LazyGridMeasuredItem m618getAndMeasure3p2s80s = this.measuredItemProvider.m618getAndMeasure3p2s80s(lineConfiguration.getFirstItemIndex() + i4, i2, m619childConstraintsJhjzzOo$foundation_release(i3, m598getCurrentLineSpanimpl));
            i3 += m598getCurrentLineSpanimpl;
            Unit unit = Unit.INSTANCE;
            lazyGridMeasuredItemArr[i4] = m618getAndMeasure3p2s80s;
        }
