...
public final class DefaultTransformableState implements TransformableState {
    ...
    public DefaultTransformableState(Function3<? super Float, ? super Offset, ? super Float, Unit> onTransformation) {
        ...
        this.transformScope = new TransformScope() { // from class: androidx.compose.foundation.gestures.DefaultTransformableState$transformScope$1
            ...
            public void mo250transformByd4ec7I(float f, long j, float f2) {
                DefaultTransformableState.this.getOnTransformation().invoke(Float.valueOf(f), Offset.m2378boximpl(j), Float.valueOf(f2));
            }
        };
