...
public final class SelectionHandleInfo {
    ...
    public static /* synthetic */ SelectionHandleInfo m889copyUv8p0NA$default(SelectionHandleInfo selectionHandleInfo, Handle handle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return selectionHandleInfo.m891copyUv8p0NA(handle, j);
    }
    ...
    public final long m890component2F1C5BW0() {
        return this.position;
    }

    /* renamed from: copy-Uv8p0NA  reason: not valid java name */
    public final SelectionHandleInfo m891copyUv8p0NA(Handle handle, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SelectionHandleInfo) {
            ...
            return this.handle == selectionHandleInfo.handle && Offset.m2386equalsimpl0(this.position, selectionHandleInfo.position);
        }
        return false;
    }
    ...
    public final long m892getPositionF1C5BW0() {
        return this.position;
    }

    public int hashCode() {
        return (this.handle.hashCode() * 31) + Offset.m2391hashCodeimpl(this.position);
    }

    public String toString() {
        return "SelectionHandleInfo(handle=" + this.handle + ", position=" + ((Object) Offset.m2397toStringimpl(this.position)) + ')';
    }
