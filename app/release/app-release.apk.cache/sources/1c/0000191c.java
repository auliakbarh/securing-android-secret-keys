...
public final class DeleteSurroundingTextCommand implements EditCommand {
    ...
    public void applyTo(EditingBuffer buffer) {
        ...
        buffer.delete$ui_text_release(Math.max(0, MathUtilsKt.subtractExactOrElse(buffer.getSelectionStart$ui_text_release(), this.lengthBeforeCursor, new Function0<Integer>() { // from class: androidx.compose.ui.text.input.DeleteSurroundingTextCommand$applyTo$start$1
