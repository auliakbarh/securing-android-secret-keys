...
public final class AndroidViewHolder$snapshotObserver$1 extends Lambda implements Function1<Function0<? extends Unit>, Unit> {
    ...
    /* renamed from: $r8$lambda$JX-oaVF9OClD3ZCS4KFD-hHwVH8 */
    public static /* synthetic */ void m5110$r8$lambda$JXoaVF9OClD3ZCS4KFDhHwVH8(Function0 function0) {
        ...
        if (this.this$0.getHandler().getLooper() == Looper.myLooper()) {
            ...
            this.this$0.getHandler().post(new Runnable() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$snapshotObserver$1$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    AndroidViewHolder$snapshotObserver$1.m5110$r8$lambda$JXoaVF9OClD3ZCS4KFDhHwVH8(Function0.this);
                }
            });
        }
    }
