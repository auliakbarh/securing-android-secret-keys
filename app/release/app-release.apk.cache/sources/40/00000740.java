...
public final class LazyStaggeredGridMeasurePolicyKt {
    ...
    public static final Function2<LazyLayoutMeasureScope, Constraints, LazyStaggeredGridMeasureResult> m664rememberStaggeredGridMeasurePolicynbWgWpA(final LazyStaggeredGridState state, final Function0<? extends LazyStaggeredGridItemProvider> itemProviderLambda, final PaddingValues contentPadding, final boolean z, final Orientation orientation, final float f, float f2, final Function2<? super Density, ? super Constraints, LazyStaggeredGridSlots> slots, Composer composer, int i) {
        ...
        Object[] objArr = {state, itemProviderLambda, contentPadding, Boolean.valueOf(z), orientation, Dp.m4870boximpl(f), Dp.m4870boximpl(f2), slots};
        ...
        if (z2 || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = (Function2) new Function2<LazyLayoutMeasureScope, Constraints, LazyStaggeredGridMeasureResult>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasurePolicyKt$rememberStaggeredGridMeasurePolicy$1$1
                ...
                public /* bridge */ /* synthetic */ LazyStaggeredGridMeasureResult invoke(LazyLayoutMeasureScope lazyLayoutMeasureScope, Constraints constraints) {
                    return m665invoke0kLqBqw(lazyLayoutMeasureScope, constraints.m4834unboximpl());
                }
                ...
                public final LazyStaggeredGridMeasureResult m665invoke0kLqBqw(LazyLayoutMeasureScope lazyLayoutMeasureScope, long j) {
                    ...
                    CheckScrollableContainerConstraintsKt.m186checkScrollableContainerConstraintsK40F9xA(j, Orientation.this);
                    LazyStaggeredGridSlots invoke = slots.invoke(lazyLayoutMeasureScope, Constraints.m4816boximpl(j));
                    ...
                    int i3 = lazyLayoutMeasureScope.mo318roundToPx0680j_4(beforePadding);
                    ...
                    int i4 = lazyLayoutMeasureScope.mo318roundToPx0680j_4(afterPadding);
                    ...
                    int i5 = lazyLayoutMeasureScope.mo318roundToPx0680j_4(startPadding);
                    int m4827getMaxHeightimpl = ((z3 ? Constraints.m4827getMaxHeightimpl(j) : Constraints.m4828getMaxWidthimpl(j)) - i3) - i4;
                    if (z3) {
                    ...
                    int i6 = lazyLayoutMeasureScope.mo318roundToPx0680j_4(Dp.m4872constructorimpl(PaddingKt.calculateStartPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection()) + PaddingKt.calculateEndPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection())));
                    PaddingValues paddingValues2 = contentPadding;
                    LazyStaggeredGridMeasureResult m663measureStaggeredGriddSVRQoE = LazyStaggeredGridMeasureKt.m663measureStaggeredGriddSVRQoE(lazyLayoutMeasureScope, state, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(invoke2, state.getPinnedItems$foundation_release(), state.getBeyondBoundsInfo$foundation_release()), invoke2, invoke, Constraints.m4819copyZbe2FdA$default(j, ConstraintsKt.m4842constrainWidthK40F9xA(j, i6), 0, ConstraintsKt.m4841constrainHeightK40F9xA(j, lazyLayoutMeasureScope.mo318roundToPx0680j_4(Dp.m4872constructorimpl(paddingValues2.mo432calculateTopPaddingD9Ej5fM() + paddingValues2.mo429calculateBottomPaddingD9Ej5fM()))), 0, 10, null), z3, z, j2, m4827getMaxHeightimpl, lazyLayoutMeasureScope.mo318roundToPx0680j_4(f), i3, i4);
                    state.applyMeasureResult$foundation_release(m663measureStaggeredGriddSVRQoE);
    ...
    public static final float startPadding(PaddingValues paddingValues, Orientation orientation, LayoutDirection layoutDirection) {
        ...
        if (i != 1) {
            if (i == 2) {
                return paddingValues.mo432calculateTopPaddingD9Ej5fM();
            }
    ...
    public static final float beforePadding(PaddingValues paddingValues, Orientation orientation, boolean z, LayoutDirection layoutDirection) {
        int i = WhenMappings.$EnumSwitchMapping$0[orientation.ordinal()];
        if (i == 1) {
            return z ? paddingValues.mo429calculateBottomPaddingD9Ej5fM() : paddingValues.mo432calculateTopPaddingD9Ej5fM();
        } else if (i == 2) {
            if (z) {
    ...
    public static final float afterPadding(PaddingValues paddingValues, Orientation orientation, boolean z, LayoutDirection layoutDirection) {
        int i = WhenMappings.$EnumSwitchMapping$0[orientation.ordinal()];
        if (i == 1) {
            return z ? paddingValues.mo432calculateTopPaddingD9Ej5fM() : paddingValues.mo429calculateBottomPaddingD9Ej5fM();
        } else if (i == 2) {
            if (z) {
                return PaddingKt.calculateStartPadding(paddingValues, layoutDirection);
            }
