...
public final class NoOpOverscrollEffect implements OverscrollEffect {
    ...
    public long mo153applyToScrollRhakbz0(long j, int i, Function1<? super Offset, Offset> performScroll) {
        Intrinsics.checkNotNullParameter(performScroll, "performScroll");
        return performScroll.invoke(Offset.m2378boximpl(j)).m2399unboximpl();
    }

    @Override // androidx.compose.foundation.OverscrollEffect
    /* renamed from: applyToFling-BMRW4eQ */
    public Object mo152applyToFlingBMRW4eQ(long j, Function2<? super Velocity, ? super Continuation<? super Velocity>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        Object invoke = function2.invoke(Velocity.m5088boximpl(j), continuation);
