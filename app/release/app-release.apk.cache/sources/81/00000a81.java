...
public final class RippleAnimationKt {
    private static final float BoundedRippleExtraRadius = Dp.m4872constructorimpl(10);
    ...
    public static final float m960getRippleStartRadiusuvyYCjk(long j) {
        return Math.max(Size.m2458getWidthimpl(j), Size.m2455getHeightimpl(j)) * 0.3f;
    }

    /* renamed from: getRippleEndRadius-cSwnlzA  reason: not valid java name */
    public static final float m959getRippleEndRadiuscSwnlzA(Density getRippleEndRadius, boolean z, long j) {
        Intrinsics.checkNotNullParameter(getRippleEndRadius, "$this$getRippleEndRadius");
        float m2387getDistanceimpl = Offset.m2387getDistanceimpl(OffsetKt.Offset(Size.m2458getWidthimpl(j), Size.m2455getHeightimpl(j))) / 2.0f;
        return z ? m2387getDistanceimpl + getRippleEndRadius.mo324toPx0680j_4(BoundedRippleExtraRadius) : m2387getDistanceimpl;
    }
}