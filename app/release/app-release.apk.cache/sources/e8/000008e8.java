...
public class StaticTextSelectionParams {
    ...
    public boolean getShouldClip() {
        ...
        TextLayoutResult textLayoutResult = this.textLayoutResult;
        TextOverflow m4803boximpl = (textLayoutResult == null || (layoutInput = textLayoutResult.getLayoutInput()) == null) ? null : TextOverflow.m4803boximpl(layoutInput.m4372getOverflowgIe3tQ8());
        int m4815getVisiblegIe3tQ8 = TextOverflow.Companion.m4815getVisiblegIe3tQ8();
        if (m4803boximpl == null) {
            return false;
        }
        return TextOverflow.m4806equalsimpl0(m4803boximpl.m4809unboximpl(), m4815getVisiblegIe3tQ8);
    }
