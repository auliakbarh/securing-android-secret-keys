...
public final class TextLayoutResultProxy {
    ...
    public static /* synthetic */ int m832getOffsetForPosition3MmeM6k$default(TextLayoutResultProxy textLayoutResultProxy, long j, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        return textLayoutResultProxy.m834getOffsetForPosition3MmeM6k(j, z);
    }

    /* renamed from: getOffsetForPosition-3MmeM6k  reason: not valid java name */
    public final int m834getOffsetForPosition3MmeM6k(long j, boolean z) {
        if (z) {
            j = m831coercedInVisibleBoundsOfInputTextMKHz9U(j);
        }
        return this.value.m4375getOffsetForPositionk4lQ0M(m833relativeToInputTextMKHz9U(j));
    }

    public final int getLineForVerticalPosition(float f) {
        return this.value.getLineForVerticalPosition(Offset.m2390getYimpl(m833relativeToInputTextMKHz9U(m831coercedInVisibleBoundsOfInputTextMKHz9U(OffsetKt.Offset(0.0f, f)))));
    }
    ...
    public final boolean m835isPositionOnTextk4lQ0M(long j) {
        long m833relativeToInputTextMKHz9U = m833relativeToInputTextMKHz9U(m831coercedInVisibleBoundsOfInputTextMKHz9U(j));
        int lineForVerticalPosition = this.value.getLineForVerticalPosition(Offset.m2390getYimpl(m833relativeToInputTextMKHz9U));
        return Offset.m2389getXimpl(m833relativeToInputTextMKHz9U) >= this.value.getLineLeft(lineForVerticalPosition) && Offset.m2389getXimpl(m833relativeToInputTextMKHz9U) <= this.value.getLineRight(lineForVerticalPosition);
    }

    /* renamed from: relativeToInputText-MK-Hz9U  reason: not valid java name */
    private final long m833relativeToInputTextMKHz9U(long j) {
        Offset offset;
        ...
        if (layoutCoordinates != null) {
            ...
            if (layoutCoordinates2 != null) {
                offset = Offset.m2378boximpl((layoutCoordinates.isAttached() && layoutCoordinates2.isAttached()) ? layoutCoordinates.mo3873localPositionOfR5De75A(layoutCoordinates2, j) : j);
            } else {
                offset = null;
            }
            return offset != null ? offset.m2399unboximpl() : j;
        }
        return j;
    }
    ...
    */
    private final long m831coercedInVisibleBoundsOfInputTextMKHz9U(long r6) {
        /*
            r5 = this;
        ...
        L1e:
            ...
            androidx.compose.ui.geometry.Rect r2 = r0.getZero()
        L24:
            long r6 = androidx.compose.foundation.text.TextLayoutResultProxyKt.m836access$coerceIn3MmeM6k(r6, r2)
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.TextLayoutResultProxy.m831coercedInVisibleBoundsOfInputTextMKHz9U(long):long");
    }
}