...
public final class SnackbarHostKt {
    ...
    public static final /* synthetic */ void access$FadeInFadeOutWithScale(SnackbarData snackbarData, Modifier modifier, Function3 function3, Composer composer, int i, int i2) {
        FadeInFadeOutWithScale(snackbarData, modifier, function3, composer, i, i2);
    }
    ...
    public static final void SnackbarHost(final SnackbarHostState hostState, Modifier modifier, Function3<? super SnackbarData, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            if (i5 != 0) {
                function3 = ComposableSingletons$SnackbarHostKt.INSTANCE.m1124getLambda1$material3_release();
            }
    ...
    /* JADX WARN: Removed duplicated region for block: B:157:0x0247 A[LOOP:2: B:155:0x0241->B:157:0x0247, LOOP_END] */
