...
public final class OutlineKt {
    public static final void addOutline(Path path, Outline outline) {
        ...
        if (outline instanceof Outline.Rectangle) {
            ...
            Path.m2892addPathUv8p0NA$default(path, ((Outline.Generic) outline).getPath(), 0L, 2, null);
        }
    }

    /* renamed from: drawOutline-hn5TExg$default */
    public static /* synthetic */ void m2879drawOutlinehn5TExg$default(DrawScope drawScope, Outline outline, Brush brush, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            f = 1.0f;
        }
        float f2 = f;
        ...
        if ((i2 & 32) != 0) {
            i = DrawScope.Companion.m3172getDefaultBlendMode0nO6VwU();
        }
        m2878drawOutlinehn5TExg(drawScope, outline, brush, f2, drawStyle2, colorFilter2, i);
    }
    ...
    public static final void drawOutline(Canvas canvas, Outline outline, Paint paint) {
        ...
        if (outline instanceof Outline.Rectangle) {
            ...
            if (roundRectPath$ui_graphics_release != null) {
                ...
                canvas.drawRoundRect(rounded.getRoundRect().getLeft(), rounded.getRoundRect().getTop(), rounded.getRoundRect().getRight(), rounded.getRoundRect().getBottom(), CornerRadius.m2364getXimpl(rounded.getRoundRect().m2437getBottomLeftCornerRadiuskKHJgLs()), CornerRadius.m2365getYimpl(rounded.getRoundRect().m2437getBottomLeftCornerRadiuskKHJgLs()), paint);
            }
        } else if (!(outline instanceof Outline.Generic)) {
            throw new NoWhenBranchMatchedException();
        } else {
    ...
    public static final boolean hasSameCornerRadius(RoundRect roundRect) {
        return ((CornerRadius.m2364getXimpl(roundRect.m2437getBottomLeftCornerRadiuskKHJgLs()) > CornerRadius.m2364getXimpl(roundRect.m2438getBottomRightCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m2364getXimpl(roundRect.m2437getBottomLeftCornerRadiuskKHJgLs()) == CornerRadius.m2364getXimpl(roundRect.m2438getBottomRightCornerRadiuskKHJgLs()) ? 0 : -1)) == 0 && (CornerRadius.m2364getXimpl(roundRect.m2438getBottomRightCornerRadiuskKHJgLs()) > CornerRadius.m2364getXimpl(roundRect.m2440getTopRightCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m2364getXimpl(roundRect.m2438getBottomRightCornerRadiuskKHJgLs()) == CornerRadius.m2364getXimpl(roundRect.m2440getTopRightCornerRadiuskKHJgLs()) ? 0 : -1)) == 0 && (CornerRadius.m2364getXimpl(roundRect.m2440getTopRightCornerRadiuskKHJgLs()) > CornerRadius.m2364getXimpl(roundRect.m2439getTopLeftCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m2364getXimpl(roundRect.m2440getTopRightCornerRadiuskKHJgLs()) == CornerRadius.m2364getXimpl(roundRect.m2439getTopLeftCornerRadiuskKHJgLs()) ? 0 : -1)) == 0) && ((CornerRadius.m2365getYimpl(roundRect.m2437getBottomLeftCornerRadiuskKHJgLs()) > CornerRadius.m2365getYimpl(roundRect.m2438getBottomRightCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m2365getYimpl(roundRect.m2437getBottomLeftCornerRadiuskKHJgLs()) == CornerRadius.m2365getYimpl(roundRect.m2438getBottomRightCornerRadiuskKHJgLs()) ? 0 : -1)) == 0 && (CornerRadius.m2365getYimpl(roundRect.m2438getBottomRightCornerRadiuskKHJgLs()) > CornerRadius.m2365getYimpl(roundRect.m2440getTopRightCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m2365getYimpl(roundRect.m2438getBottomRightCornerRadiuskKHJgLs()) == CornerRadius.m2365getYimpl(roundRect.m2440getTopRightCornerRadiuskKHJgLs()) ? 0 : -1)) == 0 && (CornerRadius.m2365getYimpl(roundRect.m2440getTopRightCornerRadiuskKHJgLs()) > CornerRadius.m2365getYimpl(roundRect.m2439getTopLeftCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m2365getYimpl(roundRect.m2440getTopRightCornerRadiuskKHJgLs()) == CornerRadius.m2365getYimpl(roundRect.m2439getTopLeftCornerRadiuskKHJgLs()) ? 0 : -1)) == 0);
    }

    /* renamed from: drawOutline-wDX37Ww */
    public static final void m2880drawOutlinewDX37Ww(DrawScope drawOutline, Outline outline, long j, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        Path path;
        ...
        if (outline instanceof Outline.Rectangle) {
            ...
            drawOutline.mo3088drawRectnJ9OG0(j, topLeft(rect), size(rect), f, style, colorFilter, i);
            return;
        }
        if (outline instanceof Outline.Rounded) {
            ...
            if (path == null) {
                ...
                drawOutline.mo3090drawRoundRectuAw5IA(j, topLeft(roundRect), size(roundRect), CornerRadiusKt.CornerRadius$default(CornerRadius.m2364getXimpl(roundRect.m2437getBottomLeftCornerRadiuskKHJgLs()), 0.0f, 2, null), style, f, colorFilter, i);
                return;
            }
        } else if (!(outline instanceof Outline.Generic)) {
            throw new NoWhenBranchMatchedException();
        ...
        drawOutline.mo3084drawPathLG529CI(path, j, f, style, colorFilter, i);
    }

    /* renamed from: drawOutline-hn5TExg */
    public static final void m2878drawOutlinehn5TExg(DrawScope drawOutline, Outline outline, Brush brush, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        Path path;
        Intrinsics.checkNotNullParameter(drawOutline, "$this$drawOutline");
        Intrinsics.checkNotNullParameter(outline, "outline");
        ...
        if (outline instanceof Outline.Rectangle) {
            Rect rect = ((Outline.Rectangle) outline).getRect();
            drawOutline.mo3087drawRectAsUm42w(brush, topLeft(rect), size(rect), f, style, colorFilter, i);
            return;
        }
        if (outline instanceof Outline.Rounded) {
            Outline.Rounded rounded = (Outline.Rounded) outline;
            ...
            if (path == null) {
                RoundRect roundRect = rounded.getRoundRect();
                drawOutline.mo3089drawRoundRectZuiqVtQ(brush, topLeft(roundRect), size(roundRect), CornerRadiusKt.CornerRadius$default(CornerRadius.m2364getXimpl(roundRect.m2437getBottomLeftCornerRadiuskKHJgLs()), 0.0f, 2, null), f, style, colorFilter, i);
                return;
            }
        } else if (!(outline instanceof Outline.Generic)) {
            throw new NoWhenBranchMatchedException();
        ...
        drawOutline.mo3083drawPathGBMwjPU(path, brush, f, style, colorFilter, i);
    }
}