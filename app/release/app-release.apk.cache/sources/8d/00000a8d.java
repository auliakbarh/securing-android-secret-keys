...
public final class StateLayer {
    ...
    public final void m968drawStateLayerH2RKhps(DrawScope drawStateLayer, float f, long j) {
        float f2;
        Intrinsics.checkNotNullParameter(drawStateLayer, "$this$drawStateLayer");
        if (Float.isNaN(f)) {
            f2 = RippleAnimationKt.m959getRippleEndRadiuscSwnlzA(drawStateLayer, this.bounded, drawStateLayer.mo3171getSizeNHjbRc());
        } else {
            f2 = drawStateLayer.mo324toPx0680j_4(f);
        }
        float f3 = f2;
        float floatValue = this.animatedAlpha.getValue().floatValue();
        if (floatValue > 0.0f) {
            long m2627copywmQWz5c$default = Color.m2627copywmQWz5c$default(j, floatValue, 0.0f, 0.0f, 0.0f, 14, null);
            if (!this.bounded) {
                DrawScope.m3153drawCircleVaOC9Bg$default(drawStateLayer, m2627copywmQWz5c$default, f3, 0L, 0.0f, null, null, 0, 124, null);
                return;
            }
            float m2458getWidthimpl = Size.m2458getWidthimpl(drawStateLayer.mo3171getSizeNHjbRc());
            float m2455getHeightimpl = Size.m2455getHeightimpl(drawStateLayer.mo3171getSizeNHjbRc());
