...
public final class InnerNodeCoordinator extends NodeCoordinator {
    ...
    private final class LookaheadDelegateImpl extends LookaheadDelegate {
        ...
        public Placeable mo3865measureBRTryo0(long j) {
            ...
            lookaheadDelegateImpl.m3921setMeasurementConstraintsBRTryo0(j);
            MutableVector<LayoutNode> mutableVector = getLayoutNode().get_children$ui_release();
            int size = mutableVector.getSize();
            if (size <= 0) {
                lookaheadDelegateImpl.set_measureResult(getLayoutNode().getMeasurePolicy().mo10measure3p2s80s(this, getLayoutNode().getChildLookaheadMeasurables$ui_release(), j));
    ...
    public Placeable mo3865measureBRTryo0(long j) {
        ...
        int size = mutableVector.getSize();
        if (size <= 0) {
            setMeasureResult$ui_release(getLayoutNode().getMeasurePolicy().mo10measure3p2s80s(this, getLayoutNode().getChildMeasurables$ui_release(), j));
            onMeasured();
            return this;
        }
        LayoutNode[] content = mutableVector.getContent();
    ...
    public void mo3866placeAtf8xVGno(long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
        super.mo3866placeAtf8xVGno(j, f, function1);
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void mo3999hitTestChildYqVAtuI(androidx.compose.ui.node.NodeCoordinator.HitTestSource r18, long r19, androidx.compose.ui.node.HitTestResult r21, boolean r22, boolean r23) {
        /*
            r17 = this;
            r0 = r17
            r8 = r18
            ...
            r3 = 0
            if (r1 == 0) goto L40
            boolean r1 = r0.m4074withinLayerBoundsk4lQ0M(r9)
            if (r1 == 0) goto L28
            r12 = r23
        L26:
            r3 = r2
        ...
        L28:
            if (r22 == 0) goto L40
            long r4 = r17.m4065getMinimumTouchTargetSizeNHjbRc()
            float r1 = r0.m4062distanceInMinimumTouchTargettz77jQw(r9, r4)
        ...
        L5c:
            ...
            r6 = r22
            r7 = r12
            r1.mo4075childHitTestYqVAtuI(r2, r3, r5, r6, r7)
        ...
        L91:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.node.InnerNodeCoordinator.mo3999hitTestChildYqVAtuI(androidx.compose.ui.node.NodeCoordinator$HitTestSource, long, androidx.compose.ui.node.HitTestResult, boolean, boolean):void");
    }
    ...
    static {
        ...
        Paint.mo2509setColor8_81llA(Color.Companion.m2662getRed0d7_KjU());
