...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public final long m6388getFirstsVKNKU() {
        return this.first;
    }

    /* renamed from: getLast-s-VKNKU  reason: not valid java name */
    public final long m6389getLastsVKNKU() {
        return this.last;
    }
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m6364getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return (((((int) ULong.m5330constructorimpl(j ^ ULong.m5330constructorimpl(j >>> 32))) * 31) + ((int) ULong.m5330constructorimpl(j2 ^ ULong.m5330constructorimpl(j2 >>> 32)))) * 31) + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            append = new StringBuilder().append((Object) ULong.m5376toStringimpl(this.first)).append("..").append((Object) ULong.m5376toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            append = new StringBuilder().append((Object) ULong.m5376toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m5376toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m6390fromClosedRange7ftBX0g(long j, long j2, long j3) {
