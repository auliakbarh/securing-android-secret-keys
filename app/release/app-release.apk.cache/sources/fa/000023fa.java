...
public interface TimeMark {
    ...
    TimeMark mo6472minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo6474plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m6619plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m6618minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo6474plusLRDsOJo(Duration.m6534unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m6514isNegativeimpl(timeMark.mo6471elapsedNowUwyO8pc());
        }
