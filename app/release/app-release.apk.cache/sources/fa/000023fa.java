...
public interface TimeMark {
    ...
    TimeMark mo6475minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo6477plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m6622plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m6621minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo6477plusLRDsOJo(Duration.m6537unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m6517isNegativeimpl(timeMark.mo6474elapsedNowUwyO8pc());
        }
