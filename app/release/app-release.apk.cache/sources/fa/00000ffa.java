...
public final class NavigationDrawerTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m4872constructorimpl((float) 56.0d);
    private static final ShapeKeyTokens ActiveIndicatorShape = ShapeKeyTokens.CornerFull;
    private static final float ActiveIndicatorWidth = Dp.m4872constructorimpl((float) 336.0d);
    ...
    private static final float ContainerWidth = Dp.m4872constructorimpl((float) 360.0d);
    ...
    private static final float ModalContainerElevation = ElevationTokens.INSTANCE.m1815getLevel1D9Ej5fM();
    private static final float StandardContainerElevation = ElevationTokens.INSTANCE.m1814getLevel0D9Ej5fM();
    ...
    public final float m1967getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m1968getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m1969getContainerWidthD9Ej5fM() {
    ...
    public final float m1971getModalContainerElevationD9Ej5fM() {
        return ModalContainerElevation;
    }

    /* renamed from: getStandardContainerElevation-D9Ej5fM  reason: not valid java name */
    public final float m1972getStandardContainerElevationD9Ej5fM() {
