        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new GridSlotCache(new Function2<Density, Constraints, LazyGridSlots>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridDslKt$rememberColumnWidthSums$1$1
                ...
                public /* bridge */ /* synthetic */ LazyGridSlots invoke(Density density, Constraints constraints) {
                    return m607invoke0kLqBqw(density, constraints.m4834unboximpl());
                }

                /* renamed from: invoke-0kLqBqw  reason: not valid java name */
                public final LazyGridSlots m607invoke0kLqBqw(Density $receiver, long j) {
                    ...
                    int[] intArray = CollectionsKt.toIntArray(gridCells2.calculateCrossAxisCellSizes($receiver, m4828getMaxWidthimpl, $receiver.mo318roundToPx0680j_4(horizontal2.mo396getSpacingD9Ej5fM())));
                    int[] iArr = new int[intArray.length];
                    horizontal2.arrange($receiver, m4828getMaxWidthimpl, intArray, LayoutDirection.Ltr, iArr);
    ...
    private static final Function2<Density, Constraints, LazyGridSlots> rememberRowHeightSums(final GridCells gridCells, final Arrangement.Vertical vertical, final PaddingValues paddingValues, Composer composer, int i) {
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new GridSlotCache(new Function2<Density, Constraints, LazyGridSlots>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridDslKt$rememberRowHeightSums$1$1
                ...
                @Override // kotlin.jvm.functions.Function2
                public /* bridge */ /* synthetic */ LazyGridSlots invoke(Density density, Constraints constraints) {
                    return m608invoke0kLqBqw(density, constraints.m4834unboximpl());
                }
                ...
                public final LazyGridSlots m608invoke0kLqBqw(Density $receiver, long j) {
                    ...
                    int[] intArray = CollectionsKt.toIntArray(gridCells2.calculateCrossAxisCellSizes($receiver, m4827getMaxHeightimpl, $receiver.mo318roundToPx0680j_4(vertical2.mo396getSpacingD9Ej5fM())));
                    int[] iArr = new int[intArray.length];
                    vertical2.arrange($receiver, m4827getMaxHeightimpl, intArray, iArr);
                    return new LazyGridSlots(intArray, iArr);
                }
            });
            composer.updateRememberedValue(rememberedValue);
