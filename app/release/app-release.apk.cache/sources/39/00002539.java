...
final class ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1<E, R> extends SuspendLambda implements Function2<ChannelResult<? extends E>, Continuation<? super R>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m6684invokeWpGqRn0(((ChannelResult) obj).m6680unboximpl(), (Continuation) obj2);
    }

    /* renamed from: invoke-WpGqRn0  reason: not valid java name */
    public final Object m6684invokeWpGqRn0(Object obj, Continuation<? super R> continuation) {
        return ((ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1) create(ChannelResult.m6668boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Object m6680unboximpl = ((ChannelResult) this.L$0).m6680unboximpl();
            Throwable m6672exceptionOrNullimpl = ChannelResult.m6672exceptionOrNullimpl(m6680unboximpl);
            if (m6672exceptionOrNullimpl != null) {
                throw m6672exceptionOrNullimpl;
            }
            Object m6673getOrNullimpl = ChannelResult.m6673getOrNullimpl(m6680unboximpl);
            this.label = 1;
            obj = this.$block.invoke(m6673getOrNullimpl, this);
