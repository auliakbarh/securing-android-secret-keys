...
final class ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1<E, R> extends SuspendLambda implements Function2<ChannelResult<? extends E>, Continuation<? super R>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m6687invokeWpGqRn0(((ChannelResult) obj).m6683unboximpl(), (Continuation) obj2);
    }

    /* renamed from: invoke-WpGqRn0  reason: not valid java name */
    public final Object m6687invokeWpGqRn0(Object obj, Continuation<? super R> continuation) {
        return ((ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1) create(ChannelResult.m6671boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Object m6683unboximpl = ((ChannelResult) this.L$0).m6683unboximpl();
            Throwable m6675exceptionOrNullimpl = ChannelResult.m6675exceptionOrNullimpl(m6683unboximpl);
            if (m6675exceptionOrNullimpl != null) {
                throw m6675exceptionOrNullimpl;
            }
            Object m6676getOrNullimpl = ChannelResult.m6676getOrNullimpl(m6683unboximpl);
            this.label = 1;
            obj = this.$block.invoke(m6676getOrNullimpl, this);
