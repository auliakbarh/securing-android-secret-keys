...
public final class SelectionManagerKt {
    ...
    private static final long calculateSelectionMagnifierCenterAndroid_O0kMr_c$getMagnifierCenter(SelectionManager selectionManager, long j, Selection.AnchorInfo anchorInfo, boolean z) {
        ...
        if (anchorSelectable$foundation_release != null && (containerLayoutCoordinates = selectionManager.getContainerLayoutCoordinates()) != null && (layoutCoordinates = anchorSelectable$foundation_release.getLayoutCoordinates()) != null) {
            ...
            Offset m914getCurrentDragPosition_m7T9E = selectionManager.m914getCurrentDragPosition_m7T9E();
            Intrinsics.checkNotNull(m914getCurrentDragPosition_m7T9E);
            float m2389getXimpl = Offset.m2389getXimpl(layoutCoordinates.mo3873localPositionOfR5De75A(containerLayoutCoordinates, m914getCurrentDragPosition_m7T9E.m2399unboximpl()));
            long mo875getRangeOfLineContainingjx7JFs = anchorSelectable$foundation_release.mo875getRangeOfLineContainingjx7JFs(offset);
            Rect boundingBox = anchorSelectable$foundation_release.getBoundingBox(TextRange.m4401getMinimpl(mo875getRangeOfLineContainingjx7JFs));
            Rect boundingBox2 = anchorSelectable$foundation_release.getBoundingBox(RangesKt.coerceAtLeast(TextRange.m4400getMaximpl(mo875getRangeOfLineContainingjx7JFs) - 1, TextRange.m4401getMinimpl(mo875getRangeOfLineContainingjx7JFs)));
            float coerceIn = RangesKt.coerceIn(m2389getXimpl, Math.min(boundingBox.getLeft(), boundingBox2.getLeft()), Math.max(boundingBox.getRight(), boundingBox2.getRight()));
            if (Math.abs(m2389getXimpl - coerceIn) > IntSize.m5032getWidthimpl(j) / 2) {
                return Offset.Companion.m2404getUnspecifiedF1C5BW0();
            }
            return containerLayoutCoordinates.mo3873localPositionOfR5De75A(layoutCoordinates, OffsetKt.Offset(coerceIn, Offset.m2390getYimpl(anchorSelectable$foundation_release.getBoundingBox(offset).m2419getCenterF1C5BW0())));
        }
        return Offset.Companion.m2404getUnspecifiedF1C5BW0();
    }

    /* renamed from: calculateSelectionMagnifierCenterAndroid-O0kMr_c  reason: not valid java name */
    public static final long m925calculateSelectionMagnifierCenterAndroidO0kMr_c(SelectionManager manager, long j) {
    ...
    public static final Rect visibleBounds(LayoutCoordinates layoutCoordinates) {
        ...
        return RectKt.m2427Rect0a9Yr6o(layoutCoordinates.mo3877windowToLocalMKHz9U(boundsInWindow.m2424getTopLeftF1C5BW0()), layoutCoordinates.mo3877windowToLocalMKHz9U(boundsInWindow.m2418getBottomRightF1C5BW0()));
    }

    /* renamed from: containsInclusive-Uv8p0NA  reason: not valid java name */
    public static final boolean m926containsInclusiveUv8p0NA(Rect containsInclusive, long j) {
