...
public final class ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public long mo333onPreScrollOzD1aCk(long j, int i) {
        if (!this.this$0.getCanScroll().invoke().booleanValue() || Offset.m2390getYimpl(j) > 0.0f) {
            return Offset.Companion.m2405getZeroF1C5BW0();
        }
        float heightOffset = this.this$0.getState().getHeightOffset();
        this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m2390getYimpl(j));
        if (heightOffset != this.this$0.getState().getHeightOffset()) {
            return Offset.m2383copydBAh8RU$default(j, 0.0f, 0.0f, 2, null);
        }
        return Offset.Companion.m2405getZeroF1C5BW0();
    }
    ...
    public long mo332onPostScrollDzOQY0M(long j, long j2, int i) {
        if (this.this$0.getCanScroll().invoke().booleanValue()) {
            ...
            state.setContentOffset(state.getContentOffset() + Offset.m2390getYimpl(j));
            if (Offset.m2390getYimpl(j2) < 0.0f || Offset.m2390getYimpl(j) < 0.0f) {
                float heightOffset = this.this$0.getState().getHeightOffset();
                this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m2390getYimpl(j));
                return OffsetKt.Offset(0.0f, this.this$0.getState().getHeightOffset() - heightOffset);
            }
            if (Offset.m2390getYimpl(j) == 0.0f && Offset.m2390getYimpl(j2) > 0.0f) {
                this.this$0.getState().setContentOffset(0.0f);
            }
            if (Offset.m2390getYimpl(j2) > 0.0f) {
                float heightOffset2 = this.this$0.getState().getHeightOffset();
                this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m2390getYimpl(j2));
    ...
    */
    public java.lang.Object mo331onPostFlingRZ2iAVY(long r10, long r12, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r14) {
        /*
            r9 = this;
        ...
        L41:
            ...
            r4 = r12
            r6 = r0
            java.lang.Object r14 = super.mo331onPostFlingRZ2iAVY(r2, r4, r6)
            if (r14 != r7) goto L55
            return r7
        L55:
            r10 = r9
        L56:
            ...
            float r12 = androidx.compose.ui.unit.Velocity.m5098getYimpl(r12)
        ...
        L81:
            androidx.compose.ui.unit.Velocity r14 = (androidx.compose.ui.unit.Velocity) r14
            long r12 = r14.m5106unboximpl()
            long r10 = androidx.compose.ui.unit.Velocity.m5101plusAH228Gc(r10, r12)
            androidx.compose.ui.unit.Velocity r10 = androidx.compose.ui.unit.Velocity.m5088boximpl(r10)
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1.mo331onPostFlingRZ2iAVY(long, long, kotlin.coroutines.Continuation):java.lang.Object");
    }
}