...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m3274getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.Companion.m2974getButtKaPHkGw();
        }
        return m3273getStrokeLineCapCSYIeUk(i, i2);
    }

    /* renamed from: getStrokeLineCap-CSYIeUk  reason: not valid java name */
    private static final int m3273getStrokeLineCapCSYIeUk(int i, int i2) {
        if (i != 0) {
            if (i != 1) {
                return i != 2 ? i2 : StrokeCap.Companion.m2976getSquareKaPHkGw();
            }
            return StrokeCap.Companion.m2975getRoundKaPHkGw();
        }
        return StrokeCap.Companion.m2974getButtKaPHkGw();
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA$default  reason: not valid java name */
    static /* synthetic */ int m3276getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.Companion.m2985getMiterLxFBmk8();
        }
        return m3275getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA  reason: not valid java name */
    private static final int m3275getStrokeLineJoinkLtJ_vA(int i, int i2) {
        if (i != 0) {
            if (i != 1) {
                return i != 2 ? i2 : StrokeJoin.Companion.m2984getBevelLxFBmk8();
            }
            return StrokeJoin.Companion.m2986getRoundLxFBmk8();
        }
        return StrokeJoin.Companion.m2985getMiterLxFBmk8();
    }
    ...
    public static final int parseCurrentVectorNode(AndroidVectorParser androidVectorParser, Resources res, AttributeSet attrs, Resources.Theme theme, ImageVector.Builder builder, int i) {
        ...
        if (eventType == 2) {
            ...
            return i;
        } else if (eventType == 3 && Intrinsics.areEqual(SHAPE_GROUP, androidVectorParser.getXmlParser().getName())) {
            int i2 = i + 1;
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser androidVectorParser, Resources res, Resources.Theme theme, AttributeSet attrs) {
        long m2664getUnspecified0d7_KjU;
        int m2570getSrcIn0nO6VwU;
        Intrinsics.checkNotNullParameter(androidVectorParser, "<this>");
        Intrinsics.checkNotNullParameter(res, "res");
        Intrinsics.checkNotNullParameter(attrs, "attrs");
        ...
        if (namedFloat > 0.0f) {
            ...
            if (obtainAttributes.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
                ...
                if (typedValue.type == 2) {
                    m2664getUnspecified0d7_KjU = Color.Companion.m2664getUnspecified0d7_KjU();
                } else {
                    ...
                    if (namedColorStateList != null) {
                        m2664getUnspecified0d7_KjU = ColorKt.Color(namedColorStateList.getDefaultColor());
                    } else {
                        m2664getUnspecified0d7_KjU = Color.Companion.m2664getUnspecified0d7_KjU();
                    }
                }
            ...
            long j = m2664getUnspecified0d7_KjU;
            ...
            if (i == -1) {
                m2570getSrcIn0nO6VwU = BlendMode.Companion.m2570getSrcIn0nO6VwU();
            } else if (i == 3) {
                m2570getSrcIn0nO6VwU = BlendMode.Companion.m2572getSrcOver0nO6VwU();
            } else if (i == 5) {
                m2570getSrcIn0nO6VwU = BlendMode.Companion.m2570getSrcIn0nO6VwU();
            } else if (i == 9) {
                m2570getSrcIn0nO6VwU = BlendMode.Companion.m2569getSrcAtop0nO6VwU();
            } else {
                switch (i) {
                    case 14:
                        m2570getSrcIn0nO6VwU = BlendMode.Companion.m2561getModulate0nO6VwU();
                        break;
                    case 15:
                        m2570getSrcIn0nO6VwU = BlendMode.Companion.m2566getScreen0nO6VwU();
                        break;
                    case 16:
                        m2570getSrcIn0nO6VwU = BlendMode.Companion.m2564getPlus0nO6VwU();
                        break;
                    default:
                        m2570getSrcIn0nO6VwU = BlendMode.Companion.m2570getSrcIn0nO6VwU();
                        break;
            ...
            int i2 = m2570getSrcIn0nO6VwU;
            float m4872constructorimpl = Dp.m4872constructorimpl(dimension / res.getDisplayMetrics().density);
            float m4872constructorimpl2 = Dp.m4872constructorimpl(dimension2 / res.getDisplayMetrics().density);
            obtainAttributes.recycle();
            return new ImageVector.Builder(null, m4872constructorimpl, m4872constructorimpl2, namedFloat, namedFloat2, j, i2, namedBoolean, 1, null);
        }
    ...
    public static final void parsePath(AndroidVectorParser androidVectorParser, Resources res, Resources.Theme theme, AttributeSet attrs, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int m3273getStrokeLineCapCSYIeUk = m3273getStrokeLineCapCSYIeUk(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineCap", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.Companion.m2974getButtKaPHkGw());
        int m3275getStrokeLineJoinkLtJ_vA = m3275getStrokeLineJoinkLtJ_vA(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineJoin", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.Companion.m2984getBevelLxFBmk8());
        ...
        builder.m3253addPathoIyEayM(addPathNodes, namedInt == 0 ? companion.m2905getNonZeroRgk1Os() : companion.m2904getEvenOddRgk1Os(), str, obtainBrushFromComplexColor, namedFloat, obtainBrushFromComplexColor2, namedFloat3, namedFloat4, m3273getStrokeLineCapCSYIeUk, m3275getStrokeLineJoinkLtJ_vA, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
    }
