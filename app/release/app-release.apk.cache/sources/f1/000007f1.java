...
public final class AndroidCursorHandle_androidKt {
    ...
    public static final void m735CursorHandleULxng0E(final long j, final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        final int i2;
        ...
        if ((i2 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            AndroidSelectionHandles_androidKt.m868HandlePopupULxng0E(j, HandleReferencePoint.TopMiddle, ComposableLambdaKt.composableLambda(startRestartGroup, -1458480226, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$1
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$2
            ...
            public final void invoke(Composer composer2, int i3) {
                AndroidCursorHandle_androidKt.m735CursorHandleULxng0E(j, modifier, function2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    public static final void DefaultCursorHandle(final Modifier modifier, Composer composer, final int i) {
        ...
        if ((i2 & 11) != 2 || !startRestartGroup.getSkipping()) {
            ...
            SpacerKt.Spacer(drawCursorHandle(SizeKt.m528sizeVpY3zN4(modifier, CursorHandleWidth, CursorHandleHeight)), startRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    public static final Modifier drawCursorHandle(Modifier modifier) {
        ...
        return ComposedModifierKt.composed$default(modifier, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1
            ...
            public final Modifier invoke(Modifier composed, Composer composer, int i) {
                ...
                Color m2618boximpl = Color.m2618boximpl(m952getHandleColor0d7_KjU);
                ...
                if (changed || rememberedValue == Composer.Companion.getEmpty()) {
                    rememberedValue = (Function1) new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1
                        ...
                        public final DrawResult invoke(CacheDrawScope drawWithCache) {
                            ...
                            final float m2458getWidthimpl = Size.m2458getWidthimpl(drawWithCache.m2295getSizeNHjbRc()) / 2.0f;
                            final ImageBitmap createHandleImage = AndroidSelectionHandles_androidKt.createHandleImage(drawWithCache, m2458getWidthimpl);
                            ...
                            return drawWithCache.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1.1
                                ...
                                public final void invoke2(ContentDrawScope onDrawWithContent) {
                                    ...
                                    transform.mo3102rotateUv8p0NA(45.0f, Offset.Companion.m2405getZeroF1C5BW0());
    ...
    static {
        float m4872constructorimpl = Dp.m4872constructorimpl(25);
        CursorHandleHeight = m4872constructorimpl;
        CursorHandleWidth = Dp.m4872constructorimpl(Dp.m4872constructorimpl(m4872constructorimpl * 2.0f) / 2.4142137f);
    }
}