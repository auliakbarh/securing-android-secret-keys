...
public final class FocusTransactionsKt {
    ...
    public static final boolean requestFocus(FocusTargetNode focusTargetNode) {
        ...
        int i = WhenMappings.$EnumSwitchMapping$0[m2340performCustomRequestFocusMxy_nc0(focusTargetNode, FocusDirection.Companion.m2317getEnterdhqQ8s()).ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i == 3 || i == 4) {
                    return false;
                            ...
                            while (parent$ui_release2 != null) {
                                if ((parent$ui_release2.getKindSet$ui_release() & m4080constructorimpl2) != 0) {
                                    ...
                                    while (node2 != null) {
                                        ...
                                        if ((node2.getKindSet$ui_release() & m4080constructorimpl2) != 0 && (node2 instanceof DelegatingNode)) {
                                            int i3 = 0;
    ...
    public static final CustomDestinationResult m2340performCustomRequestFocusMxy_nc0(FocusTargetNode performCustomRequestFocus, int i) {
        ...
        if (i2 == 3) {
            ...
            if (activeChild != null) {
                return m2337performCustomClearFocusMxy_nc0(activeChild, i);
            }
            throw new IllegalStateException("Required value was null.".toString());
        } else if (i2 == 4) {
            ...
            if (i4 != 1) {
                if (i4 != 2) {
                    if (i4 != 3) {
                        if (i4 == 4) {
                            CustomDestinationResult m2340performCustomRequestFocusMxy_nc0 = m2340performCustomRequestFocusMxy_nc0(focusTargetNode3, i);
                            CustomDestinationResult customDestinationResult = m2340performCustomRequestFocusMxy_nc0 != CustomDestinationResult.None ? m2340performCustomRequestFocusMxy_nc0 : null;
                            return customDestinationResult == null ? m2338performCustomEnterMxy_nc0(focusTargetNode3, i) : customDestinationResult;
                        }
                        throw new NoWhenBranchMatchedException();
                    }
                    return m2340performCustomRequestFocusMxy_nc0(focusTargetNode3, i);
                }
                return CustomDestinationResult.Cancelled;
            }
            return m2338performCustomEnterMxy_nc0(focusTargetNode3, i);
        } else {
            throw new NoWhenBranchMatchedException();
        }
    }
    ...
    public static final CustomDestinationResult m2337performCustomClearFocusMxy_nc0(FocusTargetNode performCustomClearFocus, int i) {
        ...
        if (i2 != 1) {
            ...
            if (i2 == 3) {
                ...
                if (activeChild != null) {
                    CustomDestinationResult m2337performCustomClearFocusMxy_nc0 = m2337performCustomClearFocusMxy_nc0(activeChild, i);
                    if (m2337performCustomClearFocusMxy_nc0 == CustomDestinationResult.None) {
                        m2337performCustomClearFocusMxy_nc0 = null;
                    }
                    return m2337performCustomClearFocusMxy_nc0 == null ? m2339performCustomExitMxy_nc0(performCustomClearFocus, i) : m2337performCustomClearFocusMxy_nc0;
                }
                throw new IllegalStateException("Required value was null.".toString());
            } else if (i2 != 4) {
                throw new NoWhenBranchMatchedException();
    ...
    private static final CustomDestinationResult m2338performCustomEnterMxy_nc0(FocusTargetNode focusTargetNode, int i) {
        if (!focusTargetNode.isProcessingCustomEnter) {
            focusTargetNode.isProcessingCustomEnter = true;
            try {
                FocusRequester invoke = focusTargetNode.fetchFocusProperties$ui_release().getEnter().invoke(FocusDirection.m2305boximpl(i));
    ...
    private static final CustomDestinationResult m2339performCustomExitMxy_nc0(FocusTargetNode focusTargetNode, int i) {
        if (!focusTargetNode.isProcessingCustomExit) {
            focusTargetNode.isProcessingCustomExit = true;
            try {
                FocusRequester invoke = focusTargetNode.fetchFocusProperties$ui_release().getExit().invoke(FocusDirection.m2305boximpl(i));
                if (invoke != FocusRequester.Companion.getDefault()) {
                    if (invoke == FocusRequester.Companion.getCancel()) {
                        return CustomDestinationResult.Cancelled;
                    }
