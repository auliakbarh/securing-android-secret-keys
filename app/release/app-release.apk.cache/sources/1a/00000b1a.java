...
public final class CardDefaults {
    ...
    public final CardElevation m1014cardElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float m1891getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? FilledCardTokens.INSTANCE.m1891getContainerElevationD9Ej5fM() : f;
        float m1897getPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? FilledCardTokens.INSTANCE.m1897getPressedContainerElevationD9Ej5fM() : f2;
        float m1894getFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? FilledCardTokens.INSTANCE.m1894getFocusContainerElevationD9Ej5fM() : f3;
        float m1895getHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? FilledCardTokens.INSTANCE.m1895getHoverContainerElevationD9Ej5fM() : f4;
        float m1893getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? FilledCardTokens.INSTANCE.m1893getDraggedContainerElevationD9Ej5fM() : f5;
        float m1892getDisabledContainerElevationD9Ej5fM = (i2 & 32) != 0 ? FilledCardTokens.INSTANCE.m1892getDisabledContainerElevationD9Ej5fM() : f6;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-574898487, i, -1, "androidx.compose.material3.CardDefaults.cardElevation (Card.kt:373)");
        }
        CardElevation cardElevation = new CardElevation(m1891getContainerElevationD9Ej5fM, m1897getPressedContainerElevationD9Ej5fM, m1894getFocusContainerElevationD9Ej5fM, m1895getHoverContainerElevationD9Ej5fM, m1893getDraggedContainerElevationD9Ej5fM, m1892getDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final CardElevation m1016elevatedCardElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float m1807getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? ElevatedCardTokens.INSTANCE.m1807getContainerElevationD9Ej5fM() : f;
        float m1813getPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? ElevatedCardTokens.INSTANCE.m1813getPressedContainerElevationD9Ej5fM() : f2;
        float m1810getFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? ElevatedCardTokens.INSTANCE.m1810getFocusContainerElevationD9Ej5fM() : f3;
        float m1811getHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? ElevatedCardTokens.INSTANCE.m1811getHoverContainerElevationD9Ej5fM() : f4;
        float m1809getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? ElevatedCardTokens.INSTANCE.m1809getDraggedContainerElevationD9Ej5fM() : f5;
        float m1808getDisabledContainerElevationD9Ej5fM = (i2 & 32) != 0 ? ElevatedCardTokens.INSTANCE.m1808getDisabledContainerElevationD9Ej5fM() : f6;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1154241939, i, -1, "androidx.compose.material3.CardDefaults.elevatedCardElevation (Card.kt:401)");
        }
        CardElevation cardElevation = new CardElevation(m1807getContainerElevationD9Ej5fM, m1813getPressedContainerElevationD9Ej5fM, m1810getFocusContainerElevationD9Ej5fM, m1811getHoverContainerElevationD9Ej5fM, m1809getDraggedContainerElevationD9Ej5fM, m1808getDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final CardElevation m1018outlinedCardElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float m1993getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? OutlinedCardTokens.INSTANCE.m1993getContainerElevationD9Ej5fM() : f;
        float f7 = (i2 & 2) != 0 ? m1993getContainerElevationD9Ej5fM : f2;
        float f8 = (i2 & 4) != 0 ? m1993getContainerElevationD9Ej5fM : f3;
        float f9 = (i2 & 8) != 0 ? m1993getContainerElevationD9Ej5fM : f4;
        float m1995getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? OutlinedCardTokens.INSTANCE.m1995getDraggedContainerElevationD9Ej5fM() : f5;
        float m1994getDisabledContainerElevationD9Ej5fM = (i2 & 32) != 0 ? OutlinedCardTokens.INSTANCE.m1994getDisabledContainerElevationD9Ej5fM() : f6;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-97678773, i, -1, "androidx.compose.material3.CardDefaults.outlinedCardElevation (Card.kt:429)");
        }
        CardElevation cardElevation = new CardElevation(m1993getContainerElevationD9Ej5fM, f7, f8, f9, m1995getDraggedContainerElevationD9Ej5fM, m1994getDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final CardColors m1013cardColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long m1093contentColorForek8zF_U = (i2 & 2) != 0 ? ColorSchemeKt.m1093contentColorForek8zF_U(color, composer, i & 14) : j2;
        long m2673compositeOverOWjLjI = (i2 & 4) != 0 ? ColorKt.m2673compositeOverOWjLjI(Color.m2627copywmQWz5c$default(ColorSchemeKt.toColor(FilledCardTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), ColorSchemeKt.m1098surfaceColorAtElevation3ABfNKs(MaterialTheme.INSTANCE.getColorScheme(composer, 6), FilledCardTokens.INSTANCE.m1892getDisabledContainerElevationD9Ej5fM())) : j3;
        long m2627copywmQWz5c$default = (i2 & 8) != 0 ? Color.m2627copywmQWz5c$default(ColorSchemeKt.m1093contentColorForek8zF_U(color, composer, i & 14), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1589582123, i, -1, "androidx.compose.material3.CardDefaults.cardColors (Card.kt:455)");
        }
        CardColors cardColors = new CardColors(color, m1093contentColorForek8zF_U, m2673compositeOverOWjLjI, m2627copywmQWz5c$default, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final CardColors m1015elevatedCardColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long m1093contentColorForek8zF_U = (i2 & 2) != 0 ? ColorSchemeKt.m1093contentColorForek8zF_U(color, composer, i & 14) : j2;
        long m2673compositeOverOWjLjI = (i2 & 4) != 0 ? ColorKt.m2673compositeOverOWjLjI(Color.m2627copywmQWz5c$default(ColorSchemeKt.toColor(ElevatedCardTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), ColorSchemeKt.m1098surfaceColorAtElevation3ABfNKs(MaterialTheme.INSTANCE.getColorScheme(composer, 6), ElevatedCardTokens.INSTANCE.m1808getDisabledContainerElevationD9Ej5fM())) : j3;
        long m2627copywmQWz5c$default = (i2 & 8) != 0 ? Color.m2627copywmQWz5c$default(m1093contentColorForek8zF_U, 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final CardColors m1017outlinedCardColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        CardColors cardColors = new CardColors(color, m1093contentColorForek8zF_U, j5, m2627copywmQWz5c$default, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final BorderStroke outlinedCardBorder(boolean z, Composer composer, int i, int i2) {
        ...
        if (z) {
            ...
            m2673compositeOverOWjLjI = ColorSchemeKt.toColor(OutlinedCardTokens.INSTANCE.getOutlineColor(), composer, 6);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-31428766);
            ComposerKt.sourceInformation(composer, "537@25023L9,540@25172L11");
            m2673compositeOverOWjLjI = ColorKt.m2673compositeOverOWjLjI(Color.m2627copywmQWz5c$default(ColorSchemeKt.toColor(OutlinedCardTokens.INSTANCE.getDisabledOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null), ColorSchemeKt.m1098surfaceColorAtElevation3ABfNKs(MaterialTheme.INSTANCE.getColorScheme(composer, 6), OutlinedCardTokens.INSTANCE.m1994getDisabledContainerElevationD9Ej5fM()));
            composer.endReplaceableGroup();
        }
        Color m2618boximpl = Color.m2618boximpl(m2673compositeOverOWjLjI);
        composer.startReplaceableGroup(1157296644);
        ComposerKt.sourceInformation(composer, "CC(remember)P(1):Composables.kt#9igjgp");
        boolean changed = composer.changed(m2618boximpl);
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = BorderStrokeKt.m185BorderStrokecXLIe8U(OutlinedCardTokens.INSTANCE.m1999getOutlineWidthD9Ej5fM(), m2673compositeOverOWjLjI);
