...
public final class ComposerImpl implements Composer {
    ...
    public static final /* synthetic */ List access$getChanges$p(ComposerImpl composerImpl) {
    ...
    public static final /* synthetic */ int[] access$getNodeCountOverrides$p(ComposerImpl composerImpl) {
        return composerImpl.nodeCountOverrides;
    }

    public static final /* synthetic */ SlotReader access$getReader$p(ComposerImpl composerImpl) {
    ...
    public static final /* synthetic */ int access$insertMovableContentGuarded$positionToInsert(SlotWriter slotWriter, Anchor anchor, Applier applier) {
        return insertMovableContentGuarded$positionToInsert(slotWriter, anchor, applier);
    }

    public static final /* synthetic */ void access$insertMovableContentGuarded$positionToParentOf(SlotWriter slotWriter, Applier applier, int i) {
        insertMovableContentGuarded$positionToParentOf(slotWriter, applier, i);
    }

    public static final /* synthetic */ void access$invokeMovableContentLambda(ComposerImpl composerImpl, MovableContent movableContent, PersistentCompositionLocalMap persistentCompositionLocalMap, Object obj, boolean z) {
        composerImpl.invokeMovableContentLambda(movableContent, persistentCompositionLocalMap, obj, z);
    }
    ...
    public static final /* synthetic */ void access$setChanges$p(ComposerImpl composerImpl, List list) {
    ...
    public static final /* synthetic */ void access$setChildrenComposing$p(ComposerImpl composerImpl, int i) {
        composerImpl.childrenComposing = i;
    }

    public static final /* synthetic */ void access$setNodeCountOverrides$p(ComposerImpl composerImpl, int[] iArr) {
        composerImpl.nodeCountOverrides = iArr;
    }

    public static final /* synthetic */ void access$setReader$p(ComposerImpl composerImpl, SlotReader slotReader) {
    ...
    public void startReplaceableGroup(int i) {
        m2240startBaiHCIY(i, null, GroupKind.Companion.m2250getGroupULZAiWs(), null);
    }
    ...
    public void startDefaults() {
        m2240startBaiHCIY(-127, null, GroupKind.Companion.m2250getGroupULZAiWs(), null);
    }
    ...
    public void startMovableGroup(int i, Object obj) {
        m2240startBaiHCIY(i, obj, GroupKind.Companion.m2250getGroupULZAiWs(), null);
    }
    ...
    public void startNode() {
        m2240startBaiHCIY(125, null, GroupKind.Companion.m2251getNodeULZAiWs(), null);
        this.nodeExpected = true;
    }

    @Override // androidx.compose.runtime.Composer
    public void startReusableNode() {
        m2240startBaiHCIY(125, null, GroupKind.Companion.m2252getReusableNodeULZAiWs(), null);
        this.nodeExpected = true;
    }
    ...
    public void startReusableGroup(int i, Object obj) {
        ...
        m2240startBaiHCIY(i, null, GroupKind.Companion.m2250getGroupULZAiWs(), obj);
    }
    ...
    public void startProviders(final ProvidedValue<?>[] values) {
        ...
        m2240startBaiHCIY(ComposerKt.compositionLocalMapKey, ComposerKt.getCompositionLocalMap(), GroupKind.Companion.m2250getGroupULZAiWs(), updateProviderMapGroup);
    }
    ...
    private final void m2240startBaiHCIY(int i, Object obj, int i2, Object obj2) {
        Object obj3 = obj;
        validateNodeNotExpected();
        updateCompoundKeyWhenWeEnterGroup(i, obj, obj2);
        boolean z = i2 != GroupKind.Companion.m2250getGroupULZAiWs();
        ...
        boolean z2 = i2 == GroupKind.Companion.m2251getNodeULZAiWs() && this.reusing;
    ...
    */
    public final void invokeMovableContentLambda(final androidx.compose.runtime.MovableContent<java.lang.Object> r11, androidx.compose.runtime.PersistentCompositionLocalMap r12, final java.lang.Object r13, boolean r14) {
        ...
        L3e:
            ...
            int r5 = r5.m2250getGroupULZAiWs()     // Catch: java.lang.Throwable -> La6
            r6 = 202(0xca, float:2.83E-43)
            r10.m2240startBaiHCIY(r6, r0, r5, r12)     // Catch: java.lang.Throwable -> La6
    ...
    public void sourceInformationMarkerStart(int i, String sourceInformation) {
        ...
        if (this.sourceInformationEnabled) {
            m2240startBaiHCIY(i, null, GroupKind.Companion.m2250getGroupULZAiWs(), sourceInformation);
        }
    }
            ...
            if (groupKey == 126665345 && (groupObjectKey instanceof MovableContent)) {
                ...
                composerImpl.record(new Function3<Applier<?>, SlotWriter, RememberManager, Unit>() { // from class: androidx.compose.runtime.ComposerImpl$reportFreeMovableContent$reportGroup$1
                    ...
                    public final void invoke2(Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
                        ...
                        Intrinsics.checkNotNullParameter(slots, "slots");
                        Intrinsics.checkNotNullParameter(rememberManager, "<anonymous parameter 2>");
                        ComposerImpl.access$releaseMovableGroupAtCurrent(ComposerImpl.this, movableContentStateReference, slots);
                    }
                });
                if (z) {
                ...
                if (component2 == null) {
                    ...
                    recomposeMovableContent$default(this, null, null, null, null, new Function0<Unit>() { // from class: androidx.compose.runtime.ComposerImpl$insertMovableContentGuarded$1$1$2$1
                        ...
                        public final void invoke2() {
                            ...
                            try {
                                ComposerImpl.access$setChanges$p(composerImpl, list5);
                                ...
                                ComposerImpl.access$setNodeCountOverrides$p(composerImpl, null);
                    ...
                    try {
                        ...
                        try {
                            recomposeMovableContent(component2.getComposition$runtime_release(), component1.getComposition$runtime_release(), Integer.valueOf(openReader2.getCurrentGroup()), component2.getInvalidations$runtime_release(), new Function0<Unit>() { // from class: androidx.compose.runtime.ComposerImpl$insertMovableContentGuarded$1$1$5$1$1$1
                                /* JADX INFO: Access modifiers changed from: package-private */
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                {
                                    super(0);
                                ...
                                /* renamed from: invoke  reason: avoid collision after fix types in other method */
                                public final void invoke2() {
                                    ComposerImpl.access$invokeMovableContentLambda(ComposerImpl.this, component1.getContent$runtime_release(), component1.getLocals$runtime_release(), component1.getParameter$runtime_release(), true);
                                }
                            });
                            Unit unit2 = Unit.INSTANCE;
                            this.changes = list2;
