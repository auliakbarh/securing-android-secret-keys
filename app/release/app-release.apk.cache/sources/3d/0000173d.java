...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    public int mo4181getCompositingStrategyNrFUSI() {
    ...
    public RenderNodeApi23(AndroidComposeView ownerView) {
        ...
        this.internalCompositingStrategy = CompositingStrategy.Companion.m2713getAutoNrFUSI();
    ...
    public void mo4182setCompositingStrategyaDBOjCE(int i) {
    ...
    public final int getLayerType$ui_release() {
        return CompositingStrategy.m2709equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.Companion.m2715getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    public void record(CanvasHolder canvasHolder, Path path, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (path != null) {
            androidCanvas.save();
            Canvas.m2599clipPathmtrdDE$default(androidCanvas, path, 0, 2, null);
        }
