...
public final class NavigationRailTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m4872constructorimpl((float) 32.0d);
    ...
    private static final float ContainerWidth = Dp.m4872constructorimpl((float) 80.0d);
    ...
    public final float m1973getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m1974getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m1975getContainerElevationD9Ej5fM() {
    ...
    public final float m1978getMenuIconSizeD9Ej5fM() {
        return MenuIconSize;
    }
    ...
    public final float m1979getNoLabelActiveIndicatorHeightD9Ej5fM() {
    ...
    static {
        float f = (float) 56.0d;
        ActiveIndicatorWidth = Dp.m4872constructorimpl(f);
        float f2 = (float) 24.0d;
        IconSize = Dp.m4872constructorimpl(f2);
        MenuIconSize = Dp.m4872constructorimpl(f2);
        NoLabelActiveIndicatorHeight = Dp.m4872constructorimpl(f);
    }
}