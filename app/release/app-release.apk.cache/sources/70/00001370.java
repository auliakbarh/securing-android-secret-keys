...
public final class CompositingStrategy {
    ...
    private static final int Auto = m2707constructorimpl(0);
    private static final int Offscreen = m2707constructorimpl(1);
    private static final int ModulateAlpha = m2707constructorimpl(2);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ CompositingStrategy m2706boximpl(int i) {
        return new CompositingStrategy(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m2707constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2708equalsimpl(int i, Object obj) {
        return (obj instanceof CompositingStrategy) && i == ((CompositingStrategy) obj).m2712unboximpl();
    }
    ...
    public static int m2710hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m2711toStringimpl(int i) {
    ...
    public String toString() {
        return m2711toStringimpl(this.value);
    }
