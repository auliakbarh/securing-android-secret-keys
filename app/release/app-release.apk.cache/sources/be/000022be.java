...
public final class UMathKt {
    ...
    private static final int m6368minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m6350minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI  reason: not valid java name */
    private static final long m6369mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m6358minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU  reason: not valid java name */
    private static final int m6366maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m6338maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI  reason: not valid java name */
    private static final long m6367maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m6346maxOfeb3DHEI(j, j2);
    }
}