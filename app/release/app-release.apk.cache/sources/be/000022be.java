...
public final class UMathKt {
    ...
    private static final int m6367minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m6349minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI  reason: not valid java name */
    private static final long m6368mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m6357minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU  reason: not valid java name */
    private static final int m6365maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m6337maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI  reason: not valid java name */
    private static final long m6366maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m6345maxOfeb3DHEI(j, j2);
    }
}