...
public final class UMathKt {
    ...
    private static final int m6371minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m6353minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI  reason: not valid java name */
    private static final long m6372mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m6361minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU  reason: not valid java name */
    private static final int m6369maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m6341maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI  reason: not valid java name */
    private static final long m6370maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m6349maxOfeb3DHEI(j, j2);
    }
}