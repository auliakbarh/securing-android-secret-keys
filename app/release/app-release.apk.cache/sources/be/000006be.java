...
public final class LazyLayoutItemContentFactoryKt {
    ...
    public static final /* synthetic */ void m635access$SkippableItemJVlU9Rs(LazyLayoutItemProvider lazyLayoutItemProvider, Object obj, int i, Object obj2, Composer composer, int i2) {
        m634SkippableItemJVlU9Rs(lazyLayoutItemProvider, obj, i, obj2, composer, i2);
    }

    /* renamed from: SkippableItem-JVlU9Rs */
    public static final void m634SkippableItemJVlU9Rs(final LazyLayoutItemProvider lazyLayoutItemProvider, final Object obj, final int i, final Object obj2, Composer composer, final int i2) {
        final int i3;
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutItemContentFactoryKt$SkippableItem$2
            ...
            public final void invoke(Composer composer2, int i4) {
                LazyLayoutItemContentFactoryKt.m635access$SkippableItemJVlU9Rs(LazyLayoutItemProvider.this, obj, i, obj2, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
            }
        });
    }
}