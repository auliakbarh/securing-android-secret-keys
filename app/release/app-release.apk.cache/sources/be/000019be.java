...
public interface TextForegroundStyle {
    ...
    public static final class Unspecified implements TextForegroundStyle {
        ...
        public long mo4673getColor0d7_KjU() {
            return Color.Companion.m2664getUnspecified0d7_KjU();
        }
    }
    ...
    public static final class Companion {
        ...
        public final TextForegroundStyle from(Brush brush, float f) {
            ...
            if (brush instanceof SolidColor) {
                return m4785from8_81llA(TextDrawStyleKt.m4784modulateDxMtmZc(((SolidColor) brush).m2956getValue0d7_KjU(), f));
            }
        ...
        public final TextForegroundStyle m4785from8_81llA(long j) {
            return j != Color.Companion.m2664getUnspecified0d7_KjU() ? new ColorStyle(j, null) : Unspecified.INSTANCE;
        }
    }
}