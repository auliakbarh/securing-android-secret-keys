...
public final class SnapFlingBehaviorKt {
    ...
    private static final float MinFlingVelocityDp = Dp.m4872constructorimpl(400);
    ...
    public static final /* synthetic */ void access$animateDecay$consumeDelta(AnimationScope animationScope, ScrollScope scrollScope, Function1 function1, float f) {
        animateDecay$consumeDelta(animationScope, scrollScope, function1, f);
    }
    ...
    public static final /* synthetic */ float access$coerceToTarget(float f, float f2) {
        return coerceToTarget(f, f2);
    }
