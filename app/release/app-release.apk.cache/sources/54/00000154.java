...
public interface AnimatedContentTransitionScope<S> extends Transition.Segment<S> {
    ...
    EnterTransition mo13slideIntoContainermOhB8PU(int i, FiniteAnimationSpec<IntOffset> finiteAnimationSpec, Function1<? super Integer, Integer> function1);

    /* renamed from: slideOutOfContainer-mOhB8PU  reason: not valid java name */
    ExitTransition mo14slideOutOfContainermOhB8PU(int i, FiniteAnimationSpec<IntOffset> finiteAnimationSpec, Function1<? super Integer, Integer> function1);
    ...
    public static final class SlideDirection {
        ...
        private static final int Left = m16constructorimpl(0);
        private static final int Right = m16constructorimpl(1);
        private static final int Up = m16constructorimpl(2);
        private static final int Down = m16constructorimpl(3);
        private static final int Start = m16constructorimpl(4);
        private static final int End = m16constructorimpl(5);

        /* renamed from: box-impl  reason: not valid java name */
        public static final /* synthetic */ SlideDirection m15boximpl(int i) {
        ...
        public static boolean m17equalsimpl(int i, Object obj) {
            return (obj instanceof SlideDirection) && i == ((SlideDirection) obj).m21unboximpl();
        }
        ...
        public final /* synthetic */ int m21unboximpl() {
            return this.value;
        }
        ...
        public static String m20toStringimpl(int i) {
            return m18equalsimpl0(i, Left) ? "Left" : m18equalsimpl0(i, Right) ? "Right" : m18equalsimpl0(i, Up) ? "Up" : m18equalsimpl0(i, Down) ? "Down" : m18equalsimpl0(i, Start) ? "Start" : m18equalsimpl0(i, End) ? "End" : "Invalid";
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: slideIntoContainer-mOhB8PU$default  reason: not valid java name */
    static /* synthetic */ EnterTransition m11slideIntoContainermOhB8PU$default(AnimatedContentTransitionScope animatedContentTransitionScope, int i, FiniteAnimationSpec finiteAnimationSpec, Function1 function1, int i2, Object obj) {
        if (obj == null) {
            if ((i2 & 2) != 0) {
                finiteAnimationSpec = AnimationSpecKt.spring$default(0.0f, 0.0f, IntOffset.m4981boximpl(VisibilityThresholdsKt.getVisibilityThreshold(IntOffset.Companion)), 3, null);
            }
            if ((i2 & 4) != 0) {
            ...
            return animatedContentTransitionScope.mo13slideIntoContainermOhB8PU(i, finiteAnimationSpec, function1);
        }
    ...
    static /* synthetic */ ExitTransition m12slideOutOfContainermOhB8PU$default(AnimatedContentTransitionScope animatedContentTransitionScope, int i, FiniteAnimationSpec finiteAnimationSpec, Function1 function1, int i2, Object obj) {
        if (obj == null) {
            if ((i2 & 2) != 0) {
                finiteAnimationSpec = AnimationSpecKt.spring$default(0.0f, 0.0f, IntOffset.m4981boximpl(VisibilityThresholdsKt.getVisibilityThreshold(IntOffset.Companion)), 3, null);
            }
            ...
            return animatedContentTransitionScope.mo14slideOutOfContainermOhB8PU(i, finiteAnimationSpec, function1);
        }
