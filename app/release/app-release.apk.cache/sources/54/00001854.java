...
public final class TextLayoutResult {
    ...
    public final long m4376getSizeYbymL2g() {
        return this.size;
    }
    ...
    public final boolean getDidOverflowHeight() {
        return this.multiParagraph.getDidExceedMaxLines() || ((float) IntSize.m5031getHeightimpl(this.size)) < this.multiParagraph.getHeight();
    }

    public final boolean getDidOverflowWidth() {
        return ((float) IntSize.m5032getWidthimpl(this.size)) < this.multiParagraph.getWidth();
    }
    ...
    public final int m4375getOffsetForPositionk4lQ0M(long j) {
        return this.multiParagraph.m4291getOffsetForPositionk4lQ0M(j);
    }
    ...
    public final long m4377getWordBoundaryjx7JFs(int i) {
        return this.multiParagraph.m4292getWordBoundaryjx7JFs(i);
    }
    ...
    public static /* synthetic */ TextLayoutResult m4373copyO0kMr_c$default(TextLayoutResult textLayoutResult, TextLayoutInput textLayoutInput, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textLayoutResult.m4374copyO0kMr_c(textLayoutInput, j);
    }

    /* renamed from: copy-O0kMr_c */
    public final TextLayoutResult m4374copyO0kMr_c(TextLayoutInput layoutInput, long j) {
        Intrinsics.checkNotNullParameter(layoutInput, "layoutInput");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TextLayoutResult) {
            ...
            return Intrinsics.areEqual(this.layoutInput, textLayoutResult.layoutInput) && Intrinsics.areEqual(this.multiParagraph, textLayoutResult.multiParagraph) && IntSize.m5030equalsimpl0(this.size, textLayoutResult.size) && this.firstBaseline == textLayoutResult.firstBaseline && this.lastBaseline == textLayoutResult.lastBaseline && Intrinsics.areEqual(this.placeholderRects, textLayoutResult.placeholderRects);
        }
        return false;
    }

    public int hashCode() {
        return (((((((((this.layoutInput.hashCode() * 31) + this.multiParagraph.hashCode()) * 31) + IntSize.m5033hashCodeimpl(this.size)) * 31) + Float.hashCode(this.firstBaseline)) * 31) + Float.hashCode(this.lastBaseline)) * 31) + this.placeholderRects.hashCode();
    }

    public String toString() {
        return "TextLayoutResult(layoutInput=" + this.layoutInput + ", multiParagraph=" + this.multiParagraph + ", size=" + ((Object) IntSize.m5035toStringimpl(this.size)) + ", firstBaseline=" + this.firstBaseline + ", lastBaseline=" + this.lastBaseline + ", placeholderRects=" + this.placeholderRects + ')';
    }
}