...
final class OffsetElement extends ModifierNodeElement<OffsetNode> {
    ...
    public void update(OffsetNode node) {
        ...
        node.m443setX0680j_4(this.x);
        node.m444setY0680j_4(this.y);
    ...
    public boolean equals(Object obj) {
        ...
        return Dp.m4877equalsimpl0(this.x, offsetElement.x) && Dp.m4877equalsimpl0(this.y, offsetElement.y) && this.rtlAware == offsetElement.rtlAware;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((Dp.m4878hashCodeimpl(this.x) * 31) + Dp.m4878hashCodeimpl(this.y)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    public String toString() {
        return "OffsetModifierElement(x=" + ((Object) Dp.m4883toStringimpl(this.x)) + ", y=" + ((Object) Dp.m4883toStringimpl(this.y)) + ", rtlAware=" + this.rtlAware + ')';
    }
