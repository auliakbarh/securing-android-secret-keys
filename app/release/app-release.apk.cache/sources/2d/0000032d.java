...
public final class MarqueeModifierNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, FocusEventModifierNode {
    ...
    public static final /* synthetic */ int access$getContainerWidth(MarqueeModifierNode marqueeModifierNode) {
        return marqueeModifierNode.getContainerWidth();
    }

    public static final /* synthetic */ int access$getContentWidth(MarqueeModifierNode marqueeModifierNode) {
        return marqueeModifierNode.getContentWidth();
    }

    public static final /* synthetic */ float access$getDirection(MarqueeModifierNode marqueeModifierNode) {
        return marqueeModifierNode.getDirection();
    }

    public static final /* synthetic */ Animatable access$getOffset$p(MarqueeModifierNode marqueeModifierNode) {
        return marqueeModifierNode.offset;
    }
    ...
    private MarqueeModifierNode(int i, int i2, int i3, int i4, final MarqueeSpacing spacing, float f) {
        ...
        mutableStateOf$default3 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(MarqueeAnimationMode.m220boximpl(i2), null, 2, null);
        ...
        this.spacingPx$delegate = SnapshotStateKt.derivedStateOf(new Function0<Integer>() { // from class: androidx.compose.foundation.MarqueeModifierNode$spacingPx$2
            ...
            public final Integer invoke() {
                ...
                return Integer.valueOf(marqueeSpacing.calculateSpacing(DelegatableNodeKt.requireDensity(marqueeModifierNode), MarqueeModifierNode.access$getContentWidth(marqueeModifierNode), MarqueeModifierNode.access$getContainerWidth(marqueeModifierNode)));
            }
        });
    }
    ...
    /* renamed from: getAnimationMode-ZbEOnfQ */
    public final int m235getAnimationModeZbEOnfQ() {
        return ((MarqueeAnimationMode) this.animationMode$delegate.getValue()).m226unboximpl();
    }

    /* renamed from: setAnimationMode-97h66l8 */
    public final void m237setAnimationMode97h66l8(int i) {
        this.animationMode$delegate.setValue(MarqueeAnimationMode.m220boximpl(i));
    }
    ...
    /* renamed from: update-lWfNwf4 */
    public final void m238updatelWfNwf4(int i, int i2, int i3, int i4, MarqueeSpacing spacing, float f) {
        Intrinsics.checkNotNullParameter(spacing, "spacing");
        setSpacing(spacing);
        m237setAnimationMode97h66l8(i2);
        if (this.iterations == i && this.delayMillis == i3 && this.initialDelayMillis == i4 && Dp.m4877equalsimpl0(this.velocity, f)) {
            return;
        }
        this.iterations = i;
        this.delayMillis = i3;
    ...
    public MeasureResult mo236measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        final Placeable mo3865measureBRTryo0 = measurable.mo3865measureBRTryo0(Constraints.m4819copyZbe2FdA$default(j, 0, Integer.MAX_VALUE, 0, 0, 13, null));
        setContainerWidth(ConstraintsKt.m4842constrainWidthK40F9xA(j, mo3865measureBRTryo0.getWidth()));
        setContentWidth(mo3865measureBRTryo0.getWidth());
        return MeasureScope.layout$default(measure, getContainerWidth(), mo3865measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.MarqueeModifierNode$measure$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.placeWithLayer$default(layout, Placeable.this, MathKt.roundToInt((-((Number) MarqueeModifierNode.access$getOffset$p(this).getValue()).floatValue()) * MarqueeModifierNode.access$getDirection(this)), 0, 0.0f, null, 12, null);
            }
        }, 4, null);
    }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        float m2455getHeightimpl = Size.m2455getHeightimpl(contentDrawScope2.mo3171getSizeNHjbRc());
        int m2617getIntersectrtfAjoo = ClipOp.Companion.m2617getIntersectrtfAjoo();
        DrawContext drawContext = contentDrawScope2.getDrawContext();
        long mo3096getSizeNHjbRc = drawContext.mo3096getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo3099clipRectN_I0leg(floatValue, 0.0f, floatValue + getContainerWidth(), m2455getHeightimpl, m2617getIntersectrtfAjoo);
        if (z) {
