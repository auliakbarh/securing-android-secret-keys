...
public final class SizeAnimationModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public static final class AnimData {
        ...
        public static /* synthetic */ AnimData m69copyO0kMr_c$default(AnimData animData, Animatable animatable, long j, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return animData.m71copyO0kMr_c(animatable, j);
        }
        ...
        public final long m70component2YbymL2g() {
            return this.startSize;
        }

        /* renamed from: copy-O0kMr_c  reason: not valid java name */
        public final AnimData m71copyO0kMr_c(Animatable<IntSize, AnimationVector2D> anim, long j) {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof AnimData) {
                ...
                return Intrinsics.areEqual(this.anim, animData.anim) && IntSize.m5030equalsimpl0(this.startSize, animData.startSize);
            }
            return false;
        }
        ...
        public final long m72getStartSizeYbymL2g() {
            return this.startSize;
        }

        public int hashCode() {
            return (this.anim.hashCode() * 31) + IntSize.m5033hashCodeimpl(this.startSize);
        }

        /* renamed from: setStartSize-ozmzZPI  reason: not valid java name */
        public final void m73setStartSizeozmzZPI(long j) {
            this.startSize = j;
        }

        public String toString() {
            return "AnimData(anim=" + this.anim + ", startSize=" + ((Object) IntSize.m5035toStringimpl(this.startSize)) + ')';
        }
    ...
    public MeasureResult mo36measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        long m68animateTomzRDjE0 = m68animateTomzRDjE0(IntSizeKt.IntSize(mo3865measureBRTryo0.getWidth(), mo3865measureBRTryo0.getHeight()));
        return MeasureScope.layout$default(measure, IntSize.m5032getWidthimpl(m68animateTomzRDjE0), IntSize.m5031getHeightimpl(m68animateTomzRDjE0), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SizeAnimationModifier$measure$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
    ...
    public final long m68animateTomzRDjE0(long j) {
        AnimData animData = getAnimData();
        if (animData != null) {
            if (!IntSize.m5030equalsimpl0(j, animData.getAnim().getTargetValue().m5036unboximpl())) {
                animData.m73setStartSizeozmzZPI(animData.getAnim().getValue().m5036unboximpl());
            ...
            animData = new AnimData(new Animatable(IntSize.m5024boximpl(j), VectorConvertersKt.getVectorConverter(IntSize.Companion), IntSize.m5024boximpl(IntSizeKt.IntSize(1, 1)), null, 8, null), j, null);
        }
        setAnimData(animData);
        return animData.getAnim().getValue().m5036unboximpl();
    }
