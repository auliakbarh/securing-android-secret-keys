...
public final class SheetDefaultsKt {
    private static final float DragHandleVerticalPadding = Dp.m4872constructorimpl(22);
    private static final float BottomSheetMaxWidth = Dp.m4872constructorimpl(640);
    ...
    public static final NestedScrollConnection ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection(final SheetState sheetState, final Orientation orientation, final Function1<? super Float, Unit> onFling) {
        ...
        return new NestedScrollConnection() { // from class: androidx.compose.material3.SheetDefaultsKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1
            ...
            public long mo333onPreScrollOzD1aCk(long j, int i) {
                ...
                if (offsetToFloat < 0.0f && NestedScrollSource.m3639equalsimpl0(i, NestedScrollSource.Companion.m3644getDragWNlRxjI())) {
            ...
            private final float velocityToFloat(long j) {
                return orientation == Orientation.Horizontal ? Velocity.m5097getXimpl(j) : Velocity.m5098getYimpl(j);
            }

            private final float offsetToFloat(long j) {
                return orientation == Orientation.Horizontal ? Offset.m2389getXimpl(j) : Offset.m2390getYimpl(j);
            }
        };
    }
    ...
    public static final SheetState rememberSheetState(boolean z, Function1<? super SheetValue, Boolean> function1, SheetValue sheetValue, boolean z2, Composer composer, int i, int i2) {
        ...
        SheetState sheetState = (SheetState) RememberSaveableKt.m2275rememberSaveable(objArr, Saver, (String) null, (Function0<? extends Object>) rememberedValue, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
