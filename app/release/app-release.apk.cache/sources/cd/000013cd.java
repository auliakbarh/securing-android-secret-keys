...
public abstract class ColorSpace {
    ...
    public final long m3037getModelxdoWZVw() {
        return this.model;
    }
    ...
    public final int getComponentCount() {
        return ColorModel.m3029getComponentCountimpl(this.model);
    }
    ...
    public long mo3038xyzaToColorJlNiLsg$ui_graphics_release(float f, float f2, float f3, float f4, ColorSpace colorSpace) {
    ...
    public final float[] fromXyz(float f, float f2, float f3) {
        float[] fArr = new float[ColorModel.m3029getComponentCountimpl(this.model)];
        fArr[0] = f;
        fArr[1] = f2;
        fArr[2] = f3;
        return fromXyz(fArr);
    ...
    public String toString() {
        return this.name + " (id=" + this.id + ", model=" + ((Object) ColorModel.m3031toStringimpl(this.model)) + ')';
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.id == colorSpace.id && Intrinsics.areEqual(this.name, colorSpace.name)) {
            return ColorModel.m3028equalsimpl0(this.model, colorSpace.model);
        }
        return false;
    }

    public int hashCode() {
        return (((this.name.hashCode() * 31) + ColorModel.m3030hashCodeimpl(this.model)) * 31) + this.id;
    }
