...
public final class NodeKindKt {
    ...
    public static final boolean m4088contains64DMado(int i, int i2) {
        return (i & i2) != 0;
    }
    ...
    public static final int m4090or64DMado(int i, int i2) {
        return i | i2;
    }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Node node) {
        ...
        int m4080constructorimpl = NodeKind.m4080constructorimpl(1);
        if (node instanceof LayoutModifierNode) {
            m4080constructorimpl |= NodeKind.m4080constructorimpl(2);
        }
        if (node instanceof DrawModifierNode) {
            m4080constructorimpl |= NodeKind.m4080constructorimpl(4);
        }
        if (node instanceof SemanticsModifierNode) {
            m4080constructorimpl |= NodeKind.m4080constructorimpl(8);
        }
        if (node instanceof PointerInputModifierNode) {
            m4080constructorimpl |= NodeKind.m4080constructorimpl(16);
        }
        if (node instanceof ModifierLocalModifierNode) {
            m4080constructorimpl |= NodeKind.m4080constructorimpl(32);
        }
        if (node instanceof ParentDataModifierNode) {
            m4080constructorimpl |= NodeKind.m4080constructorimpl(64);
        }
        if (node instanceof LayoutAwareModifierNode) {
            m4080constructorimpl |= NodeKind.m4080constructorimpl(128);
        }
        if (node instanceof GlobalPositionAwareModifierNode) {
            m4080constructorimpl |= NodeKind.m4080constructorimpl(256);
        }
        if (node instanceof IntermediateLayoutModifierNode) {
            m4080constructorimpl |= NodeKind.m4080constructorimpl(512);
        }
        if (node instanceof FocusTargetNode) {
            m4080constructorimpl |= NodeKind.m4080constructorimpl(1024);
        }
        if (node instanceof FocusPropertiesModifierNode) {
            m4080constructorimpl |= NodeKind.m4080constructorimpl(2048);
        }
        if (node instanceof FocusEventModifierNode) {
            m4080constructorimpl |= NodeKind.m4080constructorimpl(4096);
        }
        if (node instanceof KeyInputModifierNode) {
            m4080constructorimpl |= NodeKind.m4080constructorimpl(8192);
        }
        if (node instanceof RotaryInputModifierNode) {
            m4080constructorimpl |= NodeKind.m4080constructorimpl(16384);
        }
        if (node instanceof CompositionLocalConsumerModifierNode) {
            m4080constructorimpl |= NodeKind.m4080constructorimpl(32768);
        }
        return node instanceof SoftKeyboardInterceptionModifierNode ? m4080constructorimpl | NodeKind.m4080constructorimpl(131072) : m4080constructorimpl;
    }
    ...
    private static final void autoInvalidateNodeSelf(Modifier.Node node, int i, int i2) {
        if (i2 != 0 || node.getShouldAutoInvalidate()) {
            if ((NodeKind.m4080constructorimpl(2) & i) != 0 && (node instanceof LayoutModifierNode)) {
                LayoutModifierNodeKt.invalidateMeasurement((LayoutModifierNode) node);
                if (i2 == 2) {
                    DelegatableNodeKt.m3978requireCoordinator64DMado(node, NodeKind.m4080constructorimpl(2)).onRelease();
                }
            }
            if ((NodeKind.m4080constructorimpl(256) & i) != 0 && (node instanceof GlobalPositionAwareModifierNode)) {
                DelegatableNodeKt.requireLayoutNode(node).invalidateMeasurements$ui_release();
            }
            if ((NodeKind.m4080constructorimpl(4) & i) != 0 && (node instanceof DrawModifierNode)) {
                DrawModifierNodeKt.invalidateDraw((DrawModifierNode) node);
            }
            if ((NodeKind.m4080constructorimpl(8) & i) != 0 && (node instanceof SemanticsModifierNode)) {
                SemanticsModifierNodeKt.invalidateSemantics((SemanticsModifierNode) node);
            }
            if ((NodeKind.m4080constructorimpl(64) & i) != 0 && (node instanceof ParentDataModifierNode)) {
                ParentDataModifierNodeKt.invalidateParentData((ParentDataModifierNode) node);
            }
            if ((NodeKind.m4080constructorimpl(1024) & i) != 0 && (node instanceof FocusTargetNode)) {
                if (i2 == 2) {
                    node.onReset();
                } else {
            ...
            if ((NodeKind.m4080constructorimpl(2048) & i) != 0 && (node instanceof FocusPropertiesModifierNode)) {
            ...
            if ((i & NodeKind.m4080constructorimpl(4096)) == 0 || !(node instanceof FocusEventModifierNode)) {
                return;
            }
    ...
    public static final boolean m4089getIncludeSelfInTraversalH91voCI(int i) {
        return (i & NodeKind.m4080constructorimpl(128)) != 0;
    }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Element element) {
        ...
        return ((element instanceof OnPlacedModifier) || (element instanceof OnRemeasuredModifier)) ? m4080constructorimpl | NodeKind.m4080constructorimpl(128) : m4080constructorimpl;
    }
}