...
public abstract class LazyStaggeredGridMeasureProvider {
    ...
    private final long m666childConstraintsJhjzzOo(int i, int i2) {
        int i3;
        ...
        if (this.isVertical) {
            return Constraints.Companion.m4838fixedWidthOenEA2s(i3);
        }
        return Constraints.Companion.m4837fixedHeightOenEA2s(i3);
    }

    /* renamed from: getAndMeasure-jy6DScQ  reason: not valid java name */
    public final LazyStaggeredGridMeasuredItem m667getAndMeasurejy6DScQ(int i, long j) {
        int i2 = (int) (j >> 32);
        int i3 = ((int) (j & 4294967295L)) - i2;
        return createItem(i, i2, i3, this.itemProvider.getKey(i), this.itemProvider.getContentType(i), this.measureScope.mo637measure0kLqBqw(i, m666childConstraintsJhjzzOo(i2, i3)));
    }
