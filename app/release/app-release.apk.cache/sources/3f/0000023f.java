...
public final class StartOffsetType {
    ...
    private static final int Delay = m119constructorimpl(-1);
    private static final int FastForward = m119constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ StartOffsetType m118boximpl(int i) {
        return new StartOffsetType(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m119constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m120equalsimpl(int i, Object obj) {
        return (obj instanceof StartOffsetType) && i == ((StartOffsetType) obj).m124unboximpl();
    }
    ...
    public static String m123toStringimpl(int i) {
