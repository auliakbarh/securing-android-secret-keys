...
public final class MultiParagraphLayoutCache {
    ...
    public /* synthetic */ MultiParagraphLayoutCache(AnnotatedString annotatedString, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, List list, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.Companion.m4813getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, (i4 & 128) != 0 ? null : list, null);
    }
    ...
    public final boolean m847layoutWithConstraintsK40F9xA(long j, LayoutDirection layoutDirection) {
        ...
        if (!m845newLayoutWillBeDifferentVKLhPVY(this.layoutCache, j, layoutDirection)) {
            TextLayoutResult textLayoutResult = this.layoutCache;
            Intrinsics.checkNotNull(textLayoutResult);
            if (Constraints.m4821equalsimpl0(j, textLayoutResult.getLayoutInput().m4371getConstraintsmsEJaDk())) {
                return false;
            }
            TextLayoutResult textLayoutResult2 = this.layoutCache;
            Intrinsics.checkNotNull(textLayoutResult2);
            this.layoutCache = m846textLayoutResultVKLhPVY(layoutDirection, j, textLayoutResult2.getMultiParagraph());
            return true;
        }
        this.layoutCache = m846textLayoutResultVKLhPVY(layoutDirection, j, m843layoutTextK40F9xA(j, layoutDirection));
        return true;
    }

    /* renamed from: textLayoutResult-VKLhPVY  reason: not valid java name */
    private final TextLayoutResult m846textLayoutResultVKLhPVY(LayoutDirection layoutDirection, long j, MultiParagraph multiParagraph) {
        ...
        Density density = this.density;
        Intrinsics.checkNotNull(density);
        return new TextLayoutResult(new TextLayoutInput(annotatedString, textStyle, list, i, z, i2, density, layoutDirection, this.fontFamilyResolver, j, (DefaultConstructorMarker) null), multiParagraph, ConstraintsKt.m4839constrain4WqzIAM(j, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(multiParagraph.getWidth()), TextDelegateKt.ceilToIntPx(multiParagraph.getHeight()))), null);
    }
    ...
    public final int intrinsicHeight(int i, LayoutDirection layoutDirection) {
        ...
        if (i != i2 || i2 == -1) {
            int ceilToIntPx = TextDelegateKt.ceilToIntPx(m843layoutTextK40F9xA(ConstraintsKt.Constraints(0, i, 0, Integer.MAX_VALUE), layoutDirection).getHeight());
    ...
    public final void m848updateZNqEYIc(AnnotatedString text, TextStyle style, FontFamily.Resolver fontFamilyResolver, int i, boolean z, int i2, int i3, List<AnnotatedString.Range<Placeholder>> list) {
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(fontFamilyResolver, "fontFamilyResolver");
        this.text = text;
    ...
    private final MultiParagraph m843layoutTextK40F9xA(long j, LayoutDirection layoutDirection) {
        MultiParagraphIntrinsics layoutDirection2 = setLayoutDirection(layoutDirection);
        return new MultiParagraph(layoutDirection2, LayoutUtilsKt.m838finalConstraintstfFHcEY(j, this.softWrap, this.overflow, layoutDirection2.getMaxIntrinsicWidth()), LayoutUtilsKt.m839finalMaxLinesxdlQI24(this.softWrap, this.overflow, this.maxLines), TextOverflow.m4806equalsimpl0(this.overflow, TextOverflow.Companion.m4814getEllipsisgIe3tQ8()), null);
    }

    /* renamed from: newLayoutWillBeDifferent-VKLhPVY  reason: not valid java name */
    private final boolean m845newLayoutWillBeDifferentVKLhPVY(TextLayoutResult textLayoutResult, long j, LayoutDirection layoutDirection) {
        ...
        return Constraints.m4828getMaxWidthimpl(j) != Constraints.m4828getMaxWidthimpl(textLayoutResult.getLayoutInput().m4371getConstraintsmsEJaDk()) || ((float) Constraints.m4827getMaxHeightimpl(j)) < textLayoutResult.getMultiParagraph().getHeight() || textLayoutResult.getMultiParagraph().getDidExceedMaxLines();
    }

    /* renamed from: maxWidth-BRTryo0  reason: not valid java name */
    private final int m844maxWidthBRTryo0(long j) {
        boolean z = this.softWrap;
        int i = this.overflow;
        MultiParagraphIntrinsics multiParagraphIntrinsics = this.paragraphIntrinsics;
        Intrinsics.checkNotNull(multiParagraphIntrinsics);
        return LayoutUtilsKt.m840finalMaxWidthtfFHcEY(j, z, i, multiParagraphIntrinsics.getMaxIntrinsicWidth());
    }
