...
public final class SelectionHandlesKt {
    ...
    public static final long m893getAdjustedCoordinatesk4lQ0M(long j) {
        return OffsetKt.Offset(Offset.m2389getXimpl(j), Offset.m2390getYimpl(j) - 1.0f);
    }

    static {
        float f = 25;
        HandleWidth = Dp.m4872constructorimpl(f);
        HandleHeight = Dp.m4872constructorimpl(f);
    }
}