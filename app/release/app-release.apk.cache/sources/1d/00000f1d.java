...
public final class TimePickerColors {
    ...
    public final long m1554clockDialContentColorvNxB06k$material3_release(boolean z) {
    ...
    public final long m1560periodSelectorContentColorvNxB06k$material3_release(boolean z) {
    ...
    public final long m1561timeSelectorContainerColorvNxB06k$material3_release(boolean z) {
    ...
    public final long m1562timeSelectorContentColorvNxB06k$material3_release(boolean z) {
    ...
    public boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(getClass(), obj != null ? obj.getClass() : null)) {
            ...
            return Color.m2629equalsimpl0(this.clockDialColor, timePickerColors.clockDialColor) && Color.m2629equalsimpl0(this.selectorColor, timePickerColors.selectorColor) && Color.m2629equalsimpl0(this.containerColor, timePickerColors.containerColor) && Color.m2629equalsimpl0(this.periodSelectorBorderColor, timePickerColors.periodSelectorBorderColor) && Color.m2629equalsimpl0(this.periodSelectorSelectedContainerColor, timePickerColors.periodSelectorSelectedContainerColor) && Color.m2629equalsimpl0(this.periodSelectorUnselectedContainerColor, timePickerColors.periodSelectorUnselectedContainerColor) && Color.m2629equalsimpl0(this.periodSelectorSelectedContentColor, timePickerColors.periodSelectorSelectedContentColor) && Color.m2629equalsimpl0(this.periodSelectorUnselectedContentColor, timePickerColors.periodSelectorUnselectedContentColor) && Color.m2629equalsimpl0(this.timeSelectorSelectedContainerColor, timePickerColors.timeSelectorSelectedContainerColor) && Color.m2629equalsimpl0(this.timeSelectorUnselectedContainerColor, timePickerColors.timeSelectorUnselectedContainerColor) && Color.m2629equalsimpl0(this.timeSelectorSelectedContentColor, timePickerColors.timeSelectorSelectedContentColor) && Color.m2629equalsimpl0(this.timeSelectorUnselectedContentColor, timePickerColors.timeSelectorUnselectedContentColor);
        }
        return false;
    }

    public int hashCode() {
        return (((((((((((((((((((((Color.m2635hashCodeimpl(this.clockDialColor) * 31) + Color.m2635hashCodeimpl(this.selectorColor)) * 31) + Color.m2635hashCodeimpl(this.containerColor)) * 31) + Color.m2635hashCodeimpl(this.periodSelectorBorderColor)) * 31) + Color.m2635hashCodeimpl(this.periodSelectorSelectedContainerColor)) * 31) + Color.m2635hashCodeimpl(this.periodSelectorUnselectedContainerColor)) * 31) + Color.m2635hashCodeimpl(this.periodSelectorSelectedContentColor)) * 31) + Color.m2635hashCodeimpl(this.periodSelectorUnselectedContentColor)) * 31) + Color.m2635hashCodeimpl(this.timeSelectorSelectedContainerColor)) * 31) + Color.m2635hashCodeimpl(this.timeSelectorUnselectedContainerColor)) * 31) + Color.m2635hashCodeimpl(this.timeSelectorSelectedContentColor)) * 31) + Color.m2635hashCodeimpl(this.timeSelectorUnselectedContentColor);
    }
}