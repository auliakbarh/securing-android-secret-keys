...
public interface SendChannel<E> {
    ...
    Object mo6663trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            ...
            if (ChannelResult.m6678isSuccessimpl(mo6663trySendJP2dKIU)) {
                return true;
            }
            Throwable m6672exceptionOrNullimpl = ChannelResult.m6672exceptionOrNullimpl(mo6663trySendJP2dKIU);
