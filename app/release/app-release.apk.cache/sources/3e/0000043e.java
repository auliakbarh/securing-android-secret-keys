...
public final class UpdatableAnimationState {
    ...
    public static final /* synthetic */ long access$getLastFrameTime$p(UpdatableAnimationState updatableAnimationState) {
        return updatableAnimationState.lastFrameTime;
    }

    public static final /* synthetic */ AnimationVector1D access$getLastVelocity$p(UpdatableAnimationState updatableAnimationState) {
        return updatableAnimationState.lastVelocity;
    }

    public static final /* synthetic */ void access$setLastFrameTime$p(UpdatableAnimationState updatableAnimationState, long j) {
        updatableAnimationState.lastFrameTime = j;
    }

    public static final /* synthetic */ void access$setLastVelocity$p(UpdatableAnimationState updatableAnimationState, AnimationVector1D animationVector1D) {
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:95:0x00a7 -> B:116:0x00aa). Please submit an issue!!! */
    /*
