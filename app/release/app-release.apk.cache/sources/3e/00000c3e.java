...
public final class DropdownMenuPositionProvider implements PopupPositionProvider {
    ...
    public static /* synthetic */ DropdownMenuPositionProvider m1184copyrOJDEFc$default(DropdownMenuPositionProvider dropdownMenuPositionProvider, long j, Density density, Function2 function2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return dropdownMenuPositionProvider.m1186copyrOJDEFc(j, density, function2);
    }

    /* renamed from: component1-RKDOV3M  reason: not valid java name */
    public final long m1185component1RKDOV3M() {
    ...
    public final DropdownMenuPositionProvider m1186copyrOJDEFc(long j, Density density, Function2<? super IntRect, ? super IntRect, Unit> onPositionCalculated) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DropdownMenuPositionProvider) {
            ...
            return DpOffset.m4932equalsimpl0(this.contentOffset, dropdownMenuPositionProvider.contentOffset) && Intrinsics.areEqual(this.density, dropdownMenuPositionProvider.density) && Intrinsics.areEqual(this.onPositionCalculated, dropdownMenuPositionProvider.onPositionCalculated);
        }
        return false;
    }

    /* renamed from: getContentOffset-RKDOV3M  reason: not valid java name */
    public final long m1187getContentOffsetRKDOV3M() {
        return this.contentOffset;
    }
    ...
    public int hashCode() {
        return (((DpOffset.m4937hashCodeimpl(this.contentOffset) * 31) + this.density.hashCode()) * 31) + this.onPositionCalculated.hashCode();
    }

    public String toString() {
        return "DropdownMenuPositionProvider(contentOffset=" + ((Object) DpOffset.m4940toStringimpl(this.contentOffset)) + ", density=" + this.density + ", onPositionCalculated=" + this.onPositionCalculated + ')';
    }
    ...
    public long mo873calculatePositionllwVHH4(IntRect anchorBounds, long j, LayoutDirection layoutDirection, long j2) {
        Sequence sequenceOf;
        Object obj;
        Object obj2;
        Intrinsics.checkNotNullParameter(anchorBounds, "anchorBounds");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        int mo318roundToPx0680j_4 = this.density.mo318roundToPx0680j_4(MenuKt.getMenuVerticalMargin());
        int mo318roundToPx0680j_42 = this.density.mo318roundToPx0680j_4(DpOffset.m4933getXD9Ej5fM(this.contentOffset));
        int mo318roundToPx0680j_43 = this.density.mo318roundToPx0680j_4(DpOffset.m4935getYD9Ej5fM(this.contentOffset));
        int left = anchorBounds.getLeft() + mo318roundToPx0680j_42;
        int right = (anchorBounds.getRight() - mo318roundToPx0680j_42) - IntSize.m5032getWidthimpl(j2);
        int m5032getWidthimpl = IntSize.m5032getWidthimpl(j) - IntSize.m5032getWidthimpl(j2);
        if (layoutDirection == LayoutDirection.Ltr) {
            ...
            numArr[2] = Integer.valueOf(m5032getWidthimpl);
            sequenceOf = SequencesKt.sequenceOf(numArr);
        } else {
            Integer[] numArr2 = new Integer[3];
            numArr2[0] = Integer.valueOf(right);
            numArr2[1] = Integer.valueOf(left);
            if (anchorBounds.getRight() <= IntSize.m5032getWidthimpl(j)) {
                m5032getWidthimpl = 0;
            }
            numArr2[2] = Integer.valueOf(m5032getWidthimpl);
        ...
        while (true) {
            ...
            if (intValue >= 0 && intValue + IntSize.m5032getWidthimpl(j2) <= IntSize.m5032getWidthimpl(j)) {
                break;
            }
        }
        ...
        int top = (anchorBounds.getTop() - mo318roundToPx0680j_43) - IntSize.m5031getHeightimpl(j2);
        Iterator it2 = SequencesKt.sequenceOf(Integer.valueOf(max), Integer.valueOf(top), Integer.valueOf(anchorBounds.getTop() - (IntSize.m5031getHeightimpl(j2) / 2)), Integer.valueOf((IntSize.m5031getHeightimpl(j) - IntSize.m5031getHeightimpl(j2)) - mo318roundToPx0680j_4)).iterator();
        while (true) {
            if (!it2.hasNext()) {
                break;
            }
            ...
            if (intValue2 >= mo318roundToPx0680j_4 && intValue2 + IntSize.m5031getHeightimpl(j2) <= IntSize.m5031getHeightimpl(j) - mo318roundToPx0680j_4) {
                obj = next;
                break;
            }
        }
        ...
        this.onPositionCalculated.invoke(anchorBounds, new IntRect(right, top, IntSize.m5032getWidthimpl(j2) + right, IntSize.m5031getHeightimpl(j2) + top));
