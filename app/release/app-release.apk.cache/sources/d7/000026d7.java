...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m5154constructorimpl = Result.m5154constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.Companion;
                m5154constructorimpl = Result.m5154constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m5160isFailureimpl(m5154constructorimpl)) {
                m5154constructorimpl = null;
            }
            return (E) m5154constructorimpl;
        }
                    ...
                    return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$1
                        ...
                        public final Throwable invoke(Throwable th) {
                            ...
                            try {
                                ...
                                Result.Companion companion2 = Result.Companion;
                                m5154constructorimpl = Result.m5154constructorimpl(ResultKt.createFailure(th2));
                            }
                            if (newInstance != null) {
                                m5154constructorimpl = Result.m5154constructorimpl((Throwable) newInstance);
                                if (Result.m5160isFailureimpl(m5154constructorimpl)) {
                                    m5154constructorimpl = null;
                                }
                                return (Throwable) m5154constructorimpl;
                            }
                    ...
                    return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$3
                        ...
                        public final Throwable invoke(Throwable th) {
                            ...
                            if (newInstance != null) {
                                ...
                                th3.initCause(th);
                                m5154constructorimpl = Result.m5154constructorimpl(th3);
                                if (Result.m5160isFailureimpl(m5154constructorimpl)) {
                                    m5154constructorimpl = null;
                                }
                                return (Throwable) m5154constructorimpl;
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$safeCtor$1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    Result.Companion companion = Result.Companion;
                    m5154constructorimpl = Result.m5154constructorimpl(function12.invoke(th));
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.Companion;
                    m5154constructorimpl = Result.m5154constructorimpl(ResultKt.createFailure(th2));
                }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        Integer m5154constructorimpl;
        JvmClassMappingKt.getKotlinClass(cls);
        try {
            Result.Companion companion = Result.Companion;
            m5154constructorimpl = Result.m5154constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m5154constructorimpl = Result.m5154constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m5160isFailureimpl(m5154constructorimpl)) {
            m5154constructorimpl = valueOf;
        }
        return ((Number) m5154constructorimpl).intValue();
    }
